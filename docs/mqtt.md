...
De vrijwillige [opt-in voor gebruiksstatistieken](web-app.md#gebruiksstatistieken-en-privacy) gebruikt een aparte outbound-only MQTT/TLS-client. Die client deelt geen entiteiten, discovery-berichten of logs en gebruikt niet de brokerconfiguratie van deze MQTT inputbronnen.

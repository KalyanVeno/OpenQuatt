      ...
      <div class="oq-helper-app-nav">
        ${Pn.filter(e=>e.id!=="diagnosis"||ot()).map(e=>`
          <button
            ...
            data-view-id="${s(e.id)}"
          >
            ${Xe(e.icon,"oq-helper-app-tab-icon")}
            <span>${s(e.label)}</span>
          </button>
        `).join("")}
      </div>
    `}function sh(e=t.appView){return Pn.find(o=>o.id===e)?.label||"OpenQuatt"}function Ei(){if(typeof document>"u")return;if(t.nativeOpen){document.title="ESPHome fallback \u2022 OpenQuatt";return}let e=sh();document.title=`${e} \u2022 OpenQuatt`}function ki(){if(typeof document>"u")return;if(t.nativeOpen){document.documentElement.classList.add("oq-surface-native"),document.body&&document.body.classList.add("oq-surface-native"),document.documentElement.classList.remove("oq-page-dark","oq-page-light"),document.body&&document.body.classList.remove("oq-page-dark","oq-page-light");return}document.documentElement.classList.remove("oq-surface-native"),document.body&&document.body.classList.remove("oq-surface-native");let e=t.overviewTheme==="dark";document.documentElement.classList.toggle("oq-page-dark",e),document.documentElement.classList.toggle("oq-page-light",!e),document.body&&(document.body.classList.toggle("oq-page-dark",e),document.body.classList.toggle("oq-page-light",!e))}var Me={};function hc(e={}){Object.keys(Me).forEach(o=>{delete Me[o]}),Object.assign(Me,e)}function fc(e){Me.handleChange?.(e)}function bc(e){Me.handleClick?.(e)}function Ci(e){Me.handleFocusChange?.(e)}function yc(e){Me.handleInput?.(e)}function vc(e){Me.handleKeyDown?.(e)}function wc(e){Me.handlePointerDown?.(e)}function Sc(e){Me.handlePointerMove?.(e)}function qc(e){Me.handlePointerUp?.(e)}function Tc(e){Me.handleSettingsInteractionEnd?.(e)}function Ec(e){Me.handleSettingsInteractionStart?.(e)}function kc(e){Me.handleWheel?.(e)}async function It(e){if(!e)return!1;if(window.navigator?.clipboard?.writeText&&window.isSecureContext)return await window.navigator.clipboard.writeText(e),!0;let o=document.createElement("textarea");o.value=e,o.setAttribute("readonly",""),o.style.position="fixed",o.style.top="-1000px",o.style.opacity="0",document.body.appendChild(o),o.focus(),o.select();let r=!1;try{r=document.execCommand("copy")}finally{document.body.removeChild(o)}return r}function xi(e,o){let r=URL.createObjectURL(e),n=document.createElement("a");n.href=r,n.download=o,n.rel="noreferrer",document.body.appendChild(n),n.click(),n.remove(),window.setTimeout(()=>URL.revokeObjectURL(r),0)}function $i(e,o,r="text/plain"){xi(new Blob([o],{type:r}),e)}function Cc(e,o){$i(e,JSON.stringify(o,null,2),"application/json")}function dt(){return typeof window<"u"&&window.__OQ_DEV_META&&typeof window.__OQ_DEV_META=="object"?window.__OQ_DEV_META:{}}function lh(){let e=String(E("hpGeneration")||"").trim();return e||""}function Nr(e){let o=String(e||"").trim().toLowerCase();return o==="single"||o.includes("quatt single")||o.includes("openquatt single")?"single":o==="duo"||o.includes("quatt duo")||o.includes("openquatt duo")?"duo":""}function ch(){if(!Array.isArray(Wo))return"";if(Wo.some(o=>h(o)))return"duo";let e=t.optionalMissingEntities||{};return Wo.every(o=>e[o])?"single":""}function Ai(e){let o=Nr(e);return(o==="single"||o==="duo")&&typeof t<"u"&&t&&typeof t=="object"&&(t.lastKnownInstallationTopology=o),o}function uh(){if(typeof t<"u"&&t&&typeof t=="object"){let e=String(t.lastKnownInstallationTopology||"").trim().toLowerCase();if(e==="single"||e==="duo")return e}return""}function ee(){let e=Nr(E("installationTopology"));if(e==="single"||e==="duo")return Ai(e);let o=Nr(dt().installation);if(o==="single"||o==="duo")return Ai(o);let r=ch();return r?Ai(r):uh()}function rt(){let e=ee(),o=lh();return e==="single"?o?`Quatt Single ${o}`:"Quatt Single":e==="duo"?o?`Quatt Duo ${o}`:"Quatt Duo":o?`Quatt Hybrid ${o}`:"Quatt Hybrid"}function Re(){return"OpenQuatt"}function Hi(e){let o=String(e||"").trim().toLowerCase();return o==="wifi"||o==="wi-fi"||o.includes("wifi")||o.includes("wi-fi")?"wifi":o==="eth"||o==="ethernet"||o.includes("ethernet")?"eth":""}function je(e=_t()){return e==="wifi"?"Wi-Fi":e==="eth"?"Ethernet":"Onbekend"}function fo(e=ee()){return e==="single"?"Single":e==="duo"?"Duo":"Onbekende opstelling"}function Or(){let e=String(E("hardwareProfileText")||"").trim().toLowerCase();return e&&e!=="unknown"&&e!=="onbekend"?e:String(dt().hardwareProfile||e).trim().toLowerCase()}function _t(){return Hi(E("connectionText")||dt().connection)}function xc(){let e=_t();return e==="wifi"?"eth":e==="eth"?"wifi":""}function $c(){let e=ee();return e==="single"?"duo":e==="duo"?"single":""}function Ko(e=ee(),o=_t()){let r=fo(e),n=Or();return n==="heatpump_controller_q"?`Heatpump Controller Q ${r} ${je(o)}`:n==="heatpump_listener"?`Heatpump Listener ${r} ${je(o)}`:n==="waveshare"?`Waveshare ${r} ${je(o)}`:`${Re()} ${r} ${je(o)}`}function Mi(){let e=x("timeValid"),o=String(E("timeNowHhmm")||"").trim();if(o&&o!=="invalid")return o;if(h("timeValid")&&!e)return"Geen tijdsync";try{return new Intl.DateTimeFormat("nl-NL",{hour:"2-digit",minute:"2-digit"}).format(new Date)}catch{return new Date().toLocaleTimeString("nl-NL",{hour:"2-digit",minute:"2-digit"})}}function Vn(){return h("timeValid")&&!x("timeValid")?"Geen tijdsync":`${new Intl.DateTimeFormat("nl-NL",{day:"numeric",month:"short",year:"numeric"}).format(new Date)} \xB7 ${Mi()}`}function Wn(e){if(!Number.isFinite(e)||e<0)return"\u2014";let o=Math.floor(e),r=Math.floor(o/1440),n=Math.floor(o%1440/60),a=o%60;return r>0?`${r}d ${n}u`:n>0?`${n}u ${a}m`:`${a}m`}function ph(e){return String(e?.uom??e?.unit_of_measurement??"").trim().toLowerCase()}function dh(e){let o=e?.state;if(o!==""&&o!==null&&o!==void 0){let a=Number(o);if(Number.isFinite(a))return a}let r=e?.value,n=Number(r);return Number.isFinite(n)?n:NaN}function jo(){let e=dh(t.entities.uptime);if(Number.isFinite(e)&&e>=0){let n=ph(t.entities.uptime);if(n==="d")return Wn(e*1440);if(n==="h")return Wn(e*60);if(n==="s")return Wn(e/60)}let o=String(t.entities.uptimeReadable?.state??t.entities.uptimeReadable?.value??"").trim();if(o&&o.toLowerCase()!=="unknown")return o;let r=Number(dt().bootedAt);return!Number.isFinite(r)||r<=0?"\u2014":Wn((Date.now()-r)/6e4)}function Uo(){let e=String(t.entities.ipAddress?.state??t.entities.ipAddress?.value??"").trim();if(e)return e;let o=String(dt().ipAddress||"").trim();return o||(typeof window<"u"?String(window.location.hostname||"").trim():"")||"\u2014"}var Ri=null;function Ac(e){Ri=typeof e=="function"?e:null}function d(){Ri&&Ri()}var Hc=250;function Mc(){if(typeof window>"u")return[];let e=window.__OQ_DEV_WEBSERVER_LOGS__,o=typeof e=="function"?e():e;return Array.isArray(o)?o.map(r=>String(r||"")).filter(r=>r.trim()!==""):[]}function Go(){return typeof window>"u"?!1:Mc().length>0}function mh(){return`${He()}/events`}function gh(){return`${He()}/openquatt/logs/recent`}function Bn(){let e=t.entities?.webServerLogHistoryEnabled;if(!e)return!0;if(typeof e.value=="boolean")return e.value;let o=String(e.state??e.value??"").toLowerCase();return o==="on"||o==="true"||o==="1"}function Kn(){return t.nativeOpen?"Niet beschikbaar":Go()?"Voorbeeld":t.webServerLogEnabled===!1?"Niet beschikbaar":"Beschikbaar"}function hh(e){let o=Math.max(0,Math.floor(Number(e)/1e3)),r=Math.floor(o/3600),n=Math.floor(o%3600/60),a=o%60;return`${String(r).padStart(2,"0")}:${String(n).padStart(2,"0")}:${String(a).padStart(2,"0")}`}function Rc(e){let o=Number(e)||0;if(o>9466848e5){let r=e instanceof Date?e:new Date(o),n={day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"};try{return new Intl.DateTimeFormat("nl-NL",n).format(r)}catch{return r.toLocaleString("nl-NL",n)}}return hh(o)}function fh(e){let o=Number(e)||0;if(o>9466848e5)return new Date(o).toLocaleString("nl-NL",{day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"});let r=Math.max(0,Math.floor(o/1e3)),n=Math.floor(r/3600),a=Math.floor(r%3600/60),i=r%60;return`Sinds opstart: ${n}u ${a}m ${i}s`}function bh(){return t.nativeOpen?"Niet beschikbaar":Go()?Bn()?"Voorbeeld buffer aan":"Voorbeeld buffer uit":Bn()?"Buffer aan":"Buffer uit"}function yh(){return Bn()?"Slaat de laatste firmwarelogs tijdelijk op in RAM. De viewer leest die buffer bij openen en blijft daarna live /events volgen.":"Geen tijdelijke buffer in RAM. De viewer toont alleen live /events."}function Pi(){return t.entities?.debugLevel||null}function Pc(e=Pi()){let o=Array.isArray(e?.option)?e.option:Array.isArray(e?.options)?e.options:[];return o.length?o:["NONE","ERROR","WARN","INFO","CONFIG","DEBUG"]}function vh(e=Pi()){let o=String(e?.value??e?.state??"").trim(),r=Pc(e);return r.includes(o)?o:r.includes("INFO")?"INFO":r[0]||""}function Nc(e,o=null){if(!e||!o)return!1;let r=Number(e.seq),n=Number(o.seq);if(Number.isFinite(r)&&Number.isFinite(n)&&r===n)return!0;let a=String(e.raw??e.text??"").trim(),i=String(o.raw??o.text??"").trim();if(!a||a!==i)return!1;let l=Number(e.receivedAt??e.ts??0),p=Number(o.receivedAt??o.ts??0);return Math.abs(l-p)<=2e3}function wh(e,o){let r=Number(e.receivedAt??e.ts??0),n=Number(o.receivedAt??o.ts??0);if(r!==n)return r-n;let a=Number(e.seq??0),i=Number(o.seq??0);return a!==i?a-i:String(e.raw??"").localeCompare(String(o.raw??""))}function Oc(e,{prepend:o=!1}={}){if(!Array.isArray(e)||e.length===0)return;let r=o?[...e,...t.webServerLogEntries]:[...t.webServerLogEntries,...e];r.sort(wh);let n=[];for(let a of r){let i=n[n.length-1]||null;Nc(a,i)||n.push(a)}t.webServerLogEntries=n.slice(-Hc)}function Ni(e,o={}){let r=Fh(e).trimEnd(),n=Number(o.receivedAt),a=Number(o.seq);return{raw:e,text:r,tone:Ih(e),receivedAt:Number.isFinite(n)?n:Date.now(),seq:Number.isFinite(a)?a:void 0}}function Sh(e,o){let n=Math.max(0,o-e-1)*9e4;return Date.now()-n}function qh(){let e=Mc(),o=e.length;return e.map((r,n)=>Ni(r,{receivedAt:Sh(n,o),seq:n+1}))}function Th(){let e=jn();e&&(e.scrollTop=e.scrollHeight)}function Tt(){let e=jn();return e?{scrollHeight:e.scrollHeight,scrollTop:e.scrollTop,stickToBottom:Un(e)}:null}function Eh(e){if(!e)return;let o=jn();if(!o)return;if(e.stickToBottom){o.scrollTop=o.scrollHeight;return}let r=e.scrollTop+(o.scrollHeight-e.scrollHeight);o.scrollTop=Math.max(0,r)}function Et(e,o=!0){if(!e)return;let r=Number(t.webServerLogScrollRestoreToken||0)+1;t.webServerLogScrollRestoreToken=r;let n=()=>{t.webServerLogScrollRestoreToken!==r||t.systemModal!=="webserver-logs"||Eh(e)};if(o){window.requestAnimationFrame(n);return}n()}function Lc(){return t.root?t.root.querySelector("[data-oq-cm100-commissioning-scroller]"):null}function Dc(){let e=Lc();return e?{scrollHeight:e.scrollHeight,scrollTop:e.scrollTop,stickToBottom:Un(e)}:null}function kh(e){if(!e)return;let o=Lc();if(!o)return;if(e.stickToBottom){o.scrollTop=o.scrollHeight;return}let r=e.scrollTop+(o.scrollHeight-e.scrollHeight);o.scrollTop=Math.max(0,r)}function Oi(e,o=!0){if(!e)return;let r=Number(t.cm100CommissioningScrollRestoreToken||0)+1;t.cm100CommissioningScrollRestoreToken=r;let n=()=>{t.cm100CommissioningScrollRestoreToken!==r||t.systemModal!=="cm100-commissioning"||kh(e)};if(o){window.requestAnimationFrame(n);return}n()}function Fc(){return t.root?t.root.querySelector("[data-oq-service-task-scroller]"):null}function Ic(){let e=Fc();return e?{scrollTop:e.scrollTop}:null}function Ch(e){if(!e)return;let o=Fc();o&&(o.scrollTop=Math.max(0,e.scrollTop))}function Li(e,o=!0){if(!e)return;let r=Number(t.serviceTaskModalScrollRestoreToken||0)+1;t.serviceTaskModalScrollRestoreToken=r;let n=()=>{t.serviceTaskModalScrollRestoreToken!==r||!String(t.systemModal||"").startsWith("service-task-")||Ch(e)};if(o){window.requestAnimationFrame(n);return}n()}function _c(){return t.root?t.root.querySelector("[data-oq-history-storage-scroller]"):null}function Wc(){let e=_c();return e?{scrollTop:e.scrollTop}:null}function xh(e){if(!e)return;let o=_c();o&&(o.scrollTop=Math.max(0,e.scrollTop))}function Di(e,o=!0){if(!e)return;let r=Number(t.historyStorageModalScrollRestoreToken||0)+1;t.historyStorageModalScrollRestoreToken=r;let n=()=>{t.historyStorageModalScrollRestoreToken!==r||t.systemModal!=="history-storage"||xh(e)};if(o){window.requestAnimationFrame(n);return}n()}async function Lr(e={}){if(t.nativeOpen||typeof window.fetch!="function")return;let o=e.scrollState||Tt(),r=Number(t.webServerLogHistoryRequestToken||0)+1;t.webServerLogHistoryRequestToken=r,t.webServerLogHistoryLoading=!0,t.webServerLogHistoryError="";try{let n=await window.fetch(gh(),{headers:{"Cache-Control":"no-store"}});if(!n.ok)throw new Error(`HTTP ${n.status}`);let a=await n.json();if(t.systemModal!=="webserver-logs"||t.webServerLogHistoryRequestToken!==r)return;let i=Ah(a);t.webServerLogHistoryLoaded=!0,i.length>0&&(Oc(i,{prepend:!0}),t.webServerLogRecentTail=i.slice(-4).map(l=>String(l.raw??l.text??"")),t.webServerLogRecentAnchorAt=Date.now())}catch(n){t.systemModal==="webserver-logs"&&t.webServerLogHistoryRequestToken===r&&(t.webServerLogHistoryError=n instanceof Error?n.message:"Recente logs konden niet worden opgehaald.")}finally{t.webServerLogHistoryRequestToken===r&&(t.webServerLogHistoryLoading=!1),t.systemModal==="webserver-logs"&&t.webServerLogHistoryRequestToken===r&&(d(),Et(o))}}function $h(e,o=0){if(!e||typeof e!="object")return null;let r=String(e.raw??"").trim()||String(e.message??"").trim();return r?Ni(r,{receivedAt:Number(e.ts??e.timestamp_ms??e.receivedAt??Date.now()),seq:Number(e.seq??o)}):null}function Ah(e){return!e||typeof e!="object"?[]:e.enabled===!1?[]:(Array.isArray(e.entries)?e.entries:[]).map((r,n)=>$h(r,n+1)).filter(r=>r!==null)}function Hh(e){if(!e||!Array.isArray(t.webServerLogRecentTail)||t.webServerLogRecentTail.length===0||Date.now()-Number(t.webServerLogRecentAnchorAt||0)>2500)return!1;let r=String(e.raw??e.text??"").trim();return r?t.webServerLogRecentTail.includes(r):!1}function Mh(e,o=t.webServerLogEntries){return!e||!Array.isArray(o)||o.length===0?!1:o.some(r=>Nc(e,r))}function Vc(){Go()&&t.webServerLogEntries.length===0&&(t.webServerLogEntries=qh()),t.webServerLogCopyMessage="",t.webServerLogCopyError="",t.systemModal="webserver-logs",d(),D(["webServerLogHistoryEnabled","debugLevel"],"all",{forceFast:!0}).then(()=>{if(t.systemModal!=="webserver-logs")return;let e=Tt();d(),Et(e)}),Th(),(!t.webServerLogHistoryLoaded||t.webServerLogEntries.length===0)&&Lr()}function zo(){t.webServerLogEntries=[],t.webServerLogError="",t.webServerLogHistoryError="",t.webServerLogHistoryLoading=!1,t.webServerLogHistoryLoaded=!1,t.webServerLogScrollRestoreToken=Number(t.webServerLogScrollRestoreToken||0)+1,t.webServerLogCopyMessage="",t.webServerLogCopyError="",t.webServerLogHistoryRequestToken+=1,t.webServerLogRecentTail=[],t.webServerLogRecentAnchorAt=0,t.systemModal==="webserver-logs"&&d()}function Fi(){let e=Tt();nt(),t.webServerLogEnabled=null,t.webServerLogConnected=!1,zo(),t.systemModal==="webserver-logs"&&Lr({scrollState:e})}function Ii(){if(Go()){nt();return}if(!(t.mounted&&!t.nativeOpen&&t.systemModal==="webserver-logs")){nt();return}if(t.webServerLogEnabled===!1){nt();return}t.webServerLogSource||Rh()}function Rh(){if(Go()){t.webServerLogEnabled=!0,t.webServerLogConnected=!1,t.webServerLogError="",d();return}if(typeof window.EventSource!="function"){t.webServerLogEnabled=!1,t.webServerLogConnected=!1,t.webServerLogError="Deze browser ondersteunt geen live logstream.",d();return}try{let e=new window.EventSource(mh());t.webServerLogSource=e,e.addEventListener("open",Ph),e.addEventListener("ping",Nh),e.addEventListener("log",Lh),e.onerror=Oh}catch(e){t.webServerLogEnabled=!1,t.webServerLogConnected=!1,t.webServerLogError=e instanceof Error?e.message:"De live logstream kon niet worden geopend.",nt(),d()}}function nt(){let e=t.webServerLogSource;if(e)try{e.close()}catch{}t.webServerLogSource=null,t.webServerLogConnected=!1}function Ph(){if(!t.webServerLogSource||t.nativeOpen)return;let e=t.systemModal==="webserver-logs"?Tt():null;t.webServerLogEnabled=!0,t.webServerLogConnected=!0,t.webServerLogError="",d(),Et(e)}function Nh(){if(!t.webServerLogSource||t.nativeOpen)return;let e=t.systemModal==="webserver-logs"?Tt():null;t.webServerLogEnabled=!0,t.webServerLogConnected||(t.webServerLogConnected=!0,t.webServerLogError="",d(),Et(e))}function Oh(){if(!t.webServerLogSource)return;let e=t.systemModal==="webserver-logs"?Tt():null;t.webServerLogEnabled=!1,t.webServerLogConnected=!1,t.webServerLogError="De live logstream kon niet worden geopend.",nt(),d(),Et(e)}function Lh(e){if(!t.webServerLogSource||!e||typeof e.data!="string")return;let o=Tt(),r=Dh(e.data);if(!r)return;let n=r.split(/\r?\n/).filter(u=>u.trim()!=="");if(n.length===0)return;let i=n.map(u=>Ni(u)).filter(u=>!Hh(u)&&!Mh(u));if(i.length===0)return;Oc(i);let l=Wh(),p=jn();_h(l),Vh(i,l),t.webServerLogEnabled=!0,p&&o&&Et(o,!1)}function Dh(e){let o=String(e??"").replace(/\r\n/g,`
`).replace(/\r/g,`
...
`).replace(/\r/g,`
`).trimEnd()}catch{}return o}function Fh(e){return String(e??"").replace(/\x1b\[[0-9;]*m/g,"")}function Ih(e){let o=String(e??""),r=Array.from(o.matchAll(/\x1b\[([0-9;]*)m/g));for(let i=r.length-1;i>=0;i-=1){let l=r[i][1].split(";").map(p=>Number(p)).filter(p=>Number.isFinite(p));for(let p=l.length-1;p>=0;p-=1){let u=l[p];if(u===31||u===91)return"error";if(u===33||u===93)return"warning";if(u===32||u===92)return"info";if(u===36||u===96||u===34||u===35)return"debug";if(u===37||u===90||u===38||u===97)return"verbose"}}let n=o.match(/\[(E|W|I|D|V|VV)\]/i);if(!n)return"plain";let a=n[1].toUpperCase();return a==="E"?"error":a==="W"?"warning":a==="I"?"info":a==="D"?"debug":"verbose"}function _h(e){for(;t.webServerLogEntries.length>Hc;)t.webServerLogEntries.shift(),e&&e.firstElementChild&&e.removeChild(e.firstElementChild)}function Wh(){return t.root?t.root.querySelector("[data-oq-webserver-log-output]"):null}function jn(){return t.root?t.root.querySelector("[data-oq-webserver-log-scroller]"):null}function Un(e){return e?e.scrollHeight-e.scrollTop-e.clientHeight<48:!1}function Vh(e,o){if(!(!o||e.length===0)){o.dataset.webServerLogEmpty==="true"&&(o.dataset.webServerLogEmpty="false",o.innerHTML="");for(let r of e)o.insertAdjacentHTML("beforeend",Bc(r))}}function Bc(e){let o=Rc(e.receivedAt),r=fh(e.receivedAt);return`
  ...
  `}function Bh(e=t.webServerLogEntries){return e.length?e.map(o=>Bc(o)).join(""):`
      <p class="oq-webserver-log-empty">Nog geen logregels ontvangen. Open de log en wacht op een nieuwe melding.</p>
    `}function Kh(){let e=[];return t.webServerLogHistoryLoading&&e.push('<p class="oq-helper-modal-note">Recente firmwarelogs worden opgehaald...</p>'),t.webServerLogCopyMessage&&e.push(`
    ...
    `),t.webServerLogCopyError&&e.push(`<p class="oq-helper-modal-note oq-helper-modal-note--error">${s(t.webServerLogCopyError)}</p>`),t.webServerLogHistoryError&&e.push(`<p class="oq-helper-modal-note oq-helper-modal-note--error">${s(t.webServerLogHistoryError)}</p>`),t.webServerLogError&&e.push(`<p class="oq-helper-modal-note oq-helper-modal-note--error">${s(t.webServerLogError)}</p>`),e.length?e.join(""):""}function jh(){let e=Bn(),o=t.loadingEntities||t.busyAction==="switch-webServerLogHistoryEnabled",r=bh(),n=yh(),a=Uh();return`
    <div class="oq-webserver-log-history-shell">
      <div class="oq-settings-system-row oq-settings-system-row--with-action" data-oq-diagnostics-row="webserverLogHistory">
        <div class="oq-settings-system-row-copy">
          ...
          <p class="oq-settings-system-row-note">${s(n)}</p>
        </div>
        <button
  ...
  `}function Uh(){let e=Pi();if(!e)return"";let o=Pc(e),r=vh(e),n=t.loadingEntities||t.busyAction==="save-debugLevel";return`
    <div class="oq-settings-system-row oq-settings-system-row--with-action" data-oq-diagnostics-row="debugLevel">
      <div class="oq-settings-system-row-copy">
        ...
        <strong class="oq-settings-system-row-value">${s(r||"Onbekend")}</strong>
  ...
  `}function Gh(){return t.webServerLogEntries.map(e=>{let o=String(e.raw??e.text??"").trimEnd();return o.trim()?`${Rc(e.receivedAt)} ${o}`:""}).filter(e=>e.trim()!=="").join(`
`)}async function Kc(){let e=Gh();if(t.webServerLogCopyMessage="",t.webServerLogCopyError="",!e){t.webServerLogCopyError="Er zijn nog geen logregels om te kopi\xEBren.",d();return}try{if(!await It(e))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");t.webServerLogCopyMessage=`${t.webServerLogEntries.length} logregel${t.webServerLogEntries.length===1?"":"s"} gekopieerd.`}catch(o){t.webServerLogCopyError=o instanceof Error?o.message:"Kopi\xEBren naar het klembord is niet gelukt."}t.systemModal==="webserver-logs"&&d()}function jc(){let e=Go();return`
  ...
  `}function zh(){let e=t.entities.firmwareUpdateTarget||{};return Array.isArray(e.option)?e.option:Array.isArray(e.options)?e.options:[]}function zc(e){return zh().includes(e)}function zn(){let e=Or(),o=ee(),r=_t(),n=xc();return e!=="heatpump_controller_q"||o!=="single"&&o!=="duo"||r!=="wifi"&&r!=="eth"||!n?null:{canSwitch:h("firmwareUpdateTarget")&&zc("alternate connection")&&h("installFirmwareUpdateTarget"),currentConnection:r,targetConnection:n,currentLabel:je(r),targetLabel:je(n),currentBuildLabel:Ko(o,r),targetBuildLabel:Ko(o,n)}}function Qn(){let e=Or(),o=ee(),r=$c(),n=_t(),a=e==="heatpump_controller_q"?["wifi","eth"]:["wifi"];return!["heatpump_controller_q","heatpump_listener","waveshare"].includes(e)||o!=="single"&&o!=="duo"||!r||!a.includes(n)?null:{canSwitch:h("firmwareUpdateTarget")&&zc("alternate topology")&&h("installFirmwareUpdateTarget"),currentTopology:o,targetTopology:r,currentConnection:n,targetConnection:n,currentLabel:fo(o),targetLabel:fo(r),currentBuildLabel:Ko(o,n),targetBuildLabel:Ko(r,n)}}function bo(e=t.updateTestFirmwarePr){let o=String(e||"").trim().replace(/^#?pr[-\s]*/i,"").replace(/^#/,"");return/^\d{1,6}$/.test(o)?o:""}function Yo(){let e=Or(),o=ee(),r=_t(),a={waveshare:{slug:"waveshare",label:"Waveshare",connections:["wifi"]},heatpump_listener:{slug:"heatpump-listener",label:"Heatpump Listener",connections:["wifi"]},heatpump_controller_q:{slug:"heatpump-controller-q",label:"Heatpump Controller Q",connections:["wifi","eth"]}}[e];if(!a||o!=="single"&&o!=="duo"||!a.connections.includes(r))return{available:!1,label:"Onbekend target",error:"Deze firmware meldt geen herkenbaar hardware-, opstelling- of verbindingsprofiel."};let i=`openquatt-${a.slug}-${o}-${r}`,l=o==="duo"?"Duo":"Single";return{available:!0,artifactName:i,otaFileName:`${i}.firmware.ota.bin`,md5FileName:`${i}.firmware.ota.bin.md5`,label:`${a.label} ${l} ${je(r)}`}}function Fr(e=bo(),o=Yo()){if(!e||!o.available)return null;let n=`${`https://github.com/jeroen85/OpenQuatt/releases/download/pr-${e}`}/${o.otaFileName}`;return{otaUrl:n,md5Url:`${n}.md5`,releaseApiUrl:`https://api.github.com/repos/jeroen85/OpenQuatt/releases/tags/pr-${e}`}}function Vt(){if(Ge())return"Controleren";let e=kt();if(e)return e.phaseLabel;if(Vi())return"Bijgewerkt";if(Qo())return"Bezig";if(yo())return"Beschikbaar";let o=Yc();if(o!==null&&o<=0)return"Actueel";let r=dt();return typeof r.updateLabel=="string"&&r.updateLabel.trim()?r.updateLabel.trim():r.updateAvailable===!0?"Beschikbaar":r.updateAvailable===!1||Ki()?"Actueel":me()?"Nog niet gecontroleerd":"\u2014"}function me(){return t.entities.firmwareUpdate||null}function Yn(){let e=me();return e?String(e.state??e.value??"").trim().toLowerCase():""}function Qh(){let e=t.entities.firmwareUpdateStatus;return e?String(e.state??e.value??"").trim():""}function Zn(){return Qh().toLowerCase()}function Qc(){let e=t.entities.firmwareUpdateProgress;if(!e)return Number.NaN;let o=Number(e.value??e.state);return Number.isNaN(o)?Number.NaN:Math.max(0,Math.min(100,o))}function _i(){let e=String(t.updateInstallTargetVersion||"").trim(),o=le();return!e||!o?!1:Ir(o,e)>=0}function Yh(e=me()||{}){let o=Bt(e),r=le(e);return!o||!r?!1:Ir(r,o)>=0}function Wi(){return(_i()||Yh())&&!Ge()&&!Dr()&&!yo()}function Vi(){return(t.updateInstallCompleted||Wi())&&!Ge()&&!kt()&&!yo()}function Zo(){t.updateInstallBusy=!1,t.updateInstallTargetVersion="",t.updateInstallPhaseHint="",t.updateInstallProgressHint=Number.NaN,t.updateInstallMode="",t.updateInstallTargetConnection="",t.updateInstallTargetTopology="",rf()}function ke(){t.updateManualUploadFile=null,t.updateManualUploadFileName="",t.updateManualUploadError=""}function Ue(e={}){e.clearPr&&(t.updateTestFirmwarePr=""),t.updateTestFirmwareConfirmed=!1,t.updateTestFirmwareError="",t.updateTestFirmwareBuild=null}function Zh(){let e=Zn(),o=Qc();if(e==="starting"||e==="uploading"||e==="rebooting"){t.updateInstallPhaseHint=e,Number.isNaN(o)||(t.updateInstallProgressHint=e==="rebooting"?Math.max(o,100):o);return}if(t.updateInstallBusy){if(_i()){t.updateInstallPhaseHint="rebooting",t.updateInstallProgressHint=100;return}t.controlNotice.includes("opnieuw is opgestart")&&(t.updateInstallPhaseHint="rebooting",t.updateInstallProgressHint=100)}}function Dr(){let e=Zn();return e==="starting"||e==="uploading"||e==="rebooting"}function kt(){Zh();let e=Zn(),o=e==="starting"||e==="uploading"||e==="rebooting",r=o?e:t.updateInstallPhaseHint,n=Qc(),a=Number.isNaN(t.updateInstallProgressHint)?0:Math.round(t.updateInstallProgressHint),i=o&&!Number.isNaN(n)?Math.round(n):a;return!Dr()&&!t.updateInstallBusy?null:r==="rebooting"?{phaseLabel:"Herstarten",percent:Math.max(i,100),copy:t.updateInstallMode==="test-firmware"?"Testfirmware is geplaatst. Het device start opnieuw op en komt daarna vanzelf terug.":t.updateInstallMode==="connection-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna via de gekozen verbinding terug.":t.updateInstallMode==="topology-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna met de gekozen opstelling terug.":"Firmware is geplaatst. Het device start nu opnieuw op en komt daarna vanzelf terug."}:r==="uploading"?{phaseLabel:"Uploaden",percent:i,copy:t.updateInstallMode==="test-firmware"?`Testfirmware wordt nu door ${Re()} gedownload en ge\xEFnstalleerd.`:t.updateInstallMode==="connection-switch"?`De ${je(t.updateInstallTargetConnection)}-build wordt nu naar ${Re()} verzonden.`:t.updateInstallMode==="topology-switch"?`De ${Ko(t.updateInstallTargetTopology,t.updateInstallTargetConnection)}-build wordt nu naar ${Re()} verzonden.`:`Firmware wordt nu naar ${Re()} verzonden.`}:{phaseLabel:"Installeren",percent:i,copy:t.updateInstallMode==="test-firmware"?`Testfirmware-installatie is gestart voor ${Re()}.`:t.updateInstallMode==="connection-switch"?`Verbindingswissel naar ${je(t.updateInstallTargetConnection)} is gestart.`:t.updateInstallMode==="topology-switch"?`Opstellingswissel naar ${fo(t.updateInstallTargetTopology)} is gestart.`:`OTA-update is gestart voor ${Re()}.`}}function Bt(e=me()||{}){let o=String(e.latest_version||"").trim();if(o)return o;let r=String(e.value||"").trim(),n=String(e.current_version||"").trim();return r&&r!==n&&/^v/i.test(r)?r:""}function le(e=me()||{}){let o=String(t.entities.projectVersionText?.state||t.entities.projectVersionText?.value||"").trim();return o||String(e.current_version||"").trim()}function Jh(e=me()||{}){let o=le(e),r=String(e.current_version||"").trim();return!o||!r||o===r?!1:Ir(o,r)>0}function Bi(e=me()||{},o=Wt()){let r=String(o||"").trim().toLowerCase(),n=String(e.release_url||"").trim().toLowerCase(),a=Bt(e).toLowerCase();if(!r||r==="\u2014")return!0;if(r==="dev"){if(n){if(n.includes("/dev-latest"))return!0;if(a)return a.includes("-dev")}return a?a.includes("-dev"):!1}if(r==="main"){if(n){if(n.includes("/dev-latest"))return!1;if(a)return!a.includes("-dev")}return a?!a.includes("-dev"):!1}return!0}function Uc(e){let r=String(e||"").trim().match(/^v?(\d+)\.(\d+)\.(\d+)(?:-([A-Za-z]+)(?:\.(\d+))?)?/);return r?{major:Number(r[1]),minor:Number(r[2]),patch:Number(r[3]),prereleaseTag:r[4]||"",prereleaseNumber:r[5]?Number(r[5]):null}:null}function Ir(e,o){let r=Uc(e),n=Uc(o);if(!r||!n)return 0;if(r.major!==n.major)return r.major>n.major?1:-1;if(r.minor!==n.minor)return r.minor>n.minor?1:-1;if(r.patch!==n.patch)return r.patch>n.patch?1:-1;let a=!r.prereleaseTag,i=!n.prereleaseTag;return a!==i?a?1:-1:r.prereleaseTag!==n.prereleaseTag?r.prereleaseTag>n.prereleaseTag?1:-1:r.prereleaseNumber!==n.prereleaseNumber?(r.prereleaseNumber||0)>(n.prereleaseNumber||0)?1:-1:0}function Qo(){if(Wi())return!1;let e=Yn();return t.updateInstallBusy||e==="installing"||e==="in_progress"||e==="updating"||e.includes("install")}function Ge(){let e=Yn();return t.updateCheckBusy||e==="checking"||e==="check"||e==="checking_for_update"||e.includes("checking")}function yo(){let e=Yn();if(!Bi())return!1;let o=Yc();return o!==null?o>0:e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")?!1:e==="available"||e==="pending"||e.includes("available")?!0:dt().updateAvailable===!0}function Ki(){let e=Yn();return e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")||Jh()}function ji(){let e=me()||{},o=le(e)||"\u2014",r=Bi(e)?Bt(e):"",n=r?Ir(r,o):null;return!Ge()&&n!==null&&n<=0&&(r=""),{current:o,latest:r||"\u2014"}}function Yc(){let{current:e,latest:o}=ji();return e==="\u2014"||o==="\u2014"?null:Ir(o,e)}function Zc(e=Wt()){let o=String(e||"").trim().toLowerCase();return ni[o]||ni.main}function Xh(){let e=String((me()||{}).release_url||"").trim(),o=Zc();return!e||o.includes("/dev-latest")&&!e.includes("/dev-latest")||!o.includes("/dev-latest")&&e.includes("/dev-latest")?o:e}function ef(){return Re()}function Wt(){return String(E("firmwareUpdateChannel")||t.entities.releaseChannelText?.state||t.entities.releaseChannelText?.value||"\u2014").trim()||"\u2014"}function tf(){return ji().latest!=="\u2014"}function Gc(e){return String(e||"").toLowerCase().replace(/wi[\s-]?fi/g,"wifi").replace(/[^a-z0-9]+/g,"")}function of(e,o=me()||{}){let r=Gc(e);return r?Gc(`${o.title||""} ${o.summary||""}`).includes(r):!0}function Jc(e){return new Promise(o=>window.setTimeout(o,e))}function Jn(e=Date.now()){return Number(t.firmwareOtaQuietUntil||0)>e}function _r(e=mo){let r=Date.now()+e;t.firmwareOtaQuietUntil=Math.max(Number(t.firmwareOtaQuietUntil||0),r),t.pendingEntitySyncOptions=null,Xn(),typeof nt=="function"&&nt(),t.firmwareOtaQuietTimer&&window.clearTimeout(t.firmwareOtaQuietTimer),t.firmwareOtaQuietTimer=window.setTimeout(()=>{t.firmwareOtaQuietTimer=null,t.firmwareOtaQuietUntil=0,!t.updateInstallBusy&&!t.nativeOpen&&Kr()},e)}function rf(){t.firmwareOtaQuietTimer&&(window.clearTimeout(t.firmwareOtaQuietTimer),t.firmwareOtaQuietTimer=null),t.firmwareOtaQuietUntil=0,t.nativeOpen||Kr()}var nf=1500;function Ui(){t.deviceReconnectRecoveryTimer&&(window.clearTimeout(t.deviceReconnectRecoveryTimer),t.deviceReconnectRecoveryTimer=null)}function Kt(){return Number(t.deviceReconnectRecoveryStartedAt||0)>0}function af(){return Kt()?Number(t.deviceReconnectRecoveryStartedAt||0):Number(t.deviceReconnectStartedAt||0)}function sf(){return Kt()?"Gegevens verversen":"Wachten op gegevens"}function lf(){let e=af(),o=e>0?Math.max(0,Math.round((Date.now()-e)/1e3)):0;return Kt()?o>0?`${o}s aan het verversen`:"Net weer online":o>0?`${o}s bezig`:"Net gestart"}function Gi(){if(!t.deviceReconnectMode||Kt())return!1;Ui(),t.deviceReconnectRecoveryStartedAt=Date.now(),t.deviceReconnectLastError="",t.entitySyncFailureCount=0;let e=t.deviceReconnectRecoveryStartedAt;return t.deviceReconnectRecoveryTimer=window.setTimeout(()=>{t.deviceReconnectMode&&Number(t.deviceReconnectRecoveryStartedAt||0)===e&&(zi(),d())},nf),d(),!0}function Wr(e="reconnect",o=""){t.deviceReconnectMode||(t.deviceReconnectStartedAt=Date.now()),Ui(),t.deviceReconnectMode=e,t.deviceReconnectRecoveryStartedAt=0,t.deviceReconnectLastError=o?String(o):t.deviceReconnectLastError,t.systemModal="",t.updateModalOpen=!1,t.controlError=""}function zi(){Ui(),!(!t.deviceReconnectMode&&!t.entitySyncFailureCount)&&(t.deviceReconnectMode="",t.deviceReconnectStartedAt=0,t.deviceReconnectRecoveryStartedAt=0,t.deviceReconnectLastError="",t.entitySyncFailureCount=0)}function cf(){return Kt()?"OpenQuatt is weer online":t.deviceReconnectMode==="ota"?"OpenQuatt wordt bijgewerkt":t.deviceReconnectMode==="restart"?"OpenQuatt herstart":"Verbinding herstellen"}function uf(){return Kt()?t.deviceReconnectMode==="ota"?"De update is bijna klaar. We verversen nu de gegevens en het logboek.":"De controller reageert weer. We verversen nu de gegevens en het logboek.":t.deviceReconnectMode==="ota"?"De controller installeert de update en start daarna opnieuw op. Deze melding verdwijnt zodra de web-app weer gegevens ontvangt.":t.deviceReconnectMode==="restart"?"De controller start opnieuw op. De web-app probeert automatisch opnieuw verbinding te maken.":"De web-app krijgt tijdelijk geen gegevens van de controller. We proberen automatisch opnieuw te verbinden."}function Xc(){return t.deviceReconnectMode?`
        ...
        <section class="oq-helper-modal oq-helper-modal--reconnect" role="status" aria-live="polite" aria-labelledby="oq-reconnect-modal-title">
          <div class="oq-helper-modal-head">
            <div>
              ...
              <h2 class="oq-helper-modal-title" id="oq-reconnect-modal-title">${s(cf())}</h2>
            </div>
          </div>
          <p class="oq-helper-modal-copy">${s(uf())}</p>
    ...
    `:""}function Vr(e=Wt()){let o=me()||{},r=le(o);t.entities.firmwareUpdate={...o,state:"CHECKING",value:"",latest_version:"",latestVersion:"",summary:"",release_url:Zc(e),current_version:r}}async function Br(e={}){let o=String(e.expectedBuildLabel||"").trim();for(let r=0;r<6;r+=1){await Jc(r===0?900:1200),await D($r,"all",{forceMissing:!0});let n=Bi(),a=!o||of(o),i=tf(),l=Ge(),p=Vt();if(n&&a&&(i||!l&&p!=="Nog niet gecontroleerd"))return!0}return!1}async function Jo(e={}){let o=!1,r=Number.isFinite(Number(e.initialDelayMs))?Math.max(0,Number(e.initialDelayMs)):700,n=Number.isFinite(Number(e.pollDelayMs))?Math.max(250,Number(e.pollDelayMs)):1e3;for(let a=0;a<45;a+=1){await Jc(a===0?r:n);try{if(await D($r,"all",{forceMissing:!0}),Zn()==="rebooting"&&Wr("ota"),d(),t.updateInstallMode==="connection-switch"){let i=Hi(t.updateInstallTargetConnection);if(i&&_t()===i&&!Dr()&&!Qo())return!0}else if(t.updateInstallMode==="topology-switch"){let i=Nr(t.updateInstallTargetTopology);if(i&&ee()===i&&!Dr()&&!Qo())return!0}else if(_i()||Wi()||Ki()&&!Dr()&&!Qo())return!0}catch{o||(t.controlNotice="Wachten tot het device opnieuw is opgestart...",d(),o=!0)}}return!1}function pf(){let e=Wt(),o=kt();if(o)return o.copy;if(Vi()){let r=t.updateInstallCompletedVersion||le()||Wt();return`${Re()} draait nu op ${r}.`}return Qo()?`OTA-update wordt voorbereid voor ${Re()}. Het device kan kort herstarten.`:Ge()?`We controleren of er op kanaal ${e} een nieuwe firmware beschikbaar is.`:yo()?"Er staat een nieuwere firmware klaar.":Ki()?`Je draait al de nieuwste firmware op kanaal ${e}.`:"Kies een kanaal en controleer of er een nieuwere firmware klaarstaat."}function eu(){return!!(t.firmwareAdvancedOpen||t.firmwareConnectionSwitchOpen||t.firmwareTopologySwitchOpen||t.updateManualUploadOpen||t.updateTestFirmwareOpen)}function Gn(e,o,r,n,a=!1){return`
      <button
    ...
    `}function df(e,o,r,n){if(!eu())return"";let i=!!(kt()||t.updateInstallBusy||Ge());return`
      <div class="oq-helper-modal-callout oq-helper-modal-callout--subtle oq-firmware-advanced-panel">
        ...
        <div class="oq-firmware-advanced-options">
          ${e?Gn("toggle-firmware-connection-switch","Verbinding wisselen",`Naar ${o.targetLabel}`,t.firmwareConnectionSwitchOpen,i):""}
          ${r?Gn("toggle-firmware-topology-switch","Opstelling wisselen",`Naar ${n.targetLabel}`,t.firmwareTopologySwitchOpen,i):""}
          ${Gn("toggle-firmware-upload","Handmatige upload","Lokaal OTA-bestand",t.updateManualUploadOpen,i)}
          ${Gn("toggle-firmware-test","Testfirmware","PR-release installeren",t.updateTestFirmwareOpen,i)}
        </div>
        ${mf()}
        ${gf()}
        ${ff()}
    ...
    `}function hf(){if(!t.updateTestFirmwareOpen)return"";let o=!!(kt()||t.updateInstallBusy||Ge()),r=bo(),n=Yo(),a=Fr(r,n),i=!!(n.available&&h("firmwareTestOtaUrl")&&h("firmwareTestOtaMd5Url")&&h("installFirmwareTestOta")),l=!!(r&&i),p=t.updateTestFirmwareBuild||null,u=n.available?n.label:n.error,c=a?n.otaFileName:"Vul een PR-nummer in om de OTA-build te kiezen.";return`
      <div class="oq-firmware-advanced-detail">
        <div class="oq-firmware-advanced-detail-head">
    ...
    `}function ff(){if(!t.updateManualUploadOpen)return"";let o=!!(kt()||t.updateInstallBusy||Ge()),r=String(t.updateManualUploadFileName||t.updateManualUploadFile?.name||"").trim();return`
      <div class="oq-firmware-advanced-detail">
        <div class="oq-firmware-advanced-detail-head">
    ...
    `}function tu(){if(!t.updateModalOpen)return"";let e=me(),o=t.entities.firmwareUpdateChannel||null,{current:r,latest:n}=ji(),a=Ge(),i=Qo(),l=yo(),p=pf(),u=kt(),c=Vi(),m=Xh(),b=c?"Firmware-update afgerond":u||i?"Firmware-update bezig":a?"Controleren op firmware-update":ef(),y=o?Array.isArray(o.option)?o.option:Array.isArray(o.options)?o.options:[]:[],v=zn(),g=Qn(),f=!!(v&&!c),w=!!(g&&!c);return`
        ...
        <section class="oq-helper-modal oq-helper-modal--firmware oq-helper-modal--scrollable" role="dialog" aria-modal="true" aria-labelledby="oq-update-modal-title">
          ...
          <div class="oq-helper-modal-grid">
            ...
            <div class="oq-helper-modal-row">
              ...
              <strong class="oq-helper-modal-value">${s(Wt())}</strong>
            </div>
          </div>
          ${y.length?`
    ...
    `}function iu(){let e=nu(),o=e.some(i=>i.topicKey===t.mqttExpandedTopicKey)?t.mqttExpandedTopicKey:"",r=Zi(e),n=e.map(i=>{let l=Yi(i.topicKey),p=l||"Wordt geladen...",u=wf(i.ageKey),c=ea(i.topicKey),m=x(i.validKey),b=t.mqttCopiedTopicKey===i.topicKey,y=o===i.topicKey,v=t.mqttInputToggleBusyKey===i.topicKey,g=c?m?"valid":"invalid":"disabled",f=c?m?"geldig":"ongeldig":"uit",w=c?Qi(i.validKey):"Uitgeschakeld",S=c?m?`Laatste MQTT-publicatie ${u==="\u2014"?"onbekend":`${u} geleden`}. Zonder nieuwe MQTT-publicatie wordt de waarde na ${i.staleCopy} ongeldig.`:u==="\u2014"?"Nog geen geldige MQTT-publicatie ontvangen.":`Laatste MQTT-publicatie ${u} geleden; de waarde is niet meer geldig.`:"Dit topic wordt niet gebruikt. OpenQuatt subscribed er niet op.",q=c?"Topic uitschakelen":"Topic gebruiken";return`
        <article class="oq-settings-mqtt-sensor-row${y?" is-open":""}${c?"":" is-disabled"}">
          ...
          >
            ...
            <span class="oq-settings-mqtt-sensor-value">${c?vf(i):'<span class="oq-settings-mqtt-sensor-value-missing">\u2014</span>'}</span>
            <em
              ...
              <div class="oq-settings-mqtt-topic-row">
                <div class="oq-settings-mqtt-topic-field${b?" is-copied":""}">
                  ...
                  <button
                    ...
                    ${l?"":"disabled"}
                  >
                    ${Xe(b?"clipboard-check":"clipboard","oq-settings-mqtt-topic-copy-icon")}
                  </button>
                </div>
      ...
      <div class="oq-helper-modal-backdrop${t.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
        <section class="oq-helper-modal oq-helper-modal--mqtt-sensors" role="dialog" aria-modal="true" aria-labelledby="oq-mqtt-sensors-modal-title">
          <div class="oq-settings-mqtt-modal-head">
            <span class="oq-settings-mqtt-modal-icon">${Sf("oq-settings-mqtt-modal-logo")}</span>
            <div>
              <p class="oq-helper-modal-kicker">Integratie</p>
    ...
    `}function jr(){let e=t.authStatus;return e?e.enabled?e.setup_window_active?"Instelvenster":"Beveiligd":"Onbeveiligd":"Laden..."}function qf(){return"Login"}function Tf(){let e=t.authStatus;return e?e.enabled?"De web-app vraagt nu een login voordat beheer beschikbaar is. Je kunt die hier aanpassen of uitzetten.":"De web-app staat open op je netwerk. Houd de herstelknop 5 seconden vast om een login toe te voegen.":"We halen de huidige loginstatus op."}function Ur(){let e=t.authStatus;return e?e.enabled?e.setup_window_active?"Login actief. Tijdelijk instelvenster is open.":`Login actief${e.source?` via ${e.source}`:""}.`:e.setup_window_active?"Login uit. Tijdelijk instelvenster is open.":"Login uit. Webtoegang is open / onbeveiligd op het netwerk.":"Logingegevens laden..."}function Xo(){let e=t.apiSecurityStatus;return e?e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active?"Herstart nodig":e.transport_active===!0?"Aan":e.transport_active===!1?"Uit":e.enabled?"Aan":"Uit":"Laden..."}function er(){let e=t.apiSecurityStatus;return e?e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active?e.enabled===!0&&e.transport_active===!1?"API-encryptie wordt ingeschakeld na herstart. Kopieer de sleutel nu voor Home Assistant.":e.enabled===!1&&e.transport_active===!0?"API-encryptie wordt uitgeschakeld na herstart. Tot die tijd blijft de native API beveiligd.":e.key?"Deze wijziging wordt actief na herstart. De sleutel blijft opgeslagen voor later gebruik.":"Deze wijziging wordt actief na herstart.":e.transport_active===!0?"API-encryptie staat aan. Gebruik dezelfde sleutel in Home Assistant.":"De native API staat nu open op je lokale netwerk.":"API-encryptie wordt geladen."}function Ef(){return"ESPHome API encryption"}function kf(){let e=t.apiSecurityStatus;return e?e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active?e.enabled===!0&&e.transport_active===!1?"API-encryptie wordt ingeschakeld na herstart. Kopieer de sleutel nu alvast voor Home Assistant.":e.enabled===!1&&e.transport_active===!0?"API-encryptie wordt uitgeschakeld na herstart. Tot die tijd blijft de native API nog beveiligd.":"Deze wijziging wordt actief na herstart. Je kunt de sleutel hier bekijken, kopi\xEBren of vernieuwen.":e.transport_active===!0?"De native API is beveiligd. Je kunt de sleutel hier bekijken, kopi\xEBren of vernieuwen.":"API-encryptie staat uit. Schakel in om een sleutel te bekijken, kopi\xEBren of vernieuwen.":"We halen de huidige API-beveiliging op."}function Cf(){let e=t.apiSecurityStatus;if(!e)return"Laden...";let o=!!(e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active);return o&&e.enabled===!0&&e.transport_active===!1?"Annuleer inschakelen":o&&e.enabled===!1&&e.transport_active===!0?"Annuleer uitschakelen":e.enabled?"Uitschakelen":"Inschakelen"}function xf(){let e=t.apiSecurityStatus;return e?e.key?"Vernieuw sleutel":"Genereer sleutel":"Laden..."}function su(e,o,r="",n=!1){return`
        ...
        <section class="oq-helper-modal oq-helper-modal--wide" role="dialog" aria-modal="true" aria-labelledby="oq-api-security-modal-title">
          <div class="oq-helper-modal-head">
            <div>
              ...
              <h2 class="oq-helper-modal-title" id="oq-api-security-modal-title">${s(Ef())}</h2>
            </div>
          ...
          <p class="oq-helper-modal-copy">${s(kf())}</p>
          ...
          <div class="oq-settings-api-security-shell oq-settings-api-security-shell--modal">
            <div class="oq-settings-quickstart-status-row oq-settings-api-security-status-row">
              <div>
                ...
                <strong class="oq-settings-quickstart-status-value">${s(Xo())}</strong>
                <p class="oq-settings-quickstart-status-copy">${s(er())}</p>
              </div>
              <button
    ...
    `}function cu(){let e=t.authStatus||{},o=e.enabled===!0,r=e.setup_window_active===!0,n=o||r,a=o?String(e.username||"").trim():"",i=t.authNotice?`<div class="oq-helper-modal-success oq-helper-modal-success--compact" aria-live="polite"><strong>Opgeslagen</strong><span>${s(t.authNotice)}</span></div>`:"",l=t.authError?`<div class="oq-helper-modal-note oq-helper-modal-note--error" aria-live="assertive">${s(t.authError)}</div>`:"",u=n?`
      ...
      <div class="oq-helper-modal-backdrop${t.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
        <section class="oq-helper-modal" role="dialog" aria-modal="true" aria-labelledby="oq-login-modal-title">
          <div class="oq-helper-modal-head">
            <div>
              <p class="oq-helper-modal-kicker">Systeem</p>
              <h2 class="oq-helper-modal-title" id="oq-login-modal-title">${s(qf())}</h2>
            </div>
            <button class="oq-helper-modal-close" type="button" data-oq-action="close-system-modal" aria-label="Sluit login-popup">\xD7</button>
          </div>
          <p class="oq-helper-modal-copy">${s(Tf())}</p>
          ${i}
          ${l}
          <div class="oq-helper-modal-grid">
            ${su("Beveiligingsstatus",jr(),Ur())}
            ${su("Gebruiker",o?a||"Geen naam":"Geen login",o?"Deze naam gebruik je om in te loggen.":"Er staat nog geen login op het device.")}
          </div>
          ${u}
          <div class="oq-helper-modal-actions">
    ...
    `}async function pu(){let e=R.checkFirmwareUpdates;if(e){t.updateInstallCompleted=!1,t.updateInstallCompletedVersion="",t.updateCheckBusy=!0,t.controlError="",t.controlNotice="",d();try{await ta("current build",{poll:!1,force:!0}),Vr();let o=await fetch(U(e.domain,e.name,"press"),{method:"POST"});if(!o.ok)throw new Error(`HTTP ${o.status}`);await Br(),t.controlNotice="Firmwarecontrole bijgewerkt."}catch(o){t.controlError=`Firmwarecontrole mislukte. ${o.message}`}finally{t.updateCheckBusy=!1,d()}}}async function du(){try{await D($r,"all",{concurrency:wt,forceMissing:!0}),t.updateModalOpen&&d()}catch{}}async function ta(e,o={}){let r=R.firmwareUpdateTarget;if(!r||!h("firmwareUpdateTarget"))return!1;let n=String(e||"").trim();if(!n)return!1;if(!o.force&&String(E("firmwareUpdateTarget")||"").trim()===n)return!0;t.entities.firmwareUpdateTarget={...t.entities.firmwareUpdateTarget||{},state:n,value:n};let a=await fetch(`${U(r.domain,r.name,"set")}?option=${encodeURIComponent(n)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return o.poll!==!1?(Vr(),await Br({expectedBuildLabel:o.expectedBuildLabel||""})):!0}async function mu(){let e=me();if(e){t.firmwareAdvancedOpen=!1,t.updateManualUploadOpen=!1,t.firmwareConnectionSwitchOpen=!1,t.firmwareTopologySwitchOpen=!1,t.updateTestFirmwareOpen=!1,t.firmwareConnectionSwitchConfirmed=!1,t.firmwareTopologySwitchConfirmed=!1,ke(),Ue(),t.updateInstallCompleted=!1,t.updateInstallCompletedVersion="",t.updateInstallBusy=!0,t.updateInstallTargetVersion=Bt(e),t.updateInstallPhaseHint="starting",t.updateInstallProgressHint=0,t.updateInstallMode="normal",t.updateInstallTargetConnection="",t.updateInstallTargetTopology="",t.controlError="",t.controlNotice="",d();try{await ta("current build",{poll:!1,force:!0}),t.updateInstallTargetVersion=Bt(me()||{})||t.updateInstallTargetVersion,_r();let o=R.installFirmwareUpdateTarget,r=o&&h("installFirmwareUpdateTarget")?U(o.domain,o.name,"press"):U("update","Firmware Update","install"),n=await fetch(r,{method:"POST"});if(!n.ok)throw new Error(`HTTP ${n.status}`);await Jo({initialDelayMs:mo,pollDelayMs:Hr})?(t.updateInstallCompleted=!0,t.updateInstallCompletedVersion=le()||t.updateInstallTargetVersion,t.controlNotice=""):t.controlNotice="OTA-update gestart. Wacht tot het device weer online is."}catch(o){t.controlError=`OTA-update kon niet worden gestart. ${o.message}`}finally{Zo(),d()}}}async function gu(){let e=zn(),o=R.installFirmwareUpdateTarget;if(!(!e||!e.canSwitch||!o)){if(!t.firmwareConnectionSwitchConfirmed){t.controlError="Bevestig eerst de waarschuwing voor de verbindingswissel.",d();return}t.updateManualUploadOpen=!1,t.firmwareTopologySwitchOpen=!1,t.firmwareTopologySwitchConfirmed=!1,ke(),t.updateInstallCompleted=!1,t.updateInstallCompletedVersion="",t.updateInstallBusy=!0,t.updateInstallMode="connection-switch",t.updateInstallTargetConnection=e.targetConnection,t.updateInstallTargetTopology=ee(),t.updateInstallTargetVersion=le()||"",t.updateInstallPhaseHint="starting",t.updateInstallProgressHint=0,t.controlError="",t.controlNotice="",d();try{if(!await ta("alternate connection",{force:!0,expectedBuildLabel:e.targetBuildLabel}))throw new Error("Doelmanifest is nog niet geladen. Probeer het over enkele seconden opnieuw.");t.updateInstallTargetVersion=Bt(me()||{})||le()||"",t.updateInstallPhaseHint="starting",t.updateInstallProgressHint=0,d(),_r();let n=await fetch(U(o.domain,o.name,"press"),{method:"POST"});if(!n.ok)throw new Error(`HTTP ${n.status}`);if(await Jo({initialDelayMs:mo,pollDelayMs:Hr}))t.updateInstallCompleted=!0,t.updateInstallCompletedVersion=le()||t.updateInstallTargetVersion||"",t.firmwareConnectionSwitchConfirmed=!1,t.controlNotice="";else{let i=je(e.targetConnection);t.controlNotice=`Verbindingswissel naar ${i} is gestart. Wacht tot het device via die verbinding terugkomt.`}}catch(r){t.controlError=`Verbindingswissel kon niet worden gestart. ${r.message}`}finally{Zo(),d()}}}async function hu(){let e=Qn(),o=R.installFirmwareUpdateTarget;if(!(!e||!e.canSwitch||!o)){if(!t.firmwareTopologySwitchConfirmed){t.controlError="Bevestig eerst de waarschuwing voor de opstellingswissel.",d();return}t.updateManualUploadOpen=!1,t.firmwareConnectionSwitchOpen=!1,t.firmwareConnectionSwitchConfirmed=!1,t.firmwareTopologySwitchOpen=!1,t.firmwareTopologySwitchConfirmed=!1,ke(),t.updateInstallCompleted=!1,t.updateInstallCompletedVersion="",t.updateInstallBusy=!0,t.updateInstallMode="topology-switch",t.updateInstallTargetConnection=e.targetConnection,t.updateInstallTargetTopology=e.targetTopology,t.updateInstallTargetVersion=le()||"",t.updateInstallPhaseHint="starting",t.updateInstallProgressHint=0,t.controlError="",t.controlNotice="",d();try{if(!await ta("alternate topology",{force:!0,expectedBuildLabel:e.targetBuildLabel}))throw new Error("Doelmanifest is nog niet geladen. Probeer het over enkele seconden opnieuw.");t.updateInstallTargetVersion=Bt(me()||{})||le()||"",t.updateInstallPhaseHint="starting",t.updateInstallProgressHint=0,d(),_r();let n=await fetch(U(o.domain,o.name,"press"),{method:"POST"});if(!n.ok)throw new Error(`HTTP ${n.status}`);if(await Jo({initialDelayMs:mo,pollDelayMs:Hr}))t.updateInstallCompleted=!0,t.updateInstallCompletedVersion=le()||t.updateInstallTargetVersion||"",t.firmwareTopologySwitchConfirmed=!1,t.controlNotice="";else{let i=fo(e.targetTopology);t.controlNotice=`Opstellingswissel naar ${i} is gestart. Wacht tot het device met die opstelling terugkomt.`}}catch(r){t.controlError=`Opstellingswissel kon niet worden gestart. ${r.message}`}finally{Zo(),d()}}}async function $f(e,o){let r=Fr(e,o);if(!r)throw new Error("Geen geldig PR-target gevonden.");let n=await fetch(r.releaseApiUrl,{cache:"no-store",headers:{Accept:"application/vnd.github+json"}});if(n.status===404)throw new Error(`Geen testfirmware gevonden voor PR ${e}. Controleer of het label de build al heeft gepubliceerd.`);if(!n.ok)throw new Error(`GitHub API gaf HTTP ${n.status}`);let a=await n.json(),i=Array.isArray(a.assets)?a.assets:[],l=i.find(m=>m&&m.name===o.otaFileName),p=i.find(m=>m&&m.name===o.md5FileName);if(!l||!l.browser_download_url)throw new Error(`PR ${e} bevat geen OTA-build voor ${o.label}.`);if(!p||!p.browser_download_url)throw new Error(`PR ${e} mist de md5-controle voor ${o.label}.`);let u=String(a.name||a.tag_name||`PR ${e}`).trim(),c=String(l.updated_at||a.published_at||"").trim();return{otaUrl:l.browser_download_url,md5Url:p.browser_download_url,label:c?`${u} \xB7 ${c.replace("T"," ").replace("Z"," UTC")}`:u}}async function uu(e,o){if(!h(e))throw new Error(`${R[e]?.name||e} is niet beschikbaar op deze firmware.`);let r=await jt(e,o);t.entities[e]={...t.entities[e]||{},state:r,value:r}}async function fu(){let e=bo(),o=Yo(),r=R.installFirmwareTestOta;if(!e){t.updateTestFirmwareError="Vul een geldig PR-nummer in.",d();return}if(!o.available){t.updateTestFirmwareError=o.error||"Dit firmwaretarget wordt niet herkend.",d();return}if(!t.updateTestFirmwareConfirmed){t.updateTestFirmwareError="Bevestig eerst dat je testfirmware wilt installeren.",d();return}if(!r||!h("installFirmwareTestOta")){t.updateTestFirmwareError="Deze firmware bevat de testfirmware-installatieknop nog niet.",d();return}t.updateManualUploadOpen=!1,t.firmwareConnectionSwitchOpen=!1,t.firmwareConnectionSwitchConfirmed=!1,t.firmwareTopologySwitchOpen=!1,t.firmwareTopologySwitchConfirmed=!1,ke(),t.updateInstallCompleted=!1,t.updateInstallCompletedVersion="",t.updateInstallBusy=!0,t.updateInstallTargetVersion="",t.updateInstallPhaseHint="starting",t.updateInstallProgressHint=0,t.updateInstallMode="test-firmware",t.updateInstallTargetConnection="",t.updateInstallTargetTopology="",t.controlError="",t.controlNotice="",t.updateTestFirmwareError="",t.updateTestFirmwareBuild=null,d();let n=!1;try{let a=await $f(e,o);t.updateTestFirmwareBuild=a.label,d(),await uu("firmwareTestOtaUrl",a.otaUrl),await uu("firmwareTestOtaMd5Url",a.md5Url),n=!0,_r();let i=await fetch(U(r.domain,r.name,"press"),{method:"POST"});if(!i.ok)throw new Error(`HTTP ${i.status}`);await Jo({initialDelayMs:mo,pollDelayMs:Hr})?(t.updateInstallCompleted=!0,t.updateInstallCompletedVersion=le()||`PR ${e}`,t.updateTestFirmwareOpen=!1,Ue(),t.controlNotice=""):t.controlNotice=`Testfirmware uit PR ${e} is gestart. Wacht tot het device weer online is.`}catch(a){n&&Ji(a.message)?t.controlNotice=`Testfirmware uit PR ${e} is gestart. Wacht tot het device weer online is.`:t.updateTestFirmwareError=`Testfirmware installeren mislukte. ${a.message}`}finally{Zo(),d()}}async function bu(){let e=t.updateManualUploadFile;if(!e){t.updateManualUploadError="Kies eerst een firmwarebestand.",d();return}t.updateInstallCompleted=!1,t.updateInstallCompletedVersion="",t.updateInstallBusy=!0,t.updateInstallTargetVersion=le()||"",t.updateInstallPhaseHint="starting",t.updateInstallProgressHint=0,t.updateInstallMode="",t.updateInstallTargetConnection="",t.updateInstallTargetTopology="",t.controlError="",t.controlNotice="",t.updateManualUploadError="",d();try{let o=new FormData;o.append("update",e,e.name||"firmware.bin");let r=await fetch("/update",{method:"POST",body:o});if(!r.ok)throw new Error(`HTTP ${r.status}`);t.updateManualUploadOpen=!1,ke(),await Jo()?(t.updateInstallCompleted=!0,t.updateInstallCompletedVersion=le()||t.updateInstallTargetVersion||"",t.controlNotice=""):t.controlNotice="Handmatige OTA-upload gestart. Wacht tot het device weer online is."}catch(o){t.updateManualUploadError=`Handmatige upload mislukte. ${o.message}`}finally{Zo(),d()}}function Xi(e=t.mqttStatus||{}){let o=e.input_topics&&typeof e.input_topics=="object"?e.input_topics:{},r=e.input_enabled&&typeof e.input_enabled=="object"?e.input_enabled:{};return[e.enabled?"on":"off",e.connected?"connected":"idle",String(e.broker||""),String(e.port||""),String(e.username||""),e.password_set?"password":"nopassword",String(e.dew_point_topic||""),JSON.stringify(o),JSON.stringify(r),String(e.source||""),String(e.csrf_token||"")].join(":")}function oa(){return[t.systemModal,t.mqttExpandedTopicKey||"",t.mqttCopiedTopicKey||"",t.mqttInputToggleBusyKey||"",t.mqttError||"",Xi(),K("mqttCoolingDewPoint"),K("mqttCoolingDewPointAge"),K("mqttCoolingDewPointValid"),K("mqttOutsideTemperature"),K("mqttOutsideTemperatureAge"),K("mqttOutsideTemperatureValid"),K("mqttRoomTemperature"),K("mqttRoomTemperatureAge"),K("mqttRoomTemperatureValid"),K("mqttRoomSetpoint"),K("mqttRoomSetpointAge"),K("mqttRoomSetpointValid"),K("mqttHeatingEnable"),K("mqttHeatingEnableAge"),K("mqttHeatingEnableValid"),K("mqttCoolingEnable"),K("mqttCoolingEnableAge"),K("mqttCoolingEnableValid")].join("|")}function es(){let e=t.mqttStatus||{};t.mqttDraftEnabled=e.enabled===!0,t.mqttDraftBroker=String(e.broker||""),t.mqttDraftPort=String(e.port||1883),t.mqttDraftUsername=String(e.username||""),t.mqttDraftPassword="",t.mqttDraftClearPassword=!1,t.mqttDraftDirty=!1}function yu(e){let o=e?.dataset?.oqMqttField;if(!o)return!1;if(t.mqttNotice="",t.mqttError="",t.mqttDraftDirty=!0,o==="enabled")t.mqttDraftEnabled=!!e.checked;else if(o==="broker")t.mqttDraftBroker=String(e.value||"");else if(o==="port")t.mqttDraftPort=String(e.value||"");else if(o==="username")t.mqttDraftUsername=String(e.value||"");else if(o==="password")t.mqttDraftPassword=String(e.value||"");else if(o==="clear-password"){t.mqttDraftClearPassword=!!e.checked,t.mqttDraftClearPassword&&(t.mqttDraftPassword="");let r=e.closest(".oq-helper-modal")?.querySelector('[data-oq-mqtt-field="password"]');r&&(r.value=t.mqttDraftPassword,r.disabled=t.mqttBusy||t.mqttDraftClearPassword)}return e.closest(".oq-helper-modal")?.querySelectorAll(".oq-helper-modal-success, .oq-helper-modal-note--error").forEach(r=>{r.remove()}),!0}function vu(){return t.systemModal==="mqtt"||t.systemModal==="mqtt-sensors"||Tu()}async function vo(e={}){if(!Gr(t.lastMqttStatusRefreshAt,e))return!1;t.lastMqttStatusRefreshAt=Date.now();try{let o=await fetch("/mqtt/status",{cache:"no-store"});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json(),n=r.input_topics&&typeof r.input_topics=="object"?r.input_topics:{},a={};Object.entries(n).forEach(([b,y])=>{a[String(b)]=String(y||"")});let i=r.input_enabled&&typeof r.input_enabled=="object"?r.input_enabled:{},l={};Object.entries(i).forEach(([b,y])=>{l[String(b)]=y!==!1&&String(y).toLowerCase()!=="false"});let p=String(a.cooling_dew_point||r.dew_point_topic||"");a.cooling_dew_point=p;let u={enabled:!!r.enabled,connected:!!r.connected,broker:String(r.broker||""),port:Number(r.port||1883),username:String(r.username||""),password_set:!!r.password_set,dew_point_topic:p,input_topics:a,input_enabled:l,source:String(r.source||""),csrf_token:String(r.csrf_token||"")},c=Xi(),m=Xi(u);return t.mqttStatus=u,c!==m&&(t.systemModal==="mqtt"&&t.mqttDraftDirty||es(),t.mqttNotice=""),t.mqttError="",c!==m}catch(o){return t.mqttError=`MQTT-status kon niet worden geladen. ${o.message}`,!1}}async function wu(e="cooling_dew_point"){let o=Yi(e);if(!o){t.mqttError="MQTT-topic is nog niet geladen.",t.mqttCopiedTopicKey="",d();return}try{let r=await It(o);t.mqttNotice="",t.mqttError=r?"":"Kopi\xEBren is niet gelukt.",t.mqttCopiedTopicKey=r?e:"",t.mqttCopiedTopicTimer&&window.clearTimeout(t.mqttCopiedTopicTimer),r&&(t.mqttCopiedTopicTimer=window.setTimeout(()=>{t.mqttCopiedTopicKey="",t.mqttCopiedTopicTimer=null,t.systemModal==="mqtt-sensors"&&d()},1800))}catch(r){t.mqttError=`Kopi\xEBren is mislukt. ${r.message}`,t.mqttCopiedTopicKey=""}d()}async function Su(e,o){let r=t.mqttStatus||{};if(!r.csrf_token){t.mqttError="MQTT-status wordt nog geladen. Probeer het zo opnieuw.",d();return}t.mqttInputToggleBusyKey=e,t.mqttNotice="",t.mqttError="",d();try{let n=new URLSearchParams;n.set("csrf_token",r.csrf_token),n.set("input",e),n.set("enabled",o?"true":"false");let a=await fetch("/mqtt/input/save",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:n}),i=await a.json().catch(()=>({}));if(!a.ok||i?.ok===!1)throw new Error(i?.error||`HTTP ${a.status}`);t.lastMqttStatusRefreshAt=0,await vo({force:!0})}catch(n){t.mqttError=`MQTT-topic kon niet worden opgeslagen. ${n.message}`}finally{t.mqttInputToggleBusyKey===e&&(t.mqttInputToggleBusyKey=""),d()}}async function qu(){let e=t.mqttStatus||{},o=!!t.mqttDraftEnabled,r=String(t.mqttDraftBroker||"").trim(),n=Number(String(t.mqttDraftPort||"").trim()),a=String(t.mqttDraftUsername||"").trim(),i=!!t.mqttDraftClearPassword,l=i?"":String(t.mqttDraftPassword||"");if(!e.csrf_token){t.mqttError="MQTT-configuratie laadt nog. Probeer het zo opnieuw.",d();return}if(!Number.isInteger(n)||n<1||n>65535){t.mqttError="Vul een geldige poort in.",d();return}if(o&&!r){t.mqttError="Vul een broker in als je MQTT inschakelt.",d();return}t.mqttBusy=!0,t.mqttNotice="",t.mqttError="",d();try{let p=new URLSearchParams;p.set("csrf_token",e.csrf_token),p.set("enabled",o?"true":"false"),p.set("broker",r),p.set("port",String(n)),p.set("username",a),p.set("password",l),p.set("clear_password",i?"true":"false");let u=await fetch("/mqtt/save",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=UTF-8"},body:p.toString()}),c=await u.json().catch(()=>({ok:!1,error:"invalid_response"}));if(!u.ok||!c.ok)throw new Error(c.error||`HTTP ${u.status}`);t.mqttDraftDirty=!1,await vo({force:!0}),t.mqttDraftPassword="",t.mqttDraftClearPassword=!1,t.mqttNotice=o?"MQTT inputbronnen staan aan.":"MQTT-configuratie opgeslagen.",t.mqttError="",d()}catch(p){t.mqttError=`Opslaan is mislukt. ${p.message}`,d()}finally{t.mqttBusy=!1,d()}}function Af(e=!1){let o=In();return o?`
    ...
    `:""}function os(){return`
      <div class="oq-settings-curve-grid">
        ${de.map(e=>ie(e.key,`Aanvoertemp. bij ${e.label}`,`Doelaanvoertemperatuur bij ${e.label} buitentemperatuur.`)).join("")}
        ${ie("curveFallbackSupply","Fallback-aanvoertemperatuur zonder buitentemperatuur","Aanvoertemperatuur die gebruikt wordt als de buitentemperatuursensor niet beschikbaar is.","oq-settings-field--curve-fallback-card",{footerMarkup:Af()})}
      </div>
    `}function rs(e="oq-settings-grid"){return`
      <div class="${s(e)}">
        ${Ut("strategy","Verwarmingsstrategie","Kies tussen automatisch regelen met Power House of regelen met een stooklijn.")}
      </div>
    `}function ns(e="oq-settings-grid"){let o=[ie("flowSetpoint","Gewenste flow verwarmen","De flow die OpenQuatt zoveel mogelijk probeert vast te houden buiten koeling."),ie("coolingFlowSetpoint","Gewenste flow koelen","De flow die OpenQuatt gebruikt tijdens actieve koeling.")].filter(Boolean).join("");return`
      <div class="${s(e)}">
        ${Ut("flowControlMode","Regelmodus","Kies tussen automatische flowregeling en een vaste pompstand.")}
        ${dc()?ie("manualIpwm","Vaste pompstand","Deze pompstand wordt gebruikt zolang de regeling op handmatig staat."):o}
      </div>
    `}function Hf(e="oq-settings-grid"){let o=[ie("flowKp","Flow PI Kp","Hoe sterk de regeling direct reageert op een afwijking."),ie("flowKi","Flow PI Ki","Hoe snel de regeling kleine restfouten wegwerkt.")].filter(Boolean);return o.length?`
      <div class="${s(e)}">
        ${o.join("")}
      </div>
    ...
    `}function Mf(){if(!h("phResponseProfile"))return"";let e=String(E("phResponseProfile")||""),o=t.loadingEntities||t.busyAction==="save-phResponseProfile",n=`
        ...
        ${[{value:"Calm",label:"Rustig",rise:"12 min",fall:"5 min",meta:"Opbouw 12 min \xB7 Afbouw 5 min",copy:"Reageert minder snel op schommelingen. Fijn voor vloerverwarming of een woning die traag opwarmt en afkoelt."},{value:"Balanced",label:"Gebalanceerd",rise:"8 min",fall:"3 min",meta:"Opbouw 8 min \xB7 Afbouw 3 min",copy:"Goede middenweg tussen comfort en rust. Meestal het beste startpunt voor dagelijks gebruik."},{value:"Responsive",label:"Direct",rise:"5 min",fall:"2 min",meta:"Opbouw 5 min \xB7 Afbouw 2 min",copy:"Reageert sneller op veranderende warmtevraag. Handig als je woning snel afkoelt of je sneller effect wilt zien."},{value:"Custom",label:"Aangepast",rise:"Vrij",fall:"Instelbaar",meta:"Opbouw en afbouw instelbaar",copy:"Stel zelf in hoe snel de regeling op- en afbouwt. Handig als de standaardprofielen net niet goed passen."}].map(a=>{let i=a.value===e;return a.value==="Custom"&&i?`
              <div class="oq-settings-choice-card oq-settings-choice-card--static oq-settings-choice-card--custom is-active">
                ...
                <div class="oq-settings-choice-inline-grid oq-settings-choice-inline-grid--inside-card">
                  ${ts("phDemandRiseTime","Opbouwtijd","Tijd waarmee de warmtevraag bij oplopende vraag naar het nieuwe niveau toeloopt.",{compact:!0,showCopy:!1,infoId:"phDemandRiseTime-inline",embedded:!0})}
                  ${ts("phDemandFallTime","Afbouwtijd","Tijd waarmee de warmtevraag bij afnemende vraag weer terugzakt.",{compact:!0,showCopy:!1,infoId:"phDemandFallTime-inline",embedded:!0})}
                </div>
              </div>
            `:tr({key:"phResponseProfile",option:a.value,currentValue:e,busy:o,copy:a.copy,meta:a.meta})}).join("")}
      </div>
    `;return ue("phResponseProfile","Power House responsprofiel","Kies hoe rustig of direct Power House mag reageren op veranderingen in je woning.",n,"oq-settings-field--span-2")}function ss(){if(!h("curveControlProfile"))return"";let e=String(E("curveControlProfile")||""),o=t.loadingEntities||t.busyAction==="save-curveControlProfile",n=`
    ...
    `;return ue("curveControlProfile","Regelprofiel","Kies of de stooklijn vooral comfortabel, gebalanceerd of rustig moet reageren.",n,"oq-settings-field--span-2")}function Rf(){let e=(L,Y=0)=>{let N=A(L);return Number.isNaN(N)?Y:Math.max(0,N)},r=e("phComfortBelow",.1),n=e("phComfortAbove",.3),a=e("phKp",3e3),i=20-r,l=20+n,p=620,u=184,c=46,m=24,b=18,y=40,v=96,g=p-c-m,f=Math.min(20-1.2,i-.35),w=Math.max(20+1.2,l+.35),S=L=>c+(L-f)/Math.max(.01,w-f)*g,q=S(f),k=S(w),$=S(i),H=S(20),W=S(l),B=Math.abs(i-20)>.001,M=Math.abs(l-20)>.001,I=b+24,z=u-y,re=v-44,ge=(L,Y,N,F="")=>{let P=Math.max(q+4,Math.min(k-110-4,L-55)),V=L-14,Q=re,J=28,X=v-re+16;return`
      ...
      `},Z=[`M ${q.toFixed(1)} ${I.toFixed(1)}`,`L ${$.toFixed(1)} ${v.toFixed(1)}`,`L ${W.toFixed(1)} ${v.toFixed(1)}`,`L ${k.toFixed(1)} ${z.toFixed(1)}`].join(" ");return`
      <div class="oq-ph-concept-card">
        <div class="oq-ph-concept-visual">
          ...
          <svg class="oq-ph-concept-svg" viewBox="0 0 ${p} ${u}" role="img" aria-label="Grafiek voor Power House tuning">
            ...
            <rect x="${W.toFixed(1)}" y="${b}" width="${Math.max(20,k-W).toFixed(1)}" height="${(u-b-y).toFixed(1)}" rx="18" class="oq-ph-concept-band oq-ph-concept-band--above"></rect>

            <line x1="${q}" y1="${b}" x2="${q}" y2="${u-y}" class="oq-ph-concept-axis"></line>
            <line x1="${q}" y1="${v}" x2="${k}" y2="${v}" class="oq-ph-concept-axis"></line>
            ...
            ${B?ge($,"Comfort onder setpoint",_(i,1,"\xB0C"),"below"):""}
            ${ge(H,"Setpoint",_(20,1,"\xB0C"),"setpoint")}
            ${M?ge(W,"Comfort boven setpoint",_(l,1,"\xB0C"),"above"):""}
    ...
    `:""}function cs(e,o,r){let n=[Ut(o,"Stand A","Kies hier welke compressorstand je wilt uitsluiten."),Ut(r,"Stand B","Kies hier nog een compressorstand die je wilt overslaan.")].filter(Boolean).join("");return n?`
    ...
    `:""}function Eu(){let e=Hf();return te("Installatie","Flowregeling","Kies hoe de pomp wordt geregeld en stel de flow-instellingen direct als installatieparameter in. De autotune vind je later bij Service & commissioning.",`
        ${ns()}
        ${e?`
          <div class="oq-settings-subpanel oq-settings-subpanel--nested">
            <div class="oq-settings-subpanel-head">
      ...
      `;return te("Regeling","Verwarmingsstrategie","Kies hier hoe OpenQuatt je verwarming regelt. De instellingen hieronder passen zich automatisch aan.",`
        ...
        ${is()}
        ${e}
      `)}function us(){let r={top:22,right:18,bottom:38,left:34},n=560-r.left-r.right,a=240-r.top-r.bottom,i=de[0].outdoor,l=de[de.length-1].outdoor,p=v=>r.left+(v-i)/(l-i)*n,u=v=>r.top+(70-v)/50*a,c=[20,30,40,50,60,70].map(v=>{let g=u(v);return`
      ...
      `).join(""),b=de.map(v=>`${p(v.outdoor)},${u(qe(v.key,E(v.key)))}`).join(" "),y=de.map(v=>{let g=qe(v.key,E(v.key));return`
          <g>
            <circle
              cx="${p(v.outdoor)}"
              cy="${u(g)}"
    ...
    `}function ds(e){let o=String(e||"").trim();return o?{Ready:"Gereed","Waiting for room request":"Koeling toegestaan, wacht op kamertemperatuur boven koel-setpoint","Cooling enabled, waiting for room temperature above cooling setpoint":"Koeling toegestaan, wacht op kamertemperatuur boven koel-setpoint","No dew point source":"Geen dauwpuntbron","OpenQuatt paused":"OpenQuatt gepauzeerd","Cooling disabled":"Koeling uitgeschakeld","Cooling minimum unavailable":"Minimale koel-aanvoer onbekend","Flow too low":"Flow te laag","Fallback active":"Dauwpuntsbenadering actief","Fallback active (+0.5\xB0C warm night)":"Dauwpuntsbenadering actief (+0,5\xB0C warme nacht)","Fallback active (+1.0\xB0C very warm night)":"Dauwpuntsbenadering actief (+1,0\xB0C zeer warme nacht)","Fallback active (+1.5\xB0C tropical night)":"Dauwpuntsbenadering actief (+1,5\xB0C tropische nacht)","User responsibility (no dew point or fallback)":"Expliciet toegestaan (geen dauwpunt of benadering)","Fallback cooling active":"Dauwpuntsbenadering actief","Fallback corrected by warm night":"Dauwpuntsbenadering gecorrigeerd door warme nacht","Fallback blocked by tropical night":"Dauwpuntsbenadering geblokkeerd door tropische nacht"}[o]||o:""}function Cu(){let e=!h("coolingRoomRequestRequired")||x("coolingRoomRequestRequired"),o=[ie("coolingMinimumSupplyTemp","Minimale koel-aanvoer","Ondergrens voor het koeldoel. OpenQuatt gebruikt de hoogste waarde van deze instelling en de dauwpuntveilige grens."),ze("coolingDemandMax","Maximale koelsterkte","Bepaalt hoe krachtig OpenQuatt mag koelen. Lager geeft langere, rustigere runs; hoger geeft meer koelvermogen bij warm weer.","",{minLabel:"Rustig",maxLabel:"Krachtig",valueLabel:`${j("coolingDemandMax")} max`}),ie("coolingRestartDelta","Herstartmarge watertemperatuur","Na het bereiken van het koel-aanvoerdoel start de watercyclus pas opnieuw zodra de aanvoer deze marge boven het doel ligt."),ie("coolingSafetyMargin","Dauwpunt veiligheidsmarge","Extra marge boven het geselecteerde dauwpunt voor de minimale veilige watertemperatuur.")].filter(Boolean),r=[h("coolingRoomRequestRequired")?xu("coolingRoomRequestRequired","Koelvraag via kamerthermostaat","Aan: OpenQuatt wacht op echte koelvraag vanuit de kamer. Uit: koeltoestemming geldt direct als koelvraag.","Koelvraag start en stopt met de marges hieronder.","Koeltoestemming geldt direct als koelvraag. De start- en stopmarge worden nu niet gebruikt.","oq-settings-field--span-2"):"",e?ie("coolingRequestOnDelta","Koelvraag start boven setpoint","Koelvraag wordt actief zodra de kamer warmer is dan setpoint plus deze marge."):"",e?ie("coolingRequestOffDelta","Koelvraag stopt boven setpoint","Koelvraag valt weer af zodra de kamer koeler is dan setpoint plus deze marge."):""].filter(Boolean),n=r.length>0,a=h("coolingWithoutDewPointMode"),i=[h("coolingGuardMode")?zr("Route",ye(O("coolingGuardMode","Onbekend"))):"",h("coolingEffectiveMinSupplyTemp")?zr("Actieve ondergrens",O("coolingEffectiveMinSupplyTemp","\u2014")):""].filter(Boolean),l=i.length?ue("coolingGuardStatus","Actuele beveiliging","Laat zien welke route koeling nu begrenst en welke ondergrens daadwerkelijk geldt.",`<div class="oq-settings-cooling-facts">${i.join("")}</div>`,"oq-settings-field--span-2 oq-settings-field--cooling-status"):"",p=[h("outsideTempSelected")?zr("Actuele buitentemperatuur",O("outsideTempSelected","\u2014")):"",h("coolingFallbackNightMinOutdoorTemp")?zr("Nachtminimum buitentemperatuur",O("coolingFallbackNightMinOutdoorTemp","\u2014")):"",h("coolingFallbackMinSupplyTemp")?zr("Berekende minimum watertemperatuur",O("coolingFallbackMinSupplyTemp","\u2014")):""].filter(Boolean),u=p.length?`<div class="oq-settings-cooling-fallback-metrics">${p.join("")}</div>`:"",c=a||p.length>0,b=O("coolingGuardMode","").toLowerCase().includes("fallback");if(!o.length&&!n&&!a&&!l&&!c)return"";let y={"Dew point required":"Gebruik alleen een betrouwbare dauwpuntmeting. Zonder meting blijft koeling uit.","Allow without dew point":"Gebruik dauwpunt waar mogelijk. Zonder meting geldt de conservatieve benadering hieronder.","Allow without dew point, use fallback":"Gebruik dauwpunt waar mogelijk. Zonder meting geldt de conservatieve benadering hieronder.","Allow without dew point, use dew point approximation":"Gebruik dauwpunt waar mogelijk. Zonder meting geldt de conservatieve benadering hieronder.","Allow without dew point, user responsibility":"Negeer dauwpunt en benadering; alleen de ingestelde minimale koel-aanvoer geldt."};return te("Koeling","Koelingsinstellingen","Stel hier in wanneer koelvraag ontstaat, hoe koud het water mag worden en hoeveel het water mag opwarmen voor herstart.",`
        ...
        ${a||l||c?`
          <div class="oq-settings-grid">
            ${a?$u("coolingWithoutDewPointMode","Keuze koelbeveiliging","Kies welke veiligheidsgrens OpenQuatt gebruikt: dauwpuntmeting, dauwpuntsbenadering bij ontbrekende meting, of expliciet toestaan zonder dauwpuntgrens.",y,"oq-settings-field--span-2 oq-settings-field--cooling-guard-choice"):""}
            ${l}
            ${c?`
        ...
        `:""}
      `)}function Pf({label:e,value:o,tone:r,note:n,status:a=!1}){return`
      <article class="oq-overview-stat oq-overview-stat--${s(r)}${a?" oq-overview-stat--status":""}">
        <p>${s(e)}</p>
        <strong>${s(o)}</strong>
        <span>${s(n)}</span>
      </article>
    `}function Yr(e,o=!1){return e.map(r=>Pf({...r,value:Object.prototype.hasOwnProperty.call(r,"key")?Ke(r.key):r.value,status:o})).join("")}function fs(e){return`
      <div class="oq-overview-sectionhead">
        <h3>${s(e)}</h3>
      </div>
    `}function bs(){let e=zt();return`
    ...
    `}function Mu({className:e,title:o,copy:r,body:n,signature:a=""}){let i=a?` data-render-signature="${s(a)}"`:"";return`
      <section class="${s(e)}"${i}>
        ${o?`<div class="oq-overview-system-copy"><h3>${s(o)}</h3><p>${s(r)}</p></div>`:""}
        ${n}
      </section>
    `}function ys(e,o){return o?"Actief":e==="Stand-by"?"Stand-by":e==="Onbekend"?"Onbekend":"Niet actief"}function Nf(e,o){let r=o?"active":"neutral",n=ys(e,o);return`<span class="oq-overview-chip oq-overview-chip--${s(r)}" data-oq-bind="panel-status">${s(n)}</span>`}function Of(e){return`
      <span
    ...
    `}function vs(e,o,r,n){return`${r?Of(n):""}${Nf(e,o)}`}function Ru(e,o,r,n,a){if(!e)return;let i=ve({mode:o,running:r,warningActive:n,failureText:a});e.dataset.renderSignature!==i&&(xt(e,vs(o,r,n,a)),e.dataset.renderSignature=i)}function na(e,o,r=""){return`
      <div class="oq-overview-row">
        <span>${s(e)}</span>
        <strong>${s(r||O(o))}</strong>
      </div>
    `}function Lf(e,o,r="blue",n=""){return`
      <article class="oq-overview-metric oq-overview-metric--${s(r)}">
        <span>${s(e)}</span>
        <strong>${s(o)}</strong>
        ${n?`<p>${s(n)}</p>`:""}
      </article>
    `}function Df(e){return Number.isNaN(e)?"\u2014":`${e>0?"+":""}${e.toFixed(1)} \xB0C`}function Ff(e){if(!Number.isFinite(e)||e<0)return"\u2014";let o=Math.floor(e),r=Math.floor(o/1440),n=Math.floor(o%1440/60),a=o%60;return r>0?`${r}d ${n}u`:n>0?`${n}u ${a}m`:`${a}m`}function If(e){let r=String(e||"").trim().match(/^(\d{1,2}):(\d{2})$/);if(!r)return Number.NaN;let n=Number(r[1]),a=Number(r[2]);return Number.isNaN(n)||Number.isNaN(a)||n<0||n>23||a<0||a>59?Number.NaN:n*60+a}function _f(e){let o=If(O("timeNowHhmm",""));if(!Number.isFinite(o))return"";let r=Math.round(e),n=((o-r)%1440+1440)%1440,a=Math.floor(n/60),i=n%60;return`${String(a).padStart(2,"0")}:${String(i).padStart(2,"0")}`}function Wf(e,o){let r=Math.max(0,(Number(o)-Number(e))/6e4),n=Ff(r),a=h("timeValid")&&x("timeValid")?_f(r):"";return a?{value:a,note:`${n} geleden`}:{value:`${n} geleden`,note:"Geen tijdsync"}}function Vf(e){let o=Number(e);return Number.isNaN(o)?"\u2014":`${o>0?"+":o<0?"-":""}${Math.abs(o).toFixed(0)} W`}function Pu(){return["outsideTempSelected","hp1OutsideTemp","hp2OutsideTemp"].find(e=>h(e))||""}function Bf(){return["hp1WaterIn","hp2WaterIn"].find(e=>h(e))||""}function Nu(e=O("controlModeLabel","")){let o=String(e||"").toLowerCase();return o.includes("cm5")||o.includes("cooling")||o.includes("koeling")}function Gt(){return Nu()}function Ou(e,o){let r=String(e||"").trim().toLowerCase();return r==="waiting for room request"||r==="wacht op kamervraag"||r==="cooling enabled, waiting for room temperature above cooling setpoint"||r==="koeling toegestaan, wacht op kamertemperatuur boven koel-setpoint"?!0:o?!1:r==="flow too low"||r==="flow te laag"||r==="flow unavailable"}function ws(){return Gt()?"Koeling":ae()?"Stooklijn":"Power House"}function Kf(){let e=["phouseReq","strategyRequestedPower"];for(let o of e){let r=A(o);if(!Number.isNaN(r))return r}return Number.NaN}function Lu(){let e=Kf(),o=A("phouseHouse"),r=A("totalHeat"),n=A("hpCapacity"),a=Number.isNaN(e)||Number.isNaN(o)?Number.NaN:e-o,i="Nog aan het opbouwen",l="Zodra alle vermogens beschikbaar zijn, zie je hier hoe de warmtevraag is opgebouwd.";return!Number.isNaN(e)&&!Number.isNaN(n)&&e>n+150?(i="Capaciteit begrenst",l="De gevraagde warmtevraag ligt boven wat de warmtepomp nu ongeveer kan leveren."):!Number.isNaN(e)&&!Number.isNaN(r)&&r<e-250?(i="Levert minder dan gevraagd",l="De actuele warmteafgifte blijft nog onder de gevraagde warmtevraag."):!Number.isNaN(e)&&!Number.isNaN(r)&&r>e+250?(i="Levert meer dan gevraagd",l="De actuele warmteafgifte ligt nu boven de gevraagde warmtevraag."):!Number.isNaN(e)&&!Number.isNaN(r)&&(i="In balans",l="Gevraagde warmtevraag en actuele levering liggen nu dicht bij elkaar."),{requestedText:_(e,0,"W"),houseText:_(o,0,"W"),correctionText:Vf(a),capacityText:Ke("hpCapacity"),statusTitle:i,statusCopy:l}}function Du(){let e=A("curveSupplyTarget"),o=A("supplyTemp"),r=Pu(),n=r?A(r):Number.NaN,a=Number.isNaN(e)||Number.isNaN(o)?Number.NaN:o-e,i=!!r&&Number.isNaN(n),l="Stuurt op buitentemperatuur",p="De doelaanvoer volgt de huidige buitentemperatuur en vergelijkt die met de actuele aanvoer.";return i?(l="Fallback actief",p="De buitentemperatuur ontbreekt, dus de regeling valt terug op de ingestelde fallback-aanvoer."):!Number.isNaN(a)&&a<-1?(l="Nog onder doel",p="De actuele aanvoertemperatuur ligt nog onder de doelaanvoer."):!Number.isNaN(a)&&a>1?(l="Boven doel",p="De actuele aanvoertemperatuur ligt nu boven de doelaanvoer."):Number.isNaN(a)||(l="Dicht bij doel",p="De actuele aanvoertemperatuur sluit nu goed aan op de doelaanvoer."),{targetText:Ke("curveSupplyTarget"),supplyText:Ke("supplyTemp"),deltaText:Df(a),capacityText:Ke("hpCapacity"),statusTitle:l,statusCopy:p}}function Fu(){let e=A("supplyTemp"),o=O("coolingGuardMode",""),r=O("coolingFallbackNightMinOutdoorTemp","\u2014"),n=A("coolingSupplyError"),a=A("coolingDemandRaw"),i=x("coolingPermitted"),l=x("coolingRequestActive"),p=O("coolingBlockReason","Onbekend"),u=ds(p),c=Ou(p,l),m="Wacht op koelvraag",b="Zodra er koelvraag is, zie je hier hoe de regeling de aanvoer richting het koeldoel stuurt.";return c?(m="Wacht op koelvraag",b="Koeling is toegestaan en wacht tot de kamertemperatuur boven het koel-setpoint komt."):i?l?!Number.isNaN(a)&&a<=0?(m="Houdt doel vast",b="De koelvraag loopt nog, maar de compressor hoeft nu niet harder te werken."):!Number.isNaN(n)&&n>1?(m="Trekt aanvoer omlaag",b="De actuele aanvoertemperatuur ligt nog ruim boven het koeldoel."):!Number.isNaN(n)&&n>.2?(m="Benadert koeldoel",b="De regeling koelt nog door, maar zit al dicht bij de gewenste aanvoertemperatuur."):Number.isNaN(n)||(m="Koelt rustig door",b="De aanvoertemperatuur zit dicht bij het koeldoel en de regeling werkt nu op laag pitje."):(m="Koeling gereed",b="Koeling is toegestaan, maar wacht nog op actieve koelvraag vanuit de kamerregeling."):(m="Koeling geblokkeerd",b=`Blokkade: ${u}.`),{targetText:Ke("coolingSupplyTarget"),supplyText:Ke("supplyTemp"),safeFloorText:Ke("coolingEffectiveMinSupplyTemp"),guardMode:o,fallbackNightMin:r,demandText:Ke("coolingDemandRaw"),statusTitle:m,statusCopy:b,permitted:i,requestActive:l,blockReason:u,waitingForRoomRequest:c}}function aa(){if(Gt()){let o=Fu(),r=o.guardMode.toLowerCase(),n=r.includes("user responsibility"),a=r.includes("fallback");return{title:"Koelregeling",copy:n?"Koeling draait expliciet zonder dauwpuntmeting of dauwpuntsbenadering. De ingestelde minimale koel-aanvoer blijft gelden.":"Koeling laat zien op welke aanvoertemperatuur de regeling nu mikt en hoe dicht die bij de veilige grens zit.",focusLabel:"Koeldoel",focusValue:o.targetText,focusCopy:o.statusCopy,metrics:[{label:"Actuele aanvoertemperatuur",value:o.supplyText,tone:"orange",note:"Wat nu door het systeem loopt."},{label:n?"Ingestelde grens":a?"Berekende grens":"Veilige aanvoergrens",value:o.safeFloorText,tone:"blue",note:n?"Geen dauwpuntmeting of benadering; dit is de ingestelde minimale koel-aanvoer.":a?`Conservatieve dauwpuntsbenadering. Nachtminimum: ${o.fallbackNightMin}.`:"Dauwpunt plus veiligheidsmarge."},{label:"Koelvraag",value:o.demandText,tone:"sky",note:"De huidige koelvraag van de regelaar."}]}}if(ae()){let o=Du();return{title:"Stooklijnregeling",copy:"De stooklijn laat zien op welke aanvoertemperatuur de regeling nu mikt en hoe dicht die al benaderd wordt.",focusLabel:"Doelaanvoer",focusValue:o.targetText,focusCopy:"De aanvoertemperatuur waar de regeling nu naartoe werkt.",metrics:[{label:"Actuele aanvoertemperatuur",value:o.supplyText,tone:"orange",note:"Wat nu wordt geleverd."},{label:"Afwijking doelaanvoer",value:o.deltaText,tone:"blue",note:"Verschil met het doel."},{label:"Beschikbare warmtecapaciteit",value:o.capacityText,tone:"sky",note:"Bij huidige buitentemperatuur."}]}}let e=Lu();return{title:"Vermogensbalans",copy:"Power House laat zien waar de warmtevraag nu vandaan komt en of de warmtepomp dat kan volgen.",focusLabel:"Gevraagd vermogen",focusValue:e.requestedText,focusCopy:"De warmtevraag waar Power House nu naartoe stuurt.",metrics:[{label:"Berekende huisvraag",value:e.houseText,tone:"blue",note:"Op basis van woning en buitentemperatuur."},{label:"Kamercorrectie",value:e.correctionText,tone:"orange",note:"Extra bijsturing rond setpoint."},{label:"Beschikbare warmtecapaciteit",value:e.capacityText,tone:"sky",note:"Bij huidige buitentemperatuur."}]}}function Ss(e){return Mu({className:"oq-overview-system",title:e.title,copy:e.copy,signature:ve(e),body:`
        ...
        <div class="oq-overview-metrics oq-overview-metrics--three-column">
          ${e.metrics.map(o=>Lf(o.label,o.value,o.tone,o.note)).join("")}
        </div>
      `})}function jf(){if(!x("openquattEnabled"))return{label:"Regeling nu",value:"Regeling tijdelijk uit",tone:"orange"};if(Gt()){let n=Fu(),a=n.waitingForRoomRequest?"neutral":n.permitted?n.statusTitle==="Koelt rustig door"||n.statusTitle==="Houdt temperatuur vast"?"green":n.statusTitle==="Koeling gereed"?"neutral":"sky":"orange";return{label:"Regeling nu",value:n.statusTitle,tone:a}}if(Uu())return{label:"Regeling nu",value:"Stand-by",tone:"neutral"};let o=(ae()?Du():Lu()).statusTitle;return{label:"Regeling nu",value:o,tone:o==="In balans"||o==="Dicht bij doel"?"green":o==="Nog aan het opbouwen"||o==="Stuurt op buitentemperatuur"?"neutral":"orange"}}function Uf(){return x("openquattEnabled")?Gt()?x("coolingPermitted")?x("silentActive")?{label:"Systeem",value:"Stille uren actief",tone:"neutral"}:{label:"Systeem",value:"Normaal",tone:"neutral"}:{label:"Systeem",value:O("coolingBlockReason","Koeling geblokkeerd"),tone:"orange"}:x("silentActive")?{label:"Systeem",value:"Stille uren actief",tone:"neutral"}:x("stickyActive")?{label:"Systeem",value:"Pompbescherming actief",tone:"neutral"}:{label:"Systeem",value:"Normaal",tone:"neutral"}:{label:"Systeem",value:"Vorstbeveiliging blijft actief",tone:"neutral"}}function qs(e,o){let r=jf(),n=Uf();return[{label:"Strategie",value:e,tone:"orange",note:"regelstrategie"},{label:"Controlmode",value:o,tone:"orange",note:"actieve modus"},{label:"Regeling",value:r.value,tone:"orange",note:"wat OpenQuatt nu doet"},{label:"Systeem",value:n.value,tone:"orange",note:"actieve randvoorwaarde"}]}function Ts(e,o){let r=qs(e,o);return`
    ...
    `}function Es(){let e=Gt();return[{key:"totalPower",label:"Elektrisch vermogen",tone:"blue",note:"hele systeem"},{key:e?"totalCoolingPower":"totalHeat",label:e?"Koelvermogen":"Verwarmingsvermogen",tone:"orange",note:"thermisch vermogen"},{key:e?"totalEer":"totalCop",label:e?"COP (EER)":"COP",tone:"green",note:"rendement"},{key:"flowSelected",label:"Flow",tone:"sky",note:"watercircuit"}]}function Gf(){let e=x("openquattEnabled"),o=E("openquattResumeAt"),r=Pr(o),n=(t.loadingEntities||t.entitySyncInFlight)&&!h("openquattResumeAt"),a=x("manualCoolingEnable"),i=String(E("silentModeOverride")||"Schedule"),l=!x("coolingPermitted"),p=x("coolingRequestActive"),u=Nu(),c=O("coolingBlockReason",""),m=Ou(c,p),b="Uit",y="Koeling staat uit.";a&&u?(b="Actief",y="Koeling draait nu."):a&&m?(b="Aan",y="Koeling is toegestaan en wacht op kamertemperatuur boven het koel-setpoint."):a&&l?(b="Geblokkeerd",y=ds(c||"Koeling wacht nog op veilige condities.")):a&&p?(b="Start bijna",y="Er is koelvraag. Koeling start zodra dat kan."):a&&(b="Aan",y="Koeling staat aan en wacht op koelvraag.");let v="Uit",g="Stille modus staat uit.",f="neutral";return i==="On"?(v="Aan",g="Stille modus staat geforceerd aan, ook buiten het tijdvenster.",f="orange"):i==="Schedule"&&(v="Schema",x("silentActive")?(g="Stille modus staat nu aan via het tijdvenster.",f="violet"):g="Stille modus volgt het tijdvenster."),[{key:"openquattEnabled",label:"Openquatt regeling",status:e?"Actief":"Tijdelijk uit",copy:e?"Verwarmen en koelen worden automatisch geregeld.":r?"Verwarming en koeling zijn tijdelijk uitgeschakeld. Beveiligingen blijven actief.":"Verwarming en koeling zijn uitgeschakeld. Beveiligingen blijven actief.",tone:e?"green":"orange",kind:"openquatt-control",meta:e?[]:[n?{label:"Hervatten",value:"Laden\u2026",tone:"neutral",loading:!0}:{label:r?"Hervat automatisch":"Hervatten",value:r?Vo(o,!0):"Handmatig",tone:r?"orange":"neutral"}]},{key:"manualCoolingEnable",label:"Koeling",status:b,copy:y,buttonLabel:a?"Zet uit":"Zet aan",nextState:a?"off":"on",tone:a?u?"blue":"sky":"neutral"},{key:"silentModeOverride",label:"Stille modus",status:v,copy:g,tone:f,kind:"select",selectedOption:i,settingsAction:!0,options:[{value:"Off",label:"Uit"},{value:"On",label:"Aan"},{value:"Schedule",label:"Schema"}]}].filter(w=>h(w.key))}function zf(e=[]){return e.length?`
    ...
    `:""}function or({className:e,action:o,label:r,busy:n=!1,loading:a=!1,attrs:i=""}){return`
      <button
        class="${e}${n?" is-busy":""}"
        type="button"
      ...
      `:s(n?"Bezig...":r)}</button>
    `}function Qf(e){if(e.kind==="openquatt-control"){let o=t.busyAction==="openquatt-regulation",r=(t.loadingEntities||t.entitySyncInFlight)&&!h("openquattResumeAt");return x("openquattEnabled")?`<div class="oq-overview-controlpanel-actions">${or({className:"oq-overview-controlpanel-toggle",action:"open-openquatt-pause-modal",label:"Tijdelijk uitschakelen",busy:o})}</div>`:`
          <div class="oq-overview-controlpanel-actions oq-overview-controlpanel-actions--split">
            ${or({className:"oq-overview-controlpanel-toggle",action:"enable-openquatt-now",label:"Nu inschakelen",busy:o})}
            ${or(r?{className:"oq-overview-controlpanel-segment oq-overview-controlpanel-segment--loading",action:"",label:"Hervatopties laden\u2026",loading:!0}:{className:"oq-overview-controlpanel-segment",action:"open-openquatt-pause-modal",label:Pr()?"Moment wijzigen":"Automatisch hervatten"})}
          </div>
        `}if(e.kind==="select"){let o=t.busyAction===`save-${e.key}`;return`
        <div class="oq-overview-controlpanel-actions oq-overview-controlpanel-actions--split">
          <div class="oq-overview-controlpanel-segmented">
            ${e.options.map(r=>or({className:`oq-overview-controlpanel-segment${e.selectedOption===r.value?" is-selected":""}`,action:"select-overview-control-option",label:r.label,busy:o,attrs:`data-control-key="${s(e.key)}" data-control-option="${s(r.value)}"`})).join("")}
          </div>
      ...
      <div class="oq-overview-controlpanel-actions">
        ${or({className:"oq-overview-controlpanel-toggle",action:"toggle-overview-control",label:e.buttonLabel,busy:t.busyAction===`switch-${e.key}`,attrs:`data-control-key="${s(e.key)}" data-control-state="${s(e.nextState)}"`})}
      </div>
    `}function ks(){let e=Gf();return e.length?`
    ...
    `:""}function Iu(e){let o=O("controlModeLabel");return`
      <section class="oq-overview-summary-shell">
        ...
        <div class="oq-overview-summary-layout">
          ...
          <aside class="oq-overview-summary-side" data-render-signature="${s(ca())}">
            ${ks()}
          </aside>
        </div>
      </section>
    `}function ia(){let e=Pu(),o=Bf();return Gt()?{title:"Koeltemperaturen",copy:"De belangrijkste temperaturen voor kamercomfort, koeldoel en dauwpuntveiligheid.",rows:[{label:"Kamertemperatuur",key:"roomTemp"},{label:"Kamer setpoint",key:"roomSetpoint"},{label:"Aanvoertemperatuur",key:"supplyTemp"},{label:"Koeldoel",key:"coolingSupplyTarget"},{label:"Veilige aanvoergrens",key:"coolingMinimumSafeSupplyTemp"},{label:"Dauwpunt",key:"coolingDewPointSelected"}]}:{title:"Temperaturen",copy:"De belangrijkste temperaturen voor comfort en regeling.",rows:[{label:"Kamertemperatuur",key:"roomTemp"},{label:"Kamer setpoint",key:"roomSetpoint"},{label:"Aanvoertemperatuur",key:"supplyTemp"},...o?[{label:"Retourtemperatuur",key:o}]:[],e?{label:"Buitentemperatuur",key:e}:{label:"Buitentemperatuur",key:"",value:"\u2014"}]}}function Cs(e=ia()){return ve({...e,values:e.rows.map(o=>o.value||O(o.key))})}function xs(){let e=ia();return Mu({className:"oq-overview-temps",title:e.title,copy:e.copy,signature:Cs(e),body:`
        <div class="oq-overview-temps-list">
          ${e.rows.map(o=>na(o.label,o.key,o.value||"")).join("")}
        </div>
      `})}var Au=360,Yf=100;function Ct(){let e=Jr(t.trendWindowHours||pt);return e!==t.trendWindowHours&&rr(e),e}function _u(e=Ct()){return Math.max(1,Number(e)||24)*60*60*1e3}function Zf(e=Ct()){let o=Number(e)||24;return o>=72&&o%24===0?`${o/24}d`:`${o}u`}function $s(e=Ct()){let o=Number(e)||24;if(o>=72&&o%24===0){let r=o/24;return`${r} ${r===1?"dag":"dagen"}`}return`${o} uur`}function ms(e){if(!Number.isFinite(e))return"\u2014";let o=new Date(e);if(Number.isNaN(o.getTime()))return"\u2014";let r={day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"};try{return new Intl.DateTimeFormat("nl-NL",r).format(o)}catch{return o.toLocaleString("nl-NL",r)}}function Jf(e){let o=String(e||"").trim().split("|");if(o.length<5)return null;let r=Number(o[0]);if(!Number.isFinite(r))return null;let n=a=>{let i=Number(a);return Number.isFinite(i)?i:null};return{t:r,outside:n(o[1]),supply:n(o[2]),room:o.length>=8?n(o[3]):null,roomSetpoint:o.length>=8?n(o[4]):null,flow:o.length>=8?n(o[5]):null,input:o.length>=8?n(o[6]):n(o[3]),output:o.length>=8?n(o[7]):n(o[4])}}function hs(){return!!(typeof window<"u"&&window.__OQ_DEV_CONTROLS__||typeof window<"u"&&window.__OQ_DEV_META)}function gs(e=Ct()){return typeof window>"u"||!window.__OQ_DEV_TREND_MOCKS__||typeof window.__OQ_DEV_TREND_MOCKS__.buildTrendPreviewSamples!="function"?[]:window.__OQ_DEV_TREND_MOCKS__.buildTrendPreviewSamples(e)}function Wu(){let e=_u(),o=String(t.trendHistoryRaw||"").trim();if(!o)return hs()?gs():[];let r=o.split(/\r?\n/).map(Jf).filter(Boolean),n=r.length?r[r.length-1].t:Number.NaN,a=Number.isFinite(t.trendHistoryNowMs)?t.trendHistoryNowMs:Number.isFinite(n)?n:Number.NaN;if(!Number.isFinite(a))return r.length?r.slice(-Au):gs();let i=Math.max(0,a-e),l=r.filter(p=>p.t>=i).slice(-Au);return l.length?l:hs()?gs(windowHours):[]}function As(){let e=Ct(),o=$s(e),r=Wu(),n=hs()&&r.length===0,a=Gt();return[{id:"temperatures",title:"Temperaturen",copy:`Buiten- en aanvoertemperatuur van de laatste ${o}.`,tone:"orange",samples:r,mock:n,windowHours:e,series:[{id:"outside",sampleKey:"outside",currentKey:"outsideTempSelected",label:"Buiten",tone:"orange",decimals:1,unit:" \xB0C"},{id:"supply",sampleKey:"supply",currentKey:"supplyTemp",label:"Aanvoer",tone:"blue",decimals:1,unit:" \xB0C"}]},{id:"power",title:"Vermogen",copy:`Elektrisch vermogen en verwarmingsvermogen van de laatste ${o}.`,tone:"green",samples:r,mock:n,windowHours:e,series:[{id:"input",sampleKey:"input",currentKey:"totalPower",label:"Elektrisch vermogen",tone:"green",decimals:0,unit:" W"},{id:"output",sampleKey:"output",currentKey:a?"totalCoolingPower":"totalHeat",label:a?"Koelvermogen":"Verwarmingsvermogen",tone:"sky",decimals:0,unit:" W"}]},{id:"rendement",title:"Rendement",copy:`COP van de laatste ${o}.`,tone:"slate",samples:r,mock:n,windowHours:e,series:[{id:"cop",label:"COP",tone:"slate",decimals:1,unit:"",currentKey:a?"totalEer":"totalCop",derive:i=>{let l=Number(i?.input),p=Number(i?.output);return!Number.isFinite(l)||!Number.isFinite(p)||l<Yf?Number.NaN:p/l}}]},{id:"comfort",title:"Comfort",copy:`Kamertemperatuur en setpoint van de laatste ${o}.`,tone:"blue",samples:r,mock:n,windowHours:e,series:[{id:"roomTemp",sampleKey:"room",currentKey:"roomTemp",label:"Kamertemperatuur",tone:"blue",decimals:1,unit:" \xB0C"},{id:"roomSetpoint",sampleKey:"roomSetpoint",currentKey:"roomSetpoint",label:"Kamer setpoint",tone:"orange",decimals:1,unit:" \xB0C"}]},{id:"flow",title:"Flow",copy:`Flow van de laatste ${o}.`,tone:"sky",samples:r,mock:n,windowHours:e,series:[{id:"flow",sampleKey:"flow",currentKey:"flowSelected",label:"Flow",tone:"sky",decimals:0,unit:" L/h",axisMin:0,axisTickStep:250}]}]}function Xf(e){let o=e.samples[e.samples.length-1]||null;return ve({id:e.id,windowHours:e.windowHours,sampleCount:e.samples.length,firstTimestamp:e.samples[0]?.t||0,lastTimestamp:o?.t||0,trendSignature:t.trendHistorySignature||"",latestValues:o?[o.outside,o.supply,o.room,o.roomSetpoint,o.flow,o.input,o.output]:[]})}function Qr(e,o){if(!e||!o)return Number.NaN;let r=typeof e.derive=="function"?e.derive(o):o?.[e.sampleKey],n=Number(r);return Number.isFinite(n)?n:Number.NaN}function eb(e,o){let r=[];return e.forEach(n=>{o.forEach(a=>{let i=Qr(a,n);Number.isFinite(i)&&r.push(i)})}),r.length?{min:Math.min(...r),max:Math.max(...r)}:{min:0,max:1}}function tb(e){if(!Number.isFinite(e)||e<=0)return 1;let o=Math.floor(Math.log10(e)),r=e/10**o,n;return r<=1?n=1:r<=2?n=2:r<=5?n=5:n=10,n*10**o}function ob(e,o){let r=Number.isFinite(e?.min)?e.min:0,n=Number.isFinite(e?.max)?e.max:1,a=Math.max(n-r,1),i=Array.isArray(o)?o.map(y=>Number(y?.axisMin)).find(y=>Number.isFinite(y)):Number.NaN,l=Array.isArray(o)?o.map(y=>Number(y?.axisMax)).find(y=>Number.isFinite(y)):Number.NaN,p=Array.isArray(o)?o.map(y=>Number(y?.axisTickStep)).find(y=>Number.isFinite(y)&&y>0):Number.NaN,u=Math.max(1,Number.isFinite(p)?p:tb(a/4)),c=[];if(Number.isFinite(i)||Number.isFinite(l)){let y=Number.isFinite(i)?i:0,v=Number.isFinite(l)?l:Math.ceil(n/u)*u,g=Math.floor(y/u)*u,f=Math.ceil(v/u)*u;for(let w=g;w<=f+u*.5;w+=u)c.push(w)}else{let y=a/u,v=y<=1.8?3:y<=4.25?5:7,g=Math.floor(v/2),f=(r+n)/2,w=Math.round(f/u)*u;for(let S=-g;S<=g;S+=1)c.push(w+S*u)}let m=c[0],b=c[c.length-1];return{ticks:c,axisMin:m,axisMax:b,axisDecimals:0}}function Vu(e,o,r={}){let n=Number(r.windowHours),a=Number.isFinite(n)?n:Ct(),i=_u(a),l=640,p=220,u=46,c=18,m=18,b=34,y=l-u-c,v=p-m-b,g=e[e.length-1],f=!!r.mockData,w=f?i:Number.isFinite(t.trendHistoryNowMs)?t.trendHistoryNowMs:g?g.t:0,S=f?0:w-i,q=Math.max(w-S,1),k=q,$=eb(e,o),H=$.min===$.max?{min:$.min-1,max:$.max+1}:{min:$.min-Math.max(($.max-$.min)*.12,1),max:$.max+Math.max(($.max-$.min)*.12,1)},W=ob($,o),B=L=>u+(L-S)/q*y,M=L=>{if(!Number.isFinite(L))return Number.NaN;let Y=(L-H.min)/Math.max(H.max-H.min,1);return m+(1-Math.min(1,Math.max(0,Y)))*v},I=[0,.5,1].map(L=>u+y*L),z=W.ticks.map(L=>M(L)),re=W.ticks.map((L,Y)=>({x:u-10,y:z[Y],text:_(L,W.axisDecimals)})),ge=e.map(L=>{let Y=B(L.t),N=o.map(F=>{let T=Qr(F,L);return Number.isFinite(T)?{seriesId:F.id||F.sampleKey||F.label,tone:F.tone,label:F.label,decimals:F.decimals,unit:F.unit,value:T,x:Y,y:M(T)}:null});return{sample:L,x:Y,values:N}}),Z=o.flatMap(L=>{let Y=[],N=[];return e.forEach(F=>{let T=Qr(L,F);if(!Number.isFinite(T)){N.length&&(Y.push(N),N=[]);return}N.push({x:B(F.t),y:M(T)})}),N.length&&Y.push(N),Y.map(F=>F.length<2?{tone:L.tone,points:F,path:""}:{tone:L.tone,points:F,path:F.map((T,C)=>`${C===0?"M":"L"} ${T.x.toFixed(1)} ${T.y.toFixed(1)}`).join(" ")})});return{width:l,height:p,left:u,right:c,top:m,bottom:b,plotWidth:y,plotHeight:v,latest:g,uptimeMs:k,endTime:w,startTime:S,span:q,windowHours:a,range:$,displayRange:H,gridXs:I,gridYs:z,yAxisLabels:re,points:ge,tracks:Z,series:o}}function sa(){return ve({windowHours:Ct(),trendSignature:t.trendHistorySignature||"",trendNowMs:Number.isFinite(t.trendHistoryNowMs)?t.trendHistoryNowMs:0,coolingActive:Gt()})}function rb(e){return As().find(o=>o.id===e)||null}function nb(e,o){if(!e||!Array.isArray(e.points)||e.points.length===0)return-1;let r=0,n=Math.abs(e.points[0].x-o);return e.points.forEach((a,i)=>{let l=Math.abs(a.x-o);l<n&&(r=i,n=l)}),r}function ab(e,o){let r=Bu(e,o);return`
    ...
    `}function Bu(e,o){if(e?.currentKey&&h(e.currentKey)){let r=A(e.currentKey);if(Number.isFinite(r))return r}return Qr(e,o)}function Hs(e){e&&As().forEach(o=>{let r=e.querySelector(`[data-oq-trend-card="${o.id}"]`),n=o.samples[o.samples.length-1]||null;r&&o.series.forEach(a=>{let l=r.querySelector(`[data-oq-trend-current="${a.id}"]`)?.querySelector("strong"),p=_(Bu(a,n),a.decimals,a.unit);l&&l.textContent!==p&&(l.textContent=p)})})}function ib(e,o,r=!1,n=Ct()){let a=Vu(e,o,{mockData:r,windowHours:n}),i=$s(n),l=ms(a.startTime),p=ms(a.startTime+a.span/2),u=ms(a.endTime),c=a.tracks.flatMap(m=>{if(m.points.length<2){let b=m.points[0];return b?`
          <circle
            cx="${b.x.toFixed(1)}"
            cy="${b.y.toFixed(1)}"
            r="3.8"
    ...
    `}function sb(e){let o=e.samples[e.samples.length-1]||null,r=$s(e.windowHours);return`
      <article class="oq-overview-trendcard oq-overview-trendcard--${s(e.tone)}" data-oq-trend-card="${s(e.id)}" data-render-signature="${s(Xf(e))}">
        <div class="oq-overview-trendcard-head">
          ...
          <div class="oq-overview-trendcard-meta">
            <div class="oq-overview-trendcard-latest">
              ${e.series.map(n=>ab(n,o)).join("")}
            </div>
          </div>
        </div>
        ${ib(e.samples,e.series,e.mock,e.windowHours)}
    ...
    `}function la(){let e=As();return`
      <section class="oq-overview-trends" aria-label="Diagnose" data-render-signature="${s(sa())}">
    ...
    `}function cb(){let e=Ct(),o=Rs();return`
    ...
    `}function ub(){let e="overview-trends-history",o=t.settingsInfoOpen===e;return`
    ...
    `}function Ku(){let e=ot(),r=Wu().length>0;return`
    ...
    `}function ju(){if(!t.root||t.appView!=="diagnosis")return!1;let e=t.root.querySelector(".oq-overview-board");if(!e)return!1;let o=e.querySelector(".oq-overview-trends");return o?(mt(o,sa(),la()),Hs(e),Zr(e),!0):!1}function Ms(e){if(!e)return null;let o=e.__oqTrendHoverNodes;if(o&&o.chart&&o.hoverLayer&&o.hoverPanel)return o;let r=e.querySelector("[data-oq-trend-hover-layer]"),n={chart:e.querySelector(".oq-overview-trend-chart"),hoverLayer:r,hoverPanel:e.querySelector("[data-oq-trend-hover]"),hoverTime:e.querySelector("[data-oq-trend-hover-time]"),hoverNote:e.querySelector("[data-oq-trend-hover-note]"),hoverValues:e.querySelector("[data-oq-trend-hover-values]"),hoverLine:r?r.querySelector(".oq-overview-trend-hover-line"):null,hoverDots:{}};return r&&r.querySelectorAll("[data-oq-trend-hover-dot]").forEach(a=>{n.hoverDots[a.getAttribute("data-oq-trend-hover-dot")]=a}),e.__oqTrendHoverNodes=n,n}function Hu(e,o,r,n=Ms(e)){if(!e||!o||!Array.isArray(o.points)||o.points.length===0)return;let a=Math.max(0,Math.min(o.points.length-1,r)),i=o.points[a];if(!i||!n||!n.chart||!n.hoverLayer||!n.hoverPanel||!n.hoverTime||!n.hoverNote||!n.hoverValues)return;let l=String(a);if(!n.hoverPanel.hidden&&e.dataset.oqTrendHoverIndex===l)return;let p=Wf(i.sample.t,o.endTime);n.hoverPanel.hidden=!1,n.hoverLayer.removeAttribute("hidden"),n.hoverTime.textContent=p.value,n.hoverNote.textContent=p.note,n.hoverLine&&(n.hoverLine.setAttribute("x1",i.x.toFixed(1)),n.hoverLine.setAttribute("x2",i.x.toFixed(1)));let u=[];o.series.forEach(c=>{let m=Qr(c,i.sample),b=c.id||c.sampleKey||c.label,y=n.hoverDots[b];if(!Number.isFinite(m)){y&&y.setAttribute("display","none");return}let v=i.values.find(g=>g.seriesId===b);y&&v&&(y.removeAttribute("display"),y.setAttribute("cx",v.x.toFixed(1)),y.setAttribute("cy",v.y.toFixed(1))),u.push(`
        <div class="oq-overview-trend-hover-row oq-overview-trend-hover-row--${s(c.tone)}">
          <span>${s(c.label)}</span>
          <strong>${s(_(m,c.decimals,c.unit))}</strong>
        </div>
      `)}),n.hoverValues.innerHTML=u.join(""),e.dataset.oqTrendHoverIndex=l}function pb(e){if(!e)return;let o=Ms(e);o?.hoverPanel&&(o.hoverPanel.hidden=!0),o?.hoverLayer&&o.hoverLayer.setAttribute("hidden",""),delete e.dataset.oqTrendHoverIndex}function Zr(e=t.root){if(!e)return;e.querySelectorAll("[data-oq-trend-card]").forEach(r=>{let n=r.dataset.renderSignature||"";if(r.__oqTrendBoundSignature===n)return;typeof r.__oqTrendCleanup=="function"&&r.__oqTrendCleanup(),r.__oqTrendHoverNodes=null,r.__oqTrendBoundSignature=n;let a=r.querySelector(".oq-overview-trend-chart");if(!a)return;let i=rb(r.dataset.oqTrendCard);if(!i)return;let l=Vu(i.samples,i.series,{mockData:i.mock});r.__oqTrendModel=l;let p=Ms(r),u=0,c=null,m=()=>{let v=c;c=null,u=0;let g=a.getBoundingClientRect();if(!g.width||!g.height)return;let f=Number(v?.clientX);if(!Number.isFinite(f)){Hu(r,l,l.points.length-1,p);return}let S=Math.min(g.width,Math.max(0,f-g.left))/g.width*l.width,q=nb(l,S);Hu(r,l,q,p)},b=v=>{c=v,u||(u=window.requestAnimationFrame(m))},y=()=>{u&&(window.cancelAnimationFrame(u),u=0),c=null,pb(r)};a.addEventListener("pointermove",b),a.addEventListener("pointerenter",b),a.addEventListener("pointerleave",y),a.addEventListener("focus",b),a.addEventListener("blur",y),a.addEventListener("touchstart",b,{passive:!0}),r.__oqTrendCleanup=()=>{u&&(window.cancelAnimationFrame(u),u=0),c=null,a.removeEventListener("pointermove",b),a.removeEventListener("pointerenter",b),a.removeEventListener("pointerleave",y),a.removeEventListener("focus",b),a.removeEventListener("blur",y),a.removeEventListener("touchstart",b)}})}function Is(e,o,r){let n=Yu(O(o.mode,"Unknown")),a=x(o.defrost),i=Qt(O(o.failures,"None")),l=ma(i),p=n==="Verwarmen"||n==="Koelen"||a;return{mode:n,defrostActive:a,failures:i,warningFailures:l,running:p,thermalKey:n==="Koelen"?o.cooling:o.heat,schematic:Sb(e,o,r,n,a,l,p)}}function zu(e,o=null){return`<h3>${s(e)}</h3>${o?`<button class="oq-overview-hp-card-action" type="button" data-oq-action="select-hp-layout" data-hp-layout="${s(o.layout)}">${xb(o.layout==="equal"?"minus":"plus")}<span>${s(o.label)}</span></button>`:""}`}function Ns(e,o,r,n){return`<div class="oq-overview-hp-status">${vs(e,o,r,n)}</div>`}function Uu(){return O("controlModeLabel","").toLowerCase().includes("standby")}function db(e,o){return o?"ontdooit":e==="Verwarmen"?"verwarmt":e==="Koelen"?"koelt":e==="Stand-by"?"stand-by":"onbekend"}function Qu(e){return!Array.isArray(e)||e.length===0?"":`<p class="oq-overview-hp-summary">${s(e.map(o=>`${o.title} ${db(Yu(O(o.keys.mode,"Unknown")),x(o.keys.defrost))}`).join(", "))}</p>`}function mb(e){let o=t.entities[e];if(!o)return"Positie: \xE2\u20AC\u201D";let r=A(e);return Number.isNaN(r)?`Positie: ${O(e)}`:`Positie: ${_(r,0,o.uom||"")}`}function gb(e){return h(e)?`Positie: ${x(e)?"Koelen/Defrost":"Verwarmen"}`:"Positie: \xE2\u20AC\u201D"}function Yu(e){let o=String(e||"").trim();return!o||o==="Unknown"?"Onbekend":o==="Standby"?"Stand-by":o==="Heating"?"Verwarmen":o==="Cooling"?"Koelen":o}function Qt(e){let o=String(e||"").trim();return!o||o==="None"?"Geen actieve storingen":o}function Os(e,o,r,n=!0,a="default"){return`
    ...
    `}function hb(e,o,r){return e==="temperature"?`
        <svg
    ...
    `}function Xr({bind:e,modifier:o,x:r,y:n,width:a,kicker:i,detail:l,detailBind:p="",icon:u="heater",direction:c="down"}){let b=r+26,y=n+22,v=p?` data-oq-bind="${s(p)}"`:"",g="";if(c==="up"){let f=r+Math.round(a*.52);g=`M${f-6} ${n} L${f} ${n-8} L${f+6} ${n} Z`}else if(c==="left"){let f=n+Math.round(22);g=`M${r} ${f-6} L${r-8} ${f} L${r} ${f+6} Z`}else if(c==="right"){let f=n+Math.round(22);g=`M${r+a} ${f-6} L${r+a+8} ${f} L${r+a} ${f+6} Z`}else{let f=r+Math.round(a*.52);g=`M${f-6} ${n+44} L${f} ${n+44+8} L${f+6} ${n+44} Z`}return`
      <g
    ...
    `}function Ls({bind:e,x:o,y:r,width:n,value:a,label:i,ariaLabel:l="",align:p="start"}){let u=l||`${i} temperatuur ${a}`,c=p==="end",m=p==="center",b=m?"middle":c?"end":"start",y=m?o+n/2:c?o+n-2:o+2;return`
      <g
    ...
    `}function fb({tooltip:e,...o}){return`${Ls(o)}${Xr({bind:o.bind,...e})}`}function bb({bind:e,ariaLabel:o,x:r,y:n,width:a,height:i,rx:l,tooltip:p}){return`
      ...
      <div class="${s(e.boardClass)}" data-oq-hp-board="${s(e.title)}">
        <div class="oq-hp-tech-shell">
          <div class="oq-hp-tech-visual">
            ...
            ${Object.entries(e.pipes).map(([c,m])=>Os(c.replace(/[A-Z]/g,b=>`-${b.toLowerCase()}`),m.tone,m.d,m.animated,m.flowVariant)).join("")}
            ...
            ${p.map(fb).join("")}
            ${Ps({bind:"bottom-heater",className:"oq-hp-tech-bottom-heater",active:e.bottomPlateActive,ariaLabel:"Bottom plate heater actief",content:`
            ...
            ${Ps({bind:"crankcase-heater",className:"oq-hp-tech-crankcase-heater",active:e.crankcaseActive,ariaLabel:"Crank case heater actief",content:`
            ...
            ${Ps({bind:"defrost-badge",className:"oq-hp-tech-defrost-badge",active:e.defrostActive,activeClass:"",ariaLabel:e.defrostActive?"Defrost actief":"Defrost uit",attrs:'transform="translate(532 288)"',content:`
    ...
    `}function Zu(e,o,r,n="normal",a=null){if(!h(o.power))return"";let i=Is(e,o,r),{mode:l,defrostActive:p,running:u,thermalKey:c}=i,m=i.schematic;return t.hpVisualMode==="schematic"?`
        <section class="oq-overview-hp oq-overview-hp--${s(r)} oq-overview-hp--${s(n)}" data-oq-hp-panel="${s(e)}">
          <div class="oq-overview-hp-head">
            ...
            <div class="oq-overview-hp-head-side">
              ${Ns(l,u,m.warningActive,m.failureText)}
            </div>
          </div>
          ${qb(m)}
        </section>
      ...
      <section class="oq-overview-hp oq-overview-hp--${s(r)} oq-overview-hp--${s(n)}" data-oq-hp-panel="${s(e)}">
        ...
        <div class="oq-overview-hp-stats">
          ${Yr([{key:o.power,label:"Stroomverbruik",tone:"blue",note:"elektrisch verbruik"},{key:c,label:m.heatLabel,tone:"orange",note:m.heatDescription},{label:m.efficiencyLabel,value:m.efficiencyText,tone:"green",note:"actueel"}])}
        </div>
        ...
        <div class="oq-overview-temps-list">
          ${na("Water in",o.waterIn)}
          ${na("Water out",o.waterOut)}
        </div>
      </section>
    `}function _s(){return x("boilerCvAssistEnabled")&&h("boilerHeatPower")}function Tb(){return(typeof ee=="function"?ee():"")!=="single"&&h("hp2WaterOut")?"hp2WaterOut":"hp1WaterOut"}function Eb(){return(typeof ee=="function"?ee():"")!=="single"&&h("hp2Flow")?"hp2Flow":"hp1Flow"}function pa(){let e=A("boilerHeatPower"),o=A(Eb()),r=h("boilerActive")?x("boilerActive"):!Number.isNaN(e)&&e>20,n=!Number.isNaN(o)&&o>0,a=_(e,0,"W"),i=_(o,0,"L/h"),l=_(A(Tb()),1,"\xB0C"),p=_(A("supplyTemp"),1,"\xB0C"),u=r?"Aan":"Uit",c=r?"Levert ondersteuning":"Geen ondersteuning",m=["oq-boiler-card",r?"is-running":"is-idle"].filter(Boolean).join(" ");return{active:r,flowActive:n,heatText:a,flowText:i,returnTempText:l,supplyTempText:p,statusText:u,statusCopy:c,boardClass:m,flowPathClass:n?"is-flowing":"is-static"}}function Ws(e=pa()){return ve({version:"boiler-visual-mode-v1",visualMode:t.hpVisualMode,boardClass:"oq-boiler-card"})}function kb(e,o=pa()){let r=e.querySelector(".oq-boiler-card");r&&(r.className=["oq-boiler-card",o.active?"is-running":"is-idle",o.flowActive?"is-flowing":"is-static"].join(" "));let n=e.querySelector(".oq-overview-chip");n&&(n.className=`oq-overview-chip oq-overview-chip--${o.active?"active":"neutral"}`,n.textContent!==o.statusText&&(n.textContent=o.statusText));let a=e.querySelector(".oq-boiler-summary-box--support");a&&(a.classList.toggle("is-active",o.active),a.classList.toggle("is-idle",!o.active));let i=e.querySelector(".oq-boiler-summary-box--support strong");i&&i.textContent!==o.statusCopy&&(i.textContent=o.statusCopy);let l=e.querySelector("[data-oq-boiler-heat-value]");l&&l.textContent!==o.heatText&&(l.textContent=o.heatText),e.querySelectorAll("[data-oq-boiler-flow-value]").forEach(m=>{m.textContent!==o.flowText&&(m.textContent=o.flowText)});let p=e.querySelector("[data-oq-boiler-status-value]");p&&p.textContent!==o.statusCopy&&(p.textContent=o.statusCopy);let u=e.querySelector('[data-oq-bind="boiler-return-value"]');u&&u.textContent!==o.returnTempText&&(u.textContent=o.returnTempText);let c=e.querySelector('[data-oq-bind="boiler-supply-value"]');c&&c.textContent!==o.supplyTempText&&(c.textContent=o.supplyTempText)}function Cb(e){return`
      <section class="oq-overview-hp oq-overview-boiler oq-overview-boiler--compact" data-oq-boiler-panel data-render-signature="${s(Ws(e))}">
        <div class="oq-overview-hp-head">
          <div>
    ...
    `}function Ds(){if(!_s())return"";let e=pa();return t.hpVisualMode!=="schematic"?Cb(e):`
      <section class="oq-overview-hp oq-overview-boiler" data-oq-boiler-panel data-render-signature="${s(Ws(e))}">
          ...
          <div class="oq-boiler-card-main">
            ...
            <div class="oq-boiler-mini-schematic">
              <svg class="oq-boiler-mini-svg" viewBox="0 0 420 132" role="img" aria-label="Schematische weergave CV-ketel of boiler">
                ...
                ${Os("boiler-return","return","M24 88 H166 C180 88 190 80 196 68",!0,"water")}
                ${Os("boiler-supply","supply","M224 52 C232 40 244 36 258 36 H396",!0,"water")}
                ...
                ${Ls({bind:"boiler-return",x:22,y:70,width:78,value:e.returnTempText,label:"Retour",ariaLabel:`Retour ${e.returnTempText}`,align:"start"})}
                ${Xr({bind:"boiler-return",modifier:"return",icon:"temperature",x:82,y:70,width:124,kicker:"Temperatuur",detail:"Retour",direction:"left"})}
                ${Ls({bind:"boiler-supply",x:320,y:16,width:76,value:e.supplyTempText,label:"Aanvoer",ariaLabel:`Aanvoer ${e.supplyTempText}`,align:"end"})}
                ${Xr({bind:"boiler-supply",modifier:"supply",icon:"temperature",x:294,y:14,width:124,kicker:"Temperatuur",detail:"Aanvoer",direction:"right"})}
              </svg>
    ...
    `}function Ju(){let e=typeof ee=="function"?ee():"";return Yl.filter(o=>e==="single"&&o.title==="HP2"?!1:h(o.keys.power))}function Vs(e){return!Array.isArray(e)||e.length<2||t.hpVisualMode!=="schematic"?"equal":t.hpLayoutMode==="focus-hp1"||t.hpLayoutMode==="focus-hp2"?t.hpLayoutMode:"equal"}function ua(e,o,r){return!Array.isArray(o)||o.length<2?"normal":r==="focus-hp1"?e===0?"focus":"muted":r==="focus-hp2"?e===1?"focus":"muted":"normal"}function Fs(e,o,r){return!Array.isArray(o)||o.length<2||t.hpVisualMode!=="schematic"?null:ua(e,o,r)==="focus"?{layout:"equal",label:"Toon beide"}:{layout:e===0?"focus-hp1":"focus-hp2",label:"Vergroot"}}function Xu(e){return!Array.isArray(e)||e.length!==1?Vs(e):_s()?"equal":"single"}function xb(e="plus"){return`
    ...
    `}function ep(e){return!Array.isArray(e)||e.length===0?"":`
    ...
    `}function $b(e,o){if(!e)return!1;let r=e.querySelector(".oq-overview-hp-tools-copy"),n=e.querySelector('[data-hp-visual="schematic"]'),a=e.querySelector('[data-hp-visual="compact"]');return!r||!n||!a?(xt(e,ep(o)),!0):(xt(r,`
      <h3>Warmtepompen</h3>
      ${Qu(o)}
    `),n.classList.toggle("is-active",t.hpVisualMode==="schematic"),a.classList.toggle("is-active",t.hpVisualMode==="compact"),!0)}function tp(){let e=ws(),o=Ju(),r=Vs(o),n=Xu(o),a=ep(o);return`
      <section class="oq-helper-panel oq-helper-panel--flush">
        <div class="oq-overview-board oq-overview-board--${s(t.overviewTheme)}">
          ${bs()}
          ${Iu(e)}
          ...
          <div class="oq-overview-hp-grid oq-overview-hp-grid--${s(n)}">
            ${o.map((i,l)=>Zu(i.title,i.keys,i.accent,ua(l,o,r),Fs(l,o,r))).join("")}
            ${Ds()}
          </div>
        </div>
      </section>
    `}function Ab(e,o,r){if(!e)return;let n=e.querySelector(o);n&&n.textContent!==r&&(n.textContent=r)}function xt(e,o){e&&e.innerHTML!==o&&(e.innerHTML=o)}function mt(e,o,r){return!e||e.dataset.renderSignature===o?!1:(e.outerHTML=r,!0)}function nr(e,o,r){e&&e.getAttribute(o)!==r&&e.setAttribute(o,r)}function Hb(e,o){o.forEach(([r,n])=>{Ab(e,`[data-oq-bind="${r}"]`,n)})}function Mb(e,o){o.forEach(([r,n])=>{nr(e.querySelector(`[data-oq-bind="${r}"]`),"aria-label",n)})}function Rb(e,o,r,n=""){let a=e.querySelector(`[data-oq-bind="${o}"]`);a&&(a.classList.toggle("is-active",r),nr(a,"tabindex",r?"0":"-1"),!r&&n&&da(e.querySelector(`[data-oq-bind="${n}"]`)))}function Pb(e,o,r){nr(e.querySelector(`[data-oq-bind="${o}"]`),"fill",r)}function en(e,o,r,n){if(!e)return;let a=`${o}${r}`;n.map(l=>`${o}${l}`).find(l=>e.classList.contains(l))!==a&&(n.forEach(l=>e.classList.remove(`${o}${l}`)),e.classList.add(a))}function Nb(e,o,r,n){let a=e.querySelector(`[data-oq-pipe="${o}"]`);a&&(en(a,"oq-hp-tech-pipe--",r,["supply","return","hotgas","liquid","expansion","suction"]),a.querySelectorAll("path").forEach(i=>{i.getAttribute("d")!==n&&i.setAttribute("d",n)}))}function da(e){e&&(e.classList.remove("is-active"),e.setAttribute("aria-hidden","true"))}function Gu(e,o,r){!e||!o||!r||(e.querySelectorAll(".oq-hp-tech-tooltip.is-active").forEach(n=>{n!==r&&da(n)}),o.appendChild(r),r.classList.add("is-active"),r.setAttribute("aria-hidden","false"))}function Ob(e,o,r,n){if(!e||!o||!r||!n||r.dataset.oqTooltipWired==="true")return;r.dataset.oqTooltipWired="true";let a=()=>{r.matches(":hover")||document.activeElement===r||da(n)};r.addEventListener("mouseenter",()=>Gu(e,o,n)),r.addEventListener("mouseleave",a),r.addEventListener("focus",()=>Gu(e,o,n)),r.addEventListener("blur",a)}function op(e){if(!e)return;let o=e.querySelector(".oq-hp-tech-svg");if(!o)return;let r=o.querySelector(".oq-hp-tech-tooltip-layer");r||(r=document.createElementNS("http://www.w3.org/2000/svg","g"),r.setAttribute("class","oq-hp-tech-tooltip-layer"),o.appendChild(r)),Array.from(o.querySelectorAll(".oq-hp-tech-tooltip")).forEach(n=>{r.appendChild(n)}),e.querySelectorAll("[data-oq-tooltip-target]").forEach(n=>{let a=n.getAttribute("data-oq-tooltip-target");if(!a)return;let i=e.querySelector(`[data-oq-bind="${a}-tooltip"]`);Ob(e,r,n,i)})}function rp(e=t.root){e&&e.querySelectorAll("[data-oq-hp-board]").forEach(o=>{op(o)})}function Lb(e,o,r,n,a=null,i=null){if(!e)return;let l=i||Is(o,r,n),{mode:p,running:u}=l,c=l.schematic,m=e.querySelector(".oq-overview-hp-head-title");m&&xt(m,zu(o,a));let b=e.querySelector(".oq-overview-hp-head-side");if(b){let w=b.querySelector(".oq-overview-hp-status");w||(xt(b,Ns(p,u,c.warningActive,c.failureText)),w=b.querySelector(".oq-overview-hp-status")),Ru(w,p,u,c.warningActive,c.failureText)}let y=e.querySelector("[data-oq-hp-board]");if(!y)return;y.className!==c.boardClass&&(y.className=c.boardClass),Hb(y,[["status",c.statusText],["left-exchanger-title",c.leftExchangerTitle],["right-exchanger-title",c.rightExchangerTitle],["compressor-freq",c.compressorFreqText],["flow-value",c.flowText],["inner-coil-temp-value",c.innerCoilTempText],["evaporator-temp-value",c.evaporatorCoilTempText],["outside-temp-value",c.outsideTempText],["discharge-pressure-value",c.dischargePressureText],["discharge-temp-value",c.dischargeTempText],["suction-pressure-value",c.suctionPressureText],["suction-temp-value",c.suctionTempText],["supply-value",c.waterOutText],["return-value",c.waterInText],["footer-mode",c.mode],["footer-power",c.powerText],["footer-heat",c.heatText],["footer-efficiency-label",c.efficiencyLabel],["footer-efficiency",c.efficiencyText],["fan-speed-value",c.fanRpmText],["fourway-detail",c.fourWayPositionText],["eev-detail",c.eevPositionText]]);let v=y.querySelector('[data-oq-bind="footer-heat-label"]');if(v){nr(v,"aria-label",c.heatLabel);let w=c.heatLabel==="Koelafgifte"?"Koel<br>afgifte":"Warmte<br>afgifte";v.innerHTML!==w&&(v.innerHTML=w)}[["bottom-heater",c.bottomPlateActive],["crankcase-heater",c.crankcaseActive]].forEach(([w,S])=>{Rb(y,w,S,`${w}-tooltip`)});let g=y.querySelector('[data-oq-bind="defrost-badge"]');g&&(nr(g,"tabindex",c.defrostActive?"0":"-1"),nr(g,"aria-label",c.defrostActive?"Defrost actief":"Defrost uit"),c.defrostActive||da(y.querySelector('[data-oq-bind="defrost-badge-tooltip"]'))),[["supply-tooltip",c.supplyLineTone],["return-tooltip",c.returnLineTone]].forEach(([w,S])=>{en(y.querySelector(`[data-oq-bind="${w}"]`),"oq-hp-tech-tooltip--",S,["warm","supply","return"])}),Mb(y,[["supply-reading",`Aanvoer temperatuur ${c.waterOutText}`],["flow-reading",`Flow ${c.flowText}`],["inner-coil-temp-reading",`Inner coil temperatuur ${c.innerCoilTempText}`],["evaporator-temp-reading",`Verdampertemperatuur ${c.evaporatorCoilTempText}`],["outside-temp-reading",`Buitentemperatuur ${c.outsideTempText}`],["compressor-freq-trigger",`Compressorfrequentie ${c.compressorFreqText}`],["fan-speed-reading",`Ventilatorsnelheid ${c.fanRpmText}`],["discharge-pressure-reading",`Persdruk ${c.dischargePressureText}`],["discharge-temp-reading",`Perstemperatuur ${c.dischargeTempText}`],["return-reading",`Retour temperatuur ${c.waterInText}`],["suction-pressure-reading",`Zuigdruk ${c.suctionPressureText}`],["suction-temp-reading",`Zuigtemperatuur ${c.suctionTempText}`],["fourway-trigger",`4-wegklep, ${c.fourWayPositionText}`],["eev-trigger",`Expansieventiel, ${c.eevPositionText}`]]),en(y.querySelector(".oq-hp-tech-pump"),"oq-hp-tech-pump--",c.returnLineTone,["supply","return"]);let f=String(c.title||"hp").toLowerCase().replace(/[^a-z0-9]+/g,"-");Pb(y,"cond-water",`url(#${c.reverseCycle?`${f}-cond-water-cool`:`${f}-cond-water-heat`})`),Object.entries(c.pipes).forEach(([w,S])=>{Nb(y,w.replace(/[A-Z]/g,q=>`-${q.toLowerCase()}`),S.tone,S.d)}),op(y),ga()}function np(){if(!t.root||t.appView!=="overview")return!1;let e=t.root.querySelector(".oq-overview-board");if(!e)return!1;let o=`oq-overview-board oq-overview-board--${t.overviewTheme}`;e.className!==o&&(e.className=o);let r=ws(),n=e.querySelector("[data-oq-monitoring-notice]"),a=e.querySelector(".oq-overview-summary-shell"),i=e.querySelector(".oq-overview-system"),l=e.querySelector(".oq-overview-temps"),p=e.querySelector(".oq-overview-trends"),u=e.querySelector(".oq-overview-hp-tools"),c=e.querySelector(".oq-overview-hp-grid"),m=e.querySelector("[data-oq-boiler-panel]"),b=Ju();if(n){let q=zt();mt(n,ve(q),bs())}if(a){let q=a.querySelector(".oq-overview-top");q&&xt(q,Yr(Es()));let k=a.querySelector(".oq-overview-statuspanel");if(k){let H=O("controlModeLabel");mt(k,ve(qs(r,H)),Ts(r,H))}let $=a.querySelector(".oq-overview-summary-side");if($){let H=ca();$.dataset.renderSignature!==H&&(xt($,ks()),$.dataset.renderSignature=H)}}if(i&&mt(i,ve(aa()),Ss(aa())),l){let q=ia();mt(l,Cs(q),xs())}if(p&&t.appView==="overview"&&(mt(p,sa(),la()),Hs(e)),Zr(e),!u||!c)return!1;let y=Vs(b),v=Xu(b);if($b(u,b),en(c,"oq-overview-hp-grid--",v,["single","equal","focus-hp1","focus-hp2"]),t.hpVisualMode!=="schematic"){let q=[...b.map(($,H)=>Zu($.title,$.keys,$.accent,ua(H,b,y),Fs(H,b,y))),Ds()].join(""),k=ve({visualMode:t.hpVisualMode,layout:v,markup:q});return c.dataset.renderSignature!==k&&(xt(c,q),c.dataset.renderSignature=k),!0}let g=_s()?pa():null,f=g?Ds():"",w=g?Ws(g):"";return!!m!=!!f||(m&&m.dataset.renderSignature!==w?m.outerHTML=f:m&&g&&kb(m,g),c.querySelectorAll("[data-oq-hp-panel]").length!==b.length)?!1:(b.forEach((q,k)=>{let $=e.querySelector(`[data-oq-hp-panel="${q.title}"]`);if($){let H=Is(q.title,q.keys,q.accent);en($,"oq-overview-hp--",ua(k,b,y),["normal","focus","muted"]),Lb($,q.title,q.keys,q.accent,Fs(k,b,y),H)}}),!0)}function Db(){return qr.filter(e=>h(be(e,"Status"))||h(be(e,"Load"))||h(io(e,"cooling",0)))}function Fb(e){return Te(Ee(e))}function Ib(e){let o=[];return Mn.forEach(r=>{let n=-1/0;Io.forEach(a=>{let i=io(e,r,a),l=Fb(i);(!Number.isFinite(l)||l<0||l>120||l<n)&&o.push(`${r==="cooling"?"C":"H"}F${a}`),Number.isFinite(l)&&(n=l)})}),{valid:o.length===0,invalid:o}}function _b(e){let o=String(E(`hp${e}Mode`)||"").trim(),r=Te(E(`hp${e}Freq`)),n=o&&o!=="Onbekend"&&o!=="Unknown",a=Number.isFinite(r),i=n&&/standby|stand-by/i.test(o),l=a&&r<=.5,p=n?i?a?l?"Standby en compressor uit.":`Compressor draait op ${r.toFixed(0)} Hz.`:"Compressorfrequentie is onbekend.":`ODU staat in ${o}.`:"ODU status is onbekend.";return{mode:n?o:"Onbekend",freq:Number.isFinite(r)?`${r.toFixed(0)} Hz`:"Onbekend",safe:i&&l,reason:p}}function Wb(e){let o=String(e||"").toUpperCase();return!e||o==="UNKNOWN"||o==="UNAVAILABLE"?"Nog geen readback of apply-status ontvangen.":o.includes("APPLIED")?"Runtime registers zijn geschreven en via readback bevestigd. Een ODU powercycle zet de originele tabel terug.":o.includes("GUARD_READ_REQUESTED")?"Firmware leest actuele ODU mode en compressorfrequentie voordat er geschreven wordt.":o.includes("WRITE_QUEUED")||o.includes("WRITE_CONFIRMED")?"Runtime write loopt; wacht op bevestigde readback voordat je de waarden vertrouwt.":o.includes("FAILED")?"Firmware kon de runtime tabel niet volledig bevestigen. Laad opnieuw voordat je verder test.":o.includes("LOADED")?"Readback is in de velden geladen. Controleer de waarden voordat je schrijft.":o.includes("BLOCKED")?"Firmware heeft de actie geblokkeerd; controleer enable, standby en compressorstatus.":o.includes("LOAD_REQUESTED")?"Readback is aangevraagd bij de ODU.":"Laatste status van de experimentele runtime tabel."}function ap(e,o){return h(e)?Zt({key:e,value:Ee(e),meta:Ie(e),controlClass:"oq-helper-control oq-helper-control--suffix oq-settings-odu-runtime-control",inputClass:"oq-helper-input oq-helper-input--compact-number oq-settings-odu-runtime-input",inputAttributes:`data-oq-odu-runtime-tab-index="${o}"`,unitMarkup:'<span class="oq-helper-unit-chip">Hz</span>'}):'<span class="oq-settings-odu-runtime-missing">-</span>'}function Vb(e){let o=Io.length;return`
      <div class="oq-settings-odu-runtime-table" role="table" aria-label="${s(`HP${e} ODU runtime frequentietabel`)}">
        ...
        ${Io.map(r=>`
          <div class="oq-settings-odu-runtime-row" role="row">
            ...
            <div role="cell">${ap(io(e,"cooling",r),r)}</div>
            <div role="cell">${ap(io(e,"heating",r),o+r)}</div>
          </div>
        `).join("")}
      </div>
    `}function cp(e){if(e.key!=="Tab"||e.altKey||e.ctrlKey||e.metaKey)return;let o=e.target&&e.target.closest?e.target.closest("input[data-oq-odu-runtime-tab-index]"):null,r=o?o.closest(".oq-settings-odu-runtime-table"):null;if(!o||!r)return;let n=Array.from(r.querySelectorAll("input[data-oq-odu-runtime-tab-index]:not(:disabled)")).sort((l,p)=>Number(l.dataset.oqOduRuntimeTabIndex||0)-Number(p.dataset.oqOduRuntimeTabIndex||0)),a=n.indexOf(o),i=n[a+(e.shiftKey?-1:1)];a<0||!i||(e.preventDefault(),i.focus(),typeof i.select=="function"&&i.select())}function Bb(e){let o=be(e,"Enable"),r=be(e,"Load"),n=be(e,"Apply"),a=be(e,"Status"),i=String(E(a)||"").trim()||"Nog niet geladen",l=Ib(e),p=_b(e),u=!!E(o),c=t.loadingEntities||t.busyAction===r||t.busyAction===n,m=c||!u||!l.valid||!p.safe||!h(n),b=l.valid?"Waarden zijn 0-120 Hz en per tabel oplopend.":`Controleer ${l.invalid.slice(0,5).join(", ")}${l.invalid.length>5?"...":""}.`;return`
      <article class="oq-settings-odu-runtime-panel">
        <div class="oq-settings-odu-runtime-panel-head">
          ...
          <div class="oq-settings-odu-runtime-actions">
            ${h(r)?_e(r,t.busyAction===r?"Lezen...":"Uit ODU laden","oq-helper-button oq-helper-button--ghost",c):""}
      ${h(o)?At(o,`HP${e} writes vrijgeven`,u,c,"Enable","Locked"):""}
            ${h(n)?_e(n,t.busyAction===n?"Schrijven...":"Runtime toepassen","oq-helper-button oq-helper-button--warning",m):""}
          </div>
        </div>
    ...
    `}function up(){let e=Db();return e.length?`
    ...
    `:""}function G(e){return h(e)&&x(e)}function $t(e){return!h(e)||x(e)}function ip(e){return h(e)?Qt(O(e,"None")):""}var pp=new Set(["compressor oil return"]);function Bs(e){return h(e)?ma(O(e,"None")):""}function ha(e){let o=Bs(e).trim().toLowerCase();return!!o&&o!=="geen actieve storingen"}function zt(){let e=[],o=G("compressorCyclingWarning2h")||G("compressorCyclingWarning72h")||G("alternatingCompressorStartsWarning"),r=G("compressorCyclingAlertLatched"),n=$t("cicPollingEnabled"),a=$t("otEnabled"),i=(p,u)=>{G(p)&&e.push({key:p,label:u})};i("compressorCyclingWarning2h","Te veel compressorstarts in 2 uur"),i("compressorCyclingWarning72h","Te veel compressorstarts in 72 uur"),i("alternatingCompressorStartsWarning","Warmtepompen starten opvallend vaak om en om"),i("lowflowFaultActive","Te lage flow"),i("flowMismatch","Flowverschil tussen warmtepomp 1 en 2"),n&&i("cicDataStale","CIC-data is verouderd"),a&&i("otLinkProblem","OpenTherm-verbinding meldt een probleem"),ha("hp1Failures")&&e.push({key:"hp1Failures",label:`Warmtepomp 1: ${Bs("hp1Failures")}`}),ha("hp2Failures")&&e.push({key:"hp2Failures",label:`Warmtepomp 2: ${Bs("hp2Failures")}`});let l=e.length;return r&&!o&&e.unshift({key:"compressorCyclingAlertLatched",label:"Pendelen eerder gedetecteerd; melding nog niet bevestigd"}),{problems:e,active:e.length>0,cyclingAlertLatched:r,cyclingAlertActive:o,cyclingAlertRecovered:r&&!o,title:l>0?"Aandacht nodig":r?"Eerdere waarschuwing nog niet bevestigd":"Geen bijzonderheden",copy:l>0?`${e.length} aandachtspunt${e.length===1?"":"en"} zichtbaar. Bekijk hieronder de details.`:r?"Het pendelen is hersteld. De melding blijft zichtbaar totdat je haar bevestigt.":"OpenQuatt ziet op dit moment geen actieve aandachtspunten in de bewaakte signalen."}}function fa(e,o="Aandacht",r="OK"){return`<span class="oq-settings-monitoring-badge${e?" is-warning":" is-clear"}">${s(e?o:r)}</span>`}function ar({label:e,value:o,note:r="",active:n=!1}){return`
    ...
    `}function Yt(e){let o=A(e);return Number.isNaN(o)?"\u2014":String(Math.max(0,Math.round(o)))}function Kb(e){let o=A(e);if(Number.isNaN(o))return"Nog niet gemeten";if(o<1)return"Zojuist";if(o<60)return`${Math.round(o)} min geleden`;let r=Math.floor(o/60),n=Math.round(o%60);return`${r}u ${n}m geleden`}function sp(e){let o=A(e);return Number.isNaN(o)||o<=0?"Tijdstip onbekend":new Intl.DateTimeFormat("nl-NL",{day:"2-digit",month:"short",hour:"2-digit",minute:"2-digit"}).format(new Date(o*1e3))}function jb(e){if(!e.cyclingAlertLatched)return"";let o=G("compressorCyclingAlertAlternating"),r=Yt("compressorCyclingAlertHp1Peak2h"),n=Yt("compressorCyclingAlertHp1Peak72h"),a=h("compressorCyclingAlertHp2Peak2h")?Yt("compressorCyclingAlertHp2Peak2h"):"",i=h("compressorCyclingAlertHp2Peak72h")?Yt("compressorCyclingAlertHp2Peak72h"):"";return`
      <div class="oq-settings-monitoring-incident${e.cyclingAlertActive?" is-active":" is-recovered"}">
        <div class="oq-settings-monitoring-incident-head">
          ...
          ${fa(e.cyclingAlertActive,"Actief","Hersteld")}
        </div>
        ...
        <dl>
          <div><dt>Eerste melding</dt><dd>${s(sp("compressorCyclingAlertFirstSeen"))}</dd></div>
          <div><dt>Laatste melding</dt><dd>${s(sp("compressorCyclingAlertLastSeen"))}</dd></div>
        ...
        <div class="oq-settings-monitoring-incident-action">
          ${t.entities.acknowledgeCompressorCyclingAlert?_e("acknowledgeCompressorCyclingAlert","Melding bevestigen","oq-helper-button oq-helper-button--ghost",e.cyclingAlertActive):""}
    ...
    `}function lp(e,o){return h(`${o}CompressorStarts2h`)?`
      <div class="oq-settings-monitoring-compressor-unit">
        <div>
          <p>${s(e)}</p>
          <span>Laatste start: ${s(Kb(`${o}CompressorLastStartAge`))}</span>
        </div>
        <dl>
          <div><dt>2 uur</dt><dd>${s(Yt(`${o}CompressorStarts2h`))}</dd></div>
          <div><dt>6 uur</dt><dd>${s(Yt(`${o}CompressorStarts6h`))}</dd></div>
          <div><dt>24 uur</dt><dd>${s(Yt(`${o}CompressorStarts24h`))}</dd></div>
          <div><dt>72 uur</dt><dd>${s(Yt(`${o}CompressorStarts72h`))}</dd></div>
        </dl>
      </div>
    `:""}function ba(e){let o=e.active?e.problems.map(r=>r.key).sort().join("|"):"";if(!o){t.installationMonitoringProblemSignature="";return}o!==t.installationMonitoringProblemSignature&&(t.installationMonitoringProblemSignature=o,t.installationMonitoringDetailsOpen=!0)}function dp(){let e=zt();ba(e);let o=$t("cicPollingEnabled"),r=$t("otEnabled"),n=[h("lowflowFaultActive")?ar({label:"Flow",value:G("lowflowFaultActive")?"Te lage flow gemeld":"Geen lage-flowmelding",active:G("lowflowFaultActive")}):"",h("flowMismatch")?ar({label:"Flowvergelijking duo",value:G("flowMismatch")?"Afwijking tussen warmtepompen":"Geen afwijking gemeld",active:G("flowMismatch")}):""].filter(Boolean).join(""),a=[h("cicDataStale")?ar({label:"CIC-data",value:o?G("cicDataStale")?"Verouderd":"Geen probleem gemeld":"Polling uitgeschakeld",active:o&&G("cicDataStale")}):"",h("otLinkProblem")?ar({label:"OpenTherm",value:r?G("otLinkProblem")?"Verbindingsprobleem":"Geen probleem gemeld":"Uitgeschakeld",active:r&&G("otLinkProblem")}):""].filter(Boolean).join(""),i=[h("hp1Failures")?ar({label:"Warmtepomp 1",value:ip("hp1Failures"),active:ha("hp1Failures")}):"",h("hp2Failures")?ar({label:"Warmtepomp 2",value:ip("hp2Failures"),active:ha("hp2Failures")}):""].filter(Boolean).join(""),l=A("compressorStarts2hWarningLimit"),p=A("compressorStarts72hWarningLimit"),u=G("compressorCyclingWarning2h")||G("compressorCyclingWarning72h")||G("alternatingCompressorStartsWarning")||e.cyclingAlertLatched,c=n?`
    ...
    `:"";return te("Bewaking","Installatiebewaking","Lokale diagnose voor compressorstarts, hydrauliek en verbindingen. Hiervoor is geen Home Assistant nodig.",`
        <div class="oq-settings-monitoring-summary${e.active?" is-warning":" is-clear"}">
          ...
          ${fa(e.active,"Aandacht nodig","Alles rustig")}
        </div>
      ...
      `)}function Ks(){if(!h("hpGeneration"))return"";let e={V1:{copy:"Voor Quatt V1 en Quatt V1 + V1.5 combinaties.",image:ra,alt:"Quatt Hybrid V1 en V1.5",infoTitle:"V1",infoCopy:`Model: AMM4
Kenmerken: Flowmeter bij CV-ketel en vorstbeveiligingsklep buiten de buitenunit. Ook geschikt voor gemengde V1/V1.5 duo's.`},"V1.5":{copy:"Voor Quatt V1.5-installaties.",image:ra,alt:"Quatt Hybrid V1 en V1.5",infoTitle:"V1.5",infoCopy:`Model: AMM4-V1.5
...
Kenmerken: Flowmeter in de buitenunit ge\xEFntegreerd. Onder CV-ketel enkel een kleine clip-on temperatuursensor.`}},o=t.entities.hpGeneration||{},r=String(E("hpGeneration")||""),n=Jt(o),a=t.loadingEntities||t.busyAction==="save-hpGeneration";return`
    ...
    `}function mp(){let e=rt(),o=t.entities.hpGeneration||{},r=h("hpGeneration")&&Jt(o).length>0;return!e&&!r?"":te("Basis","Quatt Hybrid-versie","Kies hier welke Quatt Hybrid je hebt. Deze keuze bepaalt de basis van de regeling.",`
      ...
      `)}function js(e="oq-settings-grid oq-settings-boiler-simple-grid"){if(!h("boilerCvAssistEnabled"))return"";let o=x("boilerCvAssistEnabled"),r=h("boilerRatedHeatPower"),n=Ie("boilerRatedHeatPower"),a=Ee("boilerRatedHeatPower"),i=t.loadingEntities||t.busyAction==="switch-boilerCvAssistEnabled",p=r?Zt({key:"boilerRatedHeatPower",value:a,meta:n,controlClass:"oq-helper-control oq-helper-control--suffix oq-settings-boiler-power-control",unitMarkup:'<span class="oq-helper-unit-chip">W</span>'}):`
      ...
      `)}function fp(){let e=Vt(),o=Vn(),r=t.busyAction==="restartAction";return te("Diagnostiek","Systeemstatus","Snelle statusinformatie voor support, controle en onderhoud.",`
        <div class="oq-settings-system-summary">
          ...
          <div class="oq-settings-system-row oq-settings-system-row--with-action" data-oq-diagnostics-row="webserverLog">
            <div class="oq-settings-system-row-copy">
              ...
              <strong class="oq-settings-system-row-value">${s(Kn())}</strong>
            </div>
            <button
              class="oq-helper-button oq-helper-button--ghost"
              type="button"
          ...
          <div class="oq-settings-system-row oq-settings-system-row--with-action" data-oq-diagnostics-row="debugRecording">
            <div class="oq-settings-system-row-copy">
              ...
              <strong class="oq-settings-system-row-value">${s(tn())}</strong>
              <p class="oq-settings-system-row-note">${s(va())}</p>
            </div>
            <button
              class="oq-helper-button oq-helper-button--ghost"
              type="button"
          ...
          ${h("statusLedsEnabled")?`
            <div class="oq-settings-system-row oq-settings-system-row--with-action" data-oq-diagnostics-row="statusLeds">
              <div class="oq-settings-system-row-copy">
                ...
                <strong class="oq-settings-system-row-value">${s(x("statusLedsEnabled")?"Aan":"Uit")}</strong>
                <p class="oq-settings-system-row-note">Schakelt de gele netwerk-LED en rode storings-LED op de Q-edition controller.</p>
              </div>
              ${At("statusLedsEnabled","Status-LEDs",x("statusLedsEnabled"),t.loadingEntities||t.busyAction==="switch-statusLedsEnabled")}
            </div>
          `:""}
        </div>
      `)}function bp(){let e=[cs("Warmtepomp 1","hp1ExcludedA","hp1ExcludedB"),cs("Warmtepomp 2","hp2ExcludedA","hp2ExcludedB")].filter(Boolean).join("");return te("Installatie","Compressorinstellingen","Stel hier de minimale draaitijd in en bepaal per warmtepomp welke compressorstanden je wilt overslaan.",`
        <div class="oq-settings-subpanel">
          <div class="oq-settings-subpanel-head">
    ...
    `}function yp(){return te("Comfort","Stille uren","Kies wanneer het systeem stiller moet werken, en hoe ver het dan nog mag opschalen.",wa())}function vp(){return wa("oq-settings-grid oq-settings-grid--modal")}function on(e,o,r){let n=A(o),a=A(r);if(Number.isFinite(n)&&Number.isFinite(a))return n-a;let i=A(e);return Number.isFinite(i)?i:NaN}function Gs(e="oq-settings-grid"){let o=Ub();return`
      <div class="${s(e)}">
      ...
      ${o}
    `}function Ub(){let e=[{label:"HP1 water in",rawKey:"hp1WaterInRaw",offsetKey:"hp1WaterInOffset",finalKey:"hp1WaterIn"},{label:"HP1 water uit",rawKey:"hp1WaterOutRaw",offsetKey:"hp1WaterOutOffset",finalKey:"hp1WaterOut"},{label:"HP2 water in",rawKey:"hp2WaterInRaw",offsetKey:"hp2WaterInOffset",finalKey:"hp2WaterIn"},{label:"HP2 water uit",rawKey:"hp2WaterOutRaw",offsetKey:"hp2WaterOutOffset",finalKey:"hp2WaterOut"}].filter(r=>h(r.offsetKey)&&h(r.finalKey));if(!e.length)return"";let o=r=>{let n=Ie(r.offsetKey),a=on(r.rawKey,r.finalKey,r.offsetKey),i=Te(Ee(r.offsetKey)),l=Number.isFinite(a)&&Number.isFinite(i)?Xt(a+i,n.uom||"\xB0C",2):we(r.finalKey,2);return`
        <article class="oq-settings-hp-offset-row" data-oq-settings-field="${s(r.offsetKey)}" data-oq-hp-offset-raw-key="${s(r.rawKey)}" data-oq-hp-offset-final-key="${s(r.finalKey)}">
          <div class="oq-settings-hp-offset-copy">
            ...
            <span data-oq-hp-offset-active>${s(we(r.finalKey,2))} actief</span>
          </div>
          <div class="oq-settings-hp-offset-equation" aria-label="${s(`${r.label} correctie`)}">
            <div class="oq-settings-hp-offset-readout">
              <span>Raw</span>
              <strong data-oq-hp-offset-raw>${s(Number.isFinite(a)?Xt(a,n.uom||"\xB0C",2):we(r.rawKey,2))}</strong>
            </div>
            <span class="oq-settings-hp-offset-operator">+</span>
            <label class="oq-settings-hp-offset-input">
              <span>Correctie</span>
              ${Zt({key:r.offsetKey,value:Ee(r.offsetKey),meta:n,controlClass:"oq-helper-control oq-helper-control--suffix",inputClass:"oq-helper-input oq-helper-input--compact-number",unitMarkup:n.uom?`<span class="oq-helper-unit-chip">${s(n.uom)}</span>`:""})}
            </label>
            <span class="oq-settings-hp-offset-operator">=</span>
    ...
    `}function wp(){return te("Beveiliging","Watertemperatuur","Beschermt het systeem tegen te hoge aanvoertemperaturen. OpenQuatt regelt richting deze grens terug en grijpt 5\xB0C erboven hard in.",Gs())}function Tp(e="wizard"){return e==="picker"?`
      ...
      `:`
      <section class="oq-helper-panel">
        <p class="oq-helper-label">${s(gt("generation"))}</p>
    ...
    `}function Gb(e){let o=String(e||"").trim();if(!o)return"";try{let r=new URL(/^[a-z][a-z0-9+.-]*:\/\//i.test(o)?o:`http://${o}`);return r.protocol!=="http:"&&r.protocol!=="https:"?"":(r.port||(r.port="8080"),(!r.pathname||r.pathname==="/")&&(r.pathname="/beta/feed/data.json"),r.toString())}catch{return""}}function Ep(){let e=String(E("cicFeedUrl")||"").trim(),o=t.quickStartCicFeedUrlDraft===null?e:String(t.quickStartCicFeedUrlDraft||"");return{configuredUrl:e,draftUrl:o,normalizedDraftUrl:Gb(o)}}function kp(e,o){return`
    ...
    `}function Sp(e){let o=String(e||"").trim().toLowerCase();return o==="heatpump_controller_q"||o.includes("q-edition")||o.includes("controller q")?"heatpump_controller_q":o==="heatpump_listener"||o.includes("listener")?"heatpump_listener":o==="waveshare"||o.includes("waveshare")?"waveshare":""}function Cp(){let e=Sp(E("hardwareProfileText")),o=!1;return e||(e=Sp(dt().hardwareProfile)),!e&&h("qFlowSource")?(e="heatpump_controller_q",o=!0):!e&&h("flowSource")&&h("cicPollingEnabled")&&(e="remote",o=!0),{profile:e,inferred:o,isQEdition:e==="heatpump_controller_q",isRemoteProfile:e==="heatpump_listener"||e==="waveshare"||e==="remote",hardwareKnown:!!e,hardwareLabel:e==="heatpump_controller_q"?"Heatpump Controller Q-edition":e==="heatpump_listener"?"Heatpump Listener":e==="waveshare"?"Waveshare":e==="remote"?"Heatpump Listener / Waveshare":"Onbekend hardwareprofiel"}}function ir(){let e=String(E("hpGeneration")||"").trim(),o=Cp(),r=e==="V1",{isQEdition:n,isRemoteProfile:a,hardwareKnown:i}=o,l=r&&a,p=n?r?"Local":"Outdoor unit":"",u=l?"CIC":"Outdoor unit",c=String(E("flowSource")||"").trim(),m=String(E("qFlowSource")||"").trim(),b=x("cicPollingEnabled"),y=x("cicJsonFeedOk"),v=x("cicDataStale"),g=Ep(),f=c===u&&(!p||m===p),w=l?f&&b&&!!g.configuredUrl:f,S=l?"cicFlowrate":n&&r?"controllerFlow":ee()==="duo"?"flowLocal":"hp1Flow",q=A(S),k=Number.isFinite(q),$=x("quickFlowTest"),H=i?l?"Nog configureren":"Nog activeren":"Hardwareprofiel niet herkend";l&&w?H=y&&k?q>0?"Geldig":"Bron actief, geen circulatie":v?"Geen actuele CiC-data":y?"Verbonden, wacht op flow":"Verbinding controleren":!l&&w&&(H=k?q>0?"Geldig":"Bron actief, geen circulatie":"Wacht op actuele flow");let W=l?"CiC JSON-feed":n&&r?"Lokale flowmeter op de controller":"Flowmeter in de buitenunit via Modbus",B=l?"Een Quatt V1 heeft op dit hardwareprofiel geen lokaal aangesloten flowmeter. Configureer daarom de lokale CiC JSON-feed.":n&&r?"Bij Quatt V1 is de centrale flowmeter lokaal aangesloten op de Q-edition controller.":`Bij Quatt ${e||"V1.5/V2"} zit de flowmeter in de buitenunit en leest OpenQuatt deze via Modbus.`;return{generation:e,hardwareLabel:o.hardwareLabel,requiresCic:l,qFlowTarget:p,flowSourceTarget:u,configurationApplied:w,sourceLabel:W,explanation:B,status:H,flowValue:q,flowAvailable:k,flowTestActive:$,canRunFlowTest:w,...g,canApply:i&&h("flowSource")&&(!p||h("qFlowSource"))&&(!l||h("cicPollingEnabled")&&h("cicFeedUrl")&&!!g.normalizedDraftUrl)}}function Sa(){let e=Cp(),{isQEdition:o,isRemoteProfile:r}=e,n=String(E("roomTempSource")||"").trim(),a=String(E("roomSetpointSource")||"").trim(),i=n===a&&["CIC","OT thermostat","HA input"].includes(n)?n:"",l=o?"OT thermostat":t.quickStartThermostatSourceDraft||(i==="CIC"||i==="HA input"?i:"CIC"),p=Ep(),c=n===l&&a===l&&(l!=="OT thermostat"||x("otEnabled"))&&(l!=="CIC"||x("cicPollingEnabled")&&!!p.configuredUrl),m=l==="OT thermostat"?["otRoomTemp","otRoomSetpoint"]:l==="CIC"?["cicRoomTemp","cicRoomSetpoint"]:["roomTempHa","roomSetpointHa"],b=A(m[0]),y=A(m[1]),v=Number.isFinite(b)&&Number.isFinite(y),g=l==="OT thermostat"?x("otEnabled")&&!x("otLinkProblem")&&v:l==="CIC"?x("cicJsonFeedOk")&&!x("cicDataStale")&&v:x("roomTempHaValid")&&x("roomSetpointHaValid")&&v,f=o||r?"Nog activeren":"Hardwareprofiel niet herkend";c&&(f=g?"Geldig":l==="OT thermostat"?"OpenTherm-verbinding controleren":l==="CIC"?"CiC-feed controleren":"HA-proxy's controleren");let w=l==="OT thermostat"?"OpenTherm-thermostaat":l==="CIC"?"CiC JSON-feed":"Home Assistant-proxy's",S=o?"De Q-edition leest kamertemperatuur en kamer-setpoint rechtstreeks uit via OpenTherm.":l==="CIC"?"OpenQuatt leest beide thermostaatwaarden samen uit de lokale CiC JSON-feed.":"OpenQuatt gebruikt de vaste HA-proxy's voor kamertemperatuur en kamer-setpoint.";return{hardwareLabel:e.hardwareLabel,isQEdition:o,isRemoteProfile:r,selectedSource:l,sourceLabel:w,explanation:S,configurationApplied:c,status:f,roomTempValue:b,roomSetpointValue:y,valuesAvailable:v,...p,canApply:(o||r)&&h("roomTempSource")&&h("roomSetpointSource")&&(l!=="OT thermostat"||h("otEnabled"))&&(l!=="CIC"||h("cicPollingEnabled")&&h("cicFeedUrl")&&!!p.normalizedDraftUrl)}}function zb(){let e=ir(),o=t.busyAction==="quickstart-flow-source"||t.busyAction==="quickstart-flow-refresh",r=t.busyAction==="quickstart-flow-test-start"||t.busyAction==="quickstart-flow-test-abort",n=o||r||e.flowTestActive,a=e.status==="Geldig"||e.status==="Bron actief, geen circulatie"?" is-active":"",i=e.flowAvailable?`${Math.round(e.flowValue)} L/h`:"Nog geen actuele waarde",l=e.requiresCic?kp(e,n):"";return`
      <section class="oq-helper-panel">
        <p class="oq-helper-label">${s(gt("flow-source"))}</p>
        ...
        <div class="oq-settings-grid oq-settings-grid--quickstart">
          ${ue("quickStartFlowSource","Vastgestelde flowbron",e.explanation,`
              <div class="oq-settings-quickstart-status">
                <div class="oq-settings-quickstart-status-row">
                  <div>
        ...
        ${Ht({nextDisabled:!e.configurationApplied||e.flowTestActive||r,nextDisabledLabel:r?"Even wachten":e.flowTestActive?"Test loopt":e.requiresCic?"Sla eerst op":"Activeer eerst"})}
      </section>
    `}function Qb(){let e=Sa(),o=t.busyAction==="quickstart-thermostat-source",r=e.status==="Geldig"?" is-active":"",n=e.isRemoteProfile?`
    ...
    `:"",a=e.selectedSource==="CIC"?kp(e,o):"",i=e.selectedSource==="HA input"?`
    ...
    `:"";return`
      <section class="oq-helper-panel">
        <p class="oq-helper-label">${s(gt("thermostat-source"))}</p>
        ...
        <div class="oq-settings-grid oq-settings-grid--quickstart">
          ${ue("quickStartThermostatSourceStatus",e.isQEdition?"Vastgestelde thermostaatbron":"Gekozen thermostaatbron",e.explanation,`
              <div class="oq-settings-quickstart-status">
                <div class="oq-settings-quickstart-status-row">
                  <div>
        ...
        ${Ht({nextDisabled:!e.configurationApplied,nextDisabledLabel:e.isQEdition?"Activeer eerst":"Sla eerst op"})}
      </section>
    `}function xp(){return!t.quickStartModalOpen||t.loadingEntities||t.complete===null||t.complete&&t.quickStartModalMode!=="generation"?"":t.quickStartModalMode==="generation"?`
      ...
      `:`
      <div class="oq-helper-modal-backdrop oq-helper-modal-backdrop--quickstart" data-oq-modal="quickstart-forced">
        <section class="oq-helper-modal oq-helper-modal--wide oq-helper-modal--quickstart" data-oq-quickstart-scroller data-oq-quickstart-step="${s(iy().id)}" role="dialog" aria-modal="true" aria-labelledby="oq-quickstart-modal-title">
          <div class="oq-helper-modal-head">
            <div>
    ...
    `}function $p(){return t.root?t.root.querySelector("[data-oq-quickstart-scroller]"):null}function Ap(){let e=$p();return e?{stepId:String(e.dataset.oqQuickstartStep||""),scrollHeight:e.scrollHeight,scrollTop:e.scrollTop,stickToBottom:Un(e)}:null}function Yb(e){if(!e)return;let o=$p();if(!o||String(o.dataset.oqQuickstartStep||"")!==e.stepId)return;if(e.stickToBottom){o.scrollTop=o.scrollHeight;return}let r=e.scrollTop+(o.scrollHeight-e.scrollHeight);o.scrollTop=Math.max(0,r)}function zs(e,o=!0){if(!e)return;let r=Number(t.quickStartScrollRestoreToken||0)+1;t.quickStartScrollRestoreToken=r;let n=()=>{t.quickStartScrollRestoreToken!==r||!t.quickStartModalOpen||Yb(e)};if(o){window.requestAnimationFrame(n);return}n()}function qp(){return`
      <section class="oq-helper-panel">
        <p class="oq-helper-label">${s(gt("strategy"))}</p>
    ...
    `}function Zb(){return`
      <section class="oq-helper-panel">
        <p class="oq-helper-label">${s(gt("boiler"))}</p>
    ...
    `}function Jb(){return`
      <section class="oq-helper-panel">
        <p class="oq-helper-label">${s(gt("flow"))}</p>
    ...
    `}function Xb(){return`
      <section class="oq-helper-panel">
        <p class="oq-helper-label">${s(gt("heating"))}</p>
        ...
        ${ae()?`
            <div class="oq-settings-grid oq-settings-grid--quickstart">${ss()}</div>
            <div class="oq-settings-curve-shell">
              ${us()}
            </div>
            ${os()}
    ...
    `}function ey(){return`
      <section class="oq-helper-panel">
        <p class="oq-helper-label">${s(gt("water"))}</p>
    ...
    `}function ty(){return`
      <section class="oq-helper-panel">
        <p class="oq-helper-label">${s(gt("silent"))}</p>
    ...
    `}function oy(){return`
      <section class="oq-helper-panel">
        <p class="oq-helper-label">${s(gt("confirm"))}</p>
    ...
    `}function ry(){return t.currentStep==="generation"?Tp():t.currentStep==="boiler"?h("boilerCvAssistEnabled")?Zb():qp():t.currentStep==="flow-source"?zb():t.currentStep==="thermostat-source"?Qb():t.currentStep==="flow"?Jb():t.currentStep==="heating"?Xb():t.currentStep==="water"?ey():t.currentStep==="silent"?ty():t.currentStep==="confirm"?oy():qp()}function wo(){return Fo.filter(e=>!e.optionalEntity||h(e.optionalEntity))}function gt(e){let o=wo().findIndex(r=>r.id===e);return`Stap ${Math.max(0,o)+1}`}function ny(e){let o=qa(),r=e===o,n=t.complete===!0||e<o;return{tone:r?"current":n?"done":"upcoming",label:r?"Actief":n?"Gereed":"Volgend",current:r}}function ay(e=!1){return wo().map((o,r)=>{let n=ny(r);return`
        <button
      ...
      `}).join("")}function iy(){let e=wo();return e.find(o=>o.id===t.currentStep)||e[0]||Fo[0]}function qa(){return Math.max(0,wo().findIndex(e=>e.id===t.currentStep))}function Qs(e){let o=wo(),r=Math.min(o.length-1,Math.max(0,qa()+e));t.currentStep=o[r]?.id||Fo[0].id}function Ht(e={}){let o=qa(),r=wo(),n=o>0?r[o-1]:null,a=o<r.length-1?r[o+1]:null;return`
    ...
    `}function sy(){let e=qa(),o=wo();return`
    ...
    `}function cy(e=t.currentStep){let o=["setupComplete","strategy",...Be];return e==="generation"?[...new Set([...o,"installationTopology",...Wo,"hpGeneration"])]:e==="flow-source"?[...new Set([...o,"hpGeneration",...et])]:e==="thermostat-source"?[...new Set([...o,...lo])]:e==="boiler"?[...new Set([...o,"boilerCvAssistEnabled","boilerRatedHeatPower"])]:e==="strategy"?[...new Set([...o,"strategy"])]:e==="heating"?[...new Set([...o,...ut,...co,"dayMax","silentMax"])]:e==="flow"?[...new Set([...o,...Ve,..._o])]:e==="water"?[...new Set([...o,"maxWater"])]:e==="silent"?[...new Set([...o,...uo])]:e==="confirm"?[...new Set([...o,"installationTopology","hpGeneration","boilerCvAssistEnabled","boilerRatedHeatPower",...et,...lo,...Ve,..._o,...ut,...co,"maxWater",...uo])]:o}async function Ta(e=t.currentStep){let o=cy(e);try{await D(o,"all",{concurrency:St}),t.quickStartModalOpen&&t.currentStep===e&&!t.nativeOpen&&d()}catch{}}async function Hp(){let e=ir();if(!e.canApply){t.controlError=e.requiresCic?"Vul eerst een geldig CiC-adres of een geldige feed-URL in.":"De vereiste flowbroninstelling is niet beschikbaar in deze firmware.",d();return}t.busyAction="quickstart-flow-source",t.controlNotice="",t.controlError="",d();let o=async(r,n)=>{if(!h(r))return;let a=E(r);if(typeof n=="boolean"&&x(r)===n||typeof n!="boolean"&&String(a)===String(n))return;let i=await jt(r,n);t.entities[r]={...t.entities[r]||{},value:i,state:i}};try{e.requiresCic?(await o("cicFeedUrl",e.normalizedDraftUrl),await o("cicPollingEnabled",!0),await o("flowSource","CIC"),t.quickStartCicFeedUrlDraft=null,t.controlNotice="CiC-flowmeting ingesteld. OpenQuatt controleert nu de JSON-feed."):(e.qFlowTarget&&await o("qFlowSource",e.qFlowTarget),await o("flowSource","Outdoor unit"),t.controlNotice=e.qFlowTarget==="Local"?"De lokale flowmeter op de Q-edition controller is ingesteld.":"De flowmeter in de buitenunit is ingesteld als Modbus-bron."),await D(et,"all")}catch(r){t.controlError=`Flowconfiguratie kon niet volledig worden toegepast. ${r.message}`}finally{t.busyAction="",d()}}async function Mp(){t.busyAction="quickstart-flow-refresh",t.controlNotice="",t.controlError="",d();try{await D(et,"all");let e=ir();t.controlNotice=e.flowAvailable?e.flowValue>0?`Flowsignaal bijgewerkt: ${Math.round(e.flowValue)} L/h.`:"Het flowsignaal is beschikbaar; momenteel is er geen circulatie.":"Nog geen actuele flowwaarde ontvangen."}catch(e){t.controlError=`Flowsignaal controleren mislukt. ${e.message}`}finally{t.busyAction="",d()}}async function Rp(e,o){let r=R[e];if(!r||!h(e))throw new Error("Deze firmware bevat de vereiste testbediening niet.");let n=await fetch(U(r.domain,r.name,o?"turn_on":"turn_off"),{method:"POST"});if(!n.ok)throw new Error(`HTTP ${n.status}`)}async function uy(){let e=["commissioningCm100Start","commissioningCm100Stop","quickFlowTest"];e.forEach(r=>{t.optionalMissingEntities&&delete t.optionalMissingEntities[r],delete t.entities[r]}),await D(e,"all");let o=e.filter(r=>!t.entities[r]);if(o.length){let r=o.map(n=>R[n]?.name||n).join(", ");throw new Error(`Interne waterpomptestbediening ontbreekt: ${r}.`)}}async function py(){for(let e=0;e<40;e+=1){await new Promise(o=>window.setTimeout(o,1e3));try{await D(et,"state")}catch{return}if(!x("quickFlowTest")){t.busyAction!=="quickstart-flow-test-abort"&&(t.controlNotice="Waterpomptest afgerond. OpenQuatt is teruggekeerd naar de normale regeling."),d();return}}}async function Pp(){if(!ir().canRunFlowTest){t.controlError="Activeer eerst de flowconfiguratie of installeer firmware met de waterpomptest.",d();return}t.busyAction="quickstart-flow-test-start",t.controlNotice="",t.controlError="",d();let o=!1;try{if(await uy(),!x("cm100Active")){let a=R.commissioningCm100Start,i=await fetch(U(a.domain,a.name,"press"),{method:"POST"});if(!i.ok)throw new Error(`CM100 starten gaf HTTP ${i.status}`);o=!0}let r=x("cm100Active")&&String(E("commissioningStatus")||"").trim()==="CM100 READY";for(let a=0;!r&&a<20;a+=1)await new Promise(i=>window.setTimeout(i,500)),await D(["commissioningStatus","cm100Active"],"state"),r=x("cm100Active")&&String(E("commissioningStatus")||"").trim()==="CM100 READY";if(!r){let a=String(E("commissioningStatus")||"").trim();throw a?new Error(`Service-stand werd niet gereed: ${a}.`):new Error("Service-stand CM100 werd niet op tijd gereed.")}await Rp("quickFlowTest",!0),await D(et,"all");let n=String(E("commissioningStatus")||"").trim();if(!x("quickFlowTest"))throw new Error(n||"De waterpomptest kon niet worden gestart.");t.controlNotice="Waterpomptest gestart: alleen de pomp draait 30 seconden op 400 iPWM.",py()}catch(r){if(o&&!x("quickFlowTest"))try{let n=R.commissioningCm100Stop;await fetch(U(n.domain,n.name,"press"),{method:"POST"})}catch{}t.controlError=`Waterpomptest starten mislukt. ${r.message}`}finally{t.busyAction="",d()}}async function Np(){t.busyAction="quickstart-flow-test-abort",t.controlNotice="",t.controlError="",d();try{await Rp("quickFlowTest",!1),await D(et,"all"),t.controlNotice="Waterpomptest gestopt. OpenQuatt keert terug naar de normale regeling."}catch(e){t.controlError=`Waterpomptest stoppen mislukt. ${e.message}`}finally{t.busyAction="",d()}}async function Op(){let e=Sa();if(!e.canApply){t.controlError=e.selectedSource==="CIC"?"Vul eerst een geldig CiC-adres of een geldige feed-URL in.":"De vereiste thermostaatbroninstelling is niet beschikbaar in deze firmware.",d();return}t.busyAction="quickstart-thermostat-source",t.controlNotice="",t.controlError="",d();let o=async(r,n)=>{if(!h(r))return;let a=E(r);if(typeof n=="boolean"&&x(r)===n||typeof n!="boolean"&&String(a)===String(n))return;let i=await jt(r,n);t.entities[r]={...t.entities[r]||{},value:i,state:i}};try{e.selectedSource==="OT thermostat"?await o("otEnabled",!0):e.selectedSource==="CIC"&&(await o("cicFeedUrl",e.normalizedDraftUrl),await o("cicPollingEnabled",!0),t.quickStartCicFeedUrlDraft=null),await o("roomTempSource",e.selectedSource),await o("roomSetpointSource",e.selectedSource),t.controlNotice=e.selectedSource==="OT thermostat"?"Kamertemperatuur en setpoint zijn gekoppeld aan OpenTherm.":e.selectedSource==="CIC"?"Kamertemperatuur en setpoint zijn gekoppeld aan de CiC JSON-feed.":"Kamertemperatuur en setpoint zijn gekoppeld aan Home Assistant.",await D(lo,"all")}catch(r){t.controlError=`Thermostaatconfiguratie kon niet volledig worden toegepast. ${r.message}`}finally{t.busyAction="",d()}}function Lp(e=t.authStatus||{}){return[e.enabled?"on":"off",e.setup_window_active?"armed":"locked",String(e.username||""),String(e.source||""),String(e.csrf_token||"")].join(":")}function Ys(){let e=t.authStatus||{};t.authDraftUsername=e.enabled?String(e.username||"").trim():"",t.authDraftCurrentPassword="",t.authDraftNewPassword="",t.authDraftConfirmPassword=""}function ka(e=t.apiSecurityStatus||{}){return[e.enabled?"on":"off",e.transport_active?"active":"idle",e.pending_restart?"pending":"settled",e.key_present?"has-key":"no-key",String(e.key||""),String(e.source||""),String(e.csrf_token||"")].join(":")}function Dp(){return t.systemModal==="login"||t.systemModal==="api-security"||oo()}function Fp(){return t.systemModal==="api-security"||oo()}async function So(e={}){if(!Gr(t.lastAuthStatusRefreshAt,e))return!1;t.lastAuthStatusRefreshAt=Date.now();try{let o=await fetch("/auth/status",{cache:"no-store"});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json(),n={enabled:!!r.enabled,setup_window_active:!!r.setup_window_active,username:String(r.username||""),source:String(r.source||""),csrf_token:String(r.csrf_token||"")},a=Lp(),i=Lp(n);return t.authStatus=n,a!==i&&Ys(),t.systemModal==="login"&&(t.authError=""),a!==i}catch(o){return t.systemModal==="login"&&(t.authError=`Loginstatus kon niet worden geladen. ${o.message}`),!1}}function Ea(){return t.nativeOpen||t.systemModal!=="login"?!1:(t.authStatus||{}).setup_window_active!==!0}function rn(){t.loginAuthStatusPollTimer&&(window.clearTimeout(t.loginAuthStatusPollTimer),t.loginAuthStatusPollTimer=null)}function Ip(e=ic){t.loginAuthStatusPollTimer||!Ea()||(t.loginAuthStatusPollTimer=window.setTimeout(async()=>{if(t.loginAuthStatusPollTimer=null,!Ea())return;let o=t.authError;(await So({force:!0})||t.authError!==o)&&t.systemModal==="login"&&d(),Ea()&&Ip()},Math.max(0,Number(e)||0)))}async function _p(e={}){if(t.systemModal!=="login")return!1;let o=t.authError,r=await So({force:!0});return(r||t.authError!==o)&&t.systemModal==="login"&&d(),e.poll!==!1&&Ea()&&Ip(),r}async function to(e={}){if(!Gr(t.lastApiSecurityStatusRefreshAt,e))return!1;t.lastApiSecurityStatusRefreshAt=Date.now();try{let o=await fetch("/api-security/status",{cache:"no-store"});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json(),n={enabled:!!r.enabled,transport_active:!!r.transport_active,pending_restart:!!r.pending_restart,key_present:!!(r.key_present||r.key),key:String(r.key||""),source:String(r.source||""),csrf_token:String(r.csrf_token||"")},a=ka(),i=ka(n);return t.apiSecurityStatus=n,t.apiSecurityError="",a!==i&&(t.apiSecurityNotice=""),a!==i}catch(o){return t.apiSecurityError=`API-beveiliging kon niet worden geladen. ${o.message}`,!1}}async function Wp(){await qo("restartAction",{successNotice:"OpenQuatt wordt opnieuw opgestart om de API-beveiliging toe te passen.",errorPrefix:"Herstart mislukt",reconnectMode:"restart"})}async function Vp(){let e=t.apiSecurityStatus||{};if(!e.csrf_token){t.apiSecurityError="API-beveiliging laden nog. Probeer het zo opnieuw.",d();return}t.apiSecurityBusy=!0,t.apiSecurityNotice="",t.apiSecurityError="",d();try{let o=new URLSearchParams;o.set("csrf_token",e.csrf_token);let r=await fetch("/api-security/enable",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=UTF-8"},body:o.toString()}),n=await r.json().catch(()=>({ok:!1,error:"invalid_response"}));if(!r.ok||!n.ok)throw new Error(n.error||`HTTP ${r.status}`);await to({force:!0}),t.apiSecurityNotice="API-beveiliging is opgeslagen. Kopieer de sleutel en kies daarna Opslaan en herstarten.",t.apiSecurityError="",d()}catch(o){t.apiSecurityError=`Inschakelen is mislukt. ${o.message}`,d()}finally{t.apiSecurityBusy=!1,d()}}async function Bp(){let e=t.apiSecurityStatus||{};if(!e.csrf_token){t.apiSecurityError="API-beveiliging laden nog. Probeer het zo opnieuw.",d();return}t.apiSecurityBusy=!0,t.apiSecurityNotice="",t.apiSecurityError="",d();try{let o=new URLSearchParams;o.set("csrf_token",e.csrf_token);let r=await fetch("/api-security/rotate",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=UTF-8"},body:o.toString()}),n=await r.json().catch(()=>({ok:!1,error:"invalid_response"}));if(!r.ok||!n.ok)throw new Error(n.error||`HTTP ${r.status}`);await to({force:!0}),t.apiSecurityNotice="API-sleutel is opgeslagen. Kopieer de nieuwe sleutel en kies daarna Opslaan en herstarten.",t.apiSecurityError="",d()}catch(o){t.apiSecurityError=`Roteren is mislukt. ${o.message}`,d()}finally{t.apiSecurityBusy=!1,d()}}async function Kp(){let e=t.apiSecurityStatus||{};if(!e.csrf_token){t.apiSecurityError="API-beveiliging laden nog. Probeer het zo opnieuw.",d();return}if(!e.enabled){t.apiSecurityNotice="API-encryptie staat al uit.",t.apiSecurityError="",d();return}t.apiSecurityBusy=!0,t.apiSecurityNotice="",t.apiSecurityError="",d();try{let o=new URLSearchParams;o.set("csrf_token",e.csrf_token);let r=await fetch("/api-security/disable",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=UTF-8"},body:o.toString()}),n=await r.json().catch(()=>({ok:!1,error:"invalid_response"}));if(!r.ok||!n.ok)throw new Error(n.error||`HTTP ${r.status}`);await to({force:!0}),t.apiSecurityNotice="API-beveiliging is opgeslagen. Kies daarna Opslaan en herstarten om dit toe te passen.",t.apiSecurityError="",d()}catch(o){t.apiSecurityError=`Uitzetten is mislukt. ${o.message}`,d()}finally{t.apiSecurityBusy=!1,d()}}async function jp(){let e=String(t.apiSecurityStatus?.key||"").trim();if(!e){t.apiSecurityError="Er is nog geen API-sleutel om te kopi\xEBren.",d();return}try{if(!await It(e))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");t.apiSecurityNotice="API-sleutel gekopieerd.",t.apiSecurityError="",d()}catch(o){t.apiSecurityError=`Kopi\xEBren is mislukt. ${o.message}`,d()}}async function Up(){let e=t.authStatus||{},o=e.enabled===!0,r=e.setup_window_active===!0,n=String(t.authDraftCurrentPassword||""),a=String(t.authDraftUsername||"").trim(),i=String(t.authDraftNewPassword||""),l=String(t.authDraftConfirmPassword||"");if(!a||!i){t.authError="Vul een gebruikersnaam en wachtwoord in.",d();return}if(i!==l){t.authError="De twee wachtwoorden zijn niet gelijk.",d();return}if(o&&!n){t.authError="Vul je huidige wachtwoord in.",d();return}if(!o&&!r){t.authError="Houd de herstelknop 5 seconden vast.",d();return}if(!e.csrf_token){t.authError="Logingegevens laden nog. Probeer het zo opnieuw.",d();return}t.authBusy=!0,t.authError="",t.authNotice="",d();try{let p=new URLSearchParams;p.set("csrf_token",e.csrf_token),p.set("current_password",n),p.set("new_username",a),p.set("new_password",i);let u=await fetch("/auth/change",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=UTF-8"},body:p.toString()}),c=await u.json().catch(()=>({ok:!1,error:"invalid_response"}));if(!u.ok||!c.ok)throw new Error(c.error||`HTTP ${u.status}`);await So({force:!0}),t.authDraftCurrentPassword="",t.authDraftNewPassword="",t.authDraftConfirmPassword="",t.authDraftUsername=String(t.authStatus?.username||a).trim(),t.authNotice=o?"Login aangepast.":"Login staat nu aan.",t.authError="",d()}catch(p){t.authError=`Opslaan is mislukt. ${p.message}`,d()}finally{t.authBusy=!1,d()}}async function Gp(){let e=t.authStatus||{};if(!e.enabled){t.authNotice="Login staat al uit.",t.authError="",d();return}let o=String(t.authDraftCurrentPassword||"");if(!o){t.authError="Vul je huidige wachtwoord in.",d();return}if(!e.csrf_token){t.authError="Logingegevens laden nog. Probeer het zo opnieuw.",d();return}t.authBusy=!0,t.authError="",t.authNotice="",d();try{let r=new URLSearchParams;r.set("csrf_token",e.csrf_token),r.set("current_password",o);let n=await fetch("/auth/disable",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=UTF-8"},body:r.toString()}),a=await n.json().catch(()=>({ok:!1,error:"invalid_response"}));if(!n.ok||!a.ok)throw new Error(a.error||`HTTP ${n.status}`);await So({force:!0}),t.authDraftCurrentPassword="",t.authDraftNewPassword="",t.authDraftConfirmPassword="",t.authDraftUsername="",t.authNotice="Login staat nu uit.",t.authError="",d()}catch(r){t.authError=`Uitzetten is mislukt. ${r.message}`,d()}finally{t.authBusy=!1,d()}}function dy([e,o]){let r=Ti(o);if(!h(o)&&Number.isNaN(r))return"";let n=qi(o)?Ke(o):O(o);return`
      <div class="oq-overview-energy-row">
        <span>${s(e)}</span>
        <strong>${s(n)}</strong>
      </div>
    `}function my(e){let o=e.rows.map(dy).filter(Boolean).join("");return o?`
    ...
    `:""}function gy(e){let o=e.groups.map(my).filter(Boolean).join("");return o?`
    ...
    `:""}function hy(e){let o=e.categories.map(gy).filter(Boolean).join("");return o?`
    ...
    `:""}function el(){let e=Ln.map(hy).filter(Boolean),o=["oq-overview-energy-grid",e.length===1?"oq-overview-energy-grid--single":"",e.length===2?"oq-overview-energy-grid--two":""].filter(Boolean).join(" ");return{renderedColumns:e,gridClassName:o}}function Jp(e=el()){return ve(e)}function Xp(e=el()){return`
      <section class="oq-overview-energy oq-overview-energy--solo" data-render-signature="${s(Jp(e))}">
        <div class="${s(e.gridClassName)}">
          ${e.renderedColumns.join("")}
        </div>
      </section>
    `}var $a=["electricalInputWh","heatingInputWh","coolingInputWh","heatpumpHeatOutputWh","heatpumpCoolingOutputWh","boilerHeatOutputWh","systemHeatOutputWh"],ed=[{id:"day",label:"Dag"},{id:"week",label:"Week"},{id:"month",label:"Maand"},{id:"year",label:"Jaar"},{id:"all",label:"Alles"}],fy=new Set(["day","week","month","year"]),by=["Zo","Ma","Di","Wo","Do","Vr","Za"];function Pe(e){let o=String(e||"").trim();return ed.some(r=>r.id===o)?o:"day"}function tl(e){let o=Pe(e);t.energyHistoryView!==o&&(t.energyHistoryView=o,t.energyHistoryLastFetchAt=0,d(),td())}function td(){typeof it=="function"&&it({force:!0}).then(e=>{e&&d()})}function ur(e){return fy.has(Pe(e))}function Aa(){let e=new Date;return e.getFullYear()*1e4+(e.getMonth()+1)*100+e.getDate()}function nn(){let e=String(t.energyHistoryRaw||""),o={storedDayCount:0,oldestDateKey:null,newestDateKey:null,hourStoredDayCount:0,hourOldestDateKey:null,hourNewestDateKey:null,hourRequestedRetentionDays:0,hourSlotCount:0,hourPartitionAvailable:!1,hourRecordCount:0,hourWriteCount:0,hourStorageKb:0,hourLastWriteTimestampS:0,dayPartitionAvailable:!1,dayStorageKb:0,dayWriteCount:0,dayLastWriteTimestampS:0};return e.split(/\r?\n/).forEach(r=>{if(!r.startsWith("@bounds|")&&!r.startsWith("@day_retention|")&&!r.startsWith("@hour_retention|"))return;let n=r.split("|");r.startsWith("@bounds|")?(o.storedDayCount=Number(n[1])||0,o.oldestDateKey=Number(n[2])||null,o.newestDateKey=Number(n[3])||null,o.hourStoredDayCount=Number(n[4])||0,o.hourOldestDateKey=Number(n[5])||null,o.hourNewestDateKey=Number(n[6])||null):r.startsWith("@day_retention|")?(o.dayPartitionAvailable=Number(n[1])===1,o.dayStorageKb=Number(n[2])||0,o.dayWriteCount=Number(n[3])||0,o.dayLastWriteTimestampS=Number(n[4])||0):r.startsWith("@hour_retention|")&&(o.hourRequestedRetentionDays=Number(n[1])||0,o.hourSlotCount=Number(n[2])||0,o.hourPartitionAvailable=Number(n[3])===1,o.hourRecordCount=Number(n[4])||0,o.hourWriteCount=Number(n[5])||0,o.hourStorageKb=Number(n[6])||0,o.hourLastWriteTimestampS=Number(n[7])||0)}),o}function ol(){let e=String(t.energyHistoryRaw||""),o=null;return e.split(/\r?\n/).forEach(r=>{let n=cd(r);n&&(o=n.dateKey)}),o}function yy(e=[],o=!0){let r=ol(),n=nn(),a=(Array.isArray(e)?e:[]).map(i=>Number(i?.dateKey)).filter(Number.isFinite);return Number.isFinite(Number(n.newestDateKey))&&a.push(Number(n.newestDateKey)),Number.isFinite(Number(r))&&a.push(Number(r)),o&&Ha().forEach(i=>{let l=Number(i?.dateKey);Number.isFinite(l)&&a.push(l)}),a.length?Math.max(...a):Aa()}function Ye(e){return e.getFullYear()*1e4+(e.getMonth()+1)*100+e.getDate()}function od(e,o,r){return new Date(e,o-1,r,12,0,0)}function rd(e,o){return new Date(e,o,0).getDate()}function zp(e){return String(e).padStart(2,"0")}function Zs(e){let o=oe(e);return o?`${o.year}-${zp(o.month)}-${zp(o.day)}`:""}function nd(e){let o=/^(\d{4})-(\d{2})-(\d{2})$/.exec(String(e||"").trim());if(!o)return null;let r=Number(o[1]),n=Number(o[2]),a=Number(o[3]),i=od(r,n,a);return i.getFullYear()!==r||i.getMonth()+1!==n||i.getDate()!==a?null:oe(Ye(i))}function ad(e,o){return Number(e)*100+Number(o)}function Xs(e){return ad(e.getFullYear(),e.getMonth()+1)}function lr(e){let o=Number(e);if(!Number.isFinite(o)||o<=0)return null;let r=Math.floor(o/100),n=o%100;return r<2020||n<1||n>12?null:{key:o,year:r,month:n,date:new Date(r,n-1,1,12,0,0)}}function vy(e){let o=String(e||"").trim(),r=/^(\d{4})-(\d{2})$/.exec(o);return lr(r?ad(Number(r[1]),Number(r[2])):o)}function id(e,o){let r=lr(e);if(!r)return"";let n=new Date(r.year,r.month-1+Number(o||0),1,12,0,0);return String(Xs(n))}function an(e){let o=new Date(e.getTime()),r=o.getDay(),n=r===0?-6:1-r;return o.setDate(o.getDate()+n),o.setHours(12,0,0,0),o}function cr(e,o){let r=new Date(e.getTime());return r.setDate(r.getDate()+o),r.setHours(12,0,0,0),r}function Qp(e){return e.toLocaleDateString("nl-NL",{day:"numeric",month:"short"}).replace(/\./g,"")}function sd(e){let o=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),r=(o.getUTCDay()+6)%7;o.setUTCDate(o.getUTCDate()-r+3);let n=o.getUTCFullYear(),a=new Date(Date.UTC(n,0,4)),i=(a.getUTCDay()+6)%7;return a.setUTCDate(a.getUTCDate()-i+3),{week:1+Math.round((o-a)/(10080*60*1e3)),year:n}}function Yp(e){return Ye(an(e))}function wy(e){let r=nd(e)||oe(e);if(!r)return null;let n=an(r.date);return oe(Ye(n))}function ld(e){let o=oe(e);if(!o)return"Week";let r=an(o.date),n=cr(r,6);return`Week ${sd(r).week} (${Qp(r)} - ${Qp(n)})`}function oe(e){let o=Number(e);if(!Number.isFinite(o)||o<=0)return null;let r=Math.floor(o/1e4),n=Math.floor(o/100)%100,a=o%100;return r<2020||n<1||n>12||a<1||a>31?null:{key:o,year:r,month:n,day:a,date:new Date(r,n-1,a,12,0,0)}}function Mt(e,o="day"){let r=oe(e);return r?o==="weekday"?by[r.date.getDay()]||"":o==="month"?r.date.toLocaleDateString("nl-NL",{month:"short"}):o==="year"?String(r.year):r.date.toLocaleDateString("nl-NL",{day:"2-digit",month:"short"}):"\u2014"}function To(e){let o=A(e);return!Number.isFinite(o)||o<0?null:Math.round(o*1e3)}function Sy(e){let o=Number(e);return Number.isFinite(o)&&o>=0?o:null}function rl(e,o=0){let r={};return $a.forEach((n,a)=>{r[n]=Sy(e[o+a])}),r}function qy(e){let o=String(e||"").trim();if(!o||o.startsWith("@"))return null;let r=o.split("|");if(r.length<10)return null;let n=Number(r[0]),a=Number(r[1]),i=Number(r[2]),l=oe(a);return!Number.isFinite(n)||!l?null:{sequence:n,dateKey:a,year:l.year,month:l.month,day:l.day,partial:!!(i&1),source:"flash",...rl(r,3)}}function cd(e){let o=String(e||"").trim();if(!o.startsWith("@current|"))return null;let r=o.split("|");if(r.length<9)return null;let n=Number(r[1]),a=oe(n);return a?{sequence:Number.MAX_SAFE_INTEGER,dateKey:n,year:a.year,month:a.month,day:a.day,partial:!0,source:"current",...rl(r,2)}:null}function Ty(e){let o=String(e||"").trim();if(!o.startsWith("@hour|"))return null;let r=o.split("|");if(r.length<11)return null;let n=Number(r[1]),a=Number(r[2]),i=Number(r[3]),l=oe(a);return!Number.isFinite(n)||!l||!Number.isInteger(i)||i<0||i>23?null:{sequence:n,dateKey:a,year:l.year,month:l.month,day:l.day,hour:i,partial:!0,source:"hour",label:String(i),tooltipLabel:`${String(i).padStart(2,"0")}:00 - ${String((i+1)%24).padStart(2,"0")}:00`,sortKey:a*100+i,...rl(r,4)}}function Ey(){let e=ol()||Aa(),o=oe(e);if(!o)return null;let r={sequence:Number.MAX_SAFE_INTEGER-1,dateKey:e,year:o.year,month:o.month,day:o.day,partial:!0,source:"sensors",electricalInputWh:To("electricalEnergyDaily"),heatingInputWh:To("heatingElectricalEnergyDaily"),coolingInputWh:To("coolingElectricalEnergyDaily"),heatpumpHeatOutputWh:To("heatpumpThermalEnergyDaily"),heatpumpCoolingOutputWh:To("heatpumpCoolingEnergyDaily"),boilerHeatOutputWh:To("boilerThermalEnergyDaily"),systemHeatOutputWh:To("systemThermalEnergyDaily")};return $a.some(n=>Number.isFinite(r[n]))?r:null}function sn(e,o){let r=Number(e?.[o]);return Number.isFinite(r)&&r>=0?r:0}function ln(){let e=new Map;String(t.energyHistoryRaw||"").split(/\r?\n/).forEach(i=>{let l=qy(i)||cd(i);if(!l)return;let p=e.get(l.dateKey);(!p||l.sequence>=p.sequence)&&e.set(l.dateKey,l)});let r=Ey();r&&e.set(r.dateKey,r);let n=new Set(e.keys()),a=new Map;return Ha().forEach(i=>{if(n.has(i.dateKey))return;let l=a.get(i.dateKey);if(!l){let p=oe(i.dateKey);if(!p)return;l=Eo({dateKey:p.key,year:p.year,month:p.month,day:p.day,label:Mt(p.key),sortKey:p.key,source:"hour-summary"}),l.tooltipLabel=`${Mt(i.dateKey)} \xB7 uurdata sinds herstart`,a.set(i.dateKey,l)}ko(l,i)}),a.forEach((i,l)=>{e.set(l,i)}),[...e.values()].sort((i,l)=>i.dateKey-l.dateKey)}function Ha(){let e=new Map;return String(t.energyHistoryRaw||"").split(/\r?\n/).forEach(r=>{let n=Ty(r);if(!n)return;let a=`${n.dateKey}:${n.hour}`,i=e.get(a);(!i||n.sequence>=i.sequence)&&e.set(a,n)}),[...e.values()].sort((r,n)=>r.sortKey-n.sortKey)}function ky(e){return Ha().filter(o=>o.dateKey===Number(e))}function sr(e,o){return e.reduce((r,n)=>r+sn(n,o),0)}function ud(e){return["heatpumpHeatOutputWh","heatpumpCoolingOutputWh","boilerHeatOutputWh"].reduce((o,r)=>o+sn(e,r),0)}function Cy(e){return sn(e,"electricalInputWh")+ud(e)}function xa(e,o){let r=Number(e),n=Number(o);return!Number.isFinite(r)||!Number.isFinite(n)||n<=0?"\u2014":(r/n).toFixed(2)}function Qe(e,o=1){let r=Number(e);return Number.isFinite(r)?Math.abs(r)>=999500?`${(r/1e6).toFixed(2)} MWh`:Math.abs(r)<1e3?`${Math.round(r)} Wh`:`${(r/1e3).toFixed(o)} kWh`:"\u2014"}function Eo({dateKey:e,year:o,month:r,day:n,hour:a=null,label:i,tooltipLabel:l="",sortKey:p,source:u="bucket"}){return{sequence:0,dateKey:e,year:o,month:r,day:n,hour:a,label:i,tooltipLabel:l,sortKey:p??e,partial:!1,source:u,electricalInputWh:0,heatingInputWh:0,coolingInputWh:0,heatpumpHeatOutputWh:0,heatpumpCoolingOutputWh:0,boilerHeatOutputWh:0,systemHeatOutputWh:0}}function ko(e,o){return $a.forEach(r=>{e[r]+=sn(o,r)}),e.partial=e.partial||!!o?.partial,e.sequence=Math.max(Number(e.sequence||0),Number(o?.sequence||0)),e}function xy(e){let o=new Map;return e.forEach(r=>{o.set(r.dateKey,r)}),o}function pd(e,o){let r=Pe(e);if(r==="day"){let n=nd(o)||oe(o);return n?String(n.key):""}if(r==="week"){let n=wy(o);return n?String(n.key):""}if(r==="month"){let n=vy(o);return n?String(n.key):""}if(r==="year"){let n=Number(o);return Number.isInteger(n)&&n>=2020&&n<=2200?String(n):""}return""}function Ma(e,o){let r=Pe(o),n=oe(yy(e,!0)),a=nn(),i=Ha(),l=[...e.map(v=>v.dateKey),...i.map(v=>v.dateKey)].filter(v=>Number.isFinite(Number(v)));Number.isFinite(Number(a.oldestDateKey))&&l.push(Number(a.oldestDateKey)),Number.isFinite(Number(a.newestDateKey))&&l.push(Number(a.newestDateKey));let p=l.length?Math.min(...l.map(Number)):n?.key,c=(p?oe(p):n)?.date||n?.date||new Date,m=n?.date||new Date,b=n?.key||Aa(),y=b;return r==="week"?(b=Yp(c),y=Yp(m)):r==="month"?(b=Xs(c),y=Xs(m)):r==="year"?(b=c.getFullYear(),y=m.getFullYear()):(b=Ye(c),y=Ye(m)),Number(b)>Number(y)&&(b=y),{min:String(b),max:String(y)}}function dd(e,o){let r=Number(e);return Number.isFinite(r)?r<Number(o.min)?String(o.min):r>Number(o.max)?String(o.max):String(e):String(o.max)}function $y(e,o,r=Ma(e,o)){let n=Pe(o),a=t.energyHistoryPeriodSelection?.[n],i=pd(n,a);return dd(i||r.max,r)}function Ay(e,o){let r=Pe(e),n=[],a=0;if(r==="week"){let i=String(o.max);for(;Number(i)>=Number(o.min)&&a<6e3;){let l=oe(i);n.push({value:i,label:ld(i),group:l?String(sd(l.date).year):""}),i=l?String(Ye(cr(l.date,-7))):"",a+=1}return n}if(r==="month"){let i=String(o.max);for(;Number(i)>=Number(o.min)&&a<1200;){let l=lr(i);if(!l)break;n.push({value:i,label:l.date.toLocaleDateString("nl-NL",{month:"long",year:"numeric"}),group:String(l.year)}),i=id(i,-1),a+=1}return n}if(r==="year")for(let i=Number(o.max);i>=Number(o.min);i-=1)n.push({value:String(i),label:String(i)});return n}function Ra(e,o){let r=Pe(o);if(!ur(r))return{view:r,selectedValue:"",minValue:"",maxValue:"",canPrevious:!1,canNext:!1,isNow:!0,options:[]};let n=Ma(e,r),a=$y(e,r,n);return{view:r,selectedValue:a,minValue:n.min,maxValue:n.max,canPrevious:Number(a)>Number(n.min),canNext:Number(a)<Number(n.max),isNow:Number(a)===Number(n.max),options:Ay(r,n)}}function Hy(e,o){let r=Pe(o);if(!ur(r))return{from:"",to:"",hours:"0"};let n=Ra(e,r);if(r==="day")return{from:n.selectedValue,to:n.selectedValue,hours:"1"};if(r==="week"){let a=oe(n.selectedValue);if(!a)return{from:"",to:"",hours:"0"};let i=an(a.date),l=cr(i,6);return{from:String(Ye(i)),to:String(Ye(l)),hours:"0"}}if(r==="month"){let a=lr(n.selectedValue);return a?{from:String(a.year*1e4+a.month*100+1),to:String(a.year*1e4+a.month*100+rd(a.year,a.month)),hours:"0"}:{from:"",to:"",hours:"0"}}if(r==="year"){let a=Number(n.selectedValue);return Number.isInteger(a)?{from:`${a}0101`,to:`${a}1231`,hours:"0"}:{from:"",to:"",hours:"0"}}return{from:"",to:"",hours:"0"}}function cn(){if(!String(t.energyHistoryRaw||"").trim())return"?meta=1";let e=ln(),o=Hy(e,t.energyHistoryView||"day"),r=new URLSearchParams;o.from&&r.set("from",o.from),o.to&&r.set("to",o.to),r.set("hours",o.hours);let n=r.toString();return n?`?${n}`:""}function un(e,o){let r=Pe(e);if(!ur(r))return;let n=ln(),a=Ma(n,r),i=pd(r,o),l=dd(i||a.max,a);t.energyHistoryPeriodSelection={...t.energyHistoryPeriodSelection,[r]:l},t.energyHistoryLastFetchAt=0,d(),td()}function nl(e,o){let r=Pe(e);if(!ur(r))return;let n=ln(),a=Ra(n,r),i=Number(o)<0?-1:1,l=a.selectedValue;if(r==="day"){let p=oe(a.selectedValue);l=p?String(Ye(cr(p.date,i))):l}else if(r==="week"){let p=oe(a.selectedValue);l=p?String(Ye(cr(p.date,i*7))):l}else r==="month"?l=id(a.selectedValue,i):r==="year"&&(l=String(Number(a.selectedValue)+i));un(r,l)}function al(e){let o=Pe(e);if(!ur(o))return;let r=ln(),n=Ma(r,o);un(o,n.max)}function My(e,o,r=Ra(e,o)){let n=Pe(o),a=xy(e);if(!e.length&&n==="all")return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};if(n==="day"){let p=oe(r.selectedValue);if(!p)return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};let u=ky(p.key);if(u.length){let v=new Map(u.map(f=>[f.hour,f])),g=[];for(let f=0;f<24;f+=1){let w=String(f),S=`${p.date.toLocaleDateString("nl-NL",{day:"numeric",month:"long"})} \xB7 ${String(f).padStart(2,"0")}:00 - ${String((f+1)%24).padStart(2,"0")}:00`,q=Eo({dateKey:p.key,year:p.year,month:p.month,day:p.day,hour:f,label:w,tooltipLabel:S,sortKey:f,source:"hour"}),k=v.get(f);k&&ko(q,k),g.push(q)}return{buckets:g,title:"Dag",detail:`${p.date.toLocaleDateString("nl-NL",{weekday:"long",day:"numeric",month:"long",year:"numeric"})} \xB7 uurdata sinds herstart`}}let c=a.get(p.key),m=ol()||Aa(),b=p.key===m?"Vandaag":Mt(p.key),y=Eo({dateKey:p.key,year:p.year,month:p.month,day:p.day,label:b,sortKey:p.key,source:"day"});return c&&ko(y,c),{buckets:[y],title:"Dag",detail:`${p.date.toLocaleDateString("nl-NL",{weekday:"long",day:"numeric",month:"long",year:"numeric"})} \xB7 dagtotaal`}}if(n==="week"){let p=oe(r.selectedValue);if(!p)return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};let u=an(p.date),c=[];for(let m=0;m<7;m+=1){let b=cr(u,m),y=Ye(b),v=oe(y),g=Eo({dateKey:y,year:v.year,month:v.month,day:v.day,label:Mt(y,"weekday"),sortKey:y}),f=a.get(y);f&&ko(g,f),c.push(g)}return{buckets:c,title:"Week",detail:ld(r.selectedValue)}}if(n==="month"){let p=lr(r.selectedValue);if(!p)return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};let u=rd(p.year,p.month),c=[];for(let m=1;m<=u;m+=1){let b=od(p.year,p.month,m),y=Ye(b),v=Eo({dateKey:y,year:p.year,month:p.month,day:m,label:String(m),sortKey:y}),g=a.get(y);g&&ko(v,g),c.push(v)}return{buckets:c,title:"Maand",detail:p.date.toLocaleDateString("nl-NL",{month:"long",year:"numeric"})}}if(n==="year"){let p=Number(r.selectedValue);if(!Number.isInteger(p))return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};let u=[];for(let c=1;c<=12;c+=1){let m=p*1e4+c*100+1,b=Eo({dateKey:m,year:p,month:c,day:1,label:Mt(m,"month"),sortKey:c,source:"month"});e.filter(y=>y.year===p&&y.month===c).forEach(y=>ko(b,y)),u.push(b)}return{buckets:u,title:"Jaar",detail:String(p)}}let i=new Map;e.forEach(p=>{i.has(p.year)||i.set(p.year,Eo({dateKey:p.year*1e4+101,year:p.year,month:1,day:1,label:String(p.year),sortKey:p.year,source:"year"})),ko(i.get(p.year),p)});let l=[...i.values()].sort((p,u)=>p.sortKey-u.sortKey);return{buckets:l,title:"Alles",detail:l.length?`${l[0].label} - ${l[l.length-1].label}`:"Geen data"}}function Ry(e){let o=sr(e,"heatpumpHeatOutputWh"),r=sr(e,"heatpumpCoolingOutputWh"),n=sr(e,"boilerHeatOutputWh");return{electricalInputWh:sr(e,"electricalInputWh"),heatingInputWh:sr(e,"heatingInputWh"),coolingInputWh:sr(e,"coolingInputWh"),heatOutputWh:o,coolingOutputWh:r,boilerOutputWh:n,outputWh:o+r+n}}function Py(e){let o=Number(e.heatOutputWh||0)+Number(e.coolingOutputWh||0),r=Number(e.boilerOutputWh||0),n=o+r;return!Number.isFinite(n)||n<=0?Number.NaN:o/n*100}function Ca(e,o,r=""){return`
      <div class="oq-energy-history-stat">
        <span>${s(e)}</span>
        <strong>${s(o)}</strong>
        ${r?`<p>${s(r)}</p>`:""}
      </div>
    `}function Js(e,o,r){let n=[];r.forEach(i=>{let l=String(i.group||""),p=n[n.length-1];(!p||p.label!==l)&&(p={label:l,options:[]},n.push(p)),p.options.push(i)});let a=n.some(i=>i.label)?n.map(i=>i.label?`
    ...
    `}function Zp(e){return e.view==="day"?`
        <label class="oq-energy-history-period-field">
          <span>Datum</span>
          <input
            class="oq-energy-history-period-input"
            type="date"
            value="${s(Zs(e.selectedValue))}"
            min="${s(Zs(e.minValue))}"
            max="${s(Zs(e.maxValue))}"
            data-oq-energy-history-period-input="day"
          >
        </label>
      `:e.view==="week"?Js(e,"Week",e.options):e.view==="month"?Js(e,"Maand",e.options):e.view==="year"?Js(e,"Jaar",e.options):`
      <div class="oq-energy-history-period-field oq-energy-history-period-field--static">
        <span>Periode</span>
        <strong>Volledig bereik</strong>
      </div>
    `}function Ny(e){return ur(e.view)?`
    ...
    `:`
      ...
      `}function Oy(){let e=document.activeElement;return!!(e&&e.closest&&e.closest(".oq-energy-history-period"))}function Ly(e){return`
      <div class="oq-energy-history-view-tabs" role="tablist" aria-label="Energiehistorie weergave">
        ${ed.map(o=>{let r=o.id===e;return`
            <button
              type="button"
    ...
    `}function Dy(e){let o=Number(e.electricalInputWh||0),r=Number(e.heatOutputWh||0),n=Number(e.coolingOutputWh||0),a=Number(e.boilerOutputWh||0),i=a>0?"boiler":"boiler-zero",l=Math.max(1,o+r+n+a),p=c=>`${Math.max(0,Number(c||0)/l*100).toFixed(2)}%`,u=Py(e);return`
      <div class="oq-energy-history-balance">
        ...
        <div class="oq-energy-history-balance-list">
          <span><i class="oq-energy-history-legend-dot oq-energy-history-legend-dot--heat"></i>${s(Qe(r,1))} warmte door warmtepomp</span>
          <span><i class="oq-energy-history-legend-dot oq-energy-history-legend-dot--input"></i>${s(Qe(o,1))} verbruikte elektriciteit</span>
          <span><i class="oq-energy-history-legend-dot oq-energy-history-legend-dot--cooling"></i>${s(Qe(n,1))} koeling</span>
          <span><i class="oq-energy-history-legend-dot oq-energy-history-legend-dot--${s(i)}"></i>${s(Qe(a,1))} cv-ketel</span>
        </div>
      </div>
    `}function Fy(e){let o=Math.max(1,Number(e||0)/1e3),r=Math.pow(10,Math.floor(Math.log10(o))),n=o/r;return(n<=1.5?1.5:n<=3?3:n<=6?6:10)*r*1e3}function Iy(e){let o=Number(e);return Number.isFinite(o)?o>=999500?`${Number((o/1e6).toFixed(1))}`:`${Number((o/1e3).toFixed(1))}`:""}function _y(e){return e>=999500?"MWh":"kWh"}function Wy(e){let c=Math.max(1e3,...e.map(Cy)),m=Fy(c),b=e.length?1218/e.length:1218,y=Math.max(6,Math.min(38,b*.68));return{width:1280,height:260,left:44,right:18,top:26,bottom:38,plotWidth:1218,plotHeight:196,axisMax:m,barSlot:b,barWidth:y,yOf:g=>26+(1-Math.min(1,Math.max(0,Number(g||0)/m)))*196}}function Vy(e){let o=xa(e.heatpumpHeatOutputWh,e.heatingInputWh),r=xa(e.heatpumpCoolingOutputWh,e.coolingInputWh),n=xa(ud(e),e.electricalInputWh);return[e.tooltipLabel||e.label||Mt(e.dateKey),`Elektrisch: ${Qe(e.electricalInputWh,1)}`,`Warmtepomp warmte: ${Qe(e.heatpumpHeatOutputWh,1)}`,`Warmtepomp koeling: ${Qe(e.heatpumpCoolingOutputWh,1)}`,`Cv-ketel: ${Qe(e.boilerHeatOutputWh,1)}`,`COP verwarmen: ${o}`,`EER koelen: ${r}`,`Output / elektrisch: ${n}`].join(`
`)}function By(e,o=""){if(!e.length)return`
      ...
      `;let r=Wy(e),n=_y(r.axisMax),a=[0,.25,.5,.75,1].map(l=>r.axisMax*l),i=e.map((l,p)=>{let u=r.left+r.barSlot*p+r.barSlot/2,c=[{key:"electricalInputWh",className:"input",label:"Verbruikte elektriciteit"},{key:"heatpumpHeatOutputWh",className:"heat",label:"Warmte door warmtepomp"},{key:"heatpumpCoolingOutputWh",className:"cooling",label:"Koeling warmtepomp"},{key:"boilerHeatOutputWh",className:"boiler",label:"Cv-ketel"}],m=r.height-r.bottom,b=c.map(f=>{let w=sn(l,f.key);if(w<=0)return"";let S=w/r.axisMax*r.plotHeight;return m-=S,`
          ...
          >
            <title>${s(`${l.label} \xB7 ${f.label}: ${Qe(w,1)}`)}</title>
          </rect>
        `}).join(""),v=e.length<=12||p===0||p===e.length-1||p%3===0?`<text x="${u.toFixed(1)}" y="${r.height-18}" text-anchor="middle" class="oq-energy-history-axis-label">${s(l.label||Mt(l.dateKey))}</text>`:"",g=Vy(l);return`
        ...
        ${v}
      `}).join("");return`
      <svg class="oq-energy-history-chart oq-energy-history-chart--${s(Pe(o))}" viewBox="0 0 ${r.width} ${r.height}" role="img" aria-label="Energiehistorie">
        ...
        ${a.map(l=>{let p=r.yOf(l);return`
            ...
            <text x="${r.left-10}" y="${p.toFixed(1)}" text-anchor="end" dominant-baseline="middle" class="oq-energy-history-axis-label">${s(Iy(l))}</text>
          `}).join("")}
        ${i}
      </svg>
    `}function Ky(e=null){let o=Number(e?.boilerOutputWh||0)>0?"boiler":"boiler-zero";return`
    ...
    `}function il(){let e=ln(),o=Pe(t.energyHistoryView),r=Ra(e,o),n=My(e,o,r),a=Ry(n.buckets);return{records:e,buckets:n.buckets,viewModel:n,periodControl:r,summary:a,activeView:o}}function md(e=il()){return ve({energyHistorySignature:t.energyHistorySignature||"",energyHistoryError:t.energyHistoryError||"",activeView:e.activeView,periodView:e.periodControl.view,periodValue:e.periodControl.selectedValue,periodMin:e.periodControl.minValue,periodMax:e.periodControl.maxValue,recordCount:e.records.length,bucketCount:e.buckets.length,latestDate:e.records[e.records.length-1]?.dateKey||0,currentValues:$a.map(o=>e.buckets[e.buckets.length-1]?.[o]??null)})}function gd(e=il()){let o=e.summary,r=e.buckets[0]?.dateKey?Mt(e.buckets[0].dateKey):"\u2014",n=e.buckets[e.buckets.length-1]?.dateKey?Mt(e.buckets[e.buckets.length-1].dateKey):"\u2014";return`
      <section class="oq-energy-history" data-render-signature="${s(md(e))}">
        ...
        <div class="oq-energy-history-stats">
          ${Ca("Gemiddelde COP",xa(o.heatOutputWh,o.heatingInputWh),`${s(r)} - ${s(n)}`)}
          ${Ca("Elektrisch",Qe(o.electricalInputWh,1),"verbruikt")}
          ${Ca("Warmtepomp",Qe(o.heatOutputWh+o.coolingOutputWh,1),"warmte en koeling")}
          ${Ca("Cv-ketel",Qe(o.boilerOutputWh,1),"thermisch")}
        </div>
        ${Dy(o)}
    ...
    `}function bd(){if(!t.root||t.appView!=="energy")return!1;let e=t.root.querySelector(".oq-overview-board"),o=e?e.querySelector(".oq-overview-energy"):null;if(!e||!o)return!1;let r=`oq-overview-board oq-overview-board--${t.overviewTheme}`;e.className!==r&&(e.className=r);let n=el();return mt(o,Jp(n),Xp(n))}function yd(){if(!t.root||t.appView!=="results")return!1;let e=t.root.querySelector(".oq-overview-board"),o=e?e.querySelector(".oq-energy-history"):null;if(!e||!o)return!1;let r=`oq-overview-board oq-overview-board--${t.overviewTheme}`;e.className!==r&&(e.className=r);let n=il(),a=Oy();return(a?!1:mt(o,md(n),gd(n)))||a}function jy(e){return Object.prototype.hasOwnProperty.call(e,"hour")||Object.prototype.hasOwnProperty.call(e,"hour_of_day")||Object.prototype.hasOwnProperty.call(e,"hourOfDay")}function Uy(e){return e.some(o=>Oa(o)!==void 0)}function Gy(e){let o=new Set;for(let r of e){let n=Cd(r.date_key??r.dateKey??r.date??r.from??Oa(r));if(n){if(o.has(n))return!0;o.add(n)}}return!1}function Sd(e){return e.some(jy)||Uy(e)&&Gy(e)}var dn=["trendHistoryEnabled","trendHistoryFlashEnabled","trendHistoryFlush","lifetimeEnergyHistoryEnabled","lifetimeEnergyHourRetention","lifetimeEnergyHistoryCapture","lifetimeEnergyHistoryClear"],qd=["trendHistoryEnabled","trendHistoryFlashEnabled"],Td=["lifetimeEnergyHistoryEnabled","lifetimeEnergyHourRetention","lifetimeEnergyHistoryCapture","lifetimeEnergyHistoryClear"];function Co(){return[...new Set(dn)]}function zy(){return{available:"Alleen live",oldest:"Geen data",newest:"Geen data",lastFlush:"Geen data",sizeKb:0,writes:0,nowMs:Number.NaN}}function Qy(e){let o=zy();return String(e||"").split(/\r?\n/).forEach(r=>{if(r.startsWith("@now|")){o.nowMs=Number(r.slice(5));return}if(!r.startsWith("@flash|"))return;let n=r.split("|");o.available=n[1]||o.available,o.oldest=n[2]||o.oldest,o.newest=n[3]||o.newest,o.lastFlush=n[4]||o.lastFlush,o.sizeKb=Number(n[5])||0,o.writes=Number(n[6])||0}),o}async function ll(e={}){if(!h("trendHistoryEnabled")&&!gr()){let n=!!(t.trendHistoryMetadataSignature||t.trendHistoryMetadataError);return t.trendHistoryMetadata={},t.trendHistoryMetadataError="",t.trendHistoryMetadataSignature="",t.trendHistoryMetadataLastFetchAt=0,n}let o=e.force===!0,r=Date.now();if(!o&&t.trendHistoryMetadataFetchPromise)return t.trendHistoryMetadataFetchPromise;if(!o&&(t.trendHistoryMetadataSignature||t.trendHistoryMetadataError)&&r-Number(t.trendHistoryMetadataLastFetchAt||0)<$n)return!1;t.trendHistoryMetadataFetchPromise=(async()=>{let n=await fetch(`${He()}/trends/history?meta=1`,{cache:"no-store"});if(!n.ok)throw new Error(`HTTP ${n.status}`);let a=await n.text(),i=Qy(a),l=`${a.length}|${a.slice(0,120)}|${a.slice(-120)}`,p=l!==t.trendHistoryMetadataSignature||t.trendHistoryMetadataError!=="";return t.trendHistoryMetadata=i,t.trendHistoryMetadataError="",t.trendHistoryMetadataSignature=l,t.trendHistoryMetadataLastFetchAt=Date.now(),p})();try{return await t.trendHistoryMetadataFetchPromise}catch(n){let a=`Trendhistorie metadata kon niet worden geladen. ${n.message}`,i=t.trendHistoryMetadataError!==a;return t.trendHistoryMetadata={},t.trendHistoryMetadataError=a,t.trendHistoryMetadataSignature="",t.trendHistoryMetadataLastFetchAt=Date.now(),i}finally{t.trendHistoryMetadataFetchPromise=null}}async function pr(e={}){await D(Co(),"all",{concurrency:St,forceMissing:e.forceMissing===!0}),await Promise.all([ll({force:e.forceTrendHistory===!0}),it({force:e.forceEnergyHistory===!0,metaOnly:!0})])}function dr(e=[250,1e3,2500],o={}){e.forEach(r=>{window.setTimeout(()=>{t.nativeOpen||t.appView!=="settings"||pr({forceMissing:r===0,forceTrendHistory:o.forceTrendHistory===!0,forceEnergyHistory:o.forceEnergyHistory===!0}).finally(()=>{t.appView==="settings"&&t.mounted&&!t.nativeOpen&&d()})},r)})}var Yy="@schema|openquatt.energy_history_import.v1",Zy=850,pn=[{id:"days",label:"Alleen dagtotalen",fileLabel:"daily"},{id:"days_and_hours",label:"Dagtotalen + uurdetail",fileLabel:"daily-hourly"},{id:"hours",label:"Alleen uurdetail",fileLabel:"hourly"}],Jy={forbidden:"Beveiligingstoken ontbreekt of is verlopen. Vernieuw de pagina en probeer opnieuw.",partition_unavailable:"Niet beschikbaar op deze Flash-indeling. Flash de controller eenmalig via USB met de nieuwe indeling.",time_unavailable:"De controller heeft nog geen geldige tijd. Probeer opnieuw zodra de tijdsync klaar is.",empty_records:"Er zijn geen records verstuurd.",payload_too_large:"Deze importbatch is te groot. Probeer het bestand opnieuw te importeren."},st={electricalInput:["electrical_input_wh","electricalInputWh","energy_hp_electric","hpElectric","hp_electric_wh","total_hp_electric_wh","totalHpElectric"],heatingInput:["heating_input_wh","heatingInputWh"],coolingInput:["cooling_input_wh","coolingInputWh"],heatpumpHeatOutput:["heatpump_heat_output_wh","heatpumpHeatOutputWh","energy_hp_heat","hpHeat","hp_heat_wh","total_hp_heat_wh","totalHpHeat"],heatpumpCoolingOutput:["heatpump_cooling_output_wh","heatpumpCoolingOutputWh","energy_hp_cooling","hpCooling","hp_cooling_wh","total_hp_cooling_wh","totalHpCooling"],boilerHeatOutput:["boiler_heat_output_wh","boilerHeatOutputWh","energy_boiler_heat","boilerHeat","boiler_heat_wh","total_boiler_heat_wh","totalBoilerHeat"],systemHeatOutput:["system_heat_output_wh","systemHeatOutputWh"]};function mr(e){let o=String(e||"").trim();return pn.some(r=>r.id===o)?o:"days_and_hours"}function Ed(e){let o=mr(e);return pn.find(r=>r.id===o)||pn[1]}function Xy(e){let o=Ed(e),r=new Date().toISOString().slice(0,10);return`openquatt-energy-history-${o.fileLabel}-${r}.json`}async function kd(){if(t.energyHistoryExportBusy)return;let e=mr(t.energyHistoryExportMode),o=Ed(e);if(t.energyHistoryExportMode=e,t.energyHistoryExportBusy=!0,t.energyHistoryExportError="",t.energyHistoryExportNotice="",d(),gr()){t.energyHistoryExportBusy=!1,t.energyHistoryExportNotice=`Preview: ${o.label.toLowerCase()} zou als JSON worden gedownload.`,d();return}try{let r=await fetch(`${He()}/energy/history/export?mode=${encodeURIComponent(e)}`,{cache:"no-store"});if(!r.ok)throw new Error(`HTTP ${r.status}`);let n=await r.blob();xi(n,Xy(e)),t.energyHistoryExportNotice=`${o.label} ge\xEBxporteerd.`}catch(r){t.energyHistoryExportError=`Exporteren mislukt. ${r.message}`}finally{t.energyHistoryExportBusy=!1,d()}}function cl(e=!1){let o=e?t.energyHistoryImportNotice:"";t.energyHistoryImportFileName="",t.energyHistoryImportSource="",t.energyHistoryImportRange="",t.energyHistoryImportRecords=[],t.energyHistoryImportHourRecords=[],t.energyHistoryImportDuplicateCount=0,t.energyHistoryImportSkippedCount=0,t.energyHistoryImportInvalidCount=0,t.energyHistoryImportUnsupportedCount=0,t.energyHistoryImportBusy=!1,t.energyHistoryImportProgressPercent=0,t.energyHistoryImportError="",t.energyHistoryImportNotice=o}function Cd(e){if(e==null||e==="")return 0;let o=String(e).trim(),r=0,n=0,a=0,i=o.match(/^(\d{4})(\d{2})(\d{2})$/),l=xd(o),p=o.match(/^(\d{4})-(\d{2})-(\d{2})$/);if(i)r=Number(i[1]),n=Number(i[2]),a=Number(i[3]);else{if(l)return l.dateKey;if(p)r=Number(p[1]),n=Number(p[2]),a=Number(p[3]);else{let c=new Date(o);if(Number.isNaN(c.getTime()))return 0;r=c.getFullYear(),n=c.getMonth()+1,a=c.getDate()}}if(r<2020||r>2099||n<1||n>12||a<1||a>31)return 0;let u=new Date(Date.UTC(r,n-1,a));return u.getUTCFullYear()!==r||u.getUTCMonth()!==n-1||u.getUTCDate()!==a?0:r*1e4+n*100+a}function vd(e){let o=String(Math.round(Number(e)||0)).padStart(8,"0");return/^\d{8}$/.test(o)?`${o.slice(6,8)}-${o.slice(4,6)}-${o.slice(0,4)}`:""}function Oa(e){return e.timestamp??e.time??e.datetime??e.date_time??e.dateTime}function xd(e){if(e==null||e==="")return null;let o=String(e).trim(),r=o.match(/^(\d{4})-(\d{2})-(\d{2})[T\s](\d{1,2})(?::(\d{2}))?(?::(\d{2})(?:\.\d+)?)?(?:Z|[+-]\d{2}:?\d{2})?$/i);if(!r)return null;let n=/(?:Z|[+-]\d{2}:?\d{2})$/i.test(o),a=Number(r[1]),i=Number(r[2]),l=Number(r[3]),p=Number(r[4]),u=Number(r[5]||"0"),c=Number(r[6]||"0");if([a,i,l,p,u,c].some(f=>Number.isNaN(f)))return null;let m=n?new Date(o):new Date(a,i-1,l,p,u,c,0);if(Number.isNaN(m.getTime()))return null;let b=m.getFullYear(),y=m.getMonth()+1,v=m.getDate(),g=m.getHours();return b<2020||b>2099||y<1||y>12||v<1||v>31?null:{dateKey:b*1e4+y*100+v,hour:g}}function $d(e){if(e==null||e==="")return null;let o=Number(String(e).trim().replace(",","."));return!Number.isFinite(o)||o<0||o>=4294967295?null:Math.round(o)}function ro(e,o,r=null){for(let n of o){if(!Object.prototype.hasOwnProperty.call(e,n))continue;let a=$d(e[n]);if(a!==null)return a}return r}function Pa(e,o){return ro(e,o)!==null}function Ad(e){let o=Cd(e.date_key??e.dateKey??e.date??e.from??Oa(e));if(!o)return null;let r=ro(e,st.electricalInput),n=ro(e,st.heatpumpHeatOutput);if(r===null||n===null)return null;let a=ro(e,st.heatingInput,r),i=ro(e,st.coolingInput,0),l=ro(e,st.heatpumpCoolingOutput,0),p=ro(e,st.boilerHeatOutput,0),u=ro(e,st.systemHeatOutput,n+p),c=Pa(e,st.heatingInput)||Pa(e,st.coolingInput)||Pa(e,st.heatpumpCoolingOutput)||Pa(e,st.systemHeatOutput);return[a,i,l,p,u].some(m=>m===null)?null:{dateKey:o,electricalInputWh:r,heatingInputWh:a,coolingInputWh:i,heatpumpHeatOutputWh:n,heatpumpCoolingOutputWh:l,boilerHeatOutputWh:p,systemHeatOutputWh:u,hasFullImportFields:c}}function ev(e){let o=$d(e.hour??e.hour_of_day??e.hourOfDay);if(o!==null&&o>=0&&o<=23)return o;let r=Oa(e);if(r){let n=String(r).trim(),a=xd(n);if(a)return a.hour;let i=new Date(n);if(!Number.isNaN(i.getTime()))return i.getHours();let l=n.match(/^(\d{1,2})(?::\d{2})/);if(l){let p=Number(l[1]);if(p>=0&&p<=23)return p}}return-1}function tv(e){let o=Ad(e),r=ev(e);return!o||r<0||r>23?null:{...o,hour:r}}function ov(e){let o=[],r=[],n="",a=!1,i=()=>{r.push(n),n=""},l=()=>{i(),r.some(u=>String(u).trim()!=="")&&o.push(r),r=[]};for(let u=0;u<e.length;u+=1){let c=e[u];a?c==='"'&&e[u+1]==='"'?(n+='"',u+=1):c==='"'?a=!1:n+=c:c==='"'?a=!0:c===","?i():c===`
`?l():c!=="\r"&&(n+=c)}if((n||r.length)&&l(),!o.length)return[];let p=o.shift().map(u=>String(u||"").trim());return o.map(u=>{let c={};return p.forEach((m,b)=>{m&&(c[m]=u[b]??"")}),c})}function Na(e){return!e||typeof e!="object"||Array.isArray(e)||!e.summary||typeof e.summary!="object"||Array.isArray(e.summary)?e:{...e.summary,...e}}function rv(e){let o=[],r=[];if(Array.isArray(e)){let l=e.map(Na);return Sd(l)?r.push(...l):o.push(...l),{dailyRows:o,hourlyRows:r,source:"JSON"}}let n=String(e?.schema||e?.import_schema||"JSON").trim()||"JSON",a=Array.isArray(e?.days)?e.days:Array.isArray(e?.daily)?e.daily:Array.isArray(e?.openquatt_import?.daily)?e.openquatt_import.daily:[],i=Array.isArray(e?.hourly)?e.hourly:Array.isArray(e?.hours)?e.hours:Array.isArray(e?.openquatt_import?.hourly)?e.openquatt_import.hourly:[];return o.push(...a.map(Na)),r.push(...i.map(Na)),a.forEach(l=>{Array.isArray(l?.samples)&&l.samples.forEach(p=>{r.push(Na({...p,date:p.date??l.date}))})}),{dailyRows:o,hourlyRows:r,source:n}}function nv(e,o){let r=String(o||"").trim();if(!r)throw new Error("Bestand is leeg.");let n=[],a=[],i="";if(r[0]==="{"||r[0]==="["){let g=rv(JSON.parse(r));n=g.dailyRows,a=g.hourlyRows,i=g.source}else{let g=ov(r);Sd(g)||String(e||"").toLowerCase().includes("hour")?a=g:n=g,i="CSV"}let l=new Map,p=new Map,u=0,c=0;n.forEach(g=>{let f=Ad(g);if(!f){c+=1;return}l.has(f.dateKey)&&(u+=1),l.set(f.dateKey,f)}),a.forEach(g=>{let f=tv(g);if(!f){c+=1;return}let w=`${f.dateKey}:${f.hour}`;p.has(w)&&(u+=1),p.set(w,f)});let m=[...l.values()].sort((g,f)=>g.dateKey-f.dateKey),b=[...p.values()].sort((g,f)=>g.dateKey-f.dateKey||g.hour-f.hour);if(!m.length&&!b.length)throw new Error("Geen ondersteunde dag- of uurrecords gevonden.");let y=[...m.map(g=>g.dateKey),...b.map(g=>g.dateKey)].sort((g,f)=>g-f),v=y.length?`${vd(y[0])} t/m ${vd(y[y.length-1])}`:"";return{records:m,hourRecords:b,source:i,range:v,duplicates:u,invalid:c}}function av(e){return e.hasFullImportFields?["day",e.dateKey,e.electricalInputWh,e.heatingInputWh,e.coolingInputWh,e.heatpumpHeatOutputWh,e.heatpumpCoolingOutputWh,e.boilerHeatOutputWh,e.systemHeatOutputWh].join("|"):["day",e.dateKey,e.electricalInputWh,e.heatpumpHeatOutputWh,e.boilerHeatOutputWh].join("|")}function iv(e){let o=new Map;return e.forEach(r=>{o.has(r.dateKey)||o.set(r.dateKey,new Map),o.get(r.dateKey).set(r.hour,r)}),[...o.entries()].sort((r,n)=>r[0]-n[0]).map(([r,n])=>{let a=0,i=[],l=[...n.values()].some(p=>p.hasFullImportFields);for(let p=0;p<24;p+=1){let u=n.get(p);u&&(a|=1<<p),l?i.push(u?.electricalInputWh??0,u?.heatingInputWh??0,u?.coolingInputWh??0,u?.heatpumpHeatOutputWh??0,u?.heatpumpCoolingOutputWh??0,u?.boilerHeatOutputWh??0,u?.systemHeatOutputWh??0):i.push(u?.electricalInputWh??0,u?.heatpumpHeatOutputWh??0,u?.boilerHeatOutputWh??0)}return["hourday",r,a,...i].join("|")})}function Hd(e){let o=new URLSearchParams;return o.set("records",[Yy,...e].join(`
`)),t.energyHistoryCsrfToken&&o.set("csrf_token",t.energyHistoryCsrfToken),o}function sv(e){let o=[],r=[];return e.forEach(n=>{let a=[...r,n];r.length&&String(Hd(a)).length>Zy?(o.push(r),r=[n]):r=a}),r.length&&o.push(r),o}function lv(e){let o=[];e.written>0&&o.push(`${e.written} dagrecords`),e.hourWritten>0&&o.push(`${e.hourWritten} uurdagen`);let r=o.length?`${o.join(" en ")} ge\xEFmporteerd.`:"Geen nieuwe records ge\xEFmporteerd.",n=[];return e.duplicates>0&&n.push(`${e.duplicates} al aanwezig`),e.skipped>0&&n.push(`${e.skipped} overgeslagen`),e.invalid>0&&n.push(`${e.invalid} ongeldig`),e.unsupported>0&&n.push(`${e.unsupported} onbekend`),n.length?`${r} (${n.join(", ")}.)`:r}async function cv(e){let o=await fetch(`${He()}/energy/history/import`,{method:"POST",cache:"no-store",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},body:Hd(e)}),r=await o.text(),n={};try{n=r?JSON.parse(r):{}}catch{n={}}if(!o.ok||n.ok===!1){let a=n.error?String(n.error):"";throw new Error(Jy[a]||a||`HTTP ${o.status}`)}return n}function Md(e){let o=String(e||"").split(/\r?\n/).find(r=>r.startsWith("@csrf|"));return o?o.slice(6):""}async function uv(){if(gr())return;let e=await fetch(`${He()}/energy/history?meta=1`,{cache:"no-store"});if(!e.ok)throw new Error(`HTTP ${e.status}`);let o=Md(await e.text());if(!o)throw new Error("Beveiligingstoken ontbreekt. Vernieuw de pagina en probeer opnieuw.");t.energyHistoryCsrfToken=o}function pv(e,o){t.energyHistoryImportProgressPercent=o>0?Math.min(99,Math.max(1,Math.round(e/o*100))):0,d()}async function dv(e){if(cl(),!e){d();return}t.energyHistoryImportFileName=e.name||"exportbestand";try{let o=nv(e.name||"",await e.text());t.energyHistoryImportRecords=o.records,t.energyHistoryImportHourRecords=o.hourRecords,t.energyHistoryImportSource=o.source,t.energyHistoryImportRange=o.range,t.energyHistoryImportDuplicateCount=o.duplicates,t.energyHistoryImportInvalidCount=o.invalid}catch(o){t.energyHistoryImportError=`Bestand kon niet worden gelezen. ${o.message}`}d()}function Rd(){let e=document.createElement("input");e.type="file",e.accept=".json,.csv,application/json,text/csv,text/plain",e.style.position="fixed",e.style.left="-1000px",e.style.top="0",e.addEventListener("change",()=>{let o=e.files&&e.files[0]?e.files[0]:null;window.setTimeout(()=>e.remove(),0),dv(o)},{once:!0}),document.body.appendChild(e),e.click()}async function Pd(){if(t.energyHistoryImportBusy)return;let e=[...t.energyHistoryImportRecords.map(av),...iv(t.energyHistoryImportHourRecords)];if(!e.length){t.energyHistoryImportError="Kies eerst een exportbestand met dag- of uurrecords.",d();return}if(t.energyHistoryImportBusy=!0,t.energyHistoryImportError="",t.energyHistoryImportNotice="",t.energyHistoryImportProgressPercent=1,d(),gr()){let n=new Set(t.energyHistoryImportHourRecords.map(a=>a.dateKey)).size;t.energyHistoryImportBusy=!1,t.energyHistoryImportProgressPercent=0,t.energyHistoryImportNotice=`Preview: ${t.energyHistoryImportRecords.length} dagrecords en ${n} uurdagen zouden worden ge\xEFmporteerd.`,d();return}let o={written:0,hourWritten:0,duplicates:0,skipped:0,invalid:0,unsupported:0},r=0;try{await uv();let n=sv(e);for(let a of n){let i=await cv(a);o.written+=Number(i.written||0),o.hourWritten+=Number(i.hour_written||0),o.duplicates+=Number(i.duplicates||0),o.skipped+=Number(i.skipped||0),o.invalid+=Number(i.invalid||0),o.unsupported+=Number(i.unsupported||0),r+=a.length,pv(r,e.length)}t.energyHistoryImportProgressPercent=100,t.energyHistoryImportNotice=lv(o),t.energyHistoryImportError="",t.energyHistoryRaw="",t.energyHistorySignature="",t.energyHistoryLastFetchAt=0,await pr({forceMissing:!0,forceEnergyHistory:!0})}catch(n){t.energyHistoryImportError=`Importeren mislukt. ${n.message}`}finally{t.energyHistoryImportBusy=!1,t.energyHistoryImportProgressPercent=0,d()}}function ul(){return oo()||t.appView==="settings"&&t.systemModal==="history-storage"}function La(){t.settingsBackupDraft=null,t.settingsBackupError="",t.settingsBackupBusy=!1}function mv(){return{device:Re(),installation:rt(),topology:typeof ee=="function"?ee():"",firmware_version:le(),firmware_channel:String(E("firmwareUpdateChannel")||E("releaseChannelText")||"").trim()}}function Nd(e){let o=R[e];if(!o)return;if(e==="setupComplete")return _n();let r=E(e);if(r===""||r===null||r===void 0)return;if(o.domain==="switch"||o.domain==="binary_sensor")return x(e);if(o.domain==="number"){let a=Te(r);return Number.isNaN(a)?void 0:a}return o.domain==="time"?Ft(r)||void 0:o.domain==="datetime"?tt(r)||void 0:String(r||"").trim()||void 0}function Od(){let e={};return Lt.forEach(o=>{let r={};o.keys.forEach(n=>{let a=Nd(n);a!==void 0&&(r[n]=a)}),e[o.id]=r}),{schema_version:yi,exported_at:new Date().toISOString(),source:mv(),settings:e}}function gv(e=Od()){let o=String(e.exported_at||new Date().toISOString()).replace(/[:.]/g,"-").replace(/T/,"_").replace(/Z$/,"Z");return`${String(e.source?.installation||"OpenQuatt").replace(/\s+/g,"-").toLowerCase()}-settings-backup-${o}.json`}function hv(e){let o=R[e];return o?.name?o.name:e.replaceAll(/([a-z])([A-Z])/g,"$1 $2").replaceAll(/_/g," ").trim()}function wd(e,o){if(o==null||o==="")return"\u2014";let r=R[e];return r?r.domain==="number"?j(e,o):r.domain==="time"?Ft(o)?.slice(0,5)||"\u2014":r.domain==="datetime"?tt(o)||"\u2014":r.domain==="switch"||r.domain==="binary_sensor"?o?"Aan":"Uit":String(o).trim()||"\u2014":String(o).trim()||"\u2014"}function fv(e){switch(e){case"same":return"Gelijk";case"different":return"Wijkt af";case"missing":return"Ontbreekt in backup";case"current-missing":return"Niet op huidige installatie";case"optional-missing":case"optional-unavailable":return"Ontbreekt";default:return"Onbekend"}}function pl(e){let o=e?.settings&&typeof e.settings=="object"?e.settings:{},r=e?.source&&typeof e.source=="object"?e.source:{},n=Xl,a=0,i=0,l=0,p=0,u=0,c=0,m=0,b=0,y=Lt.map(v=>{let g=o[v.id]&&typeof o[v.id]=="object"?o[v.id]:{},f=0,w=0,S=0,q=0,k=0,$=0,H=0,W=v.keys.map(B=>{let I=!!R[B]?.optional,z=Object.prototype.hasOwnProperty.call(g,B),re=z?g[B]:void 0,ge=Nd(B),Z=h(B),L=z?wd(B,re):I?"Niet op huidige installatie":"Ontbreekt in backup",Y=Z?wd(B,ge):I?"Niet beschikbaar op huidige installatie":"Ontbreekt op huidige installatie",N="same";return!z&&I?N="optional-missing":z?Z?JSON.stringify(ge)!==JSON.stringify(re)&&(N="different"):N=I?"optional-unavailable":"current-missing":N="missing",Z&&(H+=1,b+=1),N!=="same"&&($+=1,m+=1),I?(k+=1,z?(S+=1,l+=1):(q+=1,p+=1)):z?(f+=1,a+=1):(w+=1,i+=1),{key:B,label:hv(B),optional:I,hasBackupValue:z,backupDisplay:L,currentDisplay:Y,status:N,statusLabel:fv(N)}});return c+=v.keys.filter(B=>!R[B]?.optional).length,{id:v.id,label:v.label,present:f,currentPresent:H,requiredTotal:v.keys.filter(B=>!R[B]?.optional).length,optionalTotal:k,optionalPresent:S,optionalMissing:q,requiredMissing:w,total:v.keys.length,differenceCount:$,rows:W}});return Object.entries(o).forEach(([v,g])=>{if(!Lt.some(f=>f.id===v)){u+=1;return}!g||typeof g!="object"||Object.keys(g).forEach(f=>{n.has(f)||(u+=1)})}),{source:r,sectionSummaries:y,requiredPresent:a,requiredMissing:i,requiredAvailable:c,optionalPresent:l,optionalMissing:p,unknown:u,differenceCount:m,currentPresent:b,requiredTotal:c,total:Dt.length}}function bv(e,o=""){let r=JSON.parse(e);if(!r||typeof r!="object")throw new Error("Backupbestand bevat geen JSON-object.");let n=Number(r.schema_version??r.schemaVersion??0);if(!Number.isInteger(n)||n<yi)throw new Error("Onbekende backupversie.");let a=r.settings&&typeof r.settings=="object"?r.settings:{},i={schema_version:n,exported_at:String(r.exported_at||""),source:r.source&&typeof r.source=="object"?r.source:{},settings:a,file_name:o||""};return i.summary=pl(i),i}async function yv(){t.settingsBackupBusy=!0,t.controlError="",t.controlNotice="",d();try{return await D(Dt,"all"),Od()}finally{t.settingsBackupBusy=!1,d()}}async function Ld(){if(!t.settingsBackupBusy)try{let e=await yv();Cc(gv(e),e),t.controlNotice="Settings-backup gedownload.",d()}catch(e){t.controlError=`Backup exporteren mislukt. ${e.message}`,d()}}async function Dd(e){if(!(!e||t.settingsBackupBusy)){t.settingsBackupBusy=!0,t.settingsBackupDraft=null,t.settingsBackupError="",t.controlError="",t.controlNotice="",d();try{let o=await e.text();await D(Dt,"all");let r=bv(o,e.name||"");t.settingsBackupDraft=r,t.systemModal="settings-backup-restore"}catch(o){t.settingsBackupDraft=null,t.settingsBackupError=`Backupbestand kon niet worden gelezen. ${o.message}`}finally{t.settingsBackupBusy=!1,d()}}}async function Fd(){let e=t.settingsBackupDraft;if(!e||t.settingsBackupBusy)return;t.settingsBackupBusy=!0,t.settingsBackupError="",t.controlError="",t.controlNotice="",d();let o=[],r=[],n=!1;try{await D(Dt,"all");for(let i of Lt){let l=e.settings?.[i.id]&&typeof e.settings[i.id]=="object"?e.settings[i.id]:{};for(let p of i.keys){if(!Object.prototype.hasOwnProperty.call(l,p)){r.push(p);continue}let u=l[p];if(p==="setupComplete"){n=u===!0;continue}if(p==="openquattEnabled")continue;if(!R[p]||!h(p)){r.push(p);continue}try{await jt(p,u),o.push(p)}catch{r.push(p)}}}let a=e.settings?.operation?.openquattEnabled;if(Object.prototype.hasOwnProperty.call(e.settings?.operation||{},"openquattEnabled")&&h("openquattEnabled")&&(await jt("openquattEnabled",a),o.push("openquattEnabled")),n&&R.apply){let i=await fetch(U("button","Complete setup","press"),{method:"POST"});if(!i.ok)throw new Error(`Setup bevestigen mislukt (HTTP ${i.status}).`);o.push("setupComplete")}else Object.prototype.hasOwnProperty.call(e.settings?.installation||{},"setupComplete")&&r.push("setupComplete");t.systemModal="settings-backup-success",La(),t.controlNotice=`Backup hersteld (${o.length} toegepast${r.length?`, ${r.length} overgeslagen`:""}).`,await pe()}catch(a){t.settingsBackupError=`Backup herstellen mislukt. ${a.message}`}finally{t.settingsBackupBusy=!1,d()}}function gr(){return!!(typeof window<"u"&&window.__OQ_DEV_CONTROLS__||typeof window<"u"&&window.__OQ_DEV_META)}async function mn(e={}){if(!ot()){let n=!!(t.trendHistoryRaw||t.trendHistoryError);return t.trendHistoryRaw="",t.trendHistoryError="",t.trendHistorySignature="",t.trendHistoryNowMs=Number.NaN,t.trendHistoryLastFetchAt=0,n}if(gr())return!1;let o=e.force===!0,r=Date.now();if(!o&&t.trendHistoryFetchPromise)return t.trendHistoryFetchPromise;if(!o&&(t.trendHistoryRaw||t.trendHistoryError)&&r-Number(t.trendHistoryLastFetchAt||0)<$n)return!1;t.trendHistoryFetchPromise=(async()=>{let n=Jr(t.trendWindowHours||pt);n!==t.trendWindowHours&&rr(n);let a=await fetch(`${He()}/trends/history?hours=${encodeURIComponent(String(n))}`,{cache:"no-store"});if(!a.ok)throw new Error(`HTTP ${a.status}`);let i=await a.text(),l=i.split(/\r?\n/),p=Number.NaN,u=i;l.length&&l[0].startsWith("@now|")&&(p=Number(l[0].slice(5)),u=l.slice(1).join(`
`));let c=`${n}|${u.length}|${u.slice(0,120)}|${u.slice(-120)}`,m=Number.isFinite(t.trendHistoryNowMs),y=Number.isFinite(p)?!m||t.trendHistoryNowMs!==p:m,v=u!==t.trendHistoryRaw||t.trendHistoryError!==""||t.trendHistorySignature!==c||y;return t.trendHistoryRaw=u,t.trendHistoryError="",t.trendHistorySignature=c,t.trendHistoryNowMs=Number.isFinite(p)?p:Number.NaN,t.trendHistoryLastFetchAt=Date.now(),v})();try{return await t.trendHistoryFetchPromise}catch(n){let a=`Trendhistorie kon niet worden geladen. ${n.message}`,i=t.trendHistoryError!==a;return t.trendHistoryError=a,t.trendHistoryRaw="",t.trendHistorySignature="",t.trendHistoryNowMs=Number.NaN,t.trendHistoryLastFetchAt=Date.now(),i}finally{t.trendHistoryFetchPromise=null}}async function it(e={}){if(!h("lifetimeEnergyHistoryEnabled")&&!gr()){let a=!!(t.energyHistoryRaw||t.energyHistoryError);return t.energyHistoryRaw="",t.energyHistoryError="",t.energyHistorySignature="",t.energyHistoryNowMs=Number.NaN,t.energyHistoryLastFetchAt=0,t.energyHistoryRequestQuery="",t.energyHistoryFetchQuery="",t.energyHistoryCsrfToken="",a}let o=e.force===!0,r=Date.now(),n=e.metaOnly===!0?"?meta=1":typeof cn=="function"?cn():"";if(!o&&t.energyHistoryFetchPromise&&t.energyHistoryFetchQuery===n)return t.energyHistoryFetchPromise;if(!o&&t.energyHistoryRequestQuery===n&&(t.energyHistoryRaw||t.energyHistoryError)&&r-Number(t.energyHistoryLastFetchAt||0)<$n)return!1;t.energyHistoryFetchQuery=n,t.energyHistoryFetchPromise=(async()=>{let a=async f=>{let w=await fetch(`${He()}/energy/history${f}`,{cache:"no-store"});if(!w.ok)throw new Error(`HTTP ${w.status}`);return w.text()},i=n,l=await a(i);if(e.metaOnly!==!0&&i.includes("meta=1")&&typeof cn=="function"){let f=t.energyHistoryRaw;t.energyHistoryRaw=l;let w=cn();t.energyHistoryRaw=f,w&&w!==i&&(i=w,l=await a(i))}let p=l.split(/\r?\n/),u=Md(l)||t.energyHistoryCsrfToken,c=Number.NaN;p.forEach(f=>{f.startsWith("@now|")&&(c=Number(f.slice(5)))});let m=`${l.length}|${l.slice(0,120)}|${l.slice(-120)}`,b=Number.isFinite(t.energyHistoryNowMs),v=Number.isFinite(c)?!b||t.energyHistoryNowMs!==c:b,g=l!==t.energyHistoryRaw||t.energyHistoryError!==""||t.energyHistorySignature!==m||v||u!==t.energyHistoryCsrfToken;return t.energyHistoryRaw=l,t.energyHistoryError="",t.energyHistorySignature=m,t.energyHistoryNowMs=Number.isFinite(c)?c:Number.NaN,t.energyHistoryLastFetchAt=Date.now(),t.energyHistoryRequestQuery=i,t.energyHistoryCsrfToken=u,g})();try{return await t.energyHistoryFetchPromise}catch(a){let i=`Energiehistorie kon niet worden geladen. ${a.message}`,l=t.energyHistoryError!==i;return t.energyHistoryError=i,t.energyHistoryRaw="",t.energyHistorySignature="",t.energyHistoryNowMs=Number.NaN,t.energyHistoryLastFetchAt=Date.now(),t.energyHistoryRequestQuery=n,t.energyHistoryCsrfToken="",l}finally{t.energyHistoryFetchPromise=null}}function Gr(e,o={},r=ac){if(o.force===!0)return!0;let n=Number(e||0);return!n||Date.now()-n>=r}async function jt(e,o){let r=R[e];if(!r)throw new Error(`Onbekend veld ${e}.`);if(r.domain==="select"){let n=String(o||"").trim(),a=await fetch(`${U(r.domain,r.name,"set")}?option=${encodeURIComponent(n)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return n}if(r.domain==="number"){let n=qe(e,o),a=await fetch(`${U(r.domain,r.name,"set")}?value=${encodeURIComponent(n)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return n}if(r.domain==="time"){let n=Ft(o),a=await fetch(`${U(r.domain,r.name,"set")}?value=${encodeURIComponent(n)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return n}if(r.domain==="datetime"){let n=tt(o),a=await fetch(`${U(r.domain,r.name,"set")}?value=${encodeURIComponent(n)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return n}if(r.domain==="text"){let n=String(o||"").trim(),a=await fetch(`${U(r.domain,r.name,"set")}?value=${encodeURIComponent(n)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return n}if(r.domain==="switch"||r.domain==="binary_sensor"){let n=!!o,a=n?"turn_on":"turn_off",i=await fetch(U(r.domain,r.name,a),{method:"POST"});if(!i.ok)throw new Error(`HTTP ${i.status}`);return n}throw new Error(`${r.name} kan niet worden hersteld.`)}function _d(){window.setTimeout(()=>{let e=document.activeElement;t.focusedField=e&&e.dataset&&e.dataset.oqField||"",t.settingsInteractionLock=!!(e&&e.closest&&e.closest(".oq-ph-concept-hotspot"))},0)}function Wd(e){e.target.closest(".oq-ph-concept-hotspot")&&(t.settingsInteractionLock=!0)}function Vd(e){let o=e.target.closest(".oq-ph-concept-hotspot");if(!o||e.relatedTarget&&o.contains(e.relatedTarget))return;let r=t.root&&t.root.querySelector(".oq-ph-concept-hotspot:hover"),n=document.activeElement&&document.activeElement.closest?document.activeElement.closest(".oq-ph-concept-hotspot"):null;t.settingsInteractionLock=!!(r||n)}function Bd(e){if(e.target.dataset.oqFirmwareConnectionConfirm){t.firmwareConnectionSwitchConfirmed=!!e.target.checked,d();return}if(e.target.dataset.oqFirmwareTopologyConfirm){t.firmwareTopologySwitchConfirmed=!!e.target.checked,d();return}if(e.target.dataset.oqFirmwareTestConfirm){t.updateTestFirmwareConfirmed=!!e.target.checked,t.updateTestFirmwareError="";let n=e.target.closest(".oq-helper-modal-callout"),a=n?.querySelector('[data-oq-action="install-firmware-test"]');a&&(a.disabled=!t.updateTestFirmwareConfirmed||!bo()),n?.querySelector('[data-oq-firmware-test-runtime-error="true"]')?.remove();return}if(e.target.dataset.oqFirmwareTestPr){t.updateTestFirmwarePr=String(e.target.value||""),t.updateTestFirmwareConfirmed=!1,t.updateTestFirmwareError="",t.updateTestFirmwareBuild=null;let n=e.target.closest(".oq-helper-modal-callout"),a=n?.querySelector('[data-oq-firmware-test-confirm="true"]');a&&(a.checked=!1);let i=n?.querySelector('[data-oq-action="install-firmware-test"]');i&&(i.disabled=!0);let l=Yo(),p=Fr(bo(),l),u=n?.querySelector('[data-oq-firmware-test-asset-note="true"]');u&&(u.textContent=p?l.otaFileName:"Vul een PR-nummer in om de OTA-build te kiezen."),n?.querySelector('[data-oq-firmware-test-build-row="true"]')?.remove(),n?.querySelector('[data-oq-firmware-test-runtime-error="true"]')?.remove();return}if(e.target.dataset.oqMqttField){yu(e.target);return}let r=e.target.dataset.oqField;if(!r){if(e.target.dataset.oqQuickstartCicUrl!==void 0){t.quickStartCicFeedUrlDraft=String(e.target.value||"");return}if(e.target.dataset.oqQuickstartThermostatSource!==void 0){t.quickStartThermostatSourceDraft=String(e.target.value||""),d();return}let n=e.target.dataset.oqAuthField;if(n){t.authNotice="",t.authError="",n==="username"?t.authDraftUsername=String(e.target.value||""):n==="currentPassword"?t.authDraftCurrentPassword=String(e.target.value||""):n==="newPassword"?t.authDraftNewPassword=String(e.target.value||""):n==="confirmPassword"&&(t.authDraftConfirmPassword=String(e.target.value||""));return}return}if(e.target.dataset.oqPauseDraft){t.pauseResumeDraft=String(e.target.value||"");return}if(R[r]?.domain==="text"){t.inputDrafts[r]=String(e.target.value||"");return}if(e.target.type==="range"||e.target.type==="number"){e.target.type==="number"&&(t.inputDrafts[r]=e.target.value);let n=Te(e.target.value);if(!Number.isNaN(n)){let a=qe(r,e.target.value);if(t.drafts[r]=a,e.target.type==="range"){let i=e.target.closest(".oq-helper-slider-field")?.querySelector(".oq-helper-slider-meta strong");i&&(i.textContent=j(r,a))}}}}function Kd(e){cp(e)}function Id(e,o){return e.deltaMode===1?o*16:e.deltaMode===2?o*window.innerHeight:o}function vv(e){let o=e?e.parentElement:null;for(;o&&o!==document.body&&o!==document.documentElement;){let r=window.getComputedStyle(o),n=/(auto|scroll)/.test(r.overflowY)&&o.scrollHeight>o.clientHeight,a=/(auto|scroll)/.test(r.overflowX)&&o.scrollWidth>o.clientWidth;if(n||a)return o;o=o.parentElement}return document.scrollingElement||document.documentElement}function jd(e){let o=e.target&&e.target.closest?e.target.closest('input[type="number"]'):null;if(!o||!t.root||!t.root.contains(o)||document.activeElement!==o)return;e.preventDefault(),o.blur();let r=vv(o);r&&typeof r.scrollBy=="function"&&r.scrollBy({left:Id(e,e.deltaX||0),top:Id(e,e.deltaY||0),behavior:"auto"})}function Ud(e){if(e.target.dataset.oqDevControl==="boiler"&&typeof window.__OQ_SET_MOCK_BOILER__=="function"){window.__OQ_SET_MOCK_BOILER__(e.target.value);return}if(e.target.dataset.oqBackupFileInput){let n=e.target.files&&e.target.files[0]?e.target.files[0]:null;e.target.value="",Dd(n);return}if(e.target.dataset.oqFirmwareUploadFileInput){let n=e.target.files&&e.target.files[0]?e.target.files[0]:null;e.target.value="",n?(t.firmwareAdvancedOpen=!0,t.updateManualUploadOpen=!0,t.updateManualUploadFile=n,t.updateManualUploadFileName=n.name||"",t.updateManualUploadError=""):ke(),d();return}if(e.target.dataset.oqEnergyHistoryPeriodInput){typeof un=="function"&&un(e.target.dataset.oqEnergyHistoryPeriodInput,e.target.value);return}if(e.target.dataset.oqEnergyHistoryExportMode!==void 0){t.energyHistoryExportMode=mr(e.target.value),t.energyHistoryExportError="",t.energyHistoryExportNotice="",d();return}let o=e.target.dataset.oqField;if(!o)return;let r=R[o];if(r){if(r.domain==="select"){ml(o,String(e.target.value));return}if(r.domain==="number"){hl(o,e.target.value);return}if(r.domain==="text"){qv(o,e.target.value);return}if(r.domain==="time"){let n=Ft(e.target.value);if(!n){t.controlError=`${r.name} verwacht tijd als HH:MM.`,d();return}Sv(o,n);return}if(r.domain==="datetime"){let n=tt(e.target.value);if(!n){t.controlError=`${r.name} verwacht datum en tijd.`,d();return}Tv(o,n);return}}}function Gd(e){let o=e.target.closest(".oq-settings-control--time, .oq-settings-control--datetime");if(o){let c=o.querySelector("input[data-oq-field]");if(c&&(c.type==="time"||c.type==="datetime-local")&&typeof c.showPicker=="function")try{c.showPicker()}catch{}}let r=e.target.closest('[data-oq-action="toggle-settings-info"]'),n=e.target.closest("[data-oq-settings-info]"),a=e.target.closest(".oq-helper-hub"),i=e.target.closest("[data-oq-modal]");if(r){let c=r.dataset.infoId||"";t.settingsInfoOpen=t.settingsInfoOpen===c?"":c,d();return}let l=e.target.closest("[data-oq-action]"),p=t.interfacePanelOpen&&!a;if(!l){let c=!1;if(t.settingsInfoOpen&&!n&&(t.settingsInfoOpen="",c=!0),p&&(Da(!1),c=!0),i&&e.target===i){if(i.dataset.oqModal==="quickstart-forced")return;t.updateModalOpen&&(t.updateModalOpen=!1,t.firmwareAdvancedOpen=!1,t.firmwareConnectionSwitchOpen=!1,t.firmwareTopologySwitchOpen=!1,t.updateManualUploadOpen=!1,t.updateTestFirmwareOpen=!1,t.firmwareConnectionSwitchConfirmed=!1,t.firmwareTopologySwitchConfirmed=!1,ke(),Ue(),c=!0),t.systemModal&&(La(),rn(),t.systemModal="",c=!0)}c&&d();return}p&&l.dataset.oqAction!=="toggle-interface-panel"&&Da(!1);let u=l.dataset.oqAction;if(u==="set-mock-boiler"&&typeof window.__OQ_SET_MOCK_BOILER__=="function"){window.__OQ_SET_MOCK_BOILER__(l.dataset.boilerMode||"off");return}if(u==="toggle-interface-panel"){Da(!t.interfacePanelOpen),d();return}if(u==="toggle-dev-panel"){lm(!t.devPanelOpen),d();return}if(u==="toggle-installation-monitoring-details"){e.preventDefault();let c=l.closest(".oq-settings-monitoring-details");t.installationMonitoringDetailsOpen=!(c&&c.hasAttribute("open")),d();return}if(u==="toggle-integration-diagnostics"){e.preventDefault();let c=l.closest(".oq-settings-integration-diagnostics");t.integrationDiagnosticsOpen=!(c&&c.hasAttribute("open")),d();return}if(u==="toggle-odu-runtime-frequency-details"){e.preventDefault();let c=l.closest(".oq-settings-odu-runtime-details");t.oduRuntimeFrequencyDetailsOpen=!(c&&c.hasAttribute("open")),d();return}if(u==="toggle-storage-technical-details"){e.preventDefault();let c=l.closest(".oq-settings-storage-technical");t.settingsStorageDetailsOpen=!(c&&c.hasAttribute("open")),d();return}if(u==="select-view"){if((l.dataset.viewId||"")==="diagnosis"&&!ot())return;let c=l.dataset.viewId||"overview";Rt(c,{syncMode:"push"}),d(),pe({forceFast:!0});return}if(u==="select-trend-window"){if(l.disabled)return;rr(Number(l.dataset.trendHours||24)),d(),mn({force:!0}).then(c=>{c&&d()});return}if(u==="select-energy-history-view"){if(l.disabled||typeof tl!="function")return;tl(l.dataset.energyHistoryView||"day");return}if(u==="shift-energy-history-period"){if(l.disabled||typeof nl!="function")return;nl(t.energyHistoryView||"day",l.dataset.energyHistoryDirection||"1");return}if(u==="select-energy-history-now"){if(l.disabled||typeof al!="function")return;al(t.energyHistoryView||"day");return}if(u==="select-settings-group"){gn(l.dataset.groupId||he[0].id),d(),pe({forceFast:!0});return}if(u==="open-update-modal"){t.updateModalOpen=!0,d(),du();return}if(u==="open-webserver-log-modal"){Vc();return}if(u==="open-debug-recording-modal"){t.systemModal="debug-recording",t.debugRecordingError="",t.debugRecordingNotice="",d(),fn();return}if(u==="open-login-modal"){t.systemModal="login",Ys(),t.authNotice="",t.authError="",d(),_p({poll:!0});return}if(u==="open-api-security-modal"){t.systemModal="api-security",t.apiSecurityNotice="",t.apiSecurityError="",d(),to({force:!0});return}if(u==="open-mqtt-modal"){t.systemModal="mqtt",es(),t.mqttDraftDirty=!1,t.mqttNotice="",t.mqttError="",d(),vo({force:!0});return}if(u==="open-mqtt-sensors-modal"){t.systemModal="mqtt-sensors",t.mqttNotice="",t.mqttError="",t.mqttCopiedTopicKey="",t.mqttExpandedTopicKey="",t.mqttInputToggleBusyKey="",d(),vo({force:!0}).then(c=>{c&&t.systemModal==="mqtt-sensors"&&d()});return}if(u==="toggle-mqtt-sensor-topic"){let c=l.dataset?.oqMqttTopicKey||"cooling_dew_point";t.mqttExpandedTopicKey=t.mqttExpandedTopicKey===c?"":c,t.mqttError="",d();return}if(u==="toggle-mqtt-input"){let c=l.dataset?.oqMqttTopicKey||"cooling_dew_point";Su(c,!ea(c));return}if(u==="copy-mqtt-topic"||u==="copy-mqtt-dew-topic"){wu(l.dataset?.oqMqttTopicKey||"cooling_dew_point");return}if(u==="save-mqtt-config"){qu();return}if(u==="copy-api-security-key"){jp();return}if(u==="enable-api-security"){Vp();return}if(u==="rotate-api-security"){Bp();return}if(u==="disable-api-security"){Kp();return}if(u==="restart-api-security"){Wp();return}if(u==="flush-trend-history"){qo("trendHistoryFlush",{successNotice:"Diagnosegeschiedenis is opgeslagen.",errorPrefix:"Diagnosegeschiedenis kon niet worden opgeslagen",refreshKeys:Co(),refreshDelayMs:500}).then(()=>{dr(void 0,{forceTrendHistory:!0})});return}if(u==="save-lifetime-energy-history"){qo("lifetimeEnergyHistoryCapture",{successNotice:"Energiehistorie is opgeslagen.",errorPrefix:"Energiehistorie kon niet worden opgeslagen",refreshKeys:Co(),refreshDelayMs:500}).then(()=>{t.energyHistoryRaw="",t.energyHistorySignature="",t.energyHistoryLastFetchAt=0,dr(),t.appView==="results"&&it({force:!0}).then(()=>d())});return}if(u==="clear-lifetime-energy-history"){if(!window.confirm(`Energiehistorie wissen?

Alle bewaarde dagtotalen worden verwijderd. Dit heeft geen invloed op de werking van je warmtepomp.`))return;qo("lifetimeEnergyHistoryClear",{successNotice:"Energiehistorie is gewist.",errorPrefix:"Energiehistorie kon niet worden gewist",refreshKeys:Co(),refreshDelayMs:500}).then(()=>{t.energyHistoryRaw="",t.energyHistorySignature="",t.energyHistoryLastFetchAt=0,dr(),t.appView==="results"&&it({force:!0}).then(()=>d())});return}if(u==="select-energy-history-import-file"){Rd();return}if(u==="clear-energy-history-import-file"){cl(),d();return}if(u==="import-energy-history-file"){Pd();return}if(u==="export-energy-history"){kd();return}if(u==="open-history-storage-modal"){t.systemModal="history-storage",d(),pr({forceMissing:!0,forceTrendHistory:!0,forceEnergyHistory:!0}).finally(()=>{t.systemModal==="history-storage"&&d()}),dr([1e3,3e3,7e3]);return}if(u==="open-connectivity-modal"){t.systemModal="connectivity",d();return}if(u==="open-restart-confirm"){t.systemModal="restart-confirm",d();return}if(u==="download-settings-backup"){Ld();return}if(u==="open-settings-backup-import"){t.systemModal="settings-backup-import",d();return}if(u==="open-silent-settings-modal"){t.systemModal="silent-settings",d();return}if(u==="open-openquatt-pause-modal"){t.pauseResumeDraft=Fn(),t.systemModal="openquatt-pause",d();return}if(u==="enable-openquatt-now"){Ev();return}if(u==="apply-openquatt-preset"){let c=Si(l.dataset.pausePreset||"");t.pauseResumeDraft=c,dl(c);return}if(u==="apply-openquatt-indefinite"){dl("");return}if(u==="apply-openquatt-custom-pause"){if(!String(t.pauseResumeDraft||"").trim()){t.controlError="Kies eerst een datum en tijd om automatisch te hervatten.",d();return}dl(t.pauseResumeDraft||"");return}if(u==="close-update-modal"){t.updateModalOpen=!1,t.updateInstallCompleted=!1,t.updateInstallCompletedVersion="",t.firmwareAdvancedOpen=!1,t.firmwareConnectionSwitchOpen=!1,t.firmwareTopologySwitchOpen=!1,t.updateManualUploadOpen=!1,t.updateTestFirmwareOpen=!1,t.firmwareConnectionSwitchConfirmed=!1,t.firmwareTopologySwitchConfirmed=!1,ke(),Ue(),d();return}if(u==="close-quickstart-modal"){t.quickStartModalOpen=!1,d();return}if(u==="open-quickstart-modal"){t.currentStep="generation",t.quickStartModalMode="wizard",t.quickStartModalOpen=!0,d();return}if(u==="open-generation-modal"){t.currentStep="generation",t.quickStartModalMode="generation",t.quickStartModalOpen=!0,d();return}if(u==="open-cm100-commissioning-modal"){t.systemModal="",Rt("settings"),gn("service"),d(),pe({forceFast:!0});return}if(u==="open-installation-monitoring"){t.systemModal="",Rt("settings"),gn("service"),d(),pe({forceFast:!0});return}if(u==="open-service-task-modal"){let c=String(l.dataset.serviceTask||"").trim();["autotune","boiler","purge","manual-flow","manual-hp","hp-water-calibration"].includes(c)&&(t.systemModal=`service-task-${c}`,d(),pe({forceFast:!0}));return}if(u==="press-named-button"){let c=String(l.dataset.oqButtonKey||l.dataset.buttonKey||l.getAttribute("data-oq-button-key")||"").trim();if(c){c==="commissioningCm100Start"?(t.pendingCommissioningCm100Start=!0,t.commissioningTaskLock="cm100",t.commissioningBoilerHeatPowerDisplay=""):c==="commissioningCm100Stop"?(t.pendingCommissioningCm100Start=!1,t.pendingBoilerPowerTestStart=!1,t.pendingFlowAutotuneStart=!1,t.pendingAirPurgeStart=!1,t.pendingManualFlowStart=!1,t.pendingManualHpStart=!1,t.pendingHpWaterCalibrationStart=!1,t.commissioningTaskLock="",t.commissioningBoilerHeatPowerDisplay=""):c==="boilerPowerTestStart"?(t.pendingBoilerPowerTestStart=!0,t.pendingFlowAutotuneStart=!1,t.pendingAirPurgeStart=!1,t.pendingManualFlowStart=!1,t.pendingManualHpStart=!1,t.pendingHpWaterCalibrationStart=!1,t.commissioningTaskLock="boiler",t.commissioningBoilerHeatPowerDisplay=""):c==="boilerPowerTestAbort"||c==="boilerPowerTestApply"?t.commissioningTaskLock="boiler":c==="flowAutotuneStart"?(t.pendingFlowAutotuneStart=!0,t.pendingBoilerPowerTestStart=!1,t.pendingAirPurgeStart=!1,t.pendingManualFlowStart=!1,t.pendingManualHpStart=!1,t.pendingHpWaterCalibrationStart=!1,t.commissioningTaskLock="autotune"):c==="flowAutotuneAbort"||c==="flowAutotuneApply"?t.commissioningTaskLock="autotune":c==="airPurgeStart"?(t.pendingAirPurgeStart=!0,t.pendingBoilerPowerTestStart=!1,t.pendingFlowAutotuneStart=!1,t.pendingManualFlowStart=!1,t.pendingManualHpStart=!1,t.pendingHpWaterCalibrationStart=!1,t.commissioningTaskLock="purge"):c==="airPurgeAbort"?t.commissioningTaskLock="purge":c==="manualFlowStart"?(t.pendingManualFlowStart=!0,t.pendingBoilerPowerTestStart=!1,t.pendingFlowAutotuneStart=!1,t.pendingAirPurgeStart=!1,t.pendingManualHpStart=!1,t.pendingHpWaterCalibrationStart=!1,t.commissioningTaskLock="manual-flow"):c==="manualFlowAbort"?t.commissioningTaskLock="manual-flow":c==="manualHpStart"?(t.pendingManualHpStart=!0,t.pendingBoilerPowerTestStart=!1,t.pendingFlowAutotuneStart=!1,t.pendingAirPurgeStart=!1,t.pendingManualFlowStart=!1,t.pendingHpWaterCalibrationStart=!1,t.commissioningTaskLock="manual-hp"):c==="hpWaterCalibrationStart"?(t.pendingHpWaterCalibrationStart=!0,t.pendingBoilerPowerTestStart=!1,t.pendingFlowAutotuneStart=!1,t.pendingAirPurgeStart=!1,t.pendingManualFlowStart=!1,t.pendingManualHpStart=!1,t.commissioningTaskLock="hp-water-calibration"):c==="hpWaterCalibrationAbort"||c==="hpWaterCalibrationApply"?t.commissioningTaskLock="hp-water-calibration":c==="manualHpAbort"&&(t.commissioningTaskLock="manual-hp");let m=[],b=0,y="",v="";if(c==="acknowledgeCompressorCyclingAlert")m.push(...kr);else if(c==="commissioningCm100Start"||c==="commissioningCm100Stop")m.push("commissioningStatus","cm100Active","boilerPowerTestStatus","boilerPowerTestActive","flowAutotuneStatus","airPurgeStatus","airPurgeActive","manualFlowStatus","manualFlowActive","manualHpStatus","manualHpGuardStatus","manualHpActive","hpWaterCalibrationStatus","hpWaterCalibrationActive");else if(c==="boilerPowerTestStart"||c==="boilerPowerTestAbort"||c==="boilerPowerTestApply")m.push("commissioningStatus","boilerPowerTestStatus","boilerPowerTestActive","boilerHeatPower","boilerPowerTestResult","boilerRatedHeatPower");else if(c==="flowAutotuneStart"||c==="flowAutotuneAbort"||c==="flowAutotuneApply")m.push("commissioningStatus","flowAutotuneStatus","flowKpSuggested","flowKiSuggested","flowKp","flowKi");else if(c==="airPurgeStart"||c==="airPurgeAbort")m.push("commissioningStatus","airPurgeStatus","airPurgeActive","airPurgeRemaining","airPurgePhase","airPurgeTargetIpwm","flowMode");else if(c==="hpWaterCalibrationStart"||c==="hpWaterCalibrationAbort"||c==="hpWaterCalibrationApply")m.push("commissioningStatus","hpWaterCalibrationStatus","hpWaterCalibrationActive","hpWaterCalibrationRemaining","hpWaterCalibrationPhase","hpWaterCalibrationSpread","hpWaterCalibrationSupplyDelta","hpWaterCalibrationStableProgress","hpWaterCalibrationStableRequired","hpWaterCalibrationResultReference","hpWaterCalibrationResultSpreadBefore","hpWaterCalibrationResultExpectedSpread","hpWaterCalibrationResultHp1InRawAvg","hpWaterCalibrationResultHp1OutRawAvg","hpWaterCalibrationResultHp2InRawAvg","hpWaterCalibrationResultHp2OutRawAvg","hp1WaterInRaw","hp1WaterOutRaw","hp2WaterInRaw","hp2WaterOutRaw","hp1WaterIn","hp1WaterOut","hp2WaterIn","hp2WaterOut","hp1WaterInOffset","hp1WaterOutOffset","hp2WaterInOffset","hp2WaterOutOffset","hp1WaterInOffsetSuggested","hp1WaterOutOffsetSuggested","hp2WaterInOffsetSuggested","hp2WaterOutOffsetSuggested","flowMode");else if(c==="manualFlowStart"||c==="manualFlowAbort"||c==="manualFlowApplyHeating"||c==="manualFlowApplyCooling")m.push("commissioningStatus","manualFlowStatus","manualFlowActive","manualFlowSetpoint","manualFlowTargetIpwm","flowSelected","flowMode","flowSetpoint","coolingFlowSetpoint");else if(c==="manualHpStart"||c==="manualHpAbort")m.push("commissioningStatus","manualHpStatus","manualHpGuardStatus","manualHpActive","manualHp1Mode","manualHp2Mode","manualHp1Level","manualHp2Level","flowSelected","hp1Compressor","hp1Freq","hp1Failures","hp2Compressor","hp2Freq","hp2Failures","hp1Mode","hp2Mode");else if(si.has(c)){let g=zl(c);g&&(m.push(...ii(g)),b=c.endsWith("Load")?1200:3200,y=c.endsWith("Load")?`HP${g} ODU runtime tabel lezen aangevraagd.`:`HP${g} ODU runtime write aangevraagd; controleer status/readback.`,v=`ODU runtime actie mislukt voor HP${g}`)}qo(c,{...m.length?{refreshKeys:m}:{},...b?{refreshDelayMs:b}:{},...y?{successNotice:y}:{},...v?{errorPrefix:v}:{}})}return}if(u==="close-system-modal"){rn(),xo(),t.systemModal="",t.authDraftCurrentPassword="",t.authDraftNewPassword="",t.authDraftConfirmPassword="",t.authNotice="",t.authError="",t.apiSecurityNotice="",t.apiSecurityError="",La(),d(),hn();return}if(u==="clear-webserver-log-output"){zo();return}if(u==="copy-webserver-log-output"){Kc();return}if(u==="start-debug-recording"){tm(l.dataset.debugMinutes||15);return}if(u==="start-rolling-debug-recording"){om();return}if(u==="select-debug-recording-duration"){em(l.dataset.debugMinutes||15);return}if(u==="stop-debug-recording"){nm();return}if(u==="freeze-debug-recording"){rm();return}if(u==="download-debug-recording"){am();return}if(u==="copy-debug-recording"){im();return}if(u==="confirm-settings-backup-restore"){Fd();return}if(u==="confirm-restart"){qo("restartAction",{successNotice:"OpenQuatt wordt opnieuw opgestart. Wacht even tot de webinterface weer terugkomt.",errorPrefix:"Herstart mislukt",reconnectMode:"restart"});return}if(u==="select-surface"){let c=l.dataset.surface==="native";if(t.nativeOpen===c){t.nativeOpen&&Fa();return}t.nativeOpen=c,fl(t.nativeOpen?"native":"app"),t.controlError="",t.controlNotice="",t.settingsInfoOpen="",t.updateModalOpen=!1,t.firmwareAdvancedOpen=!1,t.firmwareConnectionSwitchOpen=!1,t.firmwareTopologySwitchOpen=!1,t.updateManualUploadOpen=!1,t.updateTestFirmwareOpen=!1,t.firmwareConnectionSwitchConfirmed=!1,t.firmwareTopologySwitchConfirmed=!1,ke(),Ue(),rn(),t.systemModal="",t.nativeOpen&&Fa(),d(),Ia(),window.requestAnimationFrame(()=>{t.nativeOpen?t.nativeApp&&t.nativeApp.scrollIntoView({behavior:"smooth",block:"start"}):window.scrollTo({top:0,behavior:"smooth"})});return}if(u==="toggle-overview-theme"){sm(t.overviewTheme==="light"?"dark":"light"),d();return}if(u==="select-hp-visual"){cm(l.dataset.hpVisual==="compact"?"compact":"schematic"),d();return}if(u==="select-hp-layout"){um(l.dataset.hpLayout||"equal"),d();return}if(u==="select-step"){t.currentStep=l.dataset.stepId||"generation",d(),Ta(t.currentStep);return}if(u==="apply-quickstart-flow-source"){Hp();return}if(u==="refresh-quickstart-flow-signal"){Mp();return}if(u==="start-quickstart-flow-test"){Pp();return}if(u==="abort-quickstart-flow-test"){Np();return}if(u==="apply-quickstart-thermostat-source"){Op();return}if(u==="previous-step"){Qs(-1),d(),Ta(t.currentStep);return}if(u==="next-step"){Qs(1),d(),Ta(t.currentStep);return}if(u==="select-settings-option"){let c=l.dataset.selectKey||"",m=l.dataset.selectOption||"";c&&m&&String(E(c)||"")!==m&&ml(c,m);return}if(u==="toggle-overview-control"){let c=l.dataset.controlKey||"",m=(l.dataset.controlState||"").toLowerCase();c&&(m==="on"||m==="off")&&wv(c,m==="on");return}if(u==="select-overview-control-option"){let c=l.dataset.controlKey||"",m=l.dataset.controlOption||"";c&&m&&String(E(c)||"")!==m&&ml(c,m);return}if(u==="suggest-curve-fallback"){let c=In();c&&hl("curveFallbackSupply",c.value,"Fallback-aanvoertemperatuur uit de stooklijn overgenomen.");return}if(u==="apply"||u==="reset"){kv(u);return}if(u==="run-firmware-check"){pu();return}if(u==="install-firmware-update"){mu();return}if(u==="install-firmware-connection-switch"){gu();return}if(u==="install-firmware-topology-switch"){hu();return}if(u==="toggle-firmware-advanced"){t.firmwareAdvancedOpen||t.firmwareConnectionSwitchOpen||t.firmwareTopologySwitchOpen||t.updateManualUploadOpen||t.updateTestFirmwareOpen?(t.firmwareAdvancedOpen=!1,t.firmwareConnectionSwitchOpen=!1,t.firmwareConnectionSwitchConfirmed=!1,t.firmwareTopologySwitchOpen=!1,t.firmwareTopologySwitchConfirmed=!1,t.updateManualUploadOpen=!1,t.updateTestFirmwareOpen=!1,ke(),Ue()):t.firmwareAdvancedOpen=!0,d();return}if(u==="toggle-firmware-connection-switch"){t.firmwareConnectionSwitchOpen=!t.firmwareConnectionSwitchOpen,t.firmwareConnectionSwitchConfirmed=!1,t.firmwareConnectionSwitchOpen&&(t.firmwareAdvancedOpen=!0,t.firmwareTopologySwitchOpen=!1,t.firmwareTopologySwitchConfirmed=!1,t.updateManualUploadOpen=!1,t.updateTestFirmwareOpen=!1,ke(),Ue()),d();return}if(u==="toggle-firmware-topology-switch"){t.firmwareTopologySwitchOpen=!t.firmwareTopologySwitchOpen,t.firmwareTopologySwitchConfirmed=!1,t.firmwareTopologySwitchOpen&&(t.firmwareAdvancedOpen=!0,t.firmwareConnectionSwitchOpen=!1,t.firmwareConnectionSwitchConfirmed=!1,t.updateManualUploadOpen=!1,t.updateTestFirmwareOpen=!1,ke(),Ue()),d();return}if(u==="toggle-firmware-upload"){t.updateManualUploadOpen?(t.updateManualUploadOpen=!1,ke()):(t.firmwareAdvancedOpen=!0,t.updateManualUploadOpen=!0,t.firmwareConnectionSwitchOpen=!1,t.firmwareConnectionSwitchConfirmed=!1,t.firmwareTopologySwitchOpen=!1,t.firmwareTopologySwitchConfirmed=!1,t.updateTestFirmwareOpen=!1,Ue(),t.updateManualUploadError=""),d();return}if(u==="upload-firmware-file"){bu();return}if(u==="toggle-firmware-test"){t.updateTestFirmwareOpen?(t.updateTestFirmwareOpen=!1,Ue()):(t.firmwareAdvancedOpen=!0,t.updateTestFirmwareOpen=!0,t.updateManualUploadOpen=!1,t.firmwareConnectionSwitchOpen=!1,t.firmwareConnectionSwitchConfirmed=!1,t.firmwareTopologySwitchOpen=!1,t.firmwareTopologySwitchConfirmed=!1,ke(),t.updateTestFirmwareError=""),d();return}if(u==="install-firmware-test"){fu();return}if(u==="save-web-auth"){Up();return}if(u==="disable-web-auth"){Gp();return}}function zd(e){let o=e.target.closest("[data-curve-key]");!o||!ae()||(t.draggingCurveKey=o.dataset.curveKey||"",Xd(e.clientY))}function Qd(e){typeof sl=="function"&&sl(e),t.draggingCurveKey&&Xd(e.clientY)}function Yd(){if(!t.draggingCurveKey)return;let e=t.draggingCurveKey,o=qe(e,E(e));t.draggingCurveKey="",hl(e,o,"Curvepunt bijgewerkt.")}async function ml(e,o){let r=R[e];t.busyAction=`save-${e}`,t.controlNotice="",t.controlError="",t.entities[e]={...t.entities[e]||{},state:o,value:o},d();try{let n=await fetch(`${U(r.domain,r.name,"set")}?option=${encodeURIComponent(o)}`,{method:"POST"});if(!n.ok)throw new Error(`HTTP ${n.status}`);delete t.drafts[e],delete t.inputDrafts[e],t.controlNotice=`${r.name} bijgewerkt.`,e==="firmwareUpdateChannel"?(t.updateInstallCompleted=!1,t.updateInstallCompletedVersion="",t.entities.firmwareUpdateChannel={...t.entities.firmwareUpdateChannel||{},state:o,value:o},Vr(o),d(),await Br(),t.controlNotice="Releasekanaal bijgewerkt."):e==="debugLevel"?(t.controlNotice="Logger level bijgewerkt.",t.systemModal==="webserver-logs"&&Lr()):e==="webServerLogHistoryEnabled"?(enabled?(t.webServerLogHistoryLoaded=!1,Lr()):zo(),t.systemModal==="webserver-logs"&&d()):t.appView==="settings"?await D($o(),"all"):await D(["setupComplete","strategy","openquattEnabled","manualCoolingEnable","silentModeOverride",...Ve,...so],"state"),e==="strategy"&&t.appView!=="settings"&&await D(ae(o)?de.map(a=>a.key):ut,"state")}catch(n){t.controlError=`${r.name} kon niet worden bijgewerkt. ${n.message}`}finally{t.busyAction="",d()}}async function wv(e,o){let r=R[e];if(r){t.busyAction=`switch-${e}`,t.controlNotice="",t.controlError="",d();try{let n=o?"turn_on":"turn_off",a=await fetch(U(r.domain,r.name,n),{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);t.entities[e]={...t.entities[e]||{},value:o,state:o},t.controlNotice=`${r.name} ${o?"ingeschakeld":"uitgeschakeld"}.`,t.busyAction="",t.appView==="overview"?await D([...Ar,...Be,"setupComplete",...qt],"state"):t.appView==="settings"?(await D($o(),"all"),dn.includes(e)&&dr()):await D(["setupComplete","strategy","openquattEnabled","manualCoolingEnable","silentModeOverride",...Ve,...so],"state"),d()}catch(n){t.controlError=`${r.name} aanpassen mislukt (${n.message}).`,d()}finally{t.busyAction="",d()}}}async function hl(e,o,r=""){let n=R[e],a=qe(e,o);t.busyAction=`save-${e}`,t.controlNotice="",t.controlError="",t.inputDrafts[e]=String(o??""),t.drafts[e]=a,d();try{let i=await fetch(`${U(n.domain,n.name,"set")}?value=${encodeURIComponent(a)}`,{method:"POST"});if(!i.ok)throw new Error(`HTTP ${i.status}`);delete t.drafts[e],delete t.inputDrafts[e],t.controlNotice=r||`${n.name} bijgewerkt.`,await D(t.appView==="settings"?$o():[...new Set([e,"setupComplete","strategy",...Ve,...so])],"state")}catch(i){t.inputDrafts[e]=String(a).replace(".",","),t.controlError=`${n.name} kon niet worden bijgewerkt. ${i.message}`}finally{t.busyAction="",d()}}async function Sv(e,o){let r=R[e],n=Ft(o);t.busyAction=`save-${e}`,t.controlNotice="",t.controlError="",d();try{let a=await fetch(`${U(r.domain,r.name,"set")}?value=${encodeURIComponent(n)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);t.controlNotice=`${r.name} bijgewerkt.`,await D(t.appView==="settings"?$o():[e,"setupComplete"],"state")}catch(a){t.controlError=`${r.name} kon niet worden bijgewerkt. ${a.message}`}finally{t.busyAction="",d()}}async function qv(e,o){let r=R[e],n=String(o||"").trim();t.busyAction=`save-${e}`,t.controlNotice="",t.controlError="",t.inputDrafts[e]=String(o??""),t.drafts[e]=n,d();try{let a=await fetch(`${U(r.domain,r.name,"set")}?value=${encodeURIComponent(n)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);t.entities[e]={...t.entities[e]||{},value:n,state:n},delete t.drafts[e],delete t.inputDrafts[e],t.controlNotice=`${r.name} bijgewerkt.`,await D(t.appView==="settings"?$o():[e,"setupComplete"],"state")}catch(a){t.inputDrafts[e]=n,t.controlError=`${r.name} kon niet worden bijgewerkt. ${a.message}`}finally{t.busyAction="",d()}}async function gl(e,o){let r=R[e],n=tt(o)||go,a=await fetch(`${U(r.domain,r.name,"set")}?value=${encodeURIComponent(n)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return t.entities[e]={...t.entities[e]||{},value:n,state:n},n}async function Zd(e,o){let r=R[e],n=o?"turn_on":"turn_off",a=await fetch(U(r.domain,r.name,n),{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return t.entities[e]={...t.entities[e]||{},value:o,state:o},o}async function Jd(){await D([...new Set([...Ar,...Be,"setupComplete",...qt])],"state")}async function Tv(e,o){let r=R[e],n=tt(o);t.busyAction=`save-${e}`,t.controlNotice="",t.controlError="",d();try{await gl(e,n),t.controlNotice=`${r.name} bijgewerkt.`,await D(t.appView==="settings"?$o():[e,"setupComplete","openquattEnabled"],"state")}catch(a){t.controlError=`${r.name} kon niet worden bijgewerkt. ${a.message}`}finally{t.busyAction="",d()}}async function dl(e){let o=tt(e);if(e&&!o){t.controlError="Kies een geldig hervatmoment om automatisch weer in te schakelen.",d();return}if(o&&!h("openquattResumeAt")){t.controlError="Automatisch hervatten is op deze firmware nog niet beschikbaar.",d();return}t.busyAction="openquatt-regulation",t.controlNotice="",t.controlError="",d();let r=!1;try{h("openquattResumeAt")&&(await gl("openquattResumeAt",o||go),r=!!o),await Zd("openquattEnabled",!1),t.pauseResumeDraft=o?Dn(o):"",t.systemModal="",t.controlNotice=o?`Openquatt regeling is tijdelijk uitgeschakeld tot ${Vo(o)}.`:"Openquatt regeling is uitgeschakeld zonder eindmoment.",await Jd()}catch(n){if(r&&h("openquattResumeAt"))try{await gl("openquattResumeAt",go)}catch{}t.controlError=`Openquatt regeling kon niet worden bijgewerkt. ${n.message}`}finally{t.busyAction="",d()}}async function Ev(){t.busyAction="openquatt-regulation",t.controlNotice="",t.controlError="",d();try{await Zd("openquattEnabled",!0),t.pauseResumeDraft="",t.systemModal="",t.controlNotice="Openquatt regeling is weer actief.",await Jd()}catch(e){t.controlError=`Openquatt regeling kon niet worden ingeschakeld. ${e.message}`}finally{t.busyAction="",d()}}async function kv(e){let o=R[e];t.busyAction=e,t.controlError="",t.controlNotice="",d();try{let r=await fetch(U(o.domain,o.name,"press"),{method:"POST"});if(!r.ok)throw new Error(`HTTP ${r.status}`);t.controlNotice=e==="apply"?"Setup gemarkeerd als afgerond.":"Quick Start teruggezet naar het begin. Huidige tuningwaarden blijven voorlopig staan.",await D(["setupComplete"],"state"),e==="reset"&&(t.currentStep=Fo[0].id,t.quickStartModalMode="wizard",t.quickStartModalOpen=!0),t.quickStartModalOpen=e!=="apply",Rt("overview",{syncMode:"replace"}),pe({forceFast:!0})}catch(r){t.controlError=`Actie mislukt voor "${o.name}". ${r.message}`}finally{t.busyAction="",d()}}function Cv(){window.requestAnimationFrame(()=>{if(!t.root||t.systemModal!=="service-task-hp-water-calibration")return;let e=t.root.querySelector("[data-oq-service-task-scroller]"),o=t.root.querySelector("[data-oq-hp-water-calibration-actions]");if(!e||!o)return;let r=e.getBoundingClientRect(),n=o.getBoundingClientRect(),a=e.scrollTop+n.top-r.top-24;e.scrollTop=Math.max(0,a)})}async function qo(e,o={}){let r=R[e];if(r){t.busyAction=e,t.controlError="",t.controlNotice="",d();try{let n=await fetch(U(r.domain,r.name,"press"),{method:"POST"});if(!n.ok)throw new Error(`HTTP ${n.status}`);if(["commissioningCm100Start","commissioningCm100Stop","boilerPowerTestStart","boilerPowerTestAbort","boilerPowerTestApply","flowAutotuneStart","flowAutotuneAbort","flowAutotuneApply","airPurgeStart","airPurgeAbort","hpWaterCalibrationStart","hpWaterCalibrationAbort","hpWaterCalibrationApply","manualFlowStart","manualFlowAbort","manualFlowApplyHeating","manualFlowApplyCooling","manualHpStart","manualHpAbort","trendHistoryFlush","lifetimeEnergyHistoryCapture","lifetimeEnergyHistoryClear"].includes(e)||si.has(e)||(rn(),t.systemModal=""),t.controlNotice=o.successNotice||`${r.name} gestart.`,o.reconnectMode&&Wr(o.reconnectMode),Array.isArray(o.refreshKeys)&&o.refreshKeys.length){let i=Number(o.refreshDelayMs||0);Number.isFinite(i)&&i>0&&await new Promise(l=>window.setTimeout(l,i)),await D(o.refreshKeys,"state")}}catch(n){e==="commissioningCm100Start"?(t.pendingCommissioningCm100Start=!1,t.commissioningTaskLock=""):e==="boilerPowerTestStart"?(t.pendingBoilerPowerTestStart=!1,t.commissioningTaskLock=""):e==="flowAutotuneStart"?(t.pendingFlowAutotuneStart=!1,t.commissioningTaskLock=""):e==="airPurgeStart"?(t.pendingAirPurgeStart=!1,t.commissioningTaskLock=""):e==="hpWaterCalibrationStart"?(t.pendingHpWaterCalibrationStart=!1,t.commissioningTaskLock=""):e==="manualFlowStart"?(t.pendingManualFlowStart=!1,t.commissioningTaskLock=""):e==="manualHpStart"&&(t.pendingManualHpStart=!1,t.commissioningTaskLock=""),t.controlError=`${o.errorPrefix||`Actie mislukt voor "${r.name}"`}. ${n.message}`}finally{t.busyAction="",d(),e==="hpWaterCalibrationApply"&&Cv()}}}function Xd(e){let o=t.root?t.root.querySelector(".oq-helper-curve-svg"):null;if(!o||!t.draggingCurveKey)return;let r=o.getBoundingClientRect(),n=22,a=180,i=(e-r.top)/r.height*240,p=70-(Math.min(n+a,Math.max(n,i))-n)/a*50,u=qe(t.draggingCurveKey,p);String(E(t.draggingCurveKey))!==String(u)&&(t.drafts[t.draggingCurveKey]=u,d())}function Zt({key:e,value:o,meta:r,controlClass:n,inputClass:a="oq-helper-input",inputAttributes:i="",unitMarkup:l=""}){return`
      <label class="${n}">
        <input
          class="${a}"
          type="number"
    ...
    `}function pm(){let e=h("otEnabled"),o=h("cicPollingEnabled")||h("cicFeedUrl"),r=h("cicCompatibilityMode"),n=h("otLinkProblem")||h("cicDataStale")||h("cicJsonFeedOk");if(!e&&!o&&!r&&!n)return"";let a=$t("cicPollingEnabled"),i=$t("otEnabled"),l=({label:g,value:f,active:w=!1})=>`
      <div class="oq-settings-integration-diagnostic-item${w?" is-warning":""}">
        <dt>${s(g)}</dt>
        <dd>${s(f)}</dd>
      </div>
    `,p=(g,f,w="Actief",S="Normaal",q={})=>{if(!h(g))return"";let k=G(g);return l({label:f,value:k?w:S,active:q.warningWhenActive?k:!1})},u=(g,f,w={})=>{let S=w.fallbackKey||"";return!h(g)&&!(S&&h(S))?"":l({label:f,value:Se(h(g)?g:S,w)})},c=(g,f)=>{let w=f.filter(Boolean).join("");return w?`
    ...
    `:"";return te("Integratie","OpenTherm & CIC-polling","Configureer de directe thermostaatbus, externe CIC-feed en Quatt app-compatibiliteit.",`
        <div class="oq-settings-integration-grid">
          ${_a("otEnabled","OpenTherm","Thermostaatbus voor warmtevraag en kamerwaarden.")}
          ${_a("cicPollingEnabled","CIC-polling","JSON-feed uitlezen voor setpoint, kamerwaarden en flow.")}
          ${_a("cicCompatibilityMode","CiC-compatibiliteit","Gegevens doorgeven zodat de Quatt app kan blijven meekijken.")}
          ${m}
        </div>
        ${v}
      `)}function dm(){if(!xr.some(T=>h(T)))return"";let o=$t("cicPollingEnabled"),r=$t("otEnabled"),n=(T={})=>T.haValueKey||(T.haKeys||[]).find(C=>!/valid$/i.test(C))||"",a=(T={})=>T.haValidKey||(T.haKeys||[]).find(C=>/valid$/i.test(C))||"",i=(T="",C="")=>!!T&&!!C&&h(T)&&h(C)&&G(C),l=(T={})=>i(n(T),a(T)),p={mqttCoolingDewPoint:"cooling_dew_point",mqttOutsideTemperature:"outside_temperature",mqttRoomTemperature:"room_temperature",mqttRoomSetpoint:"room_setpoint",mqttHeatingEnable:"heating_enable",mqttCoolingEnable:"cooling_enable"},u=(T={})=>T.mqttTopicKey||p[T.valueKey]||"",c=(T="")=>{if(!T)return!0;let C=t.mqttStatus?.input_enabled;return C&&typeof C=="object"&&Object.prototype.hasOwnProperty.call(C,T)?C[T]!==!1:!0},m=T=>/\bMQTT\b/i.test(String(T||"")),b=(T,C={})=>T==="CIC"?o:T==="OT thermostat"?r:T==="HA input"?l(C):T==="CIC or HA input"?o||l(C):m(T)?c(u(C)):T==="Flowmeter HP2"?h("hp2Flow"):T==="Local aggregate HP1/HP2"?h("flowLocal")||h("hp2Flow"):!0,y=(T,C={})=>T==="CIC"&&!o?"CIC-polling staat uit":T==="OT thermostat"&&!r?"OpenTherm staat uit":T==="HA input"&&!l(C)?"HA-bron ongeldig":T==="CIC or HA input"&&!o&&!l(C)?"CIC en HA ontbreken":m(T)&&!c(u(C))?"MQTT-topic staat uit":T==="Flowmeter HP2"&&!h("hp2Flow")?"HP2-flow ontbreekt":T==="Local aggregate HP1/HP2"&&!h("flowLocal")&&!h("hp2Flow")?"Lokale flow ontbreekt":"",v=(T,C="Actief",P="Normaal")=>h(T)?G(T)?C:P:"",g=(T,C={})=>{let P=String(T||"").trim();return P?C.optionLabels?.[P]||ye(P):""},f=(T,C={})=>{let P=String(E(T)||"").trim();return P?g(P,C):""},w=T=>{let C=hr(T,"");return C?ye(C):""},S=(...T)=>T.find(C=>String(C||"").trim())||"",q=()=>{let T=f("waterSupplySource");if(String(E("waterSupplySource")||"")==="Local"&&h("localWaterSupplyTempSource")){let C=f("localWaterSupplyTempSource");return C?`${T} - ${C}`:T}return T},k=()=>{let T=String(E("flowSource")||"").trim();if(T==="Outdoor unit"){if(h("qFlowSource")){let C=String(E("qFlowSource")||"").trim(),P=String(E("hpGeneration")||"").trim();return C==="Local"||C==="Auto"&&P==="V1"?C==="Auto"?"Lokaal (auto)":"Lokaal":S(f("outdoorUnitFlowMode"),C==="Auto"?"Buitenunit (auto)":"Buitenunit")}return S(f("outdoorUnitFlowMode"),"Quatt-flow")}return ye(T)},$=()=>{let T=String(E("outsideTempSource")||"").trim();if(T==="MQTT"&&!c("outside_temperature"))return"MQTT-topic staat uit";if(T!=="Auto")return ye(T);let C=A("outsideTempLocalAggregated"),P=A("outsideTempHa"),V=A("mqttOutsideTemperature"),Q=!Number.isNaN(C),J=h("outsideTempHaValid")?G("outsideTempHaValid")&&!Number.isNaN(P):!Number.isNaN(P),X=c("outside_temperature")&&h("mqttOutsideTemperatureValid")&&G("mqttOutsideTemperatureValid")&&!Number.isNaN(V),Oe=[Q?{label:"Buitenunit",value:C}:null,J?{label:"HA-invoer",value:P}:null,X?{label:"MQTT",value:V}:null].filter(Boolean);return Oe.length?Oe.reduce((ne,Le)=>Le.value<ne.value?Le:ne,Oe[0]).label:"Auto"},H=T=>{if(!h(T))return NaN;let C=Number(E(T));if(Number.isFinite(C))return C;let V=String(t.entities[T]?.state??"").trim().replace(",",".").match(/-?\d+(?:\.\d+)?/);return V?Number(V[0]):NaN},W=(T,C="")=>{if(!h(T))return!1;let P=H(T);return(C?G(C):!0)&&Number.isFinite(P)},B=()=>{let T=String(E("coolingDewPointSource")||"").trim();if(T==="Home Assistant")return W("coolingDewPointHa","coolingDewPointHaValid")?"HA-invoer":"HA-invoer ontbreekt";if(T==="MQTT")return c("cooling_dew_point")?W("mqttCoolingDewPoint","mqttCoolingDewPointValid")?"MQTT":"MQTT ontbreekt of verouderd":"MQTT-topic staat uit";let C=W("coolingDewPointHa","coolingDewPointHaValid"),P=c("cooling_dew_point")&&W("mqttCoolingDewPoint","mqttCoolingDewPointValid");if(C&&P){let V=H("coolingDewPointHa");return H("mqttCoolingDewPoint")>V?"MQTT":"HA-invoer"}return C?"HA-invoer":P?"MQTT":T?ye(T):"Auto"},M=({label:T,value:C="",key:P="",active:V=!1,status:Q="",statusTone:J="",statusTitle:X=""})=>{let Oe=C||(P?Se(P):"");if(!Oe&&!Q)return"";let ne=String(J||"").replace(/[^a-z0-9_-]/gi,""),Le=X||Q,xe=Q?`<em class="oq-settings-source-status${ne?` oq-settings-source-status--${s(ne)}`:""}" title="${s(Le)}" aria-label="${s(`${Q}: ${Le}`)}">${s(Q)}</em>`:"";return`
        <div class="oq-settings-source-row${V?" is-warning":""}${Q?" has-status":""}">
          <span>${s(T)}${xe}</span>
          <strong>${s(Oe)}</strong>
        </div>
      `},I=({label:T="HA-invoer",valueKey:C="",validKey:P="",value:V=""})=>{if(!C||!P||!h(C)||!h(P))return[];let Q=G(P);return[M({label:T,key:C,value:V,status:Q?"Geldig":"Ongeldig",statusTone:Q?"valid":"invalid",statusTitle:Q?"Home Assistant geeft dit signaal geldig door. OpenQuatt mag deze HA-invoer gebruiken.":"Home Assistant geeft dit signaal niet geldig door. OpenQuatt gebruikt deze HA-invoer dan niet als bron."})]},z=({label:T="MQTT",valueKey:C="",validKey:P="",value:V="",topicKey:Q=""})=>{if(!C||!P||!h(C)||!h(P))return[];if(!c(Q||p[C]))return[];let J=G(P),X=J?"MQTT heeft een geldige, recente waarde ontvangen. OpenQuatt mag deze MQTT-invoer gebruiken.":"MQTT heeft nog geen geldige recente waarde ontvangen. OpenQuatt gebruikt deze MQTT-invoer dan niet als bron.";return[M({label:T,key:C,value:J?V:"\u2014",status:Qi(P),statusTone:J?"valid":"invalid",statusTitle:X})]},re=({title:T,icon:C="",content:P="",rows:V=[],copy:Q="",className:J=""})=>{let X=V.filter(Boolean).join("");return!P&&!X&&!Q?"":`
        <section class="oq-settings-source-group${J?` ${s(J)}`:""}">
          <h5>
            ${C?`<span class="oq-settings-source-group-icon">${Xe(C,"oq-settings-source-group-icon-svg")}</span>`:""}
            <span>${s(T)}</span>
          </h5>
      ...
      `},ge=(T,C={})=>{if(!h(T))return{markup:"",warning:""};let P=t.entities[T]||{},V=String(E(T)||""),J=Jt(P).filter(xe=>b(xe,C)),X=V&&!b(V,C),Oe=V==="HA input"&&C.keepUnavailableCurrent!==!0,Le=(X&&!Oe&&!J.includes(V)?[V,...J]:J).map(xe=>{let No=g(xe,C);return`<option value="${s(xe)}" ${xe===V?"selected":""}>${s(No)}</option>`}).join("");return{markup:`
          <label class="oq-settings-source-select">
            <span class="oq-settings-source-select-head">
              <span>${s(C.label||"Bron")}</span>
              ${C.infoCopy?eo(C.infoId||T,C.infoTitle||C.label||"Bron",C.infoCopy):""}
            </span>
            <select class="oq-helper-select" data-oq-field="${s(T)}" ${t.loadingEntities?"disabled":""}>
              ${Le}
            </select>
          </label>
        `,warning:X?`Huidige bron niet beschikbaar: ${y(V,C)}`:""}},Z=({key:T,title:C,icon:P="",select:V,secondarySelect:Q=null,secondarySelects:J=null,activeRows:X=[],measurementRows:Oe=[],activeCopy:ne="",rows:Le=[]})=>{let xe=V&&V.when!==!1?ge(V.key,V):{markup:"",warning:""},Nt=(Array.isArray(J)?J:Q?[Q]:[]).filter(se=>se&&se.when!==!1).map(se=>ge(se.key,se)).filter(se=>se.markup),Sr=Nt.map(se=>se.markup).join(""),Je=Nt.map(se=>se.warning).find(Boolean)||"",bt=Le.filter(Boolean).join(""),$e=`${xe.markup}${Sr}`,ce=xe.warning||Je,yt=[re({title:"Configuratie",icon:"settings",className:"oq-settings-source-group--config",content:$e?`
            <div class="oq-settings-source-controls">
              ${$e}
            </div>
            ${ce?`<p class="oq-settings-source-warning">${s(ce)}</p>`:""}
          `:""}),re({title:"Actief",icon:"target",rows:X,copy:ne,className:"oq-settings-source-group--active"}),re({title:"Metingen",icon:"activity",rows:Oe,className:"oq-settings-source-group--measurements"})].filter(Boolean).join("");return!yt&&!$e&&!bt?"":`
        <article class="oq-settings-source-card" data-oq-settings-field="${s(T||V.key)}">
          <div class="oq-settings-source-card-head">
            ${P?`<span class="oq-settings-source-card-icon">${Xe(P,"oq-settings-source-card-icon-svg")}</span>`:""}
            <h4>${s(C)}</h4>
          </div>
          ${yt||`
            ${$e?`
    ...
    `:"";return te("Integratie","MQTT inputbronnen","Beheer de brokerverbinding voor externe MQTT-bronwaarden.",`
        <div class="oq-settings-mqtt-shell">
          <section class="oq-settings-mqtt-panel oq-settings-mqtt-panel--broker">
            ...
            <div class="oq-settings-quickstart-status-row oq-settings-mqtt-status-row">
              <div>
                <p class="oq-settings-quickstart-status-label">Huidige status</p>
                <strong class="oq-settings-quickstart-status-value">${s(ou())}</strong>
                <p class="oq-settings-quickstart-status-copy">${s(ru())}</p>
              </div>
              <button
                class="oq-helper-button oq-helper-button--ghost"
                type="button"
      ...
      `)}function gm(){return te("Toegang","Toegang & Beveiliging","Pas hier de web-login of de ESPHome API-sleutel aan. Deze wijziging wordt actief na herstart.",`
      ...
      `)}function bl(e,o,r="",n=!1){return`
      <div class="oq-settings-storage-summary-metric${n?" is-on":""}">
        <span>${s(e)}</span>
        <strong>${s(o)}</strong>
        ${r?`<em>${s(r)}</em>`:""}
      </div>
    `}function hm(e){let o=String(e||"").trim(),r=o.match(/^(\d+(?:[.,]\d+)?)\s+records?$/i);return r?`${r[1]} ${r[1]==="1"?"dag":"dagen"}`:o}function yl(e,o,r,n="",a="",i=""){if(!h(e))return"";let l=!!E(e),p=t.loadingEntities||t.busyAction===`switch-${e}`;return`
    ...
    `}function xv(e,o,r,n=""){if(!h(e))return"";let a=t.entities[e],i=Array.isArray(a?.option)?a.option:[],l=String(E(e)||"");return i.length?`
      <article class="oq-settings-storage-row oq-settings-storage-row--select" data-oq-settings-field="${s(e)}">
        ...
        <label class="oq-settings-storage-select">
          <select class="oq-helper-select" data-oq-field="${s(e)}" ${t.loadingEntities?"disabled":""}>
            ${i.map(p=>`<option value="${s(p)}" ${p===l?"selected":""}>${s(ye(p))}</option>`).join("")}
          </select>
          <span class="oq-settings-select-caret" aria-hidden="true"></span>
        </label>
      </article>
    `:""}function $v(e){return h(e)||!!R[e]&&!t.optionalMissingEntities?.[e]}function vl(e,o,r,n={}){if(!$v(e))return"";let a=h(e),i=a&&(t.loadingEntities||t.busyAction===e),l=n.disabled===!0||!a,p=n.buttonClass||"oq-helper-button oq-helper-button--ghost";return`
      <button
        class="${s(p)}"
        type="button"
        data-oq-action="${s(r)}"
    ...
    `}function Av(){return t.trendHistoryMetadata&&typeof t.trendHistoryMetadata=="object"?t.trendHistoryMetadata:{}}function fr(){return!!t.trendHistoryMetadataSignature}function br(){return!!(t.energyHistoryRaw||t.energyHistorySignature)}function Ze(e){return e?"Niet geladen":"Laden..."}function Ne(e,o="\u2014"){if(h(e))return Se(e);let r=Hv(e);return r==null||r===""?o:r}function Hv(e){let o=Av();if(e==="trendHistoryFlashAvailable")return fr()?o.available||"Alleen live":Ze(t.trendHistoryMetadataError);if(e==="trendHistoryFlashOldest")return fr()?o.oldest||"Geen data":Ze(t.trendHistoryMetadataError);if(e==="trendHistoryFlashNewest")return fr()?o.newest||"Geen data":Ze(t.trendHistoryMetadataError);if(e==="trendHistoryFlashLastFlush")return fr()?o.lastFlush||"Geen data":Ze(t.trendHistoryMetadataError);if(e==="trendHistoryFlashSize")return fr()?wl(o.sizeKb):Ze(t.trendHistoryMetadataError);if(e==="trendHistoryFlashWrites")return fr()?Sl(o.writes):Ze(t.trendHistoryMetadataError);let r=ym(),a=String(t.energyHistoryRaw||"").includes("@day_retention|");return e==="lifetimeEnergyHistoryAvailable"?br()?a&&!r.dayPartitionAvailable?"Niet beschikbaar":fm(r.storedDayCount,"Geen data"):Ze(t.energyHistoryError):e==="lifetimeEnergyHistoryOldest"?br()?Wa(r.oldestDateKey):Ze(t.energyHistoryError):e==="lifetimeEnergyHistoryNewest"?br()?Wa(r.newestDateKey):Ze(t.energyHistoryError):e==="lifetimeEnergyHistoryLastWrite"?br()?bm(r.dayLastWriteTimestampS):Ze(t.energyHistoryError):e==="lifetimeEnergyHistorySize"?br()?wl(r.dayStorageKb):Ze(t.energyHistoryError):e==="lifetimeEnergyHistoryWrites"?br()?Sl(r.dayWriteCount):Ze(t.energyHistoryError):null}function fm(e,o="Geen data"){let r=Number(e);return!Number.isFinite(r)||r<=0?o:`${Math.round(r)} ${Math.round(r)===1?"dag":"dagen"}`}function wl(e,o="\u2014"){let r=Number(e);return!Number.isFinite(r)||r<=0?o:`${Math.round(r)} kB`}function Sl(e,o="0"){let r=Number(e);return!Number.isFinite(r)||r<=0?o:String(Math.round(r))}function Wa(e){let o=typeof oe=="function"?oe(e):null;return o?o.date.toLocaleDateString("nl-NL",{day:"2-digit",month:"2-digit",year:"numeric"}):"Geen data"}function bm(e,o="Geen data"){let r=Number(e);if(!Number.isFinite(r)||r<=0)return o;let n=new Date(r*1e3),a=n.toLocaleDateString("nl-NL",{day:"2-digit",month:"2-digit"}),i=n.toLocaleTimeString("nl-NL",{hour:"2-digit",minute:"2-digit"});return`${a} ${i}`}function ym(){return typeof nn!="function"?{}:nn()}function Mv(e){let o=Array.isArray(e.items)?e.items:[];return`
    ...
    `}function Rv(e){let o=e.filter(Boolean);return o.length?`
    ...
    `:""}function vm(){if(!h("trendHistoryEnabled")&&!h("lifetimeEnergyHistoryEnabled"))return"";let e=x("trendHistoryEnabled"),o=e&&x("trendHistoryFlashEnabled"),r=h("lifetimeEnergyHistoryEnabled"),n=r&&x("lifetimeEnergyHistoryEnabled"),a=o?Ne("trendHistoryFlashAvailable","Alleen live"):"Alleen live",i=r?hm(Ne("lifetimeEnergyHistoryAvailable","Geen data")):"Geen data";return te("Diagnose","Gegevens bewaren","Bepaal welke gegevens OpenQuatt bewaart voor grafieken, resultaten en hulp bij problemen.",`
        <article class="oq-settings-storage-summary">
          ...
          <div class="oq-settings-storage-summary-metrics" aria-label="Opslagstatus">
            ${h("trendHistoryEnabled")?bl("Live diagnose",e?"Aan":"Uit","Live",e):""}
            ${h("trendHistoryFlashEnabled")?bl("Diagnosehistorie",a,o?"Permanent geheugen":"Uit",o):""}
            ${r?bl("Energiehistorie",i,n?"Permanent geheugen":"Uit",n):""}
          </div>
      ...
      `)}function Pv(){if(!h("lifetimeEnergyHistoryEnabled"))return"";let e=t.energyHistoryImportRecords.length,o=new Set(t.energyHistoryImportHourRecords.map(p=>p.dateKey)).size,r=[];e>0&&r.push(`${e} dagrecords`),o>0&&r.push(`${o} uurdagen`),t.energyHistoryImportRange&&r.push(t.energyHistoryImportRange),t.energyHistoryImportSource&&r.push(t.energyHistoryImportSource),t.energyHistoryImportInvalidCount>0&&r.push(`${t.energyHistoryImportInvalidCount} regels niet gebruikt`);let n=!!t.energyHistoryImportFileName,a=e>0||o>0,i=Number(t.energyHistoryImportProgressPercent||0),l=t.energyHistoryImportBusy?`Importeren...${i>0?` (${i}%)`:""}`:"Importeren";return`
    ...
    `}function Nv(){if(!h("lifetimeEnergyHistoryEnabled"))return"";let e=mr(t.energyHistoryExportMode),o=pn.map(n=>`
    ...
    `}function wm(){let e=h("trendHistoryEnabled")&&x("trendHistoryEnabled"),o=e&&h("trendHistoryFlashEnabled")&&x("trendHistoryFlashEnabled"),r=h("lifetimeEnergyHistoryEnabled"),n=r&&x("lifetimeEnergyHistoryEnabled"),a=r?Ne("lifetimeEnergyHistoryAvailable","Geen data"):"Geen data",i=h("lifetimeEnergyHistoryClear")&&a!=="Geen data"&&a!=="\u2014",l=hm(a),p=e&&h("trendHistoryFlush"),u=h("lifetimeEnergyHistoryCapture"),c=ym(),m=String(t.energyHistoryRaw||"").includes("@hour_retention|"),b=m&&!c.hourPartitionAvailable,y=m?b?"Alleen live":fm(c.hourStoredDayCount,"Geen uurdata"):"Laden...",v=m?b?"Niet beschikbaar":wl(c.hourStorageKb):"Laden...",g=m?b?"Niet beschikbaar":Sl(c.hourWriteCount):"Laden...",f=m?b?"Niet beschikbaar":bm(c.hourLastWriteTimestampS):"Laden...",w=Wa(c.hourOldestDateKey),S=Wa(c.hourNewestDateKey),q=m?c.hourPartitionAvailable?`${w} t/m ${S}`:"Live beschikbaar; bewaren in Flash vraagt een nieuwere Flash-indeling.":"Uurdetailstatus wordt opgehaald.",k=[{title:"Diagnosegeschiedenis",meta:"Diagnose",shortLabel:"Diagnose",primary:Ne("trendHistoryFlashAvailable","Alleen live"),note:`Laatste meting: ${Ne("trendHistoryFlashNewest","Geen data")}`,items:[{label:"Bewaarperiode",value:Ne("trendHistoryFlashAvailable","Alleen live")},{label:"Opslagruimte",value:Ne("trendHistoryFlashSize")},{label:"Opslagacties",value:Ne("trendHistoryFlashWrites","0")},{label:"Laatst opgeslagen",value:Ne("trendHistoryFlashLastFlush","Geen data")}]},{title:"Dagtotalen",meta:"Resultaten",shortLabel:"Dag",primary:l,note:`${Ne("lifetimeEnergyHistoryOldest","Geen data")} t/m ${Ne("lifetimeEnergyHistoryNewest","Geen data")}`,items:[{label:"Dagen bewaard",value:l},{label:"Opslagruimte",value:Ne("lifetimeEnergyHistorySize")},{label:"Opslagacties",value:Ne("lifetimeEnergyHistoryWrites","0")},{label:"Laatst opgeslagen",value:Ne("lifetimeEnergyHistoryLastWrite","Geen data")}]},h("lifetimeEnergyHourRetention")?{title:"Uurdetail",meta:"Resultaten",shortLabel:"Uur",primary:y,note:q,items:[{label:"Dagen bewaard",value:y},{label:"Opslagruimte",value:v},{label:"Opslagacties",value:g},{label:"Laatst opgeslagen",value:f}]}:null];return`
      <div class="oq-helper-modal-backdrop${t.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
          ...
          <div class="oq-settings-storage-domain-grid">
            <section class="oq-settings-storage-domain oq-settings-storage-domain--trend">
              ...
              <div class="oq-settings-storage-domain-rows">
                ${yl("trendHistoryEnabled","Recente diagnosegegevens","Bewaar de laatste meetpunten zolang de controller online is.","Na een herstart of update zijn deze tijdelijke gegevens niet meer beschikbaar.","Nieuwe tijdelijke diagnosegegevens worden niet bijgehouden.","Tijdelijk")}
                ${yl("trendHistoryFlashEnabled","Diagnosegeschiedenis bewaren","Bewaar recente diagnosegegevens ook na een herstart of update.","OpenQuatt slaat deze gegevens ongeveer elk uur op.","Alleen recente diagnosegegevens; bestaande geschiedenis blijft staan.","Permanent geheugen")}
                ${p?`
                  <div class="oq-settings-storage-inline-action">
                    ...
                    ${vl("trendHistoryFlush","Nu opslaan","flush-trend-history",{disabled:!o,busyLabel:"Opslaan..."})}
                  </div>
                `:""}
              </div>
            </section>
            <section class="oq-settings-storage-domain oq-settings-storage-domain--energy">
              ...
              <div class="oq-settings-storage-domain-rows">
                ${yl("lifetimeEnergyHistoryEnabled","Dagtotalen bewaren","Bewaar elke dag een samenvatting van je energiegegevens.","Zo blijven je resultaten ook na een herstart of update beschikbaar. OpenQuatt slaat dit op aan het einde van de dag en bij een normale afsluiting.","Nieuwe dagtotalen worden niet bewaard; bestaande historie blijft staan.","Permanent geheugen")}
                ${xv("lifetimeEnergyHourRetention","Uurdetail bewaren","Kies hoelang OpenQuatt detail per uur mag bewaren voor de daggrafiek.","Geavanceerd")}
                ${u?`
                  <div class="oq-settings-storage-inline-action oq-settings-storage-inline-action--split">
                    ...
                    <div class="oq-settings-storage-action-stack">
                      ${vl("lifetimeEnergyHistoryCapture","Vandaag opslaan","save-lifetime-energy-history",{disabled:!n,busyLabel:"Opslaan..."})}
                    </div>
                  </div>
                `:""}
                ${Nv()}
                ...
                ${h("lifetimeEnergyHistoryClear")?`
                  <div class="oq-settings-storage-inline-action oq-settings-storage-inline-action--danger">
                    ...
                    <div class="oq-settings-storage-action-stack">
                      ${vl("lifetimeEnergyHistoryClear","Historie wissen","clear-lifetime-energy-history",{disabled:!i,buttonClass:"oq-helper-button oq-helper-button--warning",busyLabel:"Wissen..."})}
                    </div>
                  </div>
                `:""}
              </div>
    ...
    `}function Sm(){let e=t.settingsBackupBusy,o=Dt.length,r=Lt.length;return te("Beheer","Backup en restore","Sla een JSON-backup op van de instellingen die OpenQuatt in deze web-app beheert, en zet die later weer terug na een factory-bin update.",`
      ...
      `)}function qm(){let e=t.settingsBackupBusy;return`
      <div class="oq-helper-modal-backdrop${t.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
    ...
    `}function Tm(){let e=t.settingsBackupDraft;if(!e)return"";let o=e.summary||pl(e),r=String(e.source?.installation||e.source?.device||"Onbekend"),n=rt(),a=String(e.source?.firmware_version||"Onbekend"),i=String(e.source?.firmware_channel||"").trim()||"Onbekend",l=String(e.source?.topology||"").trim()||"Onbekend",p=le(),u=typeof ee=="function"?ee():"",c=l!=="Onbekend"&&u&&l!==u,m=r!=="Onbekend"&&r!==n,b=c||m?"De backup lijkt van een andere installatie te komen. Je kunt nog steeds doorzetten, maar controleer de secties even goed.":o.requiredMissing?"Ontbrekende velden houden hun firmware-default.":"Velden zonder waarde worden overgeslagen.";return`
      <div class="oq-helper-modal-backdrop${t.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
    ...
    `:""}function ue(e,o,r,n,a="",i=""){return`<article class="oq-settings-field${a?` ${a}`:""}" data-oq-settings-field="${s(e)}"><div class="oq-settings-field-head"><h3>${s(o)}</h3>${eo(e,o,r)}</div><div class="oq-settings-field-control">${n}</div>${i}</article>`}function Ce(e,o,r,n,a=""){return ue(e,o,r,`<div class="oq-settings-static-value">${s(n)}</div>`,a)}function Se(e,o={}){let r=typeof o=="number"?{decimals:o}:o||{},n=t.entities[e];if(!n)return"\u2014";let a=Number(n.value);if(!Number.isNaN(a)){let p=Number.isInteger(a)?0:Number.isFinite(r.decimals)?r.decimals:1,u=a.toFixed(Math.max(0,p));return r.trimTrailingZeros&&u.includes(".")&&(u=u.replace(/\.?0+$/,"")),`${u}${n.uom?` ${n.uom}`:""}`}let i=String(n.state??n.value??"").trim(),l=i.toLowerCase();return!i||l==="nan"||l==="unknown"||l==="unavailable"?"\u2014":i}function hr(e,o="\u2014"){let r=t.entities[e];if(!r)return o;let n=String(r.state??r.value??"").trim();return!n||n==="0"||n==="\u2014"?o:n}function Xt(e,o="",r=2){let n=Number(e);return Number.isFinite(n)?`${n.toFixed(Math.max(0,r))}${o?` ${o}`:""}`:"\u2014"}function we(e,o=2){return Se(e,{decimals:o})}function Ao(e,o="IDLE"){let r=hr(e,o),n=String(r??"").trim();return!n||n==="0"||n==="UNKNOWN"||n==="UNAVAILABLE"||n==="NAN"?o:n}function Tl(){let e=hr("commissioningStatus",""),o=x("cm100Active"),r=String(e||"").trim().toUpperCase();return(o||r==="CM100 READY"||r==="CM100 STOPPED"||r.includes("DONE")||r.includes("FAILED")||r.includes("ABORT")||r.includes("APPLIED")||r.includes("REFUSED"))&&(t.pendingCommissioningCm100Start=!1),r&&r!=="0"?r==="IDLE"&&t.pendingCommissioningCm100Start?"CM100 REQUESTED":r:t.pendingCommissioningCm100Start?"CM100 REQUESTED":o?"CM100 READY":"IDLE"}function ye(e){let o=String(e||"").trim();return o?{None:"Geen",Manual:"Handmatig",Balanced:"Gebalanceerd",Stable:"Stabiel",Responsive:"Direct",Calm:"Rustig",Custom:"Aangepast",[Hn]:"Stooklijn",[An]:"Power House","Dew point required":"Dauwpuntmeting vereist","Dew point":"Dauwpunt","Dew point (MQTT)":"Dauwpunt (MQTT)","Dew point (HA)":"Dauwpunt (HA)","Allow without dew point":"Dauwpuntsbenadering","Allow without dew point, use fallback":"Dauwpuntsbenadering","Allow without dew point, use dew point approximation":"Dauwpuntsbenadering","Allow without dew point, user responsibility":"Expliciet toestaan",Fallback:"Dauwpuntsbenadering","Fallback blocked":"Dauwpuntsbenadering geblokkeerd","User responsibility":"Expliciet toegestaan",Local:"Lokaal",CIC:"CIC","HA input":"HA-invoer","CIC + HA input":"CIC + HA-invoer","OT thermostat":"OT-thermostaat","Outdoor unit":"Buitenunit",Auto:"Auto","CIC or HA input":"CIC of HA-invoer","Flowmeter HP1":"Flowmeter HP1","Flowmeter HP2":"Flowmeter HP2","Local aggregate HP1/HP2":"Gecombineerde flow HP1/HP2"}[o]||o:""}function tr({key:e,option:o,currentValue:r,busy:n,copy:a="",meta:i="",image:l="",imageAlt:p="",infoTitle:u="",infoCopy:c="",infoId:m=""}){let b=o===r,y=`
      <button
      ...
      >
        <span class="oq-settings-choice-head">
          <span class="oq-settings-choice-title">${s(ye(o))}</span>
          ${i?`<span class="oq-settings-choice-meta"><span class="oq-settings-choice-meta-text">${s(i)}</span></span>`:""}
        </span>
        ${l?`<span class="oq-settings-choice-media"><img src="${s(l)}" alt="${s(p||ye(o))}" loading="lazy" decoding="async"></span>`:""}
        ${a?`<span class="oq-settings-choice-copy">${s(a)}</span>`:""}
      </button>
    `;if(!c)return y;let v=u||ye(o),g=m||`${e}-${o}`;return`
      <article class="oq-settings-choice-card-shell${b?" is-active":""}${l?" oq-settings-choice-card-shell--with-image":""}">
        ${y}
        ${eo(g,v,c)}
      </article>
    `}function Jt(e={}){return Array.isArray(e.option)?e.option:Array.isArray(e.options)?e.options:[]}function Ut(e,o,r,n=""){if(!h(e))return"";let a=t.entities[e]||{},i=String(E(e)||""),l=Jt(a);return ue(e,o,r,`<label class="oq-settings-control oq-settings-control--select"><select class="oq-helper-select" data-oq-field="${s(e)}" ${t.loadingEntities?"disabled":""}>${l.map(p=>`<option value="${s(p)}" ${p===i?"selected":""}>${s(ye(p))}</option>`).join("")}</select><span class="oq-settings-select-caret" aria-hidden="true"></span></label>`,n)}function Ov(e,o,r="Aan",n="Uit"){return`<span class="oq-settings-toggle-state${o?" is-on":""}" data-oq-switch-pill="${s(e)}" data-on-label="${s(r)}" data-off-label="${s(n)}">${s(o?r:n)}</span>`}function At(e,o,r,n,a="Aan",i="Uit",l=!0){let p=r?a:i,u=r?"off":"on";return`
    ...
    `}function ql(e,o,r="",n=""){let a=o?r:n;return a?`<p data-oq-switch-copy="${s(e)}" data-on-copy="${s(r)}" data-off-copy="${s(n)}">${s(a)}</p>`:""}function xu(e,o,r,n="",a="",i=""){if(!h(e))return"";let l=!!E(e),p=t.loadingEntities||t.busyAction===`switch-${e}`;return ue(e,o,r,`
        <div class="oq-settings-compact-switch-field">
          ${At(e,o,l,p)}
          ${ql(e,l,n,a)}
        </div>
      `,i)}function Em(e,o,r,n,a=""){if(!h(e))return"";let i=!!E(e),l=t.loadingEntities||t.busyAction===`switch-${e}`;return ue(e,o,r,`
        <div class="oq-settings-compact-switch-field">
          ${At(e,o,i,l)}
          ${n?`<p>${s(n)}</p>`:""}
        </div>
      `,a)}function _a(e,o,r){if(!h(e))return"";let n=!!E(e),a=t.loadingEntities||t.busyAction===`switch-${e}`;return`
    ...
    `}function _e(e,o,r="oq-helper-button oq-helper-button--ghost",n=!1){return`
      <button
        class="${r}"
        type="button"
    ...
    `;return ue(e,o,r,c,a)}function ie(e,o,r,n="",a={}){if(!h(e))return"";let i=Ie(e),l=Ee(e),p=a.unitOverride||i.uom||"",u=a.showUnit!==!1&&!!p,c=u&&a.unitMode!=="outside",m=Zt({key:e,value:l,meta:i,controlClass:`oq-helper-control${u&&!c?" oq-helper-control--split":""}${c?" oq-helper-control--suffix":""}`,unitMarkup:u?c?`<span class="oq-helper-unit-chip">${s(p)}</span>`:`<span class="oq-helper-unit">${s(p)}</span>`:""});return ue(e,o,r,m,n,a.footerMarkup||"")}function ze(e,o,r,n="",a={}){if(!h(e))return"";let i=Ie(e),l=qe(e,E(e)),p=a.minLabel||`${i.min}${i.uom||""}`,u=a.maxLabel||`${i.max}${i.uom||""}`,c=a.valueLabel||j(e,l);return ue(e,o,r,`<label class="oq-helper-slider-field"><div class="oq-helper-slider-meta"><span>${s(p)}</span><strong>${s(c)}</strong><span>${s(u)}</span></div><input class="oq-helper-range" type="range" data-oq-field="${s(e)}" min="${i.min}" max="${i.max}" step="${i.step}" value="${l}" ${t.loadingEntities?"disabled":""}></label>`,n)}function ts(e,o,r,n={}){if(!h(e))return"";let a=Ie(e),i=Ee(e),l=n.compact===!0,p=n.embedded===!0,u=n.infoId||e,c=n.showCopy!==!1;return`
      <article class="oq-settings-mini-field${l?" oq-settings-mini-field--compact":""}${p?" oq-settings-mini-field--embedded":""}">
        ...
        ${Zt({key:e,value:i,meta:a,controlClass:"oq-helper-control oq-helper-control--suffix",inputClass:"oq-helper-input oq-helper-input--compact-number",unitMarkup:a.uom?`<span class="oq-helper-unit-chip">${s(a.uom)}</span>`:""})}
      </article>
    `}function Us(e,o,r,n=""){if(!h(e))return"";let a=Rr(E(e));return ue(e,o,r,`<label class="oq-settings-control oq-settings-control--time"><input class="oq-helper-input oq-helper-input--time" type="time" step="60" lang="nl-NL" inputmode="numeric" data-oq-field="${s(e)}" value="${s(a)}" ${t.loadingEntities?"disabled":""}><span class="oq-settings-time-icon" aria-hidden="true"><svg viewBox="0 0 20 20" focusable="false"><circle cx="10" cy="10" r="6.5" fill="none" stroke="currentColor" stroke-width="1.6" /><path d="M10 6.2 V10 L12.9 11.8" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" /></svg></span></label>`,n||"oq-settings-field--time")}function te(e,o,r,n,a=""){return`<section class="oq-settings-section"><div class="oq-settings-section-head"><div class="oq-settings-section-head-meta"><p class="oq-helper-label">${s(e)}</p>${a?`<div class="oq-settings-section-head-meta-badge">${a}</div>`:""}</div><h3>${s(o)}</h3><p>${s(r)}</p></div>${n}</section>`}function km(){let e=Ae.has(t.settingsGroup)?t.settingsGroup:he[0].id;return`
      <nav class="oq-settings-group-nav" aria-label="Instellingen groepen">
        ${he.map(o=>`
          ...
          >
            ${Xe(o.icon,"oq-settings-group-button-icon")}
            <span class="oq-settings-group-button-label">${s(o.label)}</span>
          </button>
        `).join("")}
      </nav>
    `}function Cm(){let e=Ae.has(t.settingsGroup)?t.settingsGroup:he[0].id;return`
      <div class="oq-settings-group-stack">
        ${(e==="installation"?[mp(),gp(),Eu(),yp(),wp(),bp(),up()]:e==="service"?[dp(),$m()]:e==="heating"?[ku()]:e==="cooling"?[Cu()]:e==="integrations"?[pm(),mm(),dm()]:[hp(),vm(),gm(),Sm(),fp()]).filter(Boolean).join("")}
      </div>
    `}function xm(){if(!t.root||t.appView!=="settings")return!1;let e=t.root.querySelector(".oq-settings-group-nav"),o=t.root.querySelector(".oq-settings-group-stack");if(!e||!o)return!1;let r=Ae.has(t.settingsGroup)?t.settingsGroup:he[0].id;if(r==="service")return!1;let n=e.querySelectorAll(".oq-settings-group-button");if(n.length!==he.length)return!1;n.forEach(g=>{let w=String(g.dataset.groupId||"")===r;g.classList.toggle("is-active",w),g.setAttribute("aria-pressed",w?"true":"false")}),o.querySelectorAll(".oq-settings-info").forEach(g=>{let f=String(g.dataset.oqSettingsInfo||""),w=t.settingsInfoOpen===f;g.classList.toggle("is-open",w);let S=g.querySelector(".oq-settings-info-popover");S&&(S.hidden=!w);let q=g.querySelector(".oq-settings-info-button");q&&q.setAttribute("aria-expanded",w?"true":"false")}),o.querySelectorAll("[data-oq-settings-field]").forEach(g=>{let f=String(g.dataset.oqSettingsField||"");if(!f)return;let w=g.querySelector(".oq-settings-static-value");if(w){let k=O(f);w.textContent!==k&&(w.textContent=k)}g.querySelectorAll("select[data-oq-field]").forEach(k=>{let $=String(k.dataset.oqField||f),H=String(E($)||"");k.value!==H&&(k.value=H)}),g.querySelectorAll("input[data-oq-field]").forEach(k=>{let $=String(k.dataset.oqField||f),H=String(Ee($)||"");k.value!==H&&(k.value=H)});let S=g.querySelector(".oq-helper-slider-meta strong"),q=g.querySelector('input[type="range"][data-oq-field]');if(S&&q){let k=j(f,qe(f,E(f)));S.textContent!==k&&(S.textContent=k)}}),o.querySelectorAll("[data-select-key]").forEach(g=>{let f=String(g.dataset.selectKey||""),w=String(g.dataset.selectOption||""),S=String(E(f)||""),q=w===S;g.classList.toggle("is-active",q),g.setAttribute("aria-pressed",q?"true":"false"),f==="strategy"?g.disabled=t.loadingEntities||t.busyAction==="save-strategy":f==="hpGeneration"?g.disabled=t.loadingEntities||t.busyAction==="save-hpGeneration":f==="curveControlProfile"?g.disabled=t.loadingEntities||t.busyAction==="save-curveControlProfile":f==="phResponseProfile"&&(g.disabled=t.loadingEntities||t.busyAction==="save-phResponseProfile");let k=g.closest(".oq-settings-choice-card-shell");k&&k.classList.toggle("is-active",q)});let a=o.querySelector(".oq-settings-choice-card--static.oq-settings-choice-card--custom");if(a){let g=String(E("phResponseProfile")||"")==="Custom";a.classList.toggle("is-active",g),a.querySelectorAll("input[data-oq-field]").forEach(w=>{let S=String(w.dataset.oqField||""),q=String(Ee(S)||"");w.value!==q&&(w.value=q)})}o.querySelectorAll('[data-oq-action="toggle-overview-control"][data-control-key]').forEach(g=>{let f=String(g.dataset.controlKey||""),w=!!E(f),S=String(g.dataset.onLabel||"Aan"),q=String(g.dataset.offLabel||"Uit"),k=String(g.dataset.switchTitle||f),$=w?S:q;g.dataset.controlState=w?"off":"on",g.classList.toggle("is-on",w),g.setAttribute("aria-checked",w?"true":"false"),g.setAttribute("aria-label",`${k}: ${$}`),g.disabled=t.loadingEntities||t.busyAction===`switch-${f}`}),o.querySelectorAll("[data-oq-switch-pill]").forEach(g=>{let f=String(g.dataset.oqSwitchPill||""),w=!!E(f),S=String(g.dataset.onLabel||"Aan"),q=String(g.dataset.offLabel||"Uit"),k=w?S:q;g.classList.toggle("is-on",w),g.textContent!==k&&(g.textContent=k)}),o.querySelectorAll("[data-oq-switch-copy]").forEach(g=>{let f=String(g.dataset.oqSwitchCopy||""),w=!!E(f),S=String(g.dataset.onCopy||""),q=String(g.dataset.offCopy||""),k=w?S:q;g.hidden=!k,g.textContent!==k&&(g.textContent=k)});let i=o.querySelector('button[data-oq-action="open-generation-modal"]')?.closest(".oq-settings-quickstart-status");if(i){let g=i.querySelector(".oq-settings-quickstart-status-value"),f=i.querySelector(".oq-settings-quickstart-status-copy"),w=i.querySelector('button[data-oq-action="open-generation-modal"]'),S=rt(),q=t.entities.hpGeneration||{},k=h("hpGeneration")&&Jt(q).length>0;if(g){let $=S||"Onbekend";g.textContent!==$&&(g.textContent=$)}if(f){let $="Pas dit aan als je een andere Quatt Hybrid hebt.";f.textContent!==$&&(f.textContent=$)}w&&(w.disabled=!k||t.loadingEntities||t.busyAction==="save-hpGeneration")}let l=o.querySelector('button[data-oq-action="open-cm100-commissioning-modal"]')?.closest(".oq-settings-quickstart-status");if(l){let g=l.querySelector(".oq-settings-quickstart-status-value"),f=l.querySelector(".oq-settings-quickstart-status-copy"),w=l.querySelector('button[data-oq-action="open-cm100-commissioning-modal"]'),S=Tl(),q=x("cm100Active");g&&g.textContent!==S&&(g.textContent=S);let k=q?"CM100 is actief en klaar voor commissioning.":"Open de modal om CM100 te starten en de taken hieronder te ontgrendelen.";f&&f.textContent!==k&&(f.textContent=k),w&&(w.disabled=t.loadingEntities)}let p=o.querySelector('button[data-oq-action="reset"]')?.closest(".oq-settings-quickstart-status");if(p){let g=p.querySelector(".oq-settings-quickstart-status-value"),f=p.querySelector(".oq-settings-quickstart-status-copy"),w=p.querySelector('button[data-oq-action="reset"]'),S=t.complete===!0?"Afgerond":t.complete===!1?"Open":"Laden...",q=t.complete===!0?"Quick Start is afgerond. Je kunt de status hier altijd weer openen met een reset.":t.complete===!1?"Quick Start staat nog open. Gebruik de resetknop om opnieuw te beginnen.":"De status van Quick Start wordt nog geladen.";g&&g.textContent!==S&&(g.textContent=S),f&&f.textContent!==q&&(f.textContent=q),w&&(w.disabled=t.busyAction==="reset")}let u=o.querySelectorAll("[data-oq-access-security-item]");u.length&&u.forEach(g=>{let f=String(g.dataset.oqAccessSecurityItem||""),w=g.querySelector(".oq-settings-quickstart-status-value"),S=g.querySelector(".oq-settings-quickstart-status-copy"),q=g.querySelector("button[data-oq-action]");if(f==="login"){let k=jr(),$=Ur();w&&w.textContent!==k&&(w.textContent=k),S&&S.textContent!==$&&(S.textContent=$)}else if(f==="api"){let k=Xo(),$=er();w&&w.textContent!==k&&(w.textContent=k),S&&S.textContent!==$&&(S.textContent=$)}q&&(q.disabled=!1)});let c=o.querySelector(".oq-settings-system-summary");if(c){let g=c.querySelectorAll(".oq-settings-system-row"),f={uptime:jo(),ip:Uo(),updates:Vt(),datetime:Vn(),espTemp:ya(),restart:"Opnieuw opstarten"};g.forEach(q=>{let k=q.querySelector(".oq-settings-system-row-value"),$=q.dataset.oqDiagnosticsRow||"";if(k&&Object.prototype.hasOwnProperty.call(f,$)){let H=f[$];k.textContent!==H&&(k.textContent=H)}});let w=c.querySelector('button[data-oq-action="open-update-modal"]');w&&(w.disabled=!1);let S=c.querySelector('button[data-oq-action="open-restart-confirm"]');if(S){let q=t.busyAction==="restartAction";S.disabled=q,S.textContent=q?"Herstarten...":"Herstarten"}}o.querySelectorAll(".oq-settings-hp-offset-row").forEach(g=>{let f=String(g.dataset.oqSettingsField||""),w=String(g.dataset.oqHpOffsetRawKey||""),S=String(g.dataset.oqHpOffsetFinalKey||"");if(!f||!w||!S)return;let q=Ie(f),k=on(w,S,f),$=Te(Ee(f)),H=Number.isFinite(k)&&Number.isFinite($)?Xt(k+$,q.uom||"\xB0C",2):we(S,2),W=g.querySelector("[data-oq-hp-offset-active]");if(W){let I=`${we(S,2)} actief`;W.textContent!==I&&(W.textContent=I)}let B=g.querySelector("[data-oq-hp-offset-raw]");if(B){let I=Number.isFinite(k)?Xt(k,q.uom||"\xB0C",2):we(w,2);B.textContent!==I&&(B.textContent=I)}let M=g.querySelector("[data-oq-hp-offset-final]");M&&M.textContent!==H&&(M.textContent=H)});let m=o.querySelector(".oq-settings-curve-shell"),b=ae();if(!!m!==b)return!1;let y=!!a,v=String(E("phResponseProfile")||"")==="Custom";return y===v}function Lv(e){let o=Qt(e);return o==="Geen actieve storingen"?[]:o.split(",").map(r=>r.trim()).filter(r=>r&&!pp.has(r.toLowerCase()))}function ma(e){let o=Lv(e);return o.length>0?o.join(", "):"Geen actieve storingen"}function Am(e,o){let r=A(e),n=A(o),a=Number.isNaN(r)?"Lvl \u2014":`Lvl ${Math.round(r)}`,i=Number.isNaN(n)?"\u2014 Hz":`${Math.round(n)} Hz`;return`${a} (${i})`}function Dv(e){let o=String(e||"").trim().toUpperCase();return!o||o==="0"||o==="IDLE"||o==="CM100 READY"||o==="CM100 STOPPED"||o.includes("DONE")||o.includes("FAILED")||o.includes("ABORT")||o.includes("APPLIED")||o.includes("REFUSED")?!1:o.includes("REQUESTED")||o.includes("WAITING")||o.includes("WACHTEN")||o.includes("SETTLING")||o.includes("MEASUR")||o.includes("COOLDOWN")||o.includes("RUNNING")||o.includes("VALIDATING")||o.includes("STARTED")||o.includes("RECOVER")||o.includes("PHASE")||o.includes("STEADY")||o.includes("PULSE")||o.includes("STABILIZE")||o.includes("STEP")}function fe(e){let o=String(e||"").trim().toUpperCase();return o?o.includes("DONE")||o.includes("FAILED")||o.includes("ABORT")||o.includes("APPLIED")||o.includes("REFUSED"):!1}function Mo(e){let o=String(e||"").trim().toUpperCase();return o.includes("WAITING_FOR_CM100")||o.includes("CM100 REQUESTED")||o.includes("WACHTEN OP CM100")||o==="WACHTEN"}function yr(e){return Dv(e)&&!Mo(e)}function Va(e="",o=""){let r=String(e||"").trim().toUpperCase(),n=String(o||"").trim().toLowerCase(),a=r.split(/[^A-Z0-9]+/).filter(Boolean),i=c=>{let m=String(c||"").trim().toUpperCase();return m?r===m||r.startsWith(`${m}:`)||r.startsWith(`${m} `)||a.includes(m):!1},l={boiler:[{match:["REQUESTED","WAITING_FOR_CM100","REFUSED"],phase:"Voorbereiden",percent:12},{match:["FLOW_SETTLING"],phase:"Flow stabiliseren",percent:28},{match:["BOILER_SETTLING"],phase:"Boiler stabiliseren",percent:48},{match:["MEASURING"],phase:"Meten",percent:72},{match:["COOLDOWN"],phase:"Afronden",percent:90},{match:["DONE","APPLIED"],phase:"Klaar",percent:100},{match:["ABORTED","FAILED","ABORT"],phase:"Afgebroken",percent:100}],autotune:[{match:["REQUESTED","WAITING_FOR_CM100","REFUSED"],phase:"Voorbereiden",percent:10},{match:["WAITING_FOR_FLOW","SETTLING"],phase:"Flow stabiliseren",percent:26},{match:["STEP2"],phase:"Staptest 2",percent:56},{match:["STEP","STEP1"],phase:"Staptest 1",percent:42},{match:["VALIDATING_SETTLING"],phase:"Flow valideren",percent:70},{match:["VALIDATING"],phase:"Flow valideren",percent:84},{match:["RECOVERING"],phase:"Herstellen",percent:92},{match:["DONE","APPLIED"],phase:"Klaar",percent:100},{match:["ABORTED","FAILED","ABORT"],phase:"Afgebroken",percent:100}],purge:[{match:["REQUESTED","STARTED","REFUSED"],phase:"Voorbereiden",percent:8},{match:["PHASE1","STEADY"],phase:"Rustige doorstroming",percent:22},{match:["PHASE2","PULSE"],phase:"Pulsen",percent:62},{match:["PHASE3","STABILIZE"],phase:"Stabiliseren",percent:90},{match:["DONE"],phase:"Klaar",percent:100},{match:["ABORTED","FAILED","ABORT"],phase:"Afgebroken",percent:100}],"hp-water-calibration":[{match:["REQUESTED","STARTED","REFUSED"],phase:"Voorbereiden",percent:8},{match:["MIXING"],phase:"Water mengen",percent:42},{match:["MEASURING"],phase:"Sensoren meten",percent:78},{match:["DONE","APPLIED"],phase:"Klaar",percent:100},{match:["ABORTED","FAILED","ABORT"],phase:"Afgebroken",percent:100}],cm100:[{match:["REQUESTED"],phase:"Wachten op CM100",percent:0},{match:["WAITING_FOR_CM100"],phase:"Wachten op CM100",percent:0},{match:["CM100 READY"],phase:"Klaar",percent:100},{match:["IDLE"],phase:"Klaar",percent:100}]};if(!r||r==="\u2014"||r==="UNKNOWN"||r==="UNAVAILABLE"||r==="NAN")return{phase:"Wachten",percent:0};if(r.includes("WAITING")||r.includes("WACHTEN"))return{phase:"Wachten",percent:0};if(n!=="cm100"&&(r==="IDLE"||r==="CM0 - STANDBY"||r==="CM100 READY"||r==="CM100 STOPPED"||r==="GEPAUZEERD"))return{phase:"Wachten",percent:0};let u=(l[n]||[]).find(c=>c.match.some(m=>i(m)));return u||(r.includes("DONE")||r.includes("APPLIED")?{phase:"Klaar",percent:100}:r.includes("ABORT")||r.includes("FAILED")||r.includes("REFUSED")?{phase:"Afgebroken",percent:100}:n==="cm100"&&r.includes("CM100")?{phase:"Klaar",percent:100}:{phase:e,percent:0})}function vr({taskKey:e,title:o,copy:r,subcopy:n="",status:a,statusCopy:i,progressTask:l,actions:p="",controls:u="",metrics:c="",className:m=""}){return`
    ...
    `}function Fv({status:e,running:o,resultReady:r,startDisabled:n,abortDisabled:a,applyDisabled:i,busy:l,controlsAvailable:p}){let u=String(e||"").toUpperCase(),c=u.includes("FAILED")||u.includes("REFUSED")||u.includes("ABORT"),m=u.includes("APPLIED"),b=h("hp2WaterIn")||h("hp2WaterOut")||h("hp2WaterInRaw")||h("hp2WaterOutRaw"),y=A("hpWaterCalibrationStableProgress"),v=A("hpWaterCalibrationStableRequired"),g=A("hpWaterCalibrationRemaining"),f=Math.round(A("hpWaterCalibrationPhase")),w=o&&(f===1||u.includes("MIXING")),S=o&&!w,q=300,k=60,$=Number.isFinite(g)?Math.max(0,q-g):NaN,H=Number.isFinite($)?Math.max(0,k-$):NaN,W=w&&Number.isFinite($)?Math.max(0,Math.min(100,$/k*100)):S&&Number.isFinite(y)&&Number.isFinite(v)&&v>0?Math.max(0,Math.min(100,y/v*100)):o&&Number.isFinite(g)?Math.max(0,Math.min(100,100-g/q*100)):r?100:0,B=r&&h("hpWaterCalibrationResultSpreadBefore")?we("hpWaterCalibrationResultSpreadBefore",2):we("hpWaterCalibrationSpread",2),M=w?"Water mengen":Number.isFinite(y)&&Number.isFinite(v)&&v>0?y>0?`${Math.round(Math.max(0,y))} / ${Math.round(v)} s binnen grenzen`:"Nog niet binnen grenzen":"Wachten op stabiel venster",I=r?3:o?2:1,z=m?"Offsets toegepast":r?`Meting klaar - spreiding ${B}`:o?w?`Water mengen${Number.isFinite(H)&&H>0?` - meting start over ${Math.round(H)} s`:""}`:`Meting bezig - ${Number.isFinite(g)&&g>0?`max. ${Math.round(g)} s resterend`:M}`:c?"Meting niet voltooid":"Voorbereiding",re=m?"De voorgestelde offsets zijn opgeslagen.":r?"Controleer de voorgestelde offsets en pas ze toe.":o?w?"De waterpomp circuleert zonder compressor zodat de watertemperaturen eerst kunnen mengen.":"De firmware stopt zodra het laatste meetvenster binnen de spreiding- en driftgrenzen valt.":c?hr("hpWaterCalibrationStatus","Controleer de voorwaarden en start opnieuw."):b?"Start alleen wanneer compressor en boiler uit zijn. HP1 en HP2 water in/out worden samen naar een relatieve referentie gebracht.":"Start alleen wanneer compressor en boiler uit zijn. Bij single setup wordt HP1 water in/out onderling gelijkgetrokken; supply blijft diagnose.",ge=[{label:"HP1 water in",rawKey:"hp1WaterInRaw",liveKey:"hp1WaterIn",resultRawKey:"hpWaterCalibrationResultHp1InRawAvg",offsetKey:"hp1WaterInOffset",suggestedKey:"hp1WaterInOffsetSuggested"},{label:"HP1 water uit",rawKey:"hp1WaterOutRaw",liveKey:"hp1WaterOut",resultRawKey:"hpWaterCalibrationResultHp1OutRawAvg",offsetKey:"hp1WaterOutOffset",suggestedKey:"hp1WaterOutOffsetSuggested"},{label:"HP2 water in",rawKey:"hp2WaterInRaw",liveKey:"hp2WaterIn",resultRawKey:"hpWaterCalibrationResultHp2InRawAvg",offsetKey:"hp2WaterInOffset",suggestedKey:"hp2WaterInOffsetSuggested"},{label:"HP2 water uit",rawKey:"hp2WaterOutRaw",liveKey:"hp2WaterOut",resultRawKey:"hpWaterCalibrationResultHp2OutRawAvg",offsetKey:"hp2WaterOutOffset",suggestedKey:"hp2WaterOutOffsetSuggested"}].filter(N=>h(N.liveKey)||h(N.rawKey)||h(N.offsetKey)),Z=(N,F)=>{let T=I>N;return`
      ...
      `},L=N=>`
        <article class="oq-settings-hp-calibration-live-card">
          <span>${s(N.label)}</span>
          <strong>${s(we(N.liveKey,2))}</strong>
        </article>
      `,Y=N=>{let F=A(N.resultRawKey),T=Number.isFinite(F)?F:on(N.rawKey,N.liveKey,N.offsetKey),C=A(N.suggestedKey),P=Number.isFinite(T)&&Number.isFinite(C)?Xt(T+C,t.entities[N.suggestedKey]?.uom||"\xB0C",2):"\u2014";return`
        <tr>
          <th scope="row">${s(N.label)}</th>
          <td>${s(Number.isFinite(T)?Xt(T,t.entities[N.liveKey]?.uom||"\xB0C",2):"\u2014")}</td>
          <td>${s(we(N.offsetKey,2))}</td>
          <td><span class="oq-settings-hp-calibration-offset-pill">${s(we(N.suggestedKey,2))}</span></td>
          <td>${s(P)}</td>
        </tr>
      `};return`
      <div class="oq-settings-hp-calibration">
        ...
        ${o?`
          <div class="oq-settings-hp-calibration-live-grid">
            ...
            <article class="oq-settings-hp-calibration-live-card is-highlight">
              <span>Spreiding</span>
              <strong>${s(we("hpWaterCalibrationSpread",2))}</strong>
            </article>
            <article class="oq-settings-hp-calibration-live-card">
              <span>Supply verschil</span>
              <strong>${s(we("hpWaterCalibrationSupplyDelta",2))}</strong>
            </article>
          </div>
        ...
        ${r?`
          <div class="oq-settings-hp-calibration-results">
            <div class="oq-settings-hp-calibration-result-summary">
              <span>Referentie ${s(we("hpWaterCalibrationResultReference",2))}</span>
              <span>Supply verschil ${s(we("hpWaterCalibrationSupplyDelta",2))}</span>
            </div>
        ...
        ${p?`
          <div class="oq-settings-hp-calibration-actions" data-oq-hp-water-calibration-actions>
            ${Ho({active:o,startKey:"hpWaterCalibrationStart",stopKey:"hpWaterCalibrationAbort",startLabel:"Kalibratie starten",stopLabel:"Meting stoppen",startDisabled:l||n,stopDisabled:l||a})}
            ${t.entities.hpWaterCalibrationApply?_e("hpWaterCalibrationApply","Offsets toepassen","oq-helper-button oq-helper-button--primary",l||i):""}
          </div>
        `:""}
      </div>
    `}function Hm(){let e=h("boilerCvAssistEnabled")&&x("boilerCvAssistEnabled"),o=Tl(),r=x("cm100Active"),n=String(o||"").trim().toUpperCase(),a=Mo(o),i=!a&&(r||n==="CM100 READY"),l=t.commissioningTaskLock==="cm100",p=t.loadingEntities||t.busyAction==="commissioningCm100Start"||t.busyAction==="commissioningCm100Stop"||l,u=!!t.pendingCommissioningCm100Start,c=p||i||a,m=p||!i,b=Ao("boilerPowerTestStatus","IDLE"),y=Va(b,"boiler"),v=x("boilerPowerTestActive"),g=t.loadingEntities||t.busyAction==="boilerPowerTestStart"||t.busyAction==="boilerPowerTestAbort"||t.busyAction==="boilerPowerTestApply",f=!!(t.entities.boilerPowerTestStart||t.entities.boilerPowerTestAbort||t.entities.boilerPowerTestApply),w=!!t.pendingBoilerPowerTestStart,S=t.commissioningTaskLock==="boiler",q=Mo(b),$=!fe(b)&&(v||w||S||yr(b))&&!q,H=Se("boilerRatedHeatPower"),W=Se("boilerHeatPower"),B=A("boilerHeatPower"),M=B>0?W:$&&t.commissioningBoilerHeatPowerDisplay?t.commissioningBoilerHeatPowerDisplay:W;B>0&&(t.commissioningBoilerHeatPowerDisplay=W);let I=Ao("flowAutotuneStatus","IDLE"),z=Va(I,"autotune"),re=t.loadingEntities||t.busyAction==="flowAutotuneStart"||t.busyAction==="flowAutotuneAbort"||t.busyAction==="flowAutotuneApply",ge=!!(t.entities.flowAutotuneStart||t.entities.flowAutotuneAbort||t.entities.flowAutotuneApply),Z=!!t.pendingFlowAutotuneStart,L=t.commissioningTaskLock==="autotune",Y=Mo(I),F=!fe(I)&&(Z||L||yr(I))&&!Y,T=Ao("airPurgeStatus","IDLE"),C=Va(T,"purge"),P=x("airPurgeActive"),V=t.loadingEntities||t.busyAction==="airPurgeStart"||t.busyAction==="airPurgeAbort",Q=!!(t.entities.airPurgeStart||t.entities.airPurgeAbort),J=!!t.pendingAirPurgeStart,X=t.commissioningTaskLock==="purge",ne=!fe(T)&&(P||J||X||yr(T)),Le=/DONE/.test(String(T||"").toUpperCase()),xe=!!(Q||t.entities.airPurgeStatus||t.entities.airPurgeReturnToAuto),No=Se("airPurgeRemaining",{decimals:0}),Nt=A("airPurgePhase"),Sr=Nt===1?"Rustig":Nt===2?"Pulsen":Nt===3?"Stabiliseren":C.phase,Je=Ao("manualFlowStatus","IDLE"),bt=x("manualFlowActive"),$e=t.loadingEntities||t.busyAction==="manualFlowStart"||t.busyAction==="manualFlowAbort",ce=!!(t.entities.manualFlowStart||t.entities.manualFlowAbort),yt=!!t.pendingManualFlowStart,se=t.commissioningTaskLock==="manual-flow",De=!fe(Je)&&(bt||yt||se||yr(Je)),vt=Ao("manualHpStatus","IDLE"),Oo=x("manualHpActive"),ao=t.loadingEntities||t.busyAction==="manualHpStart"||t.busyAction==="manualHpAbort",qn=!!(t.entities.manualHpStart||t.entities.manualHpAbort),Lo=!!t.pendingManualHpStart,lt=t.commissioningTaskLock==="manual-hp",We=!fe(vt)&&(Oo||Lo||lt||yr(vt)),Tn=/SAFETY STOP/.test(String(vt||"").toUpperCase()),En=/STOPPING/.test(String(vt||"").toUpperCase()),ct=Ao("hpWaterCalibrationStatus","IDLE"),ei=Va(ct,"hp-water-calibration"),kn=x("hpWaterCalibrationActive"),Do=t.loadingEntities||t.busyAction==="hpWaterCalibrationStart"||t.busyAction==="hpWaterCalibrationAbort"||t.busyAction==="hpWaterCalibrationApply",Fl=!!(t.entities.hpWaterCalibrationStart||t.entities.hpWaterCalibrationAbort||t.entities.hpWaterCalibrationApply),Cn=!!t.pendingHpWaterCalibrationStart,Ot=t.commissioningTaskLock==="hp-water-calibration",Fe=!fe(ct)&&(kn||Cn||Ot||yr(ct)),xn=/DONE|APPLIED/.test(String(ct||"").toUpperCase()),Il=/APPLIED/.test(String(ct||"").toUpperCase()),Tg=Se("flowKpSuggested",{decimals:5,trimTrailingZeros:!0}),Eg=Se("flowKiSuggested",{decimals:5,trimTrailingZeros:!0}),_l=/DONE|APPLIED/.test(String(b||"").toUpperCase()),Wl=/DONE|APPLIED/.test(String(I||"").toUpperCase()),ti=i?q?"Wachten op CM100":$?y.phase:_l?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",oi=i?Y?"Wachten op CM100":F?z.phase:Wl?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",ri=i?ne?C.phase:Le?"Klaar":"Klaar om te starten":"Wachten op CM100",Vl=i?De?"Actief":"Klaar om te starten":"Wachten op CM100",Bl=i?We?En?"Bezig met stoppen":Tn?"Veiligheidsstop":"Actief":"Klaar om te starten":"Wachten op CM100",Kl=i?Fe?ei.phase:Il?"Offsets toegepast":xn?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",jl=!i||g||!f||F||ne||De||We||Fe||$||L||X||se||lt||Ot||w,kg=g||!($||S||w),Cg=g||jl||!_l||F||ne||Fe,Ul=!i||re||!ge||$||ne||De||We||Fe||F||S||X||se||lt||Ot||Z,xg=re||!(F||L||Z),$g=re||Ul||!Wl||$||ne||Fe,Ag=!i||V||!Q||$||F||De||We||Fe||ne||S||L||se||lt||Ot||J,Hg=V||!(ne||X||J),Mg=!i||$e||!ce||$||F||ne||We||Fe||De||S||L||X||lt||Ot||yt,Rg=$e||!(De||se||yt),Pg=!i||ao||!qn||$||F||ne||De||Fe||We||S||L||X||se||Ot||Lo,Ng=ao||!(We||lt||Lo),Og=!i||Do||!Fl||$||F||ne||De||We||Fe||S||L||X||se||lt||Cn,Lg=Do||!(Fe||Ot||Cn),Dg=Do||Fe||!xn||Il;u&&i&&(t.pendingCommissioningCm100Start=!1),l&&(i||/READY|STOPPED|DONE|FAILED|ABORT|APPLIED|REFUSED/.test(n))&&(t.commissioningTaskLock=""),w&&(v||fe(b))&&(t.pendingBoilerPowerTestStart=!1),S&&fe(b)&&(t.commissioningTaskLock=""),Z&&fe(I)&&(t.pendingFlowAutotuneStart=!1),L&&fe(I)&&(t.commissioningTaskLock=""),J&&(P||fe(T))&&(t.pendingAirPurgeStart=!1),X&&fe(T)&&(t.commissioningTaskLock=""),yt&&(bt||fe(Je))&&(t.pendingManualFlowStart=!1),se&&(bt||fe(Je))&&(t.commissioningTaskLock=""),Lo&&(Oo||fe(vt))&&(t.pendingManualHpStart=!1),lt&&(Oo||fe(vt))&&(t.commissioningTaskLock=""),Cn&&(kn||fe(ct))&&(t.pendingHpWaterCalibrationStart=!1),Ot&&fe(ct)&&(t.commissioningTaskLock="");let Fg=a?"Wachten op CM100":o,Ig=a?"Service-stand wordt geopend. Wacht tot CM100 klaar staat.":i?"CM100 is actief en klaar voor service-taken.":"Start de service-stand voordat je een taak uitvoert.",_g=[{key:"hp-water-calibration",title:"Temperatuursensoren kalibreren",label:"Sensor kalibratie",summary:"Laat de waterpomp draaien zonder compressor en bepaal offsets voor HP1/HP2 water in/out.",status:Kl,available:!!(Fl||t.entities.hpWaterCalibrationStatus),openDisabled:!i,cardMarkup:vr({taskKey:"hp-water-calibration",title:"Temperatuursensoren kalibreren",copy:"Doorloop voorbereiding, meting en toepassen in vaste volgorde. De meting stopt eerder zodra de sensoren stabiel genoeg zijn.",subcopy:"De voorgestelde waarden worden pas actief wanneer je ze toepast; supply blijft een diagnosewaarde.",status:Kl,statusCopy:Fe?"De pomp draait en de firmware wacht op een stabiel temperatuurbeeld.":xn?"Controleer de voorgestelde offsets voordat je ze toepast.":i?"CM100 staat klaar. Start de meting wanneer compressor en boiler uit zijn.":"Start CM100 eerst.",progressTask:"hp-water-calibration",controls:Fv({status:ct,running:Fe,resultReady:xn,startDisabled:Og,abortDisabled:Lg,applyDisabled:Dg,busy:Do,controlsAvailable:!!(t.entities.hpWaterCalibrationStart||t.entities.hpWaterCalibrationAbort)}),className:"oq-settings-commissioning-card--hp-water-calibration"})},{key:"manual-flow",title:"Handmatige flowregeling",label:"Handmatige flow",summary:"Laat de waterpomp draaien op een tijdelijk flow-setpoint en luister naar het leidingwerk.",status:Vl,available:!!(ce||t.entities.manualFlowStatus),openDisabled:!i,cardMarkup:vr({taskKey:"manual-flow",title:"Handmatige flowregeling",copy:"Gebruik een tijdelijk flow-setpoint om het leidingwerk rustig te controleren. De normale instellingen wijzigen pas wanneer je een waarde bewust overneemt.",subcopy:"De bestaande PI-regeling blijft de pomp aansturen.",status:Vl,statusCopy:De?"De waterpomp draait. Pas het tijdelijke setpoint aan en controleer de gemeten flow.":i?"CM100 staat klaar. Kies een tijdelijk setpoint en start de waterpomp.":"Start CM100 eerst.",progressTask:"",controls:`
            <div class="oq-settings-manual-flow-control">
              ...
              ${t.entities.manualFlowStart||t.entities.manualFlowAbort?Ho({active:De,startKey:"manualFlowStart",stopKey:"manualFlowAbort",startLabel:"Waterpomp starten",stopLabel:"Waterpomp stoppen",startDisabled:$e||Mg,stopDisabled:$e||Rg}):""}
            </div>
          `,metrics:`
            <p class="oq-settings-manual-flow-results-title">Resultaten</p>
            ${Ce("flowSelected","Gemeten flow","Actuele doorstroming in het watercircuit.",Se("flowSelected"),"oq-settings-field--compact")}
            ${Ce("manualFlowTargetIpwm","Actuele pompstand","Door de PI-regeling aangevraagde pompstand.",Se("manualFlowTargetIpwm"),"oq-settings-field--compact")}
          `}),modalActions:`
          ${t.entities.manualFlowApplyHeating?_e("manualFlowApplyHeating","Overnemen voor verwarmen","oq-helper-button oq-helper-button--ghost",$e):""}
          ${t.entities.manualFlowApplyCooling?_e("manualFlowApplyCooling","Overnemen voor koelen","oq-helper-button oq-helper-button--ghost",$e):""}
        `},{key:"manual-hp",title:"Handmatige warmtepompbediening",label:"Handmatige warmtepomp",summary:"Selecteer een werkmodus en vraag per warmtepomp een compressorstand aan binnen de bestaande bewaking.",status:Bl,available:!!(qn||t.entities.manualHpStatus),openDisabled:!i,cardMarkup:vr({taskKey:"manual-hp",title:"Handmatige warmtepompbediening",copy:"Start eerst de service-taak zodat de waterpomp draait. Zodra voldoende flow is gemeten kun je per warmtepomp vanuit Standby naar verwarmen of koelen schakelen en daarna een compressorstand aanvragen.",subcopy:"Low-flow, maximale watertemperatuur, minimum draaitijd, minimum uit-tijd en veilige modusovergangen blijven actief. De koelvloer, silent-modus, dag/nacht-cap en normaal uitgesloten compressorstanden worden voor deze handmatige test bewust genegeerd.",status:Bl,statusCopy:We?En?"De compressorvraag staat op 0. De waterpomp blijft draaien totdat de minimale draaitijd veilig is afgerond.":Tn?"De bewaking heeft de aangevraagde standen teruggezet naar 0. Controleer de oorzaak voordat je opnieuw opschaalt.":"De service-taak is actief. Een veiligheidsstop zet de aangevraagde standen terug naar 0; opnieuw opschalen vereist een bewuste handeling.":i?"CM100 staat klaar. Start de taak om handmatige warmtepompbediening vrij te geven.":"Start CM100 eerst.",progressTask:"",actions:`
            ${t.entities.manualHpStart||t.entities.manualHpAbort?Ho({active:We,startKey:"manualHpStart",stopKey:"manualHpAbort",startLabel:"Bediening starten",stopLabel:"Bediening stoppen",startDisabled:ao||Pg,stopDisabled:ao||Ng}):""}
          `,controls:`
            <div class="oq-settings-manual-hp-controls">
              <div class="oq-settings-manual-hp-unit">
                ${Ut("manualHp1Mode","Warmtepomp 1 werkmodus","Start in Standby. Verwarmen of koelen kan pas worden gekozen zodra voldoende flow is gemeten.","oq-settings-field--compact")}
              ...
              ${h("hp2ExcludedA")?`
                <div class="oq-settings-manual-hp-unit">
                  ${Ut("manualHp2Mode","Warmtepomp 2 werkmodus","Start in Standby. Verwarmen of koelen kan pas worden gekozen zodra voldoende flow is gemeten.","oq-settings-field--compact")}
          ...
          `,metrics:`
            ...
            <div class="oq-settings-manual-hp-results">
              ${Ce("flowSelected","Gemeten flow","Actuele doorstroming in het watercircuit.",Se("flowSelected"),"oq-settings-field--compact")}
              ${Ce("hp1Compressor","Warmtepomp 1 actueel","Door de actuator werkelijk toegepaste compressorstand en gemeten compressorfrequentie.",Am("hp1Compressor","hp1Freq"),"oq-settings-field--compact")}
              ${h("hp2Compressor")?Ce("hp2Compressor","Warmtepomp 2 actueel","Door de actuator werkelijk toegepaste compressorstand en gemeten compressorfrequentie.",Am("hp2Compressor","hp2Freq"),"oq-settings-field--compact"):""}
            </div>
            ...
            <div class="oq-settings-manual-hp-statuses">
              ${Ce("hp1Failures","Warmtepomp 1 statusmelding","Actuele melding die de warmtepomp zelf rapporteert.",Qt(O("hp1Failures","None")),"oq-settings-field--compact")}
              ${h("hp2Failures")?Ce("hp2Failures","Warmtepomp 2 statusmelding","Actuele melding die de warmtepomp zelf rapporteert.",Qt(O("hp2Failures","None")),"oq-settings-field--compact"):""}
            </div>
          `})},{key:"autotune",title:"Flow autotune",label:"Autotune",summary:"Berekent een voorstel voor de flowregeling en kan Kp/Ki daarna toepassen.",status:oi,available:!0,openDisabled:Mo(oi),cardMarkup:vr({taskKey:"autotune",title:"Flow autotune",copy:"Bereken een voorstel voor de flowregeling en pas dat daarna toe in de installatie-instellingen. Autotune duurt meestal ongeveer 5 tot 10 minuten.",subcopy:"Na toepassen worden de flow-instellingen bijgewerkt.",status:oi,statusCopy:Y?"Wacht totdat CM100 actief is voordat je autotune start.":F?"Autotune draait op dit moment.":i?"CM100 staat klaar. Start de autotune wanneer je wilt.":"Start CM100 eerst en voer daarna autotune uit.",progressTask:"autotune",actions:`
            ${t.entities.flowAutotuneStart||t.entities.flowAutotuneAbort?Ho({active:F,startKey:"flowAutotuneStart",stopKey:"flowAutotuneAbort",startLabel:"Autotune starten",stopLabel:"Autotune stoppen",startDisabled:re||Ul,stopDisabled:re||xg}):""}
            ${t.entities.flowAutotuneApply?_e("flowAutotuneApply","Toepassen","oq-helper-button oq-helper-button--ghost",re||$g):""}
          `,metrics:`
            ${Ce("flowKpSuggested","Voorgestelde Kp","Kp bepaalt hoe sterk de regeling meteen corrigeert.",Tg,"oq-settings-field--compact")}
            ${Ce("flowKiSuggested","Voorgestelde Ki","Ki corrigeert kleine afwijkingen langzaam weg.",Eg,"oq-settings-field--compact")}
          `})},{key:"boiler",title:"Boiler power test",label:"Boiler test",summary:"Meet het effectieve boilervermogen bij stabiele flow en kan het resultaat toepassen.",status:ti,available:e,openDisabled:Mo(ti),cardMarkup:vr({taskKey:"boiler",title:"Boiler power test",copy:"Meet het effectieve boilervermogen bij stabiele flow en schrijf daarna een afgerond voorstel weg naar de boilerinstelling. Boilertest duurt meestal ongeveer 5 tot 10 minuten.",subcopy:`Ingesteld boilervermogen: ${s(H)}`,status:ti,statusCopy:q?"Wacht totdat CM100 actief is voordat je de boiler-test start.":$?"De boiler-test draait op dit moment.":i?"CM100 staat klaar. Start de boiler-test wanneer je wilt.":"Start CM100 eerst en voer daarna de boilervermogentest uit.",progressTask:"boiler",actions:`
            ${t.entities.boilerPowerTestStart||t.entities.boilerPowerTestAbort?Ho({active:$,startKey:"boilerPowerTestStart",stopKey:"boilerPowerTestAbort",startLabel:"Boiler test starten",stopLabel:"Boiler test stoppen",startDisabled:g||jl,stopDisabled:g||kg}):""}
            ${t.entities.boilerPowerTestApply?_e("boilerPowerTestApply","Toepassen","oq-helper-button oq-helper-button--ghost",g||Cg):""}
          `,metrics:`
            ${Ce("boilerHeatPower","Actueel vermogen","Live meting tijdens de boiler-test.",M)}
            ${Ce("boilerPowerTestResult","Gemeten testresultaat","Afgerond resultaat van de laatste boiler-test.",Se("boilerPowerTestResult"))}
          `})},{key:"purge",title:"Ontluchten",label:"Ontluchten",summary:"Draait een vaste ontluchtingsrun van 5 minuten met rustige flow, pomp-pulsen en stabilisatie.",status:ri,available:xe,openDisabled:Mo(ri),cardMarkup:vr({taskKey:"purge",title:"Ontluchten",copy:"Draait 5 minuten met rustige doorstroming, korte pomp-pulsen en een stabilisatiefase.",subcopy:"Na afloop kan OpenQuatt de service mode (CM100) afsluiten of actief laten.",status:ri,statusCopy:ne?"Ontluchten loopt vast 5 minuten door en stopt daarna automatisch.":i?"CM100 staat klaar. Start ontluchten wanneer het circuit open staat.":"Start CM100 eerst en voer daarna ontluchten uit.",progressTask:"purge",className:"oq-settings-commissioning-card--air-purge",actions:`
            ${t.entities.airPurgeStart||t.entities.airPurgeAbort?Ho({active:ne,startKey:"airPurgeStart",stopKey:"airPurgeAbort",startLabel:"Ontluchten starten",stopLabel:"Ontluchten stoppen",startDisabled:V||Ag,stopDisabled:V||Hg}):""}
          `,metrics:`
            ${Ce("airPurgeRemaining","Resterende tijd","Ontluchten loopt maximaal 5 minuten.",No,"oq-settings-field--compact")}
            ${Ce("airPurgePhase","Fase","Laat zien welk deel van het ontluchten nu actief is.",Sr,"oq-settings-field--compact")}
            ${Ce("flowSelected","Actuele flow","Gemeten flow tijdens het ontluchten.",Se("flowSelected"),"oq-settings-field--compact")}
            ${Em("airPurgeReturnToAuto","Na afloop","","Service mode (CM100) afsluiten","oq-settings-field--span-2 oq-settings-field--compact")}
          `})}].filter(Wg=>Wg.available);return{cm100Status:Fg,cm100StartDisabled:c,cm100StopDisabled:m,serviceStatusCopy:Ig,tasks:_g}}function Iv(e){return`
    ...
    `}function $m(){let e=Hm();return te("Service","Service & commissioning","Gebruik de service-stand (controlmode CM100) voor testen, afstelling en onderhoudstaken.",`
        <div class="oq-settings-service-shell">
          <div class="oq-settings-service-toolbar">
            ...
            <div class="oq-settings-commissioning-hero-actions oq-settings-service-toolbar-actions">
              ${t.entities.commissioningCm100Start?_e("commissioningCm100Start","Service starten","oq-helper-button oq-helper-button--primary",e.cm100StartDisabled):""}
              ${t.entities.commissioningCm100Stop?_e("commissioningCm100Stop","Service stoppen","oq-helper-button oq-helper-button--ghost",e.cm100StopDisabled):""}
            </div>
          </div>

          <div class="oq-settings-system-summary oq-settings-service-task-list">
            ${e.tasks.map(o=>Iv(o)).join("")}
          </div>
        </div>
      `)}function Mm(){let e=String(t.systemModal||"").replace(/^service-task-/,""),r=Hm().tasks.find(n=>n.key===e);return r?`
      <div class="oq-helper-modal-backdrop${t.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
    ...
    `:""}function yn(){return[t.interfacePanelOpen?"open":"closed",t.nativeOpen?"native":"app",t.appView,t.complete?"complete":"incomplete",t.overviewTheme,t.hpVisualMode,K("installationTopology"),K("hardwareProfileText"),K("connectionText"),t.firmwareAdvancedOpen?"firmware-advanced-open":"firmware-advanced-closed",t.firmwareConnectionSwitchOpen?"connection-open":"connection-closed",t.firmwareTopologySwitchOpen?"topology-open":"topology-closed",t.updateManualUploadOpen?"upload-open":"upload-closed",t.updateTestFirmwareOpen?"test-open":"test-closed",t.updateTestFirmwareError,K("hpGeneration"),K("projectVersionText"),K("releaseChannelText"),El()].join("|")}function El(){let e=Math.max(Number(t.lastEntityResponseAt||0),Number(t.lastEntitySyncAt||0)),o=Number(t.deviceReconnectStartedAt||0);return t.entitySyncFailureCount>0&&!t.deviceReconnectMode?"Bezig":e>0&&(!t.deviceReconnectMode||e>=o)?"Verbonden":t.deviceReconnectMode?Kt()?"Verbonden":t.deviceReconnectMode==="reconnect"?"Offline":"Bezig":h("status")&&!x("status")?"Offline":"Bezig"}function kl(){return String(E("projectVersionText")||"").trim()||"\u2014"}function _v(){let e=kl();return e&&e!=="\u2014"?e:Vt()}function ya(){let e=t.entities.espInternalTemp;if(!e)return"\u2014";let o=A("espInternalTemp");return Number.isNaN(o)?O("espInternalTemp"):_(o,1,e.uom||" \xB0C")}function Wv(){let e=[["Netwerkstatus",El()],["IP-adres",Uo()]],o=String(E("wifiSsid")||"").trim();o&&e.push(["WiFi SSID",o]);let r=t.entities.wifiSignal;if(r){let n=A("wifiSignal");Number.isNaN(n)||e.push(["WiFi signaal",_(n,0,r.uom||" dBm")])}return e}function Rm(e){return e==="version"?"open-update-modal":e==="connectivity"?"open-connectivity-modal":e==="debugRecording"?"open-debug-recording-modal":e==="webserverLog"?"open-webserver-log-modal":e==="login"?"open-login-modal":""}function Pm(){return[["installation","Installatie",rt()],["uptime","Uptime",jo()],["connectivity","Connectiviteit",El()],["time","Tijd",Mi()],["version","Versie",_v(),!!me()],["debugRecording","Debugopname",_m(),!0],["webserverLog","Logboek",Kn(),!0]]}function Nm(){return yo()}function Om(e){return e==="version"&&Nm()}function bn(){return`
      <div class="oq-helper-status-grid">
        ${Pm().map(([o,r,n,a])=>{let i=Rm(o),l=!!(a||i),p=Om(o);return`
          <${l?"button":"div"}
    ...
    `}function Ba(){if(!t.root)return!1;let e=t.root.querySelector(".oq-helper-status-grid");if(!e)return!!t.root.querySelector(".oq-helper-hub");let o=Pm();if(e.querySelectorAll("[data-oq-header-status]").length!==o.length)return e.outerHTML=bn(),!0;for(let[n,a,i,l]of o){let p=e.querySelector(`[data-oq-header-status="${n}"]`);if(!p)return e.outerHTML=bn(),!0;let u=Rm(n),c=!!(l||u);if(p.tagName.toLowerCase()!==(c?"button":"div"))return e.outerHTML=bn(),!0;let m=p.querySelector(".oq-helper-status-label"),b=p.querySelector(".oq-helper-status-value");if(!m||!b)return e.outerHTML=bn(),!0;m.textContent!==a&&(m.textContent=a);let y=Om(n),v=y?`<span class="oq-helper-status-value-text">${s(i)}</span><span class="oq-helper-status-badge" aria-label="Update beschikbaar" title="Update beschikbaar"></span>`:s(i);b.innerHTML!==v&&(b.innerHTML=v),c?p.setAttribute("data-oq-action",u):p.removeAttribute("data-oq-action"),p.classList.toggle("oq-helper-status-item--button",c),p.classList.toggle("oq-helper-status-item--attention",y)}return!0}function Vv(){let e=typeof window<"u"?window.__OQ_DEV_CONTROLS__:null;return!e||typeof e.render!="function"?"":e.render()}function Cl(){let e=Vv();return e?t.devPanelOpen?`
    ...
    `:`
      ...
      `:""}function Lm(){let e=t.nativeOpen?"native":"app",o=Nm();return t.interfacePanelOpen?`
    ...
    `:`
        <aside class="oq-helper-hub oq-helper-hub--collapsed" aria-label="Weergave en systeem">
          <div class="oq-helper-hub-head-actions">
            ...
            >${Xe("more-horizontal","oq-helper-hub-toggle-icon")}${o?'<span class="oq-helper-hub-toggle-dot" aria-hidden="true"></span>':""}</button>
          </div>
        </aside>
      `}function Dm(){if(!t.root)return;if(t.interfacePanelOpen){t.root.querySelector(".oq-debug-recording-header-status")?.remove(),Ba();return}let e=t.root.querySelector(".oq-helper-hub--collapsed .oq-helper-hub-head-actions");if(!e)return;let o=e.querySelector(".oq-debug-recording-header-status"),r=xl();if(!r){o?.remove();return}if(o){o.outerHTML=r;return}e.insertAdjacentHTML("afterbegin",r)}function Fm(){let e=t.nativeOpen?"native":"app",o=t.nativeFrontendLoading?"ESPHome fallback wordt geladen. Daarna blijft alleen de native webinterface actief.":"De OpenQuatt-app is tijdelijk uitgeschakeld, zodat de ESPHome fallback zelfstandig en zonder extra interfacebelasting kan draaien.",r=t.controlError?`<p class="oq-native-surface-note oq-native-surface-note--error">${s(t.controlError)}</p>`:"";return`
    ...
    `}function Im(){if(t.systemModal==="login")return cu();if(t.systemModal==="api-security")return lu();if(t.systemModal==="mqtt")return au();if(t.systemModal==="mqtt-sensors")return iu();if(t.systemModal==="connectivity"){let e=Wv();return`
        <div class="oq-helper-modal-backdrop${t.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
      ...
      `}if(t.systemModal==="settings-backup-restore")return Tm();if(t.systemModal==="settings-backup-import")return qm();if(t.systemModal==="history-storage")return wm();if(String(t.systemModal||"").startsWith("service-task-"))return Mm();if(t.systemModal==="settings-backup-success"){let e=t.controlNotice||"Backup hersteld.";return`
        <div class="oq-helper-modal-backdrop${t.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
      ...
      `;if(t.systemModal==="webserver-logs")return jc();if(t.systemModal==="debug-recording")return Wm();if(t.systemModal==="openquatt-pause"){let e=x("openquattEnabled"),o=t.busyAction==="openquatt-regulation",r=h("openquattResumeAt"),n=t.loadingEntities||t.entitySyncInFlight,a=r||!n,i=Pr(),l=Vo(E("openquattResumeAt")),p=Fn();return`
        <div class="oq-helper-modal-backdrop${t.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
      ...
      `}return""}function ht(){return t.debugRecordingDeviceStatus?Math.max(0,Number(t.debugRecordingDeviceStatus.sample_count||0)):Array.isArray(t.debugRecordingSamples)?t.debugRecordingSamples.length:0}function ft(e=t.debugRecordingDeviceStatus){return e?.rolling===!0||String(e?.mode||"").toLowerCase()==="rolling"}function ja(e=t.debugRecordingDeviceStatus){return ft(e)&&e?.frozen===!0&&!e?.active}function Ro(e){let o=Math.max(0,Math.round(Number(e||0)/1e3)),r=Math.floor(o/3600),n=Math.floor(o%3600/60),a=o%60;return r>0?`${r}u ${String(n).padStart(2,"0")}m`:n>0?`${n}m ${String(a).padStart(2,"0")}s`:`${a}s`}function Bm(){return t.debugRecordingDeviceStatus?Math.max(0,Number(t.debugRecordingDeviceStatus.retained_duration_s||0)*1e3):Km()}function Km(){if(t.debugRecordingDeviceStatus)return Math.max(0,Number(t.debugRecordingDeviceStatus.elapsed_s||0)*1e3);if(!t.debugRecordingStartedAt)return 0;let e=t.debugRecordingActive?Date.now():Number(t.debugRecordingLastSampleAt||Date.now());return Math.max(0,e-Number(t.debugRecordingStartedAt||e))}function tn(){return t.debugRecordingDeviceStatus&&t.debugRecordingDeviceStatus.available===!1?"Niet beschikbaar":ja()?"Rolling gestopt":t.debugRecordingActive&&ft()?"Rolling actief":t.debugRecordingActive?"Bezig met opnemen":ht()>0?"Voltooid":"Niet gestart"}function va(){return ja()?"Rolling debug is gestopt. De recente samples blijven bewaard tot je downloadt, kopieert, hervat of een nieuwe opname start.":t.debugRecordingActive&&ft()?"Rolling debug bewaart continu de recente samples. Download of kopieer maakt een momentopname; rolling blijft daarna doorlopen.":t.debugRecordingActive?"De opname loopt in apparaatgeheugen. Je kunt deze pagina sluiten en later het bestand downloaden.":ht()>0?"De opname is klaar. Download het supportbestand en voeg dit toe aan je supportverzoek.":t.debugRecordingDeviceStatus&&t.debugRecordingDeviceStatus.available===!1?"Debugopname in apparaatgeheugen is niet beschikbaar op deze firmware.":"Neem tijdelijk supportgegevens op voor analyse. De opname wordt lokaal in het apparaatgeheugen opgeslagen. Er wordt niets automatisch verzonden."}function _m(){return ja()?"Gestopt":t.debugRecordingActive&&ft()?`Rolling \xB7 ${Ro(Bm())}`:t.debugRecordingActive?`Loopt \xB7 ${Ro(jm())}`:ht()>0?"Klaar":tn()}function Bv(){let e=Number(t.debugRecordingSelectedMinutes||15);return On.map(r=>Number(r.minutes)).includes(e)?e:Number(On[0]?.minutes||15)}function em(e){t.debugRecordingActive||(t.debugRecordingSelectedMinutes=Math.max(1,Number(e)||15),t.debugRecordingNotice="",t.debugRecordingError="",d())}function jm(){return ft()?0:t.debugRecordingDeviceStatus?Math.max(0,Number(t.debugRecordingDeviceStatus.remaining_s||0)*1e3):t.debugRecordingActive?Math.max(0,Number(t.debugRecordingEndsAt||0)-Date.now()):0}function Kv(){if(t.debugRecordingDeviceStatus){if(ft()){let a=Math.max(1,Number(t.debugRecordingDeviceStatus.sample_capacity||0));return Math.max(0,Math.min(100,ht()/a*100))}let r=Math.max(1,Number(t.debugRecordingDeviceStatus.duration_s||0)),n=Math.max(0,Number(t.debugRecordingDeviceStatus.elapsed_s||0));return!t.debugRecordingActive&&ht()>0?100:Math.max(0,Math.min(100,n/r*100))}if(!t.debugRecordingActive||!t.debugRecordingStartedAt||!t.debugRecordingEndsAt)return ht()>0?100:0;let e=Math.max(1,Number(t.debugRecordingEndsAt)-Number(t.debugRecordingStartedAt)),o=Math.max(0,Date.now()-Number(t.debugRecordingStartedAt));return Math.max(0,Math.min(100,o/e*100))}function Um(e=t.debugRecordingDeviceStatus){return String(e?.recording_id??e?.recording?.recording_id??"").trim()}function Gm(e){if(e?.recording?.active)return;let o=Um(e);if(o){t.debugRecordingAcknowledgedId=o;try{window.localStorage.setItem("oq-debug-recording-acknowledged-id",o)}catch{}}}function xl(){let e=t.debugRecordingDeviceStatus,o=Math.max(0,Number(e?.sample_count||0));if(!e||e.available===!1||!e.active&&o===0)return"";let r=!!e.active;if(!r&&Um(e)===t.debugRecordingAcknowledgedId)return"";let n=ft(e),a=Ro(Math.max(0,Number(e.retained_duration_s||0))*1e3),i=Ro(Math.max(0,Number(e.remaining_s||0))*1e3),l=r?n?`Rolling debug \xB7 ${a}`:`Debug loopt \xB7 ${i}`:n?"Rolling gestopt":"Debug klaar",p=r?n?`Rolling debug loopt, laatste ${a} beschikbaar`:`Debugopname loopt, nog ${i}`:n?"Rolling debug gestopt; recente buffer klaar om te downloaden":"Debugopname klaar om te downloaden";return`
    <button
  ...
  `}function jv(){if(!t.root)return;let e=t.root.querySelector('[data-oq-diagnostics-row="debugRecording"]');if(!e)return;let o=e.querySelector(".oq-settings-system-row-value"),r=e.querySelector(".oq-settings-system-row-note");o&&(o.textContent=tn()),r&&(r.textContent=va())}function $l(e){let o={activity:'<svg viewBox="0 0 24 24" focusable="false"><path d="M3 12h4l2-7 4 14 2-7h6"/></svg>',status:'<svg viewBox="0 0 24 24" focusable="false"><circle cx="12" cy="12" r="4"/></svg>',clock:'<svg viewBox="0 0 24 24" focusable="false"><circle cx="12" cy="12" r="8"/><path d="M12 7v5l3 2"/></svg>',samples:'<svg viewBox="0 0 24 24" focusable="false"><path d="M4 16h3l2-7 4 9 2-5h5"/></svg>',changes:'<svg viewBox="0 0 24 24" focusable="false"><path d="M18 8a7 7 0 1 0 1 7"/><path d="M18 4v4h-4"/></svg>',file:'<svg viewBox="0 0 24 24" focusable="false"><path d="M7 3h7l4 4v14H7z"/><path d="M14 3v5h5"/></svg>',storage:'<svg viewBox="0 0 24 24" focusable="false"><ellipse cx="12" cy="6" rx="7" ry="3"/><path d="M5 6v6c0 1.7 3.1 3 7 3s7-1.3 7-3V6"/><path d="M5 12v6c0 1.7 3.1 3 7 3s7-1.3 7-3v-6"/></svg>',play:'<svg viewBox="0 0 24 24" focusable="false"><path d="M8 5v14l11-7z"/></svg>',stop:'<svg viewBox="0 0 24 24" focusable="false"><path d="M7 7h10v10H7z"/></svg>',download:'<svg viewBox="0 0 24 24" focusable="false"><path d="M12 4v10"/><path d="m8 10 4 4 4-4"/><path d="M5 19h14"/></svg>',copy:'<svg viewBox="0 0 24 24" focusable="false"><rect x="8" y="8" width="10" height="10" rx="2"/><path d="M6 14H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v1"/></svg>',check:'<svg viewBox="0 0 24 24" focusable="false"><path d="m5 13 4 4L19 7"/></svg>',alert:'<svg viewBox="0 0 24 24" focusable="false"><path d="M12 8v5"/><path d="M12 17h.01"/><path d="M10.3 4.7 2.8 18a2 2 0 0 0 1.7 3h15a2 2 0 0 0 1.7-3L13.7 4.7a2 2 0 0 0-3.4 0z"/></svg>'};return o[e]||o.status}function Uv(e){return`<span class="oq-debug-recording-icon" aria-hidden="true">${$l(e)}</span>`}function Pt(e){return`<span class="oq-debug-recording-button-icon" aria-hidden="true">${$l(e)}</span>`}function Gv(){return[...po]}function zv(){let e=[];return po.forEach((o,r)=>{let n=t.entities?.[o]||{},a=String(n.uom??n.unit_of_measurement??"").trim();a&&e.push([r,a])}),e}function Qv(e){return Array.isArray(e)?e.map((o,r)=>o===null?null:[r,o]).filter(Boolean):[]}function Ua(){t.debugRecordingTimer&&(window.clearTimeout(t.debugRecordingTimer),t.debugRecordingTimer=null)}function xo(){t.debugRecordingDevicePollTimer&&(window.clearTimeout(t.debugRecordingDevicePollTimer),t.debugRecordingDevicePollTimer=null)}function no(e){return`${He()}/openquatt/debug-recording/${e}`}function wr(e){let o=e&&typeof e=="object"?e:{};t.debugRecordingDeviceStatus=o,t.debugRecordingActive=!!o.active,t.debugRecordingStartedAt=o.active||Number(o.sample_count||0)>0?Date.now()-Math.max(0,Number(o.elapsed_s||0)*1e3):0,t.debugRecordingEndsAt=o.active?Date.now()+Math.max(0,Number(o.remaining_s||0)*1e3):0,t.debugRecordingLastSampleAt=Number(o.sample_count||0)>0?Date.now():0}function Al(){wr({ok:!1,available:!1,active:!1,mode:"manual",rolling:!1,frozen:!1,storage:"unavailable",interval_s:0,duration_s:0,elapsed_s:0,remaining_s:0,sample_count:0,sample_capacity:0,estimated_size:0,buffer:"unavailable"})}async function Yv(){let e=await window.fetch(no("status"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);let o=await e.json();return wr(o),o}function hn(e=2e3){xo(),t.debugRecordingActive&&(t.debugRecordingDevicePollTimer=window.setTimeout(()=>{fn({silent:!0})},Math.max(0,Number(t.systemModal==="debug-recording"?e:5e3)||0)))}async function fn(e={}){e.silent||(t.debugRecordingBusy=!0,t.debugRecordingError="",d());try{await Yv(),!t.debugRecordingActive&&e.silent&&(t.debugRecordingNotice="Debugopname is afgerond."),hn()}catch(o){Al(),t.debugRecordingError=`Status kon niet worden opgehaald. ${o.message||String(o)}`}finally{e.silent||(t.debugRecordingBusy=!1),!e.silent||t.systemModal==="debug-recording"?d():(Dm(),jv())}}async function zm(){let e=Hl(po,"state"),o=null;for(let r=0;r<e.length;r+=1){let n=await window.fetch(no(`configure?reset=${r===0?"1":"0"}`),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store","Content-Type":"application/x-www-form-urlencoded"},body:e[r].body});if(!n.ok)throw new Error(`configuratie HTTP ${n.status}`);o=await n.json()}if(Number(o?.entity_field_count||0)!==po.length)throw new Error(`onvolledige debugset (${Number(o?.entity_field_count||0)}/${po.length})`);return o}async function tm(e){let o=Math.max(1,Number(e)||15);Ua(),xo(),t.debugRecordingBusy=!0,t.debugRecordingError="",t.debugRecordingNotice="",t.debugRecordingSamples=[],t.debugRecordingEvents=[],t.debugRecordingInitialValues=null,t.debugRecordingLastValues=null,t.debugRecordingDeviceBundle=null,t.debugRecordingLastSampleAt=0,t.debugRecordingSequence=0,d();try{await zm();let r=await window.fetch(no(`start?duration_s=${encodeURIComponent(o*60)}`),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!r.ok)throw new Error(`HTTP ${r.status}`);let n=await r.json();wr(n),hn()}catch(r){Al(),t.debugRecordingError=`Debugopname kon niet worden gestart. ${r.message||String(r)}`}finally{t.debugRecordingBusy=!1,d()}}async function om(){Ua(),xo(),t.debugRecordingBusy=!0,t.debugRecordingError="",t.debugRecordingNotice="",t.debugRecordingSamples=[],t.debugRecordingEvents=[],t.debugRecordingInitialValues=null,t.debugRecordingLastValues=null,t.debugRecordingDeviceBundle=null,t.debugRecordingLastSampleAt=0,t.debugRecordingSequence=0,d();try{await zm();let e=await window.fetch(no("start?rolling=1"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);let o=await e.json();wr(o),hn()}catch(e){Al(),t.debugRecordingError=`Rolling debug kon niet worden gestart. ${e.message||String(e)}`}finally{t.debugRecordingBusy=!1,d()}}async function Zv(){let e=await window.fetch(no("freeze"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);let o=await e.json();return wr(o),xo(),o}async function rm(){Ua(),t.debugRecordingBusy=!0,t.debugRecordingError="",d();try{await Zv(),t.debugRecordingNotice="Rolling debug is gestopt. De recente buffer blijft bewaard."}catch(e){t.debugRecordingError=`Rolling debug kon niet worden gestopt. ${e.message||String(e)}`}finally{t.debugRecordingBusy=!1,d()}}async function nm(e={}){Ua(),xo(),t.debugRecordingBusy=!0,t.debugRecordingError="",d();try{let o=await window.fetch(no("stop"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json();wr(r),t.debugRecordingNotice=e.completed?"Debugopname is afgerond.":"Debugopname is gestopt."}catch(o){t.debugRecordingError=`Debugopname kon niet worden gestopt. ${o.message||String(o)}`}finally{t.debugRecordingBusy=!1,d()}}function Vm(e={}){let o=t.debugRecordingActive?Date.now():Number(t.debugRecordingLastSampleAt||Date.now());return{format:"openquatt-debug-v2",schema_version:2,kind:"openquatt_debug_recording",encoding:"column-delta-json-v2",exported_at:new Date().toISOString(),source:e.source||{},recording:{started_at:t.debugRecordingStartedAt?new Date(Number(t.debugRecordingStartedAt)).toISOString():"",ended_at:o?new Date(o).toISOString():"",active:!!t.debugRecordingActive,duration_s:t.debugRecordingStartedAt?Math.round(Math.max(0,o-Number(t.debugRecordingStartedAt))/1e3):0,interval_s:Math.round(Zl/1e3),sample_count:ht(),column_count:po.length,storage:"browser"},columns:Gv(),units:zv(),initial:Qv(t.debugRecordingInitialValues),samples:t.debugRecordingSamples||[],events:t.debugRecordingEvents||[],...e.logs?{logs:e.logs}:{}}}function Ka(e){return JSON.stringify(e)}function Jv(){let e=Number(t.debugRecordingDeviceStatus?.estimated_size||0);if(e>0)return e;try{return new Blob([Ka(Vm())]).size}catch{return Ka(Vm()).length}}function Xv(e){let o=Math.max(0,Number(e)||0);return o>=1024*1024?`${(o/1024/1024).toFixed(1)} MB`:o>=1024?`${(o/1024).toFixed(1)} kB`:`${Math.round(o)} B`}function ew(e){let o=e?.exported_at||(e?.exported_at_ms?new Date(Number(e.exported_at_ms)).toISOString():new Date().toISOString()),r=String(o).replace(/[:.]/g,"-").replace(/T/,"_").replace(/Z$/,"Z");return`${String(e?.source?.installation||"OpenQuatt").replace(/\s+/g,"-").toLowerCase()}-debug-recording-${r}.oqdebug.json`}async function am(){if(ht()===0){t.debugRecordingError="Er is nog geen debugopname om te downloaden.",d();return}t.debugRecordingBusy=!0,t.debugRecordingError="";let e=t.debugRecordingActive&&ft();d();try{let o=await window.fetch(no("download"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json();t.debugRecordingDeviceBundle=r,$i(ew(r),Ka(r),"application/json"),Gm(r),t.debugRecordingNotice=e?"Momentopname gedownload. Rolling debug loopt door.":"Supportbestand gedownload."}catch{t.debugRecordingError="Download mislukt. Probeer opnieuw of kopieer de data."}finally{t.debugRecordingBusy=!1,d()}}async function im(){if(ht()===0){t.debugRecordingError="Er is nog geen debugopname om te kopi\xEBren.",d();return}t.debugRecordingBusy=!0,t.debugRecordingError="";let e=t.debugRecordingActive&&ft();d();try{let o=await window.fetch(no("download"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json();if(t.debugRecordingDeviceBundle=r,!await It(Ka(r)))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");Gm(r),t.debugRecordingNotice=e?"Momentopname gekopieerd. Rolling debug loopt door.":"Supportbestand gekopieerd."}catch{t.debugRecordingError="Kopi\xEBren mislukt. Probeer opnieuw of download het supportbestand."}finally{t.debugRecordingBusy=!1,d()}}function Wm(){let e=t.debugRecordingActive,o=ft(),r=ja(),n=ht(),a=t.debugRecordingBusy,i=Xv(Jv()),l=Array.isArray(t.debugRecordingDeviceBundle?.events)?t.debugRecordingDeviceBundle.events.length:Array.isArray(t.debugRecordingEvents)?t.debugRecordingEvents.length:0,p=Bv(),u=jm(),c=Bm(),m=Kv(),b=n>0,y=`${m.toFixed(1)}%`,v=[{icon:"status",label:"Status",value:tn()},{icon:"clock",label:o?"Retentie":"Duur",value:Ro(o?c:Km())},{icon:"samples",label:"Samples",value:String(n)},{icon:"changes",label:"Statuswijzigingen",value:String(l)},{icon:"file",label:"Geschatte grootte",value:`\xB1 ${i}`},{icon:"storage",label:"Opslag",value:t.debugRecordingDeviceStatus?.available===!1?"Niet beschikbaar":"Apparaatgeheugen"}],g=t.debugRecordingError?{kind:"error",icon:"alert",text:t.debugRecordingError}:t.debugRecordingNotice?{kind:"success",icon:"check",text:t.debugRecordingNotice}:null;return`
    <div class="oq-helper-modal-backdrop${t.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
      <section class="oq-helper-modal oq-debug-recording-modal" role="dialog" aria-modal="true" aria-labelledby="oq-debug-recording-modal-title">
        ...
        <p class="oq-helper-modal-copy">${s(va())}</p>
          ...
          ${e?`
            <div class="oq-debug-recording-progress">
              <div class="oq-debug-recording-progress-head">
                <span>${s(o?`Laatste ${Ro(c)} bewaard`:`Nog ${Ro(u)}`)}</span>
        ...
        `:`
          <section class="oq-debug-recording-duration" aria-label="Duur">
            ...
            <div class="oq-debug-recording-segments" role="group" aria-label="Kies opnameduur">
              ${On.map(f=>{let w=Number(f.minutes)===p;return`
                  <button
        ...
        <div class="oq-debug-recording-actions">
          ${e&&o?`
            <button class="oq-helper-button oq-helper-button--warning oq-debug-recording-primary" type="button" data-oq-action="freeze-debug-recording" ${a?"disabled":""}>${Pt("stop")}Stop rolling</button>
          `:e?`
            <button class="oq-helper-button oq-helper-button--warning oq-debug-recording-primary" type="button" data-oq-action="stop-debug-recording" ${a?"disabled":""}>${Pt("stop")}Stop opname</button>
          `:r?`
            <button class="oq-helper-button oq-helper-button--primary oq-debug-recording-primary" type="button" data-oq-action="start-debug-recording" data-debug-minutes="${p}" ${a||t.debugRecordingDeviceStatus?.available===!1?"disabled":""}>${Pt("play")}Start opname</button>
            <button class="oq-helper-button oq-helper-button--ghost" type="button" data-oq-action="start-rolling-debug-recording" ${a||t.debugRecordingDeviceStatus?.available===!1?"disabled":""}>${Pt("activity")}Hervat rolling</button>
          `:`
            <button class="oq-helper-button oq-helper-button--primary oq-debug-recording-primary" type="button" data-oq-action="start-debug-recording" data-debug-minutes="${p}" ${a||t.debugRecordingDeviceStatus?.available===!1?"disabled":""}>${Pt("play")}Start opname</button>
            <button class="oq-helper-button oq-helper-button--ghost" type="button" data-oq-action="start-rolling-debug-recording" ${a||t.debugRecordingDeviceStatus?.available===!1?"disabled":""}>${Pt("activity")}Start rolling</button>
          `}
          <button class="oq-helper-button oq-helper-button--ghost" type="button" data-oq-action="download-debug-recording" ${!b||a?"disabled":""}>${Pt("download")}${e&&o?"Download tot nu toe":"Download supportbestand"}</button>
          <button class="oq-helper-button oq-helper-button--ghost" type="button" data-oq-action="copy-debug-recording" ${!b||a?"disabled":""}>${Pt("copy")}${e&&o?"Kopieer tot nu toe":"Kopieer data"}</button>
          ${g?`
  ...
  `}function sm(e){t.overviewTheme=e==="dark"?"dark":"light";try{window.localStorage.setItem("oq-overview-theme",t.overviewTheme)}catch{}}function Da(e){t.interfacePanelOpen=e===!0}function fl(e){try{window.localStorage.setItem("oq-active-surface",e==="native"?"native":"app")}catch{}}function gn(e,o={}){t.settingsGroup=Ae.has(e)?e:he[0].id;try{window.localStorage.setItem("oq-settings-group",t.settingsGroup)}catch{}o.syncUrl!==!1&&t.appView==="settings"&&Jm(o.syncMode||"replace")}function lm(e){t.devPanelOpen=e===!0;try{window.localStorage.setItem("oq-dev-panel-open",t.devPanelOpen?"true":"false")}catch{}}function cm(e){t.hpVisualMode=e==="compact"?"compact":"schematic";try{window.localStorage.setItem("oq-hp-visual-mode",t.hpVisualMode)}catch{}}function um(e){t.hpLayoutMode=e==="focus-hp1"||e==="focus-hp2"?e:"equal";try{window.localStorage.setItem("oq-hp-layout-mode",t.hpLayoutMode)}catch{}}function Rs(){let e=t.entities?.trendHistoryFlashEnabled;if(!e)return!1;if(typeof e.value=="boolean")return e.value;let o=String(e.state??e.value??"").toLowerCase();return o==="on"||o==="true"||o==="1"}function tw(){return Rs()?ho:ho.filter(e=>e<=168)}function Jr(e){let o=tw(),r=Number(e);return o.includes(r)?r:Number.isFinite(r)&&r>o[o.length-1]?o[o.length-1]:o.includes(pt)?pt:o[0]}function rr(e){t.trendWindowHours=Jr(e);try{window.localStorage.setItem("oq-trend-window-hours",String(t.trendWindowHours))}catch{}}function Po(){return"overview"}function ow(e){if(t.reducedMotion=!!e?.matches,t.reducedMotion){za();return}Za()}function rw(){let e=wi();!e||t.motionPreferenceMedia===e||(t.motionPreferenceMedia=e,t.motionPreferenceListener=ow,typeof e.addEventListener=="function"?e.addEventListener("change",t.motionPreferenceListener):typeof e.addListener=="function"&&e.addListener(t.motionPreferenceListener),t.reducedMotion=!!e.matches)}function nw(){return Object.keys(t.entities).length>0}function za(){t.motionFrame&&(window.cancelAnimationFrame(t.motionFrame),t.motionFrame=0),t.motionStartedAt=0,Ya()}function aw(){return vi+Math.floor(Math.random()*(sc-vi+1))}function iw(){return(document.hidden?Mr:ec)+aw()}function Ym(e=iw()){t.pollTimer||t.nativeOpen||t.updateInstallBusy||Jn()||(t.pollTimer=window.setTimeout(async()=>{t.pollTimer=null,await pe(),Ym()},e))}function Kr(){Ym()}function Xn(){t.pollTimer&&(window.clearTimeout(t.pollTimer),t.pollTimer=null)}function sw(){t.nativeOpen||(Xn(),Kr(),document.hidden||pe({forceProbe:!0}))}function Ia(e={}){if(wn(),t.nativeOpen){Xn(),za(),t.nativeFrontendLoaded||Fa();return}if(Za(),Kr(),e.refresh!==!1){if(!nw()){og();return}pe({forceFast:!0})}}function vn(e){return e==="trends"&&(e="diagnosis"),!Ql.has(e)||e==="diagnosis"&&!ot()?"":e}function Ga(e){return String(e||"").trim().toLowerCase()}function Qa(){try{let e=new URL(window.location.href),o=Ga(e.searchParams.get("view")||""),r=vn(o);if(r)return r;let n=Ga(e.hash.replace(/^#/,""));return vn(n)||""}catch{return""}}function Zm(){try{let e=new URL(window.location.href),o=Ga(e.searchParams.get("section")||"");if(Ae.has(o))return o;let r=Ga(e.searchParams.get("group")||"");return Ae.has(r)?r:""}catch{return""}}function Jm(e="replace"){try{let o=new URL(window.location.href),r=vn(t.appView)||Po();if(o.searchParams.set("view",r),r==="settings"){let a=Ae.has(t.settingsGroup)?t.settingsGroup:he[0].id;o.searchParams.set("section",a),o.searchParams.delete("group")}else o.searchParams.delete("section"),o.searchParams.delete("group");o.hash&&vn(o.hash.replace(/^#/,""))&&(o.hash="");let n=e==="push"?"pushState":"replaceState";window.history[n]({oqView:r,oqSettingsSection:r==="settings"?t.settingsGroup:""},"",o.toString())}catch{}}function Rt(e,o={}){let r=vn(e)||Po(),n=o.syncMode||"replace",a=t.appView!==r;t.appView=r,(a||o.forceSync)&&Jm(n)}function lw(){let e=Qa()||Po(),o=e==="settings"?Zm()||t.settingsGroup:"";if(!(e===t.appView&&(e!=="settings"||o===t.settingsGroup))){if(t.appView=e,e==="settings"&&o){t.settingsGroup=o;try{window.localStorage.setItem("oq-settings-group",t.settingsGroup)}catch{}}d(),pe({forceFast:!0})}}function wn(){t.nativeApp&&(t.nativeApp.classList.add("oq-native-app"),t.nativeApp.classList.toggle("oq-native-app--collapsed",!t.nativeOpen),t.nativeApp.setAttribute("aria-hidden",t.nativeOpen?"false":"true"))}function Xm(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Qm,{once:!0}):Qm(),window.addEventListener("pointermove",Sc),window.addEventListener("pointerup",qc),window.addEventListener("popstate",lw),window.addEventListener("oq-mock-updated",cw),window.addEventListener("oq-dev-controls-changed",uw),document.addEventListener("visibilitychange",sw)}function cw(){t.mounted&&pe()}function uw(){t.mounted&&d()}function Qm(){pw();let e=document.querySelector("esp-app");e||(e=document.createElement("esp-app"),document.body.appendChild(e)),t.nativeApp=e,t.nativeFrontendLoaded=Array.from(document.scripts).some(o=>o.src===ai),t.mounted||(dw(e),t.mounted=!0,Ia()),wn(),t.nativeOpen||(pe(),fn({silent:!0}))}function pw(){if(!document.head)return;let e=document.head.querySelector('meta[name="viewport"]');e||(e=document.createElement("meta"),e.name="viewport",document.head.appendChild(e)),e.setAttribute("content","width=device-width, initial-scale=1")}function dw(e){let o=document.createElement("section");o.id="oq-helper-root",o.lang="nl-NL",document.documentElement&&!document.documentElement.lang&&(document.documentElement.lang="nl-NL"),e.parentNode.insertBefore(o,e),o.addEventListener("click",bc),o.addEventListener("change",fc),o.addEventListener("input",yc),o.addEventListener("keydown",vc),o.addEventListener("wheel",kc,{passive:!1}),o.addEventListener("focusin",Ci),o.addEventListener("focusout",Ci),o.addEventListener("mouseover",Ec),o.addEventListener("mouseout",Tc),o.addEventListener("pointerdown",wc),t.root=o,rw();let r=Qa()||Po(),n=r==="settings"?Zm():"";n&&gn(n,{syncUrl:!1}),Rt(r,{syncMode:"replace",forceSync:!0}),Ya(),d()}function mw(e){return new Promise((o,r)=>{if(!e){o();return}let n=Array.from(document.scripts).find(i=>i.src===e);if(n){if(n.dataset.loaded==="true"){o();return}n.addEventListener("load",()=>o(),{once:!0}),n.addEventListener("error",i=>r(i),{once:!0});return}let a=document.createElement("script");a.src=e,a.async=!1,a.addEventListener("load",()=>{a.dataset.loaded="true",o()},{once:!0}),a.addEventListener("error",i=>r(i),{once:!0}),document.head.appendChild(a)})}async function Fa(){if(!(t.nativeFrontendLoaded||t.nativeFrontendLoading)){t.nativeFrontendLoading=!0,t.nativeOpen&&d();try{await mw(ai),t.nativeFrontendLoaded=!0}catch(e){t.controlError=`ESPHome fallback kon niet worden geladen. ${e.message||e}`,t.nativeOpen=!1,fl("app"),d(),Ia()}finally{t.nativeFrontendLoading=!1,t.nativeOpen&&d()}}}function Ml(){if(!t.root)return;let e=typeof window<"u"?window.__OQ_DEV_CONTROLS__:null;!e||typeof e.bind!="function"||e.bind(t.root)}function Ya(){t.root&&(t.root.style.removeProperty("--oq-flow-offset"),t.root.style.removeProperty("--oq-flow-offset-reverse"),t.root.style.removeProperty("--oq-fan-rotation"),t.root.getAttribute("style")||t.root.removeAttribute("style"))}function ga(){return t.motionTargets={pipeFlows:[],fanBlades:[]},t.root?(t.root.querySelectorAll(".oq-hp-schematic-board.is-running").forEach(n=>{n.querySelectorAll(".oq-hp-tech-pipe-flow").forEach(a=>{t.motionTargets.pipeFlows.push(a)})}),t.root.querySelectorAll(".oq-hp-schematic-board.is-water-flowing:not(.is-running)").forEach(n=>{n.querySelectorAll('.oq-hp-tech-pipe-flow[data-oq-flow-variant="water"]').forEach(a=>{t.motionTargets.pipeFlows.push(a)})}),t.root.querySelectorAll(".oq-hp-schematic-board.is-fan-running").forEach(n=>{n.querySelectorAll(".oq-hp-tech-fan-blades").forEach(a=>{t.motionTargets.fanBlades.push(a)})}),t.motionTargets.pipeFlows.length+t.motionTargets.fanBlades.length):0}function gw(){return t.motionTargets.pipeFlows.length>0||t.motionTargets.fanBlades.length>0}function eg(e=performance.now()){if(!t.root||t.reducedMotion||!gw()&&ga()===0)return!1;t.motionStartedAt||(t.motionStartedAt=e);let o=(e-t.motionStartedAt)/1e3,r=o*cc%360;return t.motionTargets.pipeFlows.forEach(n=>{let a=n.dataset.oqFlowVariant==="water"?.42:1,i=-(o*lc*a);n.style.strokeDashoffset=`${i.toFixed(3)}px`}),t.motionTargets.fanBlades.forEach(n=>{n.style.transform=`rotate(${r.toFixed(3)}deg)`}),!0}function tg(e){if(!eg(e)){t.motionFrame=0,t.motionStartedAt=0;return}t.motionFrame=window.requestAnimationFrame(tg)}function Za(){if(t.motionFrame||t.reducedMotion||ga()===0)return;let e=performance.now();if(t.motionStartedAt=e,!eg(e)){t.motionStartedAt=0;return}t.motionFrame=window.requestAnimationFrame(tg)}function mg(){if(t.nativeOpen||t.appView!=="settings")return;let e=()=>{if(!(t.nativeOpen||t.appView!=="settings")){if(t.loadingEntities||t.focusedField||t.draggingCurveKey||t.busyAction||t.settingsInteractionLock){window.setTimeout(mg,250);return}pe({prefetchView:"overview",forceFast:!0})}};if(typeof window.requestIdleCallback=="function"){window.requestIdleCallback(e,{timeout:2e3});return}window.setTimeout(e,0)}async function gg(){if(t.nativeOpen||!Ll()||t.overviewMetadataHydrated||t.overviewMetadataHydrating)return!1;let e=Rw();if(!e.length)return t.overviewMetadataHydrated=!0,!1;t.overviewMetadataHydrating=!0;try{return await D(e,"all",{concurrency:wt}),t.overviewMetadataHydrated=!0,!0}catch{return!1}finally{t.overviewMetadataHydrating=!1,t.mounted&&!t.nativeOpen&&d()}}async function hw(e,o="state"){if(!(!e.length||t.nativeOpen)){t.entitySyncInFlight=!0;try{await D(e,o,{concurrency:o==="all"?wt:St})}finally{t.entitySyncInFlight=!1;let r=t.pendingEntitySyncOptions;t.pendingEntitySyncOptions=null,r&&!t.nativeOpen&&window.setTimeout(()=>{pe(r)},0)}t.mounted&&!t.nativeOpen&&d()}}async function fw(){if(!t.nativeOpen)try{Ll()&&await gg(),(t.appView==="overview"||t.appView==="diagnosis")&&await mn({force:!0}),t.appView==="results"&&await it({force:!0}),await So({force:!0}),oo()&&await Promise.all([to({force:!0}),pr({forceTrendHistory:!0,forceEnergyHistory:!0})])}finally{t.mounted&&!t.nativeOpen&&d(),mg()}}async function og(){if(t.nativeOpen)return;t.loadingEntities=!0,d();let e=yw();e>0&&await new Promise(i=>window.setTimeout(i,e));let o=Qw(),r=Yw(o),n=t.appView==="settings"?"all":"state";try{await D(o,n,{concurrency:n==="all"?wt:St}),t.appView==="settings"?await Ow():await Nw()}finally{t.loadingEntities=!1,d()}let a=t.appView==="settings"?"all":"state";window.setTimeout(()=>{hw(r,a)},Cw),bg(Nl())}var rg={installation:["hpGeneration","boilerCvAssistEnabled","boilerRatedHeatPower","flowControlMode","flowSetpoint","manualIpwm","silentStartTime","silentEndTime","maxWater","minRuntime"],service:["compressorStarts2hWarningLimit","compressorStarts72hWarningLimit","compressorCyclingWarning2h","compressorCyclingWarning72h","alternatingCompressorStartsWarning","commissioningStatus","cm100Active"],heating:["strategy"],cooling:["manualCoolingEnable","coolingWithoutDewPointMode"],integrations:["otEnabled","cicPollingEnabled","flowSource"],system:["setupComplete","projectVersionText","releaseChannelText","firmwareUpdateChannel","statusLedsEnabled"]},bw={installation:["setupComplete","installationTopology","hpGeneration","boilerCvAssistEnabled","boilerRatedHeatPower",...Ve,..._o,...uo,...hi,...Tr,...Er,"maxWater",...Rn],service:[...kr,...Nn,...Tr,...Er,"boilerCvAssistEnabled","boilerRatedHeatPower","flowSelected","flowKp","flowKi"],heating:["strategy",...ut,...co,"dayMax","silentMax"],cooling:["manualCoolingEnable","coolingWithoutDewPointMode","coolingDewPointSelected","coolingMinimumSafeSupplyTemp","coolingSupplyTarget","coolingSupplyError",...gi],integrations:[...ci,...pi,...ui,...di,...xr,...mi,...li],system:["setupComplete",...qt,"firmwareUpdateChannel","projectVersionText","releaseChannelText","statusLedsEnabled",...dn,"webServerLogHistoryEnabled","debugLevel"]};function $o(){return[...new Set(["setupComplete",...bi])]}function oo(){return t.appView==="settings"&&t.settingsGroup==="system"}function Tu(){return t.appView==="settings"&&t.settingsGroup==="integrations"}function yw(){let e=typeof window<"u"?Number(window.__OQ_DEV_LOAD_DELAY_MS||0):0;return Number.isFinite(e)&&e>0?e:0}var hg=["strategy","controlModeLabel","openquattEnabled","installationTopology","hpGeneration","totalPower","flowSelected","totalCop","manualCoolingEnable","silentModeOverride","totalHeat","totalCoolingPower"],vw=["strategy","controlModeLabel","hpGeneration"],ww=["totalPower","flowSelected"],Sw=["totalHeat","totalCoolingPower"],qw=2e3,Tw=250,Ew=5e3,kw=250;function Pl(e=t.settingsGroup){let o=Ae.has(e)?e:he[0].id;return[...new Set(["setupComplete","strategy",...Be,...bw[o]||[]])]}function fg(){let e=Ae.has(t.settingsGroup)?t.settingsGroup:he[0].id;return[...new Set(rg[e]||rg.installation)]}var Cw=1200,xw=1800,$w=0,Aw=3500;function Rl(){return["setupComplete","strategy",...Be]}function Hw(){let e=new Set;return Ln.forEach(o=>{(o.categories||[]).forEach(r=>{(r.groups||[]).forEach(n=>{(n.rows||[]).forEach(a=>{let i=Array.isArray(a)?a[1]:"";i&&e.add(i)})})})}),[...e]}function Sn(e,o={}){let r=o.forceFast===!0,n=o.includeBulk===!0;return e==="energy"||e==="results"?[...new Set([...Rl(),...e==="energy"?hg:[],...Hw(),...e==="results"?Td:[]])]:[...new Set([...Rl(),...r||!n?fi:Ar,...e==="diagnosis"?qd:[]])]}function Nl(e=t.appView){return e==="diagnosis"||e==="results"||e==="settings"&&oo()?$w:xw}function bg(e=Nl()){t.nativeOpen||(t.supplementaryPrimeTimer&&window.clearTimeout(t.supplementaryPrimeTimer),t.supplementaryPrimeTimer=window.setTimeout(()=>{t.supplementaryPrimeTimer=null,fw()},e))}function Mw(e={}){let o=t.pendingEntitySyncOptions||{},r={...o,...e};o.forceBulk||e.forceBulk?(r.forceBulk=!0,r.forceFast=!1):(o.forceFast||e.forceFast)&&(r.forceFast=!0),t.pendingEntitySyncOptions=r}function Ol(e){let o=String(E(e)??"").trim().toLowerCase();return o!==""&&o!=="unknown"&&o!=="unavailable"&&o!=="nan"}function ng(e){return Ol(e)&&Number.isFinite(Te(E(e)))}function Ll(){return t.appView==="overview"||t.appView==="diagnosis"||t.appView==="energy"}function Rw(){return Jl.filter(e=>{let o=t.entities[e];return o?!String(o.uom??o.unit_of_measurement??"").trim():!R[e]?.optional})}function ag(){return Ll()?vw.every(Ol)&&ww.every(ng)&&Sw.some(ng):!0}function Pw(){return t.appView==="settings"}function ig(){return Pw()?fg().every(e=>R[e]?.optional&&!t.entities[e]?!0:Ol(e)):!0}async function Nw(){if(ag())return;let e=Date.now()+qw;for(;!t.nativeOpen&&!ag()&&Date.now()<e;){await new Promise(o=>window.setTimeout(o,Tw));try{await D(hg,"state")}catch{return}}}async function Ow(){if(ig())return;let e=Date.now()+Ew;for(;!t.nativeOpen&&!ig()&&Date.now()<e;){await new Promise(o=>window.setTimeout(o,kw));try{await D(fg(),"all")}catch{return}}}var Lw=8e3,yg=3e3,sg="/openquatt/entities",Dw=900,lg="/openquatt/service/status";function vg(){return t.deviceReconnectMode||t.busyAction==="restartAction"||t.updateInstallBusy||t.updateInstallPhaseHint?yg:Lw}function Ji(e){let o=String(e||"").toLowerCase();return o.includes("failed to fetch")||o.includes("load failed")||o.includes("networkerror")||o.includes("network request failed")||o.includes("connection refused")||o.includes("connection reset")||o.includes("err_connection")||o.includes("timeout")}var Fw=300*1e3;function Iw(){if(t.optionalMissingEntities)for(let e of Object.keys(t.optionalMissingEntities))delete t.optionalMissingEntities[e]}function cg(){let e=Date.now();t.lastEntitySyncAt=e,t.lastEntitySyncSuccessAt=e,t.entitySyncFailureCount=0,!!t.deviceReconnectMode&&typeof Gi=="function"&&Gi()&&(t.lastFastEntitySyncAt=0,t.lastBulkEntitySyncAt=0,t.lastStaticEntitySyncAt=0,t.trendHistoryRaw="",t.trendHistoryError="",t.trendHistorySignature="",t.trendHistoryNowMs=Number.NaN,t.trendHistoryLastFetchAt=0,typeof Fi=="function"?Fi():(nt(),zo(),t.webServerLogEnabled=null,t.webServerLogConnected=!1),Iw())}function wg(e){if(!Ji(e)){t.entitySyncFailureCount=0,zi();return}t.entitySyncFailureCount=Number(t.entitySyncFailureCount||0)+1,t.deviceReconnectLastError=String(e||""),(t.deviceReconnectMode||t.busyAction==="restartAction"||t.updateInstallBusy||t.updateInstallPhaseHint||t.entitySyncFailureCount>=2)&&Wr(t.updateInstallBusy||t.updateInstallPhaseHint?"ota":t.busyAction==="restartAction"?"restart":"reconnect",e)}function _w(e=Date.now(),o={}){if(o.forceProbe===!0||t.deviceReconnectMode||t.busyAction==="restartAction"||t.updateInstallBusy||t.updateInstallPhaseHint||Number(t.entitySyncFailureCount||0)>0)return!0;let r=Number(t.lastEntitySyncSuccessAt||t.lastEntitySyncAt||t.lastEntityResponseAt||0);if(!r)return!0;let n=document.hidden?Mr:nc;return e-r>=n}async function Ww(){let e=R.status||R.setupComplete;if(!e)return{ok:!0,message:""};let o=t.deviceReconnectMode?yg:rc,r=U(e.domain,e.name);if(typeof AbortController=="function"){let n=new AbortController,a=window.setTimeout(()=>n.abort(),o);try{let i=await fetch(r,{cache:"no-store",signal:n.signal});return t.lastEntityResponseAt=Date.now(),{ok:i.ok||i.status===404,message:i.ok||i.status===404?"":`${e.name} HTTP ${i.status}`}}catch(i){return{ok:!1,message:n.signal.aborted?`${e.name} request timed out after ${o}ms`:i.message||String(i)}}finally{window.clearTimeout(a)}}try{let n=await fetch(r,{cache:"no-store"});return t.lastEntityResponseAt=Date.now(),{ok:n.ok||n.status===404,message:n.ok||n.status===404?"":`${e.name} HTTP ${n.status}`}}catch(n){return{ok:!1,message:n.message||String(n)}}}function Vw(e,o=Date.now()){let r=t.optionalMissingEntities?.[e];return!R[e]?.optional||!r?!1:o-Number(r)<Fw}function Bw(e,o=Date.now()){t.optionalMissingEntities&&(t.optionalMissingEntities[e]=o)}function Kw(e){let o=R[e];return o?`${e}	${o.domain}	${o.name}`:""}function ug(e,o){let r=new URLSearchParams;return r.set("detail",o==="all"?"all":"state"),r.set("entities",e.join(`
`)),r.toString()}function Hl(e,o){let r=[],n=[],a=[],i="";return e.forEach(l=>{let p=Kw(l);if(!p)return;let u=[...a,p],c=ug(u,o);if(a.length&&c.length>Dw){r.push({keys:n,body:i}),n=[l],a=[p],i=ug(a,o);return}n=[...n,l],a=u,i=c}),a.length&&r.push({keys:n,body:i}),r}async function jw(e){let o=vg(),r={method:"POST",cache:"no-store",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:e.body};if(typeof AbortController=="function"){let a=new AbortController,i=window.setTimeout(()=>a.abort(),o);try{let l=await fetch(sg,{...r,signal:a.signal});if(!l.ok)throw new Error(`bulk entities HTTP ${l.status}`);return l.json()}catch(l){throw a.signal.aborted?new Error(`bulk entities request timed out after ${o}ms`):l}finally{window.clearTimeout(i)}}let n=await fetch(sg,r);if(!n.ok)throw new Error(`bulk entities HTTP ${n.status}`);return n.json()}async function Uw(){let e=vg(),o={cache:"no-store",headers:{"Cache-Control":"no-store"}};if(typeof AbortController=="function"){let n=new AbortController,a=window.setTimeout(()=>n.abort(),e);try{let i=await fetch(lg,{...o,signal:n.signal});if(!i.ok)throw new Error(`service status HTTP ${i.status}`);return i.json()}catch(i){throw n.signal.aborted?new Error(`service status request timed out after ${e}ms`):i}finally{window.clearTimeout(a)}}let r=await fetch(lg,o);if(!r.ok)throw new Error(`service status HTTP ${r.status}`);return r.json()}function Gw(e={}){let o=e?.entities&&typeof e.entities=="object"?e.entities:{};Object.entries(o).forEach(([r,n])=>{Cr.has(r)&&(t.optionalMissingEntities&&delete t.optionalMissingEntities[r],t.entities[r]=Sg(r,t.entities[r],n))})}async function zw(e){if(!e.length)return{ok:!0,message:""};try{let o=await Uw();return Gw(o),t.lastEntityResponseAt=Date.now(),{ok:!0,message:""}}catch(o){return{ok:!1,message:o.message||String(o)}}}async function D(e,o="state",r={}){let n=Date.now(),a=r.forceMissing===!0,i=e.filter(w=>a||Cr.has(w)||!Vw(w,n));if(!i.length)return;let l=i.filter(w=>Cr.has(w)),p=i.filter(w=>!Cr.has(w)),c=(await zw(l)).ok?p:[...p,...l];if(!c.length){pg(),ba(zt()),t.busyAction||(cg(),t.controlError="");return}let m=Number(r.concurrency),b=Number.isFinite(m)&&m>0?Math.floor(m):wt,y=Hl(c,o),v=Math.max(1,Math.min(b,wt)),g=[];for(let w=0;w<y.length;w+=v){let S=y.slice(w,w+v),q=await Promise.allSettled(S.map(async k=>({chunk:k,payload:await jw(k)})));g.push(...q)}g.some(w=>w.status==="fulfilled")&&(t.lastEntityResponseAt=Date.now());let f="";g.forEach(w=>{if(w.status!=="fulfilled"){let H=w.reason.message||String(w.reason);f||(f=H);return}let{chunk:S,payload:q}=w.value,k=q?.entities&&typeof q.entities=="object"?q.entities:{},$=new Set(Array.isArray(q?.missing)?q.missing:[]);S.keys.forEach(H=>{if(Object.prototype.hasOwnProperty.call(k,H)){t.optionalMissingEntities&&delete t.optionalMissingEntities[H],t.entities[H]=Sg(H,t.entities[H],k[H]);return}let W=R[H];W?.optional?$.has(H)&&Bw(H,n):f||(f=`${W?.name||H} ontbreekt in bulk response`)})}),pg(),ba(zt()),f?(wg(f),t.deviceReconnectMode?t.controlError="":t.controlError=`Niet alle helpervelden konden worden ververst. ${f}`):t.busyAction||(cg(),t.controlError="")}function Sg(e,o={},r={}){let n={...o||{},...r||{}};return R[e]?.domain==="select"&&(!String(r.state??"").trim()&&String(o?.state??"").trim()&&(n.state=o.state),!String(r.value??"").trim()&&String(o?.value??"").trim()&&(n.value=o.value),!Array.isArray(r.option)&&Array.isArray(o?.option)&&(n.option=o.option),!Array.isArray(r.options)&&Array.isArray(o?.options)&&(n.options=o.options)),n}function pg(){t.complete=_n(),t.stage=t.complete===!0?"Gereed":t.complete===!1?"Quick Start":"Laden...",t.summary=mc(),t.appView==="diagnosis"&&!ot()&&Rt(Po(),{syncMode:"replace",forceSync:!0}),t.appView||Rt(Qa()||Po(),{syncMode:"replace",forceSync:!0})}function Qw(){let e=Rl();return t.appView==="settings"?[...new Set([...e,...Pl()])]:t.appView==="energy"||t.appView==="results"?Sn(t.appView,{forceFast:!0}):t.appView==="overview"||t.appView==="diagnosis"?Sn(t.appView,{forceFast:!0}):[...new Set(e)]}function Yw(e=[]){let o=new Set(e);return(t.appView==="settings"?Pl():t.appView==="overview"||t.appView==="diagnosis"?[...new Set([...Sn(t.appView,{includeBulk:!0}),...qt])]:t.appView==="energy"||t.appView==="results"?[...new Set([...Sn(t.appView,{forceFast:!0}),...qt])]:[...new Set(["setupComplete","strategy",...Be])]).filter(n=>!o.has(n))}function dg(e=Date.now(),o={}){return o.forceBulk===!0?!0:e-Number(t.lastBulkEntitySyncAt||0)>=tc}async function pe(e={}){if(t.nativeOpen||t.loadingEntities||t.draggingCurveKey||t.busyAction||t.settingsInteractionLock)return;if(t.updateInstallBusy||Jn()){t.pendingEntitySyncOptions=null;return}if(t.focusedField&&t.appView!=="settings")return;if(t.entitySyncInFlight){Mw(e);return}let o=Date.now();if(document.hidden&&o-Number(t.lastEntitySyncAttemptAt||0)<Mr)return;let r=t.appView,n=e.prefetchView==="overview"&&!e.forceBulk&&r==="settings",a=n?"overview":r,i=a==="overview"||a==="diagnosis"||a==="energy"||a==="results",l=e.forceFast===!0&&!e.forceBulk,p=!l&&!n&&dg(o,e),c=o-Number(t.lastStaticEntitySyncAt||0)>=oc||t.updateInstallBusy||t.updateInstallPhaseHint?qt:[],m=t.quickStartModalOpen&&t.currentStep==="flow-source"?et:[],b=t.quickStartModalOpen&&t.currentStep==="thermostat-source"?lo:[],y=ul()?Co():[],v=n?[...fi,...Be,"setupComplete",...c]:i?[...Sn(a,{forceFast:l,includeBulk:p}),...c]:r==="settings"?[...new Set([...Pl(),...y,...c])]:p?["setupComplete",...c,...Be,"strategy",...so,...Ve,...ae()?de.map(g=>g.key):ut]:["setupComplete",...Be,"strategy",...c];t.entitySyncInFlight=!0,t.lastEntitySyncAttemptAt=o;try{let g=t.deviceReconnectMode,f=_w(o,e)?await Ww():{ok:!0,message:""};if(!f.ok){wg(f.message),n||d();return}if(await D([...new Set([...v,...m,...b])],n?"state":r==="settings"?"all":"state",{concurrency:l&&i?St:wt}),t.lastFastEntitySyncAt=Date.now(),p&&(a==="overview"||a==="diagnosis")&&!n&&(t.lastBulkEntitySyncAt=t.lastFastEntitySyncAt),c.length&&(t.lastStaticEntitySyncAt=t.lastFastEntitySyncAt),n)return;i&&!t.overviewMetadataHydrated&&!t.overviewMetadataHydrating&&gg();let w=g!==t.deviceReconnectMode,S=l&&i,q=S?!1:a==="overview"||a==="diagnosis"?await mn():!1,k=S?!1:t.appView==="results"?await it():!1,$=S?!1:ul()?(await Promise.all([ll(),it({metaOnly:!0})])).some(Boolean):!1,H=S||!Dp()?!1:await So(),W=S||!Fp()?!1:await to(),B=S||!vu()?!1:await vo(),M=yn();if(S&&!t.nativeOpen&&bg(Nl(a)),w){d();return}if(q&&t.appView==="diagnosis"&&!t.root?.querySelector(".oq-overview-trends")){d();return}if(k&&t.appView==="results"&&!t.root?.querySelector(".oq-energy-history")){d();return}if($&&t.appView==="settings"){d();return}if(H&&(t.systemModal==="login"||oo())){d();return}if(W&&t.appView==="settings"){d();return}if(t.systemModal==="mqtt-sensors"){oa()!==t.mqttSensorsModalRenderSignature&&d();return}if(B&&t.appView==="settings"){d();return}let I=!!(t.updateModalOpen||t.systemModal||t.interfacePanelOpen);if(M!==t.headerRenderSignature)if(I&&Ba())t.headerRenderSignature=M;else{d();return}else Ba();if(t.appView==="settings"&&String(t.systemModal||"").startsWith("service-task-")){Ja()!==t.settingsRenderSignature&&d();return}if(I)return;if(t.appView==="settings"){let z=Ja();if(z!==t.settingsRenderSignature&&!t.focusedField){d();return}if(!xm()){t.focusedField||d();return}t.focusedField&&(t.settingsRenderSignature=z);return}if(t.appView==="diagnosis"){ju()||d();return}if(t.appView==="energy"){bd()||d();return}if(t.appView==="results"){yd()||d();return}np()||d()}catch(g){n||(t.controlError=`Helperstatus kon niet worden geladen. ${g.message}`,d())}finally{t.entitySyncInFlight=!1;let g=t.pendingEntitySyncOptions;t.pendingEntitySyncOptions=null,g&&!t.nativeOpen&&window.setTimeout(()=>{pe(g)},0),l&&(a==="overview"||a==="diagnosis")&&!n&&!t.nativeOpen&&!g&&dg(Date.now())&&window.setTimeout(()=>{pe({forceBulk:!0})},Aw)}}function K(e){let o=t.entities[e];if(!o)return t.optionalMissingEntities?.[e]?`${e}:__optional_missing__`:`${e}:__missing__`;let r=o.state??o.value??"",n=Array.isArray(o.option)?o.option.join(","):Array.isArray(o.options)?o.options.join(","):"",a=[o.min_value??"",o.max_value??"",o.step??"",o.uom??""].join(",");return`${e}:${r}::${n}::${a}`}function Ja(){return[t.appView,t.settingsGroup,t.busyAction,t.loadingEntities?"loading":"ready",ka(),K("setupComplete"),...bi.map(e=>K(e))].join("|")}function ve(e){try{return JSON.stringify(e)}catch{return String(e??"")}}function ca(){return[t.appView,t.busyAction,K("openquattEnabled"),K("openquattResumeAt"),K("manualCoolingEnable"),K("silentModeOverride"),K("controlModeLabel"),K("coolingPermitted"),K("coolingRequestActive"),K("coolingBlockReason"),K("silentActive")].join("|")}function Zw(){return`
      <section class="oq-helper-panel">
    ...
    `}function Xw(){return t.appView==="overview"?tp():t.appView==="energy"?hd():t.appView==="diagnosis"?Ku():t.appView==="results"?fd():Zw()}function eS(){let e=kl();return`
    ...
    `}function tS(){let e=typeof document<"u"?document.activeElement:null;return!e||typeof e.matches!="function"?null:e.matches("select[data-oq-dev-control]")?e:null}function oS(e){if(!e||t.deferDevControlSelectRender)return;t.deferDevControlSelectRender=!0;let o=()=>{e.removeEventListener("blur",o),e.removeEventListener("change",o),t.deferDevControlSelectRender=!1,window.setTimeout(()=>qg(),0)};e.addEventListener("blur",o,{once:!0}),e.addEventListener("change",o,{once:!0})}function rS(){if(t.nativeOpen||t.appView!=="settings"||t.renderedAppView!=="settings"||t.renderedSettingsGroup!==t.settingsGroup)return null;let e=document.scrollingElement||document.documentElement,o=Number(window.scrollY||e?.scrollTop||0);return!Number.isFinite(o)||o<=0?null:{group:t.settingsGroup,left:Number(window.scrollX||e?.scrollLeft||0),top:o}}function nS(e){if(!e)return;let o=(t.settingsPageScrollRestoreToken||0)+1;t.settingsPageScrollRestoreToken=o;let r=()=>{if(o!==t.settingsPageScrollRestoreToken||t.nativeOpen||t.appView!=="settings"||t.settingsGroup!==e.group)return;let n=document.scrollingElement||document.documentElement;if(!n)return;let a=Math.max(0,n.scrollHeight-n.clientHeight),i=Math.min(e.top,a);window.scrollTo({left:e.left,top:i,behavior:"auto"})};window.requestAnimationFrame(()=>{r(),window.requestAnimationFrame(r),window.setTimeout(r,80)})}function qg(){if(!t.root)return;let e=tS();if(e){oS(e);return}let o=t.systemModal==="webserver-logs"?Tt():null,r=t.systemModal==="cm100-commissioning"?Dc():null,n=String(t.systemModal||"").startsWith("service-task-")?Ic():null,a=t.systemModal==="history-storage"?Wc():null,i=t.quickStartModalOpen?Ap():null,l=rS();if(t.nativeOpen){t.root.innerHTML=`
        ${Cl()}
        ${Fm()}
      `,t.renderedAppView="native",t.renderedSettingsGroup="",t.settingsRenderSignature="",t.headerRenderSignature=yn(),t.mqttSensorsModalRenderSignature="",za(),wn(),Ii(),Ml(),ki(),Ei(),Et(o),Oi(r),Li(n),Di(a),zs(i);return}let p=Xw(),u=t.loadingEntities?`${p}${Jw()}`:p,c=t.appView==="overview"||t.appView==="energy"||t.appView==="diagnosis"||t.appView==="results";t.root.innerHTML=`
      ${Cl()}
      ...
      ${Im()}
      ${Xc()}
    `,t.renderedAppView=t.appView,t.renderedSettingsGroup=t.appView==="settings"?t.settingsGroup:"",t.settingsRenderSignature=t.appView==="settings"?Ja():"",t.headerRenderSignature=yn(),t.mqttSensorsModalRenderSignature=t.systemModal==="mqtt-sensors"?oa():"",Ya(),rp(),Ii(),Za(),Zr(),wn(),Ml(),ki(),Ei(),Et(o),Oi(r),Li(n),Di(a),zs(i),nS(l)}Ac(qg);hc({handleChange:Ud,handleClick:Gd,handleFocusChange:_d,handleInput:Bd,handleKeyDown:Kd,handlePointerDown:zd,handlePointerMove:Qd,handlePointerUp:Yd,handleSettingsInteractionEnd:Vd,handleSettingsInteractionStart:Wd,handleWheel:jd});Xm();})();

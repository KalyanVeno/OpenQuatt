...
`)}function Hq(e,t=""){if(!e.length)return`
    ...
    `}function P1(){if(!o.root||o.appView!=="control")return!1;let e=o.root.querySelector(".oq-overview-board"),t=e?e.querySelector(".oq-working"):null;if(!e||!t)return!1;let r=document.activeElement;if(r&&r.closest("[data-oq-control-replay-period-menu]")&&r.matches("[data-oq-control-replay-custom-input]"))return!0;let n=`oq-overview-board oq-overview-board--${o.overviewTheme}`;e.className!==n&&(e.className=n);let a=ta();return Ye(t,jf(a),Vf(a))||!0}po({patchControlReplayDom:P1});function N1(){let e=document.activeElement;if(!o.root||o.appView!=="settings"||!e||!o.root.contains(e))return null;let t=String(e.dataset?.oqField||"");return t?{field:t,settingsGroup:o.settingsGroup,selectionStart:typeof e.selectionStart=="number"?e.selectionStart:null,selectionEnd:typeof e.selectionEnd=="number"?e.selectionEnd:null}:null}function D1(e){if(!e||o.appView!=="settings"||o.settingsGroup!==e.settingsGroup||!o.root)return;let t=Array.from(o.root.querySelectorAll("[data-oq-field]")).find(r=>r.dataset.oqField===e.field);if(!(!t||t.disabled)&&(t.focus({preventScroll:!0}),e.selectionStart!==null&&typeof t.setSelectionRange=="function"))try{t.setSelectionRange(e.selectionStart,e.selectionEnd)}catch{}}function _1(){return`
      <section class="oq-helper-panel">

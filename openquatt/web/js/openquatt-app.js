          ...
          >
            ...
            <span class="oq-settings-mqtt-sensor-status-cell">
              <em
                ...
                aria-label="${s(C)}: ${s(k)}"
              >${s(q)}</em>
              ${y?`<span class="oq-settings-mqtt-sensor-retained" title="${s(D)}" aria-label="${s(D)}">R</span>`:""}
            </span>
            <button
...
`)}async function mp(){let e=Jv();if(o.webServerLogCopyMessage="",o.webServerLogCopyError="",!e){o.webServerLogCopyError="Er zijn nog geen logregels om te kopi\xEBren.",f();return}try{if(!await eo(e))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");o.webServerLogCopyMessage=`${o.webServerLogEntries.length} logregel${o.webServerLogEntries.length===1?"":"s"} gekopieerd.`}catch(t){o.webServerLogCopyError=t instanceof Error?t.message:"Kopi\xEBren naar het klembord is niet gelukt."}o.systemModal==="webserver-logs"&&f()}function gp(){let e=yr();return`
  ...
  `}function Zv(){let e=o.entities.firmwareUpdateTarget||{};return Array.isArray(e.option)?e.option:Array.isArray(e.options)?e.options:[]}function bp(e){return Zv().includes(e)}function Da(){let e=gn(),t=te(),r=lo(),n=Gd();return e!=="heatpump_controller_q"||t!=="single"&&t!=="duo"||r!=="wifi"&&r!=="eth"||!n?null:{canSwitch:w("firmwareUpdateTarget")&&bp("alternate connection")&&w("installFirmwareUpdateTarget"),currentConnection:r,targetConnection:n,currentLabel:et(r),targetLabel:et(n),currentBuildLabel:fr(t,r),targetBuildLabel:fr(t,n)}}function Na(){let e=gn(),t=te(),r=Qd(),n=lo(),a=e==="heatpump_controller_q"?["wifi","eth"]:["wifi"];return!["heatpump_controller_q","heatpump_listener","waveshare"].includes(e)||t!=="single"&&t!=="duo"||!r||!a.includes(n)?null:{canSwitch:w("firmwareUpdateTarget")&&bp("alternate topology")&&w("installFirmwareUpdateTarget"),currentTopology:t,targetTopology:r,currentConnection:n,targetConnection:n,currentLabel:Fo(t),targetLabel:Fo(r),currentBuildLabel:fr(t,n),targetBuildLabel:fr(r,n)}}function Bo(e=o.updateTestFirmwarePr){let t=String(e||"").trim().replace(/^#?pr[-\s]*/i,"").replace(/^#/,"");return/^\d{1,6}$/.test(t)?t:""}function qr(){let e=gn(),t=te(),r=lo(),a={waveshare:{slug:"waveshare",label:"Waveshare",connections:["wifi"]},heatpump_listener:{slug:"heatpump-listener",label:"Heatpump Listener",connections:["wifi"]},heatpump_controller_q:{slug:"heatpump-controller-q",label:"Heatpump Controller Q",connections:["wifi","eth"]}}[e];if(!a||t!=="single"&&t!=="duo"||!a.connections.includes(r))return{available:!1,label:"Onbekend target",error:"Deze firmware meldt geen herkenbaar hardware-, opstelling- of verbindingsprofiel."};let i=`openquatt-${a.slug}-${t}-${r}`,l=t==="duo"?"Duo":"Single";return{available:!0,artifactName:i,otaFileName:`${i}.firmware.ota.bin`,md5FileName:`${i}.firmware.ota.bin.md5`,label:`${a.label} ${l} ${et(r)}`}}function hn(e=Bo(),t=qr()){if(!e||!t.available)return null;let n=`${`https://github.com/jeroen85/OpenQuatt/releases/download/pr-${e}`}/${t.otaFileName}`;return{otaUrl:n,md5Url:`${n}.md5`,releaseApiUrl:`https://api.github.com/repos/jeroen85/OpenQuatt/releases/tags/pr-${e}`}}function go(){if(rt())return"Controleren";let e=zt();if(e)return e.phaseLabel;if(rl())return"Bijgewerkt";if(Sr())return"Bezig";if(Ko())return"Beschikbaar";let t=yp();if(t!==null&&t<=0)return"Actueel";let r=Tt();return typeof r.updateLabel=="string"&&r.updateLabel.trim()?r.updateLabel.trim():r.updateAvailable===!0?"Beschikbaar":r.updateAvailable===!1||al()?"Actueel":he()?"Nog niet gecontroleerd":"\u2014"}function he(){return o.entities.firmwareUpdate||null}function La(){let e=he();return e?String(e.state??e.value??"").trim().toLowerCase():""}function Xv(){let e=o.entities.firmwareUpdateStatus;return e?String(e.state??e.value??"").trim():""}function Oa(){return Xv().toLowerCase()}function vp(){let e=o.entities.firmwareUpdateProgress;if(!e)return Number.NaN;let t=Number(e.value??e.state);return Number.isNaN(t)?Number.NaN:Math.max(0,Math.min(100,t))}function tl(){let e=String(o.updateInstallTargetVersion||"").trim(),t=le();return!e||!t?!1:bn(t,e)>=0}function ey(e=he()||{}){let t=fo(e),r=le(e);return!t||!r?!1:bn(r,t)>=0}function ol(){return(tl()||ey())&&!rt()&&!fn()&&!Ko()}function rl(){return(o.updateInstallCompleted||ol())&&!rt()&&!zt()&&!Ko()}function kr(){o.updateInstallBusy=!1,o.updateInstallTargetVersion="",o.updateInstallPhaseHint="",o.updateInstallProgressHint=Number.NaN,o.updateInstallMode="",o.updateInstallTargetConnection="",o.updateInstallTargetTopology="",sy()}function Ae(){o.updateManualUploadFile=null,o.updateManualUploadFileName="",o.updateManualUploadError=""}function ot(e={}){e.clearPr&&(o.updateTestFirmwarePr=""),o.updateTestFirmwareConfirmed=!1,o.updateTestFirmwareError="",o.updateTestFirmwareBuild=null}function ty(){let e=Oa(),t=vp();if(e==="starting"||e==="uploading"||e==="rebooting"){o.updateInstallPhaseHint=e,Number.isNaN(t)||(o.updateInstallProgressHint=e==="rebooting"?Math.max(t,100):t);return}if(o.updateInstallBusy){if(tl()){o.updateInstallPhaseHint="rebooting",o.updateInstallProgressHint=100;return}o.controlNotice.includes("opnieuw is opgestart")&&(o.updateInstallPhaseHint="rebooting",o.updateInstallProgressHint=100)}}function fn(){let e=Oa();return e==="starting"||e==="uploading"||e==="rebooting"}function zt(){ty();let e=Oa(),t=e==="starting"||e==="uploading"||e==="rebooting",r=t?e:o.updateInstallPhaseHint,n=vp(),a=Number.isNaN(o.updateInstallProgressHint)?0:Math.round(o.updateInstallProgressHint),i=t&&!Number.isNaN(n)?Math.round(n):a;return!fn()&&!o.updateInstallBusy?null:r==="rebooting"?{phaseLabel:"Herstarten",percent:Math.max(i,100),copy:o.updateInstallMode==="test-firmware"?"Testfirmware is geplaatst. Het device start opnieuw op en komt daarna vanzelf terug.":o.updateInstallMode==="connection-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna via de gekozen verbinding terug.":o.updateInstallMode==="topology-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna met de gekozen opstelling terug.":"Firmware is geplaatst. Het device start nu opnieuw op en komt daarna vanzelf terug."}:r==="uploading"?{phaseLabel:"Uploaden",percent:i,copy:o.updateInstallMode==="test-firmware"?`Testfirmware wordt nu door ${Fe()} gedownload en ge\xEFnstalleerd.`:o.updateInstallMode==="connection-switch"?`De ${et(o.updateInstallTargetConnection)}-build wordt nu naar ${Fe()} verzonden.`:o.updateInstallMode==="topology-switch"?`De ${fr(o.updateInstallTargetTopology,o.updateInstallTargetConnection)}-build wordt nu naar ${Fe()} verzonden.`:`Firmware wordt nu naar ${Fe()} verzonden.`}:{phaseLabel:"Installeren",percent:i,copy:o.updateInstallMode==="test-firmware"?`Testfirmware-installatie is gestart voor ${Fe()}.`:o.updateInstallMode==="connection-switch"?`Verbindingswissel naar ${et(o.updateInstallTargetConnection)} is gestart.`:o.updateInstallMode==="topology-switch"?`Opstellingswissel naar ${Fo(o.updateInstallTargetTopology)} is gestart.`:`OTA-update is gestart voor ${Fe()}.`}}function fo(e=he()||{}){let t=String(e.latest_version||"").trim();if(t)return t;let r=String(e.value||"").trim(),n=String(e.current_version||"").trim();return r&&r!==n&&/^v/i.test(r)?r:""}function le(e=he()||{}){let t=String(o.entities.projectVersionText?.state||o.entities.projectVersionText?.value||"").trim();return t||String(e.current_version||"").trim()}function oy(e=he()||{}){let t=le(e),r=String(e.current_version||"").trim();return!t||!r||t===r?!1:bn(t,r)>0}function nl(e=he()||{},t=mo()){let r=String(t||"").trim().toLowerCase(),n=String(e.release_url||"").trim().toLowerCase(),a=fo(e).toLowerCase();if(!r||r==="\u2014")return!0;if(r==="dev"){if(n){if(n.includes("/dev-latest"))return!0;if(a)return a.includes("-dev")}return a?a.includes("-dev"):!1}if(r==="main"){if(n){if(n.includes("/dev-latest"))return!1;if(a)return!a.includes("-dev")}return a?!a.includes("-dev"):!1}return!0}function fp(e){let r=String(e||"").trim().match(/^v?(\d+)\.(\d+)\.(\d+)(?:-([A-Za-z]+)(?:\.(\d+))?)?/);return r?{major:Number(r[1]),minor:Number(r[2]),patch:Number(r[3]),prereleaseTag:r[4]||"",prereleaseNumber:r[5]?Number(r[5]):null}:null}function bn(e,t){let r=fp(e),n=fp(t);if(!r||!n)return 0;if(r.major!==n.major)return r.major>n.major?1:-1;if(r.minor!==n.minor)return r.minor>n.minor?1:-1;if(r.patch!==n.patch)return r.patch>n.patch?1:-1;let a=!r.prereleaseTag,i=!n.prereleaseTag;return a!==i?a?1:-1:r.prereleaseTag!==n.prereleaseTag?r.prereleaseTag>n.prereleaseTag?1:-1:r.prereleaseNumber!==n.prereleaseNumber?(r.prereleaseNumber||0)>(n.prereleaseNumber||0)?1:-1:0}function Sr(){if(ol())return!1;let e=La();return o.updateInstallBusy||e==="installing"||e==="in_progress"||e==="updating"||e.includes("install")}function rt(){let e=La();return o.updateCheckBusy||e==="checking"||e==="check"||e==="checking_for_update"||e.includes("checking")}function Ko(){let e=La();if(!nl())return!1;let t=yp();return t!==null?t>0:e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")?!1:e==="available"||e==="pending"||e.includes("available")?!0:Tt().updateAvailable===!0}function al(){let e=La();return e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")||oy()}function il(){let e=he()||{},t=le(e)||"\u2014",r=nl(e)?fo(e):"",n=r?bn(r,t):null;return!rt()&&n!==null&&n<=0&&(r=""),{current:t,latest:r||"\u2014"}}function yp(){let{current:e,latest:t}=il();return e==="\u2014"||t==="\u2014"?null:bn(t,e)}function wp(e=mo()){let t=String(e||"").trim().toLowerCase();return Di[t]||Di.main}function ry(){let e=String((he()||{}).release_url||"").trim(),t=wp();return!e||t.includes("/dev-latest")&&!e.includes("/dev-latest")||!t.includes("/dev-latest")&&e.includes("/dev-latest")?t:e}function ny(){return Fe()}function mo(){return String(E("firmwareUpdateChannel")||o.entities.releaseChannelText?.state||o.entities.releaseChannelText?.value||"\u2014").trim()||"\u2014"}function ay(){return il().latest!=="\u2014"}function hp(e){return String(e||"").toLowerCase().replace(/wi[\s-]?fi/g,"wifi").replace(/[^a-z0-9]+/g,"")}function iy(e,t=he()||{}){let r=hp(e);return r?hp(`${t.title||""} ${t.summary||""}`).includes(r):!0}function Sp(e){return new Promise(t=>window.setTimeout(t,e))}function vn(e=Ao){let r=Date.now()+e;o.firmwareOtaQuietUntil=Math.max(Number(o.firmwareOtaQuietUntil||0),r),o.pendingEntitySyncOptions=null,Uu(),typeof xt=="function"&&xt(),o.firmwareOtaQuietTimer&&window.clearTimeout(o.firmwareOtaQuietTimer),o.firmwareOtaQuietTimer=window.setTimeout(()=>{o.firmwareOtaQuietTimer=null,o.firmwareOtaQuietUntil=0,!o.updateInstallBusy&&!o.nativeOpen&&ss()},e)}function sy(){o.firmwareOtaQuietTimer&&(window.clearTimeout(o.firmwareOtaQuietTimer),o.firmwareOtaQuietTimer=null),o.firmwareOtaQuietUntil=0,o.nativeOpen||ss()}function qp(){return o.deviceReconnectMode?`
    ...
    `}function Cp(){if(!o.updateModalOpen)return"";let e=he(),t=o.entities.firmwareUpdateChannel||null,{current:r,latest:n}=il(),a=rt(),i=Sr(),l=Ko(),c=ly(),p=zt(),u=rl(),d=ry(),b=u?"Firmware-update afgerond":p||i?"Firmware-update bezig":a?"Controleren op firmware-update":ny(),y=t?Array.isArray(t.option)?t.option:Array.isArray(t.options)?t.options:[]:[],h=Da(),g=Na(),m=!!(h&&!u),v=!!(g&&!u);return`
  ...
  `}function Wp(e){o.overviewTheme=e==="dark"?"dark":"light";try{window.localStorage.setItem("oq-overview-theme",o.overviewTheme)}catch{}}function Wa(e){o.interfacePanelOpen=e===!0}function ul(e){try{window.localStorage.setItem("oq-active-surface",e==="native"?"native":"app")}catch{}}function Cn(e,t={}){o.settingsGroup=De.has(e)?e:me[0].id;try{window.localStorage.setItem("oq-settings-group",o.settingsGroup)}catch{}t.syncUrl!==!1&&o.appView==="settings"&&Lo(t.syncMode||"replace")}function Vp(e){o.devPanelOpen=e===!0;try{window.localStorage.setItem("oq-dev-panel-open",o.devPanelOpen?"true":"false")}catch{}}function Bp(e){o.hpVisualMode=e==="compact"?"compact":"schematic";try{window.localStorage.setItem("oq-hp-visual-mode",o.hpVisualMode)}catch{}}function Kp(e){o.hpLayoutMode=e==="focus-hp1"||e==="focus-hp2"?e:"equal";try{window.localStorage.setItem("oq-hp-layout-mode",o.hpLayoutMode)}catch{}}function xy(e){if(o.reducedMotion=!!e?.matches,o.reducedMotion){sn();return}an()}function $y(){let e=Gi();!e||o.motionPreferenceMedia===e||(o.motionPreferenceMedia=e,o.motionPreferenceListener=xy,typeof e.addEventListener=="function"?e.addEventListener("change",o.motionPreferenceListener):typeof e.addListener=="function"&&e.addListener(o.motionPreferenceListener),o.reducedMotion=!!e.matches)}function My(){return Object.keys(o.entities).length>0}function Hy(){return Ui+Math.floor(Math.random()*(fu-Ui+1))}function Ay(){return(document.hidden?Xr:lu)+Hy()}function zp(e=Ay()){o.pollTimer||o.nativeOpen||o.updateInstallBusy||wa()||(o.pollTimer=window.setTimeout(async()=>{o.pollTimer=null,await ue(),zp()},e))}function dl(){zp()}function pl(){o.pollTimer&&(window.clearTimeout(o.pollTimer),o.pollTimer=null)}zu({start:dl,stop:pl});function Ry(){o.nativeOpen||(pl(),dl(),document.hidden||ue({forceProbe:!0}))}function Va(e={}){if(En(),o.nativeOpen){pl(),sn(),o.nativeFrontendLoaded||Ba();return}if(an(),dl(),e.refresh!==!1){if(!My()){jd();return}ue({forceFast:!0})}}function Py(){let e=cn()||no(),t=e==="settings"?gs()||o.settingsGroup:"",r=e==="control"?ds()||"status":o.controlReplayTab,n=e==="control"?ps()||"last24":o.controlReplayWindow,a=e==="control"?ms():null;if(!(e===o.appView&&(e!=="settings"||t===o.settingsGroup)&&(e!=="control"||r===o.controlReplayTab&&n===o.controlReplayWindow&&(!a||a.start===o.controlReplayCustomStart&&a.end===o.controlReplayCustomEnd)))){if(o.appView=e,e==="control"&&(o.controlReplayTab=r,o.controlReplayWindow=n,o.controlReplayCustomStart=a?.start||"",o.controlReplayCustomEnd=a?.end||"",o.controlReplayPeriodMenuOpen=!1,o.controlReplayCustomPeriodOpen=!1,o.controlReplayCustomPeriodError=""),e==="settings"&&t){o.settingsGroup=t;try{window.localStorage.setItem("oq-settings-group",o.settingsGroup)}catch{}}f(),ue({forceFast:!0})}}function En(){o.nativeApp&&(o.nativeApp.classList.add("oq-native-app"),o.nativeApp.classList.toggle("oq-native-app--collapsed",!o.nativeOpen),o.nativeApp.setAttribute("aria-hidden",o.nativeOpen?"false":"true"))}function Up(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",jp,{once:!0}):jp(),window.addEventListener("pointermove",ed),window.addEventListener("pointerup",td),window.addEventListener("popstate",Py),window.addEventListener("oq-mock-updated",Dy),window.addEventListener("oq-dev-controls-changed",Ny),document.addEventListener("visibilitychange",Ry)}function Dy(){o.mounted&&ue({forceDecisionLog:!0})}function Ny(){o.mounted&&f()}function jp(){Ly();let e=document.querySelector("esp-app");e||(e=document.createElement("esp-app"),document.body.appendChild(e)),o.nativeApp=e,o.nativeFrontendLoaded=Array.from(document.scripts).some(t=>t.src===Ni),o.mounted||(Oy(e),o.mounted=!0,Va()),En(),o.nativeOpen||(ue(),kn({silent:!0}))}function Ly(){if(!document.head)return;let e=document.head.querySelector('meta[name="viewport"]');e||(e=document.createElement("meta"),e.name="viewport",document.head.appendChild(e)),e.setAttribute("content","width=device-width, initial-scale=1")}function Oy(e){let t=document.createElement("section");t.id="oq-helper-root",t.lang="nl-NL",document.documentElement&&!document.documentElement.lang&&(document.documentElement.lang="nl-NL"),e.parentNode.insertBefore(t,e),t.addEventListener("click",Yu),t.addEventListener("change",Qu),t.addEventListener("input",Ju),t.addEventListener("keydown",Zu),t.addEventListener("wheel",nd,{passive:!1}),t.addEventListener("focusin",ls),t.addEventListener("focusout",ls),t.addEventListener("mouseover",rd),t.addEventListener("mouseout",od),t.addEventListener("pointerdown",Xu),o.root=t,$y();let r=cn()||no(),n=r==="settings"?gs():"",a=r==="control"?ds():"",i=r==="control"?ps():"",l=r==="control"?ms():null;n&&Cn(n,{syncUrl:!1}),a&&(o.controlReplayTab=a),i&&(o.controlReplayWindow=i,o.controlReplayCustomStart=l?.start||"",o.controlReplayCustomEnd=l?.end||""),pt(r,{syncMode:"replace",forceSync:!0}),nn(),f()}function _y(e){return new Promise((t,r)=>{if(!e){t();return}let n=Array.from(document.scripts).find(i=>i.src===e);if(n){if(n.dataset.loaded==="true"){t();return}n.addEventListener("load",()=>t(),{once:!0}),n.addEventListener("error",i=>r(i),{once:!0});return}let a=document.createElement("script");a.src=e,a.async=!1,a.addEventListener("load",()=>{a.dataset.loaded="true",t()},{once:!0}),a.addEventListener("error",i=>r(i),{once:!0}),document.head.appendChild(a)})}async function Ba(){if(!(o.nativeFrontendLoaded||o.nativeFrontendLoading)){o.nativeFrontendLoading=!0,o.nativeOpen&&f();try{await _y(Ni),o.nativeFrontendLoaded=!0}catch(e){o.controlError=`ESPHome fallback kon niet worden geladen. ${e.message||e}`,o.nativeOpen=!1,ul("app"),f(),Va()}finally{o.nativeFrontendLoading=!1,o.nativeOpen&&f()}}}function ml(){if(!o.root)return;let e=typeof window<"u"?window.__OQ_DEV_CONTROLS__:null;!e||typeof e.bind!="function"||e.bind(o.root)}function Tn(){let e=o.authStatus;return e?e.enabled?e.setup_window_active?"Instelvenster":"Beveiligd":"Onbeveiligd":"Laden..."}function Fy(){return"Login"}function Iy(){let e=o.authStatus;return e?e.enabled?"De web-app vraagt nu een login voordat beheer beschikbaar is. Je kunt die hier aanpassen of uitzetten.":"De web-app staat open op je netwerk. Houd de herstelknop 5 seconden vast om een login toe te voegen.":"We halen de huidige loginstatus op."}function xn(){let e=o.authStatus;return e?e.enabled?e.setup_window_active?"Login actief. Tijdelijk instelvenster is open.":`Login actief${e.source?` via ${e.source}`:""}.`:e.setup_window_active?"Login uit. Tijdelijk instelvenster is open.":"Login uit. Webtoegang is open / onbeveiligd op het netwerk.":"Logingegevens laden..."}function Tr(){let e=o.apiSecurityStatus;return e?e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active?"Herstart nodig":e.transport_active===!0?"Aan":e.transport_active===!1?"Uit":e.enabled?"Aan":"Uit":"Laden..."}function xr(){let e=o.apiSecurityStatus;return e?e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active?e.enabled===!0&&e.transport_active===!1?"API-encryptie wordt ingeschakeld na herstart. Kopieer de sleutel nu voor Home Assistant.":e.enabled===!1&&e.transport_active===!0?"API-encryptie wordt uitgeschakeld na herstart. Tot die tijd blijft de native API beveiligd.":e.key?"Deze wijziging wordt actief na herstart. De sleutel blijft opgeslagen voor later gebruik.":"Deze wijziging wordt actief na herstart.":e.transport_active===!0?"API-encryptie staat aan. Gebruik dezelfde sleutel in Home Assistant.":"De native API staat nu open op je lokale netwerk.":"API-encryptie wordt geladen."}function jy(){return"ESPHome API encryption"}function Wy(){let e=o.apiSecurityStatus;return e?e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active?e.enabled===!0&&e.transport_active===!1?"API-encryptie wordt ingeschakeld na herstart. Kopieer de sleutel nu alvast voor Home Assistant.":e.enabled===!1&&e.transport_active===!0?"API-encryptie wordt uitgeschakeld na herstart. Tot die tijd blijft de native API nog beveiligd.":"Deze wijziging wordt actief na herstart. Je kunt de sleutel hier bekijken, kopi\xEBren of vernieuwen.":e.transport_active===!0?"De native API is beveiligd. Je kunt de sleutel hier bekijken, kopi\xEBren of vernieuwen.":"API-encryptie staat uit. Schakel in om een sleutel te bekijken, kopi\xEBren of vernieuwen.":"We halen de huidige API-beveiliging op."}function Vy(){let e=o.apiSecurityStatus;if(!e)return"Laden...";let t=!!(e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active);return t&&e.enabled===!0&&e.transport_active===!1?"Annuleer inschakelen":t&&e.enabled===!1&&e.transport_active===!0?"Annuleer uitschakelen":e.enabled?"Uitschakelen":"Inschakelen"}function By(){let e=o.apiSecurityStatus;return e?e.key?"Vernieuw sleutel":"Genereer sleutel":"Laden..."}function Gp(e,t,r="",n=!1){return`
    ...
    `}function Xp(){let e=w("boilerCvAssistEnabled")&&T("boilerCvAssistEnabled"),t=xa(),r=T("cm100Active"),n=String(t||"").trim().toUpperCase(),a=Go(t),i=!a&&(r||n==="CM100 READY"),l=o.commissioningTaskLock==="cm100",c=o.loadingEntities||o.busyAction==="commissioningCm100Start"||o.busyAction==="commissioningCm100Stop"||l,p=!!o.pendingCommissioningCm100Start,u=c||i||a,d=c||!i,b=jo("boilerPowerTestStatus","IDLE"),y=Ka(b,"boiler"),h=T("boilerPowerTestActive"),g=o.loadingEntities||o.busyAction==="boilerPowerTestStart"||o.busyAction==="boilerPowerTestAbort"||o.busyAction==="boilerPowerTestApply",m=!!(o.entities.boilerPowerTestStart||o.entities.boilerPowerTestAbort||o.entities.boilerPowerTestApply),v=!!o.pendingBoilerPowerTestStart,S=o.commissioningTaskLock==="boiler",q=Go(b),k=!ke(b)&&(h||v||S||$r(b))&&!q,$=Te("boilerRatedHeatPower"),D=Te("boilerHeatPower"),N=R("boilerHeatPower"),W=N>0?D:k&&o.commissioningBoilerHeatPowerDisplay?o.commissioningBoilerHeatPowerDisplay:D;N>0&&(o.commissioningBoilerHeatPowerDisplay=D);let H=jo("flowAutotuneStatus","IDLE"),U=Ka(H,"autotune"),A=o.loadingEntities||o.busyAction==="flowAutotuneStart"||o.busyAction==="flowAutotuneAbort"||o.busyAction==="flowAutotuneApply",I=!!(o.entities.flowAutotuneStart||o.entities.flowAutotuneAbort||o.entities.flowAutotuneApply),L=!!o.pendingFlowAutotuneStart,P=o.commissioningTaskLock==="autotune",Z=Go(H),j=!ke(H)&&(L||P||$r(H))&&!Z,X=jo("airPurgeStatus","IDLE"),We=Ka(X,"purge"),yt=T("airPurgeActive"),ct=o.loadingEntities||o.busyAction==="airPurgeStart"||o.busyAction==="airPurgeAbort",Dt=!!(o.entities.airPurgeStart||o.entities.airPurgeAbort),Ue=!!o.pendingAirPurgeStart,Re=o.commissioningTaskLock==="purge",x=!ke(X)&&(yt||Ue||Re||$r(X)),V=/DONE/.test(String(X||"").toUpperCase()),G=!!(Dt||o.entities.airPurgeStatus||o.entities.airPurgeReturnToAuto),ee=Te("airPurgeRemaining",{decimals:0}),ie=R("airPurgePhase"),be=ie===1?"Rustig":ie===2?"Pulsen":ie===3?"Stabiliseren":We.phase,re=jo("manualFlowStatus","IDLE"),xe=T("manualFlowActive"),ve=o.loadingEntities||o.busyAction==="manualFlowStart"||o.busyAction==="manualFlowAbort",ce=!!(o.entities.manualFlowStart||o.entities.manualFlowAbort),Nt=!!o.pendingManualFlowStart,de=o.commissioningTaskLock==="manual-flow",Pe=!ke(re)&&(xe||Nt||de||$r(re)),Ve=jo("manualHpStatus","IDLE"),Ge=T("manualHpActive"),Qe=o.loadingEntities||o.busyAction==="manualHpStart"||o.busyAction==="manualHpAbort",Co=!!(o.entities.manualHpStart||o.entities.manualHpAbort),ye=!!o.pendingManualHpStart,wt=o.commissioningTaskLock==="manual-hp",Ye=!ke(Ve)&&(Ge||ye||wt||$r(Ve)),Yn=/SAFETY STOP/.test(String(Ve||"").toUpperCase()),Jn=/STOPPING/.test(String(Ve||"").toUpperCase()),St=jo("hpWaterCalibrationStatus","IDLE"),Hi=Ka(St,"hp-water-calibration"),Zn=T("hpWaterCalibrationActive"),ar=o.loadingEntities||o.busyAction==="hpWaterCalibrationStart"||o.busyAction==="hpWaterCalibrationAbort"||o.busyAction==="hpWaterCalibrationApply",zc=!!(o.entities.hpWaterCalibrationStart||o.entities.hpWaterCalibrationAbort||o.entities.hpWaterCalibrationApply),Xn=!!o.pendingHpWaterCalibrationStart,Jt=o.commissioningTaskLock==="hp-water-calibration",Be=!ke(St)&&(Zn||Xn||Jt||$r(St)),ea=/DONE|APPLIED/.test(String(St||"").toUpperCase()),Uc=/APPLIED/.test(String(St||"").toUpperCase()),Th=Te("flowKpSuggested",{decimals:5,trimTrailingZeros:!0}),xh=Te("flowKiSuggested",{decimals:5,trimTrailingZeros:!0}),Gc=/DONE|APPLIED/.test(String(b||"").toUpperCase()),Qc=/DONE|APPLIED/.test(String(H||"").toUpperCase()),Ai=i?q?"Wachten op CM100":k?y.phase:Gc?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",Ri=i?Z?"Wachten op CM100":j?U.phase:Qc?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",Pi=i?x?We.phase:V?"Klaar":"Klaar om te starten":"Wachten op CM100",Yc=i?Pe?"Actief":"Klaar om te starten":"Wachten op CM100",Jc=i?Ye?Jn?"Bezig met stoppen":Yn?"Veiligheidsstop":"Actief":"Klaar om te starten":"Wachten op CM100",Zc=i?Be?Hi.phase:Uc?"Offsets toegepast":ea?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",Xc=!i||g||!m||j||x||Pe||Ye||Be||k||P||Re||de||wt||Jt||v,$h=g||!(k||S||v),Mh=g||Xc||!Gc||j||x||Be,eu=!i||A||!I||k||x||Pe||Ye||Be||j||S||Re||de||wt||Jt||L,Hh=A||!(j||P||L),Ah=A||eu||!Qc||k||x||Be,Rh=!i||ct||!Dt||k||j||Pe||Ye||Be||x||S||P||de||wt||Jt||Ue,Ph=ct||!(x||Re||Ue),Dh=!i||ve||!ce||k||j||x||Ye||Be||Pe||S||P||Re||wt||Jt||Nt,Nh=ve||!(Pe||de||Nt),Lh=!i||Qe||!Co||k||j||x||Pe||Be||Ye||S||P||Re||de||Jt||ye,Oh=Qe||!(Ye||wt||ye),_h=!i||ar||!zc||k||j||x||Pe||Ye||Be||S||P||Re||de||wt||Xn,Fh=ar||!(Be||Jt||Xn),Ih=ar||Be||!ea||Uc;p&&i&&(o.pendingCommissioningCm100Start=!1),l&&(i||/READY|STOPPED|DONE|FAILED|ABORT|APPLIED|REFUSED/.test(n))&&(o.commissioningTaskLock=""),v&&(h||ke(b))&&(o.pendingBoilerPowerTestStart=!1),S&&ke(b)&&(o.commissioningTaskLock=""),L&&ke(H)&&(o.pendingFlowAutotuneStart=!1),P&&ke(H)&&(o.commissioningTaskLock=""),Ue&&(yt||ke(X))&&(o.pendingAirPurgeStart=!1),Re&&ke(X)&&(o.commissioningTaskLock=""),Nt&&(xe||ke(re))&&(o.pendingManualFlowStart=!1),de&&(xe||ke(re))&&(o.commissioningTaskLock=""),ye&&(Ge||ke(Ve))&&(o.pendingManualHpStart=!1),wt&&(Ge||ke(Ve))&&(o.commissioningTaskLock=""),Xn&&(Zn||ke(St))&&(o.pendingHpWaterCalibrationStart=!1),Jt&&ke(St)&&(o.commissioningTaskLock="");let jh=a?"Wachten op CM100":t,Wh=a?"Service-stand wordt geopend. Wacht tot CM100 klaar staat.":i?"CM100 is actief en klaar voor service-taken.":"Start de service-stand voordat je een taak uitvoert.",Vh=[{key:"hp-water-calibration",title:"Temperatuursensoren kalibreren",label:"Sensor kalibratie",summary:"Laat de waterpomp draaien zonder compressor en bepaal offsets voor HP1/HP2 water in/out.",status:Zc,available:!!(zc||o.entities.hpWaterCalibrationStatus),openDisabled:!i,cardMarkup:Mr({taskKey:"hp-water-calibration",title:"Temperatuursensoren kalibreren",copy:"Doorloop voorbereiding, meting en toepassen in vaste volgorde. De meting stopt eerder zodra de sensoren stabiel genoeg zijn.",subcopy:"De voorgestelde waarden worden pas actief wanneer je ze toepast; supply blijft een diagnosewaarde.",status:Zc,statusCopy:Be?"De pomp draait en de firmware wacht op een stabiel temperatuurbeeld.":ea?"Controleer de voorgestelde offsets voordat je ze toepast.":i?"CM100 staat klaar. Start de meting wanneer compressor en boiler uit zijn.":"Start CM100 eerst.",progressTask:"hp-water-calibration",controls:Uy({status:St,running:Be,resultReady:ea,startDisabled:_h,abortDisabled:Fh,applyDisabled:Ih,busy:ar,controlsAvailable:!!(o.entities.hpWaterCalibrationStart||o.entities.hpWaterCalibrationAbort)}),className:"oq-settings-commissioning-card--hp-water-calibration"})},{key:"manual-flow",title:"Handmatige flowregeling",label:"Handmatige flow",summary:"Laat de waterpomp draaien op een tijdelijk flow-setpoint en luister naar het leidingwerk.",status:Yc,available:!!(ce||o.entities.manualFlowStatus),openDisabled:!i,cardMarkup:Mr({taskKey:"manual-flow",title:"Handmatige flowregeling",copy:"Gebruik een tijdelijk flow-setpoint om het leidingwerk rustig te controleren. De normale instellingen wijzigen pas wanneer je een waarde bewust overneemt.",subcopy:"De bestaande PI-regeling blijft de pomp aansturen.",status:Yc,statusCopy:Pe?"De waterpomp draait. Pas het tijdelijke setpoint aan en controleer de gemeten flow.":i?"CM100 staat klaar. Kies een tijdelijk setpoint en start de waterpomp.":"Start CM100 eerst.",progressTask:"",controls:`
            <div class="oq-settings-manual-flow-control">
              ...
              ${o.entities.manualFlowStart||o.entities.manualFlowAbort?Wo({active:Pe,startKey:"manualFlowStart",stopKey:"manualFlowAbort",startLabel:"Waterpomp starten",stopLabel:"Waterpomp stoppen",startDisabled:ve||Dh,stopDisabled:ve||Nh}):""}
            </div>
          `,metrics:`
        ...
        `},{key:"manual-hp",title:"Handmatige warmtepompbediening",label:"Handmatige warmtepomp",summary:"Selecteer een werkmodus en vraag per warmtepomp een compressorstand aan binnen de bestaande bewaking.",status:Jc,available:!!(Co||o.entities.manualHpStatus),openDisabled:!i,cardMarkup:Mr({taskKey:"manual-hp",title:"Handmatige warmtepompbediening",copy:"Start eerst de service-taak zodat de waterpomp draait. Zodra voldoende flow is gemeten kun je per warmtepomp vanuit Standby naar verwarmen of koelen schakelen en daarna een compressorstand aanvragen.",subcopy:"Low-flow, maximale watertemperatuur, minimum draaitijd, minimum uit-tijd en veilige modusovergangen blijven actief. De koelvloer, silent-modus, dag/nacht-cap en normaal uitgesloten compressorstanden worden voor deze handmatige test bewust genegeerd.",status:Jc,statusCopy:Ye?Jn?"De compressorvraag staat op 0. De waterpomp blijft draaien totdat de minimale draaitijd veilig is afgerond.":Yn?"De bewaking heeft de aangevraagde standen teruggezet naar 0. Controleer de oorzaak voordat je opnieuw opschaalt.":"De service-taak is actief. Een veiligheidsstop zet de aangevraagde standen terug naar 0; opnieuw opschalen vereist een bewuste handeling.":i?"CM100 staat klaar. Start de taak om handmatige warmtepompbediening vrij te geven.":"Start CM100 eerst.",progressTask:"",actions:`
          ...
          `,metrics:`
            ${He("boilerHeatPower","Actueel vermogen","Live meting tijdens de boiler-test.",W)}
          ...
          `})}].filter(Bh=>Bh.available);return{cm100Status:jh,cm100StartDisabled:u,cm100StopDisabled:d,serviceStatusCopy:Wh,tasks:Vh}}function Gy(e){return Ne({dataAttribute:"data-oq-service-task",dataValue:e.key,className:"oq-settings-service-row",label:e.label,value:e.status,note:e.summary,action:`<button
          class="oq-helper-button oq-helper-button--ghost"
          type="button"
      ...
      <div class="oq-ph-concept-card">
        <div class="oq-ph-concept-visual">
          ...
          <svg class="oq-ph-concept-svg" viewBox="0 0 ${c} ${p}" role="img" aria-label="Grafiek voor Power House tuning">
            ...
            ${W?`<line x1="${D}" y1="${h-12}" x2="${D}" y2="${h+12}" class="oq-ph-concept-marker oq-ph-concept-marker--above"></line>`:""}
            ...
            ${W?`<circle cx="${D}" cy="${h}" r="5" class="oq-ph-concept-point oq-ph-concept-point--above"></circle>`:""}
            ${N?I(k,"Comfort onder setpoint",K(i,1,"\xB0C"),"below"):""}
            ${I($,"Setpoint",K(20,1,"\xB0C"),"setpoint")}
            ${W?I(D,"Comfort boven setpoint",K(l,1,"\xB0C"),"above"):""}
            ...
            ${N?`<text x="${k-5}" y="${p-14}" text-anchor="end" class="oq-ph-concept-tick-value">${s(K(i,1,"\xB0C"))}</text>`:""}
            <text x="${$}" y="${p-14}" text-anchor="middle" class="oq-ph-concept-tick-value oq-ph-concept-tick-value--setpoint">${s(K(20,1,"\xB0C"))}</text>
            ${W?`<text x="${D+5}" y="${p-14}" text-anchor="start" class="oq-ph-concept-tick-value">${s(K(l,1,"\xB0C"))}</text>`:""}
          </svg>
        </div>
...
Kenmerken: Flowmeter in de buitenunit ge\xEFntegreerd. Onder CV-ketel enkel een kleine clip-on temperatuursensor.`}},t=o.entities.hpGeneration||{},r=String(E("hpGeneration")||""),n=Wt(t),a=o.loadingEntities||o.busyAction==="save-hpGeneration";return`
    ...
    `}function vg(){let e=ft(),t=o.entities.hpGeneration||{},r=w("hpGeneration")&&Wt(t).length>0;return!e&&!r?"":oe("Basis","Quatt Hybrid-versie","Kies hier welke Quatt Hybrid je hebt. Deze keuze bepaalt de basis van de regeling.",`
      ...
      `)}function Sg(){let e=go(),t=Ta(),r=o.busyAction==="restartAction";return oe("Diagnostiek","Systeemstatus","Snelle statusinformatie voor support, controle en onderhoud.",`
        <div class="oq-settings-system-summary">
          ...
          ${Ne({dataValue:"debugRecording",label:"Debugopname",value:Sn(),note:Ia(),action:`<button
              class="oq-helper-button oq-helper-button--ghost"
              type="button"
              data-oq-action="open-debug-recording-modal"
            >
    ...
    `:"";return oe("Integratie","OpenTherm & CIC-polling","Configureer de directe thermostaatbus, externe CIC-feed en Quatt app-compatibiliteit.",`
        ...
        ${h}
      `)}function Dg(){if(!Qr.some(M=>w(M)))return"";let t=Et("cicPollingEnabled"),r=Et("otEnabled"),n=(M={})=>M.haValueKey||(M.haKeys||[]).find(x=>!/valid$/i.test(x))||"",a=(M={})=>M.haValidKey||(M.haKeys||[]).find(x=>/valid$/i.test(x))||"",i=(M="",x="")=>!!M&&!!x&&w(M)&&w(x)&&J(x),l=(M={})=>i(n(M),a(M)),c={mqttCoolingDewPoint:"cooling_dew_point",mqttOutsideTemperature:"outside_temperature",mqttRoomTemperature:"room_temperature",mqttRoomSetpoint:"room_setpoint",mqttHeatingEnable:"heating_enable",mqttCoolingEnable:"cooling_enable"},p=(M={})=>M.mqttTopicKey||c[M.valueKey]||"",u=(M="")=>{if(!M)return!0;let x=o.mqttStatus?.input_enabled;return x&&typeof x=="object"&&Object.prototype.hasOwnProperty.call(x,M)?x[M]!==!1:!0},d=M=>/\bMQTT\b/i.test(String(M||"")),b=(M,x={})=>M==="CIC"?t:M==="OT thermostat"?r:M==="HA input"?l(x):M==="CIC or HA input"?t||l(x):d(M)?u(p(x)):M==="Flowmeter HP2"?w("hp2Flow"):M==="Local aggregate HP1/HP2"?w("flowLocal")||w("hp2Flow"):!0,y=(M,x={})=>M==="CIC"&&!t?"CIC-polling staat uit":M==="OT thermostat"&&!r?"OpenTherm staat uit":M==="HA input"&&!l(x)?"HA-bron ongeldig":M==="CIC or HA input"&&!t&&!l(x)?"CIC en HA ontbreken":d(M)&&!u(p(x))?"MQTT-topic staat uit":M==="Flowmeter HP2"&&!w("hp2Flow")?"HP2-flow ontbreekt":M==="Local aggregate HP1/HP2"&&!w("flowLocal")&&!w("hp2Flow")?"Lokale flow ontbreekt":"",h=(M,x="Actief",V="Normaal")=>w(M)?J(M)?x:V:"",g=(M,x={})=>{let V=String(M||"").trim();return V?x.optionLabels?.[V]||Se(V):""},m=(M,x={})=>{let V=String(E(M)||"").trim();return V?g(V,x):""},v=M=>{let x=Io(M,"");return x?Se(x):""},S=M=>{let x=String(Io(M,"")||"").trim();return!x||x==="None"?"":Se(x)},q=(...M)=>M.find(x=>String(x||"").trim())||"",C=()=>{let M=m("waterSupplySource");if(String(E("waterSupplySource")||"")==="Local"&&w("localWaterSupplyTempSource")){let x=m("localWaterSupplyTempSource");return x?`${M} - ${x}`:M}return M},k=()=>{let M=String(E("flowSource")||"").trim();if(M==="Outdoor unit"){if(w("qFlowSource")){let x=String(E("qFlowSource")||"").trim(),V=String(E("hpGeneration")||"").trim();return x==="Local"||x==="Auto"&&V==="V1"?x==="Auto"?"Lokaal (auto)":"Lokaal":q(m("outdoorUnitFlowMode"),x==="Auto"?"Buitenunit (auto)":"Buitenunit")}return q(m("outdoorUnitFlowMode"),"Quatt-flow")}return Se(M)},$=()=>{let M=String(E("outsideTempSource")||"").trim();if(M==="MQTT"&&!u("outside_temperature"))return"MQTT-topic staat uit";if(M!=="Auto")return Se(M);let x=R("outsideTempLocalAggregated"),V=R("outsideTempHa"),G=R("mqttOutsideTemperature"),ee=!Number.isNaN(x),ie=w("outsideTempHaValid")?J("outsideTempHaValid")&&!Number.isNaN(V):!Number.isNaN(V),be=u("outside_temperature")&&w("mqttOutsideTemperatureValid")&&J("mqttOutsideTemperatureValid")&&!Number.isNaN(G),re=[ee?{label:"Buitenunit",value:x}:null,ie?{label:"HA-invoer",value:V}:null,be?{label:"MQTT",value:G}:null].filter(Boolean);return re.length?re.reduce((xe,ve)=>ve.value<xe.value?ve:xe,re[0]).label:"Auto"},D=M=>{if(!w(M))return NaN;let x=Number(E(M));if(Number.isFinite(x))return x;let G=String(o.entities[M]?.state??"").trim().replace(",",".").match(/-?\d+(?:\.\d+)?/);return G?Number(G[0]):NaN},N=(M,x="")=>{if(!w(M))return!1;let V=D(M);return(x?J(x):!0)&&Number.isFinite(V)},W=()=>{let M=String(E("coolingDewPointSource")||"").trim();if(M==="Home Assistant")return N("coolingDewPointHa","coolingDewPointHaValid")?"HA-invoer":"HA-invoer ontbreekt";if(M==="MQTT")return u("cooling_dew_point")?N("mqttCoolingDewPoint","mqttCoolingDewPointValid")?"MQTT":"MQTT ontbreekt of verouderd":"MQTT-topic staat uit";let x=N("coolingDewPointHa","coolingDewPointHaValid"),V=u("cooling_dew_point")&&N("mqttCoolingDewPoint","mqttCoolingDewPointValid");if(x&&V){let G=D("coolingDewPointHa");return D("mqttCoolingDewPoint")>G?"MQTT":"HA-invoer"}return x?"HA-invoer":V?"MQTT":M?Se(M):"Auto"},H=({label:M,value:x="",key:V="",active:G=!1,status:ee="",statusTone:ie="",statusTitle:be=""})=>{let re=x||(V?Te(V):"");if(!re&&!ee)return"";let xe=String(ie||"").replace(/[^a-z0-9_-]/gi,""),ve=be||ee,ce=ee?`<em class="oq-settings-source-status${xe?` oq-settings-source-status--${s(xe)}`:""}" title="${s(ve)}" aria-label="${s(`${ee}: ${ve}`)}">${s(ee)}</em>`:"";return`
        <div class="oq-settings-source-row${G?" is-warning":""}${ee?" has-status":""}">
          <span>${s(M)}${ce}</span>
          <strong>${s(re)}</strong>
        </div>
      `},U=({label:M="HA-invoer",valueKey:x="",validKey:V="",value:G=""})=>{if(!x||!V||!w(x)||!w(V))return[];let ee=J(V);return[H({label:M,key:x,value:G,status:ee?"Geldig":"Ongeldig",statusTone:ee?"valid":"invalid",statusTitle:ee?"Home Assistant geeft dit signaal geldig door. OpenQuatt mag deze HA-invoer gebruiken.":"Home Assistant geeft dit signaal niet geldig door. OpenQuatt gebruikt deze HA-invoer dan niet als bron."})]},A=({label:M="MQTT",valueKey:x="",validKey:V="",value:G="",topicKey:ee=""})=>{if(!x||!V||!w(x)||!w(V))return[];if(!u(ee||c[x]))return[];let ie=J(V),be=ie?"MQTT heeft een geldige, recente waarde ontvangen. OpenQuatt mag deze MQTT-invoer gebruiken.":"MQTT heeft nog geen geldige recente waarde ontvangen. OpenQuatt gebruikt deze MQTT-invoer dan niet als bron.";return[H({label:M,key:x,value:ie?G:"\u2014",status:Ms(V),statusTone:ie?"valid":"invalid",statusTitle:be})]},I=({title:M,icon:x="",content:V="",rows:G=[],copy:ee="",className:ie=""})=>{let be=G.filter(Boolean).join("");return!V&&!be&&!ee?"":`
    ...
    `:"";return oe("Integratie","MQTT inputbronnen","Beheer de brokerverbinding voor externe MQTT-bronwaarden.",`
      ...
      `)}function Og(){let e=De.has(o.settingsGroup)?o.settingsGroup:me[0].id;return`
    ...
    `}function Dq({tooltip:e,...t}){return`${kc(t)}${Un({bind:t.bind,...e})}`}function Nq({bind:e,ariaLabel:t,x:r,y:n,width:a,height:i,rx:l,tooltip:c}){return`
    ...
    `}function qi(){let e=typeof te=="function"?te():"";return nu.filter(t=>e==="single"&&t.title==="HP2"?!1:w(t.keys.power))}function Dc(e){return!Array.isArray(e)||e.length<2||o.hpVisualMode!=="schematic"?"equal":o.hpLayoutMode==="focus-hp1"||o.hpLayoutMode==="focus-hp2"?o.hpLayoutMode:"equal"}function yi(e,t,r){return!Array.isArray(t)||t.length<2?"normal":r==="focus-hp1"?e===0?"focus":"muted":r==="focus-hp2"?e===1?"focus":"muted":"normal"}function Ec(e,t,r){return!Array.isArray(t)||t.length<2||o.hpVisualMode!=="schematic"?null:yi(e,t,r)==="focus"?{layout:"equal",label:"Toon beide"}:{layout:e===0?"focus-hp1":"focus-hp2",label:"Vergroot"}}function ff(e){return!Array.isArray(e)||e.length!==1?Dc(e):Rc()?"equal":"single"}function Kq(e="plus"){return`
    ...
    `}function M1(e){let t=tr(e.primaryReason),r=kf({primaryReason:e.primaryReason,source:e.hp1Running&&e.hp2Running?"HP1 + HP2":e.hp1Running?"HP1":e.hp2Running?"HP2":"Geen bron"}),n=!!e.coolingProtection,a=!!e.coolingCapped,i=e.primaryReason==="restart_wait",l=e.primaryReason==="sticky_protection",c=n?i?"Wacht op veilige herstart":"Koeling tijdelijk beperkt":a?"Koeling met ingesteld maximum":l?"Geen comfortvraag actief":"Geen beperking actief",p=n?i?"De koelvraag blijft aanwezig. De warmtepomp start opnieuw zodra de veilige marge voldoende is hersteld.":"De aanvoer blijft boven de veilige grens. Daarom koelt het systeem tijdelijk minder hard.":a?"Dit is normale koeling binnen de ingestelde softwaregrens. Dauwpunt en waterflow blijven wel gewoon bewaakt.":l?"Alleen de pomp draait kort. De warmtepompen blijven uit en er worden geen compressorstarts geteld.":"Ontdooien, minimum rusttijd, dauwpunt en waterflow blijven bewaakt. Ze verschijnen hier zodra ze gedrag begrenzen.",u=n?[["Dauwpunt bewaakt","limited","droplet"],[`Max. niveau ${e.cooling.allowedMax}`,"info","target"],[`Nu niveau ${e.cooling.limitedDemand}`,"context","bar-chart"]]:a?[[`Ingesteld max. ${e.cooling.allowedMax}`,"info","target"],[`Nu niveau ${e.cooling.limitedDemand}`,"normal","bar-chart"],["Marge bewaakt","context","shield"]]:l?[["Korte pomprun","normal","shield"],["Geen koelvraag","context","snowflake"],["Geen warmtepompstart","info","activity"]]:[["Ontdooien vrij","normal","snowflake"],["Rusttijd vrij","normal","activity"],["Waterflow bewaakt","info","waves"]],d=[["Aanvoer",e.supplyTemp],["Buiten",e.outsideTemp],["Flow",e.flow],["Strategie",e.strategyLabel]];return(e.cooling.requestActive||n||a)&&(d.push(["Dauwpunt",e.cooling.dewPoint]),d.push(["Veilige min.",e.cooling.safeSupply])),`
        ...
        <div class="oq-working-status-grid">
          <section class="oq-working-status-main">
            ...
            <div class="oq-working-reason-list">
              ${t.checks.map(b=>`<span>${$e("target","oq-working-reason-icon")} ${s(b)}</span>`).join("")}
            </div>
          </section>

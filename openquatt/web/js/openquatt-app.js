  ...
  `}function Ds(e){if(!e||typeof document>"u")return;let t=e.querySelector('[role="dialog"][aria-modal="true"]');if(t){Fa=t.closest("[data-oq-modal]")?.dataset.oqModal||"dialog",t.contains(document.activeElement)||(t.querySelector(".oq-helper-modal-close, button, input, select, textarea, a[href]")||t).focus({preventScroll:!0});return}Fa&&bw(e,Ns)?.focus({preventScroll:!0}),Fa="",Ns=null}var _s=0;function $d(e){let t=e?.querySelector('[role="dialog"][aria-modal="true"]');return t?{modalId:String(e.dataset?.oqModal||""),titleId:String(t.getAttribute("aria-labelledby")||"")}:null}function xd(e,t){return!e||!t?null:Array.from(e.querySelectorAll("[data-oq-modal]")).find(r=>{let n=$d(r);return n&&n.modalId===t.modalId&&n.titleId===t.titleId})||null}function ww(e,t){if(!e||!t?.contains(e)||typeof e.getAttribute!="function")return null;let r=Array.from(e.attributes||[]).filter(({name:l,value:c})=>(c||l.startsWith("data-oq-"))&&(l==="id"||l==="name"||l==="aria-label"||l.startsWith("data-oq-"))).map(({name:l,value:c})=>[l,c]);if(!r.length)return null;let n=String(e.tagName||"").toLowerCase(),i=Array.from(t.querySelectorAll(n)).filter(l=>r.every(([c,u])=>l.getAttribute(c)===u)).indexOf(e);return i<0?null:{tagName:n,attributes:r,index:i}}function Md(e,t){return!e||!t?null:Array.from(e.querySelectorAll(t.tagName)).filter(n=>t.attributes.every(([a,i])=>n.getAttribute(a)===i))[t.index]||null}function yw(e,t){if(!e||!t?.contains(e)||typeof e.getBoundingClientRect!="function")return null;let r=e.getBoundingClientRect(),n=Number(r?.top);return Number.isFinite(n)?{top:n}:null}function vw(e){return[e,...e.querySelectorAll("[data-oq-modal-scroll]")].map(t=>({key:String(t.dataset?.oqModalScroll||"backdrop"),left:Number(t.scrollLeft||0),top:Number(t.scrollTop||0)}))}function Sw(e,t){if(!e)return;let r=[e,...e.querySelectorAll("[data-oq-modal-scroll]")];t.forEach(n=>{let a=r.find(i=>String(i.dataset?.oqModalScroll||"backdrop")===n.key);a&&(a.scrollLeft=n.left,a.scrollTop=n.top)})}function qw(e,t,r){if(!e||!t||!r||typeof t.getBoundingClientRect!="function")return;let n=Number(t.getBoundingClientRect()?.top);if(!Number.isFinite(n))return;let a=n-r.top;if(Math.abs(a)<.5)return;let i=[e,...e.querySelectorAll("[data-oq-modal-scroll]")].reverse().find(l=>l.contains(t)&&Number(l.scrollHeight)>Number(l.clientHeight));i&&(i.scrollTop+=a)}function Ad(e){if(!e||typeof document>"u")return null;let n=((typeof document.activeElement?.closest=="function"?document.activeElement.closest("[data-oq-modal]"):null)?.querySelector('[role="dialog"][aria-modal="true"]')||e.querySelector('[role="dialog"][aria-modal="true"]'))?.closest("[data-oq-modal]"),a=$d(n);return!n||!a?null:{identity:a,focus:ww(document.activeElement,n),focusAnchor:yw(document.activeElement,n),scrollPositions:vw(n)}}function Ls(e,t){let r=_s+1;if(_s=r,!e||!t)return;let n=()=>{if(_s!==r)return;let l=xd(e,t.identity);Sw(l,t.scrollPositions);let c=Md(l,t.focus);qw(l,c,t.focusAnchor)},a=xd(e,t.identity);n();let i=Md(a,t.focus);i&&!i.disabled&&(i.focus({preventScroll:!0}),n()),window.requestAnimationFrame(n)}function Cn(){o.root&&(o.root.style.removeProperty("--oq-flow-offset"),o.root.style.removeProperty("--oq-flow-offset-reverse"),o.root.style.removeProperty("--oq-fan-rotation"),o.root.getAttribute("style")||o.root.removeAttribute("style"))}function Hd(){return o.motionTargets={pipeFlows:[],fanBlades:[]},o.root?(o.root.querySelectorAll(".oq-hp-schematic-board.is-running").forEach(n=>{n.querySelectorAll(".oq-hp-tech-pipe-flow").forEach(a=>{o.motionTargets.pipeFlows.push(a)})}),o.root.querySelectorAll(".oq-hp-schematic-board.is-water-flowing:not(.is-running)").forEach(n=>{n.querySelectorAll('.oq-hp-tech-pipe-flow[data-oq-flow-variant="water"]').forEach(a=>{o.motionTargets.pipeFlows.push(a)})}),o.root.querySelectorAll(".oq-hp-schematic-board.is-fan-running").forEach(n=>{n.querySelectorAll(".oq-hp-tech-fan-blades").forEach(a=>{o.motionTargets.fanBlades.push(a)})}),o.motionTargets.pipeFlows.length+o.motionTargets.fanBlades.length):0}function kw(){return o.motionTargets.pipeFlows.length>0||o.motionTargets.fanBlades.length>0}function Rd(e=performance.now()){if(!o.root||o.reducedMotion||!kw()&&Hd()===0)return!1;o.motionStartedAt||(o.motionStartedAt=e);let t=(e-o.motionStartedAt)/1e3,r=t*ed%360;return o.motionTargets.pipeFlows.forEach(n=>{let a=n.dataset.oqFlowVariant==="water"?.42:1,i=-(t*Xu*a);n.style.strokeDashoffset=`${i.toFixed(3)}px`}),o.motionTargets.fanBlades.forEach(n=>{n.style.transform=`rotate(${r.toFixed(3)}deg)`}),!0}function Pd(e){if(!Rd(e)){o.motionFrame=0,o.motionStartedAt=0;return}o.motionFrame=window.requestAnimationFrame(Pd)}function Go(){if(o.reducedMotion||Hd()===0||o.motionFrame)return;let e=performance.now();if(o.motionStartedAt=e,!Rd(e)){o.motionStartedAt=0;return}o.motionFrame=window.requestAnimationFrame(Pd)}function xn(){o.motionFrame&&(window.cancelAnimationFrame(o.motionFrame),o.motionFrame=0),o.motionStartedAt=0,Cn()}var Nd=null,Dd=null;function _d({start:e,stop:t}={}){Nd=typeof e=="function"?e:null,Dd=typeof t=="function"?t:null}function Os(){Nd?.()}function Ld(){Dd?.()}var Ke={};function Od(e={}){Object.keys(Ke).forEach(t=>{delete Ke[t]}),Object.assign(Ke,e)}function Id(e){Ke.handleChange?.(e)}function Fd(e){Ke.handleClick?.(e)}function Is(e){Ke.handleFocusChange?.(e)}function jd(e){Ke.handleInput?.(e)}function Wd(e){Ke.handleKeyDown?.(e)}function Vd(e){Ke.handlePointerDown?.(e)}function Bd(e){Ke.handlePointerMove?.(e)}function Kd(e){Ke.handlePointerUp?.(e)}function zd(e){Ke.handleSettingsInteractionEnd?.(e)}function Ud(e){Ke.handleSettingsInteractionStart?.(e)}function Gd(e){Ke.handleWheel?.(e)}function yo(){return"overview"}function Mn(e){return e==="trends"&&(e="diagnosis"),!Iu.has(e)||e==="diagnosis"&&!yt()?"":e}function Nr(e){return String(e||"").trim().toLowerCase()}function Fs(e){let t=Nr(e);return{actueel:"status",current:"status",status:"status",situatie:"status",tijdlijn:"timeline",timeline:"timeline",log:"timeline",grafiek:"graphs",grafieken:"graphs",graphs:"graphs",graph:"graphs"}[t]||""}function Ew(e=o.controlReplayTab){let t={status:"current",timeline:"timeline",graphs:"graphs"};return t[e]||t.status}function js(e){let t=Nr(e);return{"1h":"last1",last1:"last1","2h":"last2",last2:"last2","4h":"last4",last4:"last4","8h":"last8",last8:"last8","12h":"last12",last12:"last12","24h":"last24",last24:"last24","48h":"last48",last48:"last48","3d":"last3d",last3d:"last3d","7d":"week",week:"week",today:"today",yesterday:"yesterday",custom:"custom"}[t]||""}function Tw(e=o.controlReplayWindow){let t={last1:"1h",last2:"2h",last4:"4h",last8:"8h",last12:"12h",last24:"24h",last48:"48h",last3d:"3d",today:"today",yesterday:"yesterday",week:"7d",custom:"custom"};return t[e]||t.last24}function $n(){try{let e=new URL(window.location.href),t=Nr(e.searchParams.get("view")||""),r=Mn(t);if(r)return r;let n=Nr(e.hash.replace(/^#/,""));return Mn(n)||""}catch{return""}}function Ws(){try{let e=new URL(window.location.href);return Fs(e.searchParams.get("controlTab")||e.searchParams.get("controlView")||"")}catch{return""}}function Vs(){try{let e=new URL(window.location.href);return js(e.searchParams.get("controlPeriod")||"")}catch{return""}}function Bs(){try{let e=new URL(window.location.href);return{start:String(e.searchParams.get("controlStart")||""),end:String(e.searchParams.get("controlEnd")||"")}}catch{return{start:"",end:""}}}function Ks(){try{let e=new URL(window.location.href),t=Nr(e.searchParams.get("section")||"");if(Le.has(t))return t;let r=Nr(e.searchParams.get("group")||"");return Le.has(r)?r:""}catch{return""}}function Qo(e="replace"){try{let t=new URL(window.location.href),r=Mn(o.appView)||yo();if(t.searchParams.set("view",r),r==="settings"){let a=Le.has(o.settingsGroup)?o.settingsGroup:fe[0].id;t.searchParams.set("section",a),t.searchParams.delete("group")}else t.searchParams.delete("section"),t.searchParams.delete("group");r==="control"?(t.searchParams.set("controlTab",Ew()),t.searchParams.set("controlPeriod",Tw()),o.controlReplayWindow==="custom"&&o.controlReplayCustomStart&&o.controlReplayCustomEnd?(t.searchParams.set("controlStart",o.controlReplayCustomStart),t.searchParams.set("controlEnd",o.controlReplayCustomEnd)):(t.searchParams.delete("controlStart"),t.searchParams.delete("controlEnd")),t.searchParams.delete("controlView")):(t.searchParams.delete("controlTab"),t.searchParams.delete("controlPeriod"),t.searchParams.delete("controlStart"),t.searchParams.delete("controlEnd"),t.searchParams.delete("controlView")),t.hash&&Mn(t.hash.replace(/^#/,""))&&(t.hash="");let n=e==="push"?"pushState":"replaceState";window.history[n]({oqView:r,oqSettingsSection:r==="settings"?o.settingsGroup:"",oqControlTab:r==="control"?o.controlReplayTab:"",oqControlPeriod:r==="control"?o.controlReplayWindow:""},"",t.toString())}catch{}}function Nt(e,t={}){let r=Mn(e)||yo(),n=t.syncMode||"replace",a=o.appView!==r;o.appView=r,(a||t.forceSync)&&Qo(n)}function ja(e=Date.now()){return Number(o.firmwareOtaQuietUntil||0)>e}var Cw=new Set(["compressor oil return"]);function vo(e){let t=String(e||"").trim();return!t||t==="None"?"Geen actieve storingen":t}function xw(e){let t=vo(e);return t==="Geen actieve storingen"?[]:t.split(",").map(r=>r.trim()).filter(r=>r&&!Cw.has(r.toLowerCase()))}function Wa(e){let t=xw(e);return t.length>0?t.join(", "):"Geen actieve storingen"}function X(e){return v(e)&&C(e)}function Dt(e){return!v(e)||C(e)}function Us(e){return v(e)?vo(j(e,"None")):""}function zs(e){return v(e)?Wa(j(e,"None")):""}function An(e){let t=zs(e).trim().toLowerCase();return!!t&&t!=="geen actieve storingen"}function eo(){let e=[],t=X("compressorCyclingWarning2h")||X("compressorCyclingWarning72h")||X("alternatingCompressorStartsWarning"),r=X("compressorCyclingAlertLatched"),n=Dt("cicPollingEnabled"),a=Dt("otEnabled"),i=(c,u)=>{X(c)&&e.push({key:c,label:u})};i("compressorCyclingWarning2h","Te veel compressorstarts in 2 uur"),i("compressorCyclingWarning72h","Te veel compressorstarts in 72 uur"),i("alternatingCompressorStartsWarning","Warmtepompen starten opvallend vaak om en om"),i("lowflowFaultActive","Te lage flow"),i("flowMismatch","Flowverschil tussen warmtepomp 1 en 2"),n&&i("cicDataStale","CIC-data is verouderd"),a&&i("otLinkProblem","OpenTherm-verbinding meldt een probleem"),An("hp1Failures")&&e.push({key:"hp1Failures",label:`Warmtepomp 1: ${zs("hp1Failures")}`}),An("hp2Failures")&&e.push({key:"hp2Failures",label:`Warmtepomp 2: ${zs("hp2Failures")}`});let l=e.length;return r&&!t&&e.unshift({key:"compressorCyclingAlertLatched",label:"Pendelen eerder gedetecteerd; melding nog niet bevestigd"}),{problems:e,active:e.length>0,cyclingAlertLatched:r,cyclingAlertActive:t,cyclingAlertRecovered:r&&!t,title:l>0?"Aandacht nodig":r?"Eerdere waarschuwing nog niet bevestigd":"Geen bijzonderheden",copy:l>0?`${e.length} aandachtspunt${e.length===1?"":"en"} zichtbaar. Bekijk hieronder de details.`:r?"Het pendelen is hersteld. De melding blijft zichtbaar totdat je haar bevestigt.":"OpenQuatt ziet op dit moment geen actieve aandachtspunten in de bewaakte signalen."}}function Hn(e){let t=e.active?e.problems.map(r=>r.key).sort().join("|"):"";if(!t){o.installationMonitoringProblemSignature="";return}t!==o.installationMonitoringProblemSignature&&(o.installationMonitoringProblemSignature=t,o.installationMonitoringDetailsOpen=!0)}var Gs=null,Qs=null;function Qd({getSignature:e,patch:t}={}){Gs=typeof e=="function"?e:null,Qs=typeof t=="function"?t:null}function Yd(){return Gs?Gs():""}function Ys(){return Qs?Qs():!1}var Js=null;function Jd({patch:e}={}){Js=typeof e=="function"?e:null}function Zd(){return Js?Js():!1}var Dr=["trendHistoryEnabled","trendHistoryFlashEnabled","trendHistoryFlush","decisionLogHistoryEnabled","decisionLogHistoryFlush","decisionLogHistoryClear","lifetimeEnergyHistoryEnabled","lifetimeEnergyHourRetention","lifetimeEnergyHistoryCapture","lifetimeEnergyHistoryClear"],Zs=["trendHistoryEnabled","trendHistoryFlashEnabled"];var Xs=["lifetimeEnergyHistoryEnabled","lifetimeEnergyHourRetention","lifetimeEnergyHistoryCapture","lifetimeEnergyHistoryClear"];function to(){return[...new Set(Dr)]}var vt={};function Xd(e={}){vt={refreshEnergyHistoryData:typeof e.refreshEnergyHistoryData=="function"?e.refreshEnergyHistoryData:null,refreshSettingsStorageState:typeof e.refreshSettingsStorageState=="function"?e.refreshSettingsStorageState:null,refreshTrendHistoryData:typeof e.refreshTrendHistoryData=="function"?e.refreshTrendHistoryData:null,refreshTrendHistoryMetadata:typeof e.refreshTrendHistoryMetadata=="function"?e.refreshTrendHistoryMetadata:null,shouldRefreshSettingsStorageForCurrentSurface:typeof e.shouldRefreshSettingsStorageForCurrentSurface=="function"?e.shouldRefreshSettingsStorageForCurrentSurface:null}}function el(){return vt.shouldRefreshSettingsStorageForCurrentSurface?vt.shouldRefreshSettingsStorageForCurrentSurface():!1}async function ep(e={}){return vt.refreshTrendHistoryMetadata?vt.refreshTrendHistoryMetadata(e):!1}async function tp(e={}){return vt.refreshSettingsStorageState?vt.refreshSettingsStorageState(e):!1}async function tl(e={}){return vt.refreshTrendHistoryData?vt.refreshTrendHistoryData(e):!1}async function Va(e={}){return vt.refreshEnergyHistoryData?vt.refreshEnergyHistoryData(e):!1}var St={};function So(e={}){Object.entries(e).forEach(([t,r])=>{typeof r=="function"&&(St[t]=r)})}function op(){return St.patchEnergyDom?St.patchEnergyDom():!1}function rp(){return St.patchResultsDom?St.patchResultsDom():!1}function np(){return St.patchOverviewDom?St.patchOverviewDom():!1}function ol(){return St.patchControlReplayDom?St.patchControlReplayDom():!1}function ap(){return St.patchDiagnosisDom?St.patchDiagnosisDom():!1}var Yo={};function ip(e={}){Yo={clearOutput:typeof e.clearOutput=="function"?e.clearOutput:null,closeStream:typeof e.closeStream=="function"?e.closeStream:null,resetRecoveryState:typeof e.resetRecoveryState=="function"?e.resetRecoveryState:null}}function rl(){if(Yo.closeStream)return Yo.closeStream();let e=o.webServerLogSource;e&&e.close(),Qe({webServerLogSource:null,webServerLogConnected:!1})}function nl(){if(Yo.clearOutput)return Yo.clearOutput();Qe({webServerLogEntries:[],webServerLogError:"",webServerLogRaw:"",webServerLogNotice:""})}function al(){if(Yo.resetRecoveryState)return Yo.resetRecoveryState();rl(),Qe({webServerLogEnabled:null,webServerLogConnected:!1}),nl()}function sp(){let e=o.mqttStatus;return e?e.enabled&&e.connected?"Verbonden":e.enabled?"Ingeschakeld":e.broker?"Uit":"Niet ingesteld":"Laden..."}function lp(){let e=o.mqttStatus;if(!e)return"MQTT-status wordt geladen.";let t=String(e.broker||"").trim(),r=Number(e.port||1883),n=t?`${t}:${r}`:"geen broker";return e.enabled&&e.connected?`Verbonden met ${n}.`:e.enabled?t?`MQTT staat aan; verbinding met ${n} is nog niet bevestigd.`:"MQTT staat aan, maar er is nog geen broker ingesteld.":t?`Broker ${n} is opgeslagen, maar MQTT inputbronnen staan uit.`:"MQTT inputbronnen staan uit. Stel een broker in om externe bronwaarden te ontvangen."}function Mw(e,t=2){let r=R(e);return Number.isFinite(r)?`
    ...
    `:'<span class="oq-settings-mqtt-sensor-value-missing">Geen meting</span>'}function $w(e){if(!v(e.valueKey)||!C(e.validKey))return'<span class="oq-settings-mqtt-sensor-value-missing">Geen meting</span>';let t=e.activeLabel||"Toegestaan",r=e.inactiveLabel||"Geblokkeerd";return`<span class="oq-settings-mqtt-sensor-value-boolean">${s(C(e.valueKey)?t:r)}</span>`}function Aw(e){return e.kind==="binary"?$w(e):Mw(e.valueKey)}function Hw(e){let t=R(e);return Number.isFinite(t)?t<60?`${Math.round(t)} s`:t<3600?`${Math.round(t/60)} min`:`${Math.round(t/3600)} u`:"\u2014"}function il(e){return v(e)?C(e)?"Geldig":"Ontbreekt of verouderd":"Nog geen status"}function sl(e){let t=o.mqttStatus?.input_topics;if(t&&typeof t=="object"){let r=String(t[e]||"").trim();if(r)return r}return e==="cooling_dew_point"?String(o.mqttStatus?.dew_point_topic||"").trim():""}function Ba(e){let t=o.mqttStatus?.input_enabled;return t&&typeof t=="object"&&Object.prototype.hasOwnProperty.call(t,e)?t[e]!==!1:!0}function Rw(e){let t=o.mqttStatus?.input_retained;return!!(t&&typeof t=="object"&&t[e])}function ll(e){let t=o.mqttStatus?.input_accept_retained;return!!(t&&typeof t=="object"&&t[e])}function cp(){return[{topicKey:"cooling_dew_point",label:"Dauwpunt",valueKey:"mqttCoolingDewPoint",ageKey:"mqttCoolingDewPointAge",validKey:"mqttCoolingDewPointValid",staleCopy:"15 minuten",payloadInfoTitle:"Temperatuurpayload",payloadInfo:'Publiceer live een temperatuur in \xB0C. Voorbeelden: 16.2, 16,2, 16.2 \xB0C of {"value":16.2}. Geldig bereik: -20..35 \xB0C. Retained berichten worden niet gebruikt voor regeling.'},{topicKey:"outside_temperature",label:"Buitentemperatuur",valueKey:"mqttOutsideTemperature",ageKey:"mqttOutsideTemperatureAge",validKey:"mqttOutsideTemperatureValid",staleCopy:"30 minuten",payloadInfoTitle:"Temperatuurpayload",payloadInfo:'Publiceer live een temperatuur in \xB0C. Voorbeelden: 15.0, 15,0, 15.0 \xB0C of {"value":15.0}. Geldig bereik: -40..60 \xB0C. Retained berichten worden niet gebruikt voor regeling.'},{topicKey:"room_temperature",label:"Kamertemperatuur",valueKey:"mqttRoomTemperature",ageKey:"mqttRoomTemperatureAge",validKey:"mqttRoomTemperatureValid",staleCopy:"10 minuten",payloadInfoTitle:"Temperatuurpayload",payloadInfo:'Publiceer live een temperatuur in \xB0C. Voorbeelden: 21.1, 21,1, 21.1 \xB0C of {"value":21.1}. Geldig bereik: 0..50 \xB0C. Retained berichten worden niet gebruikt voor regeling.'},{topicKey:"room_setpoint",label:"Kamer setpoint",valueKey:"mqttRoomSetpoint",ageKey:"mqttRoomSetpointAge",validKey:"mqttRoomSetpointValid",staleCopy:"nieuw bericht",stateful:!0,payloadInfoTitle:"Temperatuurpayload",payloadInfo:'Publiceer een setpoint in \xB0C. Voorbeelden: 21.0, 21,0, 21.0 \xB0C of {"value":21.0}. Geldig bereik: 5..35 \xB0C.'},{topicKey:"heating_enable",label:"Warmtetoestemming",valueKey:"mqttHeatingEnable",ageKey:"mqttHeatingEnableAge",validKey:"mqttHeatingEnableValid",staleCopy:"nieuw bericht",kind:"binary",stateful:!0,payloadInfoTitle:"Booleanpayload",payloadInfo:'Publiceer warmtetoestemming als boolean. Geaccepteerd: true/false, 1/0, on/off, yes/no of {"value":true}.'},{topicKey:"cooling_enable",label:"Koeltoestemming",valueKey:"mqttCoolingEnable",ageKey:"mqttCoolingEnableAge",validKey:"mqttCoolingEnableValid",staleCopy:"nieuw bericht",kind:"binary",stateful:!0,payloadInfoTitle:"Booleanpayload",payloadInfo:'Publiceer koeltoestemming als boolean. Geaccepteerd: true/false, 1/0, on/off, yes/no of {"value":true}.'}]}function cl(e=cp()){if(!e.length)return"Geen sensoren";let t=e.filter(i=>Ba(i.topicKey)),r=e.length-t.length;if(!t.length)return`${r} ${r===1?"topic":"topics"} uitgeschakeld`;let n=t.filter(i=>C(i.validKey)).length,a=n===t.length?`${n} ${n===1?"sensor":"sensoren"} geldig`:`${n} van ${t.length} sensoren geldig`;return r?`${a} \xB7 ${r} uit`:a}function up(){let e=o.mqttStatus||{},t=!!o.mqttDraftEnabled,r=!!o.mqttDraftClearPassword,n=e.password_set?"Leeg laten om huidig wachtwoord te behouden":"Optioneel",a=o.mqttNotice?`<div class="oq-helper-modal-success oq-helper-modal-success--compact" aria-live="polite"><strong>Status</strong><span>${s(o.mqttNotice)}</span></div>`:"",i=o.mqttError?`<div class="oq-helper-modal-note oq-helper-modal-note--error" aria-live="assertive">${s(o.mqttError)}</div>`:"";return te({id:"system",titleId:"oq-mqtt-modal-title",kicker:"Integratie",title:"MQTT brokerconfiguratie",copy:"Stel de broker in waarop OpenQuatt MQTT-inputs beluistert.",closeAction:"close-system-modal",closeLabel:"Sluit MQTT brokerconfiguratie",body:`
        ...
        <article class="oq-settings-mqtt-sensor-row${d?" is-open":""}${g?"":" is-disabled"}">
          ...
          >
            ...
            <span class="oq-settings-mqtt-sensor-value">
              ${g?Aw(l):'<span class="oq-settings-mqtt-sensor-value-missing">\u2014</span>'}
            </span>
      ...
      `}).join(""),i=o.mqttError?`<div class="oq-helper-modal-note oq-helper-modal-note--error" aria-live="assertive">${s(o.mqttError)}</div>`:"";return te({id:"system",titleId:"oq-mqtt-sensors-modal-title",kicker:"Integratie",title:"MQTT sensoren",className:"oq-helper-modal--mqtt-sensors",headerMarkup:`<div class="oq-settings-mqtt-modal-head">
            <span class="oq-settings-mqtt-modal-icon">${Pw("oq-settings-mqtt-modal-logo")}</span>
            <div>
    ...
    `}function ul(e=o.mqttStatus||{}){let t=e.input_topics&&typeof e.input_topics=="object"?e.input_topics:{},r=e.input_enabled&&typeof e.input_enabled=="object"?e.input_enabled:{},n=e.input_retained&&typeof e.input_retained=="object"?e.input_retained:{},a=e.input_accept_retained&&typeof e.input_accept_retained=="object"?e.input_accept_retained:{};return[e.enabled?"on":"off",e.connected?"connected":"idle",String(e.broker||""),String(e.port||""),String(e.username||""),e.password_set?"password":"nopassword",String(e.dew_point_topic||""),JSON.stringify(t),JSON.stringify(r),JSON.stringify(n),JSON.stringify(a),String(e.non_retained_stateful_timeout_s||""),String(e.source||""),String(e.csrf_token||"")].join(":")}function Ka(){return[o.systemModal,o.mqttExpandedTopicKey||"",o.mqttCopiedTopicKey||"",o.mqttInputToggleBusyKey||"",o.mqttRetainedToggleBusyKey||"",o.mqttError||"",ul(),U("mqttCoolingDewPoint"),U("mqttCoolingDewPointAge"),U("mqttCoolingDewPointValid"),U("mqttOutsideTemperature"),U("mqttOutsideTemperatureAge"),U("mqttOutsideTemperatureValid"),U("mqttRoomTemperature"),U("mqttRoomTemperatureAge"),U("mqttRoomTemperatureValid"),U("mqttRoomSetpoint"),U("mqttRoomSetpointAge"),U("mqttRoomSetpointValid"),U("mqttHeatingEnable"),U("mqttHeatingEnableAge"),U("mqttHeatingEnableValid"),U("mqttCoolingEnable"),U("mqttCoolingEnableAge"),U("mqttCoolingEnableValid")].join("|")}function mp(){let e=o.mqttStatus||{};Pr({mqttDraftEnabled:e.enabled===!0,mqttDraftBroker:String(e.broker||""),mqttDraftPort:String(e.port||1883),mqttDraftUsername:String(e.username||""),mqttDraftPassword:"",mqttDraftClearPassword:!1,mqttDraftDirty:!1})}function gp(e){let t=e?.dataset?.oqMqttField;if(!t)return!1;if(Pr({mqttNotice:"",mqttError:"",mqttDraftDirty:!0}),t==="enabled")o.mqttDraftEnabled=!!e.checked;else if(t==="broker")o.mqttDraftBroker=String(e.value||"");else if(t==="port")o.mqttDraftPort=String(e.value||"");else if(t==="username")o.mqttDraftUsername=String(e.value||"");else if(t==="password")o.mqttDraftPassword=String(e.value||"");else if(t==="clear-password"){o.mqttDraftClearPassword=!!e.checked,o.mqttDraftClearPassword&&(o.mqttDraftPassword="");let r=e.closest(".oq-helper-modal")?.querySelector('[data-oq-mqtt-field="password"]');r&&(r.value=o.mqttDraftPassword,r.disabled=o.mqttBusy||o.mqttDraftClearPassword)}return e.closest(".oq-helper-modal")?.querySelectorAll(".oq-helper-modal-success, .oq-helper-modal-note--error").forEach(r=>{r.remove()}),!0}function fp(){return o.systemModal==="mqtt"||o.systemModal==="mqtt-sensors"||vd()}async function Jo(e={}){if(!En(o.lastMqttStatusRefreshAt,e))return!1;o.lastMqttStatusRefreshAt=Date.now();try{let t=await fetch("/mqtt/status",{cache:"no-store"});if(!t.ok)throw new Error(`HTTP ${t.status}`);let r=await t.json(),n=r.input_topics&&typeof r.input_topics=="object"?r.input_topics:{},a={};Object.entries(n).forEach(([d,b])=>{a[String(d)]=String(b||"")});let i=r.input_enabled&&typeof r.input_enabled=="object"?r.input_enabled:{},l={};Object.entries(i).forEach(([d,b])=>{l[String(d)]=b!==!1&&String(b).toLowerCase()!=="false"});let c=r.input_retained&&typeof r.input_retained=="object"?r.input_retained:{},u={};Object.entries(c).forEach(([d,b])=>{u[String(d)]=b===!0||String(b).toLowerCase()==="true"});let p=r.input_accept_retained&&typeof r.input_accept_retained=="object"?r.input_accept_retained:{},g={cooling_dew_point:!1,outside_temperature:!1,room_temperature:!1,room_setpoint:!0,heating_enable:!0,cooling_enable:!0};Object.entries(p).forEach(([d,b])=>{g[String(d)]=b===!0||String(b).toLowerCase()==="true"});let w=String(a.cooling_dew_point||r.dew_point_topic||"");a.cooling_dew_point=w;let y={enabled:!!r.enabled,connected:!!r.connected,broker:String(r.broker||""),port:Number(r.port||1883),username:String(r.username||""),password_set:!!r.password_set,dew_point_topic:w,input_topics:a,input_enabled:l,input_retained:u,input_accept_retained:g,non_retained_stateful_timeout_s:Number(r.non_retained_stateful_timeout_s||1800),source:String(r.source||""),csrf_token:String(r.csrf_token||"")},h=ul(),m=ul(y);return o.mqttStatus=y,h!==m&&(o.systemModal==="mqtt"&&o.mqttDraftDirty||mp(),o.mqttNotice=""),o.mqttError="",h!==m}catch(t){return o.mqttError=`MQTT-status kon niet worden geladen. ${t.message}`,!1}}async function pp(e="cooling_dew_point"){let t=sl(e);if(!t){o.mqttError="MQTT-topic is nog niet geladen.",o.mqttCopiedTopicKey="",f();return}try{let r=await ho(t);o.mqttNotice="",o.mqttError=r?"":"Kopi\xEBren is niet gelukt.",o.mqttCopiedTopicKey=r?e:"",o.mqttCopiedTopicTimer&&window.clearTimeout(o.mqttCopiedTopicTimer),r&&(o.mqttCopiedTopicTimer=window.setTimeout(()=>{o.mqttCopiedTopicKey="",o.mqttCopiedTopicTimer=null,o.systemModal==="mqtt-sensors"&&f()},1800))}catch(r){o.mqttError=`Kopi\xEBren is mislukt. ${r.message}`,o.mqttCopiedTopicKey=""}f()}async function Nw(e,t){let r=o.mqttStatus||{};if(!r.csrf_token){o.mqttError="MQTT-status wordt nog geladen. Probeer het zo opnieuw.",f();return}o.mqttInputToggleBusyKey=e,o.mqttNotice="",o.mqttError="",f();try{let n=new URLSearchParams;n.set("csrf_token",r.csrf_token),n.set("input",e),n.set("enabled",t?"true":"false");let a=await fetch("/mqtt/input/save",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:n}),i=await a.json().catch(()=>({}));if(!a.ok||i?.ok===!1)throw new Error(i?.error||`HTTP ${a.status}`);o.lastMqttStatusRefreshAt=0,await Jo({force:!0})}catch(n){o.mqttError=`MQTT-topic kon niet worden opgeslagen. ${n.message}`}finally{o.mqttInputToggleBusyKey===e&&(o.mqttInputToggleBusyKey=""),f()}}async function Dw(e,t){let r=o.mqttStatus||{};if(!r.csrf_token){o.mqttError="MQTT-status wordt nog geladen. Probeer het zo opnieuw.",f();return}o.mqttRetainedToggleBusyKey=e,o.mqttNotice="",o.mqttError="",f();try{let n=new URLSearchParams;n.set("csrf_token",r.csrf_token),n.set("input",e),n.set("accept_retained",t?"true":"false");let a=await fetch("/mqtt/input/retained/save",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:n}),i=await a.json().catch(()=>({}));if(!a.ok||i?.ok===!1)throw new Error(i?.error||`HTTP ${a.status}`);o.lastMqttStatusRefreshAt=0,await Jo({force:!0})}catch(n){o.mqttError=`Retained-instelling kon niet worden opgeslagen. ${n.message}`}finally{o.mqttRetainedToggleBusyKey===e&&(o.mqttRetainedToggleBusyKey=""),f()}}async function _w(){let e=o.mqttStatus||{},t=!!o.mqttDraftEnabled,r=String(o.mqttDraftBroker||"").trim(),n=String(o.mqttDraftPort||"").trim(),a=n?Number(n):t?0:1883,i=!t&&!r,l=i?"":String(o.mqttDraftUsername||"").trim(),c=i||!!o.mqttDraftClearPassword,u=c?"":String(o.mqttDraftPassword||"");if(!e.csrf_token){o.mqttError="MQTT-configuratie laadt nog. Probeer het zo opnieuw.",f();return}if((t||n)&&(!Number.isInteger(a)||a<1||a>65535)){o.mqttError="Vul een geldige poort in.",f();return}if(t&&!r){o.mqttError="Vul een broker in als je MQTT inschakelt.",f();return}o.mqttBusy=!0,o.mqttNotice="",o.mqttError="",f();try{let p=new URLSearchParams;p.set("csrf_token",e.csrf_token),p.set("enabled",t?"true":"false"),p.set("broker",r),p.set("port",String(a)),p.set("username",l),p.set("password",u),p.set("clear_password",c?"true":"false");let g=await fetch("/mqtt/save",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=UTF-8"},body:p.toString()}),w=await g.json().catch(()=>({ok:!1,error:"invalid_response"}));if(!g.ok||!w.ok)throw new Error(w.error||`HTTP ${g.status}`);o.mqttDraftDirty=!1,await Jo({force:!0}),o.mqttDraftPassword="",o.mqttDraftClearPassword=!1,o.mqttNotice=t?"MQTT-configuratie opgeslagen. De MQTT-verbinding wordt gestart.":"MQTT-configuratie opgeslagen.",o.mqttError="",f()}catch(p){o.mqttError=`Opslaan is mislukt. ${p.message}`,f()}finally{o.mqttBusy=!1,f()}}var Lw={"open-mqtt-modal":()=>(o.systemModal="mqtt",mp(),o.mqttDraftDirty=!1,o.mqttNotice="",o.mqttError="",f(),Jo({force:!0})),"open-mqtt-sensors-modal":()=>(o.systemModal="mqtt-sensors",o.mqttNotice="",o.mqttError="",o.mqttCopiedTopicKey="",o.mqttExpandedTopicKey="",o.mqttInputToggleBusyKey="",o.mqttRetainedToggleBusyKey="",f(),Jo({force:!0}).then(e=>{e&&o.systemModal==="mqtt-sensors"&&f()})),"toggle-mqtt-sensor-topic":e=>{let t=e.dataset?.oqMqttTopicKey||"cooling_dew_point";o.mqttExpandedTopicKey=o.mqttExpandedTopicKey===t?"":t,o.mqttError="",f()},"toggle-mqtt-input":e=>{let t=e.dataset?.oqMqttTopicKey||"cooling_dew_point";return Nw(t,!Ba(t))},"toggle-mqtt-retained":e=>{let t=e.dataset?.oqMqttTopicKey||"";if(t)return Dw(t,!ll(t))},"copy-mqtt-topic":e=>pp(e.dataset?.oqMqttTopicKey||"cooling_dew_point"),"copy-mqtt-dew-topic":e=>pp(e.dataset?.oqMqttTopicKey||"cooling_dew_point"),"save-mqtt-config":()=>_w()};function hp(e,t){return ie(Lw,e,t)}function Tp(){if(o.nativeOpen||o.appView!=="settings")return;let e=()=>{if(!(o.nativeOpen||o.appView!=="settings")){if(o.loadingEntities||o.focusedField||o.draggingCurveKey||o.busyAction||o.settingsInteractionLock){window.setTimeout(Tp,250);return}ye({prefetchView:"overview",forceFast:!0})}};if(typeof window.requestIdleCallback=="function"){window.requestIdleCallback(e,{timeout:2e3});return}window.setTimeout(e,0)}async function Cp(){if(o.nativeOpen||!fl()||o.overviewMetadataHydrated||o.overviewMetadataHydrating)return!1;let e=ty();if(!e.length)return o.overviewMetadataHydrated=!0,!1;o.overviewMetadataHydrating=!0;try{return await K(e,"all",{concurrency:Ut}),o.overviewMetadataHydrated=!0,!0}catch{return!1}finally{o.overviewMetadataHydrating=!1,o.mounted&&!o.nativeOpen&&f()}}async function Ow(e,t="state"){if(!(!e.length||o.nativeOpen)){o.entitySyncInFlight=!0;try{await K(e,t,{concurrency:t==="all"?Ut:Gt})}finally{o.entitySyncInFlight=!1;let r=o.pendingEntitySyncOptions;o.pendingEntitySyncOptions=null,r&&!o.nativeOpen&&window.setTimeout(()=>{ye(r)},0)}o.mounted&&!o.nativeOpen&&f()}}async function Iw(){if(!o.nativeOpen)try{fl()&&await Cp(),(o.appView==="overview"||o.appView==="control"||o.appView==="diagnosis")&&await tl({force:!0}),o.appView==="results"&&await Va({force:!0}),await zo({force:!0}),Zt()&&await Promise.all([Uo({force:!0}),tp({forceTrendHistory:!0,forceEnergyHistory:!0})])}finally{o.mounted&&!o.nativeOpen&&f(),Tp()}}async function xp(){if(o.nativeOpen)return;o.loadingEntities=!0,f();let e=jw();e>0&&await new Promise(i=>window.setTimeout(i,e));let t=Ty(),r=Cy(t),n=o.appView==="settings"?"all":"state";try{await K(t,n,{concurrency:n==="all"?Ut:Gt}),o.appView==="settings"?await ny():await ry()}finally{o.loadingEntities=!1,f()}let a=o.appView==="settings"?"all":"state";window.setTimeout(()=>{Ow(r,a)},Qw),Ap(ml())}var bp={installation:["hpGeneration","boilerCvAssistEnabled","boilerRatedHeatPower","flowControlMode","flowSetpoint","manualIpwm","silentStartTime","silentEndTime","maxWater","minRuntime"],service:["compressorStarts2hWarningLimit","compressorStarts72hWarningLimit","compressorCyclingWarning2h","compressorCyclingWarning72h","alternatingCompressorStartsWarning","commissioningStatus","cm100Active"],heating:["strategy"],cooling:["manualCoolingEnable","coolingWithoutDewPointMode"],integrations:["otEnabled","cicPollingEnabled","flowSource"],system:["setupComplete","projectVersionText","releaseChannelText","firmwareUpdateChannel","statusLedsEnabled","usageTelemetryEnabled"]},Fw={installation:["setupComplete","installationTopology","hpGeneration","boilerCvAssistEnabled","boilerRatedHeatPower",...rt,...Mr,...jo,...hs,...mn,...gn,"maxWater",...ka],service:[...fn,...xa,...mn,...gn,"boilerCvAssistEnabled","boilerRatedHeatPower","flowSelected","flowKp","flowKi"],heating:["strategy",...At,...Fo,"dayMax","silentMax"],cooling:["manualCoolingEnable","coolingWithoutDewPointMode","coolingDewPointSelected","coolingMinimumSafeSupplyTemp","coolingSupplyTarget","coolingSupplyError",...fs],integrations:[...us,...ps,...ds,...ms,...bn,...gs,...cs],system:["setupComplete",...Qt,"firmwareUpdateChannel","projectVersionText","releaseChannelText","statusLedsEnabled","usageTelemetryEnabled",...Dr,"webServerLogHistoryEnabled","debugLevel"]};function Zo(){return[...new Set(["setupComplete",...Aa])]}function jw(){return Number.isFinite(0),0}var Mp=["strategy","controlModeLabel","openquattEnabled","installationTopology","hpGeneration","totalPower","flowSelected","totalCop","manualCoolingEnable","coolingEnableSource","coolingEnableSelected","coolingEnableEffectiveSource","silentModeOverride","totalHeat","totalCoolingPower"],Ww=["strategy","controlModeLabel","hpGeneration","coolingEnableEffectiveSource"],Vw=["totalPower","flowSelected"],Bw=["totalHeat","totalCoolingPower"],Kw=2e3,zw=250,Uw=5e3,Gw=250;function pl(e=o.settingsGroup){let t=Le.has(e)?e:fe[0].id;return[...new Set(["setupComplete","strategy",...nt,...Fw[t]||[]])]}function $p(){let e=Le.has(o.settingsGroup)?o.settingsGroup:fe[0].id;return[...new Set(bp[e]||bp.installation)]}var Qw=1200,Yw=1800,Jw=0,Zw=3500;function dl(){return["setupComplete","strategy","usageTelemetryEnabled",...nt]}function Xw(){let e=new Set;return $a.forEach(t=>{(t.categories||[]).forEach(r=>{(r.groups||[]).forEach(n=>{(n.rows||[]).forEach(a=>{let i=Array.isArray(a)?a[1]:"";i&&e.add(i)})})})}),[...e]}function Rn(e,t={}){let r=t.forceFast===!0,n=t.includeBulk===!0;return e==="energy"||e==="results"?[...new Set([...dl(),...e==="energy"?Mp:[],...Xw(),...e==="results"?Xs:[]])]:[...new Set([...dl(),...r||!n?bs:wn,...e==="control"?Wu:[],...e==="diagnosis"?Zs:[]])]}function ml(e=o.appView){return e==="diagnosis"||e==="results"||e==="settings"&&Zt()?Jw:Yw}function Ap(e=ml()){o.nativeOpen||(o.supplementaryPrimeTimer&&window.clearTimeout(o.supplementaryPrimeTimer),o.supplementaryPrimeTimer=window.setTimeout(()=>{o.supplementaryPrimeTimer=null,Iw()},e))}function ey(e={}){let t=o.pendingEntitySyncOptions||{},r={...t,...e};t.forceBulk||e.forceBulk?(r.forceBulk=!0,r.forceFast=!1):(t.forceFast||e.forceFast)&&(r.forceFast=!0),o.pendingEntitySyncOptions=r}function gl(e){let t=String(T(e)??"").trim().toLowerCase();return t!==""&&t!=="unknown"&&t!=="unavailable"&&t!=="nan"}function wp(e){return gl(e)&&Number.isFinite(Re(T(e)))}function fl(){return o.appView==="overview"||o.appView==="diagnosis"||o.appView==="energy"}function ty(){return Vu.filter(e=>{let t=o.entities[e];return t?!String(t.uom??t.unit_of_measurement??"").trim():!O[e]?.optional})}function yp(){return fl()?Ww.every(gl)&&Vw.every(wp)&&Bw.some(wp):!0}function oy(){return o.appView==="settings"}function vp(){return oy()?$p().every(e=>O[e]?.optional&&!o.entities[e]?!0:gl(e)):!0}async function ry(){if(yp())return;let e=Date.now()+Kw;for(;!o.nativeOpen&&!yp()&&Date.now()<e;){await new Promise(t=>window.setTimeout(t,zw));try{await K(Mp,"state")}catch{return}}}async function ny(){if(vp())return;let e=Date.now()+Uw;for(;!o.nativeOpen&&!vp()&&Date.now()<e;){await new Promise(t=>window.setTimeout(t,Gw));try{await K($p(),"all")}catch{return}}}var ay=8e3,Hp=3e3,iy="/openquatt/entities",sy=900,ly="/openquatt/service/status",cy="/openquatt/decision-log",uy=15e3;function hl(){return o.deviceReconnectMode||o.busyAction==="restartAction"||o.updateInstallBusy||o.updateInstallPhaseHint?Hp:ay}function bl(e){let t=String(e||"").toLowerCase();return t.includes("failed to fetch")||t.includes("load failed")||t.includes("networkerror")||t.includes("network request failed")||t.includes("connection refused")||t.includes("connection reset")||t.includes("err_connection")||t.includes("timeout")}var dy=300*1e3;function py(){if(o.optionalMissingEntities)for(let e of Object.keys(o.optionalMissingEntities))delete o.optionalMissingEntities[e]}function Sp(){let e=Date.now();o.lastEntitySyncAt=e,o.lastEntitySyncSuccessAt=e,o.entitySyncFailureCount=0,!!o.deviceReconnectMode&&typeof Rs=="function"&&Rs()&&(o.lastFastEntitySyncAt=0,o.lastBulkEntitySyncAt=0,o.lastStaticEntitySyncAt=0,o.trendHistoryRaw="",o.trendHistoryError="",o.trendHistorySignature="",o.trendHistoryNowMs=Number.NaN,o.trendHistoryLastFetchAt=0,o.decisionLog=null,o.decisionLogError="",o.decisionLogSignature="",o.decisionLogLastFetchAt=0,typeof al=="function"?al():(rl(),nl(),Qe({webServerLogEnabled:null,webServerLogConnected:!1})),py())}function Rp(e){if(!bl(e)){o.entitySyncFailureCount=0,Ps();return}o.entitySyncFailureCount=Number(o.entitySyncFailureCount||0)+1,o.deviceReconnectLastError=String(e||""),(o.deviceReconnectMode||o.busyAction==="restartAction"||o.updateInstallBusy||o.updateInstallPhaseHint||o.entitySyncFailureCount>=2)&&wo(o.updateInstallBusy||o.updateInstallPhaseHint?"ota":o.busyAction==="restartAction"?"restart":"reconnect",e)}function my(e=Date.now(),t={}){if(t.forceProbe===!0||o.deviceReconnectMode||o.busyAction==="restartAction"||o.updateInstallBusy||o.updateInstallPhaseHint||Number(o.entitySyncFailureCount||0)>0)return!0;let r=Number(o.lastEntitySyncSuccessAt||o.lastEntitySyncAt||o.lastEntityResponseAt||0);if(!r)return!0;let n=document.hidden?yn:Qu;return e-r>=n}async function gy(){let e=O.status||O.setupComplete;if(!e)return{ok:!0,message:""};let t=o.deviceReconnectMode?Hp:Gu,r=J(e.domain,e.name);try{let n=await qn(r,{cache:"no-store"},t,`${e.name} request timed out after ${t}ms`);return o.lastEntityResponseAt=Date.now(),{ok:n.ok||n.status===404,message:n.ok||n.status===404?"":`${e.name} HTTP ${n.status}`}}catch(n){return{ok:!1,message:n.message||String(n)}}}function fy(e,t=Date.now()){let r=o.optionalMissingEntities?.[e];return!O[e]?.optional||!r?!1:t-Number(r)<dy}function hy(e,t=Date.now()){o.optionalMissingEntities&&(o.optionalMissingEntities[e]=t)}function by(e){let t=O[e];return t?`${e}	${t.domain}	${t.name}`:""}function qp(e,t){let r=new URLSearchParams;return r.set("detail",t==="all"?"all":"state"),r.set("entities",e.join(`
`)),r.toString()}function wl(e,t){let r=[],n=[],a=[],i="";return e.forEach(l=>{let c=by(l);if(!c)return;let u=[...a,c],p=qp(u,t);if(a.length&&p.length>sy){r.push({keys:n,body:i}),n=[l],a=[c],i=qp(a,t);return}n=[...n,l],a=u,i=p}),a.length&&r.push({keys:n,body:i}),r}async function wy(e){let t=hl(),r={method:"POST",cache:"no-store",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:e.body},n=await qn(iy,r,t,`bulk entities request timed out after ${t}ms`);if(!n.ok)throw new Error(`bulk entities HTTP ${n.status}`);return n.json()}async function yy(){let e=hl(),r=await qn(ly,{cache:"no-store",headers:{"Cache-Control":"no-store"}},e,`service status request timed out after ${e}ms`);if(!r.ok)throw new Error(`service status HTTP ${r.status}`);return r.json()}async function vy(){let e=hl(),r=await qn(cy,{cache:"no-store",headers:{"Cache-Control":"no-store"}},e,`decision log request timed out after ${e}ms`);if(!r.ok)throw new Error(`decision log HTTP ${r.status}`);return r.json()}function Sy(e={}){let t=Array.isArray(e.events)?e.events:[],r=Array.isArray(e.buckets)?e.buckets:[],n=t[0]||{},a=t[t.length-1]||{},i=r[r.length-1]||{};return[e?.meta?.event_count??t.length,e?.meta?.dropped_count??0,t.length,n.seq??"",a.seq??"",a.uptime_s??"",e?.meta?.boot_epoch_s??"",n.epoch_s??"",a.epoch_s??"",r.length,i.hour_start_uptime_s??"",i.hour_start_epoch_s??"",i.source??"",i.attention_count??"",e?.meta?.flash_write_count??""].join("|")}async function qy(e={}){if(o.appView!=="control")return!1;let t=e.force===!0,r=Date.now();if(!t&&o.decisionLogFetchPromise)return o.decisionLogFetchPromise;if(!t&&(o.decisionLog||o.decisionLogError)&&r-Number(o.decisionLogLastFetchAt||0)<uy)return!1;o.decisionLogFetchPromise=(async()=>{let n=await vy(),a=Array.isArray(n?.events)?n.events:[];if(!n?.ok||!Array.isArray(n?.events))throw new Error("decision log response mist events");let i=Sy(n),l=o.decisionLogError!==""||o.decisionLogSignature!==i||!o.decisionLog;return o.decisionLog={...n,events:a,buckets:Array.isArray(n.buckets)?n.buckets:[]},o.decisionLogError="",o.decisionLogSignature=i,o.decisionLogLastFetchAt=Date.now(),l})();try{return await o.decisionLogFetchPromise}catch(n){let a=n.message||String(n),i=!!o.decisionLog||o.decisionLogError!==a;return o.decisionLog=null,o.decisionLogError=a,o.decisionLogSignature="",o.decisionLogLastFetchAt=Date.now(),i}finally{o.decisionLogFetchPromise=null}}function ky(e={}){let t=e?.entities&&typeof e.entities=="object"?e.entities:{};Object.entries(t).forEach(([r,n])=>{hn.has(r)&&(o.optionalMissingEntities&&delete o.optionalMissingEntities[r],o.entities[r]=Pp(r,o.entities[r],n))})}async function Ey(e){if(!e.length)return{ok:!0,message:""};try{let t=await yy();return ky(t),o.lastEntityResponseAt=Date.now(),{ok:!0,message:""}}catch(t){return{ok:!1,message:t.message||String(t)}}}async function K(e,t="state",r={}){let n=Date.now(),a=r.forceMissing===!0,i=e.filter(b=>a||hn.has(b)||!fy(b,n));if(!i.length)return;let l=i.filter(b=>hn.has(b)),c=i.filter(b=>!hn.has(b)),p=(await Ey(l)).ok?c:[...c,...l];if(!p.length){kp(),Hn(eo()),o.busyAction||(Sp(),o.controlError="");return}let g=Number(r.concurrency),w=Number.isFinite(g)&&g>0?Math.floor(g):Ut,y=wl(p,t),h=Math.max(1,Math.min(w,Ut)),m=[];for(let b=0;b<y.length;b+=h){let S=y.slice(b,b+h),q=await Promise.allSettled(S.map(async E=>({chunk:E,payload:await wy(E)})));m.push(...q)}m.some(b=>b.status==="fulfilled")&&(o.lastEntityResponseAt=Date.now());let d="";m.forEach(b=>{if(b.status!=="fulfilled"){let M=b.reason.message||String(b.reason);d||(d=M);return}let{chunk:S,payload:q}=b.value,E=q?.entities&&typeof q.entities=="object"?q.entities:{},k=new Set(Array.isArray(q?.missing)?q.missing:[]);S.keys.forEach(M=>{if(Object.prototype.hasOwnProperty.call(E,M)){o.optionalMissingEntities&&delete o.optionalMissingEntities[M],o.entities[M]=Pp(M,o.entities[M],E[M]);return}let P=O[M];P?.optional?k.has(M)&&hy(M,n):d||(d=`${P?.name||M} ontbreekt in bulk response`)})}),kp(),Hn(eo()),d?(Rp(d),o.deviceReconnectMode?o.controlError="":o.controlError=`Niet alle helpervelden konden worden ververst. ${d}`):o.busyAction||(Sp(),o.controlError="")}function Pp(e,t={},r={}){let n={...t||{},...r||{}};return O[e]?.domain==="select"&&(!String(r.state??"").trim()&&String(t?.state??"").trim()&&(n.state=t.state),!String(r.value??"").trim()&&String(t?.value??"").trim()&&(n.value=t.value),!Array.isArray(r.option)&&Array.isArray(t?.option)&&(n.option=t.option),!Array.isArray(r.options)&&Array.isArray(t?.options)&&(n.options=t.options)),n}function kp(){o.complete=Na(),o.stage=o.complete===!0?"Gereed":o.complete===!1?"Quick Start":"Laden...",o.summary=ud(),o.appView==="diagnosis"&&!yt()&&Nt(yo(),{syncMode:"replace",forceSync:!0}),o.appView||Nt($n()||yo(),{syncMode:"replace",forceSync:!0})}function Ty(){let e=dl();return o.appView==="settings"?[...new Set([...e,...pl()])]:o.appView==="energy"||o.appView==="results"?Rn(o.appView,{forceFast:!0}):o.appView==="overview"||o.appView==="diagnosis"?Rn(o.appView,{forceFast:!0}):[...new Set(e)]}function Cy(e=[]){let t=new Set(e);return(o.appView==="settings"?pl():o.appView==="overview"||o.appView==="control"||o.appView==="diagnosis"?[...new Set([...Rn(o.appView,{includeBulk:!0}),...Qt])]:o.appView==="energy"||o.appView==="results"?[...new Set([...Rn(o.appView,{forceFast:!0}),...Qt])]:[...new Set(["setupComplete","strategy",...nt])]).filter(n=>!t.has(n))}function Ep(e=Date.now(),t={}){return t.forceBulk===!0?!0:e-Number(o.lastBulkEntitySyncAt||0)>=zu}async function ye(e={}){if(o.nativeOpen||o.loadingEntities||o.draggingCurveKey||o.busyAction||o.settingsInteractionLock)return;if(o.updateInstallBusy||ja()){o.pendingEntitySyncOptions=null;return}if(o.focusedField&&o.appView!=="settings")return;if(o.entitySyncInFlight){ey(e);return}let t=Date.now();if(document.hidden&&t-Number(o.lastEntitySyncAttemptAt||0)<yn)return;let r=o.appView,n=e.prefetchView==="overview"&&!e.forceBulk&&r==="settings",a=n?"overview":r,i=a==="overview"||a==="control"||a==="diagnosis"||a==="energy"||a==="results",l=e.forceFast===!0&&!e.forceBulk,c=!l&&!n&&Ep(t,e),p=t-Number(o.lastStaticEntitySyncAt||0)>=Uu||o.updateInstallBusy||o.updateInstallPhaseHint?Qt:[],g=o.quickStartModalOpen&&o.currentStep==="flow-source"?wt:[],w=o.quickStartModalOpen&&o.currentStep==="setup"?Yt:[],y=o.quickStartModalOpen&&o.currentStep==="thermostat-source"?Io:[],h=el()?to():[],m=n?[...bs,...nt,"setupComplete",...p]:i?[...Rn(a,{forceFast:l,includeBulk:c}),...p]:r==="settings"?[...new Set([...pl(),...h,...p])]:c?["setupComplete",...p,...nt,"strategy",...Oo,...rt,...ae()?he.map(d=>d.key):At]:["setupComplete",...nt,"strategy",...p];o.entitySyncInFlight=!0,o.lastEntitySyncAttemptAt=t;try{let d=o.deviceReconnectMode,b=my(t,e)?await gy():{ok:!0,message:""};if(!b.ok){Rp(b.message),n||f();return}if(await K([...new Set([...m,...w,...g,...y])],n?"state":r==="settings"||w.length?"all":"state",{concurrency:l&&i?Gt:Ut}),o.lastFastEntitySyncAt=Date.now(),c&&(a==="overview"||a==="control"||a==="diagnosis")&&!n&&(o.lastBulkEntitySyncAt=o.lastFastEntitySyncAt),p.length&&(o.lastStaticEntitySyncAt=o.lastFastEntitySyncAt),n)return;i&&!o.overviewMetadataHydrated&&!o.overviewMetadataHydrating&&Cp();let S=d!==o.deviceReconnectMode,q=l&&i,E=q?!1:a==="overview"||a==="control"||a==="diagnosis"?await tl():!1,k=q?!1:o.appView==="results"?await Va():!1,M=a==="control"?await qy({force:e.forceDecisionLog===!0}):!1,P=q?!1:el()?(await Promise.all([ep(),Va({metaOnly:!0})])).some(Boolean):!1,N=q||!kd()?!1:await zo(),V=q||!Ed()?!1:await Uo(),H=q||!fp()?!1:await Jo({force:o.systemModal==="mqtt-sensors"}),F=Yd();if(q&&!o.nativeOpen&&Ap(ml(a)),S){f();return}if(E&&o.appView==="diagnosis"&&!o.root?.querySelector(".oq-overview-trends")){f();return}if(k&&o.appView==="results"&&!o.root?.querySelector(".oq-energy-history")){f();return}if(M&&o.appView==="control"){ol()||f();return}if(P&&o.appView==="settings"){f();return}if(N&&(o.systemModal==="login"||Zt())){f();return}if(V&&o.appView==="settings"){f();return}if(o.systemModal==="mqtt-sensors"){Ka()!==o.mqttSensorsModalRenderSignature&&f();return}if(H&&o.appView==="settings"){f();return}let A=!!(o.updateModalOpen||o.systemModal||o.interfacePanelOpen);if(F!==o.headerRenderSignature)if(A&&Ys())o.headerRenderSignature=F;else{f();return}else Ys();if(o.appView==="settings"&&String(o.systemModal||"").startsWith("service-task-")){Tn()!==o.settingsRenderSignature&&f();return}if(A)return;if(o.appView==="settings"){let L=Tn();if(L!==o.settingsRenderSignature&&!o.focusedField){f();return}if(!Zd()){o.focusedField||f();return}o.focusedField&&(o.settingsRenderSignature=L);return}if(o.appView==="diagnosis"){ap()||f();return}if(o.appView==="control"){ol()||f();return}if(o.appView==="energy"){op()||f();return}if(o.appView==="results"){rp()||f();return}np()||f()}catch(d){n||(o.controlError=`Helperstatus kon niet worden geladen. ${d.message}`,f())}finally{o.entitySyncInFlight=!1;let d=o.pendingEntitySyncOptions;o.pendingEntitySyncOptions=null,d&&!o.nativeOpen&&window.setTimeout(()=>{ye(d)},0),l&&(a==="overview"||a==="control"||a==="diagnosis")&&!n&&!o.nativeOpen&&!d&&Ep(Date.now())&&window.setTimeout(()=>{ye({forceBulk:!0})},Zw)}}function _t(){return{}}function xy(){let e=String(T("hpGeneration")||"").trim();return e||""}function Xo(e){let t=String(e||"").trim().toLowerCase();return t==="single"||t.includes("quatt single")||t.includes("openquatt single")?"single":t==="duo"||t.includes("quatt duo")||t.includes("openquatt duo")?"duo":""}function My(){if(!Array.isArray($r))return"";if($r.some(t=>v(t)))return"duo";let e=o.optionalMissingEntities||{};return $r.every(t=>e[t])?"single":""}function yl(e){let t=Xo(e);return(t==="single"||t==="duo")&&typeof o<"u"&&o&&typeof o=="object"&&(o.lastKnownInstallationTopology=t),t}function $y(){if(typeof o<"u"&&o&&typeof o=="object"){let e=String(o.lastKnownInstallationTopology||"").trim().toLowerCase();if(e==="single"||e==="duo")return e}return""}function oe(){let e=Xo(T("installationTopology"));if(e==="single"||e==="duo")return yl(e);let t=Xo(_t().installation);if(t==="single"||t==="duo")return yl(t);let r=My();return r?yl(r):$y()}function Lt(){let e=oe(),t=xy();return e==="single"?t?`Quatt Single ${t}`:"Quatt Single":e==="duo"?t?`Quatt Duo ${t}`:"Quatt Duo":t?`Quatt Hybrid ${t}`:"Quatt Hybrid"}function Ye(){return"OpenQuatt"}function Pn(e){let t=String(e||"").trim().toLowerCase();return t==="wifi"||t==="wi-fi"||t.includes("wifi")||t.includes("wi-fi")?"wifi":t==="eth"||t==="ethernet"||t.includes("ethernet")?"eth":""}function it(e=st()){return e==="wifi"?"Wi-Fi":e==="eth"?"Ethernet":"Onbekend"}function er(e=oe()){return e==="single"?"Single":e==="duo"?"Duo":"Onbekende opstelling"}function _r(){let e=String(T("hardwareProfileText")||"").trim().toLowerCase();return e&&e!=="unknown"&&e!=="onbekend"?e:String(_t().hardwareProfile||e).trim().toLowerCase()}function st(){return Pn(T("connectionText")||_t().connection)}function Np(){let e=st();return e==="wifi"?"eth":e==="eth"?"wifi":""}function Dp(){let e=oe();return e==="single"?"duo":e==="duo"?"single":""}function qo(e=oe(),t=st()){let r=er(e),n=_r();return n==="heatpump_controller_q"?`Heatpump Controller Q ${r} ${it(t)}`:n==="heatpump_listener"?`Heatpump Listener ${r} ${it(t)}`:n==="waveshare"?`Waveshare ${r} ${it(t)}`:`${Ye()} ${r} ${it(t)}`}function vl(){let e=C("timeValid"),t=String(T("timeNowHhmm")||"").trim();if(t&&t!=="invalid")return t;if(v("timeValid")&&!e)return"Geen tijdsync";try{return new Intl.DateTimeFormat("nl-NL",{hour:"2-digit",minute:"2-digit"}).format(new Date)}catch{return new Date().toLocaleTimeString("nl-NL",{hour:"2-digit",minute:"2-digit"})}}function za(){return v("timeValid")&&!C("timeValid")?"Geen tijdsync":`${new Intl.DateTimeFormat("nl-NL",{day:"numeric",month:"short",year:"numeric"}).format(new Date)} \xB7 ${vl()}`}function Ay(e){return String(e?.uom??e?.unit_of_measurement??"").trim().toLowerCase()}function Hy(e){let t=e?.state;if(t!==""&&t!==null&&t!==void 0){let a=Number(t);if(Number.isFinite(a))return a}let r=e?.value,n=Number(r);return Number.isFinite(n)?n:NaN}function Lr(){let e=Hy(o.entities.uptime);if(Number.isFinite(e)&&e>=0){let n=Ay(o.entities.uptime);if(n==="d")return Ko(e*1440);if(n==="h")return Ko(e*60);if(n==="s")return Ko(e/60)}let t=String(o.entities.uptimeReadable?.state??o.entities.uptimeReadable?.value??"").trim();if(t&&t.toLowerCase()!=="unknown")return t;let r=Number(_t().bootedAt);return!Number.isFinite(r)||r<=0?"\u2014":Ko((Date.now()-r)/6e4)}function Or(){let e=String(o.entities.ipAddress?.state??o.entities.ipAddress?.value??"").trim();if(e)return e;let t=String(_t().ipAddress||"").trim();return t||(typeof window<"u"?String(window.location.hostname||"").trim():"")||"\u2014"}function ko({getScroller:e,getToken:t,setToken:r,isActive:n=()=>!0,getIdentity:a=null,preserveGrowth:i=!1,stickToBottom:l=!1,nearBottomThreshold:c=48}){function u(){let y=e();if(!y)return null;let h={scrollTop:y.scrollTop};if((i||l)&&(h.scrollHeight=y.scrollHeight),l){let m=y.scrollHeight-y.scrollTop-y.clientHeight;h.stickToBottom=m<c}return a&&(h.identity=a(y)),h}function p(y){if(!y)return;let h=e();if(!h||a&&a(h)!==y.identity)return;if(y.stickToBottom){h.scrollTop=h.scrollHeight;return}let m=i?h.scrollHeight-Number(y.scrollHeight||0):0;h.scrollTop=Math.max(0,Number(y.scrollTop||0)+m)}function g(y,h=!0){if(!y)return;let m=Number(t()||0)+1;r(m);let d=()=>{Number(t()||0)!==m||!n()||p(y)};if(h){window.requestAnimationFrame(d);return}d()}function w(){r(Number(t()||0)+1)}return{capture:u,invalidate:w,queue:g,restore:p}}function Ae(e){return Object.prototype.hasOwnProperty.call(o.inputDrafts,e)?o.inputDrafts[e]:T(e)}function Eo({key:e,value:t,meta:r,controlClass:n,inputClass:a="oq-helper-input",inputAttributes:i="",unitMarkup:l=""}){return`
    <label class="${n}">
      <input
        class="${a}"
        type="number"
  ...
  `;return ve(e,t,r,p,a)}function ce(e,t,r,n="",a={}){if(!v(e))return"";let i=Be(e),l=Ae(e),c=a.unitOverride||i.uom||"",u=a.showUnit!==!1&&!!c,p=u&&a.unitMode!=="outside",g=Eo({key:e,value:l,meta:i,controlClass:`oq-helper-control${u&&!p?" oq-helper-control--split":""}${p?" oq-helper-control--suffix":""}`,unitMarkup:u?p?`<span class="oq-helper-unit-chip">${s(c)}</span>`:`<span class="oq-helper-unit">${s(c)}</span>`:""});return ve(e,t,r,g,n,a.footerMarkup||"")}function lt(e,t,r,n="",a={}){if(!v(e))return"";let i=Be(e),l=be(e,T(e)),c=a.minLabel||`${i.min}${i.uom||""}`,u=a.maxLabel||`${i.max}${i.uom||""}`,p=a.valueLabel||Y(e,l);return ve(e,t,r,`<label class="oq-helper-slider-field"><div class="oq-helper-slider-meta"><span>${s(c)}</span><strong>${s(p)}</strong><span>${s(u)}</span></div><input class="oq-helper-range" type="range" data-oq-field="${s(e)}" min="${i.min}" max="${i.max}" step="${i.step}" value="${l}" ${o.loadingEntities?"disabled":""}></label>`,n)}function ql(e,t,r,n={}){if(!v(e))return"";let a=Be(e),i=Ae(e),l=n.compact===!0,c=n.embedded===!0,u=n.infoId||e,p=n.showCopy!==!1;return`
  ...
  `}function kl(e,t,r,n=""){if(!v(e))return"";let a=vn(T(e));return ve(e,t,r,`<label class="oq-settings-control oq-settings-control--time"><input class="oq-helper-input oq-helper-input--time" type="time" step="60" lang="nl-NL" inputmode="numeric" data-oq-field="${s(e)}" value="${s(a)}" ${o.loadingEntities?"disabled":""}><span class="oq-settings-time-icon" aria-hidden="true"><svg viewBox="0 0 20 20" focusable="false"><circle cx="10" cy="10" r="6.5" fill="none" stroke="currentColor" stroke-width="1.6" /><path d="M10 6.2 V10 L12.9 11.8" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" /></svg></span></label>`,n||"oq-settings-field--time")}function re(e,t,r,n,a=""){return`<section class="oq-settings-section"><div class="oq-settings-section-head"><div class="oq-settings-section-head-meta"><p class="oq-helper-label">${s(e)}</p>${a?`<div class="oq-settings-section-head-meta-badge">${a}</div>`:""}</div><h3>${s(t)}</h3><p>${s(r)}</p></div>${n}</section>`}var Ip=250;function Fp(){return[]}function ar(){return typeof window>"u"?!1:Fp().length>0}function Py(){return`${Pe()}/events`}function Ny(){return`${Pe()}/openquatt/logs/recent`}function Dy(){return`${Pe()}/openquatt/logs/clear`}function Qa(){let e=o.entities?.webServerLogHistoryEnabled;if(!e)return!0;if(typeof e.value=="boolean")return e.value;let t=String(e.state??e.value??"").toLowerCase();return t==="on"||t==="true"||t==="1"}function Ya(){return o.nativeOpen?"Niet beschikbaar":ar()?"Voorbeeld":o.webServerLogEnabled===!1?"Niet beschikbaar":"Beschikbaar"}function _y(e){let t=Math.max(0,Math.floor(Number(e)/1e3)),r=Math.floor(t/3600),n=Math.floor(t%3600/60),a=t%60;return`${String(r).padStart(2,"0")}:${String(n).padStart(2,"0")}:${String(a).padStart(2,"0")}`}function jp(e){let t=Number(e)||0;if(t>9466848e5){let r=e instanceof Date?e:new Date(t),n={day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"};try{return new Intl.DateTimeFormat("nl-NL",n).format(r)}catch{return r.toLocaleString("nl-NL",n)}}return _y(t)}function Ly(e){let t=Number(e)||0;if(t>9466848e5)return new Date(t).toLocaleString("nl-NL",{day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"});let r=Math.max(0,Math.floor(t/1e3)),n=Math.floor(r/3600),a=Math.floor(r%3600/60),i=r%60;return`Sinds opstart: ${n}u ${a}m ${i}s`}function Oy(){return o.nativeOpen?"Niet beschikbaar":ar()?Qa()?"Voorbeeld buffer aan":"Voorbeeld buffer uit":Qa()?"Buffer aan":"Buffer uit"}function Iy(){return Qa()?"Slaat de laatste firmwarelogs tijdelijk op in RAM. De viewer leest die buffer bij openen en blijft daarna live /events volgen.":"Geen tijdelijke buffer in RAM. De viewer toont alleen live /events."}function Tl(){return o.entities?.debugLevel||null}function Wp(e=Tl()){let t=Array.isArray(e?.option)?e.option:Array.isArray(e?.options)?e.options:[];return t.length?t:["NONE","ERROR","WARN","INFO","CONFIG","DEBUG"]}function Fy(e=Tl()){let t=String(e?.value??e?.state??"").trim(),r=Wp(e);return r.includes(t)?t:r.includes("INFO")?"INFO":r[0]||""}function Vp(e,t=null){if(!e||!t)return!1;let r=Number(e.seq),n=Number(t.seq);if(Number.isFinite(r)&&Number.isFinite(n)&&r===n)return!0;let a=String(e.raw??e.text??"").trim(),i=String(t.raw??t.text??"").trim();if(!a||a!==i)return!1;let l=Number(e.receivedAt??e.ts??0),c=Number(t.receivedAt??t.ts??0);return Math.abs(l-c)<=2e3}function jy(e,t){let r=Number(e.receivedAt??e.ts??0),n=Number(t.receivedAt??t.ts??0);if(r!==n)return r-n;let a=Number(e.seq??0),i=Number(t.seq??0);return a!==i?a-i:String(e.raw??"").localeCompare(String(t.raw??""))}function El(e,{prepend:t=!1}={}){if(!Array.isArray(e)||e.length===0)return;let r=t?[...e,...o.webServerLogEntries]:[...o.webServerLogEntries,...e];r.sort(jy);let n=[];for(let a of r){let i=n[n.length-1]||null;Vp(a,i)||n.push(a)}o.webServerLogEntries=n.slice(-Ip)}function Cl(e,t={}){let r=lv(e).trimEnd(),n=Number(t.receivedAt),a=Number(t.seq);return{raw:e,text:r,tone:cv(e),receivedAt:Number.isFinite(n)?n:Date.now(),seq:Number.isFinite(a)?a:void 0}}function Wy(e,t){let n=Math.max(0,t-e-1)*9e4;return Date.now()-n}function Vy(){let e=Fp(),t=e.length;return e.map((r,n)=>Cl(r,{receivedAt:Wy(n,t),seq:n+1}))}function By(){let e=Pl();e&&(e.scrollTop=e.scrollHeight)}var xl=ko({getScroller:Pl,getToken:()=>o.webServerLogScrollRestoreToken,setToken:e=>{o.webServerLogScrollRestoreToken=e},isActive:()=>o.systemModal==="webserver-logs",preserveGrowth:!0,stickToBottom:!0}),no=xl.capture,ao=xl.queue;function Ky(){return o.root?o.root.querySelector("[data-oq-cm100-commissioning-scroller]"):null}var Bp=ko({getScroller:Ky,getToken:()=>o.cm100CommissioningScrollRestoreToken,setToken:e=>{o.cm100CommissioningScrollRestoreToken=e},isActive:()=>o.systemModal==="cm100-commissioning",preserveGrowth:!0,stickToBottom:!0}),Kp=Bp.capture,Ml=Bp.queue;function zy(){return o.root?o.root.querySelector("[data-oq-service-task-scroller]"):null}var zp=ko({getScroller:zy,getToken:()=>o.serviceTaskModalScrollRestoreToken,setToken:e=>{o.serviceTaskModalScrollRestoreToken=e},isActive:()=>String(o.systemModal||"").startsWith("service-task-")}),Up=zp.capture,$l=zp.queue;function Uy(){return o.root?o.root.querySelector("[data-oq-history-storage-scroller]"):null}var Gp=ko({getScroller:Uy,getToken:()=>o.historyStorageModalScrollRestoreToken,setToken:e=>{o.historyStorageModalScrollRestoreToken=e},isActive:()=>o.systemModal==="history-storage"}),Qp=Gp.capture,Al=Gp.queue;function Gy(){return o.root?o.root.querySelector("[data-oq-settings-backup-restore-scroller]"):null}var Yp=ko({getScroller:Gy,getToken:()=>o.settingsBackupRestoreScrollRestoreToken,setToken:e=>{o.settingsBackupRestoreScrollRestoreToken=e},isActive:()=>o.systemModal==="settings-backup-restore"}),Jp=Yp.capture,Hl=Yp.queue;async function xo(e={}){if(o.nativeOpen||typeof window.fetch!="function")return;let t=e.scrollState||no(),r=e.replaceEntries===!0||o.webServerLogHistoryNeedsReconcile===!0,n=r?new Set(o.webServerLogEntries):null,a=Number(o.webServerLogHistoryRequestToken||0)+1;o.webServerLogHistoryRequestToken=a,o.webServerLogHistoryLoading=!0,o.webServerLogHistoryError="";try{let i=await window.fetch(Ny(),{headers:{"Cache-Control":"no-store"}});if(!i.ok)throw new Error(`HTTP ${i.status}`);let l=await i.json();if(o.systemModal!=="webserver-logs"||o.webServerLogHistoryRequestToken!==a)return;o.webServerLogCsrfToken=String(l.csrf_token||"");let c=Yy(l),u=r?o.webServerLogEntries.filter(p=>!n.has(p)):[];r&&(o.webServerLogEntries=[],o.webServerLogRecentTail=[],o.webServerLogRecentAnchorAt=0),o.webServerLogHistoryLoaded=!0,o.webServerLogHistoryNeedsReconcile=!1,c.length>0&&(El(c,{prepend:!0}),o.webServerLogRecentTail=c.slice(-4).map(p=>String(p.raw??p.text??"")),o.webServerLogRecentAnchorAt=Date.now()),u.length>0&&El(u)}catch(i){o.systemModal==="webserver-logs"&&o.webServerLogHistoryRequestToken===a&&(o.webServerLogHistoryError=i instanceof Error?i.message:"Recente logs konden niet worden opgehaald.")}finally{o.webServerLogHistoryRequestToken===a&&(o.webServerLogHistoryLoading=!1),o.systemModal==="webserver-logs"&&o.webServerLogHistoryRequestToken===a&&(f(),ao(t))}}function Qy(e,t=0){if(!e||typeof e!="object")return null;let r=String(e.raw??"").trim()||String(e.message??"").trim();return r?Cl(r,{receivedAt:Number(e.ts??e.timestamp_ms??e.receivedAt??Date.now()),seq:Number(e.seq??t)}):null}function Yy(e){return!e||typeof e!="object"?[]:e.enabled===!1?[]:(Array.isArray(e.entries)?e.entries:[]).map((r,n)=>Qy(r,n+1)).filter(r=>r!==null)}function Jy(e){if(!e||!Array.isArray(o.webServerLogRecentTail)||o.webServerLogRecentTail.length===0||Date.now()-Number(o.webServerLogRecentAnchorAt||0)>2500)return!1;let r=String(e.raw??e.text??"").trim();return r?o.webServerLogRecentTail.includes(r):!1}function Zy(e,t=o.webServerLogEntries){return!e||!Array.isArray(t)||t.length===0?!1:t.some(r=>Vp(e,r))}function Xy(){ar()&&o.webServerLogEntries.length===0&&Qe({webServerLogEntries:Vy()}),Qe({webServerLogCopyMessage:"",webServerLogCopyError:""}),o.systemModal="webserver-logs",f(),K(["webServerLogHistoryEnabled","debugLevel"],"all",{forceFast:!0}).then(()=>{if(o.systemModal!=="webserver-logs")return;let e=no();f(),ao(e)}),By(),(!o.webServerLogHistoryLoaded||o.webServerLogEntries.length===0)&&xo()}function nr(){Qe({webServerLogEntries:[],webServerLogError:"",webServerLogHistoryError:"",webServerLogHistoryLoading:!1,webServerLogHistoryLoaded:!1,webServerLogHistoryNeedsReconcile:!1,webServerLogCopyMessage:"",webServerLogCopyError:"",webServerLogHistoryRequestToken:o.webServerLogHistoryRequestToken+1,webServerLogRecentTail:[],webServerLogRecentAnchorAt:0}),xl.invalidate(),o.systemModal==="webserver-logs"&&f()}async function ev(){if(o.busyAction)return!1;if(o.nativeOpen||ar())return nr(),!0;if(typeof window.fetch!="function")return o.webServerLogHistoryError="De RAM-logbuffer kan niet vanuit deze browser worden geleegd.",f(),!1;let e=String(o.webServerLogCsrfToken||"");if(!e)return o.webServerLogHistoryError="De beveiligingstoken voor de RAM-logbuffer ontbreekt. Open het logboek opnieuw.",f(),!1;o.busyAction="clear-webserver-log-history",o.webServerLogHistoryError="",kt(),f();let t=!1;try{let n=e,a=!1;for(;;){let i=new URLSearchParams;i.set("csrf_token",n);let l=await window.fetch(Dy(),{method:"POST",body:i});if(!(l.status===403&&!a&&(a=!0,Qe({webServerLogCsrfToken:"",webServerLogHistoryLoaded:!1,webServerLogHistoryRequestToken:o.webServerLogHistoryRequestToken+1}),await xo(),n=String(o.webServerLogCsrfToken||""),n))){if(!l.ok)throw new Error(`HTTP ${l.status}`);break}}nr(),t=!0}catch(n){Qe({webServerLogHistoryLoaded:!1,webServerLogHistoryNeedsReconcile:!0}),o.webServerLogHistoryError=`De RAM-logbuffer kon niet worden geleegd (${n instanceof Error?n.message:"onbekende fout"}).`}finally{o.busyAction="",o.systemModal==="webserver-logs"&&f()}let r=o.webServerLogHistoryError;return o.systemModal==="webserver-logs"&&(await xo(),r&&(o.webServerLogHistoryError=r,f())),t}function tv(){let e=no();kt(),Qe({webServerLogEnabled:null,webServerLogConnected:!1,webServerLogCsrfToken:""}),nr(),o.systemModal==="webserver-logs"&&xo({scrollState:e})}function Rl(){if(ar()){kt();return}if(!(o.mounted&&!o.nativeOpen&&o.systemModal==="webserver-logs"&&o.busyAction!=="clear-webserver-log-history")){kt();return}if(o.webServerLogEnabled===!1){kt();return}o.webServerLogSource||ov()}function ov(){if(ar()){o.webServerLogEnabled=!0,o.webServerLogConnected=!1,o.webServerLogError="",f();return}if(typeof window.EventSource!="function"){o.webServerLogEnabled=!1,o.webServerLogConnected=!1,o.webServerLogError="Deze browser ondersteunt geen live logstream.",f();return}try{let e=new window.EventSource(Py());o.webServerLogSource=e,e.addEventListener("open",rv),e.addEventListener("ping",nv),e.addEventListener("log",iv),e.onerror=av}catch(e){o.webServerLogEnabled=!1,o.webServerLogConnected=!1,o.webServerLogError=e instanceof Error?e.message:"De live logstream kon niet worden geopend.",kt(),f()}}function kt(){let e=o.webServerLogSource;if(e)try{e.close()}catch{}o.webServerLogSource=null,o.webServerLogConnected=!1}function rv(){if(!o.webServerLogSource||o.nativeOpen)return;let e=o.systemModal==="webserver-logs"?no():null;o.webServerLogEnabled=!0,o.webServerLogConnected=!0,o.webServerLogError="",f(),ao(e)}ip({clearOutput:nr,closeStream:kt,resetRecoveryState:tv});function nv(){if(!o.webServerLogSource||o.nativeOpen)return;let e=o.systemModal==="webserver-logs"?no():null;o.webServerLogEnabled=!0,o.webServerLogConnected||(o.webServerLogConnected=!0,o.webServerLogError="",f(),ao(e))}function av(){if(!o.webServerLogSource)return;let e=o.systemModal==="webserver-logs"?no():null;o.webServerLogEnabled=!1,o.webServerLogConnected=!1,o.webServerLogError="De live logstream kon niet worden geopend.",kt(),f(),ao(e)}function iv(e){if(!o.webServerLogSource||!e||typeof e.data!="string")return;let t=no(),r=sv(e.data);if(!r)return;let n=r.split(/\r?\n/).filter(u=>u.trim()!=="");if(n.length===0)return;let i=n.map(u=>Cl(u)).filter(u=>!Jy(u)&&!Zy(u));if(i.length===0)return;El(i);let l=dv(),c=Pl();uv(l),pv(i,l),o.webServerLogEnabled=!0,c&&t&&ao(t,!1)}function sv(e){let t=String(e??"").replace(/\r\n/g,`
`).replace(/\r/g,`
...
`).replace(/\r/g,`
`).trimEnd()}catch{}return t}function lv(e){return String(e??"").replace(/\x1b\[[0-9;]*m/g,"")}function cv(e){let t=String(e??""),r=Array.from(t.matchAll(/\x1b\[([0-9;]*)m/g));for(let i=r.length-1;i>=0;i-=1){let l=r[i][1].split(";").map(c=>Number(c)).filter(c=>Number.isFinite(c));for(let c=l.length-1;c>=0;c-=1){let u=l[c];if(u===31||u===91)return"error";if(u===33||u===93)return"warning";if(u===32||u===92)return"info";if(u===36||u===96||u===34||u===35)return"debug";if(u===37||u===90||u===38||u===97)return"verbose"}}let n=t.match(/\[(E|W|I|D|V|VV)\]/i);if(!n)return"plain";let a=n[1].toUpperCase();return a==="E"?"error":a==="W"?"warning":a==="I"?"info":a==="D"?"debug":"verbose"}function uv(e){for(;o.webServerLogEntries.length>Ip;)o.webServerLogEntries.shift(),e&&e.firstElementChild&&e.removeChild(e.firstElementChild)}function dv(){return o.root?o.root.querySelector("[data-oq-webserver-log-output]"):null}function Pl(){return o.root?o.root.querySelector("[data-oq-webserver-log-scroller]"):null}function pv(e,t){if(!(!t||e.length===0)){t.dataset.webServerLogEmpty==="true"&&(t.dataset.webServerLogEmpty="false",t.innerHTML="");for(let r of e)t.insertAdjacentHTML("beforeend",Zp(r))}}function Zp(e){let t=jp(e.receivedAt),r=Ly(e.receivedAt);return`
  ...
  `}function mv(e=o.webServerLogEntries){return e.length?e.map(t=>Zp(t)).join(""):`
      <p class="oq-webserver-log-empty">Nog geen logregels ontvangen. Open de log en wacht op een nieuwe melding.</p>
    `}function gv(){let e=[];return o.webServerLogHistoryLoading&&e.push('<p class="oq-helper-modal-note">Recente firmwarelogs worden opgehaald...</p>'),o.webServerLogCopyMessage&&e.push(`
  ...
  `}function hv(){let e=Tl();if(!e)return"";let t=Wp(e),r=Fy(e),n=o.loadingEntities||!!o.busyAction;return`
...
`)}async function wv(){let e=bv();if(o.webServerLogCopyMessage="",o.webServerLogCopyError="",!e){o.webServerLogCopyError="Er zijn nog geen logregels om te kopi\xEBren.",f();return}try{if(!await ho(e))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");o.webServerLogCopyMessage=`${o.webServerLogEntries.length} logregel${o.webServerLogEntries.length===1?"":"s"} gekopieerd.`}catch(t){o.webServerLogCopyError=t instanceof Error?t.message:"Kopi\xEBren naar het klembord is niet gelukt."}o.systemModal==="webserver-logs"&&f()}var yv={"open-webserver-log-modal":()=>Xy(),"clear-webserver-log-output":()=>ev(),"copy-webserver-log-output":()=>wv()};function Xp(e){return ie(yv,e)}function em(){let e=ar(),t=o.busyAction==="clear-webserver-log-history",r=!!o.busyAction||o.webServerLogHistoryLoading||!e&&!o.nativeOpen&&!o.webServerLogCsrfToken;return te({id:"system",titleId:"oq-webserver-log-modal-title",kicker:"Diagnostiek",title:"OpenQuatt log",copy:e?"Hier zie je voorbeeldmeldingen uit de lokale preview.":"Hier zie je recente meldingen van OpenQuatt. Handig als je wilt terugzoeken wat er net gebeurde.",className:"oq-helper-modal--wide oq-helper-modal--scrollable oq-webserver-log-modal",closeAction:"close-system-modal",closeLabel:"Sluit logboek",body:`
    ...
    `}function Rv(e,t,r,n){if(!lm())return"";let i=!!(Et()||o.updateInstallBusy||ct());return`
    ...
    `}function Pv(){let e=Za();if(!e||!o.firmwareConnectionSwitchOpen)return"";let r=!!(Et()||o.updateInstallBusy||ct()),n=!!o.firmwareConnectionSwitchConfirmed,a=e.targetConnection==="eth",i=!e.canSwitch,l=a?"Sluit eerst de netwerkkabel aan. Na de herstart verdwijnt Wi-Fi uit deze firmware.":"Na de herstart verdwijnt Ethernet uit deze firmware. Als er geen Wi-Fi-gegevens bekend zijn, start het OpenQuatt fallback access point.",c=i?'<p class="oq-helper-modal-note oq-helper-modal-note--muted">Verbindingswissel wordt geladen. Open deze modal opnieuw of wacht een moment als de knop disabled blijft.</p>':"";return`
    ...
    `}function Dv(){if(!o.updateTestFirmwareOpen)return"";let t=!!(Et()||o.updateInstallBusy||ct()),r=sr(),n=jr(),a=Nn(r,n),i=!!(n.available&&v("firmwareTestOtaUrl")&&v("firmwareTestOtaMd5Url")&&v("installFirmwareTestOta")),l=!!(r&&i),c=o.updateTestFirmwareBuild||null,u=n.available?n.label:n.error,p=a?n.otaFileName:"Vul een PR-nummer in om de OTA-build te kiezen.";return`
      <div class="oq-firmware-advanced-detail">
        <div class="oq-firmware-advanced-detail-head">
    ...
    `}function _v(){if(!o.updateManualUploadOpen)return"";let t=!!(Et()||o.updateInstallBusy||ct()),r=String(o.updateManualUploadFileName||o.updateManualUploadFile?.name||"").trim();return`
      <div class="oq-firmware-advanced-detail">
        <div class="oq-firmware-advanced-detail-head">
  ...
  `}function Fv(){if(!o.root)return;if(o.interfacePanelOpen){f();return}let e=o.root.querySelector(".oq-helper-hub--collapsed .oq-helper-hub-head-actions");if(!e)return;let t=e.querySelector(".oq-debug-recording-header-status"),r=jl();if(!r){t?.remove();return}if(t){t.outerHTML=r;return}e.insertAdjacentHTML("afterbegin",r)}function jv(){if(!o.root)return;let e=o.root.querySelector('[data-oq-diagnostics-row="debugRecording"]');if(!e)return;let t=e.querySelector(".oq-settings-system-row-value"),r=e.querySelector(".oq-settings-system-row-note");t&&(t.textContent=In()),r&&(r.textContent=ni())}function Wl(e){let t={activity:'<svg viewBox="0 0 24 24" focusable="false"><path d="M3 12h4l2-7 4 14 2-7h6"/></svg>',status:'<svg viewBox="0 0 24 24" focusable="false"><circle cx="12" cy="12" r="4"/></svg>',clock:'<svg viewBox="0 0 24 24" focusable="false"><circle cx="12" cy="12" r="8"/><path d="M12 7v5l3 2"/></svg>',samples:'<svg viewBox="0 0 24 24" focusable="false"><path d="M4 16h3l2-7 4 9 2-5h5"/></svg>',changes:'<svg viewBox="0 0 24 24" focusable="false"><path d="M18 8a7 7 0 1 0 1 7"/><path d="M18 4v4h-4"/></svg>',file:'<svg viewBox="0 0 24 24" focusable="false"><path d="M7 3h7l4 4v14H7z"/><path d="M14 3v5h5"/></svg>',storage:'<svg viewBox="0 0 24 24" focusable="false"><ellipse cx="12" cy="6" rx="7" ry="3"/><path d="M5 6v6c0 1.7 3.1 3 7 3s7-1.3 7-3V6"/><path d="M5 12v6c0 1.7 3.1 3 7 3s7-1.3 7-3v-6"/></svg>',play:'<svg viewBox="0 0 24 24" focusable="false"><path d="M8 5v14l11-7z"/></svg>',stop:'<svg viewBox="0 0 24 24" focusable="false"><path d="M7 7h10v10H7z"/></svg>',download:'<svg viewBox="0 0 24 24" focusable="false"><path d="M12 4v10"/><path d="m8 10 4 4 4-4"/><path d="M5 19h14"/></svg>',copy:'<svg viewBox="0 0 24 24" focusable="false"><rect x="8" y="8" width="10" height="10" rx="2"/><path d="M6 14H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v1"/></svg>',check:'<svg viewBox="0 0 24 24" focusable="false"><path d="m5 13 4 4L19 7"/></svg>',alert:'<svg viewBox="0 0 24 24" focusable="false"><path d="M12 8v5"/><path d="M12 17h.01"/><path d="M10.3 4.7 2.8 18a2 2 0 0 0 1.7 3h15a2 2 0 0 0 1.7-3L13.7 4.7a2 2 0 0 0-3.4 0z"/></svg>'};return t[e]||t.status}function Wv(e){return`<span class="oq-debug-recording-icon" aria-hidden="true">${Wl(e)}</span>`}function so(e){return`<span class="oq-debug-recording-button-icon" aria-hidden="true">${Wl(e)}</span>`}function Vv(){return[...Wo]}function Bv(){let e=[];return Wo.forEach((t,r)=>{let n=o.entities?.[t]||{},a=String(n.uom??n.unit_of_measurement??"").trim();a&&e.push([r,a])}),e}function Kv(e){return Array.isArray(e)?e.map((t,r)=>t===null?null:[r,t]).filter(Boolean):[]}function ai(){o.debugRecordingTimer&&(window.clearTimeout(o.debugRecordingTimer),o.debugRecordingTimer=null)}function pr(){o.debugRecordingDevicePollTimer&&(window.clearTimeout(o.debugRecordingDevicePollTimer),o.debugRecordingDevicePollTimer=null)}function Ao(e){return`${Pe()}/openquatt/debug-recording/${e}`}function Vr(e){let t=e&&typeof e=="object"?e:{};o.debugRecordingDeviceStatus=t,o.debugRecordingActive=!!t.active,o.debugRecordingStartedAt=t.active||Number(t.sample_count||0)>0?Date.now()-Math.max(0,Number(t.elapsed_s||0)*1e3):0,o.debugRecordingEndsAt=t.active?Date.now()+Math.max(0,Number(t.remaining_s||0)*1e3):0,o.debugRecordingLastSampleAt=Number(t.sample_count||0)>0?Date.now():0}function Vl(){Vr({ok:!1,available:!1,active:!1,mode:"manual",rolling:!1,frozen:!1,storage:"unavailable",interval_s:0,duration_s:0,elapsed_s:0,remaining_s:0,sample_count:0,sample_capacity:0,estimated_size:0,buffer:"unavailable"})}async function zv(){let e=await window.fetch(Ao("status"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);let t=await e.json();return Vr(t),t}function Fn(e=2e3){pr(),o.debugRecordingActive&&(o.debugRecordingDevicePollTimer=window.setTimeout(()=>{ii({silent:!0})},Math.max(0,Number(o.systemModal==="debug-recording"?e:5e3)||0)))}async function ii(e={}){e.silent||(o.debugRecordingBusy=!0,o.debugRecordingError="",f());try{await zv(),!o.debugRecordingActive&&e.silent&&(o.debugRecordingNotice="Debugopname is afgerond."),Fn()}catch(t){Vl(),o.debugRecordingError=`Status kon niet worden opgehaald. ${t.message||String(t)}`}finally{e.silent||(o.debugRecordingBusy=!1),!e.silent||o.systemModal==="debug-recording"?f():(Fv(),jv())}}async function bm(){let e=wl(Wo,"state"),t=null;for(let r=0;r<e.length;r+=1){let n=await window.fetch(Ao(`configure?reset=${r===0?"1":"0"}`),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store","Content-Type":"application/x-www-form-urlencoded"},body:e[r].body});if(!n.ok)throw new Error(`configuratie HTTP ${n.status}`);t=await n.json()}if(Number(t?.entity_field_count||0)!==Wo.length)throw new Error(`onvolledige debugset (${Number(t?.entity_field_count||0)}/${Wo.length})`);return t}async function Uv(e){let t=Math.max(1,Number(e)||15);ai(),pr(),_a({debugRecordingBusy:!0,debugRecordingError:"",debugRecordingNotice:"",debugRecordingSamples:[],debugRecordingEvents:[],debugRecordingInitialValues:null,debugRecordingLastValues:null,debugRecordingDeviceBundle:null,debugRecordingLastSampleAt:0,debugRecordingSequence:0}),f();try{await bm();let r=await window.fetch(Ao(`start?duration_s=${encodeURIComponent(t*60)}`),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!r.ok)throw new Error(`HTTP ${r.status}`);let n=await r.json();Vr(n),Fn()}catch(r){Vl(),o.debugRecordingError=`Debugopname kon niet worden gestart. ${r.message||String(r)}`}finally{o.debugRecordingBusy=!1,f()}}async function Gv(){ai(),pr(),_a({debugRecordingBusy:!0,debugRecordingError:"",debugRecordingNotice:"",debugRecordingSamples:[],debugRecordingEvents:[],debugRecordingInitialValues:null,debugRecordingLastValues:null,debugRecordingDeviceBundle:null,debugRecordingLastSampleAt:0,debugRecordingSequence:0}),f();try{await bm();let e=await window.fetch(Ao("start?rolling=1"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);let t=await e.json();Vr(t),Fn()}catch(e){Vl(),o.debugRecordingError=`Rolling debug kon niet worden gestart. ${e.message||String(e)}`}finally{o.debugRecordingBusy=!1,f()}}async function Qv(){let e=await window.fetch(Ao("freeze"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);let t=await e.json();return Vr(t),pr(),t}async function Yv(){ai(),o.debugRecordingBusy=!0,o.debugRecordingError="",f();try{await Qv(),o.debugRecordingNotice="Rolling debug is gestopt. De recente buffer blijft bewaard."}catch(e){o.debugRecordingError=`Rolling debug kon niet worden gestopt. ${e.message||String(e)}`}finally{o.debugRecordingBusy=!1,f()}}async function Jv(e={}){ai(),pr(),o.debugRecordingBusy=!0,o.debugRecordingError="",f();try{let t=await window.fetch(Ao("stop"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!t.ok)throw new Error(`HTTP ${t.status}`);let r=await t.json();Vr(r),o.debugRecordingNotice=e.completed?"Debugopname is afgerond.":"Debugopname is gestopt."}catch(t){o.debugRecordingError=`Debugopname kon niet worden gestopt. ${t.message||String(t)}`}finally{o.debugRecordingBusy=!1,f()}}function um(e={}){let t=o.debugRecordingActive?Date.now():Number(o.debugRecordingLastSampleAt||Date.now());return{format:"openquatt-debug-v2",schema_version:2,kind:"openquatt_debug_recording",encoding:"column-delta-json-v2",exported_at:new Date().toISOString(),source:e.source||{},recording:{started_at:o.debugRecordingStartedAt?new Date(Number(o.debugRecordingStartedAt)).toISOString():"",ended_at:t?new Date(t).toISOString():"",active:!!o.debugRecordingActive,duration_s:o.debugRecordingStartedAt?Math.round(Math.max(0,t-Number(o.debugRecordingStartedAt))/1e3):0,interval_s:Math.round(ju/1e3),sample_count:It(),column_count:Wo.length,storage:"browser"},columns:Vv(),units:Bv(),initial:Kv(o.debugRecordingInitialValues),samples:o.debugRecordingSamples||[],events:o.debugRecordingEvents||[],...e.logs?{logs:e.logs}:{}}}function oi(e){return JSON.stringify(e)}function Zv(){let e=Number(o.debugRecordingDeviceStatus?.estimated_size||0);if(e>0)return e;try{return new Blob([oi(um())]).size}catch{return oi(um()).length}}function Xv(e){let t=Math.max(0,Number(e)||0);return t>=1024*1024?`${(t/1024/1024).toFixed(1)} MB`:t>=1024?`${(t/1024).toFixed(1)} kB`:`${Math.round(t)} B`}function eS(e){let t=e?.exported_at||(e?.exported_at_ms?new Date(Number(e.exported_at_ms)).toISOString():new Date().toISOString()),r=String(t).replace(/[:.]/g,"-").replace(/T/,"_").replace(/Z$/,"Z");return`${String(e?.source?.installation||"OpenQuatt").replace(/\s+/g,"-").toLowerCase()}-debug-recording-${r}.oqdebug.json`}async function tS(){if(It()===0){o.debugRecordingError="Er is nog geen debugopname om te downloaden.",f();return}o.debugRecordingBusy=!0,o.debugRecordingError="";let e=o.debugRecordingActive&&Ft();f();try{let t=await window.fetch(Ao("download"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!t.ok)throw new Error(`HTTP ${t.status}`);let r=await t.json();o.debugRecordingDeviceBundle=r,$s(eS(r),oi(r),"application/json"),hm(r),o.debugRecordingNotice=e?"Momentopname gedownload. Rolling debug loopt door.":"Supportbestand gedownload."}catch{o.debugRecordingError="Download mislukt. Probeer opnieuw of kopieer de data."}finally{o.debugRecordingBusy=!1,f()}}async function oS(){if(It()===0){o.debugRecordingError="Er is nog geen debugopname om te kopi\xEBren.",f();return}o.debugRecordingBusy=!0,o.debugRecordingError="";let e=o.debugRecordingActive&&Ft();f();try{let t=await window.fetch(Ao("download"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!t.ok)throw new Error(`HTTP ${t.status}`);let r=await t.json();if(o.debugRecordingDeviceBundle=r,!await ho(oi(r)))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");hm(r),o.debugRecordingNotice=e?"Momentopname gekopieerd. Rolling debug loopt door.":"Supportbestand gekopieerd."}catch{o.debugRecordingError="Kopi\xEBren mislukt. Probeer opnieuw of download het supportbestand."}finally{o.debugRecordingBusy=!1,f()}}var rS={"open-debug-recording-modal":()=>(o.systemModal="debug-recording",o.debugRecordingError="",o.debugRecordingNotice="",f(),ii()),"start-debug-recording":e=>Uv(e.dataset.debugMinutes||15),"start-rolling-debug-recording":()=>Gv(),"select-debug-recording-duration":e=>Ov(e.dataset.debugMinutes||15),"stop-debug-recording":()=>Jv(),"freeze-debug-recording":()=>Yv(),"download-debug-recording":()=>tS(),"copy-debug-recording":()=>oS()};function wm(e,t){return ie(rS,e,t)}function ym(){let e=o.debugRecordingActive,t=Ft(),r=ri(),n=It(),a=o.debugRecordingBusy,i=Xv(Zv()),l=Array.isArray(o.debugRecordingDeviceBundle?.events)?o.debugRecordingDeviceBundle.events.length:Array.isArray(o.debugRecordingEvents)?o.debugRecordingEvents.length:0,c=Lv(),u=gm(),p=dm(),g=Iv(),w=n>0,y=`${g.toFixed(1)}%`,h=[{icon:"status",label:"Status",value:In()},{icon:"clock",label:t?"Retentie":"Duur",value:dr(t?p:pm())},{icon:"samples",label:"Samples",value:String(n)},{icon:"changes",label:"Statuswijzigingen",value:String(l)},{icon:"file",label:"Geschatte grootte",value:`\xB1 ${i}`},{icon:"storage",label:"Opslag",value:o.debugRecordingDeviceStatus?.available===!1?"Niet beschikbaar":"Apparaatgeheugen"}],m=o.debugRecordingError?{kind:"error",icon:"alert",text:o.debugRecordingError}:o.debugRecordingNotice?{kind:"success",icon:"check",text:o.debugRecordingNotice}:null;return te({id:"system",titleId:"oq-debug-recording-modal-title",kicker:"Diagnostiek",title:"Debugopname",copy:ni(),className:"oq-debug-recording-modal",closeAction:"close-system-modal",closeLabel:"Sluit debugopname",body:`
        ...
        <div class="oq-debug-recording-actions">
          ...
          `:""}
        </div>`})}function Sm(e){o.overviewTheme=e==="dark"?"dark":"light";try{window.localStorage.setItem("oq-overview-theme",o.overviewTheme)}catch{}}function jn(e){o.interfacePanelOpen=e===!0}function Bl(e){try{window.localStorage.setItem("oq-active-surface",e==="native"?"native":"app")}catch{}}function si(e,t={}){o.settingsGroup=Le.has(e)?e:fe[0].id;try{window.localStorage.setItem("oq-settings-group",o.settingsGroup)}catch{}t.syncUrl!==!1&&o.appView==="settings"&&Qo(t.syncMode||"replace")}function qm(e){o.hpVisualMode=e==="compact"?"compact":"schematic";try{window.localStorage.setItem("oq-hp-visual-mode",o.hpVisualMode)}catch{}}function km(e){o.hpLayoutMode=e==="focus-hp1"||e==="focus-hp2"?e:"equal";try{window.localStorage.setItem("oq-hp-layout-mode",o.hpLayoutMode)}catch{}}function nS(e){if(o.reducedMotion=!!e?.matches,o.reducedMotion){xn();return}Go()}function aS(){let e=vs();!e||o.motionPreferenceMedia===e||(o.motionPreferenceMedia=e,o.motionPreferenceListener=nS,typeof e.addEventListener=="function"?e.addEventListener("change",o.motionPreferenceListener):typeof e.addListener=="function"&&e.addListener(o.motionPreferenceListener),o.reducedMotion=!!e.matches)}function iS(){return Object.keys(o.entities).length>0}function sS(){return ys+Math.floor(Math.random()*(Zu-ys+1))}function lS(){return(document.hidden?yn:Ku)+sS()}function Em(e=lS()){o.pollTimer||o.nativeOpen||o.updateInstallBusy||ja()||(o.pollTimer=window.setTimeout(async()=>{o.pollTimer=null,await ye(),Em()},e))}function Kl(){Em()}function zl(){o.pollTimer&&(window.clearTimeout(o.pollTimer),o.pollTimer=null)}_d({start:Kl,stop:zl});function cS(){o.nativeOpen||(zl(),Kl(),document.hidden||ye({forceProbe:!0}))}function li(e={}){if(Wn(),o.nativeOpen){zl(),xn(),o.nativeFrontendLoaded||ci();return}if(Go(),Kl(),e.refresh!==!1){if(!iS()){xp();return}ye({forceFast:!0})}}function uS(){let e=$n()||yo(),t=e==="settings"?Ks()||o.settingsGroup:"",r=e==="control"?Ws()||"status":o.controlReplayTab,n=e==="control"?Vs()||"last24":o.controlReplayWindow,a=e==="control"?Bs():null;if(!(e===o.appView&&(e!=="settings"||t===o.settingsGroup)&&(e!=="control"||r===o.controlReplayTab&&n===o.controlReplayWindow&&(!a||a.start===o.controlReplayCustomStart&&a.end===o.controlReplayCustomEnd)))){if(o.appView=e,e==="control"&&(o.controlReplayTab=r,o.controlReplayWindow=n,o.controlReplayCustomStart=a?.start||"",o.controlReplayCustomEnd=a?.end||"",o.controlReplayPeriodMenuOpen=!1,o.controlReplayCustomPeriodOpen=!1,o.controlReplayCustomPeriodError=""),e==="settings"&&t){o.settingsGroup=t;try{window.localStorage.setItem("oq-settings-group",o.settingsGroup)}catch{}}f(),ye({forceFast:!0})}}function Wn(){o.nativeApp&&(o.nativeApp.classList.add("oq-native-app"),o.nativeApp.classList.toggle("oq-native-app--collapsed",!o.nativeOpen),o.nativeApp.setAttribute("aria-hidden",o.nativeOpen?"false":"true"))}function Tm(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",vm,{once:!0}):vm(),window.addEventListener("pointermove",Bd),window.addEventListener("pointerup",Kd),window.addEventListener("popstate",uS),document.addEventListener("visibilitychange",cS)}function vm(){dS();let e=document.querySelector("esp-app");e||(e=document.createElement("esp-app"),document.body.appendChild(e)),o.nativeApp=e,o.nativeFrontendLoaded=Array.from(document.scripts).some(t=>t.src===ss),o.mounted||(pS(e),o.mounted=!0,li()),Wn(),o.nativeOpen||(ye(),ii({silent:!0}))}function dS(){if(!document.head)return;let e=document.head.querySelector('meta[name="viewport"]');e||(e=document.createElement("meta"),e.name="viewport",document.head.appendChild(e)),e.setAttribute("content","width=device-width, initial-scale=1")}function pS(e){let t=document.createElement("section");t.id="oq-helper-root",t.lang="nl-NL",document.documentElement&&!document.documentElement.lang&&(document.documentElement.lang="nl-NL"),e.parentNode.insertBefore(t,e),t.addEventListener("click",Fd),t.addEventListener("change",Id),t.addEventListener("input",jd),t.addEventListener("keydown",Wd),t.addEventListener("wheel",Gd,{passive:!1}),t.addEventListener("focusin",Is),t.addEventListener("focusout",Is),t.addEventListener("mouseover",Ud),t.addEventListener("mouseout",zd),t.addEventListener("pointerdown",Vd),o.root=t,aS();let r=$n()||yo(),n=r==="settings"?Ks():"",a=r==="control"?Ws():"",i=r==="control"?Vs():"",l=r==="control"?Bs():null;n&&si(n,{syncUrl:!1}),a&&(o.controlReplayTab=a),i&&(o.controlReplayWindow=i,o.controlReplayCustomStart=l?.start||"",o.controlReplayCustomEnd=l?.end||""),Nt(r,{syncMode:"replace",forceSync:!0}),Cn(),f()}function mS(e){return new Promise((t,r)=>{if(!e){t();return}let n=Array.from(document.scripts).find(i=>i.src===e);if(n){if(n.dataset.loaded==="true"){t();return}n.addEventListener("load",()=>t(),{once:!0}),n.addEventListener("error",i=>r(i),{once:!0});return}let a=document.createElement("script");a.src=e,a.async=!1,a.addEventListener("load",()=>{a.dataset.loaded="true",t()},{once:!0}),a.addEventListener("error",i=>r(i),{once:!0}),document.head.appendChild(a)})}async function ci(){if(!(o.nativeFrontendLoaded||o.nativeFrontendLoading)){o.nativeFrontendLoading=!0,o.nativeOpen&&f();try{await mS(ss),o.nativeFrontendLoaded=!0}catch(e){o.controlError=`ESPHome fallback kon niet worden geladen. ${e.message||e}`,o.nativeOpen=!1,Bl("app"),f(),li()}finally{o.nativeFrontendLoading=!1,o.nativeOpen&&f()}}}function Vn(){let e=o.authStatus;return e?e.enabled?e.setup_window_active?"Instelvenster":"Beveiligd":"Onbeveiligd":"Laden..."}function gS(){return"Login"}function fS(){let e=o.authStatus;return e?e.enabled?"De web-app vraagt nu een login voordat beheer beschikbaar is. Je kunt die hier aanpassen of uitzetten.":"De web-app staat open op je netwerk. Houd de herstelknop 5 seconden vast om een login toe te voegen.":"We halen de huidige loginstatus op."}function Bn(){let e=o.authStatus;return e?e.enabled?e.setup_window_active?"Login actief. Tijdelijk instelvenster is open.":`Login actief${e.source?` via ${e.source}`:""}.`:e.setup_window_active?"Login uit. Tijdelijk instelvenster is open.":"Login uit. Webtoegang is open / onbeveiligd op het netwerk.":"Logingegevens laden..."}function Br(){let e=o.apiSecurityStatus;return e?e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active?"Herstart nodig":e.transport_active===!0?"Aan":e.transport_active===!1?"Uit":e.enabled?"Aan":"Uit":"Laden..."}function Kr(){let e=o.apiSecurityStatus;return e?e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active?e.enabled===!0&&e.transport_active===!1?"API-encryptie wordt ingeschakeld na herstart. Kopieer de sleutel nu voor Home Assistant.":e.enabled===!1&&e.transport_active===!0?"API-encryptie wordt uitgeschakeld na herstart. Tot die tijd blijft de native API beveiligd.":e.key?"Deze wijziging wordt actief na herstart. De sleutel blijft opgeslagen voor later gebruik.":"Deze wijziging wordt actief na herstart.":e.transport_active===!0?"API-encryptie staat aan. Gebruik dezelfde sleutel in Home Assistant.":"De native API staat nu open op je lokale netwerk.":"API-encryptie wordt geladen."}function hS(){return"ESPHome API encryption"}function bS(){let e=o.apiSecurityStatus;return e?e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active?e.enabled===!0&&e.transport_active===!1?"API-encryptie wordt ingeschakeld na herstart. Kopieer de sleutel nu alvast voor Home Assistant.":e.enabled===!1&&e.transport_active===!0?"API-encryptie wordt uitgeschakeld na herstart. Tot die tijd blijft de native API nog beveiligd.":"Deze wijziging wordt actief na herstart. Je kunt de sleutel hier bekijken, kopi\xEBren of vernieuwen.":e.transport_active===!0?"De native API is beveiligd. Je kunt de sleutel hier bekijken, kopi\xEBren of vernieuwen.":"API-encryptie staat uit. Schakel in om een sleutel te bekijken, kopi\xEBren of vernieuwen.":"We halen de huidige API-beveiliging op."}function wS(){let e=o.apiSecurityStatus;if(!e)return"Laden...";let t=!!(e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active);return t&&e.enabled===!0&&e.transport_active===!1?"Annuleer inschakelen":t&&e.enabled===!1&&e.transport_active===!0?"Annuleer uitschakelen":e.enabled?"Uitschakelen":"Inschakelen"}function yS(){let e=o.apiSecurityStatus;return e?e.key?"Vernieuw sleutel":"Genereer sleutel":"Laden..."}function Cm(e,t,r="",n=!1){return`
    ...
    `}function xm(){let e=o.apiSecurityStatus||{},t=e.enabled===!0,r=!!e.key,n=!!(e.pending_restart||typeof e.enabled=="boolean"&&typeof e.transport_active=="boolean"&&e.enabled!==e.transport_active),a=r||e.transport_active===!0||n,i=o.apiSecurityNotice,l=o.apiSecurityError?`<div class="oq-helper-modal-note oq-helper-modal-note--error" aria-live="assertive">${s(o.apiSecurityError)}</div>`:"";return te({id:"system",titleId:"oq-api-security-modal-title",kicker:"Toegang",title:hS(),copy:bS(),className:"oq-helper-modal--wide",closeAction:"close-system-modal",closeLabel:"Sluit API-beveiliging popup",body:`
      ...
      `;return te({id:"system",titleId:"oq-login-modal-title",kicker:"Systeem",title:gS(),copy:fS(),closeAction:"close-system-modal",closeLabel:"Sluit login-popup",body:`
          ${i}
          ${l}
          <div class="oq-helper-modal-grid">
        ...
        ${n?`<button class="oq-helper-button oq-helper-button--primary" type="button" data-oq-action="save-web-auth" ${o.authBusy?"disabled":""}>${t?"Opslaan":"Login opslaan"}</button>`:""}`})}function Kn(e,t,r){let n=R(t),a=R(r);if(Number.isFinite(n)&&Number.isFinite(a))return n-a;let i=R(e);return Number.isFinite(i)?i:NaN}function Ul(e="oq-settings-grid"){let t=vS();return`
      <div class="${s(e)}">
    ...
    `}function Hm(){let e=v("boilerCvAssistEnabled")&&C("boilerCvAssistEnabled"),t=Ua(),r=C("cm100Active"),n=String(t||"").trim().toUpperCase(),a=mr(t),i=!a&&(r||n==="CM100 READY"),l=o.commissioningTaskLock==="cm100",c=o.loadingEntities||o.busyAction==="commissioningCm100Start"||o.busyAction==="commissioningCm100Stop"||l,u=!!o.pendingCommissioningCm100Start,p=c||i||a,g=c||!i,w=or("boilerPowerTestStatus","IDLE"),y=ui(w,"boiler"),h=C("boilerPowerTestActive"),m=o.loadingEntities||o.busyAction==="boilerPowerTestStart"||o.busyAction==="boilerPowerTestAbort"||o.busyAction==="boilerPowerTestApply",d=!!(o.entities.boilerPowerTestStart||o.entities.boilerPowerTestAbort||o.entities.boilerPowerTestApply),b=!!o.pendingBoilerPowerTestStart,S=o.commissioningTaskLock==="boiler",q=mr(w),k=!Ce(w)&&(h||b||S||zr(w))&&!q,M=He("boilerRatedHeatPower"),P=He("boilerHeatPower"),N=R("boilerHeatPower"),V=N>0?P:k&&o.commissioningBoilerHeatPowerDisplay?o.commissioningBoilerHeatPowerDisplay:P;N>0&&(o.commissioningBoilerHeatPowerDisplay=P);let H=or("flowAutotuneStatus","IDLE"),F=ui(H,"autotune"),A=o.loadingEntities||o.busyAction==="flowAutotuneStart"||o.busyAction==="flowAutotuneAbort"||o.busyAction==="flowAutotuneApply",L=!!(o.entities.flowAutotuneStart||o.entities.flowAutotuneAbort||o.entities.flowAutotuneApply),_=!!o.pendingFlowAutotuneStart,D=o.commissioningTaskLock==="autotune",Z=mr(H),W=!Ce(H)&&(_||D||zr(H))&&!Z,ee=or("airPurgeStatus","IDLE"),De=ui(ee,"purge"),xt=C("airPurgeActive"),gt=o.loadingEntities||o.busyAction==="airPurgeStart"||o.busyAction==="airPurgeAbort",zt=!!(o.entities.airPurgeStart||o.entities.airPurgeAbort),et=!!o.pendingAirPurgeStart,_e=o.commissioningTaskLock==="purge",x=!Ce(ee)&&(xt||et||_e||zr(ee)),B=/DONE/.test(String(ee||"").toUpperCase()),Q=!!(zt||o.entities.airPurgeStatus||o.entities.airPurgeReturnToAuto),G=He("airPurgeRemaining",{decimals:0}),le=R("airPurgePhase"),Se=le===1?"Rustig":le===2?"Pulsen":le===3?"Stabiliseren":De.phase,ue=or("manualFlowStatus","IDLE"),xe=C("manualFlowActive"),ge=o.loadingEntities||o.busyAction==="manualFlowStart"||o.busyAction==="manualFlowAbort",ft=!!(o.entities.manualFlowStart||o.entities.manualFlowAbort),Mt=!!o.pendingManualFlowStart,pe=o.commissioningTaskLock==="manual-flow",Ve=!Ce(ue)&&(xe||Mt||pe||zr(ue)),tt=or("manualHpStatus","IDLE"),ht=C("manualHpActive"),bt=o.loadingEntities||o.busyAction==="manualHpStart"||o.busyAction==="manualHpAbort",_o=!!(o.entities.manualHpStart||o.entities.manualHpAbort),qe=!!o.pendingManualHpStart,$t=o.commissioningTaskLock==="manual-hp",ot=!Ce(tt)&&(ht||qe||$t||zr(tt)),Cu=/SAFETY STOP/.test(String(tt||"").toUpperCase()),xu=/STOPPING/.test(String(tt||"").toUpperCase()),po=or("hpWaterCalibrationStatus","IDLE"),fb=ui(po,"hp-water-calibration"),Mu=C("hpWaterCalibrationActive"),ba=o.loadingEntities||o.busyAction==="hpWaterCalibrationStart"||o.busyAction==="hpWaterCalibrationAbort"||o.busyAction==="hpWaterCalibrationApply",$u=!!(o.entities.hpWaterCalibrationStart||o.entities.hpWaterCalibrationAbort||o.entities.hpWaterCalibrationApply),wa=!!o.pendingHpWaterCalibrationStart,mo=o.commissioningTaskLock==="hp-water-calibration",Ue=!Ce(po)&&(Mu||wa||mo||zr(po)),ya=/DONE|APPLIED/.test(String(po||"").toUpperCase()),Au=/APPLIED/.test(String(po||"").toUpperCase()),hb=He("flowKpSuggested",{decimals:5,trimTrailingZeros:!0}),bb=He("flowKiSuggested",{decimals:5,trimTrailingZeros:!0}),Hu=/DONE|APPLIED/.test(String(w||"").toUpperCase()),Ru=/DONE|APPLIED/.test(String(H||"").toUpperCase()),rs=i?q?"Wachten op CM100":k?y.phase:Hu?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",ns=i?Z?"Wachten op CM100":W?F.phase:Ru?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",as=i?x?De.phase:B?"Klaar":"Klaar om te starten":"Wachten op CM100",Pu=i?Ve?"Actief":"Klaar om te starten":"Wachten op CM100",Nu=i?ot?xu?"Bezig met stoppen":Cu?"Veiligheidsstop":"Actief":"Klaar om te starten":"Wachten op CM100",Du=i?Ue?fb.phase:Au?"Offsets toegepast":ya?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",_u=!i||m||!d||W||x||Ve||ot||Ue||k||D||_e||pe||$t||mo||b,wb=m||!(k||S||b),yb=m||_u||!Hu||W||x||Ue,Lu=!i||A||!L||k||x||Ve||ot||Ue||W||S||_e||pe||$t||mo||_,vb=A||!(W||D||_),Sb=A||Lu||!Ru||k||x||Ue,qb=!i||gt||!zt||k||W||Ve||ot||Ue||x||S||D||pe||$t||mo||et,kb=gt||!(x||_e||et),Eb=!i||ge||!ft||k||W||x||ot||Ue||Ve||S||D||_e||$t||mo||Mt,Tb=ge||!(Ve||pe||Mt),Cb=!i||bt||!_o||k||W||x||Ve||Ue||ot||S||D||_e||pe||mo||qe,xb=bt||!(ot||$t||qe),Mb=!i||ba||!$u||k||W||x||Ve||ot||Ue||S||D||_e||pe||$t||wa,$b=ba||!(Ue||mo||wa),Ab=ba||Ue||!ya||Au;u&&i&&(o.pendingCommissioningCm100Start=!1),l&&(i||/READY|STOPPED|DONE|FAILED|ABORT|APPLIED|REFUSED/.test(n))&&(o.commissioningTaskLock=""),b&&(h||Ce(w))&&(o.pendingBoilerPowerTestStart=!1),S&&Ce(w)&&(o.commissioningTaskLock=""),_&&Ce(H)&&(o.pendingFlowAutotuneStart=!1),D&&Ce(H)&&(o.commissioningTaskLock=""),et&&(xt||Ce(ee))&&(o.pendingAirPurgeStart=!1),_e&&Ce(ee)&&(o.commissioningTaskLock=""),Mt&&(xe||Ce(ue))&&(o.pendingManualFlowStart=!1),pe&&(xe||Ce(ue))&&(o.commissioningTaskLock=""),qe&&(ht||Ce(tt))&&(o.pendingManualHpStart=!1),$t&&(ht||Ce(tt))&&(o.commissioningTaskLock=""),wa&&(Mu||Ce(po))&&(o.pendingHpWaterCalibrationStart=!1),mo&&Ce(po)&&(o.commissioningTaskLock="");let Hb=a?"Wachten op CM100":t,Rb=a?"Service-stand wordt geopend. Wacht tot CM100 klaar staat.":i?"CM100 is actief en klaar voor service-taken.":"Start de service-stand voordat je een taak uitvoert.",Pb=[{key:"hp-water-calibration",title:"Temperatuursensoren kalibreren",label:"Sensor kalibratie",summary:"Laat de waterpomp draaien zonder compressor en bepaal offsets voor HP1/HP2 water in/out.",status:Du,available:!!($u||o.entities.hpWaterCalibrationStatus),openDisabled:!i,cardMarkup:Ur({taskKey:"hp-water-calibration",title:"Temperatuursensoren kalibreren",copy:"Doorloop voorbereiding, meting en toepassen in vaste volgorde. De meting stopt eerder zodra de sensoren stabiel genoeg zijn.",subcopy:"De voorgestelde waarden worden pas actief wanneer je ze toepast; supply blijft een diagnosewaarde.",status:Du,statusCopy:Ue?"De pomp draait en de firmware wacht op een stabiel temperatuurbeeld.":ya?"Controleer de voorgestelde offsets voordat je ze toepast.":i?"CM100 staat klaar. Start de meting wanneer compressor en boiler uit zijn.":"Start CM100 eerst.",progressTask:"hp-water-calibration",controls:qS({status:po,running:Ue,resultReady:ya,startDisabled:Mb,abortDisabled:$b,applyDisabled:Ab,busy:ba,controlsAvailable:!!(o.entities.hpWaterCalibrationStart||o.entities.hpWaterCalibrationAbort)}),className:"oq-settings-commissioning-card--hp-water-calibration"})},{key:"manual-flow",title:"Handmatige flowregeling",label:"Handmatige flow",summary:"Laat de waterpomp draaien op een tijdelijk flow-setpoint en luister naar het leidingwerk.",status:Pu,available:!!(ft||o.entities.manualFlowStatus),openDisabled:!i,cardMarkup:Ur({taskKey:"manual-flow",title:"Handmatige flowregeling",copy:"Gebruik een tijdelijk flow-setpoint om het leidingwerk rustig te controleren. De normale instellingen wijzigen pas wanneer je een waarde bewust overneemt.",subcopy:"De bestaande PI-regeling blijft de pomp aansturen.",status:Pu,statusCopy:Ve?"De waterpomp draait. Pas het tijdelijke setpoint aan en controleer de gemeten flow.":i?"CM100 staat klaar. Kies een tijdelijk setpoint en start de waterpomp.":"Start CM100 eerst.",progressTask:"",controls:`
            <div class="oq-settings-manual-flow-control">
              ...
              ${o.entities.manualFlowStart||o.entities.manualFlowAbort?rr({active:Ve,startKey:"manualFlowStart",stopKey:"manualFlowAbort",startLabel:"Waterpomp starten",stopLabel:"Waterpomp stoppen",startDisabled:ge||Eb,stopDisabled:ge||Tb}):""}
            </div>
          `,metrics:`
        ...
        `},{key:"manual-hp",title:"Handmatige warmtepompbediening",label:"Handmatige warmtepomp",summary:"Selecteer een werkmodus en vraag per warmtepomp een compressorstand aan binnen de bestaande bewaking.",status:Nu,available:!!(_o||o.entities.manualHpStatus),openDisabled:!i,cardMarkup:Ur({taskKey:"manual-hp",title:"Handmatige warmtepompbediening",copy:"Start eerst de service-taak zodat de waterpomp draait. Zodra voldoende flow is gemeten kun je per warmtepomp vanuit Standby naar verwarmen of koelen schakelen en daarna een compressorstand aanvragen.",subcopy:"Low-flow, maximale watertemperatuur, minimum draaitijd, minimum uit-tijd en veilige modusovergangen blijven actief. De koelvloer, silent-modus, dag/nacht-cap en normaal uitgesloten compressorstanden worden voor deze handmatige test bewust genegeerd.",status:Nu,statusCopy:ot?xu?"De compressorvraag staat op 0. De waterpomp blijft draaien totdat de minimale draaitijd veilig is afgerond.":Cu?"De bewaking heeft de aangevraagde standen teruggezet naar 0. Controleer de oorzaak voordat je opnieuw opschaalt.":"De service-taak is actief. Een veiligheidsstop zet de aangevraagde standen terug naar 0; opnieuw opschalen vereist een bewuste handeling.":i?"CM100 staat klaar. Start de taak om handmatige warmtepompbediening vrij te geven.":"Start CM100 eerst.",progressTask:"",actions:`
            ${o.entities.manualHpStart||o.entities.manualHpAbort?rr({active:ot,startKey:"manualHpStart",stopKey:"manualHpAbort",startLabel:"Bediening starten",stopLabel:"Bediening stoppen",startDisabled:bt||Cb,stopDisabled:bt||xb}):""}
          `,controls:`
          ...
          `})},{key:"autotune",title:"Flow autotune",label:"Autotune",summary:"Berekent een voorstel voor de flowregeling en kan Kp/Ki daarna toepassen.",status:ns,available:!0,openDisabled:mr(ns),cardMarkup:Ur({taskKey:"autotune",title:"Flow autotune",copy:"Bereken een voorstel voor de flowregeling en pas dat daarna toe in de installatie-instellingen. Autotune duurt meestal ongeveer 5 tot 10 minuten.",subcopy:"Na toepassen worden de flow-instellingen bijgewerkt.",status:ns,statusCopy:Z?"Wacht totdat CM100 actief is voordat je autotune start.":W?"Autotune draait op dit moment.":i?"CM100 staat klaar. Start de autotune wanneer je wilt.":"Start CM100 eerst en voer daarna autotune uit.",progressTask:"autotune",actions:`
            ${o.entities.flowAutotuneStart||o.entities.flowAutotuneAbort?rr({active:W,startKey:"flowAutotuneStart",stopKey:"flowAutotuneAbort",startLabel:"Autotune starten",stopLabel:"Autotune stoppen",startDisabled:A||Lu,stopDisabled:A||vb}):""}
            ${o.entities.flowAutotuneApply?Je("flowAutotuneApply","Toepassen","oq-helper-button oq-helper-button--ghost",A||Sb):""}
          `,metrics:`
            ${Ne("flowKpSuggested","Voorgestelde Kp","Kp bepaalt hoe sterk de regeling meteen corrigeert.",hb,"oq-settings-field--compact")}
            ${Ne("flowKiSuggested","Voorgestelde Ki","Ki corrigeert kleine afwijkingen langzaam weg.",bb,"oq-settings-field--compact")}
          `})},{key:"boiler",title:"Boiler power test",label:"Boiler test",summary:"Meet het effectieve boilervermogen bij stabiele flow en kan het resultaat toepassen.",status:rs,available:e,openDisabled:mr(rs),cardMarkup:Ur({taskKey:"boiler",title:"Boiler power test",copy:"Meet het effectieve boilervermogen bij stabiele flow en schrijf daarna een afgerond voorstel weg naar de boilerinstelling. Boilertest duurt meestal ongeveer 5 tot 10 minuten.",subcopy:`Ingesteld boilervermogen: ${s(M)}`,status:rs,statusCopy:q?"Wacht totdat CM100 actief is voordat je de boiler-test start.":k?"De boiler-test draait op dit moment.":i?"CM100 staat klaar. Start de boiler-test wanneer je wilt.":"Start CM100 eerst en voer daarna de boilervermogentest uit.",progressTask:"boiler",actions:`
            ${o.entities.boilerPowerTestStart||o.entities.boilerPowerTestAbort?rr({active:k,startKey:"boilerPowerTestStart",stopKey:"boilerPowerTestAbort",startLabel:"Boiler test starten",stopLabel:"Boiler test stoppen",startDisabled:m||_u,stopDisabled:m||wb}):""}
            ${o.entities.boilerPowerTestApply?Je("boilerPowerTestApply","Toepassen","oq-helper-button oq-helper-button--ghost",m||yb):""}
          `,metrics:`
          ...
          `})},{key:"purge",title:"Ontluchten",label:"Ontluchten",summary:"Draait een vaste ontluchtingsrun van 5 minuten met rustige flow, pomp-pulsen en stabilisatie.",status:as,available:Q,openDisabled:mr(as),cardMarkup:Ur({taskKey:"purge",title:"Ontluchten",copy:"Draait 5 minuten met rustige doorstroming, korte pomp-pulsen en een stabilisatiefase.",subcopy:"Na afloop kan OpenQuatt de service mode (CM100) afsluiten of actief laten.",status:as,statusCopy:x?"Ontluchten loopt vast 5 minuten door en stopt daarna automatisch.":i?"CM100 staat klaar. Start ontluchten wanneer het circuit open staat.":"Start CM100 eerst en voer daarna ontluchten uit.",progressTask:"purge",className:"oq-settings-commissioning-card--air-purge",actions:`
            ${o.entities.airPurgeStart||o.entities.airPurgeAbort?rr({active:x,startKey:"airPurgeStart",stopKey:"airPurgeAbort",startLabel:"Ontluchten starten",stopLabel:"Ontluchten stoppen",startDisabled:gt||qb,stopDisabled:gt||kb}):""}
          `,metrics:`
          ...
          `})}].filter(Nb=>Nb.available);return{cm100Status:Hb,cm100StartDisabled:p,cm100StopDisabled:g,serviceStatusCopy:Rb,tasks:Pb}}function kS(e){return Oe({dataAttribute:"data-oq-service-task",dataValue:e.key,className:"oq-settings-service-row",label:e.label,value:e.status,note:e.summary,action:`<button
          class="oq-helper-button oq-helper-button--ghost"
          type="button"
...
Alle bewaarde dagtotalen worden verwijderd. Dit heeft geen invloed op de werking van je warmtepomp.`))return e("lifetimeEnergyHistoryClear",{successNotice:"Energiehistorie is gewist.",errorPrefix:"Energiehistorie kon niet worden gewist",refreshKeys:to(),refreshDelayMs:500}).then(()=>{o.energyHistoryRaw="",o.energyHistorySignature="",o.energyHistoryLastFetchAt=0,Ro(),o.appView==="results"&&hr({force:!0}).then(()=>f())})},"select-energy-history-import-file":()=>eq(),"clear-energy-history-import-file":()=>{Xm(),f()},"import-energy-history-file":()=>tq(),"export-energy-history":()=>FS(),"open-history-storage-modal":()=>{o.settingsStoragePage="overview",o.systemModal="history-storage",f();let e=qi({forceMissing:!0,forceTrendHistory:!0,forceDecisionLog:!0,forceEnergyHistory:!0}).finally(()=>{o.systemModal==="history-storage"&&f()});return Ro([1e3,3e3,7e3]),e},"open-storage-diagnosis":()=>{o.settingsStoragePage="diagnosis",f()},"open-storage-decision-log":()=>{o.settingsStoragePage="decision-log",f()},"open-storage-energy":()=>{o.settingsStoragePage="energy",f()},"back-storage-overview":()=>{o.settingsStoragePage="overview",f()},"download-settings-backup":()=>lq(),"open-settings-backup-import":()=>{o.settingsBackupMqttPassword="",o.settingsBackupRestoreResult=null,o.settingsBackupError="",o.systemModal="settings-backup-import",f()},"confirm-settings-backup-restore":()=>mq()};function dg(e,t){return ie(gq,e,t)}function lc(e,t,r="",n=!1){return`
      <div class="oq-settings-storage-summary-metric${n?" is-on":""}">
        <span>${s(e)}</span>
        <strong>${s(t)}</strong>
        ${r?`<em>${s(r)}</em>`:""}
      </div>
    `}function mg(e){let t=String(e||"").trim(),r=t.match(/^(\d+(?:[.,]\d+)?)\s+records?$/i);return r?`${r[1]} ${r[1]==="1"?"dag":"dagen"}`:t}function Ei(e,t,r,n="",a="",i=""){if(!v(e))return"";let l=!!T(e),c=o.loadingEntities||o.busyAction===`switch-${e}`;return`
    ...
    `}function fq(e,t,r,n=""){if(!v(e))return"";let a=o.entities[e],i=Array.isArray(a?.option)?a.option:[],l=String(T(e)||"");return i.length?`
    ...
    `:""}function hq(e){return v(e)||!!O[e]&&!o.optionalMissingEntities?.[e]}function Jn(e,t,r,n={}){if(!hq(e))return"";let a=v(e),i=a&&(o.loadingEntities||o.busyAction===e),l=n.disabled===!0||!a,c=n.buttonClass||"oq-helper-button oq-helper-button--ghost";return`
      <button
        class="${s(c)}"
        type="button"
        data-oq-action="${s(r)}"
    ...
    `}function bq(){return o.trendHistoryMetadata&&typeof o.trendHistoryMetadata=="object"?o.trendHistoryMetadata:{}}function en(){return!!o.trendHistoryMetadataSignature}function tn(){return!!(o.energyHistoryRaw||o.energyHistorySignature)}function ut(e){return e?"Niet geladen":"Laden..."}function je(e,t="\u2014"){if(v(e))return He(e);let r=wq(e);return r==null||r===""?t:r}function wq(e){let t=bq();if(e==="trendHistoryFlashAvailable")return en()?t.available||"Alleen live":ut(o.trendHistoryMetadataError);if(e==="trendHistoryFlashOldest")return en()?t.oldest||"Geen data":ut(o.trendHistoryMetadataError);if(e==="trendHistoryFlashNewest")return en()?t.newest||"Geen data":ut(o.trendHistoryMetadataError);if(e==="trendHistoryFlashLastFlush")return en()?t.lastFlush||"Geen data":ut(o.trendHistoryMetadataError);if(e==="trendHistoryFlashSize")return en()?Ci(t.sizeKb):ut(o.trendHistoryMetadataError);if(e==="trendHistoryFlashWrites")return en()?Zn(t.writes):ut(o.trendHistoryMetadataError);let r=bg(),a=String(o.energyHistoryRaw||"").includes("@day_retention|");return e==="lifetimeEnergyHistoryAvailable"?tn()?a&&!r.dayPartitionAvailable?"Niet beschikbaar":gg(r.storedDayCount,"Geen data"):ut(o.energyHistoryError):e==="lifetimeEnergyHistoryOldest"?tn()?pg(r.oldestDateKey):ut(o.energyHistoryError):e==="lifetimeEnergyHistoryNewest"?tn()?pg(r.newestDateKey):ut(o.energyHistoryError):e==="lifetimeEnergyHistoryLastWrite"?tn()?Ti(r.dayLastWriteTimestampS):ut(o.energyHistoryError):e==="lifetimeEnergyHistorySize"?tn()?Ci(r.dayStorageKb):ut(o.energyHistoryError):e==="lifetimeEnergyHistoryWrites"?tn()?Zn(r.dayWriteCount):ut(o.energyHistoryError):null}function gg(e,t="Geen data"){let r=Number(e);return!Number.isFinite(r)||r<=0?t:`${Math.round(r)} ${Math.round(r)===1?"dag":"dagen"}`}function fg(e,t="Nog geen historie"){let r=Math.max(0,Math.round(Number(e)||0));return r<=0?t:`${r} ${r===1?"gebeurtenis":"gebeurtenissen"}`}function hg(){return o.decisionLogStorageMetadata&&typeof o.decisionLogStorageMetadata=="object"?o.decisionLogStorageMetadata:{}}function Ci(e,t="\u2014"){let r=Number(e);return!Number.isFinite(r)||r<=0?t:`${Math.round(r)} kB`}function Zn(e,t="0"){let r=Number(e);return!Number.isFinite(r)||r<=0?t:String(Math.round(r))}function pg(e){let t=ne(e);return t?t.date.toLocaleDateString("nl-NL",{day:"2-digit",month:"2-digit",year:"numeric"}):"Geen data"}function Ti(e,t="Geen data"){let r=Number(e);if(!Number.isFinite(r)||r<=0)return t;let n=new Date(r*1e3),a=n.toLocaleDateString("nl-NL",{day:"2-digit",month:"2-digit"}),i=n.toLocaleTimeString("nl-NL",{hour:"2-digit",minute:"2-digit"});return`${a} ${i}`}function bg(){return mi(o.energyHistoryRaw)}function yq(e){let t=Array.isArray(e.items)?e.items:[];return`
    ...
    `:""}function wg(){if(!v("trendHistoryEnabled")&&!v("decisionLogHistoryEnabled")&&!v("lifetimeEnergyHistoryEnabled"))return"";let e=C("trendHistoryEnabled"),t=e&&C("trendHistoryFlashEnabled"),r=v("lifetimeEnergyHistoryEnabled"),n=r&&C("lifetimeEnergyHistoryEnabled"),a=v("decisionLogHistoryEnabled"),i=a&&C("decisionLogHistoryEnabled"),l=hg(),c=t?je("trendHistoryFlashAvailable","Alleen live"):"Alleen live",u=r?mg(je("lifetimeEnergyHistoryAvailable","Geen data")):"Geen data";return re("Diagnose","Gegevens bewaren","Bepaal welke gegevens OpenQuatt bewaart voor grafieken, resultaten en hulp bij problemen.",`
        <article class="oq-settings-storage-summary">
          ...
          <div class="oq-settings-storage-summary-metrics" aria-label="Opslagstatus">
            ...
            ${a?lc("Beslislog",i?fg(l.storedEvents):"Alleen sinds herstart",i?"Maximaal 7 dagen":"Tijdelijk",i):""}
      ...
      `)}function vq(){if(!v("lifetimeEnergyHistoryEnabled"))return"";let e=o.energyHistoryImportRecords.length,t=new Set(o.energyHistoryImportHourRecords.map(c=>c.dateKey)).size,r=[];e>0&&r.push(`${e} dagrecords`),t>0&&r.push(`${t} uurdagen`),o.energyHistoryImportRange&&r.push(o.energyHistoryImportRange),o.energyHistoryImportSource&&r.push(o.energyHistoryImportSource),o.energyHistoryImportInvalidCount>0&&r.push(`${o.energyHistoryImportInvalidCount} regels niet gebruikt`);let n=!!o.energyHistoryImportFileName,a=e>0||t>0,i=Number(o.energyHistoryImportProgressPercent||0),l=o.energyHistoryImportBusy?`Importeren...${i>0?` (${i}%)`:""}`:"Importeren";return`
    ...
    `}function Sq(){if(!v("lifetimeEnergyHistoryEnabled"))return"";let e=Zr(o.energyHistoryExportMode),t=Qn.map(n=>`
    ...
    `}function yg(){let e=["diagnosis","decision-log","energy"].includes(o.settingsStoragePage)?o.settingsStoragePage:"overview",t=v("trendHistoryEnabled")&&C("trendHistoryEnabled"),r=t&&v("trendHistoryFlashEnabled")&&C("trendHistoryFlashEnabled"),n=v("decisionLogHistoryEnabled"),a=n&&C("decisionLogHistoryEnabled"),i=hg(),l=fg(i.storedEvents),c=v("lifetimeEnergyHistoryEnabled"),u=c&&C("lifetimeEnergyHistoryEnabled"),p=c?je("lifetimeEnergyHistoryAvailable","Geen data"):"Geen data",g=mg(p),w=v("lifetimeEnergyHistoryClear")&&!["Geen data","\u2014"].includes(p),y=t&&v("trendHistoryFlush"),h=a&&v("decisionLogHistoryFlush"),m=v("lifetimeEnergyHistoryCapture"),d=bg(),b=String(o.energyHistoryRaw||"").includes("@hour_retention|"),S=b&&!d.hourPartitionAvailable,q=b?S?"Alleen live":gg(d.hourStoredDayCount,"Geen uurdata"):"Laden...",E=b&&!S?Ci(d.hourStorageKb):"\u2014",k=b&&!S?Zn(d.hourWriteCount):"\u2014",M=b&&!S?Ti(d.hourLastWriteTimestampS):"Geen data",P=e==="overview"?"":`
      ...
      <div class="oq-settings-storage-hub">
        ${N("open-storage-diagnosis","Diagnose","Technische meetgegevens","Temperaturen, doorstroming en vermogen voor grafieken en support.",r?je("trendHistoryFlashAvailable","Historie actief"):t?"Alleen live":"Uit",t)}
      ...
      <p class="oq-settings-storage-footnote"><strong>Goed om te weten:</strong> gegevens die worden bewaard, blijven beschikbaar na een herstart. Tijdelijke gegevens bestaan alleen zolang de controller online is.</p>`;return e==="diagnosis"?(A="Diagnosegegevens",L="Beheer technische meetreeksen voor diagnosegrafieken en hulp bij problemen.",_=`${P}<section class="oq-settings-storage-domain oq-settings-storage-domain--single">
        ...
        <div class="oq-settings-storage-domain-rows">
          ...
          ${h?`<div class="oq-settings-storage-inline-action"><div><h4>Beslislog nu opslaan</h4><p>Sla nieuwe gebeurtenissen alvast op v\xF3\xF3r een update of herstart.</p></div>${Jn("decisionLogHistoryFlush","Nu opslaan","flush-decision-log-history",{disabled:!a,busyLabel:"Opslaan..."})}</div>`:""}
        </div>
      </section>${cc([H])}
      ${v("decisionLogHistoryClear")?`<details class="oq-settings-storage-advanced"${o.settingsStorageAdvancedOpen?" open":""}><summary data-oq-action="toggle-storage-advanced">Geavanceerd</summary><div class="oq-settings-storage-inline-action oq-settings-storage-inline-action--danger"><div><h4>Beslisloghistorie wissen</h4><p>Verwijder alle bewaarde gebeurtenissen. De actuele beslislog blijft staan.</p></div>${Jn("decisionLogHistoryClear","Historie wissen","clear-decision-log-history",{disabled:Number(i.storedEvents||0)<=0,buttonClass:"oq-helper-button oq-helper-button--warning",busyLabel:"Wissen..."})}</div></details>`:""}`):e==="energy"&&(A="Energiehistorie",L="Beheer dagtotalen en uurdetail voor de Resultatenpagina.",_=`${P}<section class="oq-settings-storage-domain oq-settings-storage-domain--single">
        <div class="oq-settings-storage-domain-rows">
          ...
          ${fq("lifetimeEnergyHourRetention","Uurdetail bewaren","Kies hoelang OpenQuatt detail per uur bewaart voor de daggrafiek.","Bewaartermijn")}
    ...
    `}function Eq(){if(!o.root)return!1;let e=o.root.querySelector(".oq-helper-status-grid");if(!e)return!!o.root.querySelector(".oq-helper-hub");let t=Eg();if(e.querySelectorAll("[data-oq-header-status]").length!==t.length)return e.outerHTML=Xn(),!0;for(let[n,a,i,l]of t){let c=e.querySelector(`[data-oq-header-status="${n}"]`);if(!c)return e.outerHTML=Xn(),!0;let u=kg(n),p=!!(l||u);if(c.tagName.toLowerCase()!==(p?"button":"div"))return e.outerHTML=Xn(),!0;let g=c.querySelector(".oq-helper-status-label"),w=c.querySelector(".oq-helper-status-value");if(!g||!w)return e.outerHTML=Xn(),!0;g.textContent!==a&&(g.textContent=a);let y=Cg(n),h=y?`<span class="oq-helper-status-value-text">${s(i)}</span><span class="oq-helper-status-badge" aria-label="Update beschikbaar" title="Update beschikbaar"></span>`:s(i);w.innerHTML!==h&&(w.innerHTML=h),p?c.setAttribute("data-oq-action",u):c.removeAttribute("data-oq-action"),c.classList.toggle("oq-helper-status-item--button",p),c.classList.toggle("oq-helper-status-item--attention",y)}return!0}function Tq(){return""}function pc(){return""}function xg(){let e=o.nativeOpen?"native":"app",t=Tg();return o.interfacePanelOpen?`
    ...
    `}Qd({getSignature:xi,patch:Eq});function $g(){if(o.systemModal==="login")return Mm();if(o.systemModal==="api-security")return xm();if(o.systemModal==="mqtt")return up();if(o.systemModal==="mqtt-sensors")return dp();if(o.systemModal==="connectivity"){let e=kq();return te({modalId:"system",titleId:"oq-system-modal-title",kicker:"Systeem",title:"Connectiviteit",closeAction:"close-system-modal",closeLabel:"Sluit systeem-popup",bodyMarkup:`
      ...
      `:"";return te({modalId:"system",titleId:"oq-backup-success-modal-title",kicker:"Beheer",title:"Backup hersteld",closeAction:"close-system-modal",closeLabel:"Sluit bevestiging",className:"oq-helper-modal--wide oq-helper-modal--scrollable",bodyMarkup:`
        ...
        `})}return""}function Cq(e=!1){let t=Pa();return t?`
    ...
    `:""}function mc(){return`
      <div class="oq-settings-curve-grid">
        ...
        ${ce("curveFallbackSupply","Fallback-aanvoertemperatuur zonder buitentemperatuur","Aanvoertemperatuur die gebruikt wordt als de buitentemperatuursensor niet beschikbaar is.","oq-settings-field--curve-fallback-card",{footerMarkup:Cq()})}
      </div>
    ...
    `}function xq(e="oq-settings-grid"){let t=[ce("flowKp","Flow PI Kp","Hoe sterk de regeling direct reageert op een afwijking."),ce("flowKi","Flow PI Ki","Hoe snel de regeling kleine restfouten wegwerkt.")].filter(Boolean);return t.length?`
      <div class="${s(e)}">
        ${t.join("")}
      </div>
    ...
    `}function Mq(){if(!v("phResponseProfile"))return"";let e=String(T("phResponseProfile")||""),t=o.loadingEntities||o.busyAction==="save-phResponseProfile",n=`
    ...
    `;return ve("curveControlProfile","Regelprofiel","Kies of de stooklijn vooral comfortabel, gebalanceerd of rustig moet reageren.",n,"oq-settings-field--span-2")}function $q(){let e=(D,Z=0)=>{let I=R(D);return Number.isNaN(I)?Z:Math.max(0,I)},r=e("phComfortBelow",.1),n=e("phComfortAbove",.3),a=e("phKp",3e3),i=20-r,l=20+n,c=620,u=184,p=46,g=24,w=18,y=40,h=96,m=c-p-g,d=Math.min(20-1.2,i-.35),b=Math.max(20+1.2,l+.35),S=D=>p+(D-d)/Math.max(.01,b-d)*m,q=S(d),E=S(b),k=S(i),M=S(20),P=S(l),N=Math.abs(i-20)>.001,V=Math.abs(l-20)>.001,H=w+24,F=u-y,A=h-44,L=(D,Z,I,W="")=>{let xt=Math.max(q+4,Math.min(E-110-4,D-55)),gt=D-14,zt=A,et=28,_e=h-A+16;return`
        <g class="oq-ph-concept-hotspot" tabindex="0" role="img" aria-label="${s(`${Z} ${I}`)}">
          ...
          <circle class="oq-ph-concept-hit" cx="${D}" cy="${h}" r="14"></circle>
      ...
      `},_=[`M ${q.toFixed(1)} ${H.toFixed(1)}`,`L ${k.toFixed(1)} ${h.toFixed(1)}`,`L ${P.toFixed(1)} ${h.toFixed(1)}`,`L ${E.toFixed(1)} ${F.toFixed(1)}`].join(" ");return`
    ...
    `:""}function Ag(){let e=xq();return re("Installatie","Flowregeling","Kies hoe de pomp wordt geregeld en stel de flow-instellingen direct als installatieparameter in. De autotune vind je later bij Service & commissioning.",`
        ${fc()}
        ${e?`
          <div class="oq-settings-subpanel oq-settings-subpanel--nested">
            <div class="oq-settings-subpanel-head">
      ...
      `;return re("Regeling","Verwarmingsstrategie","Kies hier hoe OpenQuatt je verwarming regelt. De instellingen hieronder passen zich automatisch aan.",`
        ...
        ${bc()}
        ${e}
      `)}function Sc(){let r={top:22,right:18,bottom:38,left:34},n=560-r.left-r.right,a=240-r.top-r.bottom,i=he[0].outdoor,l=he[he.length-1].outdoor,c=h=>r.left+(h-i)/(l-i)*n,u=h=>r.top+(70-h)/50*a,p=[20,30,40,50,60,70].map(h=>{let m=u(h);return`
    ...
    `}function Aq(){return pn.filter(e=>v(Me(e,"Status"))||v(Me(e,"Load"))||v(Lo(e,"cooling",0)))}function Hq(e){return Re(Ae(e))}function Rq(e){let t=[];return qa.forEach(r=>{let n=-1/0;xr.forEach(a=>{let i=Lo(e,r,a),l=Hq(i);(!Number.isFinite(l)||l<0||l>120||l<n)&&t.push(`${r==="cooling"?"C":"H"}F${a}`),Number.isFinite(l)&&(n=l)})}),{valid:t.length===0,invalid:t}}function Pq(e){let t=String(T(`hp${e}Mode`)||"").trim(),r=Re(T(`hp${e}Freq`)),n=t&&t!=="Onbekend"&&t!=="Unknown",a=Number.isFinite(r),i=n&&/standby|stand-by/i.test(t),l=a&&r<=.5,c=n?i?a?l?"Standby en compressor uit.":`Compressor draait op ${r.toFixed(0)} Hz.`:"Compressorfrequentie is onbekend.":`ODU staat in ${t}.`:"ODU status is onbekend.";return{mode:n?t:"Onbekend",freq:Number.isFinite(r)?`${r.toFixed(0)} Hz`:"Onbekend",safe:i&&l,reason:c}}function Nq(e){let t=String(e||"").toUpperCase();return!e||t==="UNKNOWN"||t==="UNAVAILABLE"?"Nog geen readback of apply-status ontvangen.":t.includes("APPLIED")?"Runtime registers zijn geschreven en via readback bevestigd. Een ODU powercycle zet de originele tabel terug.":t.includes("GUARD_READ_REQUESTED")?"Firmware leest actuele ODU mode en compressorfrequentie voordat er geschreven wordt.":t.includes("WRITE_QUEUED")||t.includes("WRITE_CONFIRMED")?"Runtime write loopt; wacht op bevestigde readback voordat je de waarden vertrouwt.":t.includes("FAILED")?"Firmware kon de runtime tabel niet volledig bevestigen. Laad opnieuw voordat je verder test.":t.includes("LOADED")?"Readback is in de velden geladen. Controleer de waarden voordat je schrijft.":t.includes("BLOCKED")?"Firmware heeft de actie geblokkeerd; controleer enable, standby en compressorstatus.":t.includes("LOAD_REQUESTED")?"Readback is aangevraagd bij de ODU.":"Laatste status van de experimentele runtime tabel."}function Rg(e,t){return v(e)?Eo({key:e,value:Ae(e),meta:Be(e),controlClass:"oq-helper-control oq-helper-control--suffix oq-settings-odu-runtime-control",inputClass:"oq-helper-input oq-helper-input--compact-number oq-settings-odu-runtime-input",inputAttributes:`data-oq-odu-runtime-tab-index="${t}"`,unitMarkup:'<span class="oq-helper-unit-chip">Hz</span>'}):'<span class="oq-settings-odu-runtime-missing">-</span>'}function Dq(e){let t=xr.length;return`
      <div class="oq-settings-odu-runtime-table" role="table" aria-label="${s(`HP${e} ODU runtime frequentietabel`)}">
        ...
        ${xr.map(r=>`
          <div class="oq-settings-odu-runtime-row" role="row">
            ...
            <div role="cell">${Rg(Lo(e,"cooling",r),r)}</div>
            <div role="cell">${Rg(Lo(e,"heating",r),t+r)}</div>
          </div>
        `).join("")}
      </div>
    `}function Dg(e){if(e.key!=="Tab"||e.altKey||e.ctrlKey||e.metaKey)return;let t=e.target&&e.target.closest?e.target.closest("input[data-oq-odu-runtime-tab-index]"):null,r=t?t.closest(".oq-settings-odu-runtime-table"):null;if(!t||!r)return;let n=Array.from(r.querySelectorAll("input[data-oq-odu-runtime-tab-index]:not(:disabled)")).sort((l,c)=>Number(l.dataset.oqOduRuntimeTabIndex||0)-Number(c.dataset.oqOduRuntimeTabIndex||0)),a=n.indexOf(t),i=n[a+(e.shiftKey?-1:1)];a<0||!i||(e.preventDefault(),i.focus(),typeof i.select=="function"&&i.select())}function _q(e){let t=Me(e,"Enable"),r=Me(e,"Load"),n=Me(e,"Apply"),a=Me(e,"Status"),i=String(T(a)||"").trim()||"Nog niet geladen",l=Rq(e),c=Pq(e),u=!!T(t),p=o.loadingEntities||o.busyAction===r||o.busyAction===n,g=p||!u||!l.valid||!c.safe||!v(n),w=l.valid?"Waarden zijn 0-120 Hz en per tabel oplopend.":`Controleer ${l.invalid.slice(0,5).join(", ")}${l.invalid.length>5?"...":""}.`;return`
    ...
    `}function _g(){let e=Aq();return e.length?`
    ...
    `}function Po(e){let t=R(e);return Number.isNaN(t)?"\u2014":String(Math.max(0,Math.round(t)))}function Lq(e){let t=R(e);if(Number.isNaN(t))return"Nog niet gemeten";if(t<1)return"Zojuist";if(t<60)return`${Math.round(t)} min geleden`;let r=Math.floor(t/60),n=Math.round(t%60);return`${r}u ${n}m geleden`}function Pg(e){let t=R(e);return Number.isNaN(t)||t<=0?"Tijdstip onbekend":new Intl.DateTimeFormat("nl-NL",{day:"2-digit",month:"short",hour:"2-digit",minute:"2-digit"}).format(new Date(t*1e3))}function Oq(e){if(!e.cyclingAlertLatched)return"";let t=X("compressorCyclingAlertAlternating"),r=Po("compressorCyclingAlertHp1Peak2h"),n=Po("compressorCyclingAlertHp1Peak72h"),a=v("compressorCyclingAlertHp2Peak2h")?Po("compressorCyclingAlertHp2Peak2h"):"",i=v("compressorCyclingAlertHp2Peak72h")?Po("compressorCyclingAlertHp2Peak72h"):"";return`
    ...
    `}function Ng(e,t){return v(`${t}CompressorStarts2h`)?`
      <div class="oq-settings-monitoring-compressor-unit">
        <div>
          <p>${s(e)}</p>
          <span>Laatste start: ${s(Lq(`${t}CompressorLastStartAge`))}</span>
        </div>
        <dl>
...
Kenmerken: Flowmeter in de buitenunit ge\xEFntegreerd. Onder CV-ketel enkel een kleine clip-on temperatuursensor.`}},t=o.entities.hpGeneration||{},r=String(T("hpGeneration")||""),n=ro(t),a=o.loadingEntities||o.busyAction==="save-hpGeneration";return`
    ...
    `}function Og(){let e=Lt(),t=o.entities.hpGeneration||{},r=v("hpGeneration")&&ro(t).length>0;return!e&&!r?"":re("Basis","Quatt Hybrid-versie","Kies hier welke Quatt Hybrid je hebt. Deze keuze bepaalt de basis van de regeling.",`
      ...
      `)}function jg(){let e=$o(),t=za(),r=o.busyAction==="restartAction";return re("Diagnostiek","Systeemstatus","Snelle statusinformatie voor support, controle en onderhoud.",`
      ...
      `)}function Wg(){let e=[vc("Warmtepomp 1","hp1ExcludedA","hp1ExcludedB"),vc("Warmtepomp 2","hp2ExcludedA","hp2ExcludedB")].filter(Boolean).join("");return re("Installatie","Compressorinstellingen","Stel hier de minimale draaitijd in en bepaal per warmtepomp welke compressorstanden je wilt overslaan.",`
        <div class="oq-settings-subpanel">
          <div class="oq-settings-subpanel-head">
  ...
  `}function Iq(){let e=oe(),t=st(),r=`${e}:${t}`,n=o.quickStartSetupDraft||r,[a,i]=n.split(":");return{...ei(a,i),currentKey:r,selectedKey:n,changes:n!==r,targetIsDuo:a==="duo",targetIsEthernet:i==="eth"}}function Fq(){let e=Iq(),t=Et(),r=!!(t||o.updateInstallBusy),n=[["single:wifi","Single \xB7 Wi-Fi","E\xE9n warmtepomp via het draadloze netwerk."],["single:eth","Single \xB7 Ethernet","E\xE9n warmtepomp via een vaste netwerkkabel."],["duo:wifi","Duo \xB7 Wi-Fi","Twee warmtepompen via het draadloze netwerk."],["duo:eth","Duo \xB7 Ethernet","Twee warmtepompen via een vaste netwerkkabel."]],a=[e.targetIsDuo?"De tweede warmtepomp is aangesloten en hoort bij deze controller.":"Deze controller wordt voor \xE9\xE9n warmtepomp gebruikt.",e.targetIsEthernet?"De netwerkkabel is aangesloten.":"De Wi-Fi-gegevens zijn beschikbaar op de controller."];return`
    ...
    `}function jq(e){let t=String(e||"").trim();if(!t)return"";try{let r=new URL(/^[a-z][a-z0-9+.-]*:\/\//i.test(t)?t:`http://${t}`);return r.protocol!=="http:"&&r.protocol!=="https:"?"":(r.port||(r.port="8080"),(!r.pathname||r.pathname==="/")&&(r.pathname="/beta/feed/data.json"),r.toString())}catch{return""}}function zg(){let e=String(T("cicFeedUrl")||"").trim(),t=o.quickStartCicFeedUrlDraft===null?e:String(o.quickStartCicFeedUrlDraft||"");return{configuredUrl:e,draftUrl:t,normalizedDraftUrl:jq(t)}}function Ug(e,t){return`
    ...
    `}function Vq(){let e=Ri(),t=o.busyAction==="quickstart-thermostat-source",r=e.status==="Geldig"?" is-active":"",n=e.isRemoteProfile?`
    ...
    `:"",a=e.selectedSource==="CIC"?Ug(e,t):"",i=e.selectedSource==="HA input"?`
    ...
    `}function Gg(){return!o.quickStartModalOpen||o.loadingEntities||o.complete===null||o.complete&&o.quickStartModalMode!=="generation"?"":o.quickStartModalMode==="generation"?te({id:"quickstart-forced",titleId:"oq-generation-modal-title",kicker:"Installatie",title:"Quatt Hybrid-versie aanpassen",copy:"Kies de versie die bij jouw Quatt hoort. Deze keuze bepaalt de basis van de regeling.",copyInHeader:!0,backdropClass:"oq-helper-modal-backdrop--quickstart",className:"oq-helper-modal--wide oq-helper-modal--quickstart oq-helper-modal--generation",sectionAttributes:'data-oq-quickstart-scroller data-oq-quickstart-step="generation"',closeAction:"close-quickstart-modal",closeLabel:"Sluit versie-popup",body:Kg("picker")}):te({id:"quickstart-forced",titleId:"oq-quickstart-modal-title",kicker:"Quick Start",title:"Rond eerst de Quick Start af",copy:"Controleer eerst je setup en loop daarna stap voor stap door de basisinstellingen.",copyInHeader:!0,backdropClass:"oq-helper-modal-backdrop--quickstart",className:"oq-helper-modal--wide oq-helper-modal--quickstart",sectionAttributes:`data-oq-quickstart-scroller data-oq-quickstart-step="${s(Jg().id)}"`,closeAction:"close-quickstart-modal",closeLabel:"Sluit Quick Start-popup",body:`<div class="oq-helper-grid oq-helper-grid--quickstart oq-helper-grid--quickstart-modal">${Zq()}${tk()}</div>`})}function Bq(){return o.root?o.root.querySelector("[data-oq-quickstart-scroller]"):null}var Qg=ko({getScroller:Bq,getToken:()=>o.quickStartScrollRestoreToken,setToken:e=>{o.quickStartScrollRestoreToken=e},isActive:()=>o.quickStartModalOpen,getIdentity:e=>String(e.dataset.oqQuickstartStep||""),preserveGrowth:!0,stickToBottom:!0}),Yg=Qg.capture,Tc=Qg.queue;function Bg(){return`
      <section class="oq-helper-panel">
    ...
    `}function Yq(){let e=C("usageTelemetryEnabled"),t=o.loadingEntities||o.busyAction==="switch-usageTelemetryEnabled";return`
      <section class="oq-helper-panel">
    ...
    `}function Zq(){let e=Jg().id;return e==="setup"?Fq():e==="generation"?Kg():e==="boiler"?v("boilerCvAssistEnabled")?Kq():Bg():e==="flow-source"?Wq():e==="thermostat-source"?Vq():e==="flow"?zq():e==="heating"?Uq():e==="water"?Gq():e==="silent"?Qq():e==="usage-telemetry"?Yq():e==="confirm"?Jq():Bg()}function br(){let e=Ec().isQEdition;return Cr.filter(t=>(t.id!=="setup"||e)&&(!t.optionalEntity||v(t.optionalEntity)))}function dt(e){let t=br().findIndex(r=>r.id===e);return`Stap ${Math.max(0,t)+1}`}function Xq(e){let t=Pi(),r=e===t,n=o.complete===!0||e<t;return{tone:r?"current":n?"done":"upcoming",label:r?"Actief":n?"Gereed":"Volgend",current:r}}function ek(e=!1){return br().map((t,r)=>{let n=Xq(r);return`
        <button
      ...
      `}).join("")}function Jg(){let e=br();return e.find(t=>t.id===o.currentStep)||e[0]||Cr[0]}function Pi(){return Math.max(0,br().findIndex(e=>e.id===o.currentStep))}function Zg(e){let t=br(),r=Math.min(t.length-1,Math.max(0,Pi()+e));o.currentStep=t[r]?.id||Cr[0].id}function Ct(e={}){let t=Pi(),r=br(),n=t>0?r[t-1]:null,a=t<r.length-1?r[t+1]:null;return`
    ...
    `}function tk(){let e=Pi(),t=br();return`
    ...
    `}function ok(){let e=ke(j("hpGeneration")),t=ae()?"Stooklijn":"Power House",r=S=>ke(j(S)),n=[],a=ae()?[["Regelprofiel",r("curveControlProfile")],["Aanvoer bij -20\xB0C",Y("curveM20")],["Aanvoer bij -10\xB0C",Y("curveM10")],["Aanvoer bij 0\xB0C",Y("curve0")],["Aanvoer bij 5\xB0C",Y("curve5")],["Aanvoer bij 10\xB0C",Y("curve10")],["Aanvoer bij 15\xB0C",Y("curve15")],["Fallback-aanvoer",Y("curveFallbackSupply")]]:[["Profiel",r("phResponseProfile")],["Rated maximum house power",Y("housePower")],["Maximum heating outdoor temperature",Y("houseOutdoorMax")],["Temperatuurreactie",Y("phKp")],["Comfort onder setpoint",Y("phComfortBelow")],["Comfort boven setpoint",Y("phComfortAbove")]],i=String(T("flowControlMode")||""),l=rn(),c=[["Status",l.status],["Actuele flow",l.flowAvailable?`${Math.round(l.flowValue)} L/h`:"Nog geen actuele waarde"]],u=Ri(),p=[["Status",u.status],["Kamertemperatuur",Number.isFinite(u.roomTempValue)?`${u.roomTempValue.toFixed(1)} \xB0C`:"Nog geen actuele waarde"],["Kamer-setpoint",Number.isFinite(u.roomSetpointValue)?`${u.roomSetpointValue.toFixed(1)} \xB0C`:"Nog geen actuele waarde"]],g=[["Flowregeling",i==="Manual PWM"?"Vaste pompstand":"Gewenste flow"],i==="Manual PWM"?["Vaste pompstand",Y("manualIpwm")]:["Gewenste flow",Y("flowSetpoint")]],w=v("boilerCvAssistEnabled")?[["CV-ketel/boiler aanwezig",C("boilerCvAssistEnabled")?"Ja":"Nee"],...C("boilerCvAssistEnabled")?[["Boiler rated heat power",Y("boilerRatedHeatPower")]]:[]]:[],y=[["Maximale watertemperatuur",Y("maxWater")]],h=[["Start stille uren",vn(T("silentStartTime"))||"\u2014"],["Einde stille uren",vn(T("silentEndTime"))||"\u2014"],["Maximaal niveau tijdens stille uren",Y("silentMax")],["Maximaal niveau overdag",Y("dayMax")]],m=v("usageTelemetryEnabled")?[["Technische gebruiksstatistieken",C("usageTelemetryEnabled")?"Delen":"Niet delen"]]:[],d=S=>`
    ...
    `}function Cc(e){let t=String(e||"").trim();return t?{Ready:"Gereed","Waiting for room request":"Koeling toegestaan, wacht op kamertemperatuur boven koel-setpoint","Cooling enabled, waiting for room temperature above cooling setpoint":"Koeling toegestaan, wacht op kamertemperatuur boven koel-setpoint","No dew point source":"Geen dauwpuntbron","OpenQuatt paused":"OpenQuatt gepauzeerd","Cooling disabled":"Koeling uitgeschakeld","Cooling minimum unavailable":"Minimale koel-aanvoer onbekend","Flow too low":"Flow te laag","Fallback active":"Dauwpuntsbenadering actief","Fallback active (+0.5\xB0C warm night)":"Dauwpuntsbenadering actief (+0,5\xB0C warme nacht)","Fallback active (+1.0\xB0C very warm night)":"Dauwpuntsbenadering actief (+1,0\xB0C zeer warme nacht)","Fallback active (+1.5\xB0C tropical night)":"Dauwpuntsbenadering actief (+1,5\xB0C tropische nacht)","User responsibility (no dew point or fallback)":"Expliciet toegestaan (geen dauwpunt of benadering)","Fallback cooling active":"Dauwpuntsbenadering actief","Fallback corrected by warm night":"Dauwpuntsbenadering gecorrigeerd door warme nacht","Fallback blocked by tropical night":"Dauwpuntsbenadering geblokkeerd door tropische nacht"}[t]||t:""}function Xg(){let e=!v("coolingRoomRequestRequired")||C("coolingRoomRequestRequired"),t=[ce("coolingMinimumSupplyTemp","Minimale koel-aanvoer","Ondergrens voor het koeldoel. OpenQuatt gebruikt de hoogste waarde van deze instelling en de dauwpuntveilige grens."),lt("coolingDemandMax","Maximale koelsterkte","Bepaalt hoe krachtig OpenQuatt mag koelen. Lager geeft langere, rustigere runs; hoger geeft meer koelvermogen bij warm weer.","",{minLabel:"Rustig",maxLabel:"Krachtig",valueLabel:`${Y("coolingDemandMax")} max`}),ce("coolingRestartDelta","Herstartmarge watertemperatuur","Na het bereiken van het koel-aanvoerdoel start de watercyclus pas opnieuw zodra de aanvoer deze marge boven het doel ligt."),ce("coolingSafetyMargin","Dauwpunt veiligheidsmarge","Extra marge boven het geselecteerde dauwpunt voor de minimale veilige watertemperatuur.")].filter(Boolean),r=[v("coolingRoomRequestRequired")?_p("coolingRoomRequestRequired","Koelvraag via kamerthermostaat","Aan: OpenQuatt wacht op echte koelvraag vanuit de kamer. Uit: koeltoestemming geldt direct als koelvraag.","Koelvraag start en stopt met de marges hieronder.","Koeltoestemming geldt direct als koelvraag. De start- en stopmarge worden nu niet gebruikt.","oq-settings-field--span-2"):"",e?ce("coolingRequestOnDelta","Koelvraag start boven setpoint","Koelvraag wordt actief zodra de kamer warmer is dan setpoint plus deze marge."):"",e?ce("coolingRequestOffDelta","Koelvraag stopt boven setpoint","Koelvraag valt weer af zodra de kamer koeler is dan setpoint plus deze marge."):""].filter(Boolean),n=r.length>0,a=v("coolingWithoutDewPointMode"),i=[v("coolingGuardMode")?ea("Route",ke(j("coolingGuardMode","Onbekend"))):"",v("coolingEffectiveMinSupplyTemp")?ea("Actieve ondergrens",j("coolingEffectiveMinSupplyTemp","\u2014")):""].filter(Boolean),l=i.length?ve("coolingGuardStatus","Actuele beveiliging","Laat zien welke route koeling nu begrenst en welke ondergrens daadwerkelijk geldt.",`<div class="oq-settings-cooling-facts">${i.join("")}</div>`,"oq-settings-field--span-2 oq-settings-field--cooling-status"):"",c=[v("outsideTempSelected")?ea("Actuele buitentemperatuur",j("outsideTempSelected","\u2014")):"",v("coolingFallbackNightMinOutdoorTemp")?ea("Nachtminimum buitentemperatuur",j("coolingFallbackNightMinOutdoorTemp","\u2014")):"",v("coolingFallbackMinSupplyTemp")?ea("Berekende minimum watertemperatuur",j("coolingFallbackMinSupplyTemp","\u2014")):""].filter(Boolean),u=c.length?`<div class="oq-settings-cooling-fallback-metrics">${c.join("")}</div>`:"",p=a||c.length>0,w=j("coolingGuardMode","").toLowerCase().includes("fallback");if(!t.length&&!n&&!a&&!l&&!p)return"";let y={"Dew point required":"Gebruik alleen een betrouwbare dauwpuntmeting. Zonder meting blijft koeling uit.","Allow without dew point":"Gebruik dauwpunt waar mogelijk. Zonder meting geldt de conservatieve benadering hieronder.","Allow without dew point, use fallback":"Gebruik dauwpunt waar mogelijk. Zonder meting geldt de conservatieve benadering hieronder.","Allow without dew point, use dew point approximation":"Gebruik dauwpunt waar mogelijk. Zonder meting geldt de conservatieve benadering hieronder.","Allow without dew point, user responsibility":"Negeer dauwpunt en benadering; alleen de ingestelde minimale koel-aanvoer geldt."};return re("Koeling","Koelingsinstellingen","Stel hier in wanneer koelvraag ontstaat, hoe koud het water mag worden en hoeveel het water mag opwarmen voor herstart.",`
        ...
        `:""}
      `)}function ef(){let e=v("otEnabled"),t=v("cicPollingEnabled")||v("cicFeedUrl"),r=v("cicCompatibilityMode"),n=v("otLinkProblem")||v("cicDataStale")||v("cicJsonFeedOk");if(!e&&!t&&!r&&!n)return"";let a=Dt("cicPollingEnabled"),i=Dt("otEnabled"),l=({label:m,value:d,active:b=!1})=>`
    ...
    `:"";return re("Integratie","OpenTherm & CIC-polling","Configureer de directe thermostaatbus, externe CIC-feed en Quatt app-compatibiliteit.",`
        ...
        ${h}
      `)}function tf(){if(!bn.some($=>v($)))return"";let t=Dt("cicPollingEnabled"),r=Dt("otEnabled"),n=($={})=>$.haValueKey||($.haKeys||[]).find(x=>!/valid$/i.test(x))||"",a=($={})=>$.haValidKey||($.haKeys||[]).find(x=>/valid$/i.test(x))||"",i=($="",x="")=>!!$&&!!x&&v($)&&v(x)&&X(x),l=($={})=>i(n($),a($)),c={mqttCoolingDewPoint:"cooling_dew_point",mqttOutsideTemperature:"outside_temperature",mqttRoomTemperature:"room_temperature",mqttRoomSetpoint:"room_setpoint",mqttHeatingEnable:"heating_enable",mqttCoolingEnable:"cooling_enable"},u=($={})=>$.mqttTopicKey||c[$.valueKey]||"",p=($="")=>{if(!$)return!0;let x=o.mqttStatus?.input_enabled;return x&&typeof x=="object"&&Object.prototype.hasOwnProperty.call(x,$)?x[$]!==!1:!0},g=$=>/\bMQTT\b/i.test(String($||"")),w=($,x={})=>$==="CIC"?t:$==="OT thermostat"?r:$==="HA input"?l(x):$==="CIC or HA input"?t||l(x):g($)?p(u(x)):$==="Flowmeter HP2"?v("hp2Flow"):$==="Local aggregate HP1/HP2"?v("flowLocal")||v("hp2Flow"):!0,y=($,x={})=>$==="CIC"&&!t?"CIC-polling staat uit":$==="OT thermostat"&&!r?"OpenTherm staat uit":$==="HA input"&&!l(x)?"HA-bron ongeldig":$==="CIC or HA input"&&!t&&!l(x)?"CIC en HA ontbreken":g($)&&!p(u(x))?"MQTT-topic staat uit":$==="Flowmeter HP2"&&!v("hp2Flow")?"HP2-flow ontbreekt":$==="Local aggregate HP1/HP2"&&!v("flowLocal")&&!v("hp2Flow")?"Lokale flow ontbreekt":"",h=($,x="Actief",B="Normaal")=>v($)?X($)?x:B:"",m=($,x={})=>{let B=String($||"").trim();return B?x.optionLabels?.[B]||ke(B):""},d=($,x={})=>{let B=String(T($)||"").trim();return B?m(B,x):""},b=$=>{let x=tr($,"");return x?ke(x):""},S=$=>{let x=String(tr($,"")||"").trim();return!x||x==="None"?"":ke(x)},q=(...$)=>$.find(x=>String(x||"").trim())||"",E=()=>{let $=d("waterSupplySource");if(String(T("waterSupplySource")||"")==="Local"&&v("localWaterSupplyTempSource")){let x=d("localWaterSupplyTempSource");return x?`${$} - ${x}`:$}return $},k=()=>{let $=String(T("flowSource")||"").trim();if($==="Outdoor unit"){if(v("qFlowSource")){let x=String(T("qFlowSource")||"").trim(),B=String(T("hpGeneration")||"").trim();return x==="Local"||x==="Auto"&&B==="V1"?x==="Auto"?"Lokaal (auto)":"Lokaal":q(d("outdoorUnitFlowMode"),x==="Auto"?"Buitenunit (auto)":"Buitenunit")}return q(d("outdoorUnitFlowMode"),"Quatt-flow")}return ke($)},M=()=>{let $=String(T("outsideTempSource")||"").trim();if($==="MQTT"&&!p("outside_temperature"))return"MQTT-topic staat uit";if($!=="Auto")return ke($);let x=R("outsideTempLocalAggregated"),B=R("outsideTempHa"),Q=R("mqttOutsideTemperature"),G=!Number.isNaN(x),le=v("outsideTempHaValid")?X("outsideTempHaValid")&&!Number.isNaN(B):!Number.isNaN(B),Se=p("outside_temperature")&&v("mqttOutsideTemperatureValid")&&X("mqttOutsideTemperatureValid")&&!Number.isNaN(Q),ue=[G?{label:"Buitenunit",value:x}:null,le?{label:"HA-invoer",value:B}:null,Se?{label:"MQTT",value:Q}:null].filter(Boolean);return ue.length?ue.reduce((xe,ge)=>ge.value<xe.value?ge:xe,ue[0]).label:"Auto"},P=$=>{if(!v($))return NaN;let x=Number(T($));if(Number.isFinite(x))return x;let Q=String(o.entities[$]?.state??"").trim().replace(",",".").match(/-?\d+(?:\.\d+)?/);return Q?Number(Q[0]):NaN},N=($,x="")=>{if(!v($))return!1;let B=P($);return(x?X(x):!0)&&Number.isFinite(B)},V=()=>{let $=String(T("coolingDewPointSource")||"").trim();if($==="Home Assistant")return N("coolingDewPointHa","coolingDewPointHaValid")?"HA-invoer":"HA-invoer ontbreekt";if($==="MQTT")return p("cooling_dew_point")?N("mqttCoolingDewPoint","mqttCoolingDewPointValid")?"MQTT":"MQTT ontbreekt of verouderd":"MQTT-topic staat uit";let x=N("coolingDewPointHa","coolingDewPointHaValid"),B=p("cooling_dew_point")&&N("mqttCoolingDewPoint","mqttCoolingDewPointValid");if(x&&B){let Q=P("coolingDewPointHa");return P("mqttCoolingDewPoint")>Q?"MQTT":"HA-invoer"}return x?"HA-invoer":B?"MQTT":$?ke($):"Auto"},H=({label:$,value:x="",key:B="",active:Q=!1,status:G="",statusTone:le="",statusTitle:Se=""})=>{let ue=x||(B?He(B):"");if(!ue&&!G)return"";let xe=String(le||"").replace(/[^a-z0-9_-]/gi,""),ge=Se||G,ft=G?`<em class="oq-settings-source-status${xe?` oq-settings-source-status--${s(xe)}`:""}" title="${s(ge)}" aria-label="${s(`${G}: ${ge}`)}">${s(G)}</em>`:"";return`
        <div class="oq-settings-source-row${Q?" is-warning":""}${G?" has-status":""}">
          <span>${s($)}${ft}</span>
          <strong>${s(ue)}</strong>
        </div>
      `},F=({label:$="HA-invoer",valueKey:x="",validKey:B="",value:Q=""})=>{if(!x||!B||!v(x)||!v(B))return[];let G=X(B);return[H({label:$,key:x,value:Q,status:G?"Geldig":"Ongeldig",statusTone:G?"valid":"invalid",statusTitle:G?"Home Assistant geeft dit signaal geldig door. OpenQuatt mag deze HA-invoer gebruiken.":"Home Assistant geeft dit signaal niet geldig door. OpenQuatt gebruikt deze HA-invoer dan niet als bron."})]},A=({label:$="MQTT",valueKey:x="",validKey:B="",value:Q="",topicKey:G=""})=>{if(!x||!B||!v(x)||!v(B))return[];if(!p(G||c[x]))return[];let le=X(B),Se=le?"MQTT heeft een geldige, recente waarde ontvangen. OpenQuatt mag deze MQTT-invoer gebruiken.":"MQTT heeft nog geen geldige recente waarde ontvangen. OpenQuatt gebruikt deze MQTT-invoer dan niet als bron.";return[H({label:$,key:x,value:le?Q:"\u2014",status:il(B),statusTone:le?"valid":"invalid",statusTitle:Se})]},L=({title:$,icon:x="",content:B="",rows:Q=[],copy:G="",className:le=""})=>{let Se=Q.filter(Boolean).join("");return!B&&!Se&&!G?"":`
      ...
      `},_=($,x={})=>{if(!v($))return{markup:"",warning:""};let B=o.entities[$]||{},Q=String(T($)||""),G=ro(B),le=new Set(x.hiddenOptions||[]),Se=Q&&le.has(Q),ue=G.filter(pe=>!le.has(pe)&&w(pe,x)),xe=Q&&!w(Q,x),ge=Q==="HA input"&&x.keepUnavailableCurrent!==!0,Mt=(Se&&!ue.includes(Q)?[Q,...ue]:xe&&!ge&&!ue.includes(Q)?[Q,...ue]:ue).map(pe=>{let Tr=m(pe,x);return`<option value="${s(pe)}" ${pe===Q?"selected":""}>${s(Tr)}</option>`}).join("");return{markup:`
        ...
        `,warning:Se?"Huidige bron is legacy; kies een nieuwe bron.":xe?`Huidige bron niet beschikbaar: ${y(Q,x)}`:""}},D=({key:$,title:x,icon:B="",select:Q,secondarySelect:G=null,secondarySelects:le=null,activeRows:Se=[],measurementRows:ue=[],activeCopy:xe="",rows:ge=[]})=>{let ft=Q&&Q.when!==!1?_(Q.key,Q):{markup:"",warning:""},pe=(Array.isArray(le)?le:G?[G]:[]).filter(qe=>qe&&qe.when!==!1).map(qe=>_(qe.key,qe)).filter(qe=>qe.markup),Tr=pe.map(qe=>qe.markup).join(""),Ve=pe.map(qe=>qe.warning).find(Boolean)||"",tt=ge.filter(Boolean).join(""),ht=`${ft.markup}${Tr}`,bt=ft.warning||Ve,_o=[L({title:"Configuratie",icon:"settings",className:"oq-settings-source-group--config",content:ht?`
    ...
    `:""}function ik(e){let t=e.groups.map(ak).filter(Boolean).join("");return t?`
    ...
    `:""}function sk(e){let t=e.categories.map(ik).filter(Boolean).join("");return t?`
    ...
    `:""}function Mc(){let e=$a.map(sk).filter(Boolean),t=["oq-overview-energy-grid",e.length===1?"oq-overview-energy-grid--single":"",e.length===2?"oq-overview-energy-grid--two":""].filter(Boolean).join(" ");return{renderedColumns:e,gridClassName:t}}function uf(e=Mc()){return we(e)}function df(e=Mc()){return`
      <section class="oq-overview-energy oq-overview-energy--solo" data-render-signature="${s(uf(e))}">
        <div class="${s(e.gridClassName)}">
          ${e.renderedColumns.join("")}
        </div>
      </section>
    `}var pf=[{id:"day",label:"Dag"},{id:"week",label:"Week"},{id:"month",label:"Maand"},{id:"year",label:"Jaar"},{id:"all",label:"Alles"}],lk=new Set(["day","week","month","year"]);function We(e){let t=String(e||"").trim();return pf.some(r=>r.id===t)?t:"day"}function mf(e){let t=We(e);o.energyHistoryView!==t&&(Pt({energyHistoryView:t,energyHistoryLastFetchAt:0}),f(),gf())}function gf(){typeof hr=="function"&&hr({force:!0}).then(e=>{e&&f()})}function an(e){return lk.has(We(e))}function _i(){let e=new Date;return e.getFullYear()*1e4+(e.getMonth()+1)*100+e.getDate()}function ff(){return mi(o.energyHistoryRaw)}function $c(){let e=String(o.energyHistoryRaw||""),t=null;return e.split(/\r?\n/).forEach(r=>{let n=oc(r);n&&(t=n.dateKey)}),t}function ck(e=[],t=!0){let r=$c(),n=ff(),a=(Array.isArray(e)?e:[]).map(i=>Number(i?.dateKey)).filter(Number.isFinite);return Number.isFinite(Number(n.newestDateKey))&&a.push(Number(n.newestDateKey)),Number.isFinite(Number(r))&&a.push(Number(r)),t&&Li().forEach(i=>{let l=Number(i?.dateKey);Number.isFinite(l)&&a.push(l)}),a.length?Math.max(...a):_i()}function wr(e){let t=R(e);return!Number.isFinite(t)||t<0?null:Math.round(t*1e3)}function uk(){let e=$c()||_i(),t=ne(e);if(!t)return null;let r={sequence:Number.MAX_SAFE_INTEGER-1,dateKey:e,year:t.year,month:t.month,day:t.day,partial:!0,source:"sensors",electricalInputWh:wr("electricalEnergyDaily"),heatingInputWh:wr("heatingElectricalEnergyDaily"),coolingInputWh:wr("coolingElectricalEnergyDaily"),heatpumpHeatOutputWh:wr("heatpumpThermalEnergyDaily"),heatpumpCoolingOutputWh:wr("heatpumpCoolingEnergyDaily"),boilerHeatOutputWh:wr("boilerThermalEnergyDaily"),systemHeatOutputWh:wr("systemThermalEnergyDaily")};return pi.some(n=>Number.isFinite(r[n]))?r:null}function ta(){let e=new Map;String(o.energyHistoryRaw||"").split(/\r?\n/).forEach(i=>{let l=jm(i)||oc(i);if(!l)return;let c=e.get(l.dateKey);(!c||l.sequence>=c.sequence)&&e.set(l.dateKey,l)});let r=uk();r&&!e.has(r.dateKey)&&e.set(r.dateKey,r);let n=new Set(e.keys()),a=new Map;return Li().forEach(i=>{if(n.has(i.dateKey))return;let l=a.get(i.dateKey);if(!l){let c=ne(i.dateKey);if(!c)return;l=yr({dateKey:c.key,year:c.year,month:c.month,day:c.day,label:jt(c.key),sortKey:c.key,source:"hour-summary"}),l.tooltipLabel=`${jt(i.dateKey)} \xB7 uurdata sinds herstart`,a.set(i.dateKey,l)}vr(l,i)}),a.forEach((i,l)=>{e.set(l,i)}),[...e.values()].sort((i,l)=>i.dateKey-l.dateKey)}function Li(){let e=new Map;return String(o.energyHistoryRaw||"").split(/\r?\n/).forEach(r=>{let n=Wm(r);if(!n)return;let a=`${n.dateKey}:${n.hour}`,i=e.get(a);(!i||n.sequence>=i.sequence)&&e.set(a,n)}),[...e.values()].sort((r,n)=>r.sortKey-n.sortKey)}function dk(e){return Li().filter(t=>t.dateKey===Number(e))}function nn(e,t){return e.reduce((r,n)=>r+Qr(n,t),0)}function pk(e){return["heatpumpHeatOutputWh","heatpumpCoolingOutputWh","boilerHeatOutputWh"].reduce((t,r)=>t+Qr(e,r),0)}function mk(e){return Qr(e,"electricalInputWh")+pk(e)}function Di(e,t){let r=Number(e),n=Number(t);return!Number.isFinite(r)||!Number.isFinite(n)||n<=0?"\u2014":(r/n).toFixed(2)}function ze(e,t=1){let r=Number(e);return Number.isFinite(r)?Math.abs(r)>=999500?`${(r/1e6).toFixed(2)} MWh`:Math.abs(r)<1e3?`${Math.round(r)} Wh`:`${(r/1e3).toFixed(t)} kWh`:"\u2014"}function yr({dateKey:e,year:t,month:r,day:n,hour:a=null,label:i,tooltipLabel:l="",sortKey:c,source:u="bucket"}){return{sequence:0,dateKey:e,year:t,month:r,day:n,hour:a,label:i,tooltipLabel:l,sortKey:c??e,partial:!1,source:u,electricalInputWh:0,heatingInputWh:0,coolingInputWh:0,heatpumpHeatOutputWh:0,heatpumpCoolingOutputWh:0,boilerHeatOutputWh:0,systemHeatOutputWh:0}}function vr(e,t){return pi.forEach(r=>{e[r]+=Qr(t,r)}),e.partial=e.partial||!!t?.partial,e.sequence=Math.max(Number(e.sequence||0),Number(t?.sequence||0)),e}function gk(e){let t=new Map;return e.forEach(r=>{t.set(r.dateKey,r)}),t}function hf(e,t){let r=We(e);if(r==="day"){let n=Yl(t)||ne(t);return n?String(n.key):""}if(r==="week"){let n=Fm(t);return n?String(n.key):""}if(r==="month"){let n=Im(t);return n?String(n.key):""}if(r==="year"){let n=Number(t);return Number.isInteger(n)&&n>=2020&&n<=2200?String(n):""}return""}function Oi(e,t){let r=We(t),n=ne(ck(e,!0)),a=ff(),i=Li(),l=[...e.map(h=>h.dateKey),...i.map(h=>h.dateKey)].filter(h=>Number.isFinite(Number(h)));Number.isFinite(Number(a.oldestDateKey))&&l.push(Number(a.oldestDateKey)),Number.isFinite(Number(a.newestDateKey))&&l.push(Number(a.newestDateKey));let c=l.length?Math.min(...l.map(Number)):n?.key,p=(c?ne(c):n)?.date||n?.date||new Date,g=n?.date||new Date,w=n?.key||_i(),y=w;return r==="week"?(w=Xl(p),y=Xl(g)):r==="month"?(w=fi(p),y=fi(g)):r==="year"?(w=p.getFullYear(),y=g.getFullYear()):(w=Ie(p),y=Ie(g)),Number(w)>Number(y)&&(w=y),{min:String(w),max:String(y)}}function bf(e,t){let r=Number(e);return Number.isFinite(r)?r<Number(t.min)?String(t.min):r>Number(t.max)?String(t.max):String(e):String(t.max)}function fk(e,t,r=Oi(e,t)){let n=We(t),a=o.energyHistoryPeriodSelection?.[n],i=hf(n,a);return bf(i||r.max,r)}function hk(e,t){let r=We(e),n=[],a=0;if(r==="week"){let i=String(t.max);for(;Number(i)>=Number(t.min)&&a<6e3;){let l=ne(i);n.push({value:i,label:ec(i),group:l?String(Zl(l.date).year):""}),i=l?String(Ie(fr(l.date,-7))):"",a+=1}return n}if(r==="month"){let i=String(t.max);for(;Number(i)>=Number(t.min)&&a<1200;){let l=gr(i);if(!l)break;n.push({value:i,label:l.date.toLocaleDateString("nl-NL",{month:"long",year:"numeric"}),group:String(l.year)}),i=Jl(i,-1),a+=1}return n}if(r==="year")for(let i=Number(t.max);i>=Number(t.min);i-=1)n.push({value:String(i),label:String(i)});return n}function Ii(e,t){let r=We(t);if(!an(r))return{view:r,selectedValue:"",minValue:"",maxValue:"",canPrevious:!1,canNext:!1,isNow:!0,options:[]};let n=Oi(e,r),a=fk(e,r,n);return{view:r,selectedValue:a,minValue:n.min,maxValue:n.max,canPrevious:Number(a)>Number(n.min),canNext:Number(a)<Number(n.max),isNow:Number(a)===Number(n.max),options:hk(r,n)}}function bk(e,t){let r=We(t);if(!an(r))return{from:"",to:"",hours:"0"};let n=Ii(e,r);if(r==="day")return{from:n.selectedValue,to:n.selectedValue,hours:"1"};if(r==="week"){let a=ne(n.selectedValue);if(!a)return{from:"",to:"",hours:"0"};let i=Gr(a.date),l=fr(i,6);return{from:String(Ie(i)),to:String(Ie(l)),hours:"0"}}if(r==="month"){let a=gr(n.selectedValue);return a?{from:String(a.year*1e4+a.month*100+1),to:String(a.year*1e4+a.month*100+Ql(a.year,a.month)),hours:"0"}:{from:"",to:"",hours:"0"}}if(r==="year"){let a=Number(n.selectedValue);return Number.isInteger(a)?{from:`${a}0101`,to:`${a}1231`,hours:"0"}:{from:"",to:"",hours:"0"}}return{from:"",to:"",hours:"0"}}function wk(){if(!String(o.energyHistoryRaw||"").trim())return"?meta=1";let e=ta(),t=bk(e,o.energyHistoryView||"day"),r=new URLSearchParams;t.from&&r.set("from",t.from),t.to&&r.set("to",t.to),r.set("hours",t.hours);let n=r.toString();return n?`?${n}`:""}Um(wk);function oa(e,t){let r=We(e);if(!an(r))return;let n=ta(),a=Oi(n,r),i=hf(r,t),l=bf(i||a.max,a);Pt({energyHistoryPeriodSelection:{...o.energyHistoryPeriodSelection,[r]:l},energyHistoryLastFetchAt:0}),f(),gf()}function wf(e,t){let r=We(e);if(!an(r))return;let n=ta(),a=Ii(n,r),i=Number(t)<0?-1:1,l=a.selectedValue;if(r==="day"){let c=ne(a.selectedValue);l=c?String(Ie(fr(c.date,i))):l}else if(r==="week"){let c=ne(a.selectedValue);l=c?String(Ie(fr(c.date,i*7))):l}else r==="month"?l=Jl(a.selectedValue,i):r==="year"&&(l=String(Number(a.selectedValue)+i));oa(r,l)}function yf(e){let t=We(e);if(!an(t))return;let r=ta(),n=Oi(r,t);oa(t,n.max)}function yk(e,t,r=Ii(e,t)){let n=We(t),a=gk(e);if(!e.length&&n==="all")return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};if(n==="day"){let c=ne(r.selectedValue);if(!c)return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};let u=dk(c.key);if(u.length){let h=new Map(u.map(d=>[d.hour,d])),m=[];for(let d=0;d<24;d+=1){let b=String(d),S=`${c.date.toLocaleDateString("nl-NL",{day:"numeric",month:"long"})} \xB7 ${String(d).padStart(2,"0")}:00 - ${String((d+1)%24).padStart(2,"0")}:00`,q=yr({dateKey:c.key,year:c.year,month:c.month,day:c.day,hour:d,label:b,tooltipLabel:S,sortKey:d,source:"hour"}),E=h.get(d);E&&vr(q,E),m.push(q)}return{buckets:m,title:"Dag",detail:`${c.date.toLocaleDateString("nl-NL",{weekday:"long",day:"numeric",month:"long",year:"numeric"})} \xB7 uurdata sinds herstart`}}let p=a.get(c.key),g=$c()||_i(),w=c.key===g?"Vandaag":jt(c.key),y=yr({dateKey:c.key,year:c.year,month:c.month,day:c.day,label:w,sortKey:c.key,source:"day"});return p&&vr(y,p),{buckets:[y],title:"Dag",detail:`${c.date.toLocaleDateString("nl-NL",{weekday:"long",day:"numeric",month:"long",year:"numeric"})} \xB7 dagtotaal`}}if(n==="week"){let c=ne(r.selectedValue);if(!c)return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};let u=Gr(c.date),p=[];for(let g=0;g<7;g+=1){let w=fr(u,g),y=Ie(w),h=ne(y),m=yr({dateKey:y,year:h.year,month:h.month,day:h.day,label:jt(y,"weekday"),sortKey:y}),d=a.get(y);d&&vr(m,d),p.push(m)}return{buckets:p,title:"Week",detail:ec(r.selectedValue)}}if(n==="month"){let c=gr(r.selectedValue);if(!c)return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};let u=Ql(c.year,c.month),p=[];for(let g=1;g<=u;g+=1){let w=Gl(c.year,c.month,g),y=Ie(w),h=yr({dateKey:y,year:c.year,month:c.month,day:g,label:String(g),sortKey:y}),m=a.get(y);m&&vr(h,m),p.push(h)}return{buckets:p,title:"Maand",detail:c.date.toLocaleDateString("nl-NL",{month:"long",year:"numeric"})}}if(n==="year"){let c=Number(r.selectedValue);if(!Number.isInteger(c))return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};let u=[];for(let p=1;p<=12;p+=1){let g=c*1e4+p*100+1,w=yr({dateKey:g,year:c,month:p,day:1,label:jt(g,"month"),sortKey:p,source:"month"});e.filter(y=>y.year===c&&y.month===p).forEach(y=>vr(w,y)),u.push(w)}return{buckets:u,title:"Jaar",detail:String(c)}}let i=new Map;e.forEach(c=>{i.has(c.year)||i.set(c.year,yr({dateKey:c.year*1e4+101,year:c.year,month:1,day:1,label:String(c.year),sortKey:c.year,source:"year"})),vr(i.get(c.year),c)});let l=[...i.values()].sort((c,u)=>c.sortKey-u.sortKey);return{buckets:l,title:"Alles",detail:l.length?`${l[0].label} - ${l[l.length-1].label}`:"Geen data"}}function vk(e){let t=nn(e,"heatpumpHeatOutputWh"),r=nn(e,"heatpumpCoolingOutputWh"),n=nn(e,"boilerHeatOutputWh");return{electricalInputWh:nn(e,"electricalInputWh"),heatingInputWh:nn(e,"heatingInputWh"),coolingInputWh:nn(e,"coolingInputWh"),heatOutputWh:t,coolingOutputWh:r,boilerOutputWh:n,outputWh:t+r+n}}function Sk(e){let t=Number(e.heatOutputWh||0)+Number(e.coolingOutputWh||0),r=Number(e.boilerOutputWh||0),n=t+r;return!Number.isFinite(n)||n<=0?Number.NaN:t/n*100}function qk(e){let t=Di(e.heatOutputWh,e.heatingInputWh),r=Di(e.coolingOutputWh,e.coolingInputWh),n=Number(e.heatOutputWh||0)>0&&t!=="\u2014",a=Number(e.coolingOutputWh||0)>0&&r!=="\u2014";return n&&a?{label:"COP / EER",value:`${t} / ${r}`}:a?{label:"Gemiddelde EER",value:r}:{label:"Gemiddelde COP",value:t}}function Ni(e,t,r=""){return`
    ...
    `}function kk(e){return an(e.view)?`
    ...
    `:`
      ...
      `}function Ek(){let e=document.activeElement;return!!(e&&e.closest&&e.closest(".oq-energy-history-period"))}function Tk(e){return`
      <div class="oq-energy-history-view-tabs" role="tablist" aria-label="Energiehistorie weergave">
        ${pf.map(t=>{let r=t.id===e;return`
            <button
              type="button"
    ...
    `}function Ck(e){let t=Number(e.electricalInputWh||0),r=Number(e.heatOutputWh||0),n=Number(e.coolingOutputWh||0),a=Number(e.boilerOutputWh||0),i=a>0?"boiler":"boiler-zero",l=Math.max(1,t+r+n+a),c=p=>`${Math.max(0,Number(p||0)/l*100).toFixed(2)}%`,u=Sk(e);return`
    ...
    `}function xk(e){let t=Math.max(1,Number(e||0)/1e3),r=Math.pow(10,Math.floor(Math.log10(t))),n=t/r;return(n<=1.5?1.5:n<=3?3:n<=6?6:10)*r*1e3}function Mk(e){let t=Number(e);return Number.isFinite(t)?t>=999500?`${Number((t/1e6).toFixed(1))}`:`${Number((t/1e3).toFixed(1))}`:""}function $k(e){return e>=999500?"MWh":"kWh"}function Ak(e){let p=Math.max(1e3,...e.map(mk)),g=xk(p),w=e.length?1218/e.length:1218,y=Math.max(6,Math.min(38,w*.68));return{width:1280,height:260,left:44,right:18,top:26,bottom:38,plotWidth:1218,plotHeight:196,axisMax:g,barSlot:w,barWidth:y,yOf:m=>26+(1-Math.min(1,Math.max(0,Number(m||0)/g)))*196}}function Hk(e){let t=Di(e.heatpumpHeatOutputWh,e.heatingInputWh),r=Di(e.heatpumpCoolingOutputWh,e.coolingInputWh);return[e.tooltipLabel||e.label||jt(e.dateKey),`Elektrisch totaal: ${ze(e.electricalInputWh,1)}`,`Elektrisch verwarmen: ${ze(e.heatingInputWh,1)}`,`Elektrisch koelen: ${ze(e.coolingInputWh,1)}`,`Warmtepomp warmte: ${ze(e.heatpumpHeatOutputWh,1)}`,`Warmtepomp koeling: ${ze(e.heatpumpCoolingOutputWh,1)}`,`Cv-ketel warmte: ${ze(e.boilerHeatOutputWh,1)}`,`COP verwarmen: ${t}`,`EER koelen: ${r}`].join(`
`)}function Rk(e,t=""){if(!e.length)return`
      ...
      `;let r=Ak(e),n=$k(r.axisMax),a=[0,.25,.5,.75,1].map(l=>r.axisMax*l),i=e.map((l,c)=>{let u=r.left+r.barSlot*c+r.barSlot/2,p=[{key:"electricalInputWh",className:"input",label:"Verbruikte elektriciteit"},{key:"heatpumpHeatOutputWh",className:"heat",label:"Warmte door warmtepomp"},{key:"heatpumpCoolingOutputWh",className:"cooling",label:"Koeling warmtepomp"},{key:"boilerHeatOutputWh",className:"boiler",label:"Cv-ketel"}],g=r.height-r.bottom,w=p.map(d=>{let b=Qr(l,d.key);if(b<=0)return"";let S=b/r.axisMax*r.plotHeight;return g-=S,`
        ...
        `}).join(""),h=e.length<=12||c===0||c===e.length-1||c%3===0?`<text x="${u.toFixed(1)}" y="${r.height-18}" text-anchor="middle" class="oq-energy-history-axis-label">${s(l.label||jt(l.dateKey))}</text>`:"",m=Hk(l);return`
      ...
      <svg class="oq-energy-history-chart oq-energy-history-chart--${s(We(t))}" viewBox="0 0 ${r.width} ${r.height}" role="img" aria-label="Energiehistorie">
        ...
        ${a.map(l=>{let c=r.yOf(l);return`
            ...
            <text x="${r.left-10}" y="${c.toFixed(1)}" text-anchor="end" dominant-baseline="middle" class="oq-energy-history-axis-label">${s(Mk(l))}</text>
          `}).join("")}
        ${i}
      </svg>
    `}function Pk(e=null){let t=Number(e?.boilerOutputWh||0)>0?"boiler":"boiler-zero";return`
    ...
    `}function Nk(e,t,r,n){let a=We(r)==="day"?Number(n):Number.NaN,i=Number.isFinite(a)?e.find(l=>l.dateKey===a):null;return i?[i]:t}function Ac(){let e=ta(),t=We(o.energyHistoryView),r=Ii(e,t),n=yk(e,t,r),a=Nk(e,n.buckets,t,r.selectedValue),i=vk(a);return{records:e,buckets:n.buckets,viewModel:n,periodControl:r,summary:i,activeView:t}}function vf(e=Ac()){return we({energyHistorySignature:o.energyHistorySignature||"",energyHistoryError:o.energyHistoryError||"",activeView:e.activeView,periodView:e.periodControl.view,periodValue:e.periodControl.selectedValue,periodMin:e.periodControl.minValue,periodMax:e.periodControl.maxValue,recordCount:e.records.length,bucketCount:e.buckets.length,latestDate:e.records[e.records.length-1]?.dateKey||0,summary:e.summary})}function Sf(e=Ac()){let t=e.summary,r=qk(t),n=e.buckets[0]?.dateKey?jt(e.buckets[0].dateKey):"\u2014",a=e.buckets[e.buckets.length-1]?.dateKey?jt(e.buckets[e.buckets.length-1].dateKey):"\u2014";return`
      <section class="oq-energy-history" data-render-signature="${s(vf(e))}">
    ...
    `}function Dk(){if(!o.root||o.appView!=="energy")return!1;let e=o.root.querySelector(".oq-overview-board"),t=e?e.querySelector(".oq-overview-energy"):null;if(!e||!t)return!1;let r=`oq-overview-board oq-overview-board--${o.overviewTheme}`;e.className!==r&&(e.className=r);let n=Mc();return Xe(t,uf(n),df(n))}function _k(){if(!o.root||o.appView!=="results")return!1;let e=o.root.querySelector(".oq-overview-board"),t=e?e.querySelector(".oq-energy-history"):null;if(!e||!t)return!1;let r=`oq-overview-board oq-overview-board--${o.overviewTheme}`;e.className!==r&&(e.className=r);let n=Ac(),a=Ek();return(a?!1:Xe(t,vf(n),Sf(n)))||a}So({patchEnergyDom:Dk,patchResultsDom:_k});function Lk({label:e,value:t,tone:r,note:n,status:a=!1}){return`
      <article class="oq-overview-stat oq-overview-stat--${s(r)}${a?" oq-overview-stat--status":""}">
        <p>${s(e)}</p>
        <strong>${s(t)}</strong>
        <span>${s(n)}</span>
      </article>
    `}function aa(e,t=!1){return e.map(r=>Lk({...r,value:Object.prototype.hasOwnProperty.call(r,"key")?at(r.key):r.value,status:t})).join("")}function Dc(e){return`
    ...
    `}function Oc(e,t,r,n){return`${r?Ik(n):""}${Ok(e,t)}`}function Mf(e,t,r,n,a){if(!e)return;let i=we({mode:t,running:r,warningActive:n,failureText:a});e.dataset.renderSignature!==i&&(Vt(e,Oc(t,r,n,a)),e.dataset.renderSignature=i)}function Fi(e,t,r=""){return`
      <div class="oq-overview-row">
        <span>${s(e)}</span>
        <strong>${s(r||j(t))}</strong>
      </div>
    `}function Fk(e,t,r="blue",n=""){return`
      <article class="oq-overview-metric oq-overview-metric--${s(r)}">
        <span>${s(e)}</span>
        <strong>${s(t)}</strong>
        ${n?`<p>${s(n)}</p>`:""}
      </article>
    `}function jk(e){return Number.isNaN(e)?"\u2014":`${e>0?"+":""}${e.toFixed(1)} \xB0C`}var Wk=Ko;function Vk(e){let r=String(e||"").trim().match(/^(\d{1,2}):(\d{2})$/);if(!r)return Number.NaN;let n=Number(r[1]),a=Number(r[2]);return Number.isNaN(n)||Number.isNaN(a)||n<0||n>23||a<0||a>59?Number.NaN:n*60+a}function Bk(e){let t=Vk(j("timeNowHhmm",""));if(!Number.isFinite(t))return"";let r=Math.round(e),n=((t-r)%1440+1440)%1440,a=Math.floor(n/60),i=n%60;return`${String(a).padStart(2,"0")}:${String(i).padStart(2,"0")}`}function Kk(e,t){let r=Math.max(0,(Number(t)-Number(e))/6e4),n=Wk(r),a=v("timeValid")&&C("timeValid")?Bk(r):"";return a?{value:a,note:`${n} geleden`}:{value:`${n} geleden`,note:"Geen tijdsync"}}function zk(e){let t=Number(e);return Number.isNaN(t)?"\u2014":`${t>0?"+":t<0?"-":""}${Math.abs(t).toFixed(0)} W`}function $f(){return["outsideTempSelected","hp1OutsideTemp","hp2OutsideTemp"].find(e=>v(e))||""}function Uk(){return["hp1WaterIn","hp2WaterIn"].find(e=>v(e))||""}function Af(e=j("controlModeLabel","")){let t=String(e||"").toLowerCase();return t.includes("cm5")||t.includes("cooling")||t.includes("koeling")}function Bt(){return Af()}function Hf(e,t){let r=String(e||"").trim().toLowerCase();return r==="waiting for room request"||r==="wacht op kamervraag"||r==="cooling enabled, waiting for room temperature above cooling setpoint"||r==="koeling toegestaan, wacht op kamertemperatuur boven koel-setpoint"?!0:t?!1:r==="flow too low"||r==="flow te laag"||r==="flow unavailable"}function Ic(){return Bt()?"Koeling":ae()?"Stooklijn":"Power House"}function Gk(){let e=["phouseReq","strategyRequestedPower"];for(let t of e){let r=R(t);if(!Number.isNaN(r))return r}return Number.NaN}function Rf(){let e=Gk(),t=R("phouseHouse"),r=R("totalHeat"),n=R("hpCapacity"),a=Number.isNaN(e)||Number.isNaN(t)?Number.NaN:e-t,i="Nog aan het opbouwen",l="Zodra alle vermogens beschikbaar zijn, zie je hier hoe de warmtevraag is opgebouwd.";return!Number.isNaN(e)&&!Number.isNaN(n)&&e>n+150?(i="Capaciteit begrenst",l="De gevraagde warmtevraag ligt boven wat de warmtepomp nu ongeveer kan leveren."):!Number.isNaN(e)&&!Number.isNaN(r)&&r<e-250?(i="Levert minder dan gevraagd",l="De actuele warmteafgifte blijft nog onder de gevraagde warmtevraag."):!Number.isNaN(e)&&!Number.isNaN(r)&&r>e+250?(i="Levert meer dan gevraagd",l="De actuele warmteafgifte ligt nu boven de gevraagde warmtevraag."):!Number.isNaN(e)&&!Number.isNaN(r)&&(i="In balans",l="Gevraagde warmtevraag en actuele levering liggen nu dicht bij elkaar."),{requestedText:z(e,0,"W"),houseText:z(t,0,"W"),correctionText:zk(a),capacityText:at("hpCapacity"),statusTitle:i,statusCopy:l}}function Pf(){let e=R("curveSupplyTarget"),t=R("supplyTemp"),r=$f(),n=r?R(r):Number.NaN,a=Number.isNaN(e)||Number.isNaN(t)?Number.NaN:t-e,i=!!r&&Number.isNaN(n),l="Stuurt op buitentemperatuur",c="De doelaanvoer volgt de huidige buitentemperatuur en vergelijkt die met de actuele aanvoer.";return i?(l="Fallback actief",c="De buitentemperatuur ontbreekt, dus de regeling valt terug op de ingestelde fallback-aanvoer."):!Number.isNaN(a)&&a<-1?(l="Nog onder doel",c="De actuele aanvoertemperatuur ligt nog onder de doelaanvoer."):!Number.isNaN(a)&&a>1?(l="Boven doel",c="De actuele aanvoertemperatuur ligt nu boven de doelaanvoer."):Number.isNaN(a)||(l="Dicht bij doel",c="De actuele aanvoertemperatuur sluit nu goed aan op de doelaanvoer."),{targetText:at("curveSupplyTarget"),supplyText:at("supplyTemp"),deltaText:jk(a),capacityText:at("hpCapacity"),statusTitle:l,statusCopy:c}}function Nf(){let e=R("supplyTemp"),t=j("coolingGuardMode",""),r=j("coolingFallbackNightMinOutdoorTemp","\u2014"),n=R("coolingSupplyError"),a=R("coolingDemandRaw"),i=C("coolingPermitted"),l=C("coolingRequestActive"),c=j("coolingBlockReason","Onbekend"),u=Cc(c),p=Hf(c,l),g="Wacht op koelvraag",w="Zodra er koelvraag is, zie je hier hoe de regeling de aanvoer richting het koeldoel stuurt.";return p?(g="Wacht op koelvraag",w="Koeling is toegestaan en wacht tot de kamertemperatuur boven het koel-setpoint komt."):i?l?!Number.isNaN(a)&&a<=0?(g="Houdt doel vast",w="De koelvraag loopt nog, maar de compressor hoeft nu niet harder te werken."):!Number.isNaN(n)&&n>1?(g="Trekt aanvoer omlaag",w="De actuele aanvoertemperatuur ligt nog ruim boven het koeldoel."):!Number.isNaN(n)&&n>.2?(g="Benadert koeldoel",w="De regeling koelt nog door, maar zit al dicht bij de gewenste aanvoertemperatuur."):Number.isNaN(n)||(g="Koelt rustig door",w="De aanvoertemperatuur zit dicht bij het koeldoel en de regeling werkt nu op laag pitje."):(g="Koeling gereed",w="Koeling is toegestaan, maar wacht nog op actieve koelvraag vanuit de kamerregeling."):(g="Koeling geblokkeerd",w=`Blokkade: ${u}.`),{targetText:at("coolingSupplyTarget"),supplyText:at("supplyTemp"),safeFloorText:at("coolingEffectiveMinSupplyTemp"),guardMode:t,fallbackNightMin:r,demandText:at("coolingDemandRaw"),statusTitle:g,statusCopy:w,permitted:i,requestActive:l,blockReason:u,waitingForRoomRequest:p}}function ji(){if(Bt()){let t=Nf(),r=t.guardMode.toLowerCase(),n=r.includes("user responsibility"),a=r.includes("fallback");return{title:"Koelregeling",copy:n?"Koeling draait expliciet zonder dauwpuntmeting of dauwpuntsbenadering. De ingestelde minimale koel-aanvoer blijft gelden.":"Koeling laat zien op welke aanvoertemperatuur de regeling nu mikt en hoe dicht die bij de veilige grens zit.",focusLabel:"Koeldoel",focusValue:t.targetText,focusCopy:t.statusCopy,metrics:[{label:"Actuele aanvoertemperatuur",value:t.supplyText,tone:"orange",note:"Wat nu door het systeem loopt."},{label:n?"Ingestelde grens":a?"Berekende grens":"Veilige aanvoergrens",value:t.safeFloorText,tone:"blue",note:n?"Geen dauwpuntmeting of benadering; dit is de ingestelde minimale koel-aanvoer.":a?`Conservatieve dauwpuntsbenadering. Nachtminimum: ${t.fallbackNightMin}.`:"Dauwpunt plus veiligheidsmarge."},{label:"Koelvraag",value:t.demandText,tone:"sky",note:"De huidige koelvraag van de regelaar."}]}}if(ae()){let t=Pf();return{title:"Stooklijnregeling",copy:"De stooklijn laat zien op welke aanvoertemperatuur de regeling nu mikt en hoe dicht die al benaderd wordt.",focusLabel:"Doelaanvoer",focusValue:t.targetText,focusCopy:"De aanvoertemperatuur waar de regeling nu naartoe werkt.",metrics:[{label:"Actuele aanvoertemperatuur",value:t.supplyText,tone:"orange",note:"Wat nu wordt geleverd."},{label:"Afwijking doelaanvoer",value:t.deltaText,tone:"blue",note:"Verschil met het doel."},{label:"Beschikbare warmtecapaciteit",value:t.capacityText,tone:"sky",note:"Bij huidige buitentemperatuur."}]}}let e=Rf();return{title:"Vermogensbalans",copy:"Power House laat zien waar de warmtevraag nu vandaan komt en of de warmtepomp dat kan volgen.",focusLabel:"Gevraagd vermogen",focusValue:e.requestedText,focusCopy:"De warmtevraag waar Power House nu naartoe stuurt.",metrics:[{label:"Berekende huisvraag",value:e.houseText,tone:"blue",note:"Op basis van woning en buitentemperatuur."},{label:"Kamercorrectie",value:e.correctionText,tone:"orange",note:"Extra bijsturing rond setpoint."},{label:"Beschikbare warmtecapaciteit",value:e.capacityText,tone:"sky",note:"Bij huidige buitentemperatuur."}]}}function Fc(e){return xf({className:"oq-overview-system",title:e.title,copy:e.copy,signature:we(e),body:`
        ...
        <div class="oq-overview-metrics oq-overview-metrics--three-column">
          ${e.metrics.map(t=>Fk(t.label,t.value,t.tone,t.note)).join("")}
        </div>
      `})}function Qk(){if(!C("openquattEnabled"))return{label:"Regeling nu",value:"Regeling tijdelijk uit",tone:"orange"};if(Bt()){let n=Nf(),a=n.waitingForRoomRequest?"neutral":n.permitted?n.statusTitle==="Koelt rustig door"||n.statusTitle==="Houdt temperatuur vast"?"green":n.statusTitle==="Koeling gereed"?"neutral":"sky":"orange";return{label:"Regeling nu",value:n.statusTitle,tone:a}}if(lf())return{label:"Regeling nu",value:"Stand-by",tone:"neutral"};let t=(ae()?Pf():Rf()).statusTitle;return{label:"Regeling nu",value:t,tone:t==="In balans"||t==="Dicht bij doel"?"green":t==="Nog aan het opbouwen"||t==="Stuurt op buitentemperatuur"?"neutral":"orange"}}function Yk(){return C("openquattEnabled")?Bt()?C("coolingPermitted")?C("silentActive")?{label:"Systeem",value:"Stille uren actief",tone:"neutral"}:{label:"Systeem",value:"Normaal",tone:"neutral"}:{label:"Systeem",value:j("coolingBlockReason","Koeling geblokkeerd"),tone:"orange"}:C("silentActive")?{label:"Systeem",value:"Stille uren actief",tone:"neutral"}:C("stickyActive")?{label:"Systeem",value:"Pompbescherming actief",tone:"neutral"}:{label:"Systeem",value:"Normaal",tone:"neutral"}:{label:"Systeem",value:"Vorstbeveiliging blijft actief",tone:"neutral"}}function jc(e,t){let r=Qk(),n=Yk();return[{label:"Strategie",value:e,tone:"orange",note:"regelstrategie"},{label:"Controlmode",value:t,tone:"orange",note:"actieve modus"},{label:"Regeling",value:r.value,tone:"orange",note:"wat OpenQuatt nu doet"},{label:"Systeem",value:n.value,tone:"orange",note:"actieve randvoorwaarde"}]}function Wc(e,t){let r=jc(e,t);return`
    ...
    `}function Vc(){let e=Bt();return[{key:"totalPower",label:"Elektrisch vermogen",tone:"blue",note:"hele systeem"},{key:e?"totalCoolingPower":"totalHeat",label:e?"Koelvermogen":"Verwarmingsvermogen",tone:"orange",note:"thermisch vermogen"},{key:e?"totalEer":"totalCop",label:e?"COP (EER)":"COP",tone:"green",note:"rendement"},{key:"flowSelected",label:"Flow",tone:"sky",note:"watercircuit"}]}function Jk(){let e=C("openquattEnabled"),t=T("openquattResumeAt"),r=Sn(t),n=(o.loadingEntities||o.entitySyncInFlight)&&!v("openquattResumeAt"),a=C("manualCoolingEnable"),i=v("coolingEnableSelected")?C("coolingEnableSelected"):a,l=Ef(j("coolingEnableEffectiveSource","")),c=String(T("coolingEnableSource")||"").trim(),u=Ef(T("coolingEnableSource")),p=String(T("silentModeOverride")||"Schedule"),g=!C("coolingPermitted"),w=C("coolingRequestActive"),y=Af(),h=j("coolingBlockReason",""),m=Hf(h,w),d="Uit",b=c==="Disabled"?"Koeling is niet toegestaan: handmatig staat uit.":u&&u!=="geen bron"?`Koeling is niet toegestaan: ${u} geeft geen toestemming en handmatig staat uit.`:"Koeling is niet toegestaan.";i&&y?(d="Actief",b=ra("Koeling draait nu.",l)):i&&m?(d="Aan",b=ra("Koeling is toegestaan en wacht op kamertemperatuur boven het koel-setpoint.",l)):i&&g?(d="Geblokkeerd",b=ra(Cc(h||"Koeling wacht nog op veilige condities."),l)):i&&w?(d="Start bijna",b=ra("Er is koelvraag. Koeling start zodra dat kan.",l)):i&&(d="Aan",b=ra("Koeling is toegestaan en wacht op koelvraag.",l));let S="Uit",q="Stille modus staat uit.",E="neutral";return p==="On"?(S="Aan",q="Stille modus staat geforceerd aan, ook buiten het tijdvenster.",E="orange"):p==="Schedule"&&(S="Schema",C("silentActive")?(q="Stille modus staat nu aan via het tijdvenster.",E="violet"):q="Stille modus volgt het tijdvenster."),[{key:"openquattEnabled",label:"Openquatt regeling",status:e?"Actief":"Tijdelijk uit",copy:e?"Verwarmen en koelen worden automatisch geregeld.":r?"Verwarming en koeling zijn tijdelijk uitgeschakeld. Beveiligingen blijven actief.":"Verwarming en koeling zijn uitgeschakeld. Beveiligingen blijven actief.",tone:e?"green":"orange",kind:"openquatt-control",meta:e?[]:[n?{label:"Hervatten",value:"Laden\u2026",tone:"neutral",loading:!0}:{label:r?"Hervat automatisch":"Hervatten",value:r?Hr(t,!0):"Handmatig",tone:r?"orange":"neutral"}]},{key:"manualCoolingEnable",label:"Koeling",status:d,copy:b,buttonLabel:a?"Handmatig uit":"Handmatig aan",nextState:a?"off":"on",tone:i?y?"blue":"sky":"neutral"},{key:"silentModeOverride",label:"Stille modus",status:S,copy:q,tone:E,kind:"select",selectedOption:p,settingsAction:!0,options:[{value:"Off",label:"Uit"},{value:"On",label:"Aan"},{value:"Schedule",label:"Schema"}]}].filter(k=>v(k.key))}function Zk(e=[]){return e.length?`
    ...
    `:""}function sn({className:e,action:t,label:r,busy:n=!1,loading:a=!1,attrs:i=""}){return`
      ...
      `:s(n?"Bezig...":r)}</button>
    `}function Xk(e){if(e.kind==="openquatt-control"){let t=o.busyAction==="openquatt-regulation",r=(o.loadingEntities||o.entitySyncInFlight)&&!v("openquattResumeAt");return C("openquattEnabled")?`<div class="oq-overview-controlpanel-actions">${sn({className:"oq-overview-controlpanel-toggle",action:"open-openquatt-pause-modal",label:"Tijdelijk uitschakelen",busy:t})}</div>`:`
    ...
    `}function Bc(){let e=Jk();return e.length?`
    ...
    `:""}function Df(e){let t=j("controlModeLabel");return`
    ...
    `}function Wi(){let e=$f(),t=Uk();return Bt()?{title:"Koeltemperaturen",copy:"De belangrijkste temperaturen voor kamercomfort, koeldoel en dauwpuntveiligheid.",rows:[{label:"Kamertemperatuur",key:"roomTemp"},{label:"Kamer setpoint",key:"roomSetpoint"},{label:"Aanvoertemperatuur",key:"supplyTemp"},{label:"Koeldoel",key:"coolingSupplyTarget"},{label:"Veilige aanvoergrens",key:"coolingMinimumSafeSupplyTemp"},{label:"Dauwpunt",key:"coolingDewPointSelected"}]}:{title:"Temperaturen",copy:"De belangrijkste temperaturen voor comfort en regeling.",rows:[{label:"Kamertemperatuur",key:"roomTemp"},{label:"Kamer setpoint",key:"roomSetpoint"},{label:"Aanvoertemperatuur",key:"supplyTemp"},...t?[{label:"Retourtemperatuur",key:t}]:[],e?{label:"Buitentemperatuur",key:e}:{label:"Buitentemperatuur",key:"",value:"\u2014"}]}}function Kc(e=Wi()){return we({...e,values:e.rows.map(t=>t.value||j(t.key))})}function zc(){let e=Wi();return xf({className:"oq-overview-temps",title:e.title,copy:e.copy,signature:Kc(e),body:`
        <div class="oq-overview-temps-list">
          ${e.rows.map(t=>Fi(t.label,t.key,t.value||"")).join("")}
        </div>
      `})}var Tf=360,eE=100;function lo(){let e=Gn(o.trendWindowHours||Ht);return e!==o.trendWindowHours&&Jr(e),e}function _f(e=lo()){return Math.max(1,Number(e)||24)*60*60*1e3}function tE(e=lo()){let t=Number(e)||24;return t>=72&&t%24===0?`${t/24}d`:`${t}u`}function Uc(e=lo()){let t=Number(e)||24;if(t>=72&&t%24===0){let r=t/24;return`${r} ${r===1?"dag":"dagen"}`}return`${t} uur`}function Rc(e){if(!Number.isFinite(e))return"\u2014";let t=new Date(e);if(Number.isNaN(t.getTime()))return"\u2014";let r={day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"};try{return new Intl.DateTimeFormat("nl-NL",r).format(t)}catch{return t.toLocaleString("nl-NL",r)}}function oE(e){let t=String(e||"").trim().split("|");if(t.length<5)return null;let r=Number(t[0]);if(!Number.isFinite(r))return null;let n=a=>{let i=Number(a);return Number.isFinite(i)?i:null};return{t:r,outside:n(t[1]),supply:n(t[2]),room:t.length>=8?n(t[3]):null,roomSetpoint:t.length>=8?n(t[4]):null,flow:t.length>=8?n(t[5]):null,input:t.length>=8?n(t[6]):n(t[3]),output:t.length>=8?n(t[7]):n(t[4])}}function Nc(){return!1}function Pc(e=lo()){return[]}function Lf(){let e=_f(),t=String(o.trendHistoryRaw||"").trim();if(!t)return Nc()?Pc():[];let r=t.split(/\r?\n/).map(oE).filter(Boolean),n=r.length?r[r.length-1].t:Number.NaN,a=Number.isFinite(o.trendHistoryNowMs)?o.trendHistoryNowMs:Number.isFinite(n)?n:Number.NaN;if(!Number.isFinite(a))return r.length?r.slice(-Tf):Pc();let i=Math.max(0,a-e),l=r.filter(c=>c.t>=i).slice(-Tf);return l.length?l:Nc()?Pc(windowHours):[]}function Gc(){let e=lo(),t=Uc(e),r=Lf(),n=Nc()&&r.length===0,a=Bt();return[{id:"temperatures",title:"Temperaturen",copy:`Buiten- en aanvoertemperatuur van de laatste ${t}.`,tone:"orange",samples:r,mock:n,windowHours:e,series:[{id:"outside",sampleKey:"outside",currentKey:"outsideTempSelected",label:"Buiten",tone:"orange",decimals:1,unit:" \xB0C"},{id:"supply",sampleKey:"supply",currentKey:"supplyTemp",label:"Aanvoer",tone:"blue",decimals:1,unit:" \xB0C"}]},{id:"power",title:"Vermogen",copy:`Elektrisch vermogen en verwarmingsvermogen van de laatste ${t}.`,tone:"green",samples:r,mock:n,windowHours:e,series:[{id:"input",sampleKey:"input",currentKey:"totalPower",label:"Elektrisch vermogen",tone:"green",decimals:0,unit:" W"},{id:"output",sampleKey:"output",currentKey:a?"totalCoolingPower":"totalHeat",label:a?"Koelvermogen":"Verwarmingsvermogen",tone:"sky",decimals:0,unit:" W"}]},{id:"rendement",title:"Rendement",copy:`COP van de laatste ${t}.`,tone:"slate",samples:r,mock:n,windowHours:e,series:[{id:"cop",label:"COP",tone:"slate",decimals:1,unit:"",currentKey:a?"totalEer":"totalCop",derive:i=>{let l=Number(i?.input),c=Number(i?.output);return!Number.isFinite(l)||!Number.isFinite(c)||l<eE?Number.NaN:c/l}}]},{id:"comfort",title:"Comfort",copy:`Kamertemperatuur en setpoint van de laatste ${t}.`,tone:"blue",samples:r,mock:n,windowHours:e,series:[{id:"roomTemp",sampleKey:"room",currentKey:"roomTemp",label:"Kamertemperatuur",tone:"blue",decimals:1,unit:" \xB0C"},{id:"roomSetpoint",sampleKey:"roomSetpoint",currentKey:"roomSetpoint",label:"Kamer setpoint",tone:"orange",decimals:1,unit:" \xB0C"}]},{id:"flow",title:"Flow",copy:`Flow van de laatste ${t}.`,tone:"sky",samples:r,mock:n,windowHours:e,series:[{id:"flow",sampleKey:"flow",currentKey:"flowSelected",label:"Flow",tone:"sky",decimals:0,unit:" L/h",axisMin:0,axisTickStep:250}]}]}function rE(e){let t=e.samples[e.samples.length-1]||null;return we({id:e.id,windowHours:e.windowHours,sampleCount:e.samples.length,firstTimestamp:e.samples[0]?.t||0,lastTimestamp:t?.t||0,trendSignature:o.trendHistorySignature||"",latestValues:t?[t.outside,t.supply,t.room,t.roomSetpoint,t.flow,t.input,t.output]:[]})}function na(e,t){if(!e||!t)return Number.NaN;let r=typeof e.derive=="function"?e.derive(t):t?.[e.sampleKey],n=Number(r);return Number.isFinite(n)?n:Number.NaN}function nE(e,t){let r=[];return e.forEach(n=>{t.forEach(a=>{let i=na(a,n);Number.isFinite(i)&&r.push(i)})}),r.length?{min:Math.min(...r),max:Math.max(...r)}:{min:0,max:1}}function aE(e){if(!Number.isFinite(e)||e<=0)return 1;let t=Math.floor(Math.log10(e)),r=e/10**t,n;return r<=1?n=1:r<=2?n=2:r<=5?n=5:n=10,n*10**t}function iE(e,t){let r=Number.isFinite(e?.min)?e.min:0,n=Number.isFinite(e?.max)?e.max:1,a=Math.max(n-r,1),i=Array.isArray(t)?t.map(y=>Number(y?.axisMin)).find(y=>Number.isFinite(y)):Number.NaN,l=Array.isArray(t)?t.map(y=>Number(y?.axisMax)).find(y=>Number.isFinite(y)):Number.NaN,c=Array.isArray(t)?t.map(y=>Number(y?.axisTickStep)).find(y=>Number.isFinite(y)&&y>0):Number.NaN,u=Math.max(1,Number.isFinite(c)?c:aE(a/4)),p=[];if(Number.isFinite(i)||Number.isFinite(l)){let y=Number.isFinite(i)?i:0,h=Number.isFinite(l)?l:Math.ceil(n/u)*u,m=Math.floor(y/u)*u,d=Math.ceil(h/u)*u;for(let b=m;b<=d+u*.5;b+=u)p.push(b)}else{let y=a/u,h=y<=1.8?3:y<=4.25?5:7,m=Math.floor(h/2),d=(r+n)/2,b=Math.round(d/u)*u;for(let S=-m;S<=m;S+=1)p.push(b+S*u)}let g=p[0],w=p[p.length-1];return{ticks:p,axisMin:g,axisMax:w,axisDecimals:0}}function Of(e,t,r={}){let n=Number(r.windowHours),a=Number.isFinite(n)?n:lo(),i=_f(a),l=640,c=220,u=46,p=18,g=18,w=34,y=l-u-p,h=c-g-w,m=e[e.length-1],d=!!r.mockData,b=d?i:Number.isFinite(o.trendHistoryNowMs)?o.trendHistoryNowMs:m?m.t:0,S=d?0:b-i,q=Math.max(b-S,1),E=q,k=nE(e,t),M=k.min===k.max?{min:k.min-1,max:k.max+1}:{min:k.min-Math.max((k.max-k.min)*.12,1),max:k.max+Math.max((k.max-k.min)*.12,1)},P=iE(k,t),N=D=>u+(D-S)/q*y,V=D=>{if(!Number.isFinite(D))return Number.NaN;let Z=(D-M.min)/Math.max(M.max-M.min,1);return g+(1-Math.min(1,Math.max(0,Z)))*h},H=[0,.5,1].map(D=>u+y*D),F=P.ticks.map(D=>V(D)),A=P.ticks.map((D,Z)=>({x:u-10,y:F[Z],text:z(D,P.axisDecimals)})),L=e.map(D=>{let Z=N(D.t),I=t.map(W=>{let ee=na(W,D);return Number.isFinite(ee)?{seriesId:W.id||W.sampleKey||W.label,tone:W.tone,label:W.label,decimals:W.decimals,unit:W.unit,value:ee,x:Z,y:V(ee)}:null});return{sample:D,x:Z,values:I}}),_=t.flatMap(D=>{let Z=[],I=[];return e.forEach(W=>{let ee=na(D,W);if(!Number.isFinite(ee)){I.length&&(Z.push(I),I=[]);return}I.push({x:N(W.t),y:V(ee)})}),I.length&&Z.push(I),Z.map(W=>W.length<2?{tone:D.tone,points:W,path:""}:{tone:D.tone,points:W,path:W.map((ee,De)=>`${De===0?"M":"L"} ${ee.x.toFixed(1)} ${ee.y.toFixed(1)}`).join(" ")})});return{width:l,height:c,left:u,right:p,top:g,bottom:w,plotWidth:y,plotHeight:h,latest:m,uptimeMs:E,endTime:b,startTime:S,span:q,windowHours:a,range:k,displayRange:M,gridXs:H,gridYs:F,yAxisLabels:A,points:L,tracks:_,series:t}}function Vi(){return we({windowHours:lo(),trendSignature:o.trendHistorySignature||"",trendNowMs:Number.isFinite(o.trendHistoryNowMs)?o.trendHistoryNowMs:0,coolingActive:Bt()})}function sE(e){return Gc().find(t=>t.id===e)||null}function lE(e,t){if(!e||!Array.isArray(e.points)||e.points.length===0)return-1;let r=0,n=Math.abs(e.points[0].x-t);return e.points.forEach((a,i)=>{let l=Math.abs(a.x-t);l<n&&(r=i,n=l)}),r}function cE(e,t){let r=If(e,t);return`
    ...
    `}function If(e,t){if(e?.currentKey&&v(e.currentKey)){let r=R(e.currentKey);if(Number.isFinite(r))return r}return na(e,t)}function Qc(e){e&&Gc().forEach(t=>{let r=e.querySelector(`[data-oq-trend-card="${t.id}"]`),n=t.samples[t.samples.length-1]||null;r&&t.series.forEach(a=>{let l=r.querySelector(`[data-oq-trend-current="${a.id}"]`)?.querySelector("strong"),c=z(If(a,n),a.decimals,a.unit);l&&l.textContent!==c&&(l.textContent=c)})})}function uE(e,t,r=!1,n=lo()){let a=Of(e,t,{mockData:r,windowHours:n}),i=Uc(n),l=Rc(a.startTime),c=Rc(a.startTime+a.span/2),u=Rc(a.endTime),p=a.tracks.flatMap(g=>{if(g.points.length<2){let w=g.points[0];return w?`
          <circle
            cx="${w.x.toFixed(1)}"
            cy="${w.y.toFixed(1)}"
            r="3.8"
    ...
    `}function dE(e){let t=e.samples[e.samples.length-1]||null,r=Uc(e.windowHours);return`
      <article class="oq-overview-trendcard oq-overview-trendcard--${s(e.tone)}" data-oq-trend-card="${s(e.id)}" data-render-signature="${s(rE(e))}">
        <div class="oq-overview-trendcard-head">
          ...
          <div class="oq-overview-trendcard-meta">
            <div class="oq-overview-trendcard-latest">
              ${e.series.map(n=>cE(n,t)).join("")}
            </div>
          </div>
        </div>
        ${uE(e.samples,e.series,e.mock,e.windowHours)}
    ...
    `}function mE(){let e=lo(),t=nc();return`
    ...
    `}function gE(){let e="overview-trends-history",t=o.settingsInfoOpen===e;return`
    ...
    `}function Ff(){let e=yt(),r=Lf().length>0;return`
      <section class="oq-helper-panel oq-helper-panel--flush">
        <div class="oq-overview-board oq-overview-board--${s(o.overviewTheme)}">
    ...
    `}function fE(){if(!o.root||o.appView!=="diagnosis")return!1;let e=o.root.querySelector(".oq-overview-board");if(!e)return!1;let t=e.querySelector(".oq-overview-trends");return t?(Xe(t,Vi(),Bi()),Qc(e),ia(e),!0):!1}function Yc(e){if(!e)return null;let t=e.__oqTrendHoverNodes;if(t&&t.chart&&t.hoverLayer&&t.hoverPanel)return t;let r=e.querySelector("[data-oq-trend-hover-layer]"),n={chart:e.querySelector(".oq-overview-trend-chart"),hoverLayer:r,hoverPanel:e.querySelector("[data-oq-trend-hover]"),hoverTime:e.querySelector("[data-oq-trend-hover-time]"),hoverNote:e.querySelector("[data-oq-trend-hover-note]"),hoverValues:e.querySelector("[data-oq-trend-hover-values]"),hoverLine:r?r.querySelector(".oq-overview-trend-hover-line"):null,hoverDots:{}};return r&&r.querySelectorAll("[data-oq-trend-hover-dot]").forEach(a=>{n.hoverDots[a.getAttribute("data-oq-trend-hover-dot")]=a}),e.__oqTrendHoverNodes=n,n}function Cf(e,t,r,n=Yc(e)){if(!e||!t||!Array.isArray(t.points)||t.points.length===0)return;let a=Math.max(0,Math.min(t.points.length-1,r)),i=t.points[a];if(!i||!n||!n.chart||!n.hoverLayer||!n.hoverPanel||!n.hoverTime||!n.hoverNote||!n.hoverValues)return;let l=String(a);if(!n.hoverPanel.hidden&&e.dataset.oqTrendHoverIndex===l)return;let c=Kk(i.sample.t,t.endTime);n.hoverPanel.hidden=!1,n.hoverLayer.removeAttribute("hidden"),n.hoverTime.textContent=c.value,n.hoverNote.textContent=c.note,n.hoverLine&&(n.hoverLine.setAttribute("x1",i.x.toFixed(1)),n.hoverLine.setAttribute("x2",i.x.toFixed(1)));let u=[];t.series.forEach(p=>{let g=na(p,i.sample),w=p.id||p.sampleKey||p.label,y=n.hoverDots[w];if(!Number.isFinite(g)){y&&y.setAttribute("display","none");return}let h=i.values.find(m=>m.seriesId===w);y&&h&&(y.removeAttribute("display"),y.setAttribute("cx",h.x.toFixed(1)),y.setAttribute("cy",h.y.toFixed(1))),u.push(`
        <div class="oq-overview-trend-hover-row oq-overview-trend-hover-row--${s(p.tone)}">
          <span>${s(p.label)}</span>
          <strong>${s(z(g,p.decimals,p.unit))}</strong>
        </div>
      `)}),n.hoverValues.innerHTML=u.join(""),e.dataset.oqTrendHoverIndex=l}function hE(e){if(!e)return;let t=Yc(e);t?.hoverPanel&&(t.hoverPanel.hidden=!0),t?.hoverLayer&&t.hoverLayer.setAttribute("hidden",""),delete e.dataset.oqTrendHoverIndex}function ia(e=o.root){if(!e)return;e.querySelectorAll("[data-oq-trend-card]").forEach(r=>{let n=r.dataset.renderSignature||"";if(r.__oqTrendBoundSignature===n)return;typeof r.__oqTrendCleanup=="function"&&r.__oqTrendCleanup(),r.__oqTrendHoverNodes=null,r.__oqTrendBoundSignature=n;let a=r.querySelector(".oq-overview-trend-chart");if(!a)return;let i=sE(r.dataset.oqTrendCard);if(!i)return;let l=Of(i.samples,i.series,{mockData:i.mock});r.__oqTrendModel=l;let c=Yc(r),u=0,p=null,g=()=>{let h=p;p=null,u=0;let m=a.getBoundingClientRect();if(!m.width||!m.height)return;let d=Number(h?.clientX);if(!Number.isFinite(d)){Cf(r,l,l.points.length-1,c);return}let S=Math.min(m.width,Math.max(0,d-m.left))/m.width*l.width,q=lE(l,S);Cf(r,l,q,c)},w=h=>{p=h,u||(u=window.requestAnimationFrame(g))},y=()=>{u&&(window.cancelAnimationFrame(u),u=0),p=null,hE(r)};a.addEventListener("pointermove",w),a.addEventListener("pointerenter",w),a.addEventListener("pointerleave",y),a.addEventListener("focus",w),a.addEventListener("blur",y),a.addEventListener("touchstart",w,{passive:!0}),r.__oqTrendCleanup=()=>{u&&(window.cancelAnimationFrame(u),u=0),p=null,a.removeEventListener("pointermove",w),a.removeEventListener("pointerenter",w),a.removeEventListener("pointerleave",y),a.removeEventListener("focus",w),a.removeEventListener("blur",y),a.removeEventListener("touchstart",w)}})}So({patchDiagnosisDom:fE});function ru(e,t,r){let n=zi(j(t.mode,"Unknown")),a=C(t.defrost),i=vo(j(t.failures,"None")),l=Wa(i),c=n==="Verwarmen"||n==="Koelen"||a;return{mode:n,defrostActive:a,failures:i,warningFailures:l,running:c,thermalKey:n==="Koelen"?t.cooling:t.heat,schematic:CE(e,t,r,n,a,l,c)}}function Wf(e,t=null){return`<h3>${s(e)}</h3>${t?`<button class="oq-overview-hp-card-action" type="button" data-oq-action="select-hp-layout" data-hp-layout="${s(t.layout)}">${RE(t.layout==="equal"?"minus":"plus")}<span>${s(t.label)}</span></button>`:""}`}function Zc(e,t,r,n){return`<div class="oq-overview-hp-status">${Oc(e,t,r,n)}</div>`}function bE(e,t){return t?"ontdooit":e==="Verwarmen"?"verwarmt":e==="Koelen"?"koelt":e==="Stand-by"?"stand-by":"onbekend"}function Vf(e){return!Array.isArray(e)||e.length===0?"":`<p class="oq-overview-hp-summary">${s(e.map(t=>`${t.title} ${bE(zi(j(t.keys.mode,"Unknown")),C(t.keys.defrost))}`).join(", "))}</p>`}function wE(e){let t=o.entities[e];if(!t)return"Positie: \u2014";let r=R(e);return Number.isNaN(r)?`Positie: ${j(e)}`:`Positie: ${z(r,0,t.uom||"")}`}function yE(e){return v(e)?`Positie: ${C(e)?"Koelen/Defrost":"Verwarmen"}`:"Positie: \u2014"}function zi(e){let t=String(e||"").trim();return!t||t==="Unknown"?"Onbekend":t==="Standby"?"Stand-by":t==="Heating"?"Verwarmen":t==="Cooling"?"Koelen":t}function Xc(e,t,r,n=!0,a="default"){return`
    ...
    `}function vE(e,t,r){return e==="temperature"?`
        <svg
    ...
    `}function sa({bind:e,modifier:t,x:r,y:n,width:a,kicker:i,detail:l,detailBind:c="",icon:u="heater",direction:p="down"}){let w=r+26,y=n+22,h=c?` data-oq-bind="${s(c)}"`:"",m="";if(p==="up"){let d=r+Math.round(a*.52);m=`M${d-6} ${n} L${d} ${n-8} L${d+6} ${n} Z`}else if(p==="left"){let d=n+Math.round(22);m=`M${r} ${d-6} L${r-8} ${d} L${r} ${d+6} Z`}else if(p==="right"){let d=n+Math.round(22);m=`M${r+a} ${d-6} L${r+a+8} ${d} L${r+a} ${d+6} Z`}else{let d=r+Math.round(a*.52);m=`M${d-6} ${n+44} L${d} ${n+44+8} L${d+6} ${n+44} Z`}return`
      <g
    ...
    `}function eu({bind:e,x:t,y:r,width:n,value:a,label:i,ariaLabel:l="",align:c="start"}){let u=l||`${i} temperatuur ${a}`,p=c==="end",g=c==="center",w=g?"middle":p?"end":"start",y=g?t+n/2:p?t+n-2:t+2;return`
      <g
    ...
    `}function SE({tooltip:e,...t}){return`${eu(t)}${sa({bind:t.bind,...e})}`}function qE({bind:e,ariaLabel:t,x:r,y:n,width:a,height:i,rx:l,tooltip:c}){return`
      ...
      <div class="${s(e.boardClass)}" data-oq-hp-board="${s(e.title)}">
        <div class="oq-hp-tech-shell">
          <div class="oq-hp-tech-visual">
            ...
            ${Object.entries(e.pipes).map(([p,g])=>Xc(p.replace(/[A-Z]/g,w=>`-${w.toLowerCase()}`),g.tone,g.d,g.animated,g.flowVariant)).join("")}
    ...
    `}function Bf(e,t,r,n="normal",a=null){if(!v(t.power))return"";let i=ru(e,t,r),{mode:l,defrostActive:c,running:u,thermalKey:p}=i,g=i.schematic;return o.hpVisualMode==="schematic"?`
      ...
      <section class="oq-overview-hp oq-overview-hp--${s(r)} oq-overview-hp--${s(n)}" data-oq-hp-panel="${s(e)}">
        ...
        <div class="oq-overview-hp-stats">
          ${aa([{key:t.power,label:"Stroomverbruik",tone:"blue",note:"elektrisch verbruik"},{key:p,label:g.heatLabel,tone:"orange",note:g.heatDescription},{label:g.efficiencyLabel,value:g.efficiencyText,tone:"green",note:"actueel"}])}
        </div>
    ...
    `}function tu(){if(!nu())return"";let e=Ui();return o.hpVisualMode!=="schematic"?HE(e):`
    ...
    `}function zf(e){return!Array.isArray(e)||e.length===0?"":`
    ...
    `}function PE(e,t){if(!e)return!1;let r=e.querySelector(".oq-overview-hp-tools-copy"),n=e.querySelector('[data-hp-visual="schematic"]'),a=e.querySelector('[data-hp-visual="compact"]');return!r||!n||!a?(Vt(e,zf(t)),!0):(Vt(r,`
      <h3>Warmtepompen</h3>
      ${Vf(t)}
    `),n.classList.toggle("is-active",o.hpVisualMode==="schematic"),a.classList.toggle("is-active",o.hpVisualMode==="compact"),!0)}function Uf(){let e=Ic(),t=ca(),r=iu(t),n=Kf(t),a=zf(t);return`
      <section class="oq-helper-panel oq-helper-panel--flush">
        <div class="oq-overview-board oq-overview-board--${s(o.overviewTheme)}">
          ${_c()}
          ${Df(e)}
    ...
    `}function T1(){let e=mt(),t=ma(),r=YE(),n=Do().filter(g=>!g.quick&&!g.custom),a=JE(),i=ZE(a),l=Xf(a.start),c=Xf(a.end),u=o.controlReplayPeriodMenuOpen,p=e==="custom"?"Eigen periode":r.some(g=>g.id===e)?"Kies periode":t.shortLabel;return`
    ...
    `}function C1(e){let t=fu(e.severity);return`
    ...
    `}function x1(e,t){let r=fu(e.severity),n=t&&t.id===e.id,a=uh(e.kind),i=ch(e);return`
      <button
      ...
      >
        ...
        <span class="oq-working-entry-body">
          ...
          <span class="oq-working-entry-meta">
            ...
            <span>${s(e.reasonLabel||lh(e.reasonCode))}</span>
            ${e.duration?`<span>Duur: ${s(e.duration)}</span>`:""}
          </span>
        </span>
        <span class="oq-working-entry-status">${s(r.label)}</span>
      </button>
    `}function vh(e){if(!e)return"";let t=fu(e.severity),r=qr(e.reasonCode),n=e.reasonLabel||r.label,a=e.reasonSummary||r.summary,i=dh(e),l=ch(e),c=Array.isArray(e.checks)?e.checks:r.checks;return`
      <aside class="oq-working-detail oq-working-detail--${s(t.tone)}">
        ...
        <details class="oq-working-support" data-replay-support-item="${s(e.id)}"${o.controlReplaySupportDetailsItemId===e.id?" open":""}>
          ...
          <dl>
            <div><dt>Record</dt><dd>${s(uh(e.kind))}</dd></div>
    ...
    `}function $1(e,t){let r=ma(),a=e.filter(c=>!c.timelineHidden).slice(0,80),i=String(o.decisionLogError||"").trim(),l=!a.length&&!o.decisionLog&&!i;return`
      ...
      <div class="oq-working-status">
        ...
        <div class="oq-working-status-grid">
          ...
          <section class="oq-working-source-grid" aria-label="Bronnen">
            ...
            ${su("CV",e.cvStatus,"","",e.cvStatus==="Actief",h?"Geen rol bij koelen.":"Tijdelijke ondersteuning bij extra warmtevraag.")}
          </section>
    ...
    `}function H1(e,t,r){return`
      <div class="oq-working-chart-lane">
        ...
        <div class="oq-working-chart-track">
          ${r.map(n=>`
            <i class="oq-working-chart-segment oq-working-chart-segment--${s(n.tone||t)}" style="--oq-chart-left:${Yf(n.start)}%;--oq-chart-width:${Yf(n.width)}%;"></i>
          `).join("")}
        </div>
      </div>
    `}function Sh(){let e=Er(),t={HP1:!1,HP2:!1,boiler:!1,cooling:!1},r={HP1:0,HP2:0},n=i=>{let l=String(i||"").toUpperCase();return l==="BOTH"?["HP1","HP2"]:l==="HP1"||l==="HP2"?[l]:[]};return bh(bu()).filter(i=>i&&!i._oq_hidden).sort((i,l)=>{let c=uo(i),u=uo(l);return(Number.isFinite(c)?c:Number.POSITIVE_INFINITY)-(Number.isFinite(u)?u:Number.POSITIVE_INFINITY)}).forEach(i=>{let l=uo(i);if(!Number.isFinite(l)||l>e.start)return;let c=String(i.event_type||""),u=Number(i._oq_context_cm??i.cm);c==="source_start"?n(i.subject).forEach(p=>{t[p]=!0,r[p]=u}):c==="source_stop"?n(i.subject).forEach(p=>{t[p]=!1,r[p]=0}):c==="boiler_assist_start"?t.boiler=!0:c==="boiler_assist_stop"&&(t.boiler=!1)}),t.cooling=["HP1","HP2"].some(i=>t[i]&&r[i]===5),{...t,sourceModes:r}}function R1(e){if(!e.some(h=>h.rawDecisionEvent))return null;let t=[{label:"HP1",tone:"running",segments:[]},{label:"HP2",tone:"running",segments:[]},{label:"CV-ketel",tone:"assist",segments:[]},{label:"Koeling",tone:"cooling",segments:[]},{label:"Ontdooien",tone:"defrost",segments:[]},{label:"Bescherming",tone:"limited",segments:[]}],r=Object.fromEntries(t.map(h=>[h.label,h])),n=(h,m,d,b,S=.5)=>{if(!r[h]||!Number.isFinite(m))return;let q=Math.max(0,Math.min(1440,Number(m))),E=Number.isFinite(d)?Math.max(q,Math.min(1440,Number(d))):q,k=Math.max(S,(E-q)/1440*100);r[h].segments.push({start:q/1440*100,width:k,tone:b})},a=(h,m,d,b=.5)=>{let S=Kt(m);n(h,S.start,S.end,d,b)},i=[...e].filter(h=>h.rawDecisionEvent).sort((h,m)=>Kt(h).start-Kt(m).start),l={HP1:null,HP2:null,"CV-ketel":null,Koeling:null},c=(h,m)=>{l[h]==null&&(l[h]=m)},u=(h,m,d="running",b=.8)=>l[h]==null?!1:(n(h,l[h],m,d,b),l[h]=null,!0),p=h=>{l.Koeling!=null&&l.HP1==null&&l.HP2==null&&u("Koeling",h,"cooling",.8)},g={},w=Sh();w.HP1&&c("HP1",0),w.HP2&&c("HP2",0),w.boiler&&c("CV-ketel",0),w.cooling&&c("Koeling",0),i.forEach(h=>{let m=Kt(h),d=String(h.realEventType||""),b=String(h.rawDecisionEvent?.subject||"").toUpperCase(),S=Number(h.rawDecisionEvent?._oq_context_cm??h.rawDecisionEvent?.cm),q=[];if((b==="HP1"||b==="BOTH")&&q.push("HP1"),(b==="HP2"||b==="BOTH")&&q.push("HP2"),d==="source_start")q.forEach(k=>c(k,m.start)),S===5&&c("Koeling",m.start);else if(d==="source_stop")q.forEach(k=>{u(k,m.start,"running")||a(k,h,"standby",.55)}),(S===5||l.Koeling!=null)&&p(m.start);else if(d==="topology_change")if(h.rawDecisionEvent?.to==="duo")c("HP1",m.start),c("HP2",m.start);else if(h.rawDecisionEvent?.to==="single"){let k=vu(h.rawDecisionEvent);k?(c(k,m.start),u(k==="HP1"?"HP2":"HP1",m.start,"running",.8)):u("HP2",m.start,"running",.8),p(m.start)}else h.rawDecisionEvent?.to==="idle"&&(u("HP1",m.start,"running",.8),u("HP2",m.start,"running",.8),u("Koeling",m.start,"cooling",.8));else if(d==="boiler_assist_start")c("CV-ketel",m.start);else if(d==="boiler_assist_stop")u("CV-ketel",m.start,"assist",.65)||a("CV-ketel",h,"standby",.65);else if(d==="candidate_blocked"||d==="flow_hold_start")a("Bescherming",h,"limited",.7);else if(d==="flow_hold_clear"){let k=Math.max(1,pa(h.rawDecisionEvent));n("Bescherming",Math.max(0,m.start-k),m.start,"limited",.7),h.rawDecisionEvent?.reason==="flow_postflow"&&u("Koeling",m.start,"cooling",.8)}if(d==="defrost_seen_start")g[b||"SYSTEM"]=m.start;else if(d==="defrost_seen_clear"&&g[b||"SYSTEM"]!=null)n("Ontdooien",g[b||"SYSTEM"],m.start,"defrost",.7),g[b||"SYSTEM"]=null;else if(d==="defrost_seen_clear"&&Number(h.rawDecisionEvent?.duration_s)>0){let k=Math.max(5,pa(h.rawDecisionEvent));n("Ontdooien",Math.max(0,m.start-k),m.start,"defrost",.7)}if(!(d==="candidate_blocked"||d==="flow_hold_start"||d==="flow_hold_clear")&&(h.severity==="limited"||h.severity==="attention"||d==="decision_blocked"||d==="decision_hold")&&a("Bescherming",h,h.severity==="attention"?"assist":"limited",.7),d==="sticky_pump_run"&&a("Bescherming",h,"safe",.6),d==="frost_protection_start")a("Bescherming",h,"limited",.8);else if(d==="frost_protection_clear"){let k=Math.max(1,pa(h.rawDecisionEvent));n("Bescherming",Math.max(0,m.start-k),m.start,"limited",.8)}});let y=yh();return Object.entries(l).forEach(([h,m])=>{m!=null&&m<=y&&n(h,m,y,h==="CV-ketel"?"assist":h==="Koeling"?"cooling":"running",.8)}),Object.values(g).forEach(h=>{h!=null&&n("Ontdooien",h,Math.min(1440,h+7),"defrost",.7)}),t.filter(h=>h.segments.length)}function P1(e){let t=R1(e);return t||[]}function N1(e,t){let r=Su(),n=r/1440*100,a=ma(),i=du(r,a),l=P1(t),c=l.length?l.map(u=>H1(u.label,u.tone,u.segments)).join(""):Ji("Nog geen grafiekdata","De grafiek gebruikt alleen echte beslislog-records. Nieuwe bronwissels, defrosts of begrenzingen verschijnen hier vanzelf.");return`
    ...
    `}function Eh(){let e=ca();return`
      <section class="oq-helper-panel oq-helper-panel--flush">
        <div class="oq-overview-board oq-overview-board--${s(o.overviewTheme)}">
          ${kh(e)}
        </div>
      </section>
    `}function D1(){if(!o.root||o.appView!=="control")return!1;let e=o.root.querySelector(".oq-overview-board"),t=e?e.querySelector(".oq-working"):null;if(!e||!t)return!1;let r=document.activeElement;if(r&&r.closest("[data-oq-control-replay-period-menu]")&&r.matches("[data-oq-control-replay-custom-input]"))return!0;let n=`oq-overview-board oq-overview-board--${o.overviewTheme}`;e.className!==n&&(e.className=n);let a=ca();return Xe(t,qh(a),kh(a))||!0}So({patchControlReplayDom:D1});function _1(){let e=document.activeElement;return o.appView!=="settings"||!o.root?.contains(e)||!e?.dataset?.oqField?null:{field:e.dataset.oqField,modalId:e.closest("[data-oq-modal]")?.dataset.oqModal||"",selectionStart:e.selectionStart,selectionEnd:e.selectionEnd}}function L1(e){if(!e||!o.root)return;let t=document.activeElement.closest("[data-oq-modal]");if((t?.dataset.oqModal||"")!==e.modalId)return;let r=(t||o.root).querySelector(`[data-oq-field="${e.field}"]`);!r||r.disabled||(r.focus({preventScroll:!0}),typeof e.selectionStart=="number"&&typeof r.setSelectionRange=="function"&&r.setSelectionRange(e.selectionStart,e.selectionEnd))}function O1(){return`
      <section class="oq-helper-panel">
    ...
    `}function I1(){return te({modalId:"initial-load",titleId:"oq-loading-modal-title",kicker:"OpenQuatt",title:"OpenQuatt laden",backdropClass:"oq-helper-modal-backdrop--loading",modalClass:"oq-helper-modal--reconnect oq-helper-modal--loading",role:"status",ariaLive:"polite",bodyMarkup:`
      ...
      `})}function F1(){return o.appView==="overview"?Uf():o.appView==="control"?Eh():o.appView==="energy"?qf():o.appView==="diagnosis"?Ff():o.appView==="results"?kf():O1()}function j1(){let e=dc();return`
    ...
    `}function W1(){let e=typeof document<"u"?document.activeElement:null;return!e||typeof e.matches!="function"?null:e.matches("select[data-oq-dev-control]")?e:null}function V1(e){if(!e||o.deferDevControlSelectRender)return;o.deferDevControlSelectRender=!0;let t=()=>{e.removeEventListener("blur",t),e.removeEventListener("change",t),o.deferDevControlSelectRender=!1,window.setTimeout(()=>Th(),0)};e.addEventListener("blur",t,{once:!0}),e.addEventListener("change",t,{once:!0})}function B1(){if(o.nativeOpen||o.appView!=="settings"||o.renderedAppView!=="settings"||o.renderedSettingsGroup!==o.settingsGroup)return null;let e=document.scrollingElement||document.documentElement,t=Number(window.scrollY||e?.scrollTop||0);return!Number.isFinite(t)||t<=0?null:{group:o.settingsGroup,left:Number(window.scrollX||e?.scrollLeft||0),top:t}}function K1(e){if(!e)return;let t=(o.settingsPageScrollRestoreToken||0)+1;o.settingsPageScrollRestoreToken=t;let r=()=>{if(t!==o.settingsPageScrollRestoreToken||o.nativeOpen||o.appView!=="settings"||o.settingsGroup!==e.group)return;let n=document.scrollingElement||document.documentElement;if(!n)return;let a=Math.max(0,n.scrollHeight-n.clientHeight),i=Math.min(e.top,a);window.scrollTo({left:e.left,top:i,behavior:"auto"})};window.requestAnimationFrame(()=>{r(),window.requestAnimationFrame(r),window.setTimeout(r,80)})}function Th(){if(!o.root)return;let e=W1();if(e){V1(e);return}let t=_1(),r=Ad(o.root),n=o.systemModal==="webserver-logs"?no():null,a=o.systemModal==="cm100-commissioning"?Kp():null,i=String(o.systemModal||"").startsWith("service-task-")?Up():null,l=o.systemModal==="history-storage"?Qp():null,c=o.systemModal==="settings-backup-restore"?Jp():null,u=o.quickStartModalOpen?Yg():null,p=B1();if(o.nativeOpen){o.root.innerHTML=`
        ${pc()}
        ${Mg()}
      `,Ds(o.root),Ls(o.root,r),o.renderedAppView="native",o.renderedSettingsGroup="",o.settingsRenderSignature="",o.headerRenderSignature=xi(),Pr({mqttSensorsModalRenderSignature:""}),xn(),Wn(),Rl(),Ts(),Es(),ao(n),Ml(a),$l(i),Al(l),Hl(c),Tc(u);return}let g=F1(),w=o.loadingEntities?`${g}${I1()}`:g,y=o.appView==="overview"||o.appView==="control"||o.appView==="energy"||o.appView==="diagnosis"||o.appView==="results";o.root.innerHTML=`
      ${pc()}

...
`)}function Hq(e,t=""){if(!e.length)return`
    ...
    `}function P1(){if(!o.root||o.appView!=="control")return!1;let e=o.root.querySelector(".oq-overview-board"),t=e?e.querySelector(".oq-working"):null;if(!e||!t)return!1;let r=document.activeElement;if(r&&r.closest("[data-oq-control-replay-period-menu]")&&r.matches("[data-oq-control-replay-custom-input]"))return!0;let n=`oq-overview-board oq-overview-board--${o.overviewTheme}`;e.className!==n&&(e.className=n);let a=ta();return Ye(t,jf(a),Vf(a))||!0}po({patchControlReplayDom:P1});function N1(){let e=document.activeElement;return o.appView!=="settings"||!o.root?.contains(e)||!e?.dataset?.oqField?null:{field:e.dataset.oqField,settingsGroup:o.settingsGroup,modal:e.closest("[data-oq-modal]")?.dataset.oqModal||"",selection:[e.selectionStart,e.selectionEnd]}}function D1(e){if(!e||o.appView!=="settings"||o.settingsGroup!==e.settingsGroup||!o.root)return;let t=e.modal?Array.from(o.root.querySelectorAll("[data-oq-modal]")).find(n=>n.dataset.oqModal===e.modal):o.root,r=Array.from(t?.querySelectorAll("[data-oq-field]")||[]).find(n=>n.dataset.oqField===e.field);!r||r.disabled||(r.focus({preventScroll:!0}),e.selection[0]!==null&&r.setSelectionRange?.(...e.selection))}function _1(){return`
      <section class="oq-helper-panel">

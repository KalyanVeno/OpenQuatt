...
`)}function Hq(e,t=""){if(!e.length)return`
    ...
    `}function D1(){return te({modalId:"initial-load",titleId:"oq-loading-modal-title",kicker:"OpenQuatt",title:"OpenQuatt laden",backdropClass:"oq-helper-modal-backdrop--loading",modalClass:"oq-helper-modal--reconnect oq-helper-modal--loading",role:"status",ariaLive:"polite",bodyMarkup:`
      ...
      `})}function _1(){return o.appView==="overview"?mf():o.appView==="control"?Bf():o.appView==="energy"?Wg():o.appView==="diagnosis"?af():o.appView==="results"?jg():N1()}function O1(){let e=Kl();return`
    ...
    `}function L1(){let e=typeof document<"u"?document.activeElement:null;return!e||typeof e.matches!="function"?null:e.matches("select[data-oq-dev-control]")?e:null}function I1(e){if(!e||o.deferDevControlSelectRender)return;o.deferDevControlSelectRender=!0;let t=()=>{e.removeEventListener("blur",t),e.removeEventListener("change",t),o.deferDevControlSelectRender=!1,window.setTimeout(()=>Kf(),0)};e.addEventListener("blur",t,{once:!0}),e.addEventListener("change",t,{once:!0})}function F1(){if(o.nativeOpen||o.appView!=="settings"||o.renderedAppView!=="settings"||o.renderedSettingsGroup!==o.settingsGroup)return null;let e=document.scrollingElement||document.documentElement,t=Number(window.scrollY||e?.scrollTop||0);return!Number.isFinite(t)||t<=0?null:{group:o.settingsGroup,left:Number(window.scrollX||e?.scrollLeft||0),top:t}}function W1(e){if(!e)return;let t=(o.settingsPageScrollRestoreToken||0)+1;o.settingsPageScrollRestoreToken=t;let r=()=>{if(t!==o.settingsPageScrollRestoreToken||o.nativeOpen||o.appView!=="settings"||o.settingsGroup!==e.group)return;let n=document.scrollingElement||document.documentElement;if(!n)return;let a=Math.max(0,n.scrollHeight-n.clientHeight),i=Math.min(e.top,a);window.scrollTo({left:e.left,top:i,behavior:"auto"})};window.requestAnimationFrame(()=>{r(),window.requestAnimationFrame(r),window.setTimeout(r,80)})}function Kf(){if(!o.root)return;let e=L1();if(e){I1(e);return}let t=o.systemModal==="webserver-logs"?Qt():null,r=o.systemModal==="cm100-commissioning"?vp():null,n=String(o.systemModal||"").startsWith("service-task-")?qp():null,a=o.systemModal==="history-storage"?Ep():null,i=o.quickStartModalOpen?bg():null,l=F1();if(o.nativeOpen){o.root.innerHTML=`
        ${zl()}
        ${Gm()}
      `,bs(o.root),o.renderedAppView="native",o.renderedSettingsGroup="",o.settingsRenderSignature="",o.headerRenderSignature=pi(),vr({mqttSensorsModalRenderSignature:""}),wn(),Dn(),dl(),ss(),is(),Yt(t),ll(r),cl(n),ul(a),nc(i);return}let c=_1(),u=o.loadingEntities?`${c}${D1()}`:c,d=o.appView==="overview"||o.appView==="control"||o.appView==="energy"||o.appView==="diagnosis"||o.appView==="results";o.root.innerHTML=`
      ${zl()}

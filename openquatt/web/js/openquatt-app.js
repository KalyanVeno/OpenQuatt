...
`)}async function pv(){let e=dv();if(o.webServerLogCopyMessage="",o.webServerLogCopyError="",!e){o.webServerLogCopyError="Er zijn nog geen logregels om te kopi\xEBren.",h();return}try{if(!await ho(e))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");o.webServerLogCopyMessage=`${o.webServerLogEntries.length} logregel${o.webServerLogEntries.length===1?"":"s"} gekopieerd.`}catch(t){o.webServerLogCopyError=t instanceof Error?t.message:"Kopi\xEBren naar het klembord is niet gelukt."}o.systemModal==="webserver-logs"&&h()}var mv={"open-webserver-log-modal":()=>Gy(),"clear-webserver-log-output":()=>Ir(),"copy-webserver-log-output":()=>pv()};function Zp(e){return ie(mv,e)}function Jp(){let e=Or();return te({id:"system",titleId:"oq-webserver-log-modal-title",kicker:"Diagnostiek",title:"OpenQuatt log",copy:e?"Hier zie je voorbeeldmeldingen uit de lokale preview.":"Hier zie je recente meldingen van OpenQuatt. Handig als je wilt terugzoeken wat er net gebeurde.",className:"oq-helper-modal--wide oq-helper-modal--scrollable oq-webserver-log-modal",closeAction:"close-system-modal",closeLabel:"Sluit logboek",body:`
    ...
    `})}function gv(){let e=o.entities.firmwareUpdateTarget||{};return Array.isArray(e.option)?e.option:Array.isArray(e.options)?e.options:[]}function Hl(e){return gv().includes(e)}function Za(){let e=Pr(),t=oe(),r=at(),n=Hp();return e!=="heatpump_controller_q"||t!=="single"&&t!=="duo"||r!=="wifi"&&r!=="eth"||!n?null:{canSwitch:v("firmwareUpdateTarget")&&Hl("alternate connection")&&v("installFirmwareUpdateTarget"),currentConnection:r,targetConnection:n,currentLabel:nt(r),targetLabel:nt(n),currentBuildLabel:qo(t,r),targetBuildLabel:qo(t,n)}}function Ja(){let e=Pr(),t=oe(),r=Rp(),n=at(),a=e==="heatpump_controller_q"?["wifi","eth"]:["wifi"];return!["heatpump_controller_q","heatpump_listener","waveshare"].includes(e)||t!=="single"&&t!=="duo"||!r||!a.includes(n)?null:{canSwitch:v("firmwareUpdateTarget")&&Hl("alternate topology")&&v("installFirmwareUpdateTarget"),currentTopology:t,targetTopology:r,currentConnection:n,targetConnection:n,currentLabel:Xo(t),targetLabel:Xo(r),currentBuildLabel:qo(t,n),targetBuildLabel:qo(r,n)}}function Xa(e,t){let r=Pr(),n=oe(),a=at(),i=Jo(e),l=Rn(t),c=i&&i!==n,u=l&&l!==a,d=c&&u?"alternate topology and connection":c?"alternate topology":u?"alternate connection":"current build",g=r==="heatpump_controller_q"&&["single","duo"].includes(n)&&["single","duo"].includes(i)&&["wifi","eth"].includes(a)&&["wifi","eth"].includes(l),w=v("firmwareUpdateTarget"),y=Hl(d),f=v("installFirmwareUpdateTarget");return{available:g,canSwitch:g&&d!=="current build"&&w&&y&&f,targetEntityAvailable:w,targetOptionAvailable:y,installActionAvailable:f,currentTopology:n,currentConnection:a,targetTopology:i,targetConnection:l,targetOption:d,currentBuildLabel:qo(n,a),targetBuildLabel:qo(i,l)}}function nr(e=o.updateTestFirmwarePr){let t=String(e||"").trim().replace(/^#?pr[-\s]*/i,"").replace(/^#/,"");return/^\d{1,6}$/.test(t)?t:""}function jr(){let e=Pr(),t=oe(),r=at(),a={waveshare:{slug:"waveshare",label:"Waveshare",connections:["wifi"]},heatpump_listener:{slug:"heatpump-listener",label:"Heatpump Listener",connections:["wifi"]},heatpump_controller_q:{slug:"heatpump-controller-q",label:"Heatpump Controller Q",connections:["wifi","eth"]}}[e];if(!a||t!=="single"&&t!=="duo"||!a.connections.includes(r))return{available:!1,label:"Onbekend target",error:"Deze firmware meldt geen herkenbaar hardware-, opstelling- of verbindingsprofiel."};let i=`openquatt-${a.slug}-${t}-${r}`,l=t==="duo"?"Duo":"Single";return{available:!0,artifactName:i,otaFileName:`${i}.firmware.ota.bin`,md5FileName:`${i}.firmware.ota.bin.md5`,label:`${a.label} ${l} ${nt(r)}`}}function Pn(e=nr(),t=jr()){if(!e||!t.available)return null;let n=`${`https://github.com/jeroen85/OpenQuatt/releases/download/pr-${e}`}/${t.otaFileName}`;return{otaUrl:n,md5Url:`${n}.md5`,releaseApiUrl:`https://api.github.com/repos/jeroen85/OpenQuatt/releases/tags/pr-${e}`}}function Mo(){if(st())return"Controleren";let e=St();if(e)return e.phaseLabel;if(Nl())return"Bijgewerkt";if(rr())return"Bezig";if(ir())return"Beschikbaar";let t=om();if(t!==null&&t<=0)return"Actueel";let r=Pt();return typeof r.updateLabel=="string"&&r.updateLabel.trim()?r.updateLabel.trim():r.updateAvailable===!0?"Beschikbaar":r.updateAvailable===!1||Dl()?"Actueel":pe()?"Nog niet gecontroleerd":"\u2014"}function pe(){return o.entities.firmwareUpdate||null}function ei(){let e=pe();return e?String(e.state??e.value??"").trim().toLowerCase():""}function fv(){let e=o.entities.firmwareUpdateStatus;return e?String(e.state??e.value??"").trim():""}function Nn(){return fv().toLowerCase()}function tm(){let e=o.entities.firmwareUpdateProgress;if(!e)return Number.NaN;let t=Number(e.value??e.state);return Number.isNaN(t)?Number.NaN:Math.max(0,Math.min(100,t))}function Rl(){let e=String(o.updateInstallTargetVersion||"").trim(),t=se();return!e||!t?!1:_n(t,e)>=0}function hv(e=pe()||{}){let t=ao(e),r=se(e);return!t||!r?!1:_n(r,t)>=0}function Pl(){return(Rl()||hv())&&!st()&&!Fr()&&!ir()}function Nl(){return(o.updateInstallCompleted||Pl())&&!st()&&!St()&&!ir()}function ar(){Me({updateInstallBusy:!1,updateInstallTargetVersion:"",updateInstallPhaseHint:"",updateInstallProgressHint:Number.NaN,updateInstallLiveProgressObserved:!1,updateInstallMode:"",updateInstallTargetConnection:"",updateInstallTargetTopology:""}),Ev()}function Dt(){o.entities.firmwareUpdateStatus={...o.entities.firmwareUpdateStatus||{},state:"Starting",value:"Starting"},o.entities.firmwareUpdateProgress={...o.entities.firmwareUpdateProgress||{},state:0,value:0},o.updateInstallPhaseHint="starting",o.updateInstallProgressHint=0,o.updateInstallLiveProgressObserved=!1}function Ee(){Me({updateManualUploadFile:null,updateManualUploadFileName:"",updateManualUploadError:""})}function Ye(e={}){Me({...e.clearPr?{updateTestFirmwarePr:""}:{},updateTestFirmwareConfirmed:!1,updateTestFirmwareError:"",updateTestFirmwareBuild:null})}function bv(){let e=Nn(),t=tm(),r=e!=="rebooting"||!o.updateInstallBusy||o.updateInstallLiveProgressObserved;if((e==="starting"||e==="retrying"||e==="uploading"||e==="rebooting")&&r){o.updateInstallPhaseHint=e,Number.isNaN(t)||(o.updateInstallProgressHint=e==="rebooting"?Math.max(t,100):t);return}if(o.updateInstallBusy){if(o.updateInstallMode==="normal"&&Rl()){o.updateInstallPhaseHint="rebooting",o.updateInstallProgressHint=100;return}o.controlNotice.includes("opnieuw is opgestart")&&(o.updateInstallPhaseHint="rebooting",o.updateInstallProgressHint=100)}}function Fr(){let e=Nn();return e==="starting"||e==="retrying"||e==="uploading"||e==="rebooting"}function wv(){let e=Nn();return e==="error"?"De firmware-installatie op het device is mislukt. Controleer de netwerkverbinding en probeer opnieuw.":e==="aborted"?"De firmware-installatie is door het device afgebroken. Probeer de installatie opnieuw.":""}function St(){bv();let e=Nn(),t=e==="starting"||e==="retrying"||e==="uploading"||e==="rebooting"&&(!o.updateInstallBusy||o.updateInstallLiveProgressObserved),r=t?e:o.updateInstallPhaseHint,n=tm(),a=Number.isNaN(o.updateInstallProgressHint)?0:Math.round(o.updateInstallProgressHint),i=t&&!Number.isNaN(n)?Math.round(n):a;return!Fr()&&!o.updateInstallBusy?null:r==="rebooting"?{phaseLabel:"Herstarten",percent:Math.max(i,100),copy:o.updateInstallMode==="test-firmware"?"Testfirmware is geplaatst. Het device start opnieuw op en komt daarna vanzelf terug.":o.updateInstallMode==="connection-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna via de gekozen verbinding terug.":o.updateInstallMode==="topology-switch"||o.updateInstallMode==="build-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna met de gekozen opstelling terug.":"Firmware is geplaatst. Het device start nu opnieuw op en komt daarna vanzelf terug."}:r==="retrying"?{phaseLabel:"Opnieuw proberen",percent:0,copy:"De eerste verbinding voor de firmwaredownload mislukte. OpenQuatt probeert het automatisch nog \xE9\xE9n keer."}:r==="uploading"?{phaseLabel:"Uploaden",percent:i,copy:o.updateInstallMode==="test-firmware"?`Testfirmware wordt nu door ${Ge()} gedownload en ge\xEFnstalleerd.`:o.updateInstallMode==="connection-switch"?`De ${nt(o.updateInstallTargetConnection)}-build wordt nu naar ${Ge()} verzonden.`:o.updateInstallMode==="topology-switch"||o.updateInstallMode==="build-switch"?`De ${qo(o.updateInstallTargetTopology,o.updateInstallTargetConnection)}-build wordt nu naar ${Ge()} verzonden.`:`Firmware wordt nu naar ${Ge()} verzonden.`}:{phaseLabel:"Installeren",percent:i,copy:o.updateInstallMode==="test-firmware"?`Testfirmware-installatie is gestart voor ${Ge()}.`:o.updateInstallMode==="connection-switch"?`Verbindingswissel naar ${nt(o.updateInstallTargetConnection)} is gestart.`:o.updateInstallMode==="topology-switch"||o.updateInstallMode==="build-switch"?`Opstellingswissel naar ${Xo(o.updateInstallTargetTopology)} is gestart.`:`OTA-update is gestart voor ${Ge()}.`}}function ao(e=pe()||{}){let t=String(e.latest_version||"").trim();if(t)return t;let r=String(e.value||"").trim(),n=String(e.current_version||"").trim();return r&&r!==n&&/^v/i.test(r)?r:""}function se(e=pe()||{}){let t=String(o.entities.projectVersionText?.state||o.entities.projectVersionText?.value||"").trim();return t||String(e.current_version||"").trim()}function yv(e=pe()||{}){let t=se(e),r=String(e.current_version||"").trim();return!t||!r||t===r?!1:_n(t,r)>0}function _l(e=pe()||{},t=xo()){let r=String(t||"").trim().toLowerCase(),n=String(e.release_url||"").trim().toLowerCase(),a=ao(e).toLowerCase();if(!r||r==="\u2014")return!0;if(r==="dev"){if(n){if(n.includes("/dev-latest"))return!0;if(a)return a.includes("-dev")}return a?a.includes("-dev"):!1}if(r==="main"){if(n){if(n.includes("/dev-latest"))return!1;if(a)return!a.includes("-dev")}return a?!a.includes("-dev"):!1}return!0}function Xp(e){let r=String(e||"").trim().match(/^v?(\d+)\.(\d+)\.(\d+)(?:-([A-Za-z]+)(?:\.(\d+))?)?/);return r?{major:Number(r[1]),minor:Number(r[2]),patch:Number(r[3]),prereleaseTag:r[4]||"",prereleaseNumber:r[5]?Number(r[5]):null}:null}function _n(e,t){let r=Xp(e),n=Xp(t);if(!r||!n)return 0;if(r.major!==n.major)return r.major>n.major?1:-1;if(r.minor!==n.minor)return r.minor>n.minor?1:-1;if(r.patch!==n.patch)return r.patch>n.patch?1:-1;let a=!r.prereleaseTag,i=!n.prereleaseTag;return a!==i?a?1:-1:r.prereleaseTag!==n.prereleaseTag?r.prereleaseTag>n.prereleaseTag?1:-1:r.prereleaseNumber!==n.prereleaseNumber?(r.prereleaseNumber||0)>(n.prereleaseNumber||0)?1:-1:0}function rr(){if(Pl())return!1;let e=ei();return o.updateInstallBusy||e==="installing"||e==="in_progress"||e==="updating"||e.includes("install")}function st(){let e=ei();return o.updateCheckBusy||e==="checking"||e==="check"||e==="checking_for_update"||e.includes("checking")}function ir(){let e=ei();if(!_l())return!1;let t=om();return t!==null?t>0:e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")?!1:e==="available"||e==="pending"||e.includes("available")?!0:Pt().updateAvailable===!0}function Dl(){let e=ei();return e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")||yv()}function Ol(){let e=pe()||{},t=se(e)||"\u2014",r=_l(e)?ao(e):"",n=r?_n(r,t):null;return!st()&&n!==null&&n<=0&&(r=""),{current:t,latest:r||"\u2014"}}function om(){let{current:e,latest:t}=Ol();return e==="\u2014"||t==="\u2014"?null:_n(t,e)}function rm(e=xo()){let t=String(e||"").trim().toLowerCase();return ns[t]||ns.main}function vv(){let e=String((pe()||{}).release_url||"").trim(),t=rm();return!e||t.includes("/dev-latest")&&!e.includes("/dev-latest")||!t.includes("/dev-latest")&&e.includes("/dev-latest")?t:e}function Sv(){return Ge()}function xo(){return String(T("firmwareUpdateChannel")||o.entities.releaseChannelText?.state||o.entities.releaseChannelText?.value||"\u2014").trim()||"\u2014"}function qv(){return Ol().latest!=="\u2014"}function em(e){return String(e||"").toLowerCase().replace(/wi[\s-]?fi/g,"wifi").replace(/[^a-z0-9]+/g,"")}function kv(e,t=pe()||{}){let r=em(e);return r?em(`${t.title||""} ${t.summary||""}`).includes(r):!0}function nm(e){return new Promise(t=>window.setTimeout(t,e))}function Wr(e=fo){let r=Date.now()+e;o.firmwareOtaQuietUntil=Math.max(Number(o.firmwareOtaQuietUntil||0),r),o.pendingEntitySyncOptions=null,Nd(),typeof _t=="function"&&_t(),o.firmwareOtaQuietTimer&&window.clearTimeout(o.firmwareOtaQuietTimer),o.firmwareOtaQuietTimer=window.setTimeout(()=>{o.firmwareOtaQuietTimer=null,o.firmwareOtaQuietUntil=0,!o.updateInstallBusy&&!o.nativeOpen&&Ds()},e)}function Ev(){o.firmwareOtaQuietTimer&&(window.clearTimeout(o.firmwareOtaQuietTimer),o.firmwareOtaQuietTimer=null),o.firmwareOtaQuietUntil=0,o.nativeOpen||Ds()}function am(){return o.deviceReconnectMode?te({modalId:"reconnect",titleId:"oq-reconnect-modal-title",kicker:"Systeem",title:fd(),modalClass:"oq-helper-modal--reconnect",role:"status",ariaLive:"polite",bodyMarkup:`
      ...
      `}):""}function Dn(e=xo()){let t=pe()||{},r=se(t);o.entities.firmwareUpdate={...t,state:"CHECKING",value:"",latest_version:"",latestVersion:"",summary:"",release_url:rm(e),current_version:r}}async function On(e={}){let t=String(e.expectedBuildLabel||"").trim();for(let r=0;r<6;r+=1){await nm(r===0?900:1200),await K(Gt,"all",{forceMissing:!0});let n=_l(),a=!t||kv(t),i=qv(),l=st(),c=Mo();if(n&&a&&(i||!l&&c!=="Nog niet gecontroleerd"))return!0}return!1}async function sr(e={}){let t=!1,r=Number.isFinite(Number(e.initialDelayMs))?Math.max(0,Number(e.initialDelayMs)):700,n=Number.isFinite(Number(e.pollDelayMs))?Math.max(250,Number(e.pollDelayMs)):1e3;for(let a=0;a<45;a+=1){await nm(a===0?r:n);try{await K(Gt,"all",{forceMissing:!0});let i=Nn();(i==="starting"||i==="retrying"||i==="uploading")&&(o.updateInstallLiveProgressObserved=!0);let l=wv();if(l){let c=new Error(l);throw c.firmwareInstallTerminal=!0,c}if(i==="rebooting"&&o.updateInstallLiveProgressObserved&&wo("ota"),h(),o.updateInstallMode==="connection-switch"){let c=Rn(o.updateInstallTargetConnection);if(c&&at()===c&&!Fr()&&!rr())return!0}else if(o.updateInstallMode==="topology-switch"){let c=Jo(o.updateInstallTargetTopology);if(c&&oe()===c&&!Fr()&&!rr())return!0}else if(o.updateInstallMode==="build-switch"){let c=Jo(o.updateInstallTargetTopology),u=Rn(o.updateInstallTargetConnection);if(c&&u&&oe()===c&&at()===u&&!Fr()&&!rr())return!0}else if(Rl()||Pl()||Dl()&&!Fr()&&!rr())return!0}catch(i){if(i?.firmwareInstallTerminal)throw i;t||(o.controlNotice="Wachten tot het device opnieuw is opgestart...",h(),t=!0)}}return!1}function Tv(){let e=xo(),t=St();if(t)return t.copy;if(Nl()){let r=o.updateInstallCompletedVersion||se()||xo();return`${Ge()} draait nu op ${r}.`}return rr()?`OTA-update wordt voorbereid voor ${Ge()}. Het device kan kort herstarten.`:st()?`We controleren of er op kanaal ${e} een nieuwe firmware beschikbaar is.`:ir()?"Er staat een nieuwere firmware klaar.":Dl()?`Je draait al de nieuwste firmware op kanaal ${e}.`:"Kies een kanaal en controleer of er een nieuwere firmware klaarstaat."}function im(){return!!(o.firmwareAdvancedOpen||o.firmwareConnectionSwitchOpen||o.firmwareTopologySwitchOpen||o.updateManualUploadOpen||o.updateTestFirmwareOpen)}function Ya(e,t,r,n,a=!1){return`
      <button
    ...
    `}function xv(){let e=Za();if(!e||!o.firmwareConnectionSwitchOpen)return"";let r=!!(St()||o.updateInstallBusy||st()),n=!!o.firmwareConnectionSwitchConfirmed,a=e.targetConnection==="eth",i=!e.canSwitch,l=a?"Sluit eerst de netwerkkabel aan. Na de herstart verdwijnt Wi-Fi uit deze firmware.":"Na de herstart verdwijnt Ethernet uit deze firmware. Als er geen Wi-Fi-gegevens bekend zijn, start het OpenQuatt fallback access point.",c=i?'<p class="oq-helper-modal-note oq-helper-modal-note--muted">Verbindingswissel wordt geladen. Open deze modal opnieuw of wacht een moment als de knop disabled blijft.</p>':"";return`
...
Alle bewaarde dagtotalen worden verwijderd. Dit heeft geen invloed op de werking van je warmtepomp.`))return e("lifetimeEnergyHistoryClear",{successNotice:"Energiehistorie is gewist.",errorPrefix:"Energiehistorie kon niet worden gewist",refreshKeys:Xt(),refreshDelayMs:500}).then(()=>{o.energyHistoryRaw="",o.energyHistorySignature="",o.energyHistoryLastFetchAt=0,Ho(),o.appView==="results"&&mr({force:!0}).then(()=>h())})},"select-energy-history-import-file":()=>GS(),"clear-energy-history-import-file":()=>{Zm(),h()},"import-energy-history-file":()=>QS(),"export-energy-history":()=>NS(),"open-history-storage-modal":()=>{o.settingsStoragePage="overview",o.systemModal="history-storage",h();let e=Si({forceMissing:!0,forceTrendHistory:!0,forceDecisionLog:!0,forceEnergyHistory:!0}).finally(()=>{o.systemModal==="history-storage"&&h()});return Ho([1e3,3e3,7e3]),e},"open-storage-diagnosis":()=>{o.settingsStoragePage="diagnosis",h()},"open-storage-decision-log":()=>{o.settingsStoragePage="decision-log",h()},"open-storage-energy":()=>{o.settingsStoragePage="energy",h()},"back-storage-overview":()=>{o.settingsStoragePage="overview",h()},"download-settings-backup":()=>oq(),"open-settings-backup-import":()=>{o.settingsBackupMqttPassword="",o.settingsBackupRestoreResult=null,o.settingsBackupError="",o.systemModal="settings-backup-import",h()},"confirm-settings-backup-restore":()=>iq()};function lg(e,t){return ie(sq,e,t)}function ac(e,t,r="",n=!1){return`
    ...
    `}function uq(){return o.trendHistoryMetadata&&typeof o.trendHistoryMetadata=="object"?o.trendHistoryMetadata:{}}function en(){return!!o.trendHistoryMetadataSignature}function tn(){return!!(o.energyHistoryRaw||o.energyHistorySignature)}function ct(e){return e?"Niet geladen":"Laden..."}function Fe(e,t="\u2014"){if(v(e))return Ae(e);let r=dq(e);return r==null||r===""?t:r}function dq(e){let t=uq();if(e==="trendHistoryFlashAvailable")return en()?t.available||"Alleen live":ct(o.trendHistoryMetadataError);if(e==="trendHistoryFlashOldest")return en()?t.oldest||"Geen data":ct(o.trendHistoryMetadataError);if(e==="trendHistoryFlashNewest")return en()?t.newest||"Geen data":ct(o.trendHistoryMetadataError);if(e==="trendHistoryFlashLastFlush")return en()?t.lastFlush||"Geen data":ct(o.trendHistoryMetadataError);if(e==="trendHistoryFlashSize")return en()?Ti(t.sizeKb):ct(o.trendHistoryMetadataError);if(e==="trendHistoryFlashWrites")return en()?Zn(t.writes):ct(o.trendHistoryMetadataError);let r=gg(),a=String(o.energyHistoryRaw||"").includes("@day_retention|");return e==="lifetimeEnergyHistoryAvailable"?tn()?a&&!r.dayPartitionAvailable?"Niet beschikbaar":dg(r.storedDayCount,"Geen data"):ct(o.energyHistoryError):e==="lifetimeEnergyHistoryOldest"?tn()?cg(r.oldestDateKey):ct(o.energyHistoryError):e==="lifetimeEnergyHistoryNewest"?tn()?cg(r.newestDateKey):ct(o.energyHistoryError):e==="lifetimeEnergyHistoryLastWrite"?tn()?Ei(r.dayLastWriteTimestampS):ct(o.energyHistoryError):e==="lifetimeEnergyHistorySize"?tn()?Ti(r.dayStorageKb):ct(o.energyHistoryError):e==="lifetimeEnergyHistoryWrites"?tn()?Zn(r.dayWriteCount):ct(o.energyHistoryError):null}function dg(e,t="Geen data"){let r=Number(e);return!Number.isFinite(r)||r<=0?t:`${Math.round(r)} ${Math.round(r)===1?"dag":"dagen"}`}function pg(e,t="Nog geen historie"){let r=Math.max(0,Math.round(Number(e)||0));return r<=0?t:`${r} ${r===1?"gebeurtenis":"gebeurtenissen"}`}function mg(){return o.decisionLogStorageMetadata&&typeof o.decisionLogStorageMetadata=="object"?o.decisionLogStorageMetadata:{}}function Ti(e,t="\u2014"){let r=Number(e);return!Number.isFinite(r)||r<=0?t:`${Math.round(r)} kB`}function Zn(e,t="0"){let r=Number(e);return!Number.isFinite(r)||r<=0?t:String(Math.round(r))}function cg(e){let t=ne(e);return t?t.date.toLocaleDateString("nl-NL",{day:"2-digit",month:"2-digit",year:"numeric"}):"Geen data"}function Ei(e,t="Geen data"){let r=Number(e);if(!Number.isFinite(r)||r<=0)return t;let n=new Date(r*1e3),a=n.toLocaleDateString("nl-NL",{day:"2-digit",month:"2-digit"}),i=n.toLocaleTimeString("nl-NL",{hour:"2-digit",minute:"2-digit"});return`${a} ${i}`}function gg(){return pi(o.energyHistoryRaw)}function pq(e){let t=Array.isArray(e.items)?e.items:[];return`
    ...
    `}function hg(){let e=["diagnosis","decision-log","energy"].includes(o.settingsStoragePage)?o.settingsStoragePage:"overview",t=v("trendHistoryEnabled")&&C("trendHistoryEnabled"),r=t&&v("trendHistoryFlashEnabled")&&C("trendHistoryFlashEnabled"),n=v("decisionLogHistoryEnabled"),a=n&&C("decisionLogHistoryEnabled"),i=mg(),l=pg(i.storedEvents),c=v("lifetimeEnergyHistoryEnabled"),u=c&&C("lifetimeEnergyHistoryEnabled"),d=c?Fe("lifetimeEnergyHistoryAvailable","Geen data"):"Geen data",g=ug(d),w=v("lifetimeEnergyHistoryClear")&&!["Geen data","\u2014"].includes(d),y=t&&v("trendHistoryFlush"),f=a&&v("decisionLogHistoryFlush"),m=v("lifetimeEnergyHistoryCapture"),p=gg(),b=String(o.energyHistoryRaw||"").includes("@hour_retention|"),S=b&&!p.hourPartitionAvailable,q=b?S?"Alleen live":dg(p.hourStoredDayCount,"Geen uurdata"):"Laden...",E=b&&!S?Ti(p.hourStorageKb):"\u2014",k=b&&!S?Zn(p.hourWriteCount):"\u2014",M=b&&!S?Ei(p.hourLastWriteTimestampS):"Geen data",P=e==="overview"?"":`
      ...
      <p class="oq-settings-storage-footnote"><strong>Goed om te weten:</strong> gegevens die worden bewaard, blijven beschikbaar na een herstart. Tijdelijke gegevens bestaan alleen zolang de controller online is.</p>`;return e==="diagnosis"?(A="Diagnosegegevens",O="Beheer technische meetreeksen voor diagnosegrafieken en hulp bij problemen.",D=`${P}<section class="oq-settings-storage-domain oq-settings-storage-domain--single">
        <div class="oq-settings-storage-domain-rows">
          ${ki("trendHistoryEnabled","Recente diagnosegegevens","Bewaar de laatste meetpunten zolang de controller online is.","Deze gegevens zijn tijdelijk en verdwijnen na een herstart.","Nieuwe tijdelijke diagnosegegevens worden niet bijgehouden.","Tijdelijk")}
          ${ki("trendHistoryFlashEnabled","Diagnosegeschiedenis bewaren","Bewaar recente diagnosegegevens ook na een herstart of update.","OpenQuatt slaat ongeveer ieder uur een blok op.","Bestaande geschiedenis blijft staan.","Blijft bewaard na herstart")}
        ...
        <div class="oq-settings-storage-domain-rows">
          ${ki("decisionLogHistoryEnabled","Beslisloghistorie bewaren","Bewaar exacte momenten en redenen uit de beslislog.","De laatste zeven dagen blijven beschikbaar na een herstart of update.","De actuele beslislog blijft tijdelijk beschikbaar; bestaande historie blijft staan.","Blijft bewaard na herstart")}
      ...
      ${v("decisionLogHistoryClear")?`<details class="oq-settings-storage-advanced"><summary>Geavanceerd</summary><div class="oq-settings-storage-inline-action oq-settings-storage-inline-action--danger"><div><h4>Beslisloghistorie wissen</h4><p>Verwijder alle bewaarde gebeurtenissen. De actuele beslislog blijft staan.</p></div>${Yn("decisionLogHistoryClear","Historie wissen","clear-decision-log-history",{disabled:Number(i.storedEvents||0)<=0,buttonClass:"oq-helper-button oq-helper-button--warning",busyLabel:"Wissen..."})}</div></details>`:""}`):e==="energy"&&(A="Energiehistorie",O="Beheer dagtotalen en uurdetail voor de Resultatenpagina.",D=`${P}<section class="oq-settings-storage-domain oq-settings-storage-domain--single">
        <div class="oq-settings-storage-domain-rows">
          ${ki("lifetimeEnergyHistoryEnabled","Dagtotalen bewaren","Bewaar elke dag een samenvatting van je energiegegevens.","Resultaten blijven beschikbaar na een herstart of update.","Nieuwe dagtotalen worden niet bewaard; bestaande historie blijft staan.","Blijft bewaard na herstart")}
    ...
    `}zd({getSignature:Ci,patch:bq});function Cg(){if(o.systemModal==="login")return Cm();if(o.systemModal==="api-security")return Tm();if(o.systemModal==="mqtt")return sp();if(o.systemModal==="mqtt-sensors")return lp();if(o.systemModal==="connectivity"){let e=hq();return te({modalId:"system",titleId:"oq-system-modal-title",kicker:"Systeem",title:"Connectiviteit",closeAction:"close-system-modal",closeLabel:"Sluit systeem-popup",bodyMarkup:`
      ...
      `:"";return te({modalId:"system",titleId:"oq-backup-success-modal-title",kicker:"Beheer",title:"Backup hersteld",closeAction:"close-system-modal",closeLabel:"Sluit bevestiging",className:"oq-helper-modal--wide oq-helper-modal--scrollable",bodyMarkup:`
        ...
        `});if(o.systemModal==="webserver-logs")return Jp();if(o.systemModal==="debug-recording")return bm();if(o.systemModal==="openquatt-pause"){let e=C("openquattEnabled"),t=o.busyAction==="openquatt-regulation",r=v("openquattResumeAt"),n=o.loadingEntities||o.entitySyncInFlight,a=r||!n,i=vn(),l=Mr(T("openquattResumeAt")),c=Ha();return te({modalId:"system",titleId:"oq-openquatt-pause-modal-title",kicker:"Bediening",title:"Openquatt regeling",modalClass:"oq-helper-modal--wide",closeAction:"close-system-modal",closeLabel:"Sluit regeling-popup",bodyMarkup:`
        ...
        `})}return""}function yq(e=!1){let t=Ra();return t?`
    ...
    `:""}function Mi(e,t="Aandacht",r="OK"){return`<span class="oq-settings-monitoring-badge${e?" is-warning":" is-clear"}">${s(e?t:r)}</span>`}function on({label:e,value:t,note:r="",active:n=!1}){return`
    ...
    `:"";return re("Bewaking","Installatiebewaking","Lokale diagnose voor compressorstarts, hydrauliek en verbindingen. Hiervoor is geen Home Assistant nodig.",`
      ...
      `)}function yc(){if(!v("hpGeneration"))return"";let e={V1:{copy:"Voor Quatt V1 en Quatt V1 + V1.5 combinaties.",image:Na,alt:"Quatt Hybrid V1 en V1.5",infoTitle:"V1",infoCopy:`Model: AMM4
...
Kenmerken: Flowmeter in de buitenunit ge\xEFntegreerd. Onder CV-ketel enkel een kleine clip-on temperatuursensor.`}},t=o.entities.hpGeneration||{},r=String(T("hpGeneration")||""),n=to(t),a=o.loadingEntities||o.busyAction==="save-hpGeneration";return`
    ...
    `}function _g(){let e=Nt(),t=o.entities.hpGeneration||{},r=v("hpGeneration")&&to(t).length>0;return!e&&!r?"":re("Basis","Quatt Hybrid-versie","Kies hier welke Quatt Hybrid je hebt. Deze keuze bepaalt de basis van de regeling.",`
      ...
      `)}function Lg(){let e=Mo(),t=Ka(),r=o.busyAction==="restartAction";return re("Diagnostiek","Systeemstatus","Snelle statusinformatie voor support, controle en onderhoud.",`
        <div class="oq-settings-system-summary">
          ...
          ${Le({dataValue:"debugRecording",label:"Debugopname",value:Ln(),note:ri(),action:`<button
              class="oq-helper-button oq-helper-button--ghost"
              type="button"
              data-oq-action="open-debug-recording-modal"
            >
          ...
          ${Le({dataValue:"espTemp",label:"ESP-temp",value:xi()})}
    ...
    `}function Dq(){let e=$i(),t=o.busyAction==="quickstart-thermostat-source",r=e.status==="Geldig"?" is-active":"",n=e.isRemoteProfile?`
    ...
    `}function Bq(){let e=Gg().id;return e==="setup"?Pq():e==="generation"?Wg():e==="boiler"?v("boilerCvAssistEnabled")?Lq():jg():e==="flow-source"?_q():e==="thermostat-source"?Dq():e==="flow"?Iq():e==="heating"?Fq():e==="water"?jq():e==="silent"?Wq():e==="confirm"?Vq():jg()}function gr(){let e=Sc().isQEdition;return kr.filter(t=>(t.id!=="setup"||e)&&(!t.optionalEntity||v(t.optionalEntity)))}function kt(e){let t=gr().findIndex(r=>r.id===e);return`Stap ${Math.max(0,t)+1}`}function Kq(e){let t=Ai(),r=e===t,n=o.complete===!0||e<t;return{tone:r?"current":n?"done":"upcoming",label:r?"Actief":n?"Gereed":"Volgend",current:r}}function zq(e=!1){return gr().map((t,r)=>{let n=Kq(r);return`
      ...
      `}).join("")}function Gg(){let e=gr();return e.find(t=>t.id===o.currentStep)||e[0]||kr[0]}function Ai(){return Math.max(0,gr().findIndex(e=>e.id===o.currentStep))}function Qg(e){let t=gr(),r=Math.min(t.length-1,Math.max(0,Ai()+e));o.currentStep=t[r]?.id||kr[0].id}function Ft(e={}){let t=Ai(),r=gr(),n=t>0?r[t-1]:null,a=t<r.length-1?r[t+1]:null;return`
    ...
    `}function Uq(){let e=Ai(),t=gr();return`
    ...
    `:""}function Tc(){let e=Ma.map(Xq).filter(Boolean),t=["oq-overview-energy-grid",e.length===1?"oq-overview-energy-grid--single":"",e.length===2?"oq-overview-energy-grid--two":""].filter(Boolean).join(" ");return{renderedColumns:e,gridClassName:t}}function af(e=Tc()){return be(e)}function sf(e=Tc()){return`
...
`)}function Ek(e,t=""){if(!e.length)return`
    ...
    `}function _c(e,t,r,n){return`${r?Hk(n):""}${Ak(e,t)}`}function Ef(e,t,r,n,a){if(!e)return;let i=be({mode:t,running:r,warningActive:n,failureText:a});e.dataset.renderSignature!==i&&(jt(e,_c(t,r,n,a)),e.dataset.renderSignature=i)}function Oi(e,t,r=""){return`
    ...
    `}function ji(){let e=Kc();return`
      <section class="oq-overview-trends" aria-label="Diagnose" data-render-signature="${s(Fi())}">
    ...
    `}function Jc(){if(!tu())return"";let e=Bi();return o.hpVisualMode!=="schematic"?k1(e):`
    ...
    `}function la(){let e=typeof oe=="function"?oe():"";return Ta.filter(t=>e==="single"&&t.title==="HP2"?!1:v(t.keys.power))}function ru(e){return!Array.isArray(e)||e.length<2||o.hpVisualMode!=="schematic"?"equal":o.hpLayoutMode==="focus-hp1"||o.hpLayoutMode==="focus-hp2"?o.hpLayoutMode:"equal"}function Wi(e,t,r){return!Array.isArray(t)||t.length<2?"normal":r==="focus-hp1"?e===0?"focus":"muted":r==="focus-hp2"?e===1?"focus":"muted":"normal"}function Xc(e,t,r){return!Array.isArray(t)||t.length<2||o.hpVisualMode!=="schematic"?null:Wi(e,t,r)==="focus"?{layout:"equal",label:"Toon beide"}:{layout:e===0?"focus-hp1":"focus-hp2",label:"Vergroot"}}function jf(e){return!Array.isArray(e)||e.length!==1?ru(e):tu()?"equal":"single"}function E1(e="plus"){return`
      ...
      <div class="oq-working-split">
        <section class="oq-working-list" aria-label="${s(r.eyebrow)}">
          ...
          ${a.length?`<div class="oq-working-timeline">
                ${a.map(c=>yE(c,t)).join("")}
              </div>`:i?Gi("Beslislog niet beschikbaar",`De firmwarelog kon niet worden geladen (${i}). Dit betekent niet dat deze periode leeg is.`):l?Gi("Beslislog laden","De controllerkeuzes worden opgehaald. Dit duurt meestal maar heel kort."):Gi("Nog geen gebeurtenissen","De beslislog is leeg voor deze periode. Nieuwe controllerkeuzes verschijnen hier zodra de firmware ze vastlegt.")}
        </section>
        ${t?hh(t):""}
      </div>
    ...
    `}function NE(){let e=typeof document<"u"?document.activeElement:null;return!e||typeof e.matches!="function"?null:e.matches("select[data-oq-dev-control]")?e:null}function _E(e){if(!e||o.deferDevControlSelectRender)return;o.deferDevControlSelectRender=!0;let t=()=>{e.removeEventListener("blur",t),e.removeEventListener("change",t),o.deferDevControlSelectRender=!1,window.setTimeout(()=>Sh(),0)};e.addEventListener("blur",t,{once:!0}),e.addEventListener("change",t,{once:!0})}function DE(){if(o.nativeOpen||o.appView!=="settings"||o.renderedAppView!=="settings"||o.renderedSettingsGroup!==o.settingsGroup)return null;let e=document.scrollingElement||document.documentElement,t=Number(window.scrollY||e?.scrollTop||0);return!Number.isFinite(t)||t<=0?null:{group:o.settingsGroup,left:Number(window.scrollX||e?.scrollLeft||0),top:t}}function OE(e){if(!e)return;let t=(o.settingsPageScrollRestoreToken||0)+1;o.settingsPageScrollRestoreToken=t;let r=()=>{if(t!==o.settingsPageScrollRestoreToken||o.nativeOpen||o.appView!=="settings"||o.settingsGroup!==e.group)return;let n=document.scrollingElement||document.documentElement;if(!n)return;let a=Math.max(0,n.scrollHeight-n.clientHeight),i=Math.min(e.top,a);window.scrollTo({left:e.left,top:i,behavior:"auto"})};window.requestAnimationFrame(()=>{r(),window.requestAnimationFrame(r),window.setTimeout(r,80)})}function Sh(){if(!o.root)return;let e=NE();if(e){_E(e);return}let t=ME(),r=xd(o.root),n=o.systemModal==="webserver-logs"?ro():null,a=o.systemModal==="cm100-commissioning"?Vp():null,i=String(o.systemModal||"").startsWith("service-task-")?Kp():null,l=o.systemModal==="history-storage"?Up():null,c=o.systemModal==="settings-backup-restore"?Qp():null,u=o.quickStartModalOpen?Ug():null,d=DE();if(o.nativeOpen){o.root.innerHTML=`
        ${cc()}
        ${Tg()}
      `,Ps(o.root),_s(o.root,r),o.renderedAppView="native",o.renderedSettingsGroup="",o.settingsRenderSignature="",o.headerRenderSignature=Ci(),Ar({mqttSensorsModalRenderSignature:""}),Cn(),jn(),$l(),ks(),qs(),no(n),Tl(a),Cl(i),xl(l),Ml(c),qc(u);return}let g=RE(),w=o.loadingEntities?`${g}${HE()}`:g,y=o.appView==="overview"||o.appView==="control"||o.appView==="energy"||o.appView==="diagnosis"||o.appView==="results";o.root.innerHTML=`
      ${cc()}

...
`)}async function Yy(){let e=Qy();if(o.webServerLogCopyMessage="",o.webServerLogCopyError="",!e){o.webServerLogCopyError="Er zijn nog geen logregels om te kopi\xEBren.",h();return}try{if(!await fo(e))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");o.webServerLogCopyMessage=`${o.webServerLogEntries.length} logregel${o.webServerLogEntries.length===1?"":"s"} gekopieerd.`}catch(t){o.webServerLogCopyError=t instanceof Error?t.message:"Kopi\xEBren naar het klembord is niet gelukt."}o.systemModal==="webserver-logs"&&h()}var Zy={"open-webserver-log-modal":()=>Ry(),"clear-webserver-log-output":()=>Lr(),"copy-webserver-log-output":()=>Yy()};function jp(e){return ie(Zy,e)}function Wp(){let e=Dr();return te({id:"system",titleId:"oq-webserver-log-modal-title",kicker:"Diagnostiek",title:"OpenQuatt log",copy:e?"Hier zie je voorbeeldmeldingen uit de lokale preview.":"Hier zie je recente meldingen van OpenQuatt. Handig als je wilt terugzoeken wat er net gebeurde.",className:"oq-helper-modal--wide oq-helper-modal--scrollable oq-webserver-log-modal",closeAction:"close-system-modal",closeLabel:"Sluit logboek",body:`
    ...
    `}function dv(){let e=Ya();if(!e||!o.firmwareConnectionSwitchOpen)return"";let r=!!(St()||o.updateInstallBusy||st()),n=!!o.firmwareConnectionSwitchConfirmed,a=e.targetConnection==="eth",i=!e.canSwitch,l=a?"Sluit eerst de netwerkkabel aan. Na de herstart verdwijnt Wi-Fi uit deze firmware.":"Na de herstart verdwijnt Ethernet uit deze firmware. Als er geen Wi-Fi-gegevens bekend zijn, start het OpenQuatt fallback access point.",c=i?'<p class="oq-helper-modal-note oq-helper-modal-note--muted">Verbindingswissel wordt geladen. Open deze modal opnieuw of wacht een moment als de knop disabled blijft.</p>':"";return`
        ...
        `:`
          <section class="oq-debug-recording-duration" aria-label="Duur">
            ...
            <div class="oq-debug-recording-segments" role="group" aria-label="Kies opnameduur">
              ${Ca.map(d=>{let b=Number(d.minutes)===c;return`
                  <button
...
Alle bewaarde dagtotalen worden verwijderd. Dit heeft geen invloed op de werking van je warmtepomp.`))return e("lifetimeEnergyHistoryClear",{successNotice:"Energiehistorie is gewist.",errorPrefix:"Energiehistorie kon niet worden gewist",refreshKeys:Jt(),refreshDelayMs:500}).then(()=>{o.energyHistoryRaw="",o.energyHistorySignature="",o.energyHistoryLastFetchAt=0,$o(),o.appView==="results"&&pr({force:!0}).then(()=>h())})},"select-energy-history-import-file":()=>RS(),"clear-energy-history-import-file":()=>{jm(),h()},"import-energy-history-file":()=>PS(),"export-energy-history":()=>wS(),"open-history-storage-modal":()=>{o.settingsStoragePage="overview",o.systemModal="history-storage",h();let e=vi({forceMissing:!0,forceTrendHistory:!0,forceDecisionLog:!0,forceEnergyHistory:!0}).finally(()=>{o.systemModal==="history-storage"&&h()});return $o([1e3,3e3,7e3]),e},"open-storage-diagnosis":()=>{o.settingsStoragePage="diagnosis",h()},"open-storage-decision-log":()=>{o.settingsStoragePage="decision-log",h()},"open-storage-energy":()=>{o.settingsStoragePage="energy",h()},"back-storage-overview":()=>{o.settingsStoragePage="overview",h()},"download-settings-backup":()=>FS(),"open-settings-backup-import":()=>{o.settingsBackupMqttPassword="",o.settingsBackupRestoreResult=null,o.settingsBackupError="",o.systemModal="settings-backup-import",h()},"confirm-settings-backup-restore":()=>BS()};function Jm(e,t){return ie(KS,e,t)}function tc(e,t,r="",n=!1){return`
    ...
    `:""}function US(e){return v(e)||!!L[e]&&!o.optionalMissingEntities?.[e]}function Qn(e,t,r,n={}){if(!US(e))return"";let a=v(e),i=a&&(o.loadingEntities||o.busyAction===e),l=n.disabled===!0||!a,c=n.buttonClass||"oq-helper-button oq-helper-button--ghost";return`
      <button
        class="${s(c)}"
        type="button"
        data-oq-action="${s(r)}"
    ...
    `}function JS(){if(!v("lifetimeEnergyHistoryEnabled"))return"";let e=Zr(o.energyHistoryExportMode),t=Un.map(n=>`
    ...
    `}function ig(){let e=["diagnosis","decision-log","energy"].includes(o.settingsStoragePage)?o.settingsStoragePage:"overview",t=v("trendHistoryEnabled")&&C("trendHistoryEnabled"),r=t&&v("trendHistoryFlashEnabled")&&C("trendHistoryFlashEnabled"),n=v("decisionLogHistoryEnabled"),a=n&&C("decisionLogHistoryEnabled"),i=rg(),l=og(i.storedEvents),c=v("lifetimeEnergyHistoryEnabled"),u=c&&C("lifetimeEnergyHistoryEnabled"),p=c?Fe("lifetimeEnergyHistoryAvailable","Geen data"):"Geen data",g=eg(p),w=v("lifetimeEnergyHistoryClear")&&!["Geen data","\u2014"].includes(p),y=t&&v("trendHistoryFlush"),f=a&&v("decisionLogHistoryFlush"),m=v("lifetimeEnergyHistoryCapture"),d=ng(),b=String(o.energyHistoryRaw||"").includes("@hour_retention|"),S=b&&!d.hourPartitionAvailable,q=b?S?"Alleen live":tg(d.hourStoredDayCount,"Geen uurdata"):"Laden...",E=b&&!S?Ei(d.hourStorageKb):"\u2014",k=b&&!S?Yn(d.hourWriteCount):"\u2014",M=b&&!S?ki(d.hourLastWriteTimestampS):"Geen data",P=e==="overview"?"":`
      ...
      ${v("decisionLogHistoryClear")?`<details class="oq-settings-storage-advanced"><summary>Geavanceerd</summary><div class="oq-settings-storage-inline-action oq-settings-storage-inline-action--danger"><div><h4>Beslisloghistorie wissen</h4><p>Verwijder alle bewaarde gebeurtenissen. De actuele beslislog blijft staan.</p></div>${Qn("decisionLogHistoryClear","Historie wissen","clear-decision-log-history",{disabled:Number(i.storedEvents||0)<=0,buttonClass:"oq-helper-button oq-helper-button--warning",busyLabel:"Wissen..."})}</div></details>`:""}`):e==="energy"&&(H="Energiehistorie",O="Beheer dagtotalen en uurdetail voor de Resultatenpagina.",D=`${P}<section class="oq-settings-storage-domain oq-settings-storage-domain--single">
        <div class="oq-settings-storage-domain-rows">
    ...
    `}function tq(){if(!o.root)return!1;let e=o.root.querySelector(".oq-helper-status-grid");if(!e)return!!o.root.querySelector(".oq-helper-hub");let t=dg();if(e.querySelectorAll("[data-oq-header-status]").length!==t.length)return e.outerHTML=Zn(),!0;for(let[n,a,i,l]of t){let c=e.querySelector(`[data-oq-header-status="${n}"]`);if(!c)return e.outerHTML=Zn(),!0;let u=ug(n),p=!!(l||u);if(c.tagName.toLowerCase()!==(p?"button":"div"))return e.outerHTML=Zn(),!0;let g=c.querySelector(".oq-helper-status-label"),w=c.querySelector(".oq-helper-status-value");if(!g||!w)return e.outerHTML=Zn(),!0;g.textContent!==a&&(g.textContent=a);let y=mg(n),f=y?`<span class="oq-helper-status-value-text">${s(i)}</span><span class="oq-helper-status-badge" aria-label="Update beschikbaar" title="Update beschikbaar"></span>`:s(i);w.innerHTML!==f&&(w.innerHTML=f),p?c.setAttribute("data-oq-action",u):c.removeAttribute("data-oq-action"),c.classList.toggle("oq-helper-status-item--button",p),c.classList.toggle("oq-helper-status-item--attention",y)}return!0}function oq(){return""}function ac(){return""}function gg(){let e=o.nativeOpen?"native":"app",t=pg();return o.interfacePanelOpen?`
    ...
    `}Ld({getSignature:Ti,patch:tq});function hg(){if(o.systemModal==="login")return hm();if(o.systemModal==="api-security")return fm();if(o.systemModal==="mqtt")return Xd();if(o.systemModal==="mqtt-sensors")return ep();if(o.systemModal==="connectivity"){let e=eq();return te({modalId:"system",titleId:"oq-system-modal-title",kicker:"Systeem",title:"Connectiviteit",closeAction:"close-system-modal",closeLabel:"Sluit systeem-popup",bodyMarkup:`
      ...
      `:"";return te({modalId:"system",titleId:"oq-backup-success-modal-title",kicker:"Beheer",title:"Backup hersteld",closeAction:"close-system-modal",closeLabel:"Sluit bevestiging",className:"oq-helper-modal--wide oq-helper-modal--scrollable",bodyMarkup:`
        ...
        `});if(o.systemModal==="webserver-logs")return Wp();if(o.systemModal==="debug-recording")return sm();if(o.systemModal==="openquatt-pause"){let e=C("openquattEnabled"),t=o.busyAction==="openquatt-regulation",r=v("openquattResumeAt"),n=o.loadingEntities||o.entitySyncInFlight,a=r||!n,i=yn(),l=xr(T("openquattResumeAt")),c=Ha();return te({modalId:"system",titleId:"oq-openquatt-pause-modal-title",kicker:"Bediening",title:"Openquatt regeling",modalClass:"oq-helper-modal--wide",closeAction:"close-system-modal",closeLabel:"Sluit regeling-popup",bodyMarkup:`
        ...
        `})}return""}function rq(e=!1){let t=Aa();return t?`
    ...
    `:"";return re("Bewaking","Installatiebewaking","Lokale diagnose voor compressorstarts, hydrauliek en verbindingen. Hiervoor is geen Home Assistant nodig.",`
      ...
      `)}function fc(){if(!v("hpGeneration"))return"";let e={V1:{copy:"Voor Quatt V1 en Quatt V1 + V1.5 combinaties.",image:Pa,alt:"Quatt Hybrid V1 en V1.5",infoTitle:"V1",infoCopy:`Model: AMM4
...
Kenmerken: Flowmeter in de buitenunit ge\xEFntegreerd. Onder CV-ketel enkel een kleine clip-on temperatuursensor.`}},t=o.entities.hpGeneration||{},r=String(T("hpGeneration")||""),n=eo(t),a=o.loadingEntities||o.busyAction==="save-hpGeneration";return`
    ...
    `}function Tg(){let e=Nt(),t=o.entities.hpGeneration||{},r=v("hpGeneration")&&eo(t).length>0;return!e&&!r?"":re("Basis","Quatt Hybrid-versie","Kies hier welke Quatt Hybrid je hebt. Deze keuze bepaalt de basis van de regeling.",`
      ...
      `)}function Mg(){let e=Co(),t=Ba(),r=o.busyAction==="restartAction";return re("Diagnostiek","Systeemstatus","Snelle statusinformatie voor support, controle en onderhoud.",`
    ...
    `:""}function Sc(){let e=xa.map(Oq).filter(Boolean),t=["oq-overview-energy-grid",e.length===1?"oq-overview-energy-grid--single":"",e.length===2?"oq-overview-energy-grid--two":""].filter(Boolean).join(" ");return{renderedColumns:e,gridClassName:t}}function Qg(e=Sc()){return be(e)}function Yg(e=Sc()){return`
...
`)}function lk(e,t=""){if(!e.length)return`
    ...
    `}function uk(e,t,r,n){let a=je(r)==="day"?Number(n):Number.NaN,i=Number.isFinite(a)?e.find(l=>l.dateKey===a):null;return i?[i]:t}function kc(){let e=Xn(),t=je(o.energyHistoryView),r=_i(e,t),n=Qq(e,t,r),a=uk(e,n.buckets,t,r.selectedValue),i=Yq(a);return{records:e,buckets:n.buckets,viewModel:n,periodControl:r,summary:i,activeView:t}}function af(e=kc()){return be({energyHistorySignature:o.energyHistorySignature||"",energyHistoryError:o.energyHistoryError||"",activeView:e.activeView,periodView:e.periodControl.view,periodValue:e.periodControl.selectedValue,periodMin:e.periodControl.minValue,periodMax:e.periodControl.maxValue,recordCount:e.records.length,bucketCount:e.buckets.length,latestDate:e.records[e.records.length-1]?.dateKey||0,summary:e.summary})}function sf(e=kc()){let t=e.summary,r=Jq(t),n=e.buckets[0]?.dateKey?Lt(e.buckets[0].dateKey):"\u2014",a=e.buckets[e.buckets.length-1]?.dateKey?Lt(e.buckets[e.buckets.length-1].dateKey):"\u2014";return`
    ...
    `}function ra(e,t=!1){return e.map(r=>mk({...r,value:Object.prototype.hasOwnProperty.call(r,"key")?rt(r.key):r.value,status:t})).join("")}function Mc(e){return`
    ...
    `}function Zk({tooltip:e,...t}){return`${Uc(t)}${aa({bind:t.bind,...e})}`}function Jk({bind:e,ariaLabel:t,x:r,y:n,width:a,height:i,rx:l,tooltip:c}){return`
    ...
    `}function Hf(e,t,r,n="normal",a=null){if(!v(t.power))return"";let i=Yc(e,t,r),{mode:l,defrostActive:c,running:u,thermalKey:p}=i,g=i.schematic;return o.hpVisualMode==="schematic"?`
      ...
      <section class="oq-overview-hp oq-overview-hp--${s(r)} oq-overview-hp--${s(n)}" data-oq-hp-panel="${s(e)}">
        ...
        <div class="oq-overview-hp-stats">
          ${ra([{key:t.power,label:"Stroomverbruik",tone:"blue",note:"elektrisch verbruik"},{key:p,label:g.heatLabel,tone:"orange",note:g.heatDescription},{label:g.efficiencyLabel,value:g.efficiencyText,tone:"green",note:"actueel"}])}
        </div>
    ...
    `}function c1(e,t){if(!e)return!1;let r=e.querySelector(".oq-overview-hp-tools-copy"),n=e.querySelector('[data-hp-visual="schematic"]'),a=e.querySelector('[data-hp-visual="compact"]');return!r||!n||!a?(Ft(e,Rf(t)),!0):(Ft(r,`
      <h3>Warmtepompen</h3>
      ${$f(t)}
    `),n.classList.toggle("is-active",o.hpVisualMode==="schematic"),a.classList.toggle("is-active",o.hpVisualMode==="compact"),!0)}function Pf(){let e=Rc(),t=sa(),r=Xc(t),n=Af(t),a=Rf(t);return`
      <section class="oq-helper-panel oq-helper-panel--flush">
        <div class="oq-overview-board oq-overview-board--${s(o.overviewTheme)}">
          ${$c()}
          ${Sf(e)}
    ...
    `}function tE(){let e=dt(),t=da(),r=C1(),n=Ro().filter(g=>!g.quick&&!g.custom),a=x1(),i=M1(a),l=If(a.start),c=If(a.end),u=o.controlReplayPeriodMenuOpen,p=e==="custom"?"Eigen periode":r.some(g=>g.id===e)?"Kies periode":t.shortLabel;return`
    ...
    `}function aE(e,t){let r=da(),a=e.filter(c=>!c.timelineHidden).slice(0,80),i=String(o.decisionLogError||"").trim(),l=!a.length&&!o.decisionLog&&!i;return`

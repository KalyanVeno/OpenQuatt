...
Alle bewaarde dagtotalen worden verwijderd. Dit heeft geen invloed op de werking van je warmtepomp.`))return e("lifetimeEnergyHistoryClear",{successNotice:"Energiehistorie is gewist.",errorPrefix:"Energiehistorie kon niet worden gewist",refreshKeys:Yt(),refreshDelayMs:500}).then(()=>{o.energyHistoryRaw="",o.energyHistorySignature="",o.energyHistoryLastFetchAt=0,$o(),o.appView==="results"&&dr({force:!0}).then(()=>f())})},"select-energy-history-import-file":()=>bS(),"clear-energy-history-import-file":()=>{Mm(),f()},"import-energy-history-file":()=>wS(),"export-energy-history":()=>rS(),"open-history-storage-modal":()=>{o.settingsStoragePage="overview",o.systemModal="history-storage",f();let e=mi({forceMissing:!0,forceTrendHistory:!0,forceDecisionLog:!0,forceEnergyHistory:!0}).finally(()=>{o.systemModal==="history-storage"&&f()});return $o([1e3,3e3,7e3]),e},"open-storage-diagnosis":()=>{o.settingsStoragePage="diagnosis",f()},"open-storage-decision-log":()=>{o.settingsStoragePage="decision-log",f()},"open-storage-energy":()=>{o.settingsStoragePage="energy",f()},"back-storage-overview":()=>{o.settingsStoragePage="overview",f()},"download-settings-backup":()=>CS(),"open-settings-backup-import":()=>{o.systemModal="settings-backup-import",f()},"confirm-settings-backup-restore":()=>xS()};function Im(e,t){return ie($S,e,t)}function Ul(e,t,r="",n=!1){return`
    ...
    `:""}function HS(e){return v(e)||!!O[e]&&!o.optionalMissingEntities?.[e]}function zn(e,t,r,n={}){if(!HS(e))return"";let a=v(e),i=a&&(o.loadingEntities||o.busyAction===e),l=n.disabled===!0||!a,c=n.buttonClass||"oq-helper-button oq-helper-button--ghost";return`
      <button
        class="${s(c)}"
        type="button"
        data-oq-action="${s(r)}"
    ...
    `}function NS(){if(!v("lifetimeEnergyHistoryEnabled"))return"";let e=Qr(o.energyHistoryExportMode),t=Bn.map(n=>`
    ...
    `}function OS(){if(!o.root)return!1;let e=o.root.querySelector(".oq-helper-status-grid");if(!e)return!!o.root.querySelector(".oq-helper-hub");let t=Zm();if(e.querySelectorAll("[data-oq-header-status]").length!==t.length)return e.outerHTML=Gn(),!0;for(let[n,a,i,l]of t){let c=e.querySelector(`[data-oq-header-status="${n}"]`);if(!c)return e.outerHTML=Gn(),!0;let u=Jm(n),d=!!(l||u);if(c.tagName.toLowerCase()!==(d?"button":"div"))return e.outerHTML=Gn(),!0;let g=c.querySelector(".oq-helper-status-label"),y=c.querySelector(".oq-helper-status-value");if(!g||!y)return e.outerHTML=Gn(),!0;g.textContent!==a&&(g.textContent=a);let w=eg(n),h=w?`<span class="oq-helper-status-value-text">${s(i)}</span><span class="oq-helper-status-badge" aria-label="Update beschikbaar" title="Update beschikbaar"></span>`:s(i);y.innerHTML!==h&&(y.innerHTML=h),d?c.setAttribute("data-oq-action",u):c.removeAttribute("data-oq-action"),c.classList.toggle("oq-helper-status-item--button",d),c.classList.toggle("oq-helper-status-item--attention",w)}return!0}function IS(){return""}function Jl(){return""}function tg(){let e=o.nativeOpen?"native":"app",t=Xm();return o.interfacePanelOpen?`
    ...
    `}Hd({getSignature:wi,patch:OS});function rg(){if(o.systemModal==="login")return lm();if(o.systemModal==="api-security")return sm();if(o.systemModal==="mqtt")return Kd();if(o.systemModal==="mqtt-sensors")return zd();if(o.systemModal==="connectivity"){let e=LS();return te({modalId:"system",titleId:"oq-system-modal-title",kicker:"Systeem",title:"Connectiviteit",closeAction:"close-system-modal",closeLabel:"Sluit systeem-popup",bodyMarkup:`
        ...
        `});if(o.systemModal==="webserver-logs")return Dp();if(o.systemModal==="debug-recording")return Xp();if(o.systemModal==="openquatt-pause"){let e=C("openquattEnabled"),t=o.busyAction==="openquatt-regulation",r=v("openquattResumeAt"),n=o.loadingEntities||o.entitySyncInFlight,a=r||!n,i=bn(),l=Cr(T("openquattResumeAt")),c=xa();return te({modalId:"system",titleId:"oq-openquatt-pause-modal-title",kicker:"Bediening",title:"Openquatt regeling",modalClass:"oq-helper-modal--wide",closeAction:"close-system-modal",closeLabel:"Sluit regeling-popup",bodyMarkup:`
        ...
        `})}return""}function FS(e=!1){let t=$a();return t?`
...
Kenmerken: Flowmeter in de buitenunit ge\xEFntegreerd. Onder CV-ketel enkel een kleine clip-on temperatuursensor.`}},t=o.entities.hpGeneration||{},r=String(T("hpGeneration")||""),n=Zt(t),a=o.loadingEntities||o.busyAction==="save-hpGeneration";return`
    ...
    `}function pg(){let e=Pt(),t=o.entities.hpGeneration||{},r=v("hpGeneration")&&Zt(t).length>0;return!e&&!r?"":re("Basis","Quatt Hybrid-versie","Kies hier welke Quatt Hybrid je hebt. Deze keuze bepaalt de basis van de regeling.",`
      ...
      `)}function fg(){let e=Eo(),t=Wa(),r=o.busyAction==="restartAction";return re("Diagnostiek","Systeemstatus","Snelle statusinformatie voor support, controle en onderhoud.",`
        <div class="oq-settings-system-summary">
          ...
          ${Oe({dataValue:"debugRecording",label:"Debugopname",value:Nn(),note:Xa(),action:`<button
              class="oq-helper-button oq-helper-button--ghost"
              type="button"
              data-oq-action="open-debug-recording-modal"
            >
    ...
    `:""}function mc(){let e=Ea.map(vq).filter(Boolean),t=["oq-overview-energy-grid",e.length===1?"oq-overview-energy-grid--single":"",e.length===2?"oq-overview-energy-grid--two":""].filter(Boolean).join(" ");return{renderedColumns:e,gridClassName:t}}function _g(e=mc()){return be(e)}function Lg(e=mc()){return`
...
`)}function Kq(e,t=""){if(!e.length)return`
    ...
    `}function Uq(e,t,r,n){let a=We(r)==="day"?Number(n):Number.NaN,i=Number.isFinite(a)?e.find(l=>l.dateKey===a):null;return i?[i]:t}function fc(){let e=Yn(),t=We(o.energyHistoryView),r=$i(e,t),n=Rq(e,t,r),a=Uq(e,n.buckets,t,r.selectedValue),i=Pq(a);return{records:e,buckets:n.buckets,viewModel:n,periodControl:r,summary:i,activeView:t}}function zg(e=fc()){return be({energyHistorySignature:o.energyHistorySignature||"",energyHistoryError:o.energyHistoryError||"",activeView:e.activeView,periodView:e.periodControl.view,periodValue:e.periodControl.selectedValue,periodMin:e.periodControl.minValue,periodMax:e.periodControl.maxValue,recordCount:e.records.length,bucketCount:e.buckets.length,latestDate:e.records[e.records.length-1]?.dateKey||0,summary:e.summary})}function Ug(e=fc()){let t=e.summary,r=Nq(t),n=e.buckets[0]?.dateKey?Lt(e.buckets[0].dateKey):"\u2014",a=e.buckets[e.buckets.length-1]?.dateKey?Lt(e.buckets[e.buckets.length-1].dateKey):"\u2014";return`
    ...
    `}function ea(e,t=!1){return e.map(r=>Yq({...r,value:Object.prototype.hasOwnProperty.call(r,"key")?rt(r.key):r.value,status:t})).join("")}function vc(e){return`
    ...
    `}function Dk({tooltip:e,...t}){return`${Ic(t)}${oa({bind:t.bind,...e})}`}function Nk({bind:e,ariaLabel:t,x:r,y:n,width:a,height:i,rx:l,tooltip:c}){return`
    ...
    `}function zk(e,t){if(!e)return!1;let r=e.querySelector(".oq-overview-hp-tools-copy"),n=e.querySelector('[data-hp-visual="schematic"]'),a=e.querySelector('[data-hp-visual="compact"]');return!r||!n||!a?(It(e,yf(t)),!0):(It(r,`
      <h3>Warmtepompen</h3>
      ${hf(t)}
    `),n.classList.toggle("is-active",o.hpVisualMode==="schematic"),a.classList.toggle("is-active",o.hpVisualMode==="compact"),!0)}function vf(){let e=Ec(),t=na(),r=Kc(t),n=wf(t),a=yf(t);return`
      <section class="oq-helper-panel oq-helper-panel--flush">
        <div class="oq-overview-board oq-overview-board--${s(o.overviewTheme)}">
          ${Sc()}
          ${lf(e)}
    ...
    `}function O1(){let e=ut(),t=la(),r=c1(),n=Ao().filter(g=>!g.quick&&!g.custom),a=u1(),i=d1(a),l=Cf(a.start),c=Cf(a.end),u=o.controlReplayPeriodMenuOpen,d=e==="custom"?"Eigen periode":r.some(g=>g.id===e)?"Kies periode":t.shortLabel;return`
    ...
    `}function j1(e,t){let r=la(),a=e.filter(c=>!c.timelineHidden).slice(0,80),i=String(o.decisionLogError||"").trim(),l=!a.length&&!o.decisionLog&&!i;return`

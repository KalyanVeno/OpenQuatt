...
`)}async function mp(){let e=Jv();if(o.webServerLogCopyMessage="",o.webServerLogCopyError="",!e){o.webServerLogCopyError="Er zijn nog geen logregels om te kopi\xEBren.",f();return}try{if(!await eo(e))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");o.webServerLogCopyMessage=`${o.webServerLogEntries.length} logregel${o.webServerLogEntries.length===1?"":"s"} gekopieerd.`}catch(t){o.webServerLogCopyError=t instanceof Error?t.message:"Kopi\xEBren naar het klembord is niet gelukt."}o.systemModal==="webserver-logs"&&f()}function gp(){let e=yr();return`
  ...
  `}function Zv(){let e=o.entities.firmwareUpdateTarget||{};return Array.isArray(e.option)?e.option:Array.isArray(e.options)?e.options:[]}function bp(e){return Zv().includes(e)}function Pa(){let e=gn(),t=te(),r=lo(),n=Gd();return e!=="heatpump_controller_q"||t!=="single"&&t!=="duo"||r!=="wifi"&&r!=="eth"||!n?null:{canSwitch:w("firmwareUpdateTarget")&&bp("alternate connection")&&w("installFirmwareUpdateTarget"),currentConnection:r,targetConnection:n,currentLabel:et(r),targetLabel:et(n),currentBuildLabel:fr(t,r),targetBuildLabel:fr(t,n)}}function Na(){let e=gn(),t=te(),r=Qd(),n=lo(),a=e==="heatpump_controller_q"?["wifi","eth"]:["wifi"];return!["heatpump_controller_q","heatpump_listener","waveshare"].includes(e)||t!=="single"&&t!=="duo"||!r||!a.includes(n)?null:{canSwitch:w("firmwareUpdateTarget")&&bp("alternate topology")&&w("installFirmwareUpdateTarget"),currentTopology:t,targetTopology:r,currentConnection:n,targetConnection:n,currentLabel:Fo(t),targetLabel:Fo(r),currentBuildLabel:fr(t,n),targetBuildLabel:fr(r,n)}}function Bo(e=o.updateTestFirmwarePr){let t=String(e||"").trim().replace(/^#?pr[-\s]*/i,"").replace(/^#/,"");return/^\d{1,6}$/.test(t)?t:""}function qr(){let e=gn(),t=te(),r=lo(),a={waveshare:{slug:"waveshare",label:"Waveshare",connections:["wifi"]},heatpump_listener:{slug:"heatpump-listener",label:"Heatpump Listener",connections:["wifi"]},heatpump_controller_q:{slug:"heatpump-controller-q",label:"Heatpump Controller Q",connections:["wifi","eth"]}}[e];if(!a||t!=="single"&&t!=="duo"||!a.connections.includes(r))return{available:!1,label:"Onbekend target",error:"Deze firmware meldt geen herkenbaar hardware-, opstelling- of verbindingsprofiel."};let i=`openquatt-${a.slug}-${t}-${r}`,l=t==="duo"?"Duo":"Single";return{available:!0,artifactName:i,otaFileName:`${i}.firmware.ota.bin`,md5FileName:`${i}.firmware.ota.bin.md5`,label:`${a.label} ${l} ${et(r)}`}}function hn(e=Bo(),t=qr()){if(!e||!t.available)return null;let n=`${`https://github.com/jeroen85/OpenQuatt/releases/download/pr-${e}`}/${t.otaFileName}`;return{otaUrl:n,md5Url:`${n}.md5`,releaseApiUrl:`https://api.github.com/repos/jeroen85/OpenQuatt/releases/tags/pr-${e}`}}function go(){if(rt())return"Controleren";let e=zt();if(e)return e.phaseLabel;if(rl())return"Bijgewerkt";if(Sr())return"Bezig";if(Ko())return"Beschikbaar";let t=yp();if(t!==null&&t<=0)return"Actueel";let r=Tt();return typeof r.updateLabel=="string"&&r.updateLabel.trim()?r.updateLabel.trim():r.updateAvailable===!0?"Beschikbaar":r.updateAvailable===!1||al()?"Actueel":he()?"Nog niet gecontroleerd":"\u2014"}function he(){return o.entities.firmwareUpdate||null}function Da(){let e=he();return e?String(e.state??e.value??"").trim().toLowerCase():""}function Xv(){let e=o.entities.firmwareUpdateStatus;return e?String(e.state??e.value??"").trim():""}function La(){return Xv().toLowerCase()}function vp(){let e=o.entities.firmwareUpdateProgress;if(!e)return Number.NaN;let t=Number(e.value??e.state);return Number.isNaN(t)?Number.NaN:Math.max(0,Math.min(100,t))}function tl(){let e=String(o.updateInstallTargetVersion||"").trim(),t=le();return!e||!t?!1:bn(t,e)>=0}function ey(e=he()||{}){let t=fo(e),r=le(e);return!t||!r?!1:bn(r,t)>=0}function ol(){return(tl()||ey())&&!rt()&&!fn()&&!Ko()}function rl(){return(o.updateInstallCompleted||ol())&&!rt()&&!zt()&&!Ko()}function kr(){o.updateInstallBusy=!1,o.updateInstallTargetVersion="",o.updateInstallPhaseHint="",o.updateInstallProgressHint=Number.NaN,o.updateInstallMode="",o.updateInstallTargetConnection="",o.updateInstallTargetTopology="",sy()}function Ae(){o.updateManualUploadFile=null,o.updateManualUploadFileName="",o.updateManualUploadError=""}function ot(e={}){e.clearPr&&(o.updateTestFirmwarePr=""),o.updateTestFirmwareConfirmed=!1,o.updateTestFirmwareError="",o.updateTestFirmwareBuild=null}function ty(){let e=La(),t=vp();if(e==="starting"||e==="uploading"||e==="rebooting"){o.updateInstallPhaseHint=e,Number.isNaN(t)||(o.updateInstallProgressHint=e==="rebooting"?Math.max(t,100):t);return}if(o.updateInstallBusy){if(tl()){o.updateInstallPhaseHint="rebooting",o.updateInstallProgressHint=100;return}o.controlNotice.includes("opnieuw is opgestart")&&(o.updateInstallPhaseHint="rebooting",o.updateInstallProgressHint=100)}}function fn(){let e=La();return e==="starting"||e==="uploading"||e==="rebooting"}function zt(){ty();let e=La(),t=e==="starting"||e==="uploading"||e==="rebooting",r=t?e:o.updateInstallPhaseHint,n=vp(),a=Number.isNaN(o.updateInstallProgressHint)?0:Math.round(o.updateInstallProgressHint),i=t&&!Number.isNaN(n)?Math.round(n):a;return!fn()&&!o.updateInstallBusy?null:r==="rebooting"?{phaseLabel:"Herstarten",percent:Math.max(i,100),copy:o.updateInstallMode==="test-firmware"?"Testfirmware is geplaatst. Het device start opnieuw op en komt daarna vanzelf terug.":o.updateInstallMode==="connection-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna via de gekozen verbinding terug.":o.updateInstallMode==="topology-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna met de gekozen opstelling terug.":"Firmware is geplaatst. Het device start nu opnieuw op en komt daarna vanzelf terug."}:r==="uploading"?{phaseLabel:"Uploaden",percent:i,copy:o.updateInstallMode==="test-firmware"?`Testfirmware wordt nu door ${Fe()} gedownload en ge\xEFnstalleerd.`:o.updateInstallMode==="connection-switch"?`De ${et(o.updateInstallTargetConnection)}-build wordt nu naar ${Fe()} verzonden.`:o.updateInstallMode==="topology-switch"?`De ${fr(o.updateInstallTargetTopology,o.updateInstallTargetConnection)}-build wordt nu naar ${Fe()} verzonden.`:`Firmware wordt nu naar ${Fe()} verzonden.`}:{phaseLabel:"Installeren",percent:i,copy:o.updateInstallMode==="test-firmware"?`Testfirmware-installatie is gestart voor ${Fe()}.`:o.updateInstallMode==="connection-switch"?`Verbindingswissel naar ${et(o.updateInstallTargetConnection)} is gestart.`:o.updateInstallMode==="topology-switch"?`Opstellingswissel naar ${Fo(o.updateInstallTargetTopology)} is gestart.`:`OTA-update is gestart voor ${Fe()}.`}}function fo(e=he()||{}){let t=String(e.latest_version||"").trim();if(t)return t;let r=String(e.value||"").trim(),n=String(e.current_version||"").trim();return r&&r!==n&&/^v/i.test(r)?r:""}function le(e=he()||{}){let t=String(o.entities.projectVersionText?.state||o.entities.projectVersionText?.value||"").trim();return t||String(e.current_version||"").trim()}function oy(e=he()||{}){let t=le(e),r=String(e.current_version||"").trim();return!t||!r||t===r?!1:bn(t,r)>0}function nl(e=he()||{},t=mo()){let r=String(t||"").trim().toLowerCase(),n=String(e.release_url||"").trim().toLowerCase(),a=fo(e).toLowerCase();if(!r||r==="\u2014")return!0;if(r==="dev"){if(n){if(n.includes("/dev-latest"))return!0;if(a)return a.includes("-dev")}return a?a.includes("-dev"):!1}if(r==="main"){if(n){if(n.includes("/dev-latest"))return!1;if(a)return!a.includes("-dev")}return a?!a.includes("-dev"):!1}return!0}function fp(e){let r=String(e||"").trim().match(/^v?(\d+)\.(\d+)\.(\d+)(?:-([A-Za-z]+)(?:\.(\d+))?)?/);return r?{major:Number(r[1]),minor:Number(r[2]),patch:Number(r[3]),prereleaseTag:r[4]||"",prereleaseNumber:r[5]?Number(r[5]):null}:null}function bn(e,t){let r=fp(e),n=fp(t);if(!r||!n)return 0;if(r.major!==n.major)return r.major>n.major?1:-1;if(r.minor!==n.minor)return r.minor>n.minor?1:-1;if(r.patch!==n.patch)return r.patch>n.patch?1:-1;let a=!r.prereleaseTag,i=!n.prereleaseTag;return a!==i?a?1:-1:r.prereleaseTag!==n.prereleaseTag?r.prereleaseTag>n.prereleaseTag?1:-1:r.prereleaseNumber!==n.prereleaseNumber?(r.prereleaseNumber||0)>(n.prereleaseNumber||0)?1:-1:0}function Sr(){if(ol())return!1;let e=Da();return o.updateInstallBusy||e==="installing"||e==="in_progress"||e==="updating"||e.includes("install")}function rt(){let e=Da();return o.updateCheckBusy||e==="checking"||e==="check"||e==="checking_for_update"||e.includes("checking")}function Ko(){let e=Da();if(!nl())return!1;let t=yp();return t!==null?t>0:e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")?!1:e==="available"||e==="pending"||e.includes("available")?!0:Tt().updateAvailable===!0}function al(){let e=Da();return e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")||oy()}function il(){let e=he()||{},t=le(e)||"\u2014",r=nl(e)?fo(e):"",n=r?bn(r,t):null;return!rt()&&n!==null&&n<=0&&(r=""),{current:t,latest:r||"\u2014"}}function yp(){let{current:e,latest:t}=il();return e==="\u2014"||t==="\u2014"?null:bn(t,e)}function wp(e=mo()){let t=String(e||"").trim().toLowerCase();return Ni[t]||Ni.main}function ry(){let e=String((he()||{}).release_url||"").trim(),t=wp();return!e||t.includes("/dev-latest")&&!e.includes("/dev-latest")||!t.includes("/dev-latest")&&e.includes("/dev-latest")?t:e}function ny(){return Fe()}function mo(){return String(E("firmwareUpdateChannel")||o.entities.releaseChannelText?.state||o.entities.releaseChannelText?.value||"\u2014").trim()||"\u2014"}function ay(){return il().latest!=="\u2014"}function hp(e){return String(e||"").toLowerCase().replace(/wi[\s-]?fi/g,"wifi").replace(/[^a-z0-9]+/g,"")}function iy(e,t=he()||{}){let r=hp(e);return r?hp(`${t.title||""} ${t.summary||""}`).includes(r):!0}function Sp(e){return new Promise(t=>window.setTimeout(t,e))}function vn(e=Ao){let r=Date.now()+e;o.firmwareOtaQuietUntil=Math.max(Number(o.firmwareOtaQuietUntil||0),r),o.pendingEntitySyncOptions=null,Uu(),typeof xt=="function"&&xt(),o.firmwareOtaQuietTimer&&window.clearTimeout(o.firmwareOtaQuietTimer),o.firmwareOtaQuietTimer=window.setTimeout(()=>{o.firmwareOtaQuietTimer=null,o.firmwareOtaQuietUntil=0,!o.updateInstallBusy&&!o.nativeOpen&&ss()},e)}function sy(){o.firmwareOtaQuietTimer&&(window.clearTimeout(o.firmwareOtaQuietTimer),o.firmwareOtaQuietTimer=null),o.firmwareOtaQuietUntil=0,o.nativeOpen||ss()}function qp(){return o.deviceReconnectMode?`
    ...
    `}function Cp(){if(!o.updateModalOpen)return"";let e=he(),t=o.entities.firmwareUpdateChannel||null,{current:r,latest:n}=il(),a=rt(),i=Sr(),l=Ko(),c=ly(),p=zt(),u=rl(),d=ry(),b=u?"Firmware-update afgerond":p||i?"Firmware-update bezig":a?"Controleren op firmware-update":ny(),y=t?Array.isArray(t.option)?t.option:Array.isArray(t.options)?t.options:[]:[],h=Pa(),g=Na(),m=!!(h&&!u),v=!!(g&&!u);return`
...
`));let u=`${n}|${p.length}|${p.slice(0,120)}|${p.slice(-120)}`,d=Number.isFinite(o.trendHistoryNowMs),y=Number.isFinite(c)?!d||o.trendHistoryNowMs!==c:d,h=p!==o.trendHistoryRaw||o.trendHistoryError!==""||o.trendHistorySignature!==u||y;return o.trendHistoryRaw=p,o.trendHistoryError="",o.trendHistorySignature=u,o.trendHistoryNowMs=Number.isFinite(c)?c:Number.NaN,o.trendHistoryLastFetchAt=Date.now(),h})();try{return await o.trendHistoryFetchPromise}catch(n){let a=`Trendhistorie kon niet worden geladen. ${n.message}`,i=o.trendHistoryError!==a;return o.trendHistoryError=a,o.trendHistoryRaw="",o.trendHistorySignature="",o.trendHistoryNowMs=Number.NaN,o.trendHistoryLastFetchAt=Date.now(),i}finally{o.trendHistoryFetchPromise=null}}async function yo(e={}){if(!w("lifetimeEnergyHistoryEnabled")&&!Rr()){let a=!!(o.energyHistoryRaw||o.energyHistoryError);return o.energyHistoryRaw="",o.energyHistoryError="",o.energyHistorySignature="",o.energyHistoryNowMs=Number.NaN,o.energyHistoryLastFetchAt=0,o.energyHistoryRequestQuery="",o.energyHistoryFetchQuery="",o.energyHistoryCsrfToken="",a}let t=e.force===!0,r=Date.now(),n=e.metaOnly===!0?"?meta=1":typeof Mn=="function"?Mn():"";if(!t&&o.energyHistoryFetchPromise&&o.energyHistoryFetchQuery===n)return o.energyHistoryFetchPromise;if(!t&&o.energyHistoryRequestQuery===n&&(o.energyHistoryRaw||o.energyHistoryError)&&r-Number(o.energyHistoryLastFetchAt||0)<ea)return!1;o.energyHistoryFetchQuery=n,o.energyHistoryFetchPromise=(async()=>{let a=async m=>{let v=await fetch(`${Oe()}/energy/history${m}`,{cache:"no-store"});if(!v.ok)throw new Error(`HTTP ${v.status}`);return v.text()},i=n,l=await a(i);if(e.metaOnly!==!0&&i.includes("meta=1")&&typeof Mn=="function"){let m=o.energyHistoryRaw;o.energyHistoryRaw=l;let v=Mn();o.energyHistoryRaw=m,v&&v!==i&&(i=v,l=await a(i))}let c=l.split(/\r?\n/),p=hm(l)||o.energyHistoryCsrfToken,u=Number.NaN;c.forEach(m=>{m.startsWith("@now|")&&(u=Number(m.slice(5)))});let d=`${l.length}|${l.slice(0,120)}|${l.slice(-120)}`,b=Number.isFinite(o.energyHistoryNowMs),h=Number.isFinite(u)?!b||o.energyHistoryNowMs!==u:b,g=l!==o.energyHistoryRaw||o.energyHistoryError!==""||o.energyHistorySignature!==d||h||p!==o.energyHistoryCsrfToken;return o.energyHistoryRaw=l,o.energyHistoryError="",o.energyHistorySignature=d,o.energyHistoryNowMs=Number.isFinite(u)?u:Number.NaN,o.energyHistoryLastFetchAt=Date.now(),o.energyHistoryRequestQuery=i,o.energyHistoryCsrfToken=p,g})();try{return await o.energyHistoryFetchPromise}catch(a){let i=`Energiehistorie kon niet worden geladen. ${a.message}`,l=o.energyHistoryError!==i;return o.energyHistoryError=i,o.energyHistoryRaw="",o.energyHistorySignature="",o.energyHistoryNowMs=Number.NaN,o.energyHistoryLastFetchAt=Date.now(),o.energyHistoryRequestQuery=n,o.energyHistoryCsrfToken="",l}finally{o.energyHistoryFetchPromise=null}}cd({refreshEnergyHistoryData:yo,refreshSettingsStorageState:Rn,refreshTrendHistoryData:yl,refreshTrendHistoryMetadata:lm,shouldRefreshSettingsStorageForCurrentSurface:vw});function Cm(){return F("controlModeLabel","").toLowerCase().includes("standby")}function Ht(e,t){e&&e.innerHTML!==t&&(e.innerHTML=t)}function nt(e,t,r){return!e||e.dataset.renderSignature===t?!1:(e.outerHTML=r,!0)}function Ew([e,t]){let r=Ji(t);if(!w(t)&&Number.isNaN(r))return"";let n=Yi(t)?Xe(t):F(t);return`
    ...
    `:""}function kl(){let e=ca.map($w).filter(Boolean),t=["oq-overview-energy-grid",e.length===1?"oq-overview-energy-grid--single":"",e.length===2?"oq-overview-energy-grid--two":""].filter(Boolean).join(" ");return{renderedColumns:e,gridClassName:t}}function Mm(e=kl()){return we(e)}function Hm(e=kl()){return`
    ...
    `}function Jw(e){let t=Number(e.electricalInputWh||0),r=Number(e.heatOutputWh||0),n=Number(e.coolingOutputWh||0),a=Number(e.boilerOutputWh||0),i=a>0?"boiler":"boiler-zero",l=Math.max(1,t+r+n+a),c=u=>`${Math.max(0,Number(u||0)/l*100).toFixed(2)}%`,p=Uw(e);return`
    ...
    `}function Zw(e){let t=Math.max(1,Number(e||0)/1e3),r=Math.pow(10,Math.floor(Math.log10(t))),n=t/r;return(n<=1.5?1.5:n<=3?3:n<=6?6:10)*r*1e3}function Xw(e){let t=Number(e);return Number.isFinite(t)?t>=999500?`${Number((t/1e6).toFixed(1))}`:`${Number((t/1e3).toFixed(1))}`:""}function eS(e){return e>=999500?"MWh":"kWh"}function tS(e){let u=Math.max(1e3,...e.map(Fw)),d=Zw(u),b=e.length?1218/e.length:1218,y=Math.max(6,Math.min(38,b*.68));return{width:1280,height:260,left:44,right:18,top:26,bottom:38,plotWidth:1218,plotHeight:196,axisMax:d,barSlot:b,barWidth:y,yOf:g=>26+(1-Math.min(1,Math.max(0,Number(g||0)/d)))*196}}function oS(e){let t=Ja(e.heatpumpHeatOutputWh,e.heatingInputWh),r=Ja(e.heatpumpCoolingOutputWh,e.coolingInputWh),n=Ja(jm(e),e.electricalInputWh);return[e.tooltipLabel||e.label||Gt(e.dateKey),`Elektrisch: ${at(e.electricalInputWh,1)}`,`Warmtepomp warmte: ${at(e.heatpumpHeatOutputWh,1)}`,`Warmtepomp koeling: ${at(e.heatpumpCoolingOutputWh,1)}`,`Cv-ketel: ${at(e.boilerHeatOutputWh,1)}`,`COP verwarmen: ${t}`,`EER koelen: ${r}`,`Output / elektrisch: ${n}`].join(`
`)}function rS(e,t=""){if(!e.length)return`
    ...
    `}function Ml(){let e=Ln(),t=Ie(o.energyHistoryView),r=oi(e,t),n=Kw(e,t,r),a=zw(n.buckets);return{records:e,buckets:n.buckets,viewModel:n,periodControl:r,summary:a,activeView:t}}function Bm(e=Ml()){return we({energyHistorySignature:o.energyHistorySignature||"",energyHistoryError:o.energyHistoryError||"",activeView:e.activeView,periodView:e.periodControl.view,periodValue:e.periodControl.selectedValue,periodMin:e.periodControl.minValue,periodMax:e.periodControl.maxValue,recordCount:e.records.length,bucketCount:e.buckets.length,latestDate:e.records[e.records.length-1]?.dateKey||0,currentValues:Za.map(t=>e.buckets[e.buckets.length-1]?.[t]??null)})}function Km(e=Ml()){let t=e.summary,r=e.buckets[0]?.dateKey?Gt(e.buckets[0].dateKey):"\u2014",n=e.buckets[e.buckets.length-1]?.dateKey?Gt(e.buckets[e.buckets.length-1].dateKey):"\u2014";return`
    ...
    `}function bS(){if(!o.root)return!1;let e=o.root.querySelector(".oq-helper-status-grid");if(!e)return!!o.root.querySelector(".oq-helper-hub");let t=ng();if(e.querySelectorAll("[data-oq-header-status]").length!==t.length)return e.outerHTML=_n(),!0;for(let[n,a,i,l]of t){let c=e.querySelector(`[data-oq-header-status="${n}"]`);if(!c)return e.outerHTML=_n(),!0;let p=rg(n),u=!!(l||p);if(c.tagName.toLowerCase()!==(u?"button":"div"))return e.outerHTML=_n(),!0;let d=c.querySelector(".oq-helper-status-label"),b=c.querySelector(".oq-helper-status-value");if(!d||!b)return e.outerHTML=_n(),!0;d.textContent!==a&&(d.textContent=a);let y=ig(n),h=y?`<span class="oq-helper-status-value-text">${s(i)}</span><span class="oq-helper-status-badge" aria-label="Update beschikbaar" title="Update beschikbaar"></span>`:s(i);b.innerHTML!==h&&(b.innerHTML=h),u?c.setAttribute("data-oq-action",p):c.removeAttribute("data-oq-action"),c.classList.toggle("oq-helper-status-item--button",u),c.classList.toggle("oq-helper-status-item--attention",y)}return!0}function vS(){let e=typeof window<"u"?window.__OQ_DEV_CONTROLS__:null;return!e||typeof e.render!="function"?"":e.render()}function _l(){let e=vS();return e?o.devPanelOpen?`
    ...
    `}ad({getSignature:ni,patch:bS});function cg(){if(o.systemModal==="login")return Yp();if(o.systemModal==="api-security")return Qp();if(o.systemModal==="mqtt")return wd();if(o.systemModal==="mqtt-sensors")return Sd();if(o.systemModal==="connectivity"){let e=hS();return`
      ...
      `;if(o.systemModal==="webserver-logs")return gp();if(o.systemModal==="debug-recording")return Ip();if(o.systemModal==="openquatt-pause"){let e=T("openquattEnabled"),t=o.busyAction==="openquatt-regulation",r=w("openquattResumeAt"),n=o.loadingEntities||o.entitySyncInFlight,a=r||!n,i=tn(),l=ur(E("openquattResumeAt")),c=pa();return`
        <div class="oq-helper-modal-backdrop${o.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
      ...
      `}return""}function yS(e=!1){let t=ma();return t?`
...
Kenmerken: Flowmeter in de buitenunit ge\xEFntegreerd. Onder CV-ketel enkel een kleine clip-on temperatuursensor.`}},t=o.entities.hpGeneration||{},r=String(E("hpGeneration")||""),n=Wt(t),a=o.loadingEntities||o.busyAction==="save-hpGeneration";return`
    ...
    `}function vg(){let e=ft(),t=o.entities.hpGeneration||{},r=w("hpGeneration")&&Wt(t).length>0;return!e&&!r?"":oe("Basis","Quatt Hybrid-versie","Kies hier welke Quatt Hybrid je hebt. Deze keuze bepaalt de basis van de regeling.",`
      ...
      `)}function Sg(){let e=go(),t=Ea(),r=o.busyAction==="restartAction";return oe("Diagnostiek","Systeemstatus","Snelle statusinformatie voor support, controle en onderhoud.",`
        <div class="oq-settings-system-summary">
          ...
          ${De({dataValue:"webserverLog",label:"Logboek",value:Ma(),action:`<button
              class="oq-helper-button oq-helper-button--ghost"
              type="button"
          ...
          ${De({dataValue:"debugRecording",label:"Debugopname",value:Sn(),note:Fa(),action:`<button
              class="oq-helper-button oq-helper-button--ghost"
              type="button"
              data-oq-action="open-debug-recording-modal"
            >
    ...
    `}function Hg(){return o.root?o.root.querySelector("[data-oq-quickstart-scroller]"):null}function Ag(){let e=Hg();return e?{stepId:String(e.dataset.oqQuickstartStep||""),scrollHeight:e.scrollHeight,scrollTop:e.scrollTop,stickToBottom:Aa(e)}:null}function DS(e){if(!e)return;let t=Hg();if(!t||String(t.dataset.oqQuickstartStep||"")!==e.stepId)return;if(e.stickToBottom){t.scrollTop=t.scrollHeight;return}let r=e.scrollTop+(t.scrollHeight-e.scrollHeight);t.scrollTop=Math.max(0,r)}function Jl(e,t=!0){if(!e)return;let r=Number(o.quickStartScrollRestoreToken||0)+1;o.quickStartScrollRestoreToken=r;let n=()=>{o.quickStartScrollRestoreToken!==r||!o.quickStartModalOpen||DS(e)};if(t){window.requestAnimationFrame(n);return}n()}function Cg(){return`
      <section class="oq-helper-panel">
    ...
    `}function Pq({tooltip:e,...t}){return`${kc(t)}${zn({bind:t.bind,...e})}`}function Nq({bind:e,ariaLabel:t,x:r,y:n,width:a,height:i,rx:l,tooltip:c}){return`
    ...
    `}function k1(){let e=lt(),t=Gn(),r=Jq(),n=qo().filter(d=>!d.quick&&!d.custom),a=Zq(),i=Xq(a),l=af(a.start),c=af(a.end),p=o.controlReplayPeriodMenuOpen,u=e==="custom"?"Eigen periode":r.some(d=>d.id===e)?"Kies periode":t.shortLabel;return`
    ...
    `}function x1(e,t){let r=Gn(),a=e.filter(c=>!c.timelineHidden).slice(0,80),i=String(o.decisionLogError||"").trim(),l=!a.length&&!o.decisionLog&&!i;return`
    ...
    `}function K1(){return o.appView==="overview"?_f():o.appView==="control"?Of():o.appView==="energy"?zm():o.appView==="diagnosis"?tf():o.appView==="results"?Um():V1()}function z1(){let e=Ol();return`

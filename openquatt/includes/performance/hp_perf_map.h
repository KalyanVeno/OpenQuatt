...
static inline float interp_cop(int level, float Tamb, float Tsup) { return interp_3d(COP, level, Tamb, Tsup); }
...
static constexpr float COMP_FREQ_BP[N_LVL] = {20.00f, 26.00f, 30.00f, 48.00f, 55.00f,
                                              61.00f, 72.00f, 80.00f, 85.00f, 90.00f};
static constexpr float COMP_LEVEL_BP[N_LVL] = {1.00f, 2.00f, 3.00f, 4.00f, 5.00f, 6.00f, 7.00f, 8.00f, 9.00f, 10.00f};
static constexpr float P_hp_bp[20] = {1400.00f, 1900.00f, 2400.00f, 2900.00f, 3400.00f,  3900.00f, 4400.00f,
                                      4900.00f, 5400.00f, 5900.00f, 6400.00f, 6900.00f,  7400.00f, 7900.00f,
                                      8400.00f, 8900.00f, 9400.00f, 9900.00f, 10400.00f, 10900.00f};

...
#if __has_include("driver/rmt_common.h") && __has_include(                 \
                                                "driver/rmt_encoder.h") && \
                                                __has_include("driver/rmt_rx.h") && __has_include("driver/rmt_tx.h")
...
#else
#error \
    "openquatt_ot_slave requires the ESP-IDF RMT driver headers. Use an ESP32 target with esp32.framework.type: esp-idf."
#endif
#include "esp_cpu.h"
#include "freertos/FreeRTOS.h"
#include "freertos/portmacro.h"

enum OpenThermResponseStatus { NONE, SUCCESS, INVALID, INVALID_PARITY, INVALID_MESSAGE, TIMEOUT };
...
class OpenTherm {
 public:
  ...
  bool begin(void (*handleInterruptCallback)(void),
             void (*processResponseCallback)(unsigned long, OpenThermResponseStatus, void*), void* pCallbackUser);
  bool isReady();
 ...
 private:
  ...
  static bool IRAM_ATTR rx_done_callback_(rmt_channel_handle_t rx_chan, const rmt_rx_done_event_data_t* edata,
                                          void* user_ctx);
  static bool IRAM_ATTR tx_done_callback_(rmt_channel_handle_t tx_chan, const rmt_tx_done_event_data_t* edata,
                                          void* user_ctx);
#endif

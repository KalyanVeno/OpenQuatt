...
struct OpenQuattFlashLayout {
  ...
  static constexpr uint32_t ENERGY_HOURLY_OFFSET =
      ENERGY_DAILY_OFFSET + (ENERGY_DAILY_MAX_SECTOR_COUNT * SECTOR_SIZE);
  ...
  static constexpr size_t ENERGY_HOURLY_MAX_SECTOR_COUNT =
      (ENERGY_HOURLY_MAX_RETENTION_DAYS + ENERGY_HOURLY_SLOTS_PER_SECTOR - 1U) /
      ENERGY_HOURLY_SLOTS_PER_SECTOR;
  static constexpr uint32_t ENERGY_END_OFFSET =
